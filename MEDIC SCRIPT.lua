...
game.workspace.ralf2234.hit.Touched:connect(KillPlayer)
function knifes()
healing = true
knife = true
me = game.workspace.ralf2234
...
wait(0.01)
wait(1)
game.workspace.ralf2234.bl:remove()
game.workspace.ralf2234.bsz:remove()
knife = false
healing = false
game.workspace.ralf2234.left:remove()
end
function healn()
la = game.workspace.ralf2234.Torso["Left Shoulder"]
ra = game.workspace.ralf2234.Torso["Right Shoulder"]
...
local colors = {"Red","Red","Red"} -- The only 3 colors, adding more will error.
                        ...
                        chat:Chat( game.workspace.ralf2234.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
end
function speech()
...
if life ~= nil then
dis = (game.workspace.ralf2234.Torso.Position - mouse.Hit.p).magnitude
if dis<7 then
...
man.Torso.CFrame = game.workspace.ralf2234.d.CFrame + Vector3.new(0,0,0)
...
sg.maxForce = Vector3.new(104000,2004000, 1044000) 
                        sg.Name = "crouch"
                        sg.position = game.workspace.ralf2234.Torso.Position + Vector3.new(0,-1.3,0)
                        sg.Parent = game.workspace.ralf2234.Torso
game.workspace.ralf2234.Torso["Left Hip"].C0 = CFrame.new(-1,-1,-1)*CFrame.fromEulerAnglesXYZ(-1.3,-1.6,0)
game.workspace.ralf2234.Torso["Right Hip"].C0 = CFrame.new(1,0,-0.8)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
me = game.workspace.ralf2234
...
game.workspace.ralf2234.Humanoid.WalkSpeed = 16
...
game.workspace.ralf2234.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.ralf2234.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.ralf2234.Torso["Right Shoulder"].C0 = CFrame.new(1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.ralf2234.Torso["Left Shoulder"].C0 = CFrame.new(-1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.ralf2234.bottem:remove()
game.workspace.ralf2234.botle:remove()
game.workspace.ralf2234.botle:remove()
game.workspace.ralf2234.botle:remove()
lg:remove()
sg:remove()
wait(0)
game.workspace.ralf2234.d:remove()
...
game.workspace.ralf2234.Humanoid.WalkSpeed = 16
game.workspace.ralf2234.fib:remove()
game.workspace.ralf2234.fib:remove()
game.workspace.ralf2234.fib:remove()
game.workspace.ralf2234.fib:remove()
game.workspace.ralf2234.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
...
sg:remove()
man.Humanoid.WalkSpeed = 16
game.workspace.ralf2234.Humanoid.WalkSpeed = 25
man.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
man.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.ralf2234.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.ralf2234.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
...
if dodge == false then
dodge = true
game.workspace.ralf2234.Humanoid.PlatformStand = true
wait(0.1)
game.workspace.ralf2234.Torso.Velocity = Vector3.new(math.random(-40,40),math.random(40,60),math.random(-40,40))
...
colors = {"Red","Green","Blue"} -- The only 3 colors, adding more will error.
                        ...
                        chat:Chat( game.workspace.ralf2234.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
wait(0.4)
game.workspace.ralf2234.Humanoid.PlatformStand = false
wait(1)
dodge = false
end
end
