...
fx.BrickColor = BrickColor.new("Bright bluish green")
...
pr.BrickColor = BrickColor.new("Bright bluish green")
pr.Material = "Metal"
pr.Reflectance = 0.04
pr.Anchored = false
pr.CanCollide = false
...
GroundWave1 = function()
	...
	local Colors = {"Teal", "Bright bluish green"}
...
----------------------------------------------------
Blast = function()
	local Colors = {"Bright bluish green", "Teal"}
		local wave = Instance.new("Part", torso)
		wave.BrickColor = BrickColor.new(Colors[math.random(1,#Colors)])
		wave.Anchored = true
		wave.CanCollide = false
...
mouse.KeyDown:connect(function(key)
	...
	sp2.Name = "Energy"
	sp2.BrickColor = BrickColor.new("Teal")
	...
	Explode = X.Touched:connect(function(hit)
		...
		function Crater(Torso,Radius)
			...
			function explosion(col1,col2,cfr,sz,rng,dmg)
				...
				blast.BrickColor = BrickColor.new("Teal")
				blast.Anchored = true
				...
				blast2.BrickColor = BrickColor.new("Teal")
				...
				blast3.BrickColor = BrickColor.new("Teal")
...
rng.Anchored = true
rng.BrickColor = BrickColor.new("Teal")
rng.CanCollide = false
rng.FormFactor = 3
rng.Name = "Ring"
rng.Size = Vector3.new(1, 1, 1)
...
bnd.Anchored = true
bnd.BrickColor = BrickColor.new("Bright bluish green")
	...
	if key == "x" then
		if Debounces.CanAttack == true then
			...
			Debounces.on = true
				...
				shell.BrickColor = BrickColor.new("Bright bluish green")
...
pt.CFrame=root.CFrame*CFrame.new(0,-1,0)
pt.Transparency=.6
pt.BrickColor=BrickColor.new('Teal')
msh=Instance.new('SpecialMesh',pt)
msh.MeshId='http://www.roblox.com/asset/?id=24388358'
...
pt2.Parent = torso
pt2.CFrame=root.CFrame*CFrame.new(0,-1,0)
pt2.BrickColor=BrickColor.new("Teal")
msh2=msh:clone()
msh2.Parent=pt2
...
bl.Locked = true
bl.Name = "Shell"
bl.BrickColor = BrickColor.new("Teal")
bl.Anchored = true
bl.CanCollide = false
bl.Transparency = 0
bl.Reflectance = 0
