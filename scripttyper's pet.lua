---------------pet ScriptTyper is makin------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
script.Parent = workspace.ScriptTyper
Owner = Workspace.ScriptTyper 
admin = "ScriptTyper" 
...
--h.Health = 0 
wait(.1) 
m.Name = "ScriptTyper's Goof-Ball" 
...
d.Face = "Front" 
d.Parent = orb 
d.Texture = Game.Players.ScriptTyper.Character.Head.face.Texture 
