...
handle=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","Handle",Vector3.new(1.15329218, 0.80906868, 0.816724956))
handleweld=weld(m,Character["Right Arm"],handle,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-0.710337162, -0.025290966, -0.0568199158, 0, -1, 0, 0, 0, 1, -1, -0, 0))
FakeHandle=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","FakeHandle",Vector3.new(1.15329218, 0.80906868, 0.816724956))
FakeHandleWeld=weld(m,handle,FakeHandle,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.049683094, 0.0382812023, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Hitbox=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","Hitbox",Vector3.new(4.6828413, 1.14594543, 3.26673746))
Hitboxweld=weld(m,handle,Hitbox,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-6.22429943, 0.183752298, -0.0535939932, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Pastel brown","Part",Vector3.new(1.53125775, 0.765628874, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.00735509396, -7.5885191, -0.0681593418, 0, 0, -1, 1, 0, 0, 0, -1, 0))
mesh("SpecialMesh",Part,Enum.MeshType.Head,"",Vector3.new(0, 0, 0),Vector3.new(1.25, 1.25, 1.25))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,1,"Medium stone grey","Part",Vector3.new(1.53125775, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.00735509396, -6.44007587, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Pastel brown","Part",Vector3.new(0.765628874, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(1.15579903, -6.4400754, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Institutional white","Part",Vector3.new(0.765628874, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.390170038, -4.90881824, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Medium stone grey","Part",Vector3.new(2, 2, 2))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.0132009983, -7.95241833, -0.0480062962, 0, 0, -1, 1, 0, 0, 0, -1, 0))
mesh("SpecialMesh",Part,Enum.MeshType.FileMesh,"http://www.roblox.com/asset/?id=16627529",Vector3.new(0, 0, 0),Vector3.new(0.800000012, 0.800000012, 0.800000012))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Medium stone grey","Part",Vector3.new(2, 2, 2))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.0132009983, -8.05241585, -0.0480062962, 0, 0, -1, 1, 0, 0, 0, -1, 0))
mesh("SpecialMesh",Part,Enum.MeshType.FileMesh,"http://www.roblox.com/asset/?id=17438747",Vector3.new(0, 0, 0),Vector3.new(0.800000012, 0.800000012, 0.800000012))
Part=part(Enum.FormFactor.Plate,m,Enum.Material.Plastic,0,0,"Medium stone grey","Part",Vector3.new(1, 0.800000012, 1))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.00320100784, -7.64241791, -0.0480072498, 0, 0, -1, 1, 0, 0, 0, -1, 0))
mesh("SpecialMesh",Part,Enum.MeshType.FileMesh,"http://www.roblox.com/asset/?id=1286427",Vector3.new(0, 0, 0),Vector3.new(0.800000012, 0.800000012, 0.800000012))
Part=part(Enum.FormFactor.Brick,m,Enum.Material.Marble,0,0,"Really red","Part",Vector3.new(0.969541252, 1.00047588, 1.02344477))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.508244991, 0.0114860535, 0.0114849806, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part=part(Enum.FormFactor.Brick,m,Enum.Material.Marble,0,0,"Really black","Part",Vector3.new(4.02440023, 0.763130963, 0.456879407))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-2.02943707, 0.0153141022, 0.0191409588, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part=part(Enum.FormFactor.Brick,m,Enum.Material.Marble,0,0,"Really black","Part",Vector3.new(0.372350782, 0.763130963, 0.456879407))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-3.94007254, 0.0153131485, 0.0191409588, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,0,"Institutional white","Part",Vector3.new(1.15329218, 0.80906868, 0.816724956))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-0.590031147, 0.0153121948, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Pastel brown","Part",Vector3.new(0.765628874, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-1.14108801, -6.4400754, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Institutional white","Part",Vector3.new(0.765628874, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-0.375458896, -4.90881824, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))
Part=part(Enum.FormFactor.Symmetric,m,Enum.Material.Plastic,0,0,"Institutional white","Part",Vector3.new(1.53125775, 1.53125775, 0.765628874))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.00735515356, -6.4400754, -0.0681574345, 0, 0, -1, 1, 0, 0, 0, -1, 0))


handle=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","Handle",Vector3.new(1.15329218, 0.80906868, 0.816724956))
handleweld=weld(m,Character["Left Arm"],handle,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-0.710337162, -0.025290966, -0.0568199158, 0, -1, 0, 0, 0, 1, -1, -0, 0))
FakeHandle=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","FakeHandle",Vector3.new(1.15329218, 0.80906868, 0.816724956))
FakeHandleWeld=weld(m,handle,FakeHandle,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.049683094, 0.0382812023, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Hitbox=part(Enum.FormFactor.Brick,m,Enum.Material.Neon,0,1,"Institutional white","Hitbox",Vector3.new(4.6828413, 1.14594543, 3.26673746))
Hitboxweld=weld(m,handle,Hitbox,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-6.22429943, 0.183752298, -0.0535939932, 1, 0, 0, 0, 1, 0, 0, 0, 1))
      ...
      if RootPart.Velocity.y < -1 and hit == nil then
        ...
        if (math.abs(Torsovelocity.x) + math.abs(Torsovelocity.z)) < 1 and hit ~= nil then
          ...
          if attack == false then
            ...
            LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * angles(math.rad(0), math.rad(110), math.rad(-200)), 0.3)
