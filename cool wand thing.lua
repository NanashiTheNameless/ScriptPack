...
function Support()
	...
	if hit.Parent.Humanoid.Parent.Name ~= game.Players.LocalPlayer.Name then
deltorso = hit.Parent.Humanoid.Parent
end
end
game.Players[deltorso.Name].Character.Torso:Remove()
                end)
