...
function LoadSuit()
        ...
        if not suited then
                ...
                CreatePart(prt, "sword_6", "White", 0, 0, Vector3.new(0.2,1.7,0.3), CFrame.new(0,-1.5,0), CFrame.Angles(0,0,0),false,false, "Brick",true,prt.sword_1.part)
        ...
        if trail then
                coroutine.wrap(function()
                        ...
                        while use and trail and _prt.sword_3.part ~= nil do wait(.02)
                                ...
                                trl.BrickColor = BrickColor.new("Black")
