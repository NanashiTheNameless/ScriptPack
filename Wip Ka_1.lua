...
local cooldownadd3 = 0.35
table.insert(cooldownsadd, cooldownadd3)
local cooldownadd4 = 0.07
...
attackone = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt12.CFrame
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 6, 4, 6, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 6)), nil, true)
...
attackfour = function()
  ...
  if Stagger.Value ~= true and StunT.Value > Stun.Value then
    if StaggerHit.Value == true then
      ...
      MagniDamage(prt14, 10, 5, 6, math.random(10, 20), "Knockdown2", prt14, 0, 1, (math.random(3, 6)), nil, nil, true, "Movement", 0.1, 100)
      CF = prt14.CFrame
...
TemporalImage = function()
  ...
  if Image.Parent == nil then
    ...
    if Rooted.Value == false and mana.Value >= 15 and distort >= 50 and ((RootPart.Position - ImageRoot.Position).magnitude) <= 150 then
      ...
      MagniDamage(Torso, 20, 4, 7, math.random(5, 10), "Normal", Torso, 0, 1, (math.random(1, 5)), nil, nil, true, "Temporal", 0.1, 300)
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and (mana.Value >= 20 or distort >= 100) then
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      ...
      MagniDamage(RootPart, 30, 5, 10, math.random(20, 30), "Normal", RootPart, 0, 1, (math.random(5, 10)), nil, nil, true, "Movement", 0.2, 300)
      MagniBuff(RootPart, 30, "Damage", -0.2, 500)
      MagniBuff(RootPart, 30, "Movement", -0.2, 500)
      num = 0
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 10 then
    ...
    while 1 do
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        ...
        if mana.Value <= 8 then
          graviting = false
        end
        wld1.C0 = wld1.C0 * euler(0.2, 0, 0)
        num = num + 1
        ...
        MagicCircle(BrickColor.new("Navy blue"), cf(ref.Position), 20, 20, 20, 5, 5, 5, 0.1)
        hitfloor2 = rayCast(ref.Position, CFrame.new(ref.Position, ref.Position - Vector3.new(0, 1, 0)).lookVector, 30, Character)
        if num >= 30 then
          if distort >= 100 then
            distort = distort - 40
          else
            mana.Value = mana.Value - 8
          end
          num = 0
          num2 = num2 + 1
          if num2 < 3 then
            so("183763506", ref, 1, 1)
            MagniDamage(ref, 20, 2, 3, 0, "Normal", ref, 0, 1, (math.random(5, 8)), nil, nil, true, "Defense", 0.05, 100)
          end
          MagicCircle(BrickColor.new("Black"), cf(ref.Position), 20, 20, 20, 10, 10, 10, 0.05)
          if hitfloor2 ~= nil then
            MagicWave(hitfloor.BrickColor, cf(RootPart.Position), 1, 1, 1, 4, -0.1, 4, 0.1)
            for i = 1, 5 do
              Lightning(ref.Position, ref.Position + vt(math.random(-1000, 1000) / 100, 0, math.random(-1000, 1000) / 100), 5, 2, "Navy blue", 0.5, 0.4, 0.05)
            end
          end
        end
        do
          do
            if num2 >= 3 then
              ...
              MagniDamage(ref, 20, 4, 5, math.random(-30, -20), "Normal", ref, 0, 1, (math.random(6, 8)), nil, nil, true, "Defense", 0.05, 400)
              MagniDamage(ref, 20, 4, 5, math.random(-30, -20), "Normal", ref, 0, 1, (math.random(6, 8)), nil, nil, true, "Defense", 0.05, 400)
            end
            -- DECOMPILER ERROR at PC795: LeaveBlock: unexpected jumping out DO_STMT
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and (mana.Value >= 5 or distort >= 100) and RecentEnemy.Value ~= nil then
    decreasemana = true
    if distort >= 100 then
      distort = 0
      decreasemana = false
    ...
    repeat
        ...
        for i = 0, 1, 0.15 do
          ...
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC755: LeaveBlock: unexpected jumping out IF_THEN_STMT

              -- DECOMPILER ERROR at PC755: LeaveBlock: unexpected jumping out IF_STMT
      ...
      if target ~= nil then
        ...
        Damagefunc(target, 3, 5, 0, "Normal", RootPart, 0, 1, (math.random(1, 3)), nil, false, true, "Movement", 0.02, 200)
      end
      while 1 do
        if num1 <= 20 then
          swait()
        ...
        if doanim ~= true and mana.Value >= 5 or decreasemana == true then
          break
        end
      end
      if doanim == true then
      ...
      if (mana.Value < 5 and decreasemana == true) or hits2 >= 5 then
        endanim = true
      end
    until endanim == true
    attack = false
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    DecreaseStat(Character, "Movement", -0.3, 700)
    table.insert(Effects, {nil, "CloneEf", 0, 0})
    MagniDamage(RootPart, 30, 5, 10, 0, "Normal", RootPart, 0, 1, (math.random(10, 15)), nil, nil, false, "Temporal2", 10, 200)
    MagicCircle(BrickColor.new(NewCol2), cf(RootPart.Position), 300, 300, 300, -1, -1, -1, 0.05)
    for i = 0.523, 6.28, 0.523 do
      MagicBlock(BrickColor.new(NewCol2), cf(RootPart.Position) * euler(0, i, 0) * cf(0, 0, 30) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 15, 15, 15, -0.2, -0.2, -0.2, 0.01, 2)
    end
    for i = 0, 1, 0.1 do
      swait()
...
while 1 do
  ...
  stunanim = false
    ...
    do
      ...
      -- DECOMPILER ERROR at PC5416: LeaveBlock: unexpected jumping out DO_STMT
