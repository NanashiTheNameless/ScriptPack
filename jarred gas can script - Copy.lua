...
burn = {}
burning = {}
colr={"Neon orange","Black","White","Bright yellow","Lime green","Bright blue","Bright green","Really black","Royal purple","Magenta","Pink"}
col="Lime green"
...
function onKeyDown(key)
	...
	elseif key == "q" then
		...
		box = Part(1,2,1,'Lime green',0,true,false,workspace)
...
mpa= Part(1.25,1.5,.6,'Lime green',0,false,false,mo)
mwl= Weld(mpa,pl.Torso,0,0,.8,0,0,0,mo)
pa= Part(.6,1.5,.6,'Lime green',0,false,false,mo)
wl= Weld(pa,mpa,.61,0,0,0,0,0,mo)m=Mesh(pa,1,1,1,1)
pa= Part(.6,1.5,.6,'Lime green',0,false,false,mo)
wl= Weld(pa,mpa,-.61,0,0,0,0,0,mo)m=Mesh(pa,1,1,1,1)
pa= Part(.3,.3,.3,'Really black',0,false,false,mo)
wl= Weld(pa,mpa,-.4,.75,0,0,0,0,mo)m=Mesh(pa,1,1,1,1)
pa= Part(.2,.3,.2,'Really black',0,false,false,mo)
wl= Weld(pa,mpa,-.4,1,0,0,0,0,mo)m=Mesh(pa,1,1,1,1)
noz= Part(.2,.7,.2,'Really black',0,false,false,mo)
