...
--[[Hair]]--
local Hprt1=part(3,suit,0,0,BrickColor.new("Really black"),"Hair",vt(1.04,1.04,1.04))
Hmsh1=mesh("SpecialMesh",Hprt1,"FileMesh","http://www.roblox.com/asset/?id=62246019",vt(0,0,0),vt(1.01,1.01,1.01))
--Hmsh1.TextureId="http://www.roblox.com/asset/?id=101203430"
local Hwld1=weld(Hprt1,Hprt1,Head,euler(0,0,0)*cf(0.04,-0.3,-0.2))
 
--[[TORSO]]--
numb=0.525
for i=1,2 do
local Tprt1=part(3,suit,0,0,BrickColor.new("Really black"),"Torso Part1",vt(1,1,1))
...
numb2=-0.4
for i=1,9 do
local Tprt3=part(3,suit,0,0,BrickColor.new("Dark stone grey"),"Torso Part3",vt(1,1,1))
...
local Tprt10=part(3,suit,0,0,BrickColor.new("Navy blue"),"Torso Part10",vt(1,1,1))
Tmsh10=mesh("BlockMesh",Tprt10,"","",vt(0,0,0),vt(0.2,0.8,0.1))
local Twld10=weld(Tprt10,Tprt10,Tprt7,euler(0,0,0)*cf(0.2,0.2,0.01))
numb=0.3
for i=1,4 do
local Tprt11=part(3,suit,0,0,BrickColor.new("Really black"),"Torso Part11",vt(1,1,1))
...
local Tprt12=part(3,suit,0,0,BrickColor.new("Navy blue"),"Torso Part12",vt(1,1,1))
Tmsh12=mesh("BlockMesh",Tprt12,"","",vt(0,0,0),vt(0.2,0.8,0.1))
local Twld12=weld(Tprt12,Tprt12,Tprt5,euler(0,0,0)*cf(-0.2,0.2,0.01))
numb=0.3
for i=1,4 do
local Tprt13=part(3,suit,0,0,BrickColor.new("Really black"),"Torso Part13",vt(1,1,1))
