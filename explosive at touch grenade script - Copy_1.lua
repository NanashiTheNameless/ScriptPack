...
do --rayCast
    ...
    msh.MeshId = "http://www.roblox.com/asset/?id=10207236"
    msh.TextureId = "http://www.roblox.com/asset/?id=16190577"
    msh.Scale = Vector3.new(0.2, 0.2, 0.2)
    ...
    local bulletlastposition = bulletposition
        ...
        if (torso.Position - rayPart.Position).magnitude > 540 then
         ...
         break
            ...
            if hit then
                                        local damage = math.random(Dmg, Dmg+9999)
...
Gernade = Instance.new("Part", char)
Gernade.FormFactor = "Custom"
Gernade.Size = Vector3.new(1, 1, 1)
Gernade:breakJoints()
local wld = Instance.new("Weld", char)
wld.C1 = CFrame.new(0, -1.25, 0)
wld.C0 = CFrame.Angles(1.5, 0, 0)
wld.Part1 = ra
wld.Part0 = Gernade
local msh = Instance.new("SpecialMesh", Gernade)
msh.MeshId = "http://www.roblox.com/asset/?id=10207236"
msh.TextureId = "http://www.roblox.com/asset/?id=55852313"
msh.Scale = Vector3.new(0.2, 0.2, 0.2)
...
while wait() do
    angle = (angle % 100) + anglespeed/10
        ...
        if throwing then
            ...
            rayCast(Gernade, math.random(140, 150), 20, 28)
        throwing = false
        done = false
        end
    rm.C0 = clerp(rm.C0,rscf,speed)
