...
prop(handle, "Really black", Model2, 1, 2, 1) 
...
prop(handle2, "Mid stone grey", Model2, 1, 1, 1) 
local handle2m = Instance.new("CylinderMesh") 
meshp(handle2m, handle2, 1, 0.15, 1) 
local handle2w = Instance.new("Weld") 
weld(handle2w, handle2, handle2, handle, CFrame.new(0, 1, 0) * CFrame.Angles(7.8, 0, 0)) 
local handle3 = Instance.new("Part") 
prop(handle3, "Black", Model2, 1, 1, 1) 
local handle3m = Instance.new("BlockMesh") 
meshp(handle3m, handle3, 1.5, 0.15, 0.35) 
local handle3w = Instance.new("Weld") 
weld(handle3w, handle3, handle3, handle, CFrame.new(0, -1, 0) * CFrame.Angles(0, 0, 0)) 
local handle4 = Instance.new("Part") 
prop(handle4, "Mid stone grey", Model2, 1, 5, 1) 
local handle4m = Instance.new("BlockMesh") 
meshp(handle4m, handle4, 0.75, 1, 0.25) 
local handle4w = Instance.new("Weld") 
weld(handle4w, handle4, handle4, handle, CFrame.new(0, -3.5, 0) * CFrame.Angles(0, 0, 0)) 
