...
--[[
	for i = 1,20 do
		...
		b.Position = Vector3.new(game.workspace.koopa13.Torso.Position.x+math.random(-1,2),game.workspace.koopa13.Torso.Position.y+1,game.workspace.koopa13.Torso.Position.z+math.random(-1,2))
