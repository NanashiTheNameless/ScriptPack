		...
		local function makeLightning(Par, Start, End, Width, Length, RandomScale, ArcScale, Num1)
			...
			while Par.Parent do
				...
				if oldParts[IterNum] then
					...
					Trail.BrickColor = ((Num1 % 2 == 0) and BrickColor.new("Deep orange")) or BrickColor.new("Really black")
					...
					Trail.BrickColor = ((Num1 % 2 == 0) and BrickColor.new("Really black")) or BrickColor.new("Deep orange")
