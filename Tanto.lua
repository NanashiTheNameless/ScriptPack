...
blade = Part(Mo, false, false, 0, 0.1, "Hot pink", 0.2, 1.15, 0.3, true)
blade.Name = "Blade"
Instance.new("BlockMesh", blade).Scale = Vector3.new(0.1, 1, 0.8)
 
bladetip = Part(Mo, false, false, 0, 0.1, "Hot pink", 0.2, 0.3, 0.3, true)
bladetip.Name = "Tip"
...
function freeze(m)
    ...
    if (phit~=nil) then
        ...
        if (char:findFirstChild("fr_block")==nil) then
            ...
            pa.Name = "fr_block"
            pa.Transparency = 1
            pa.BrickColor = BrickColor.New("Hot pink")
