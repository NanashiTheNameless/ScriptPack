--[[
Vanguard script made by hacker33331916.
...
local prt7=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Part7",vt(1,1,1))
local prt8=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Part8",vt(1,1,1))
...
numb=0
for i=1,4 do
local prt9=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Part9",vt(1,1,1))
...
Lightning(LP,point1,5,1,"Royal purple",0.3,0.1)
end
...
MagicCircle(BrickColor.new("Royal purple"),CFrame.new(newpos),2,2,2,3,3,3)
MagicBlock(BrickColor.new("Royal purple"),CFrame.new(newpos),2,2,2,2,2,2)
end
until rangepos <= 0
end))
end
...
--ADmg(hum,hit)
        ...
        BreakEffect(BrickColor.new("Royal purple"),CFrame.new(newpos),0.5,math.random(5,20),0.5)
        end
...
Damagefuncbr=function(hit,Damage,Knockback)
        ...
        Damage=Damage
        for i=1,math.random(3,6) do
        BreakEffect(BrickColor.new("Royal purple"),hit.Parent.Torso.CFrame,0.5,math.random(5,20),0.5)
        end
        coroutine.resume(coroutine.create(function(Part) 
        for i=1,5 do
        wait()
        Part.CFrame=Head.CFrame*cf(0,0,-3)
        MagicBlock(BrickColor.new("Royal purple"),Part.CFrame*cf(0,0,0),1,1,1,1,1,1)
        end
...
for i=1,25 do
wait()
MagicCircle(BrickColor.new("Royal purple"),prt7.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),0.1,2,0.1,0.5,5,0.5)
end
for i=0,1,0.2 do
wait()
...
MagicCircle(BrickColor.new("Royal purple"),prt7.CFrame*cf(0,1,0),1,1,1,10,10,10)
MagicBlock(BrickColor.new("Royal purple"),prt7.CFrame*cf(0,1,0),1,1,1,5,5,5)
MagicBlock(BrickColor.new("Royal purple"),prt7.CFrame*cf(0,1,0),1,1,1,7,7,7)
...
for i=0,1,0.1 do
wait()
MagicBlock(BrickColor.new("Royal purple"),hitbox.CFrame*cf(math.random()+math.random(-1,0),math.random()+math.random(-2,1),math.random()+math.random(-1,0)),1,1,1,0.5,0.5,0.5)
...
for i=0,10 do
wait()
MagicBlock(BrickColor.new("Royal purple"),hitbox.CFrame,1,1,1,2,2,2)
end
...
MagicBlock(BrickColor.new("Royal purple"),BaseCF,0.5,0.5,0.5,2,2,2)
BlastEffect(BrickColor.new("Royal purple"),BaseCF,0.5,0.5,0.5,0.5,0.5,0.5)
numb=numb-3
wait(0.2)
end
end))
...
MagicCircle(BrickColor.new("Royal purple"),prt7.CFrame,1,1,1,2,2,2)
for i=1,10 do
wait(0.1)
MagicBlock(BrickColor.new("Royal purple"),prt7.CFrame*cf(math.random(-1,1),math.random(-1,1),math.random(-1,1)),0,0,0,0.5,0.5,0.5)
end
wait(0.5)
so("http://www.roblox.com/asset/?id=2974249",prt7,1,0.6) 
so("http://www.roblox.com/asset?id=1369158",prt7,1,2) 
shoottrail2(mouse,prt7)
MagicCircle(BrickColor.new("Royal purple"),prt7.CFrame,1,1,1,3,3,3)
attack=false
end
...
so("http://www.roblox.com/asset/?id=2101137",prt7,1,0.75) 
MagicCircle(BrickColor.new("Royal purple"),prt7.CFrame,1,1,1,2,2,2)
local ring=part(3,modelzorz,0,1,BrickColor.new("Royal purple"),"Ring",vt(1,1,1))
...
MagicBlock(BrickColor.new("Royal purple"),Part.CFrame*cf(0,1,0),0,0,0,0.5,0.5,0.5)
end
...
if attack == true then return end 
if key=="f" then
BreakEffect(BrickColor.new("Royal purple"),Torso.CFrame,0.5,math.random(5,20),0.5)
end
if Mode=="Sword" then
if key=="z" then
GroundBlast()
...
-- mediafire
--[[ 
Copyrighted (C) hacker33331916 2013
]]
