...
repeat Wait()until Game.Players.serun15 ~= nil;Player = Game.Players.serun15 Tool = script.Parent if not script.Parent:IsA("Tool")then Tool = Instance.new("Tool",Player.Backpack)script.Parent = Tool end
...
Trolling = true
local Taunts = {"uMaD bR0?","Trolololol","You seem quite mad.","do you think you can you kill serun15?"}
...
HealthGui.Name = "Serun15's HealthGui"
...
Txt.BackgroundTransparency = 1
Txt.Text = AmazingMode and ByteToStr({3096,3131,3138,3121,3052,3141,3131,3137,3052,3092,3121,3117,3134,3136,3066,3066,3066,3052,3080,3071},3020)or "Serun15"
Txt.TextScaled = true
Txt.Font = "SourceSansBold"
