...
RH = Torso["Right Hip"] 
DamageUpgraded = Player["Excidium Damage Upgrade"] 
attacktype = 1 
damage = 3 
oridamage = 3 
--player 
...
ExciHandle.BrickColor = Character.Torso.BrickColor
...
ExciPart2.BrickColor = BrickColor.new("Black") 
...
R_Conv1=ExciPart2.Touched:connect(function1)
ss(ExciHandle,0.8) 
for i = 0 , 1 , 0.1 do 
wait(0) 
...
attacking = true 
R_Conv1=ExciPart2.Touched:connect(function1)
R_Conv2=ExciBlade2.Touched:connect(function1)
R_Conv3=ExciBlade3.Touched:connect(function1)
R_Conv4=ExciBlade4.Touched:connect(function1)
R_Conv5=ExciBlade5.Touched:connect(function1)
ss(ExciHandle,0.8) 
for i = 0 , 1 , 0.1 do 
wait(0) 
...
R_Conv1=ExciPart2.Touched:connect(function2)
R_Conv2=ExciBlade2.Touched:connect(function2)
R_Conv3=ExciBlade3.Touched:connect(function2)
R_Conv4=ExciBlade4.Touched:connect(function2)
R_Conv5=ExciBlade5.Touched:connect(function2)
ss(ExciHandle,0.8) 
...
wait(0.5) 
R_Conv1=ExciPart2.Touched:connect(function3)
R_Conv2=ExciBlade2.Touched:connect(function3)
R_Conv3=ExciBlade3.Touched:connect(function3)
R_Conv4=ExciBlade4.Touched:connect(function3)
R_Conv5=ExciBlade5.Touched:connect(function3)
ss(ExciPart2,0.8) 
for i = 0 ,1 , 0.2 do 
wait(0)  
...
if DamageUpgraded.Value == false then 
function function1(hit) Damagefunc1(hit,20,20) end
function function2(hit) Damagefunc2(hit,1,20) end
function function3(hit) TAUNTKILLWIN(hit) end
else 
function function1(hit) Damagefunc1(hit,40,30) end
function function2(hit) Damagefunc2(hit,5,30) end
function function3(hit) TAUNTKILLWIN(hit) end
end 
...
game:service'Lighting'["Lolsound"].Value=SlashSoundeh1
...
game:service'Lighting'["Lolsound"].Value=SlashSoundeh2
...
game:service'Lighting'["Lolsound"].Value=SlashSoundeh3
