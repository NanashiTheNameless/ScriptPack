...
NewCol2 = Color3.new(0, 1, 102/255)
NewCol3 = BrickColor.new("Black").Color
NewCol3aa = BrickColor.new("Black").Color
NewCol4 = Color3.new(0, 1, 102/255)
NewCol5 = BrickColor.new("Black").Color
NewCol6 = BrickColor.new("Black").Color
...
parti1 = particle(dprt2, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "http://www.roblox.com/asset/?id=197195522", transseq, 0, vt(0, -1, 0), 0, false, 0, "Back", true, nr(7, 7), 80, nr(-360, 360), nr(-30, 30), nr(5), 30)
...
parti2 = particle(dprt2, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "http://www.roblox.com/asset/?id=269030572", transseq, 0, vt(0, -35, 0), 0, false, 0, "Back", true, nr(1, 1.5), 80, nr(-360, 360), nr(-180, 180), nr(20), 25)
sizeseq = ns({nsk(0, 1), nsk(0.096, 2.5), nsk(0.3, 10), nsk(1, 10)})
transseq = ns({nsk(0, 0), nsk(0.05, 0.5), nsk(0.1, 1), nsk(1, 1)})
parti3 = particle(dprt2, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "http://www.roblox.com/asset/?id=197195522", transseq, 1, vt(0, -0.5, 0), 0, false, 0, "Back", false, nr(7, 7), 80, nr(-360, 360), nr(-30, 30), nr(0), 30)
...
mistparti1 = particle(sref, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "http://www.roblox.com/asset/?id=197195522", transseq, 0, vt(0, -0.25, 0), 0, false, 0, "Top", true, nr(3, 4), 10, nr(-360, 360), nr(-35, 35), nr(4, 5), -90)
sizeseq = ns({nsk(0, 3.61), nsk(0.162, 5.85), nsk(1, 10)})
transseq = ns({nsk(0, 1), nsk(0.498, 0.5), nsk(0.913, 0.55), nsk(1, 1)})
mistparti2 = particle(sref, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "rbxasset://textures/particles/smoke_main.dds", transseq, 0, vt(0, -0.5, 0), 0, false, 0, "Top", true, nr(2, 3), 15, nr(-360, 360), nr(-55, 55), nr(5, 6), -90)
...
local icicleparti1 = particle(nil, Color3.new(0, 1, 102/255),Color3.new(0, 1, 102/255), 0.2, sizeseq, "http://www.roblox.com/asset/?id=329766994", transseq, 0, vt(0, -0.5, 0), 0, false, 0, "Bottom", true, nr(7, 10), 15, nr(-360, 360), nr(-30, 30), nr(3), 20)
sizeseq = ns({nsk(0, 0), nsk(0.025, 0.383), nsk(0.192, 2.51), nsk(1, 2.02)})
transseq = ns({nsk(0, 0.8), nsk(0.3, 1), nsk(1, 1)})
local icicleparti2 = particle(nil, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.3, sizeseq, "http://www.roblox.com/asset/?id=241594419", transseq, 0, vt(0, -0.5, 0), 0, false, 0, "Bottom", true, nr(7, 10), 80, nr(-360, 360), nr(-30, 30), nr(3), 20)
            ...
            if Mode == "Monarch" then
              ...
              for i = 0, 1, 0.1 do
                ...
                if i < 0.8 then
                  ...
                  freeze = false
                  effect2("Lime green", 0, RightArm.CFrame * cf(0, -10, 0.5), oldCF, nil, 1, 2)
                  effect2("Lime green", 0, RightArm.CFrame * cf(0, -10, -0.5), oldCF2, nil, 1, 2)
    ...
    if Mode == "Drakes" then
      ...
      for i = 0, 1, 0.15 do
        ...
        if RecentEnemy.Value == nil then
          ...
          effect2("Lime green", 0, drakepart.CFrame, oldCF, nil, 3, 1)
          ...
          if drakesplode == false then
            ...
            drakes = drakes - 1
            thdrake.Parent = nil
            local ref = part(3, effects, 0, 1, BrickColor.new("Lime green"), "Reference", vt())
            ref.Anchored = true
        ...
        if Mode == "Monarch" then
          ...
          for i = 0, 1, 0.1 do
            ...
            if i < 0.8 then
              ...
              breakfreeze = false
              effect2("Lime green", 0, RightArm.CFrame * cf(0.2, -3, 0.5), oldCF, nil, 1, 2)
              effect2("Lime green", 0, RightArm.CFrame * cf(0.2, -3, -0.5), oldCF2, nil, 1, 2)
...
do3 = function()
  ...
  if attack == true then
    ...
    for i = #Claw / 2, 1, -1 do
      ...
      local refaa = part(3, effects, 0, 1, BrickColor.new("Lime green"), "Reference", vt())
      refaa.Anchored = true
...
do4 = function()
  ...
  if drakes > 0 then
    ...
    local reft = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt())
    ...
    transseq = ns({nsk(0, 0.8), nsk(0.3, 1), nsk(1, 1)})
    local rara = particle(reft, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.3, sizeseq, "http://www.roblox.com/asset/?id=241594419", transseq, 0, vt(0, 0, 0), 0, true, 0, "Bottom", true, nr(7, 10), 80, nr(-360, 360), nr(-30, 30), nr(0), 20)
    sizeseq = ns({nsk(0, 0), nsk(0.054, 0.3), nsk(0.451, 0.2), nsk(1, 0.12)})
    transseq = ns({nsk(0, 1), nsk(0.03, 1), nsk(0.1, 0.137), nsk(0.232, 1), nsk(1, 1)})
    local rara2 = particle(reft, Color3.new(0, 1, 102/255), Color3.new(0, 1, 102/255), 0.4, sizeseq, "http://www.roblox.com/asset/?id=269030572", transseq, 0, vt(0, -35, 0), 0, false, 0, "Back", true, nr(1, 1.5), 80, nr(-360, 360), nr(-180, 180), nr(40), 180)
    ...
    for i = 0, 1, 0.01 do
      ...
      MagicHead(BrickColor.new("Black"), CFrame.new((reft.Position + pos) / 2, pos) * angles(1.57, 0, 0), 15, mag * 5, 15, 3, 1, 3, 0.1)
...
Humanoid.JumpPower = Old_J
  ...
  if key == "q" and drakes < 6 and Mode ~= "Monarch" then
    IceDrake()
  end
end 
            ...
            if Thing ~= nil then
              ...
              if Thing[2] == "ShootIce" then
                ...
                if hit ~= nil or Thing[3] <= 0 then
                  Thing[3] = 0
                  ref = part(3, effects, 0, 1, BrickColor.new("Lime green"), "Reference", vt())
                  ref.Anchored = true
                  ref.CFrame = cf(pos)
                  game:GetService("Debris"):AddItem(ref, 1)
                  ref2 = part(3, effects, 0, 1, BrickColor.new("Lime green"), "Reference", vt(5, 5, 5))
                  ref2.Anchored = true
                  ref2.CFrame = cf(pos)
