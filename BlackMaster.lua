-- Player declarations
local player = game.Players.kash5
...
local frames = {}
local parts = {}
local Taunts = {"Weak faggot", "Heh.", "You have no hope. Bitch", "Grow up Gay queer", "DIE!", "EARTH, SHOOT!", "GOOD LUCK STAYING ALIVE!", "You pitiful being."}
