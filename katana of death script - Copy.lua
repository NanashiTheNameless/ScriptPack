...
local themeColor = BrickColor.new ("Light stone grey")
...
local metalColor = BrickColor.new("Dark stone grey")

local metalRef = .5

local bladeColor = BrickColor.new("Medium stone grey")
