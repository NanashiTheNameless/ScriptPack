...
local admins = {'King_N3xul',''} -- names here of people who have access to your commands! (Your name doesn't need to be in here.)
...
_G.Rc7Notification("Done","Rc7 Admin by Caleb",5)
wait(5)
