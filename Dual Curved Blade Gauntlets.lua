...
coroutine.resume(coroutine.create(function() 
local sword=part(1,workspace,"SmoothPlastic",0,1,BrickColor.new("Bright violet"),"Sword",vt(2,2,2))
sword.Anchored=true
...
--EVENMOARMAGIX(sword,4,4,4,0,0,0,0,0,0,BrickColor.new("Bright violet")) 
