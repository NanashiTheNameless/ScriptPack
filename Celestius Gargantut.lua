-- Gaster <3
-- Made By LockedMetaTables. Good Edit.
...
function expandDong()
        ...
        Orbi.BrickColor = BrickColor.new('Deep orange')
...
cylinderOpen(Torso.CFrame,"Deep orange","Really black")
expandDong2()
expandDong()
----------------------------------------------------
z = Instance.new("Sound", Character)
z.SoundId = "rbxassetid://223854962"--Sao Crossing: 155183751 -- SAN HOLO DOnkeykong: 246056418 -- "Innocence" - Sword Art Online OP 2: 142357253 -- OnePunch Hero: 339250412 (Fav) -- Sethbling: 170902050
z.Looped = true
z.Pitch = .9
z.Volume = .5
wait(.1)
...
Energycover = makeframe(Energybar, 0, UDim2.new(0, 0, 0, 0), UDim2.new(1, 0, 1, 0), BrickColor.new("Deep orange").Color)
...
healthcover = makeframe(healthbar, 0, UDim2.new(0, 0, 0, 0), UDim2.new(1, 0, 1, 0), BrickColor.new("Deep orange").Color)
...
Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Deep orange", "Handle", Vector3.new(2.20000005, 0.200000003, 2.20000005))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Deep orange", "Part", Vector3.new(0.480000019, 2.200000003, 2.720000625))
...
Layer3Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 1, "Deep orange", "Layer3Handle", Vector3.new(0.720000029, 0.720000029, 0.200000003))
...
mesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.600000024, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0.19999998807907, "Deep orange", "Part", Vector3.new(0.480000019, 0.480000019, 0.200000003))
...
local Lite = Create("PointLight"){
	Parent = Handle,
	Color = BrickColor.new("Deep orange").Color,
	Shadows = true,
	Range = 20,
	Brightness = 0.5,
}
...
CylinderEffect(BrickColor.new("Deep orange"),CFrame.new((MainPos+pos)/2,pos)*angles(1.57,0,0),3,mag*5,3,1.5,0,1.5,0.1)
MainPos=MainPos+(MouseLook.lookVector*10)
num=num-1
if hit~=nil then
num=0
local ref=part(3,workspace,"Neon",0,1,BrickColor.new("Deep orange"),"Reference",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
...
for i = 1,8 do
ShootCannon(Handle)
BlockEffect(BrickColor.new("Deep orange"),Handle.CFrame,.5,.5,.5,.9,.9,.9,0.05)
...
BlastEffect(BrickColor.new("Deep orange"), Handle.CFrame, .1, .1, .1, 1, 1, 1)
for i = 1,5 do
BlockEffect(BrickColor.new("Deep orange"),Handle.CFrame,1,1,1,5,5,5,0.05)
end
attack = false
end
...
BlockEffect(BrickColor.new("Deep orange"),wave.CFrame,1,1,1,3,3,3,0.05)
local PE1 = Create("ParticleEmitter"){
Parent = wave,
Color = ColorSequence.new(BrickColor.new("Deep orange").Color),
Transparency = NumberSequence.new(.5),
...
for i = 0, 1, 0.1 do
	swait()
	BlockEffect(BrickColor.new("Deep orange"),Handle.CFrame,.1,.1,.1,1,1,1,0.05)
	RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), .3)
	Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(math.rad(-10), math.rad(0), math.rad(0)), .3)
...
local efprt=part(3,Parent,"Neon",0,0.5,BrickColor.new("Deep orange"),"Effect",vt(5,5,5))
efprt.Anchored=true
...
BlastEffect(BrickColor.new("Deep orange"),cf(pos),5,5,5,5,3,5,0.07)
MagicCircle(BrickColor.new("Deep orange"),cf(pos),5,5,5,5,3,5,0.04)
BlastEffect(BrickColor.new("Deep orange"),cf(pos),5,5,5,5,3,5,0.07)
...
MagicCylinder(BrickColor.new("Deep orange"),Part.CFrame,1,mag*5,1,5,5,5,0.25)
Part.Parent=nil
...
for i = 0,1,0.01 do
swait()
BlockEffect(BrickColor.new("Deep orange"),Handle.CFrame,0,0,0,.2,.2,.2,0.25)

local c = game.Players.LocalPlayer.Character
local radius = 10
local pos = Handle.CFrame
local clrz = {'Really black','Deep orange'};
for HAAA = 1, 10 do
for i = 1,1 do
...
wait(.1)
BlastEffect(BrickColor.new("Deep orange"),Handle.CFrame,0,0,0,.2,.2,.2,0.01)
RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), .5)
Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(math.rad(-5), math.rad(0), math.rad(0)), .5)
