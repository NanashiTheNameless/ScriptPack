...
Decal1.Texture = "http://www.roblox.com/asset/?id=30208174"
Decal1.Face = "Front"
local Decal2 = Instance.new("Decal",FlagLogo)
Decal2.Texture = "http://www.roblox.com/asset/?id=30208174"
Decal2.Face = "Back"
Humanoid.WalkSpeed = 25

function ALLAHUAKBAR()
attack = true
local speak = {"ALLAHU SNAKBAR"}
...
bar = Instance.new("Part",workspace)
bard = Instance.new("Decal",bar)
attack = false
--bard.Facing=Top
bar.BrickColor = BrickColor.new("Reddish brown")
bard.Texture="http://roblox.com/asset/?id=189913925"
wait(30)
bar:Destroy()
--[[for i = 1,20 do
