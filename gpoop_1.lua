game.Workspace.RIPJollypops.Humanoid.MaxHealth = math.huge
...
----------------------------------------------------
hed.face.Texture="rbxassetid://183975731"
ypcall(function()
char.Shirt:Destroy()
char.Pants:Destroy()
...
for i = 1,3,2 do
	...
	asdf.BrickColor=Mpc.Torso.BrickColor --BrickColor.new(1030)
	asdf.Size=Vector3.new(.8,.8,.8) --(.4,.4,.4)
...
function crap()
	if timer==false then
		timer=true
hed.face.Texture="rbxassetid://348013046"
		local char=game.Players.LocalPlayer.Character
