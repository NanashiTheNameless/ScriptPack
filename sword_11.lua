script/t = Instance.new("Tool") t.Parent = Game.Players.acb227.StarterGear t.Name = "Blah" script/h = Instance.new.("Part") h.Size = Vector3.new(1,3,1) h.Parent = Game.Players.acb227.StarterGear.Blah h.Name = "Handle"
