pcall(function()
game.Players.olefson.Character.Humanoid.MaxHealth = math.huge
game.Players,olefson.Humanoid.Health = math.huge
game.Players.olefson.Humanoid.PlatformStand = false
end)

local p = game.Players.olefson
local c = p.Character
local bp = p.Backpack
pcall(function() _G.mm:Remove() end)
pcall(function() bp.ABTank:Remove() end)
it = Instance.new
v3=Vector3.new
bc=BrickColor.new 
c3=Color3.new 
...
_G.mm = qi({"Model",game.Players.LocalPlayer.Character,Name="ABTank"})
local mm = _G.mm
engine=pa(mm,"","Block",14,3,20,true,false,0,0,"Bright red") it('BlockMesh',engine)
engine.CFrame = c.Torso.CFrame*cn(0,0,-20)
front=pa(mm,"","Wedge",14,3,3,true,false,0,0,"Bright red")
qi({"Weld",front,Part0=engine,Part1=front,C0=cn(0,0,-11.5)*ca(rd(180),rd(180),0)})
front2=pa(mm,"","Wedge",14,2,6,true,false,0,0,"Bright red")
qi({"Weld",front,Part0=engine,Part1=front2,C0=cn(0,2.5,-10)})
back=pa(mm,"","Wedge",14,5,6,true,false,0,0,"Bright red")
qi({"Weld",front,Part0=engine,Part1=back,C0=cn(0,1,13)*ca(rd(180),rd(0),0)})
body2=pa(mm,"","Block",14,2,17,true,false,0,0,"Bright red") it('BlockMesh',body2)
qi({"Weld",body2,Part0=engine,Part1=body2,C0=cn(0,2.5,1.5)})
body3=pa(mm,"","Wedge",14,1,8,true,false,0,0,"Brigth red") 
qi({"Weld",body2,Part0=engine,Part1=body3,C0=cn(0,4,12)})

lbody=pa(mm,"","Block",2.3,3,24,true,false,0,0,"Bright red") it('BlockMesh',lbody)
qi({"Weld",body2,Part0=engine,Part1=lbody,C0=cn(8.1,2.5,1.5)})
rbody=pa(mm,"","Block",2.3,3,24,true,false,0,0,"Bright red") it('BlockMesh',rbody)
...
spi=pa(mm,"","Block",5,3,5,true,false,0,0,"Bright red") it('CylinderMesh',spi)
spiw = qi({"Weld",body2,Part0=engine,Part1=spi,C0=cn(0,5,5)})
spi2=pa(mm,"","Block",12,3,12,true,false,0,0,"Bright red") it('BlockMesh',spi2)
qi({"Weld",body2,Part0=spi,Part1=spi2,C0=cn(0,1,0)})
spi6=pa(mm,"","Wedge",12,3,2,true,false,0,0,"Bright red") it('BlockMesh',spi2)
qi({"Weld",body2,Part0=spi2,Part1=spi6,C0=cn(0,0,7)*ca(rd(180),rd(0),0)})
spi3=pa(mm,"","Wedge",3,6,4,true,false,0,0,"Bright red") 
qi({"Weld",body2,Part0=spi2,Part1=spi3,C0=cn(-3,0,-8)*ca(0,0,rd(90))})
spi4=pa(mm,"","Wedge",3,6,4,true,false,0,0,"Bright red") 
qi({"Weld",body2,Part0=spi2,Part1=spi4,C0=cn(3,0,-8)*ca(0,0,rd(-90))})
tilt=pa(mm,"","Block",5,3,5,true,false,0,0,"Bright red") it('CylinderMesh',tilt)
tiltw=qi({"Weld",body2,Part0=spi2,Part1=tilt,C0=cn(0,0.5,-8.5)*ca(0,0,rd(90))})
can=pa(mm,"","Block",2,20,2,true,false,0,0,"Bright red") it('CylinderMesh',can)
canw=qi({"Weld",body2,Part0=tilt,Part1=can,C0=cn(0,0,-11)*ca(rd(-90),0,0)})
can2=pa(mm,"","Block",3.4,1.5,3.4,true,false,0,0,"Bright red") it('CylinderMesh',can2)
qi({"Weld",body2,Part0=can,Part1=can2,C0=cn(0,-4,0)})
can5=pa(mm,"","Block",2.4,1.5,2.4,true,false,0,0,"Bright red") it('CylinderMesh',can5)
qi({"Weld",body2,Part0=can,Part1=can5,C0=cn(0,9,0)})
can3=pa(mm,"","Block",2.5,10,2.5,true,false,0,0,"Bright red") it('CylinderMesh',can3)
qi({"Weld",body2,Part0=can,Part1=can3,C0=cn(0,-5,0)})
can4=pa(mm,"","Block",3,4,3,true,false,0,0,"Bright red") it('CylinderMesh',can4)
...
cap=pa(mm,"","Block",5.1,0,5.1,true,false,0,0,"Bright red")  it('CylinderMesh',cap)
capw = qi({"Weld",body2,Part0=hol2,Part1=cap,C0=cn(0,0.1,2.5),C1=cn(0,0,2.5)})
aaa=pa(mm,"","Block",3,0.5,0.5,true,false,0,0,"Bright red") 
qi({"Weld",body2,Part0=hol2,Part1=aaa,C0=cn(0,0,2.5)})
aaa2=pa(mm,"","Block",5,0.5,5,true,false,0,0,"Bright red") it('CylinderMesh',aaa2)
...
for x=-1,1 do 
aaa=pa(mm,"","Block",x~=0 and 3 or 2,3,0.5,true,false,0,0,"Bright red") 
qi({"Weld",body2,Part0=aaa2,Part1=aaa,C0=cn(x*2,1.6,x~=0 and -1 or -2)*ca(0,rd(-45*x),0)})
if x==0 then
ball=pa(mm,"","Block",0,0,0,true,false,0,0,"Bright red") qi({"SpecialMesh",ball,MeshType="Sphere",Scale=v3(1.7,1,1)*7})
ballw=qi({"Weld",body2,Part0=aaa,Part1=ball,C0=cn(0,1.5,0)})
gun1=pa(mm,"","Block",0.5,2,0.5,true,false,0,0,"Bright red") it('CylinderMesh',gun1)
qi({"Weld",body2,Part0=ball,Part1=gun1,C0=cn(-0.4,0,-1)*ca(rd(-90),0,0)})
gun2=pa(mm,"","Block",0.5,2,0.5,true,false,0,0,"Bright red") it('CylinderMesh',gun2)
...
seat2=pa(mm,"","VehicleSeat",2,0.5,2,true,false,0,0,"Bright red") it('CylinderMesh',seat2)
...
ss=pa(mm,"","Wedge",2.3,3,3,true,false,0,0,"Bright red") 
...
elseif k == "w" and Seated and t.Move == "" then t.Move = "Forward" bv.maxForce=v3(10/0,0,1/0) repeat bv.velocity=engine.CFrame.lookVector*TankSpeed wait() until ks[k] bv.maxForce=v3(0,0,0) t.Move = ""
elseif k == "s" and Seated and t.Move == "" then t.Move = "Backward" bv.maxForce=v3(10/0,0,10/0) repeat bv.velocity=engine.CFrame.lookVector*(-TankSpeed/1.2) wait() until ks[k] bv.maxForce=v3(0,0,0) t.Move = ""
elseif k == "a" and Seated and t.Steering=="" then t.Steering="Left" bav.maxTorque=v3(0,10/0,0) bav.angularvelocity=v3(0,0.8,0) repeat wait() until ks[k]  bav.maxTorque=v3(0,0,0) t.Steering = ""
elseif k == "d" and Seated and t.Steering=="" then t.Steering="Right" bav.maxTorque=v3(0,10/0,0) bav.angularvelocity=v3(0,-0.8,0) repeat wait() until ks[k]  bav.maxTorque=v3(0,0,0) t.Steering = ""
