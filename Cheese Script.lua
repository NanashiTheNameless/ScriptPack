local name = "Cheese" -- This Is The Name Of Your Cheese
local master = "Chris10002"-- Put Your Name Here
local admins = {"Chris10002"} -- These Are The People Who Can Use Your Cheese
...
PartChatG("Loaded "..master.."'s "..name.." By LuaModelMaker")
function findp(name) 
...
name = string.sub(string.lower(msg), 6) 
PartChatG("My Name Is: "..name)
...
PartChatB(name.." Made by LuaModelMaker, Is a Fun Tool Command While Being Silly and Interacive")
wait(5)
...
PartChatG("...")
elseif string.sub(string.lower(msg), 1, 15) == "what chris does" then
PartChatG("Chris10002 trades scripts")
...
elseif string.sub(string.lower(msg), 1, 21) == "who is luamodelmaker?" then
