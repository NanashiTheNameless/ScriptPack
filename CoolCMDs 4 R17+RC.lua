-- CoolCMDs 4 R17+Release Candidate by DarkShadow6.
...
_C.Data.Version = "4 R17+Release Candidate"
...
_C.Functions.CreateGroup("example group", 1, "Example Group Full Name", "This is the group help/description.")
...
_C.Functions.CreateCommand("remove", 1, function(Msg, MsgSplit, OrigMsg, OrigMsgSplit, Speaker, Self, TriggerMsg) -- Free command!
	loadstring([==[_G.CoolCMDs[_C.Init.InstanceNum]:Remove()]==])()
