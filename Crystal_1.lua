...
local CrystalNumb=0
local Crystals={}
CrystalColor=BrickColor.new("Bright red")
crystal = BrickColor.new("Bright red")
--player
player = nil
--save shoulders
RSH, LSH = nil, nil
...
local prt1=part(3,modelzorz,0,0,BrickColor.new("Bright red"),"Part1",vt(1,1,1))
...
local prt4=part(3,modelzorz,0,0,BrickColor.new("Bright red"),"Part4",vt(1,1,1))
...
local prt=part(3,workspace,1,0,BrickColor.new("Bright red"),"Part",vt(1,1,1))
prt.Anchored=true
...
--   hs(hit,1.2)
 ...
 Damage=Damage+math.random(9999,999999)
--  h:TakeDamage(Damage)
 blocked=false
...
--[[  if math.random(0,99)+math.random()<=7.8 then
 ...
 Damage=Damage+math.random(99999,999999)
...
print(CrystalNumb)
local base=part(3,modelzorz,0,1,BrickColor.new("Bright red"),"Part1",vt(1,1,1))
base.Anchored=true
...
attackdebounce=false
Damagefunc1(head1,99999,999999)
end
end
end
end
