Player = game.Players.DEADDEVIL1919
...
--[[ * StickA * ]]--
m = Instance.new("Fire")
m.Parent = game.Workspace.DEADDEVIL1919.Torso
m.Heat = 0
m.Size = 4
m.Color = Color3.new(0,0,1)
StickA = Instance.new("Part")
StickA.formFactor = "Custom"
StickA.Locked = true
StickA.CanCollide = false
StickA.BrickColor = BrickColor.new("Really blue")
...
MeshA.MeshId = "http://www.roblox.com/asset/?id=18471202"
...
clone = s:clone()
clone.Mesh.Scale = Vector3.new(0.3,0.3,1.1)
clone.BrickColor = BrickColor.Bright blue()
clone.Transparency = 0.8
clone.Parent = s.Parent
wait(0.5)
end
