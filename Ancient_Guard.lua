...
local cooldownsadd = {}
local cooldownadd1 = 0.13
table.insert(cooldownsadd, cooldownadd1)
local cooldownadd2 = 0.32
...
local sprt11 = part(3, modelzorz, 0.8, 0.2, BrickColor.new("Light blue"), "Shield Part11", vt())
local sprt12 = part(3, modelzorz, 0.8, 0.2, BrickColor.new("Light blue"), "Shield Part12", vt())
local sprt13 = part(3, modelzorz, 0.8, 0.2, BrickColor.new("Light blue"), "Shield Part13", vt())
local sprt14 = part(3, modelzorz, 0.8, 0.2, BrickColor.new("Light blue"), "Shield Part14", vt())
...
local smsh11 = mesh("SpecialMesh", sprt11, "Wedge", "nil", vt(0, 0, 0), vt(0.5, 10, 14))
local smsh12 = mesh("SpecialMesh", sprt12, "Wedge", "nil", vt(0, 0, 0), vt(0.5, 10, 14))
local smsh13 = mesh("SpecialMesh", sprt13, "Wedge", "nil", vt(0, 0, 0), vt(0.5, 10, 9))
local smsh14 = mesh("SpecialMesh", sprt14, "Wedge", "nil", vt(0, 0, 0), vt(0.5, 10, 9))
...
local swld11 = weld(prt1, sprt11, sprt1, euler(-1.57, 0, 0) * cf(0.1, -1.2, -1))
local swld12 = weld(prt1, sprt12, sprt1, euler(-1.57, 3.14, 0) * cf(0.1, -1.2, 1))
local swld13 = weld(prt1, sprt13, sprt1, euler(-1.57, 0, 3.14) * cf(0.1, 1.1, -1))
local swld14 = weld(prt1, sprt14, sprt1, euler(-1.57, 3.14, 3.14) * cf(0.1, 1.1, 1))
for i = 0, 180, 180 do
  for x = -20, 20, 40 do
    local lol = i - 90
...
Bin = script.Parent
if Bin.Name == "Frigost: Frost Guard" then
  Bin.Name = "Glaciem"
end
  ...
  for i = 0, 1, 0.1 do
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        ...
        -- DECOMPILER ERROR at PC454: LeaveBlock: unexpected jumping out IF_THEN_STMT

        -- DECOMPILER ERROR at PC454: LeaveBlock: unexpected jumping out IF_STMT
...
attacktwo = function()
  ...
  for i = 0, 1, 0.15 do
    ...
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 0.8) * euler(0, 0, 0), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = sprt1.CFrame * cf(0, 0.3, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 3, 6, 7, math.random(10, 20), "Knockdown2", false, nil, nil, nil, math.random(10, 15), RootPart, 0.5, 1)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.5) * euler(0.1, 0, 0), 0.4)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.5), 0.4)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.6, 0, 0.6) * euler(0, 0, 0), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-0.5, 0.5, -0.5) * euler(1.4, 0, 0.8) * euler(0, -0.5, 0), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        ...
        -- DECOMPILER ERROR at PC456: LeaveBlock: unexpected jumping out IF_THEN_STMT

        -- DECOMPILER ERROR at PC456: LeaveBlock: unexpected jumping out IF_STMT
...
attackthree = function()
  ...
  for i = 0, 1, 0.15 do
    ...
    hitboxCF = prtt.CFrame * cf(0, -1.2, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 4, 4, 5, math.random(5, 10), "Normal", false, nil, nil, nil, math.random(2, 8), RootPart, 0.5, 1)
...
attackfour = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = sprt1.CFrame * cf(0, 0.3, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 3, 4, 6, math.random(20, 30), "Knockdown2", false, nil, nil, nil, math.random(5, 15), RootPart, 0.2, 1)
    wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
  ...
  if shhit == true then
    for i = 0, 1, 0.2 do
      ...
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.2, 0, 0.8), 0.4)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      LW.C0 = clerp(LW.C0, cf(-0.5, 0.5, -0.7) * euler(1.3, 0, 1.4) * euler(0, -0.2, 0), 0.4)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, 0.8, 0) * euler(-0.1, 0, 0), 0.4)
      LH.C0 = clerp(LH.C0, cf(-0.8, -1, 0.4) * euler(0, -1.57, 0) * euler(0, 0.8, 0) * euler(-0.1, 0, 0), 0.4)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
            break
          end
          -- DECOMPILER ERROR at PC633: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC633: LeaveBlock: unexpected jumping out IF_STMT
    ...
    for i = 0, 1, 0.1 do
      swait()
      MagniDamage(hitbox, 3, 7, 8, math.random(20, 30), "Knockdown2", false, nil, nil, nil, 15, RootPart, 1, 1)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.5) * euler(0, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0.5), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.6, 0, 0.4), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.6, 0, -1) * euler(0, 0, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          ...
          -- DECOMPILER ERROR at PC866: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC866: LeaveBlock: unexpected jumping out IF_STMT
...
Guard = function()
  ...
  if manualguardend == false and blocknum > 1 then
    ...
    MagniDamage(sprt1, 15, 10, 15, math.random(20, 40), "Knockdown2", false, "Movement", 0.2, 400, math.random(10, 20), RootPart, 0, 1)
    for i = 0, 1, 0.1 do
      swait()
      for i = 1, 2 do
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 25 then
    ...
    for i = 0, 1, 0.1 do
      ...
      RW.C0 = clerp(RW.C0, cf(1, 0.3, -0.5) * euler(0.7, 0, -0.6), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1, 0.3, -0.5) * euler(0.7, 0, 0.6), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(1, -0.8, -0.4) * euler(0, 1.57, 0) * euler(0, 0, -1), 0.3)
    ...
    if icehitfloor ~= nil then
      ...
      MagniDamage(ref, 15, 10, 15, 0, "Normal", true, "Shatter", 0.2, 300, math.random(10, 20), RootPart, 0.5, 1)
      MagicIcicle(BrickColor.new("Cyan"), cf(iceposfloor) * cf(0, -12, 0), 20, 20, 20, 0.02)
    ...
    for i = 0, 1, 0.05 do
      ...
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(-0.1, 0, 0), 0.2)
      RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(2, 0, -0.2), 0.2)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      LW.C0 = clerp(LW.C0, cf(-1.3, 0.5, -0.2) * euler(2, 0, 0.2), 0.2)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 15 then
    ...
    for i = 0, 1, 0.1 do
      ...
      hitboxCF = prtt.CFrame * cf(0, -1.2, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 4, 10, 15, math.random(5, 10), "Shatter", true, "Shatter", 0.2, 200, math.random(10, 20), RootPart, 0.5, 1)
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 30 then
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      if StaggerHit.Value ~= true then
        guard = true
        glacguard = true
        table.insert(Effects, {Model, "Blocking", 300})
        so("199146181", sprt1, 1, 1)
        MagniDamage(Torso, 20, 6, 8, 0, "Normal", true, "Movement", 0.25, 100, math.random(5, 10), Torso, 0, 1)
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    MagniDamage(Torso, 20, 1, 3, math.random(-40, -20), "Knockdown2", true, "Movement", 0.3, 150, math.random(5, 7), Torso, 0, 1)
    for i = 0, 1, 0.1 do
      swait()
    ...
    do
      for i = 0, 50 do
        swait()
        if i % 10 == 0 then
          MagniDamage(Torso, 20, 1, 3, 0, "Normal", true, nil, nil, nil, 0, Torso, 0, 1)
        end
        MagicBlock(BrickColor.new("Cyan"), cf(Torso.Position) * cf(math.random(-1500, 1500) / 100, -3, math.random(-1500, 1500) / 100) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 1, 1, 1, 0.1, 2)
        for i = 1, 1 do
      ...
      do
        ...
        do
          if StunT.Value >= Stun.Value then
            ...
            MagniDamage(Torso, 25, 15, 20, math.random(40, 60), "Knockdown2", false, "Movement", 0.15, 9999, 80, Torso, 0, 1)
...
MagicIcicle = function(brickcolor, cframe, x1, y1, z1, delay)
  local prt = part(3, workspace, 0.5, 0, brickcolor, "Effect", vt(15, 30, 15))
  prt.Anchored = true
  prt.CFrame = cframe
  prt.CanCollide = true
  conderp = prt.Touched:connect(function(hit)
    Damagefunc(hit, 4, 8, math.random(20, 30), "Shatter2", prt, 0.2, 1, 0, nil, false, true, "Shatter", 0.1, 300, "Shatter")
  end)
  msh = mesh("SpecialMesh", prt, "FileMesh", "1778999", vt(0, 0, 0), vt(x1, y1, z1))
  game:GetService("Debris"):AddItem(prt, 30)
  for i = 1, 5 do
  ...
  for i = 1, 15 do
    ...
    freezepart.CFrame = cframe * cf(math.random(-600, 600) / 100, 12, math.random(-600, 600) / 100) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50))
    game:GetService("Debris"):AddItem(freezepart, 10)
  end
  table.insert(Effects, {prt, "Ice", delay, msh, 1, 0.2, 400})
end
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, incstun, stagger, staghit, ranged, DecreaseState, DecreaseAmount, Duration, Sound)
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
    ...
    if Sound == "Shatter" or Sound == "Shatter2" then
...
equipped = false
key = function(key)
  if key == "e" and glacguard == false and guard == true then
    guard = false
    manualguardend = true
  end
  if attack == true then
  ...
  if key == "e" and glacguard == false and guard == false and blocknum == 100 then
    Guard()
  end
  if key == "z" then
    do1()
