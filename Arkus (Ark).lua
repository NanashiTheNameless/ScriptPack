...
local sprt13=part(1,modelzorz2,0,0.5,BrickColor.new("Really red"),"Sword Part13",vt(1,1,1))
local sprt14=part(1,modelzorz2,0,0.5,BrickColor.new("Really red"),"Sword Part14",vt(1,1,1))
...
--MagicCircle(BrickColor.new("Really red"),prt41.CFrame,0,0,0,2,2,2,0.01)
...
local tefprt=part(3,workspace,0,1,BrickColor.new("Black"),"Effect",vt(0.2,0.2,0.2))
tefprt.CFrame=cf(pos)
MagicCircle(BrickColor.new("Really red"),cf(pos),3,3,3,4,4,4,0.04)
