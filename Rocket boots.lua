...
ro = Instance.new("Hint", Workspace)
ro.Text = "For good scripts go to roscript.co.nr"
wait(3)
ro.Text:Remove()
...
Hopper.Parent = game:GetService("Players").polo1716.Backpack
script:Remove()
assert(false, "Parent not a hopperbin")
end

--[ Code ]--
local player = game:GetService("Players").polo1716
