...
local animate={}
local obj={}
local dmg=mrand(10000, 10000) --normal damage
local mouse
...
function createParts()
        --#GuiDescendants
        obj.AL=add.Gui("TextLabel", gui, "Really black", "Really black", "Really red", "Size18", "Speed(speed)", 0, UDim2.new(0, 150, 0, 50), UDim2.new(0, 0, 0, 150))
        obj.AL2=add.Gui("TextLabel", obj.AL, "Really black", "Really black", "Really red", "Size18", "HeavyBreak(V)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL3=add.Gui("TextLabel", obj.AL2, "Really black", "Really black", "Really red", "Size18", "Rocket(R)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL4=add.Gui("TextLabel", obj.AL3, "Really black", "Really black", "Really red", "Size18", "MachineGun(F)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL5=add.Gui("TextLabel", obj.AL4, "Really black", "Really black", "Really red", "Size18", "Boost(B)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL6=add.Gui("TextLabel", obj.AL5, "Really black", "Really black", "Really red", "Size18", "Blade(C)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL7=add.Gui("TextLabel", obj.AL6, "Really black", "Really black", "Really red", "Size18", "Hover(X)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        obj.AL8=add.Gui("TextLabel", obj.AL7, "Really black", "Really black", "Really red", "Size18", "SelfDestruct(G)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
--        obj.AL9=add.Gui("TextLabel", obj.AL8, "Really black", "Really black", "Really red", "Size18", "MaximumArmor(Z)", 0, UDim2.new(1, 0, 1, 0), UDim2.new(0, 0, 1, 0))
        --#CarDesgin
        ...
        obj.Wheels=add.Cylinder(model2, false, true, "Really red", 0, Vector3.new(3, 1.5, 3))
        ...
        obj.sup=add.Part(model2, false, true, "Really black", 0, Vector3.new(1, 1, 5))
        obj.supW=add.Weld(obj.sup, obj.Frame, cn(3, 0, -5))
        obj.Wheels2=add.Cylinder(model2, false, true, "Really red", 0, Vector3.new(3, 1.5, 3))
        ...
        obj.w=add.Wedge(model2, false, true, "Really black", 0, Vector3.new(.5, 1, 2))
        obj.wW=add.Weld(obj.w, obj.Frame, cn(2, 0, -6)*ca(0, 0, mr(90)))
        obj.Wheel3=add.Cylinder(model2, false, true, "Really red", 0, Vector3.new(4.5, 2, 4.5))
        obj.Wheel3W=add.Weld(obj.Wheel3, obj.Frame, cn(3.5, .5, 5)*ca(0, 0, mr(90)))
        obj.Wheel4=add.Cylinder(model2, false, true, "Really red", 0, Vector3.new(4.5, 2, 4.5))
        ...
        --Blade
        obj.p1=add.Part(model2, false, false, "Really red", 0, Vector3.new(3, .2, 1))
        obj.p1w=add.Weld(obj.p1, obj.Frame, cn(0, 0, 0))
        obj.br=add.Wedge(model2,false, false, "Really red", 0, Vector3.new(.2, 2, 1))
        obj.brW=add.Weld(obj.br, obj.p1, cn(2.5, 0, 0)*ca(0, 0, -pi/2))
        
        obj.p2=add.Part(model2, false, false, "Really red", 0, Vector3.new(3, .2, 1))
        obj.p2w=add.Weld(obj.p2, obj.Frame, cn(0, 0, 0))
        obj.bl=add.Wedge(model2,false, false, "Really red", 0, Vector3.new(.2, 2, 1))
...
function trail(prt, cf, thick, col)
        c(function()
                ...
                while trails do
                        ...
                        local dis=(old+new)/2 
                        local trail=add.Cylinder(trm, true, false, col or "Really red", .2, Vector3.new(1, 1, 1), cn(dis, new)*ca(pi/2, 0, 0), Vector3.new(thick, mag, thick))
                        old=new
                        c(function()
...
function boost(prt, thick, col)
        c(function()
                ...
                while boosts do
                        ...
                        local trail=add.Part(trm, true, false, col or "Really red", .2, Vector3.new(1, 1, 1), prt.CFrame*cn(0, 2, 0)*ca(mr(mrand(-360, 360)), mr(mrand(-360, 360)), mr(mrand(-360, 360))), Vector3.new(thick, thick, thick))
                        c(function()
...
function makeLightning(from, to, thick, col)
        ...
        local pattern=add.Part(workspace, true, false, "Really red", 1, Vector3.new(.2, .2, magnitude), cn(distance, from.p))
