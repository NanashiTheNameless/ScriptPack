...
c2(raw,spd,3,1,0.5,-0.5,-70,-25,0) c2(law,spd,3,-1,0.5,-0.5,-70,25,0)  c1(tw,spd,3,0,0,0,30,0,0) wait(0.2) GlowMesh(false,"Sphere",t,v3(9,15,12),'New Yeller',to.CFrame,0.1,1,0.05) CrownSwords(to.CFrame*cn(0,-2.5,-3)) to.CFrame = to.CFrame*cn(0,0,30) GlowMesh(false,"Sphere",t,v3(9,15,12),'New Yeller',to.CFrame,0.1,1,0.05)
...
local das = pa(su,"","Block",1.5,2.5,1.5,false,true,0.1,0,"New Yeller") qi({"SpecialMesh",das,MeshType="Sphere"})
...
if ty%6==0 then GlowMesh(false,Decs.Crown,t,v3(3,6,3),'New Yeller',to.CFrame*cn(0,0,3)*ca(rd(90),0,0),0.1,1,0.05) end
end) ws(16)
...
local pla = pa(su,"","Block",7,1,7,true,true,1,0,"New Yeller")
function ButtonDown() if Anim~="None" then return end 
to.Velocity=v3(0,0,0) if hu.Jump then GlowMesh(false,"Sphere",t,v3(8,2,8),'New Yeller',to.CFrame*cn(0,-2,0),0.1,1,0.05)  GlowMesh(false,Decs.Crown,t,v3(5,3,5),'New Yeller',to.CFrame*cn(0,-1.5,0)*ca(rd(180),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,20,0) 
hu.Jump=false GlowMesh(false,"Sphere",t,v3(8,2,8),'Navy blue',to.CFrame*cn(0,-4,0),0.1,1,0.05)
else GlowMesh(false,"Sphere",t,v3(8,10,2),'New Yeller',to.CFrame,0.1,1,0.05)
GlowMesh(false,Decs.Crown,t,v3(5,3,5),'New Yeller',to.CFrame*cn(0,0,1)*ca(rd(90),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,0,-12) GlowMesh(false,"Sphere",t,v3(8,10,2),'New Yeller',to.CFrame*cn(0,0,1),0.1,1,0.05) end
pla.CFrame= to.CFrame*cn(0,-3.4,0) local orpos = pla.Position repeat wait(0.5) GlowMesh(false,"Sphere",t,v3(14,1,14),'New Yeller',cn(orpos)*cn(0,0.5,0),0.1,1,0.02) until pla.Position~=orpos or (pla.Position-to.Position).magnitude>10
