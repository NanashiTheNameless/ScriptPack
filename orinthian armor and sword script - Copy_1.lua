...
Meshes = {          --texture id       --mesh id
	Coif = {Asset..(111503130), Asset..(111503081)},
	
	Torso = {Asset..(110958169), Asset..(106706744)},
	
	Rarm = {Asset..(110958169), Asset..(106706906)},
	
	
	Larm = {Asset..(110958169), Asset..(106706782)},
	
	
	Rleg = {Asset..(110958169), Asset..(106706947)}, 
	
	Lleg = {Asset..(110958169), Asset..(106706851)},
	
	Sword = {Asset..(92537877), Asset..(50798664)},
	
	Shield = {Asset..(92537839), Asset..(50798797)},
}
...
CamBlock = Part(Mod, true, false, 1, 0, "Sky blue", V3(0.4, 0.4, 0.4))
...
HatHandle = Part(Hat, false, false, 0, 0, "Navy blue", V3(2.9, 1.8, 1.4))
HatHandle.Name = "Handle"
Hat.AttachmentPos = V3(0, 0.3, -0.1)
Add.Mesh(HatHandle, Meshes.Coif[2], Meshes.Coif[1], V3(2,2,2))
...
Sword = Part(Mod, false, false, 0, 0, "Navy blue", V3(0.8, 0.4, 4.5))
Add.Mesh(Sword, Meshes.Sword[2], Meshes.Sword[1], V3(2.1, 2.5, 2.15))

Shield = Part(Mod, false, false, 0, 0, "Navy blue", V3(2.3, 0.6, 3))
Add.Mesh(Shield, Meshes.Shield[2], Meshes.Shield[1], V3(1.7, 1.9, 1.8))

RABrick = Part(Mod, false, false, 1, 0, "Navy blue", V3(0.1, 0.1, 0.1))
LABrick = Part(Mod, false, false, 1, 0, "Navy blue", V3(0.1, 0.1, 0.1))
RLBrick = Part(Mod, false, false, 1, 0, "Navy blue", V3(0.1, 0.1, 0.1))
LLBrick = Part(Mod, false, false, 1, 0, "Navy blue", V3(0.1, 0.1, 0.1))
...
HB = Part(Mod, false, false, 1, 0, "Navy blue", V3(0.1, 0.1, 0.1))
...
function SE(part, cf)
	coroutine.resume(coroutine.create(function()
		...
		while Effect do
			wait()
			local p = Part(Mod, true, false, 0, 0, "Navy blue", V3(0.2, 0.2, 0.2))
...
--Splintered sky Gifted by TheRedAngel, Local Script!
...
Meshes = {          --texture id       --mesh id
	Coif = {Asset..(101740615), Asset..(101742035)},
	
	Torso = {Asset..(101727937), Asset..(101737660)},
	
	Rarm = {Asset..(101727937), Asset..(101730738)},
	
	
	Larm = {Asset..(101727937), Asset..(101731090)},
	
	
	Rleg = {Asset..(101727937), Asset..(101730623)}, 
	
	Lleg = {Asset..(101727937), Asset..(101730942)},
...
CamBlock = Part(Mod, true, false, 1, 0, "Navy blue", V3(0.4, 0.4, 0.4))
Cam = workspace.CurrentCamera
