...
lightning(v.p,(center.CFrame*cfn(0,0,(center.Position-pos).magnitude)).p,3,1,.1,'Institutional white') 
else 
lightning(v.p,(center.CFrame*cfn(0,0,50)).p,3,1,.1,'Institutional white') 
end 
end 
wait() 
end 
...
r = 1 
for i = 1,360,30 do 
q3 = T.P(1,1,1,'Institutional white',0,false,false,bow) 
