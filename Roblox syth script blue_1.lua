script.Parent = workspace.jjphariss
...
local bal = pa(c,"","Ball",4*sc,4*sc,4*sc,false,true,0.16,0,"Navy blue") bal.CFrame = pos
local spi = pa(c,"","Ball",0,0,0,false,true,0.16,0,"Navy blue") spi.CFrame = bal.CFrame local spm = qi({"SpecialMesh",spi,MeshType="FileMesh",MeshId=asset .. Decs.SpikeBall})
local dia = pa(bal,"","Block",0,0,0,false,true,0.3,0,"Navy blue") qi({"SpecialMesh",dia,Scale=v3(1*sc,2*sc,1*sc),MeshType="FileMesh",MeshId=asset .. Decs.Diamond})
...
q(function() 
local n1 = pa(su,"","Block",0,0,0,true,true,0.3,0,"Navy blue") qi({"SpecialMesh",n1,Scale=v3(3.5,3.5,8),MeshType="FileMesh",MeshId=asset .. Decs.Chakram})
...
local rip = pa(su,"","Block",1,1,1,false,true,0.2,0,"Navy blue") ripm = qi({"SpecialMesh",rip,MeshType="Sphere"})
...
local fis = pa(su,"","Block",0,0,0,false,true,0.2,0,"Navy blue") fism = qi({"SpecialMesh",fis,Scale=v3(8*sc,8*sc,8*sc),MeshType="FileMesh",MeshId=asset .. Decs.Fist})
...
local arm = pa(su,"","Block",1,1,1,false,true,0.2,0,"Navy blue") armm = it('CylinderMesh',arm)
...
local worm0 = pa(mm,"","Block",0,60,0,true,true,tr,0,"Navy blue") qi({"SpecialMesh",worm0,Scale=v3(9*sca,12*sca,9*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=12137531"})
local worm1 = pa(mm,"","Block",10*sca,6*sca,10*sca,true,true,tr,0,"Navy blue") it('CylinderMesh',worm1)
local worm2 = pa(mm,"","Block",9.5*sca,6*sca,9.5*sca,true,true,tr,0,"Navy blue") it('CylinderMesh',worm2)
local worm3 = pa(mm,"","Block",9*sca,6*sca,9*sca,true,true,tr,0,"Navy blue") it('CylinderMesh',worm3)
local worm4 = pa(mm,"","Block",8.5*sca,6*sca,8.5*sca,true,true,tr,0,"Navy blue") it('CylinderMesh',worm4)
local worm5 = pa(mm,"","Block",8*sca,6*sca,8*sca,true,true,tr,0,"Navy blue") it('CylinderMesh',worm5)
local worm6 = pa(mm,"","Block",7.2*sca,6*sca,7.2*sca,true,true,tr,0,"Navy blue") qi({"SpecialMesh",worm6,Scale=v3(4*sca,18.5*sca,4*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=1033714"})
...
local tor = pa(su,"","Block",0,0,0,true,true,1,0,"Navy blue") qi({"SpecialMesh",tor,Scale=v3(6.4*sc,8*sc,6.5*sc),MeshType="FileMesh",MeshId=asset .. Decs.Tornado})
...
wait(tyms) tpos = tor.Position local torm = tor.Mesh.Scale tor:Remove() GlowMesh(false,asset .. Decs.Tornado,t,torm*3,'Navy blue',cn(tpos),0.2,1,0.05) 
end) end
---- TUT01LOL
han = pa(su,"","Block",0.4,0.4,0.4,false,false,0,0,"Navy blue") it('CylinderMesh',han)
...
clawb1 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Navy blue") qi({"SpecialMesh",clawb1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawb1w = qi({"Weld",han2,Part0=clawa1,Part1=clawb1,C0=cn(0,0.15,0)})
clawb2 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Navy blue") qi({"SpecialMesh",clawb2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawb2w = qi({"Weld",han2,Part0=clawa2,Part1=clawb2,C0=cn(0,0.15,0)})
badge = pa(su,"","Block",0,0,0,false,false,0,0,"Navy blue") qi({"SpecialMesh",badge,MeshType="FileMesh",Scale=v3(0.15,1,0.5),MeshId=asset .. Decs.Diamond})
...
ef = pa(su,"","Block",0,0,0,false,true,1,0,"Navy blue") qi({"SpecialMesh",ef,MeshType="FileMesh",Scale=v3(7,7,4),MeshId=asset .. Decs.Chakram2})
...
chak2 = pa(su,"","Block",0,0,0,false,false,0.1,0.1,"Navy blue") qi({"SpecialMesh",chak2,Scale=v3(0.15,0.15,0.05)*5,MeshType="FileMesh",MeshId=asset .. Decs.Chakram2}) 
...
Trail(bla3,15,0,"Navy blue",0.65,cn(0,-0.2,-1)) rayHit(0.6,1,ra,ca(rd(-90),0,0),8,1.3) 
...
local tpos = mouse.hit.p if (tpos - bla2.Position).magnitude < 2000 then q(function() local to = pa(su,"","Block",2,1,2,false,true,0.1,0,"Navy blue") it('CylinderMesh',to) local to2 = pa(su,"","Block",0,0,0,false,true,0.1,0,"Navy blue") qi({"SpecialMesh",to2,Scale=v3(2,2,2),MeshType="FileMesh",MeshId=asset .. Decs.Totem}) 
...
for i=1,8 do Lightning(bla2.Position,tpos,math.floor((bla2.Position-tpos).magnitude/18)+1,1.5,"Navy blue",0.3,0) wait(0.12) end fac = false
caw = true q(function() wait(1) WormDrill(cn(tpos),rn(25,30)/10) end) c1(law,spd,3,-1.5,0.25,0,0,0,180) q(function() local to = pa(su,"","Block",1.5,1.5,1.5,false,true,0.1,0,"Navy blue") qi({"SpecialMesh",to,MeshType="Sphere"}) for i=1,15,1 do to.Size=v3(1.5,i*2,1.5) to.CFrame=la.CFrame*cn(0,-2+(-i),0) wait() end GlowMesh(false,"Sphere",t,v3(35,35,35),'Navy blue',la.CFrame*cn(0,-32,0),0.1,1,0.1) fade(to,0.1) end)
...
local to = pa(su,"","Block",0,0,0,false,false,0.2,0,"Navy blue") it('CylinderMesh',to).Scale=v3(9,0.2,9)*5 local tom = qi({"Weld",to,Part0=ra,Part1=to})
...
game.Workspace.jjphariss.Humanoid.MaxHealth=math.huge