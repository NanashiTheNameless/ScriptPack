...
local CoreGui = game.Players.TheGreenLabs.PlayerGui
----------------------------------------------------------------------------------------------------
local CoreGui= game.Players.TheGreenLabs.PlayerGui
...
local Loadchar=Instance.new("TextButton")
	...
	Loadchar.Position=UDim2.new(0,-5,0,-5)
	Loadchar.Text="ShotGun"
...
Close.MouseButton1Down:connect(function()
	f:TweenPosition(UDim2.new(0,-100,0.1,0),Out,"Linear",.5,true,nil)
wait(.1)
	Close.Visible = false
	Open.Visible = true
end)
...
Open.MouseButton1Down:connect(function()
	f:TweenPosition(UDim2.new(0,0,0.1,0),Out,"Linear",.5,true,nil)
wait(.1)
	Close.Visible = true
	Open.Visible = false
end)
...
Accuracy = {Minimum = 1, Maximum = 1, Momentum = 5}
