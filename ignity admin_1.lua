-- Pay no attention to this. Its quite simple to use however.

-- Type 'bye [playername]' to ban someone from the server
-- Type 'kick/[playername]' to kick someone from the server
-- Type 'kill/[playername]' to kill someone

-- More commands below. PM me if you have any concerns.

owner = "Dignity"
banned = { }
admins = {"Dignity"}
mods = { "Bspurrell", "rogue658", "Dill5000100", "SlimShady", "Shaylya" } -- Add more if you'd like.
superusers = {}
powerusers = { }
...
function getCall(call, parent)
	if call == "" then
		showMsg(parent, "Dignity's Admin Commands Script Loaded (V1.7); General Info Accessed.")
...
function onChatted(msg,recipient,speaker)
	...
	if string.sub(msg,1) == "updates/" then
		...
		showMsg(speaker, "Dignity's V1.7 Commands Uploaded")
		showMsg(speaker, "Credits: rogue658")
