--MADE BY OneLegend (NOT THE SCRIPT) Credits to CyberFromLU for letting me publish REGULAR SCRIPT: Just hit CNTRL + H and where it says Find what type "SergeantSmokey" and where it says Replace with Put your name.

if script == nil then return end


Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("SergeantSmokey")
...
--lego
game.Workspace.SergeantSmokey.Humanoid.MaxHealth = math.huge  -----Replace SergeantSmokey with your name, it gives you INF health, enjoy. C:
print(lego)
