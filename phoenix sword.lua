...
main.Name="MainParts"
handle = makepart("Handle",main,.2,2,.2,"Dark stone grey")
        cylinder(handle)
...
handlep8 = makepart("HandlePart8",main,.02,0.02,.02,chosen)
        ...
        w1.Part0=handlep8
        w1.C1=CFrame.new(-.5,-.84,0) * CFrame.Angles(0,0,0)
handlep11 = makepart("HandlePart11",main,.02,0.02,.02,"Dark stone grey")
...
handleg = makepart("Handle",main2,.2,2,.2,"Dark stone grey")
        cylinder(handleg)
...
handlep8 = makepart("HandlePart8",main2,.02,0.02,.02,chosen)
        ...
        w1.Part0=handlep8
        w1.C1=CFrame.new(-.5,-.84,0) * CFrame.Angles(0,0,0)
handlep11 = makepart("HandlePart11",main2,.02,0.02,.02,"Dark stone grey")
        bm11=blockmesh(handlep11)
        bm11.Scale=Vector3.new(1.4,1.4,1.61)
        w1=Instance.new("Weld",handlep11)
        w1.Part1=handleg
        w1.Part0=handlep11
        w1.C1=CFrame.new(0,-.84,0) * CFrame.Angles(0,0,0)
bladep1 = makepart("BladePart1",main2,.02,4,.02,"Dark stone grey")
        bp1=blockmesh(bladep1)
        bp1.Scale=Vector3.new(4,1,.5)
        w1=Instance.new("Weld",bladep1)
        w1.Part1=handleg
...
bladep7 = makepart("BladePart7",main2,.02,.02,.02,chosen)
        ...
        w1.Part0=bladep7
        w1.C1=CFrame.new(0,-2.72,0)
bladep8 = makepart("BladePart8",main2,.02,.02,.02,"Dark stone grey")
        bp8=specmesh(bladep8,"Wedge",.51,2,3)
        w1=Instance.new("Weld",bladep8)
        w1.Part1=handleg
        w1.Part0=bladep8
        w1.C1=CFrame.new(0.20,-5.3,0)
        w1.C0=CFrame.Angles(math.rad(90),math.rad(90),0)
bladep9 = makepart("BladePart9",main2,.02,.02,.02,"Dark stone grey")
        bp9=specmesh(bladep9,"Wedge",.51,2,3)
        w1=Instance.new("Weld",bladep9)
        w1.Part1=handleg
        w1.Part0=bladep9
...
d.Transparency=0.5
d.BrickColor=BrickColor.new("White")
end
for i=0,1,0.1 do
wait()
...
d.Transparency=0.5
d.BrickColor=BrickColor.new("Royal purple")
end
for i=0,1,0.1 do
wait()
