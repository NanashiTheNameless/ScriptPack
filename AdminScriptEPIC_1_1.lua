--Kohls Admin Commands Version 3
-----------------------------------------------------------------------------------------
-- Heres my new admin V3 because i was banned it cant update and Thanx for using meh admin --
-----------------------------------------------------------------------------------------
local owners = {"SergeantSmokey"} -- Are able to set admins who can ban/etc... using :pa name
