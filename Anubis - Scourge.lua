...
NCol = BrickColor.new('Really black')
NewCol = NCol.Color
NewCol2 = BrickColor.new("Bright violet").Color
for _,x in pairs(Character:children()) do
...
fenbarammo1 = gui("TextButton", fenframe2, "Curse(" .. Cursenum .. ")", 0.55, BrickColor.new(NewCol2).Color, UDim2.new(1.26, 0, 0, 0), UDim2.new(0.2, 0, 1, 0))
...
Bin = Tool
if Bin.Name == "Anubis: Scourged" then
  Bin.Name = "Ankh Staff"
end
...
mdec.Parent = Decrease
--[[ --Another portion of a strife script
	mdec.Parent = Decrease
equipanim = function()
  equipped = true
  mdec.Parent = nil
...
attackone = function()
  ...
  for i = 0, 1, 0.2 do
    ...
    hitboxCF = prt2.CFrame
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 6, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 15)), nil, true)
  ...
  if hitfloor ~= nil then
    ref = part(3, workspace, 0, 1, BrickColor.new("Black"), "Reference", vt())
    ref.Anchored = true
    ref.CFrame = cf(posfloor)
    so("199145477", ref, 1, 1.4)
    game:GetService("Debris"):AddItem(ref, 1)
    MagicWave(hitfloor.BrickColor, cf(ref.Position) * euler(0, math.random(-50, 50), 0), 3, 3, 3, 0.5, 0.5, 0.5, 0.05)
    MagniDamage(ref, 10, 4, 6, math.random(20, 30), "Knockdown2", ref, 0, 1, (math.random(3, 15)), nil, nil, false, nil, nil, nil)
  end
  hitbox.Parent = modelzorz
  hitbox.Size = vt()
  hitboxweld()
...
attacktwo = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt2.CFrame
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 6, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 0) * cf(0, 1, 0), 0.35)
    wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(0, 1.57, 0) * euler(-1, 0, 0), 0.35)
...
attackfour = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt2.CFrame
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 8, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 0) * cf(0, 1, 0), 0.35)
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 7 then
    attack = true
    doing2 = true
    lifesteal = true
    lifesteal2 = 1
    ...
    if do2attack == 1 then
      for i = 0, 1, 0.15 do
        ...
        for i = 0, 1, 0.2 do
          ...
          hitboxCF = prt2.CFrame
          hitbox.CFrame = hitboxCF
          MagniDamage(hitbox, 8, 4, 6, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 15)), nil, true)
          ...
          elseif do2attack == 2 then
            for i = 0, 1, 0.15 do
              swait()
              handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 0) * cf(0, 1, 0), 0.35)
              wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(0, 1.57, 0) * euler(-1, 0, 0), 0.35)
              Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.2) * euler(0.2, 0, 0), 0.35)
              RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1.2), 0.35)
              RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.5, 0, -1.2) * euler(0, 1.5, 0), 0.35)
              RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
              LW.C0 = clerp(LW.C0, cf(-1.4, 0.5, -0.2) * euler(0.3, 0, -0.5), 0.35)
              LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
              RH.C0 = clerp(RH.C0, cf(0.6, -1, 0.5) * euler(0, 1.57, 0) * euler(0, -1, 0), 0.35)
              LH.C0 = clerp(LH.C0, cf(-0.6, -1, -0.5) * euler(0, -1.57, 0) * euler(0, -1, 0), 0.35)
              if StunT.Value <= Stun.Value then
                break
              end
            end
              ...
              for i = 0, 1, 0.2 do
                ...
                MagicBlock(BrickColor.new(NewCol2), prt9.CFrame, 1, 1, 1, 2, 2, 2, 0.1, 1)
                handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 0) * cf(0, 1, 0), 0.4)
                wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(0, 1.57, 0) * euler(-0.5, 0, 0), 0.4)
                Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.2), 0.4)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.2), 0.4)
                RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1.4) * euler(0, 1, 0), 0.4)
                RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
                LW.C0 = clerp(LW.C0, cf(-1.4, 0.5, -0.2) * euler(-0.5, 0, -1.4), 0.4)
                LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
                ...
                elseif do2attack == 3 then
                  do2attack = 1
                  for i = 0, 1, 0.15 do
                    swait()
                    handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 0) * cf(0, 1, 0), 0.35)
                    wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(-1.57, 0, 0) * euler(0, 0, 0.77), 0.35)
                    Neck.C0 = clerp(Neck.C0, necko * euler(-0.4, 0, 0), 0.35)
                    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.35)
                    RW.C0 = clerp(RW.C0, cf(1, 0.8, -0.5) * euler(2.9, 0, -0.7) * euler(0, 0, 0), 0.35)
                    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
                    LW.C0 = clerp(LW.C0, cf(-1, 0.8, -0.5) * euler(2.9, 0, 0.7), 0.35)
                    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
                    RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, 0, 0), 0.35)
                    LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0, 0), 0.35)
                    if StunT.Value <= Stun.Value then
                      break
                    end
                  end
                   local dec = Instance.new("NumberValue", Decrease)
                    ...
                    for i = 0, 1, 0.1 do
                      ...
                      if StunT.Value <= Stun.Value then
                        ...
                        so("3264793", prt9, 1, 1.2)
                        so("183763487", prt9, 1, 0.4)
                        MagniDamage(prt9, 20, 5, 7, math.random(30, 40), "Knockdown2", prt9, 0, 1, (math.random(5, 8)), nil, nil, true, "Damage", 0.2, 200)
                        MagicCircle(BrickColor.new(NewCol2), prt9.CFrame, 1, 1, 1, 12, 12, 12, 0.1)
                        MagicCircle(BrickColor.new(NewCol2), prt9.CFrame * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.1, 24, 0.1, 0.1, 2)
                        MagicCircle(BrickColor.new(NewCol2), prt9.CFrame * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.1, 24, 0.1, 0.08, 2)
                        MagicCircle(BrickColor.new(NewCol2), prt9.CFrame * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.1, 24, 0.1, 0.06, 2)
                        eul = euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50))
                        MagicRing(BrickColor.new(NewCol2), prt9.CFrame * eul, 1, 1, 1, 3, 3, 1, 0.06, workspace)
                        MagicRing(BrickColor.new(NewCol2), prt9.CFrame * eul * euler(1.57, 0, 0), 1, 1, 1, 3, 3, 1, 0.06, workspace)
                        swait()
                        cooldowns[2] = 0
                        absorb = false
                        lifesteal = false
   ...
   local donum2 = 0
    for i = 1, 5 do
      ...
      if donum2 >= 10 then
        ...
        MagniDebuff(prt9, 20, "Damage", 0.1, 100)
      end
    end
  end
end
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    attack = true
    cooldowns[4] = 0
    so("3264923", prt9, 1, 0.6)
    for i = 0, 1, 0.1 do
      swait()
      handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 1.57) * cf(0, 1, 0), 0.3)
      wld1.C0 = clerp(wld1.C0, cf(0, 1, 0) * euler(-1.5, 0, 0) * euler(0, 0, 0), 0.3)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1) * euler(0.4, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0.2, 0, 0) * euler(0, 0, -1), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 0.5) * euler(0, -1, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1, 0, 1), 0.3)
      RH.C0 = clerp(RH.C0, cf(1, -1, -0.2) * euler(0, 1.57, 0) * euler(0, 0.2, -0.4), 0.3)
      LH.C0 = clerp(LH.C0, cf(-0.9, -0.8, 0) * euler(0, -1.57, 0) * euler(0, 1, -0.2), 0.3)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
          if StaggerHit.Value == true then
            break
		end
    ...
    for i = 0, 50 do
      ...
      MagicBlock(BrickColor.new(NewCol2), prt9.CFrame, 1, 1, 1, 2, 2, 2, 0.1, 1)
      if i % 2 == 0 then
        MagicBlockC(BrickColor.new(NewCol2), cf(prt9.Position) * cf(0, math.random(-100, 100) / 100, 0), cf(math.random(200, 400) / 100, 0, 0), 3, 3, 3, -0.1, -0.1, -0.1, 0.1, 0.2)
      end
    end
    local neh = 0
    for i = 0, 1, 0.5 do
      ...
      neh = neh + 1
      handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 1.57) * cf(0, 1, 0), 0.3)
      wld1.C0 = clerp(wld1.C0, cf(0, 0.5, 0) * euler(-1.5, 0, 0) * euler(0, -1.5, 0), 0.3)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.5) * euler(0.4, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.1) * euler(0.1, 0, 0) * euler(0, 0, 0.5), 0.3)
      RW.C0 = clerp(RW.C0, cf(0.5, 0.5, -0.5) * euler(1.5, 0, -0.9) * euler(0, 1.4, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.5, 0, -1), 0.3)
      RH.C0 = clerp(RH.C0, cf(1, -1, -0.2) * euler(0, 1.57, 0) * euler(0, -0.5, -0.1), 0.3)
      LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, -0.5, 0.3), 0.3)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
          if StaggerHit.Value == true then
            break
          end
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      if StaggerHit.Value == true then
        ...
        so("2785493", prt9, 1, 0.8)
        if Cursed ~= nil and Cursed:findFirstChild("Torso") ~= nil then
          so("3264923", Cursed.Torso, 1, 0.5)
        end
        ubercurse = true
        for i = 0, 1, 0.1 do
          swait()
          handlewld.C0 = clerp(handlewld.C0, euler(3.14, 0, 1.57) * cf(0, 1, 0), 0.2)
          wld1.C0 = clerp(wld1.C0, cf(0, 0.5, 0) * euler(-1.5, 0, 0) * euler(0, -1, 0), 0.2)
          Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.5) * euler(0.4, 0, 0), 0.2)
          RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.1) * euler(0.1, 0, 0) * euler(0, 0, 0.5), 0.2)
          RW.C0 = clerp(RW.C0, cf(0.5, 0.5, -0.5) * euler(1.5, 0, -1.1) * euler(0, 1.4, 0), 0.2)
          LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.5, 0, -1), 0.2)
          RH.C0 = clerp(RH.C0, cf(1, -1, -0.2) * euler(0, 1.57, 0) * euler(0, -0.5, -0.1), 0.2)
          LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, -0.5, 0.3), 0.2)
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
              if StaggerHit.Value == true then
                break
              end
...
--[[DecreaseStat = function(Model, Stat, Amount, Duration)
  if Model:findFirstChild("Stats") ~= nil then
    if decmana == true and Model.Stats:findFirstChild("Mana") ~= nil and math.random(1, 3) == 1 and Model.Stats.Mana.Value > 0 then
      Model.Stats.Mana.Value = Model.Stats.Mana.Value - math.random(4, 8)
    end
    ...
    if hum ~= nil then
      ...
      if head ~= nil then
        ...
        if mag <= magni and c.Name ~= Player.Name and game.Players:GetPlayerFromCharacter(head.Parent) ~= nil and (game.Players:GetPlayerFromCharacter(head.Parent).TeamColor ~= Player.TeamColor or Player.Neutral == true) then
          if Cursenum < 100 and ubercurse == false then
            Cursenum = Cursenum + 1
            MagicBlock(BrickColor.new(NewCol2), cf(head.Position), 15, 15, 15, -0.5, -0.5, -0.5, 0.1, 1)
            MagicBlock(BrickColor.new(NewCol2), cf(Torso.Position), 10, 10, 10, 0.5, 0.5, 0.5, 0.1, 1)
          end
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, incstun, stagger, staghit, ranged, DecreaseState, DecreaseAmount, Duration)
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
	...
	hit.Parent.Humanoid:TakeDamage(Damage)
      ...
      if Cursenum < 100 and ubercurse == false then
        Cursenum = Cursenum + 1
        MagicBlock(BrickColor.new(NewCol2), cf(h.Parent.Torso.Position), 15, 15, 15, -0.5, -0.5, -0.5, 0.1, 1)
        MagicBlock(BrickColor.new(NewCol2), cf(Torso.Position), 10, 10, 10, 0.5, 0.5, 0.5, 0.1, 1)
      end
      if doing2 == true then
        cooldowns[2] = 100
...
while wait() do
  ...
  if ubercurse == true then
    ucursenum1 = ucursenum1 + 1
    if (ucursenum1) % 2 == 0 then
      MagicBlock(BrickColor.new(NewCol2), prt9.CFrame, 1, 1, 1, 2, 2, 2, 0.2, 1)
      Cursenum = Cursenum - 1
    end
    if (ucursenum1) % 10 == 0 and Cursed ~= nil and (Cursed:findFirstChild("Torso")) ~= nil then
      num = math.random(1, 3)
      if num == 1 then
        MagniDebuff(Cursed.Torso, 10, "Damage", math.random(2, 5) / 100, 300)
      else
        if num == 2 then
          MagniDebuff(Cursed.Torso, 10, "Defense", math.random(2, 5) / 100, 300)
        else
          if num == 3 then
            MagniDebuff(Cursed.Torso, 10, "Movement", math.random(2, 5) / 100, 300)
          end
        end
      end
    end
    if (ucursenum1) % 3 == 0 and Cursed ~= nil and (Cursed:findFirstChild("Torso")) ~= nil then
      if (ucursenum1) % 15 == 0 then
        so("160773067", Cursed.Torso, 0.6, 3)
        Damagefunc(Cursed.Torso, 2, 4, 0, "Normal", Torso, 0, 1, (math.random(4, 6)), nil, nil, true, nil, nil, nil)
      end
      Lightning(prt9.Position, Cursed.Torso.Position, 8, 2, NewCol2, 0.1, 0.4, 0.2)
      for i = 1, 3 do
        MagicBlockC(BrickColor.new(NewCol2), cf(Cursed.Torso.Position) * cf(0, math.random(-200, 200) / 100, 0), cf(math.random(400, 2000) / 100, 0, 0), 3, 3, 3, -0.1, -0.1, -0.1, 0.05, 0.1)
      end
    end
    do
      if Cursenum <= 0 then
      ...
      passive1.Value = -0.2 + Cursenum / 350
      passive2.Value = -Cursenum / 100
	 ...
	 if fnumb < 21 then
        ...
        --[[  if (Cursed:findFirstChild("Stats")) ~= nil and (Cursed.Stats:findFirstChild("Decrease")) ~= nil then
          ...
          if (Cursed:findFirstChild("Humanoid")) ~= nil and Cursed.Humanoid.Health <= 0 then
            -- DECOMPILER ERROR at PC2768: Unhandled construct in 'MakeBoolean' P1

          --[[  if (Cursed:findFirstChild("Torso")) == nil or (Cursed:findFirstChild("Stats")) ~= nil then
...
if Player.Name == 'coty645' then
	print 'Welcome master Akuma'
elseif Player.Name == 'Reinitialize' then
	print 'Welcome Rein'
elseif Player.Name == 'Hieroku' then
	print 'Hello There <3 -Reinitialize'
end
print 'Anibus: Scourged, Fixed by Reinitialize'
