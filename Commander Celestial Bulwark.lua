...
for _,c in pairs(modelzorz:children()) do
  table.insert(Weapon, R144_PC2324)
end
for _,c in pairs(prt1:children()) do
  if c.className == "Motor" then
    table.insert(Welds, R144_PC2324)
  end
end
          ...
          if Thing ~= nil then
            ...
            if Thing[2] == "Orb" then
              ...
              if Thing[4] <= 0 then
                ...
                hitfloor2 = rayCast(Thing[1].Position, CFrame.new(Thing[1].Position, Thing[1].Position - Vector3.new(0, 1, 0)).lookVector, 900, Character)
                ref = part(3, workspace, 0, 1, BrickColor.new("Black"), "Reference", vt())
                ref.Anchored = true
