damf = Instance.new("RemoteFunction", workspace)
damf.Name="damageFunc"
repeat
  wait()
until game.Workspace:FindFirstChild("damageFunc")
...
local handlewld = weld(handle, handle, Torso, euler(2.1, 1.57, 0) * cf(1, -1, -0.5))
...
for _,c in pairs(modelzorz:children()) do
  table.insert(Weapon, R140_PC2235)
end
for _,c in pairs(prt1:children()) do
  if c.className == "Motor" then
    table.insert(Welds, R140_PC2235)
  end
end
-- DECOMPILER ERROR at PC2265: Overwrote pending register: R140 in 'AssignReg'
...
oattackone = function()
  ...
  for i = 0, 1, 0.15 do
    ...
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.1, 0, 0.7), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 0.5), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.4, 0, -0.4) * euler(0, -0.4, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, -0.7, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, -0.7, 0), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt5.CFrame * cf(0, 2.8, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 8, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(6, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.4)
    wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(1, 0, 0), 0.4)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.5) * euler(-0.1, 0, 0), 0.4)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.5), 0.4)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 0.2), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-1.2, 0.5, -0.4) * euler(1.2, 0, -0.4) * euler(0, 0.2, 0), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
...
oattackthree = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt5.CFrame * cf(0, 2.8, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 8, math.random(10, 20), "Normal", RootPart, 0.5, 2, (math.random(6, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
    wld1.C0 = clerp(wld1.C0, cf(0, 1, 0) * euler(0.5, 0, 0), 0.3)
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        ...
        -- DECOMPILER ERROR at PC488: LeaveBlock: unexpected jumping out IF_THEN_STMT

        -- DECOMPILER ERROR at PC488: LeaveBlock: unexpected jumping out IF_STMT
  ...
  for i = 0, 1, 0.1 do
    ...
    MagniDamage(hitbox, 5, 4, 8, math.random(10, 20), "Normal", RootPart, 0.5, 2, (math.random(6, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
    wld1.C0 = clerp(wld1.C0, cf(0, 1, 0) * euler(1, 0, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 1), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
...
oattackfour = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    hitboxCF = prt5.CFrame * cf(0, 2.8, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 5, 4, 8, math.random(-20, -10), "Normal", RootPart, 0.5, 2, (math.random(6, 10)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
    wld1.C0 = clerp(wld1.C0, cf(0, 1, 0) * euler(0.2, 0, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.5), 0.3)
    RootJoint.C0 = RootCF * euler(0, 0, 0.5 - 7.28 * i)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 0.6), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.5, 0.5, -0.5) * euler(0.6, 0, 1) * euler(0, 0.8, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, 0.5, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0.5, 0), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
  ...
  for i = 0, 1, 0.1 do
    ...
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
    wld1.C0 = clerp(wld1.C0, cf(0, 0, 0) * euler(1.4, 0, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.57), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 0.6), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.4, 0, -1.4) * euler(0, 1, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
...
ModeChange = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.3)
    RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(0.8, 0, -1) * euler(0, 1, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.2, 0, 1.1) * euler(0, -1, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  ...
  for i = 0, 1, 0.05 do
    ...
    if Mode == "Offensive" then
      wld14.C0 = clerp(wld14.C0, euler(3.14, 1.57, 0) * cf(0.4, 0.6, -2) * euler(0, 0.5, 0), 0.3)
      wld15.C0 = clerp(wld15.C0, euler(3.14, -1.57, 0) * cf(-0.4, 0.6, 2) * euler(0, 0.5, 0), 0.3)
      wld16.C0 = clerp(wld16.C0, euler(3.14, 1.57, 0) * cf(0.4, 0.6, 2) * euler(0, -0.5, 0), 0.3)
      wld17.C0 = clerp(wld17.C0, euler(3.14, -1.57, 0) * cf(-0.4, 0.6, -2) * euler(0, -0.5, 0), 0.3)
    else
      wld14.C0 = clerp(wld14.C0, euler(3.14, 1.57, 0) * cf(0.4, 0.6, -2), 0.3)
      wld15.C0 = clerp(wld15.C0, euler(3.14, -1.57, 0) * cf(-0.4, 0.6, 2), 0.3)
      wld16.C0 = clerp(wld16.C0, euler(3.14, 1.57, 0) * cf(0.4, 0.6, 2), 0.3)
      wld17.C0 = clerp(wld17.C0, euler(3.14, -1.57, 0) * cf(-0.4, 0.6, -2), 0.3)
    end
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
    wld1.C0 = clerp(wld1.C0, cf(0, 1.5, 0) * euler(0, 0, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0.1, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 0) * euler(0, 1.57, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1, 0, 0) * euler(0, 1.57, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  attack = false
end
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 15 then
    ...
    if Mode == "Defensive" then
      ...
      MagniDamage(RootPart, 40, 4, 8, math.random(30, 40), "Knockdown2", RootPart, 0, 1, 0, nil, nil, true)
      ...
      for i = 0, 1, 0.1 do
        ...
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            ...
            -- DECOMPILER ERROR at PC783: LeaveBlock: unexpected jumping out IF_THEN_STMT

            -- DECOMPILER ERROR at PC783: LeaveBlock: unexpected jumping out IF_STMT
      ...
      for i = 1, 50 do
        swait()
        ref.CFrame = cf(RootPart.Position) * cf(math.random(-2000, 2000) / 100, 0, math.random(-2000, 2000) / 100)
        hit = rayCast(ref.Position, CFrame.new(ref.Position, ref.Position - Vector3.new(0, 1, 0)).lookVector, 20, Character)
        if hit ~= nil then
          MagicCircle(BrickColor.new("White"), cf(posfloor2), 1, 1, 1, 0.5, 7, 0.5, 0.1)
        end
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            if StaggerHit.Value == true then
            ...
            -- DECOMPILER ERROR at PC943: LeaveBlock: unexpected jumping out IF_THEN_STMT

            -- DECOMPILER ERROR at PC943: LeaveBlock: unexpected jumping out IF_STMT
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 10 and Rooted.Value == false then
    ...
    if manualguardend == true then
      ...
      for i = 0, 1, 0.1 do
        ...
        hitboxCF = prt5.CFrame * cf(0, 2.8, 0)
        hitbox.CFrame = hitboxCF
        MagniDamage(hitbox, 5, 5, 10, math.random(5, 10), "Normal", RootPart, 0.5, 2, math.random(10, 15), false, false)
        if Rooted.Value == false then
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 25 then
    ...
    for i = 0, 1, 0.1 do
      ...
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.2, 0, 1), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    ...
    for i = 0, 1, 0.1 do
      ...
      handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0.785) * cf(0, 1, 0), 0.3)
      wld1.C0 = clerp(wld1.C0, cf(0, 0.2, 0) * euler(0.4, 0, 0), 0.3)
      Neck.C0 = clerp(Neck.C0, necko * euler(-0.8, 0, 0), 0.3)
      RootJoint.C0 = RootCF * cf(0, 0, -0.5 + 2.5 * i) * euler(0.1 + 9.32 * i, 0, 0)
      RW.C0 = clerp(RW.C0, cf(0.8, 0.5, -0.5) * euler(1.3, 0, -0.6), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(2, 0, 0.785) * euler(0, 0, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(1, -0.6, -0.2) * euler(0, 1.57, 0) * euler(-0.2, 0, -0.2), 0.3)
      LH.C0 = clerp(LH.C0, cf(-1, -0.6, -0.2) * euler(0, -1.57, 0) * euler(-0.2, 0, 0.2), 0.3)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
    ...
    hit = nil
      while hit == nil do
        hit = rayCast(prt5.Position, CFrame.new(prt5.Position, prt5.Position - Vector3.new(0, 1, 0)).lookVector, 4, modelzorz)
        if hit ~= nil and (hit.Parent.className == "Hat" or hit.Name == "Triangle") then
          print("poot")
          hit = nil
        end
        swait()
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      if StaggerHit.Value == true then
        ...
        ref.Anchored = true
        ref.CFrame = cf(pos)
        MagicWave(BrickColor.new("Teal"), cf(ref.Position), 1, 1, 1, 1.2, 0.4, 1.2, 0.05)
        MagniDamage(ref, 20, 5, 10, math.random(40, 60), "Knockdown2", RootPart, 0, 1, (math.random(15, 20)), nil, nil, true, "Damage", 0.1, 300)
        ...
        for i = 0, 1, 0.5 do
          swait()
          RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(-1.57, 0, 0), 0.3)
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              if StaggerHit.Value == true then
                break
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    for i = 0, 1, 0.1 do
      ...
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.2, 0, 0.4), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -0.4) * euler(0, -0.2, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
    ...
    for i = 1, 20 do
      swait()
      MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.5, 5, 0.5, 0.05)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
            break
    ...
    for i = 0, 1, 0.05 do
      ...
      handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.2)
      wld1.C0 = clerp(wld1.C0, cf(0, -0.5, 0) * euler(1, 0, 0), 0.2)
      Neck.C0 = clerp(Neck.C0, necko * euler(-0.2, 0, 0.4), 0.2)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.2), 0.2)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.2, 0, 0.4), 0.2)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(3.5, 0, -0.5) * euler(0, -0.2, 0), 0.2)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
          ...
          -- DECOMPILER ERROR at PC649: LeaveBlock: unexpected jumping out IF_THEN_STMT
    ...
    for i = 0, 1, 0.1 do
      ...
      MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.5, 5, 0.5, 0.05)
      handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.35)
      wld1.C0 = clerp(wld1.C0, cf(0, -0.5, 0) * euler(1.4, 0, 0), 0.35)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.4), 0.35)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.4), 0.35)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.2, 0, 0.6), 0.35)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.4, 0, -0.4) * euler(0, 0, 0), 0.35)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.35)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      if StaggerHit.Value == true then
        ...
        MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(0, 0, 0), 10, 1, 10, -0.1, 6, -0.1, 0.01)
        MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(1.57, 0, 0), 10, 1, 10, -0.1, 6, -0.1, 0.01)
        MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(0, 0, 1.57), 10, 1, 10, -0.1, 6, -0.1, 0.01)
        MagicCircle(BrickColor.new("Teal"), cf(prt5.Position) * euler(0, 0, 1.57), 1, 1, 1, 16, 16, 16, 0.04)
        for i = 1, 10 do
          swait()
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC1003: LeaveBlock: unexpected jumping out IF_THEN_STMT

              -- DECOMPILER ERROR at PC1003: LeaveBlock: unexpected jumping out IF_STMT
        ...
        for i = 1, 10 do
          ...
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC1045: LeaveBlock: unexpected jumping out IF_THEN_STMT

              -- DECOMPILER ERROR at PC1045: LeaveBlock: unexpected jumping out IF_STMT
...
while 1 do
  ...
  stunanim = false
    ...
    do
      ...
      -- DECOMPILER ERROR at PC5374: LeaveBlock: unexpected jumping out DO_STMT
