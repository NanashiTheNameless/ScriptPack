...
as.Kick='46153268'
as.cast='2101137'
as.rockhead= '21057410'
as.rockheadt='133912426'
...
Stay(true,BG.cframe)
    ...
    MeshEffect(35,Torso.CFrame*cn(0,-3.5*Scale,-6*Scale)*ca(90,0,0),nil,v3(2,2,1)*Scale,v3(12,12,5)*Scale,0.2,1,'Royal purple',as.ring)
    wait(0.5)
    for x=1,ASpeed do 
...
MeshEffect(35,Grabbing.Part1.CFrame,nil,v3(2,2,1)*Scale,v3(7,7,3)*Scale,0.3,1,'Royal purple',as.ring)
local crushjo=60
...
MeshEffect(35,pt*cn(0,5,0)*ca(90,0,0),nil,v3(2,2,1)*Scale,v3(7,7,3)*Scale,0.2,1,'Royal purple',as.ring)
else
