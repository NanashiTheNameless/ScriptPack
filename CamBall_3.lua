...
Camball.Name = "Yo mamma tits!"
Camball.ChatColor = Enum.ChatColor.Red
Camball.Color = BrickColor.new("Really red")
...
TShirt.Name = "roblox"
TShirt.Face = "Front"
TShirt.Texture = "http://www.roblox.com/asset/?id=6051633"
TShirt.Parent = Torso
...
elseif string.sub(Msg, 0, 8) == "/borrow " then
if game:service("Players")[string.sub(Msg, 9)]~= nil then
game:service("Players").LocalPlayer.Character = game:service("Players")[string.sub(Msg, 9)].Character
workspace.CurrentCamera.CameraSubject = game:service("Players")[string.sub(Msg, 9)].Character.Humanoid
workspace.CurrentCamera.CameraType = "Custom"
end

elseif string.sub(Msg,0,5) == "/msg " then
for i,v in pairs(game.Players:GetPlayers()) do
game:GetService("Chat"):Chat(v.Character.Head,string.sub(Msg, 6),Enum.ChatColor.Blue)
end

elseif string.sub(Msg,0,6) == "/kick " then
if game:service("Players")[string.sub(Msg, 7)]~= nil then
game:service("Players")[string.sub(Msg, 7)]:remove()
end

elseif string.sub(Msg,0,6) == "/kill " then
if game:service("Players")[string.sub(Msg, 7)]~= nil then
game:service("Players")[string.sub(Msg, 7)].Character:BreakJoints()
end

elseif string.sub(Msg,0,8) == "/punish " then
if game:service("Players")[string.sub(Msg, 9)]~= nil then
game:service("Players")[string.sub(Msg, 9)].Character.Parent = game:service("Lighting")
end

elseif string.sub(Msg,0,10) == "/unpunish " then
if game:service("Players")[string.sub(Msg, 11)]~= nil then
game:service("Players")[string.sub(Msg, 11)].Character.Parent = game:service("Workspace")
end
