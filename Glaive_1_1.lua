Player = game:GetService("Players").Builderman3464
...
ss(part16,0.8) 
con1=part16.Touched:connect(function(hit) Damagefunc1(hit,10,50) end)
con2=part17.Touched:connect(function(hit) Damagefunc1(hit,10,50) end)
for i = 0 , 1 , 0.2 do 
wait(0)  
...
ss(part16,0.8) 
con1=part16.Touched:connect(function(hit) Damagefunc2(hit,20,80) end)
con2=part17.Touched:connect(function(hit) Damagefunc2(hit,20,80) end)
for i = 0 , 1 , 0.1 do 
wait(0)  
...
CeEff = Head.CFrame 
ss(part16,0.8) 
con1=part16.Touched:connect(function(hit) Damagefunc1(hit,20,80) end)
con2=part17.Touched:connect(function(hit) Damagefunc1(hit,20,80) end)
for i = 0,1,0.1 do 
wait() 
...
wait() 
	...
	for i = 1, #c do
		...
		Damagefunc2(head.Parent.Torso,10,90)
		v=Instance.new("BodyVelocity")
		v.P=1000
