--[[
 This is the next f(_)cking script: Tesla Cannon; fires a bolt of electricity bound to fry anyone or anything it hits.
--]]
...
DC = BrickColor.new("Lime green")
GC = BrickColor.new("Lime green")
MR = 0
GR = 0
WSPenalty = 5
selected = false
...
function makeParts(format)
        ...
        if format ~= nil then
                ...
                elseif format == "RightHolster" then
                        ...
                        w.C0 = CFrame.new(-0.65, 1, 0) * CFrame.fromEulerAnglesXYZ(math.rad(-40), math.rad(90), 0)
                        w.C1 = CFrame.new()
        ...
        m.MeshType = "Brick"
        m.Scale = Vector3.new(0.29, 0.35, 0.7)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        m.Scale = Vector3.new(0.4, 0.8, 0.4)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, 0.11, -0.2) * CFrame.fromEulerAnglesXYZ(math.rad(-20), 0, 0)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "EndBack"
        ...
        p.Parent = model
        local m = Instance.new("CylinderMesh")
        m.Scale = Vector3.new(0.65, 0.8, 0.64)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, 3.2, 0) * CFrame.fromEulerAnglesXYZ(math.rad(180), 0, 0)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "Center"
        ...
        p.Parent = model
        local m = Instance.new("CylinderMesh")
        m.Scale = Vector3.new(0.1, 4, 0.1)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0.15, -1.2, 0.15)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "Pipe"
        ...
        p.Parent = model
        local m = Instance.new("CylinderMesh")
        m.Scale = Vector3.new(0.51, 0.4, 0.51)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("CylinderMesh")
        m.Scale = Vector3.new(0.64, 0.8, 0.64)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        f.Enabled = false
        f.Name = "Fire"
        f.Color = Color3.new(0 / 0, 0 / 0, 0 / 0)
        f.SecondaryColor = Color3.new(0 / 0, 0 / 0, 0 / 0)
        f.Heat = -35
        f.Size = 1
        f.Parent = p
        local p = Instance.new("Part")
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.1, 0.32, 0.4)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0.1, 0, 0.36)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.36, 0.4, 0.26)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, -0.4, 0.475)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "Scope End W" --End = Back
        p.formFactor = "Symmetric"
        p.Size = Vector3.new(1, 1, 1)
        p.BrickColor = BrickColor.new("Lime green")
        p.Reflectance = 0.5
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.3, 0.4, 0.2)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, -0.402, 0.475)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "Scope Front W"
        p.formFactor = "Symmetric"
        p.Size = Vector3.new(1, 1, 1)
        p.BrickColor = BrickColor.new("Lime green")
        p.Reflectance = 0.5
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.3, 0.7, 0.22)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, 0, 0.475)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
...
function playAnimation(format, mouse)
        ...
        if format == "fire" then
                Player.Character[Name].Bolt.Transparency = 0.8
                ...
                if Player.Character[Name]:FindFirstChild("Muzzle") ~= nil then
                        coroutine.resume(coroutine.create(function() Player.Character[Name].Muzzle.Smoke.Enabled = true Player.Character[Name].Muzzle.Fire.Enabled = true wait(0.8) Player.Character[Name].Muzzle.Smoke.Enabled = false Player.Character[Name].Muzzle.Fire.Enabled = false end))
                else return false end
                for i = 0, 10, 5 do
                        if Player.Character:FindFirstChild("Torso") ~= nil then
                                if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil and Player.Character.Torso:FindFirstChild("Right Shoulder 2") ~= nil then
                ...
                Player.Character[Name].Bolt.Transparency = 1
        end
        return true
end
...
function makeShell(part)
        ...
        casing.BrickColor = BrickColor.new("White")
        local mesh = Instance.new("CylinderMesh")
        mesh.Scale = Vector3.new(0.6, 1, 0.6)
        mesh.Parent = casing
        casing.Parent = game:GetService("Workspace")
        casing:BreakJoints()
        casing.Velocity = (part.CFrame.lookVector * 50) + Vector3.new(-10, 0, 0)
...
function fire(startPoint, endPoint, hit)
        ...
        mesh.MeshType = "Brick"
        mesh.Scale = Vector3.new(0.5, 0.5, (startPoint - endPoint).magnitude)
        mesh.Parent = trail
        ...
        if hit ~= nil then
                ...
                if hit.Anchored == false then
                        hit.Velocity = hit.Velocity + ((endPoint - startPoint).unit * (damage * 10))
                end
        end
end
        ...
        if Player.Character:FindFirstChild(Name) ~= nil and Button1Down == false and canFire == true and (function() if dual == true then if Player.Character:FindFirstChild(Name.. " (Left)") ~= nil then return true else return false end else return true end end)() == true then
                ...
                while canFire2 == true do
                        ...
                        if magazine.Value > 0 then
                                ...
                                --Player.Character[Name].BoltB.Transparency = 0
                                --Player.Character[Name].BoltC.Transparency = 1
                        end
