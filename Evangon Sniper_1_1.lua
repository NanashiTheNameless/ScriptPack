--[[Evangon's Sniper. Made by Evangon]]-- 
Name = "*{Evangon's Sniper}*"
if script.Parent.className ~= "HopperBin" then 
local Bin = Instance.new("HopperBin") 
Bin.Parent = game:GetService("Players").lordsheen.Backpack 
Bin.Name = "*{Gun}*"
script.Parent = Bin
end 
...
Model.Parent = game:service("Players").lordsheen.Character
Model.Name = Name
...
HW.Parent = Handle
HW.Part0 = Handle
HW.Part1 = game:service("Players").lordsheen.Character["Torso"]
HW.C0 = CFrame.new(1.5,-0.5,2)
pcall(function() game:service("Players").lordsheen.Character["Left Arm"]:Remove() end)
...
if v.className == "Model" and v.Name ~= "lordsheen" then
