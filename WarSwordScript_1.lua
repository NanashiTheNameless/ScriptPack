--MADE BY BRICKER24alt (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 3,4,7,8,21, and 22 and put your name where it says "BRICKER24alt"

while game.Players.BRICKER24alt.PlayerGui:FindFirstChild("BRICKER24alt's Sword") == nil do
wait()
if game.Players.BRICKER24alt.PlayerGui:FindFirstChild("BRICKER24alt's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.BRICKER24alt.PlayerGui
screengui.Name = "BRICKER24alts's Sword"
...
bl = game.Players.BRICKER24alt.Backpack
