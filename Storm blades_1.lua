...
RH = Torso["Right Hip"] 
bladecolor = BrickColor.new("Dark stone grey") 
attack = false 
...
prt3.BrickColor = BrickColor.new("Brown") 
prt3.Name = "Part1" 
...
prt4.BrickColor = BrickColor.new("Brown") 
prt4.Name = "Part2" 
...
if key == "f" then 
if DemonizeUpgraded.Value == true then 
demonize() 
end 
end 
if key == "g" then 
...
if key == "z" then 
if MegaChargeUpgraded.Value == true then 
if mode == 0 then 
bewmstab() 
elseif mode == 1 then 
testy() 
...
if key == "j" then 
if StormPikeUpgraded.Value == true then 
switch() 
end 
end 
end 
