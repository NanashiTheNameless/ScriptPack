...
local EnergyBlade  = Instance.new("Part", m)
			...
			EnergyBlade.BrickColor = TorsoColor
...
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,-1.5),.3)
...
so("http://roblox.com/asset/?id=200632211",Torso,1,.75) 
swait(5)
con1=Hitbox.Touched:connect(function(hit) Damagefunc(hit,10,20,math.random(5,10),"Normal",RootPart,.2,1) end) 
for i=0,1,0.1 do
swait()
...
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,-1.4+6*i),.3)
...
so("http://roblox.com/asset/?id=233856140",Hitbox,1,0.8) 
for i=0,1,0.1 do
swait() 
--wld1.C0=clerp(wld1.C0,euler(2.2,0,0)*cf(0,.8,-0.3),.3)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*euler(0,0,1.4)*euler(0.4,0,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,-1.4),.3)
--RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,-1.3)*euler(0,0,-1.4),.3)
RW.C0=clerp(RW.C0,cf(.5,0.2,-0.5)*euler(3,-1.4,0)*euler(-2.7,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.2,0.1,-0.3)*euler(0,-1.4,0)*euler(.5,0,0),.3)
RH.C0=clerp(RH.C0,cf(1,-1,0)*euler(0,1.57,0),.3)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*euler(0,-1.57,0),.3)
...
function attackone()
    ...
    for i=0,1,0.1 do
            ...
            RH.C0=clerp(RH.C0,cf(1,-1,0)*euler(0,1.57,0)*euler(-.2,0,0),.3)
            LH.C0=clerp(LH.C0,cf(-1,-1,0)*euler(0,-1.57,0)*euler(-.2,0,0),.3)
			Handleweld.C0=clerp(Handleweld.C0,cf(0,0,0)*angles(math.rad(20),math.rad(0),math.rad(0)),.5)
    end
...
so("http://roblox.com/asset/?id=233856140",Hitbox,1,1) 
    for i=0,1,0.1 do
            ...
            RH.C0=clerp(RH.C0,cf(1,-1,0)*euler(0,1.57,0)*euler(-.2,0,0),.3)
            LH.C0=clerp(LH.C0,cf(-1,-1,0)*euler(0,-1.57,0)*euler(-.2,0,0),.3)
			Handleweld.C0=clerp(Handleweld.C0,cf(0,0,-1)*angles(math.rad(-40),math.rad(0),math.rad(0)),.5)
    end
attack=false
atktype(1, 2)
con1:disconnect()
...
function attacktwo()
    ...
    for i=0,1,0.1 do
            swait()
            Neck.C0=clerp(Neck.C0,necko*euler(0.1,0.1,1),.3)
            RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,-1),.3)
            RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(0,-1,1),.3)
            RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
            LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(1,0,0.5),.3)
            LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
            RH.C0=clerp(RH.C0,cf(1,-1,0)*euler(0,1.57,0)*euler(-.2,0,0),.3)
            LH.C0=clerp(LH.C0,cf(-1,-1,0)*euler(0,-1.57,0)*euler(-.2,0,0),.3)
		Handleweld.C0=clerp(Handleweld.C0,cf(0,0,0)*angles(math.rad(20),math.rad(0),math.rad(0)),.5)
    end
so("http://roblox.com/asset/?id=233856140",Hitbox,1,0.85)
con1=Hitbox.Touched:connect(function(hit) Damagefunc(hit,5,10,math.random(5,10),"Normal",RootPart,.2,1) end) 
    for i=0,1,0.1 do
            swait()
            Neck.C0=clerp(Neck.C0,necko*euler(-0.1,0.1,-1),.3)
            RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,1),.3)
            RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(0,1,1.6),.3)
            RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
...
con1=Hitbox.Touched:connect(function(hit) Damagefunc(hit,5,10,math.random(5,10),"Normal",RootPart,.2,1) end) 
    for i=0,1,0.1 do
            ...
            RW.C0=clerp(RW.C0,cf(1,0.5,-0.5)*euler(1.2,0,-1.2)*euler(0,-1.2,0),.3)
            RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
            LW.C0=clerp(LW.C0,cf(-1.4,0.5,-.2)*euler(-.4,0,-.7)*euler(0,0,0),.3)
            LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
            RH.C0=clerp(RH.C0,cf(1,-1,0)*euler(0,1.57,0)*euler(-.2,0,0),.3)
            LH.C0=clerp(LH.C0,cf(-1,-1,0)*euler(0,-1.57,0)*euler(-.2,0,0),.3)
			Handleweld.C0=clerp(Handleweld.C0,cf(0,0,-1)*angles(math.rad(-40),math.rad(0),math.rad(0)),.5)
...
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0+6*i,9,0),.3)
...
if attack==false then
Humanoid.WalkSpeed = 100
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,-0.5)*angles(math.rad(0),math.rad(0),math.rad(-30)),.3)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(10-2.5*math.cos(sine/40)),math.rad(0),math.rad(30)),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*angles(math.rad(10+5*math.cos(sine/40)),math.rad(-15),math.rad(15+5*math.cos(sine/40))),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*angles(math.rad(5+5*math.cos(sine/40)),math.rad(0),math.rad(-10-5*math.cos(sine/40))),.3)
RH.C0=clerp(RH.C0,cf(1,-1,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-10),math.rad(0),math.rad(-50)),.3)
LH.C0=clerp(LH.C0,cf(-1.1,-0.6,-0.75)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(0),math.rad(0),math.rad(-5)),.3)
Handleweld.C0=clerp(Handleweld.C0,cf(0,0,0)*angles(math.rad(-20),math.rad(0),math.rad(0)),.5)
end
elseif torvel>2 and torvel<22 and hitfloor~=nil then
Anim="Walk"
if attack==false then
RootJoint.C0=clerp(RootJoint.C0,RootCF*angles(math.rad(15),math.rad(0),math.rad(-45)),.3)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(45)),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*angles(math.rad(-25-2.5*math.cos(sine/20)),math.rad(-30-2.5*math.cos(sine/20)),math.rad(25+2.5*math.cos(sine/20))),.3)
LW.C0=clerp(LW.C0,cf(-1,0.5,-0.5)*angles(math.rad(90-5*math.cos(sine/20)),math.rad(0),math.rad(50-5*math.cos(sine/40))),.3)
RH.C0=clerp(RH.C0,cf(1,-1,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
Handleweld.C0=clerp(Handleweld.C0,cf(0,-2,0)*angles(math.rad(-180),math.rad(0),math.rad(0)),.5)
end
elseif torvel>=22 and hitfloor~=nil then
Anim="Run"
if attack==false then
RootJoint.C0=clerp(RootJoint.C0,RootCF*angles(math.rad(25),math.rad(0),math.rad(-60)),.3)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-10),math.rad(-10),math.rad(60)),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*angles(math.rad(-35-2.5*math.cos(sine/20)),math.rad(-40-2.5*math.cos(sine/20)),math.rad(35+2.5*math.cos(sine/20))),.3)
LW.C0=clerp(LW.C0,cf(-1,0.5,-0.5)*angles(math.rad(90-5*math.cos(sine/20)),math.rad(0),math.rad(50-5*math.cos(sine/20))),.3)
RH.C0=clerp(RH.C0,cf(1,-1,0)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
Handleweld.C0=clerp(Handleweld.C0,cf(0,-2,0)*angles(math.rad(-180),math.rad(0),math.rad(0)),.5)
end
