...
if User.Name == "kash5" then
-------------------------------
--GO TO LInE 2 and replace coolboyjake1 with ur name--
-------------------------------
...
TailDecoration.BrickColor = BrickColor.new("White")
...
--------------------
for i = 2, 12 do
TailParts[i].BrickColor = BrickColor.new("White")
end
TailParts[13].BrickColor = BrickColor.new("Really black")
-----------------------
--Animation Smoothing--
-----------------------
