...
z.SoundId       = "rbxassetid://401120618"--
...
z:Play()
------------------------
game.Chat:Chat(game.Players.LocalPlayer.Character.Head,"MrWolf's Beast Claw.", "Green")
...
Claw = CreatePart2(m, Enum.Material.Neon, 0.30000001192093, 0, "Part", "Industrial black", "Claw", Vector3.new(1, 1, 1))
...
CreateMesh("SpecialMesh", Claw, Enum.MeshType.FileMesh, "http://www.roblox.com/Asset/?id=9756362", Vector3.new(0, 0, 0), Vector3.new(1, 0.709999979, 0.100000001))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 0.200000003))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 1.04200566))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.445813209, 0.210449979, 1.04200566))
...
CreateMesh("BlockMesh", ClawMaterial, "", "", Vector3.new(0, 0, 0), Vector3.new(0.821169853, 0.388499111, 1.00999999))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.664211631, 0.210449979, 1.04200566))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.627083898, 0.210449979, 1.04200566))
...
CreateMesh("BlockMesh", ClawMaterial, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.388499111, 1.00999999))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Industrial White", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 0.329999983))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 0.210450009))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 0.796189725))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 0.524428368))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.231076032, 0.543544471, 0.369591445))
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 1.06329954))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.728394926, 0.35408181, 1.04200566))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 1.04200566))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.231076032, 0.543544471, 0.369591445))
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(0.475480139, 0.404664904, 1.04200566))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.225887179, 0.543544471, 0.369591445))
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "Part", "Really red", "Part", Vector3.new(1.06224263, 1.11860847, 1.04200566))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.225887179, 0.543544471, 0.369591445))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "WedgePart", "Industrial White", "ClawMaterial", Vector3.new(1.0507766, 0.342107773, 0.210450009))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.210449979, 0.210449979, 0.210450009))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Wedge, "", Vector3.new(0, 0, 0), Vector3.new(1, 0.961427808, 0.961421788))
MotorOne = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 1, "Industrial red", "MotorOne", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Shard = CreatePart2(m, Enum.Material.Neon, 0.30000001192093, 0, "Part", "Industrial red", "Shard", Vector3.new(1, 1, 1))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.28999996, 0.319999993))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 2.73999977, 0.339999974))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.28999996, 0.479999989))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.28999996, 0.339999974))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.03999996, 0.480000019))
...
Claw = CreatePart2(m, Enum.Material.Neon, 0.30000001192093, 0, "Part", "Industrial red", "Claw", Vector3.new(1, 1, 1))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 0.370000005, 0.200000003))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 0.200000003, 0.200000003))
...
MotorTwo = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 1, "Industrial red", "MotorTwo", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
CreateMesh("SpecialMesh", Claw, Enum.MeshType.FileMesh, "http://www.roblox.com/Asset/?id=9756362", Vector3.new(0, 0, 0), Vector3.new(2.5, 0.300000012, 0.519999981))
CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 0.370000005, 0.200000003))
...
CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 0.200000003, 0.200000003))
...
MotorThumb = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 0, "Industrial red", "MotorThumb", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.28999996, 0.200000003))
...
Part = CreatePart2(m, Enum.Material.SmoothPlastic, 0, 0, "WedgePart", "Really red", "Part", Vector3.new(0.329999983, 1.03999996, 0.390000015))
...
MotorThumbTwo = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 0, "Industrial red", "MotorThumbTwo", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
if script.ClassName == "LocalScript" then
	game.StarterGui:SetCore("ChatMakeSystemMessage", {
		Text = "Beast Z fixed by norp/end_itt";
