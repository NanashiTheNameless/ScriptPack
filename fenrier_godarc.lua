...
prt6.BrickColor = BrickColor.new("Really red")
prt6.Name = "Part6"
...
prt13.BrickColor = BrickColor.new("Really red")
...
prt15.BrickColor = BrickColor.new("Really red")
...
prt17.BrickColor = BrickColor.new("Really red")
prt17.Name = "Part17"
...
prt18.BrickColor = BrickColor.new("Really red")
prt18.Name = "Part18"
...
prt20.BrickColor = BrickColor.new("Really red")
prt20.Name = "Part20"
...
prt21.BrickColor = BrickColor.new("Really red")
prt21.Name = "Part21"
...
prt22.BrickColor = BrickColor.new("Really red")
prt22.Name = "Part22"
...
prt23.BrickColor = BrickColor.new("Really red")
prt23.Name = "Part23"
...
con1=LeftLeg.Touched:connect(function(hit) Damagefunc2(hit,99999,99999) end)
con2=RightLeg.Touched:connect(function(hit) Damagefunc2(hit,99999,9999) end)
con3=Torso.Touched:connect(function(hit) Damagefunc2(hit,99999,999999) end)
lightning = true
...
ss(1)
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
for i = 0,1,0.2 do
wait()
...
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,9999) end)
for i = 0,1,0.1 do
wait()
...
ss(0.9)
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,99999,9999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,99999,9999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
for i = 0,1,0.2 do
wait()
...
ss(1.2)
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,9999999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,999999,999999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,9999) end)
for i = 0,1,0.2 do
wait()
...
CF = Torso.CFrame
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,999999,99999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
for i = 0,1,0.1 do
wait()
...
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,999999,99999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,99999,999999) end)
ss(1.1)
local vel = Instance.new("BodyGyro")
vel.Parent = Torso
vel.maxTorque = Vector3.new(4e+005,4e+005,4e+005)*math.huge
...
Stun2(prt12,20,40,20,BrickColor.new("Really red"))
end))
wait(0.2)
for i = 0,1,0.1 do
wait()
...
ss(0.8)
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,9999999,999999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,999999,999999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,999999,999999) end)
local vel = Instance.new("BodyGyro")
vel.Parent = Torso
vel.maxTorque = Vector3.new(4e+005,4e+005,4e+005)*math.huge
vel.P = 20e+003
...
ss(0.8)
con1=prt12.Touched:connect(function(hit) Damagefunc1(hit,999999,99999) end)
con2=prt13.Touched:connect(function(hit) Damagefunc1(hit,99999,99999) end)
con3=prt7.Touched:connect(function(hit) Damagefunc1(hit,999999,99999) end)
for i = 0,1,0.05 do
wait()
...
coroutine.resume(coroutine.create(function()
        ...
        for i=0,200 do
        wait()
        DerpMagic(Part,1,i/3,1,0,i/3,0,BrickColor.new("Really red"))
        blackhole=true
        DemMags=DemMags+0.2
        ...
        for i=0,100 do
        wait()
        DerpMagic(Part,1,fff/3,1,0,fff/3,0,BrickColor.new("Really red"))
        Part.CFrame=effectsg.CFrame*CFrame.new(0,0,0)*CFrame.fromEulerAnglesXYZ(math.random(-50,50),math.random(-50,50),math.random(-50,50))
        end
        for i=0,1,0.05 do
        wait()
