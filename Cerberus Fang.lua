...
if key == "p" and not Firing and DCOn and CanUseCannon and Player.UserId == 25084774 or key == "p" and not Firing and DCOn and CanUseCannon and Player.UserId == 25084774 then
	Firing = true
	keyConnect = MMouse.KeyUp:connect(function(key)
	...
	if C == 1 then
		C = 2
		FireLaser(CHole1, math.huge, 300, Vector3.new(150.8,150.8,1186), 6000000, 90000000, 0.05, "You made me do this..", "Planet buster!", true)
	elseif C == 2 then
		C = 1
		FireLaser(CHole2, math.huge, 300, Vector3.new(150.8,150.8,1186), 6000000, 90000000, 0.056, "You made me do this..", "Planet buster!", true)
	end
end
if key == "e" then
