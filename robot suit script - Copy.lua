:ls --MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 5 and 6 and put your name where it says "YOUR NAME HERE"



Names = "luxulux"--------your name goes here
Player = game:GetService("Players").luxulux------your name goes also here
