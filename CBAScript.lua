--MADE BY OneLegend (NOT THE SCRIPT) Credits to CyberFromLU for letting me publish LOCAL SCRIPT: Just hit CNTRL + H and where it says Find what type "BRICKER24alt" and where it says Replace with Put your name.
...
CBA.admins  = {{"BRICKER24alt", 7}, {"hillow25", 4},  {"ghostbusters1", 6}, {"manguy12", 5}, {"chrismash", 5}, {"randomepicnoob",  5}, {"LuaModelMaker", 4}, {"joey2678", 4}, {"RobloxDude10101", 4}, {"ProLevi27", 4}, {"thejonathann", 5}, {"1WOOF1", 4}, {"Penjuin3", 4}, {"thomas0233", 3}}; 
CBA.ablist = {"BRICKER24alt"}; 
CBA.connect = {}
CBA.blocked = {}
