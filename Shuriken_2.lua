...
chak=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Gold") chakw=weld(chak,ha,chak,0,0,0,0,0,0) qi{"SpecialMesh",chak,Scale=v3(1,1,2),MeshId=ids.chakram}
...
p=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Gold") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,MeshId=ids.Diamond,Scale=v3(0.1,0.3,0.3)} 
