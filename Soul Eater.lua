--Your name is there BlackMacLeod
Player = game:GetService("Players").BlackMacLeod
...
function AoECataclysm(p,magnitude,damage,critornot) 
        ...
        if head ~= nil then
                ...
                if mag <= magnitude and c[o].Name ~= Character.Name then
                table.insert(founded,c[o])
                --blast(2.5,0.5,"Really red",prt2,false)
                end
                end
                end
                end
...
for i = 1 , 15 do
local colors = {BrickColor.new("Really red"),BrickColor.new("Bright orange")}
...
earth5.CFrame = CF5
earthm5.Parent = earth5
earth5.BrickColor = BrickColor.new("Really red")
earth5.Transparency = 0.25
                hum:TakeDamage(damage)
                damagesplat(damage,c.Head,critornot)
                table.insert(AoETrue,founded[i].Name)
...
bubblyblast(2.5,0.5,"Really red",prt2,false)
wait(0.1)
bubblyblast(2.5,0.5,"Really red",prt2,false)
wait(0.1)
bubblyblast(2.5,0.5,"Really red",prt2,false)
...
if thing == 1 then
thing = thing + 1
ringblast(2,0.5,"Really red",prt2)
end
end
cs(game.Workspace,1.5)
for i = 0 , 1 , 0.2 do
...
if thing == 1 then
thing = thing + 1
ringblast(3.5,1,"Really red",prt2)
end
end
cs(game.Workspace,1.5)
for i = 0 , 1 , 0.2 do
