:ls --MADE BY YOUR NAME HERE (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 3,4,7,8,21, and 22 and put your name where it says "YOUR NAME HERE"

while game.Players.TheKorbloxCore.PlayerGui:FindFirstChild("TheKorbloxCore's Sword") == nil do
wait()
if game.Players.TheKorbloxCore.PlayerGui:FindFirstChild("TheKorbloxCore's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.TheKorbloxCore.PlayerGui
screengui.Name = "TheKorbloxCore's Sword"
...
bl = game.Players.TheKorbloxCore.Backpack
me = game.Players.TheKorbloxCore
char = me.Character
