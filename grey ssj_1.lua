...
Hair22.BrickColor = BrickColor.new("Black")
Hair22.Reflectance = 0.3
...
Hair4.BrickColor = BrickColor.new("Black")
Hair4.Reflectance = 0.3
...
pie.Size = 9
pie.Color = BrickColor.new("Really black").Color
pie.SecondaryColor = BrickColor.new("Mid gray").Color
pie.SecindarySize = 8
end
...
jun.Chatted:connect(function(Msg)
 msg = Msg:lower()
 if string.sub(msg, 1, 7) == "dssj" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 13) == "dssj" then
 wait(0.1)
  ssj()
 end
