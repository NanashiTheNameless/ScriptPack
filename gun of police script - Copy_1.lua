--HopperBin Pistol Gifted by TheRedAngel, Regular Script!
name = "luxulux"
...
gun3.Name = "Handle3"
gun3:BreakJoints()
gun3.BrickColor = BrickColor.new("Lime green")
...
gun4:BreakJoints()
gun4.BrickColor = BrickColor.new("Lime green")
