...
pl.Staff.Orb1.BrickColor = BrickColor.new("Really Red")
pl.Staff.OrbDeco.BrickColor = BrickColor.new("really red")
pl.Staff.OrbDeco2.BrickColor = BrickColor.new("Really red")
...
pl.Staff.Orb2.BrickColor = BrickColor.new("Really Black")
