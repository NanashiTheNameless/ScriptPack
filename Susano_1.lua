mouse = game.Players.ssddaa3:GetMouse()
 
game:GetService("Chat"):Chat(Workspace.ssddaa3.Head,"It's time Death ended your life...")
wait()
game:GetService("Chat"):Chat(Workspace.ssddaa3.Head,"SUSANOO!")
wait(1)
 
Workspace.ssddaa3.Humanoid.MaxHealth = math.huge
Workspace.ssddaa3.Humanoid.WalkSpeed = 30
Workspace.ssddaa3["Left Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ssddaa3.Torso.BrickColor = BrickColor.new("Cool yellow")
Workspace.ssddaa3.Head.BrickColor = BrickColor.new("Cool yellow")
Workspace.ssddaa3["Right Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ssddaa3["Left Leg"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ssddaa3["Right Leg"].BrickColor = BrickColor.new("Cool yellow")
 
 
-- Main
Handle = Instance.new("Part",Workspace.ssddaa3)
...
Weld = Instance.new("Weld",Workspace.ssddaa3)
Weld.Part0 = game.Workspace.ssddaa3["Torso"]
Weld.Part1 = Handle
Weld.C1 = CFrame.new(0, -3, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)
 
RA = Instance.new("Part",Workspace.ssddaa3)
...
LA = Instance.new("Part",Workspace.ssddaa3)
...
Head = Instance.new("Part",Workspace.ssddaa3)
...
Katana = Instance.new("Part",Workspace.ssddaa3)
...
Sphere = Instance.new("Part",Workspace.ssddaa3)
...
H = Instance.new("Part",Workspace.ssddaa3)
H.TopSurface = "Smooth"
...
Shield = Instance.new("ForceField",Workspace.ssddaa3)
 
Shirt = Instance.new("Shirt",Character)
 
Shirt.Parent = game.Workspace.ssddaa3
...
Pant.Parent = game.Workspace.ssddaa3
