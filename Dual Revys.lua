--[[ Frostftw, Revys Dual Cutlass's <3 ]]--
wait();
...
PA16 = AddPart("Part",GunModelOne,.02,1,.3,"Lime green")
PA16.Mesh.Scale = V3(1.1,.9,1)
WPA16 = AddWeld("Weld",PA16,PA16,HandleOne,CF.new(0,0,0),CF.new(0,0,0))
PA17 = AddPart("Part",GunModelOne,.1,.3,.3,"Lime green")
PA17.Mesh:Remove()
...
PB16 = AddPart("Part",GunModelTwo,.02,1,.3,"Lime green")
PB16.Mesh.Scale = V3(1.1,.9,1)
WPB16 = AddWeld("Weld",PB16,PB16,HandleTwo,CF.new(0,0,0),CF.new(0,0,0))
PB17 = AddPart("Part",GunModelTwo,.1,.3,.3,"Lime green")
PB17.Mesh:Remove()
