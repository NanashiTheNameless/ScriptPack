...
if ForceField == true then return end
Energy = Energy - 0
...
function __ForceField()
if Energy < 45 then return end
if ManaExplosion == true then return end
if Regening == true then return end
if ForceField == true then return end
ForceField = true
humanoid.WalkSpeed = 0
Energy = Energy - 0
local Force_Field = Instance.new('Part',LocalPlayer.Character.Torso)
Force_Field.CFrame = LocalPlayer.Character['Left Leg'].CFrame
Force_Field.Transparency = 0.7
Force_Field.TopSurface = 0
Force_Field.BottomSurface = 0
Force_Field.Anchored = true
Force_Field.Shape = 'Ball'
Force_Field.FormFactor = 'Custom'
Force_Field.CanCollide = false
Force_Field.BrickColor = BrickColor.new('Deep blue')
local FF_Mesh = Instance.new('SpecialMesh',Force_Field)
FF_Mesh.MeshType = 'Sphere'
FF_Mesh.Scale = Vector3.new(0,0,0)
Force_Field.Touched:connect(function(what)
print(what.Name)
...
for i = 0,15,0.1 do
FF_Mesh.Scale = Vector3.new(i,i,i)
wait()
end
for i = 15,0,-0.1 do
FF_Mesh.Scale = Vector3.new(i,i,i)
...
p.Parent = workspace
p.Position = LocalPlayer.Character['Right Arm'].Position
p.CanCollide = true
...
elseif Mode == 'ForceField' then
TEXTLABEL3.Text = 'Spell: Force Field (45 mana)'
end
...
elseif mg > 2 and mg < 40 then-- walk
...
rj.C0 = rootc0 * CFrame.Angles(0, 0, 0)
elseif mg > 40 then--run
countspeed = 8
rlegm.C0 = rlc0 * CFrame.Angles(-angle*0.200, 0, 0)
llegm.C0 = llc0 * CFrame.Angles(angle*0.200, 0, 0)
neck.C0 = neckc0 * CFrame.Angles(math.rad(-40), 0, 0)
lm.C0 = lsc0 * CFrame.Angles(-math.rad(50)-(angle*0.100), 0, 0)
rm.C0 = rsc0 * CFrame.Angles(-math.rad(50)+(angle*0.100), 0, 0)
rj.C0 = rootc0 * CFrame.Angles(math.rad(40), 0, (angle*0.100))
end
end
end)()
--[[
The script can't be local if you run with http service
