--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 12 and put your name where it says "YOUR NAME HERE"
--[[
American M249 Squad Automatic Weapon, derived from the Fabrique National Minimi, using 
key design elements from the older M60, it maintains a relatively smaller profile and 
sacrifices power for speed and accuracy.
--]]
...
Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("dylanmillicankid")
Name = "M249"
