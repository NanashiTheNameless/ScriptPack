...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=397040429"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=397040429"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
char["Moon Seeing Stars"].Handle.Mesh.Scale = char["Moon Seeing Stars"].Handle.Mesh.Scale * 3.2
char["Moon Seeing Stars"].Handle.Mesh.VertexColor = Vector3.new(1,1,1)
...
z.SoundId = "rbxassetid://289054567 "--242463565
z.Looped = true
z.Pitch = 1
z.Volume = 10
wait(.01)
