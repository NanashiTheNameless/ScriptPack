...
local sig1 = Instance.new("Part") 
sig1.Name = "Handle" 
sig1.Parent = Workspace.acb227 
sig1.Size = Vector3.new(1,1,1) 
sig1.formFactor = "Brick" 
sig1.BrickColor = BrickColor.new("White") 
sig1.TopSurface = "Smooth" 
sig1.BottomSurface = "Smooth" 
sig1.Transparency = 0 
sig1.Reflectance = 0 
---------------------mesh 
...
local sig2 = Instance.new("Part") 
sig2.Name = "Handlee" 
sig2.Parent = Workspace.acb227 
sig2.Size = Vector3.new(1,1,1) 
sig2.formFactor = "Brick" 
sig2.BrickColor = BrickColor.new("Bright orange") 
sig2.TopSurface = "Smooth" 
sig2.BottomSurface = "Smooth" 
sig2.Transparency = 0 
sig2.Reflectance = 0 
---------------------mesh 
m = Instance.new("CylinderMesh") 
