...
--------------------------------------------------------
    ...
    b.Size = UDim2.new(5, 0, 5, 0)
        f.TextColor3 = Color3.new(100/255,0/255,0/255)
    ...
    b.Adornee = hed
        ...
        f.Text = "Chara"
--------------------------------------------------------
--hed.Face.TextureId = "http://www.roblox.com/asset/?id=381193106"
hed.face.Texture = "rbxassetid://381193198"
--------------------------------------------------------
--[[h1 = Instance.new("Hat",workspace)
m1 = Instance.new("Part",h1)
--m1.Name="Hair1"
m1.Name="Handle"
m1.Transparency=0
m1.Position= hed.Position
hm1 = Instance.new("SpecialMesh",m1)
hm1.MeshId = "http://www.roblox.com/asset/?id=74868480"
hm1.TextureId = "http://www.roblox.com/asset/?id=75975464"

h2 = Instance.new("Hat",workspace)
m2 = Instance.new("Part",h2)
m2.Position= hed.Position
--m2.Name="Hair2"
m2.Name="Handle"
m2.Transparency=0
hm2 = Instance.new("SpecialMesh",m2)
hm2.MeshId = "http://www.roblox.com/asset/?id=250264520"
hm2.TextureId = "http://www.roblox.com/asset/?id=75975464"
TI1 = Instance.new("TouchTransmitter",m1)
TI2 = Instance.new("TouchTransmitter",m2)
TI1.Name="TouchInterest"
TI2.Name="TouchInterest" ]]
--------------------------------------------------------
c.Shirt:Destroy()
c.Pants:Destroy()
...
s.ShirtTemplate = "http://www.roblox.com/asset/?id=344089667"
p.PantsTemplate = "http://www.roblox.com/asset/?id=344084364"
s.Name="Shirt"
p.Name="Pants"
--------------------------------------------------------
	...
	m.MeshType = "FileMesh"
	m.VertexColor = Vector3.new(5,0,0)
	--m.Scale = Vector3.new(1.5,2.3,2.3)
	m.Scale = Vector3.new(1.2,1.2,1.2)
	m.MeshId = "http://www.roblox.com/asset/?id=24712232"
    m.TextureId = "http://www.roblox.com/asset/?id=24712222"
...
meme.SoundId = "rbxassetid://399570826"
meme.Volume = 1

local meme1 = Instance.new("Sound",c)
meme1.SoundId = "rbxassetid://354742306"
meme1.Volume = 1

local meme2 = Instance.new("Sound",c)
meme2.SoundId = "rbxassetid://320355925"
meme2.Volume = 1
	...
	uinps.InputBegan:connect(function(InputObject)
		if InputObject.KeyCode == Enum.KeyCode.F and Debounces.isTyping == false then
meme:Stop()
meme1:Stop()
meme2:Stop()
		end
	...
	uinps.InputBegan:connect(function(InputObject)
		if InputObject.KeyCode == Enum.KeyCode.G and Debounces.isTyping == false then
meme:Play()
		end
	end)

	uinps.InputBegan:connect(function(InputObject)
		if InputObject.KeyCode == Enum.KeyCode.H and Debounces.isTyping == false then
meme1:Play()
		end
	end)
...
hed.face.Texture = "http://www.roblox.com/asset/?id=381193198"
				changeColor("Still")
			elseif InputObj.KeyCode == Enum.KeyCode.X and Debounces.SwitchingModes == false then
hed.face.Texture = "http://www.roblox.com/asset/?id=381193138"
				changeColor("Blue")
