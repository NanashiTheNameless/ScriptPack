--[[ | II Nation II Owner | Special thanks to : doforgetme ]]--

if script.Name == "II Nation II" then
loadstring(script.source.Value)()
else

Version = "16.0"
Players = game:GetService("Players")
LocalPlayer = Players.matthuio
Camera = workspace.CurrentCamera
script.Name = "II Nation II"
...
pn= LocalPlayer.Name
if pn ~= "doforgetme" and pn ~= "matthuio" and pn ~= "xD3athted" then
...
Text2.Text = "II Nation II by doforgetme has successfully been installed to your player."
...
Output("doforgetme Rules You",{Color3.new(1,0,0)},LocalPlayer)
Output("II Nation II "..Version.." loaded sucuessfully.",{Color3.new(1,0,0)},LocalPlayer)
print("doforgetme Is A Boss.")
