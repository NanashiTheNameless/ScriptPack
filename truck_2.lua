...
Health = 2500
MaxHealth = 2500
ToughnessMinorDamage = 350
ToughnessMajorDamage = 450

DriftCheck = 0
Drifting = true 
DriftAcceleration = 0.15
DriftSteerDifficulty = 0.00025
DriftSteerPower = 7500
...
MasterColor = BrickColor.new("Bright red")
...
hov.Parent = Base 
hov.maxForce = Vector3.new(1000, 0, 1000) 
hov.position = Base.Position + Vector3.new(Base.Position.X, 2, Base.Position.Z) 
...
coroutine.wrap(function(Part2, Weld2)
	...
	Open.MouseClick:connect(function()
		...
		Part2.BrickColor = HeadlightsOn == true and BrickColor.new("Indistrial white") or BrickColor.new("New Yeller")
		coroutine.wrap(function()
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(-5, 1.75, 14.5)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(0, 1.25, 10.75) * CFrame.fromEulerAnglesXYZ(math.rad(180), 0, 0)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(-5, 1.25, 13.25) * CFrame.fromEulerAnglesXYZ(math.rad(180), math.rad(180), 0)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(0, 0.25, 8.25)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(-3.75, 1.5, 6.5)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(0, 1.5, 5) * CFrame.fromEulerAnglesXYZ(0, math.rad(180), 0)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(0, 2.751, 8.5)
...
Weld.Part1 = Part
Weld.C0 = CFrame.new(0, -1.25, 4.02)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(-4.375, 1.75, 15.5)
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(-5, 1.25, 15.5)
coroutine.wrap(function(Part2)
	while true do
...
Weld.Part0 = Base
Weld.Part1 = Part
Weld.C0 = CFrame.new(5, 0, 15) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(90))
...
Vehicle:MoveTo((workspace:FindFirstChild("acb227") == nil and Vector3.new() or workspace.acb227.Torso.CFrame.p) + Vector3.new(9, 3, 0))
