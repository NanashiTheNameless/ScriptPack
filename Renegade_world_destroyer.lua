...
local fenbarblock3 = gui("TextLabel", fenframe, "Pursuit(" .. pursuitnum .. ")", 1, Color3.new(0, 0, 0), UDim2.new(-0.7, 0, 0.2, 0), UDim2.new(0.4, 0, 0.2, 0))
...
attackone = function()
  ...
  for i = 0, 1, 0.15 do
    ...
    hitboxCF = prt6.CFrame * euler(-0.3, 0, 0) * cf(0, 0, -2.2) 
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 4, 5, 7, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, nil, true)
...
if not buff then
  buff = true
fenbarmove1b.BackgroundColor3 = BrickColor.new("Really black").Color
fenbarmove2b.BackgroundColor3 = BrickColor.new("Really black").Color
else
  buff = false
end
end
...
if mana.Value > 20 then
	   attack = true
          for i = 0, 1, 0.05 do
            ...
            MagniDamage(hitbox, hitbox.Size.Y, 8, 15, math.random(20, 40), "Normal", ref, 1, 2, (math.random(5, 8)), nil, false, true)
          end
          hitbox.Parent = modelzorz
          hitbox.Size = vt()
          hitboxweld()
...
Circle = MagicCircle(BrickColor.new("Really black"), cf(MMouse.hit.p), 100, 1, 100, 0, 0, 0, 0.05)
MagicBlock(BrickColor.new("Bright red"), cf(Circle.Position), 3, 3, 3, 5, 5, 5, 0.05, 1)
MagniDamage(Circle, 10, 11, 15, math.random(5, 10), "Shatter", RootPart, 0.5, 2, (math.random(5, 8)), nil, true, true)

if buff then
coroutine.resume(coroutine.create(function()
for i = 1,10 do
wait()
a1 = MagicCircle(BrickColor.new("Really red"), Circle.CFrame * CFrame.new(math.random(-5,5),0,math.random(-5,5)) * euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)), 1, 5, 1, -0.01,1, -0.01, 0.01)	
MagniDamage(a1, 10, 1, 3, math.random(5, 10), "Shatter", RootPart, 0.5, 2, (math.random(5, 8)), nil, nil, true)
              ...
              for i = 0, 1, 0.05 do
                ...
                MagniDamage(hitbox, hitbox.Size.Y, 5, 10, math.random(20, 40), "Normal", ref, 1, 2, (math.random(5, 8)), nil, false, true, "Movement", 0.4, 200)
              end
              hitbox.Parent = modelzorz
              hitbox.Size = vt()
              hitboxweld()
...
if buff then
      ...
      a1 = MagicCircle(BrickColor.new("Really red"), hitbox2.CFrame * CFrame.new(0,10,0) * euler(-0.6, 0, 0), 5, 5, 5, -0.05, 3, -0.05, 0.01)
    MagniDamage(a1, 20, 5, 6, math.random(5, 10), "Normal", RootPart, 0.3, 2, (math.random(4, 6)),nil, nil, true)
end
 MagicBlock(BrickColor.new("Bright red"), cf(hitbox.Position), 3, 3, 3, 1, 1, 1, 0.1, 1)
          MagicBlock(BrickColor.new("Black"), cf(hitbox.Position), 3, 3, 3, 1, 1, 1, 0.1, 3)
    hitboxCF = prt6.CFrame * euler(-0.3, 0, 0) * cf(0, 0, -2.2)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 4, 5, 6, math.random(5, 10), "Normal", RootPart, 0.3, 2, (math.random(4, 6)), nil, true)
    handlewld.C0 = clerp(handlewld.C0, euler(0, 0, 0) * cf(0, 1, 0), 0.4)
...
do3 = function()
 ...
 a1 = MagicCircle(BrickColor.new("Really red"), hitbox2.CFrame * CFrame.new(0,0,0) * euler(math.random(),math.random(),math.random()), 1, 5, 1, -0.01,1, -0.01, 0.01)

      so("92597369", prt6, 1, 0.8)
      so("92597296", prt6, 1, 1)
    hitboxCF = prt6.CFrame * euler(-0.3, 0, 0) * cf(0, 0, -2.2)
    hitbox.CFrame = hitboxCF
  MagniDamage(a1, 4, 3, 6, math.random(5, 10), "Ranged", RootPart, 0.2, 2, (math.random(2, 5)), nil, nil, true)
handlewld.C0 = clerp(handlewld.C0, euler(0, 0, 0) * cf(0, 1, 0), 0.5)
    wld1.C0 = euler(22 * i, -1.57 + 1.7 * i, 0) * euler(0, 0, 0) * cf(0, 0, 0) * euler(2.5 - 0.93 * i, 0, 0)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1) * euler(0, 0, 0), 0.5)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1), 0.5)
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    for i = 0, 1, 0.05 do
      ...
      hitboxCF = prt6.CFrame * euler(-0.3, 0, 0) * cf(0, 0, -2.2)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 20, 20, 0, "Normal", RootPart, 1, 1, (math.random(10, 20)), nil, nil, false, nil, nil, nil, true, true)
      handlewld.C0 = clerp(handlewld.C0, euler(0, 0, 0) * cf(0, 1, 0), 0.4)
...
mana.Value = mana.Value - 20
    ...
    for i = 1, 0, -0.08 do
      ...
      if da <= 5 then
        hitboxCF = prt6.CFrame * euler(-0.3, 0, 0) * cf(0, 0, -2.2)
        hitbox.CFrame = hitboxCF
        MagniDamage(hitbox, 6, 20, 20, math.random(30, 50), "Normal", Torso, 1, 1, (math.random(30, 40)), nil, nil, false, nil, nil, nil, true, true)
      end
...
mana.Value = mana.Value - 15
    for i = 0, 1, 0.05 do
      ...
      MagniDamage(hitbox, 6, 10, 10, math.random(30, 50), "Normal", RootPart, 1, 1, (math.random(10, 20)), nil, nil, false, nil, nil, nil, true, true)
...
key = function(key)
  ...
  if key == "e" and pursuitnum > 99 then
    RangeBuff()
  end
...
while 1 do
  swait()
if pursuitnum > 99 and not buff then
pursuitnum = 100	
  ...
  stunanim = false
      ...
      do
        ...
        fenbarblock2:TweenSize((UDim2.new(0.4, 0, -4 * pursuitnum / 100, 0)), nil, 1, 0.4, true)
        fenbarblock3.Text = "Chaos(" .. pursuitnum .. ")"
