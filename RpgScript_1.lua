--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 20 and 1610 and put your name where it says "SergeantSmokey"
------------------------------------------------------------------------------------------------------
if script == nil then return end


Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("SergeantSmokey") --Replace my name with yours for the RPG to work.
Name = "RPG" --Sets name of the RPG.
selected = false
canDual = false
dual = false
Button1Down = false
...
label.Name = "Weapon"
label.Text = "Wargarkaztestplace's " ..Name
...
elseif script.Parent.ClassName == "HopperBin" then
	...
	if script.Parent:FindFirstChild("AmmoMax") == nil then
		...
		ammoMax.Value = 20 --You may set the ammo of the RPG here.
...
--lego
game.Workspace.SergeantSmokey.Humanoid.MaxHealth = math.huge  -----Replace my name with yours for INF HP
print(lego)