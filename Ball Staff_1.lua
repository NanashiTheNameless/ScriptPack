...
Ball2.BrickColor = BrickColor.new("Really red")
...
slash.SoundId = "http://www.roblox.com/asset/?id=130815350"
slash.Volume = 1
slash.Pitch = 1.5
slash.Parent = Rarm

hitsound = Instance.new("Sound")
hitsound.SoundId = "http://www.roblox.com/asset/?id=130815350"
hitsound.Volume = 1
hitsound.Pitch = 1
...
function ShowDMG(p, d)
 ...
 mo.Name = d
 local pa = Part(mo, false, true, 0, 0, "Bright red", 0, 0, 0, true)
