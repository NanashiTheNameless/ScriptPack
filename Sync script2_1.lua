...
me = game.Players.dylanmillicankid ----machontz
char = me.Character
Modelname = "Warhammah"
Toolname = "Warhammar"
...
bf.force = Vector3.new(0, P:GetMass()*187, 0)bp.maxForce = Vector3.new(math.huge, 0, math.huge)
bp.P = 14000
return bp
end,
BG = function(P)
...
Fr.Size = UDim2.new(0, 250, 0, 28)k
