...
RABrick = Part(Mo, false, false, 1, 0, "Navy blue", 0.1, 0.1, 0.1, true)
LABrick = Part(Mo, false, false, 1, 0, "Bright blue", 0.1, 0.1, 0.1, true)
RLBrick = Part(Mo, false, false, 1, 0, "Bright blue", 0.1, 0.1, 0.1, true)
LLBrick = Part(Mo, false, false, 1, 0, "Bright blue", 0.1, 0.1, 0.1, true)
...
HB = Part(Mo, false, false, 1, 0, "Bright blue", 0.1, 0.1, 0.1, true)
...
handle = Part(Mo, false, false, 0, 0, "Bright blue", 0.4, 5, 0.4, true)
handle.Name = "Handle"
Instance.new("SpecialMesh",handle)

maintip = Part(Mo, false, false, 1, 0, "Bright blue", 0.6, 0.5, 0.6, true)
Weld(handle, maintip, 0, -1.8, 0, 0, 0, 0)

DMGParts = {}

for i = 0, 135, 45 do
local tip = Part(Mo, false, false, 0, 0, "Bright blue", 0.54, 1.3, 2.2, true)
...
local spike = Part(Mo, false, false, 0, 0, "Bright blue", 0.3, 0.5, 0.3, true)
...
spiketip = Part(Mo, false, false, 0, 0.2, "Bright blue", 0.3, 0.8, 0.3, true)
...
local handletip1 = Part(Mo, false, false, 0, 0.2, "Bright blue", 0.5, 0.5, 0.5, true)
...
local handletip2 = Part(Mo, false, false, 0, 0.2, "Bright blue", 0.5, 0.5, 0.5, true)
...
local p = Part(workspace, true, false, 0.1, 0, "Bright blue", 1, 1, 1, true)
local m = Instance.new("SpecialMesh",p)
...
local partie = Part(workspace, true, false, 1, 0, "New Yeller", siz, 0.2, siz, true)
