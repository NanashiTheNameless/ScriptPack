...
Chat.Draggable = true
Chat.Position = UDim2.new(0, 361, 0, 151)
...
InfiniteLamina.Position = UDim2.new(0, 180, 0, 150)
...
Nowipe.Position = UDim2.new(0, 100, 0, 150)
...
Regenerate.Position = UDim2.new(0, 20, 0, 150)
...
SetSecondMagic.Position = UDim2.new(0, 260, 0, 150)
...
SetSecondMagic.MouseButton1Down:connect(function(open)
	MagicA = Namee_7.Text
    game.Workspace.Stats.SetStat:FireServer("Magic2", tostring(MagicA), "math.random() is the best thing ever")
end)
--
--
...
SkillPoints.Position = UDim2.new(0, 340, 0, 150)
