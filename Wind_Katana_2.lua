...
weldIt = function(p1, p2, r1, r2, place)
...
Add = {part = function(color, size, pos, place, naym, scale, thing, mt, ccd, id, transparent, loool, ff, yos)
  if loool ~= nil then
  ...
  balleff.CanCollide = ccd
  balleff.Transparency = transparent
...
while 1 do
  if not ra or not la or not t or not humanoid or not head or not ll or not rl or not hrp then
    wait()
    -- DECOMPILER ERROR at PC1408: LeaveBlock: unexpected jumping out IF_THEN_STMT

    -- DECOMPILER ERROR at PC1408: LeaveBlock: unexpected jumping out IF_STMT

  end
end
hrpw = hrp:findFirstChild("RootJoint")
...
while 1 do
  if not ls or not rs or not neck or not hrpw then
    wait()
    -- DECOMPILER ERROR at PC1453: LeaveBlock: unexpected jumping out IF_THEN_STMT

    -- DECOMPILER ERROR at PC1453: LeaveBlock: unexpected jumping out IF_STMT
...
backweld()
checkintable = function(chek, tabl)
  for i = 1, #tabl do
...
splash = function()
  local blcf = hitbox.CFrame * CFrame.new(-0.125, 0.2, 0)
...
slash = {function()
  ...
  for i = 0, 1, 0.23 do
    ...
    animate("rr", CFrame.new(1.5, 0.5, 0), 0, math.rad(95), math.rad(110), i)
    animate("lr", CFrame.new(-1.5, 0.5, 0), math.rad(-45), 0, math.rad(-25), i)
  ...
  for i = 0, 1, 0.16 do
    wait()
    splash()
    animate("Toso", co - Vector3.new(0, 0, 0), 0, math.rad(0), math.rad(20), i)
    animate("hr", CFrame.new(0, 1, 0), 0, math.rad(-20), 0, i)
...
, function()
  ...
  for i = 0, 1, 0.24 do
    ...
    animate("Toso", co - Vector3.new(0, 0, 0), 0, math.rad(0), math.rad(-50), i)
    animate("hr", CFrame.new(0, 1, 0), 0, math.rad(10), 0, i)
  ...
  for i = 0, 1, 0.2 do
    ...
    animate("Toso", co - Vector3.new(0, 0.3, 0), math.rad(40), math.rad(0), math.rad(0), i)
    animate("hr", CFrame.new(0, 1, 0), math.rad(40), math.rad(10), 0, i)
...
, function()
  ...
  for i = 0, 1, 0.24 do
    ...
    animate("Toso", co - Vector3.new(0, 0, 0), 0, math.rad(0), math.rad(30), i)
    animate("hr", CFrame.new(0, 1, 0), 0, math.rad(-30), 0, i)
  ...
  for i = 0, 1, 0.2 do
    ...
    animate("Toso", co - Vector3.new(0, 0, 0), 0, math.rad(0), math.rad(-50), i)
    animate("hr", CFrame.new(0, 1, 0), 0, math.rad(50), 0, i)
...
, function()
  ...
  for i = 0, 1, 0.24 do
    ...
    animate("Toso", co - Vector3.new(0, 0.6, 0), 0, math.rad(0), math.rad(-40), i)
    animate("hr", CFrame.new(0, 1, 0), 0, math.rad(-30), 0, i)
...
QHIT = false
skills = {function(mouse)
  anim = true
  locanrun = true
  canjump = false
  normal(1)
  mh = mouse.Hit.p
  x = CFrame.new(char.Torso.Position, Vector3.new(mh.X, char.Torso.Position.Y, mh.Z)):toEulerAnglesXYZ()
  ...
  for i = 0, 1, 0.333333 do
    ...
    animate("hr", CFrame.new(0, 1, 0), math.rad(-10), math.rad(90), 0, i)
  ...
  wind2 = Add.part("Really black", Vector3.new(4, 1.2, 1), (hitbox.CFrame - Vector3.new(0, 1, 0)) * CFrame.Angles(math.rad(-10), 0, math.rad(90)), sword, "wind", Vector3.new(1.6, 1.1, 1.1), "Block", "Sphere", false, nil, 0.60000002384186, Part, "Brick")
  wind2.Mesh.Offset = Vector3.new(0.4, 0, 0)
  wind3 = Add.part("Medium stone grey", Vector3.new(4, 1.2, 1), (hitbox.CFrame - Vector3.new(0, 1, 0)) * CFrame.Angles(math.rad(-10), 0, math.rad(90)), sword, "wind", Vector3.new(1.6, 1.1, 1.1), "Block", "Sphere", false, nil, 0.5, Part, "Brick")
  wind3.Mesh.Offset = Vector3.new(0.6, 0, 0)
  wind1.CFrame = hitbox.CFrame * CFrame.Angles(math.rad(-10), 0, math.rad(90)) - Vector3.new(0, 0.3, 0)
  wind2.CFrame = hitbox.CFrame * CFrame.Angles(math.rad(-10), 0, math.rad(90)) - Vector3.new(0, 0.3, 0)
  wind3.CFrame = hitbox.CFrame * CFrame.Angles(math.rad(-10), 0, math.rad(90)) - Vector3.new(0, 0.3, 0)
  ...
  eff1.CFrame = hitbox.CFrame * CFrame.Angles(math.random(-360, 360), math.random(-360, 360), math.random(-360, 360))
  eff2.CFrame = hitbox.CFrame * CFrame.Angles(math.random(-360, 360), math.random(-360, 360), math.random(-360, 360))
  eff3.CFrame = hitbox.CFrame * CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(90), 0, 0)
  eff4.CFrame = hitbox.CFrame * CFrame.new(0, -1.5, 0) * CFrame.Angles(math.rad(90), 0, 0)
  table.insert(mufu, wind1)
  table.insert(mufu, wind2)
  table.insert(mufu, wind3)
  coroutine.resume(coroutine.create(function(p1, p2, p3, p4, cf1)
    for i = 0, 1, 0.076923076923077 do
      p1.CFrame = cf1 * CFrame.new(0, 3 * i, -0.5 * i) * CFrame.Angles(math.rad(math.random(-400, 400)), math.rad(math.random(-400, 400)), math.rad(math.random(-400, 400)))
      p1.Transparency = p1.Transparency + 0.046153846153846
      p2.CFrame = cf1 * CFrame.new(0, 3 * i, -0.5 * i) * CFrame.Angles(math.rad(math.random(-400, 400)), math.rad(math.random(-400, 400)), math.rad(math.random(-400, 400)))
      p2.Transparency = p2.Transparency + 0.046153846153846
      p3.CFrame = cf1 * CFrame.new(0, -1 + 8 * i, 0.17 - 1.3333333333333 * i) * CFrame.Angles(math.rad(90), 0, 0)
      p3.Mesh.Scale = Vector3.new(1.5 + 1 * i, 1.5 + 1 * i, 1)
      p3.Transparency = 0.8 + 0.3 * i
      p4.CFrame = cf1 * CFrame.new(0, -1.5 + 7.5 * i, 0.17 - 1.25 * i) * CFrame.Angles(math.rad(90), 0, 0)
      p4.Mesh.Scale = Vector3.new(1.25 + 1 * i, 1.25 + 1 * i, 1)
      p4.Transparency = 0.8 + 0.3 * i
      wait()
    end
    p1.Parent = nil
    p2.Parent = nil
...
), eff1, eff2, eff3, eff4, hitbox.CFrame)
  for x = 1, #mufu do
...
), mufu[x], mufu[x].Mesh.Scale, mufu[x].Transparency, mufu[x].Mesh.Offset.X)
  end
  QHIT = false
  locanrun = false
  canjump = true
...
, function()
  ...
  for i = 1, 10 do
    ...
    for i = 0, 1, 0.083333333333333 do
      mama.CFrame = mama.CFrame * CFrame.Angles(0, math.rad(math.random(-360, 360)), 0)
      mama.Transparency = 0.3 + 0.5 * i
      mama.Mesh.Scale = Vector3.new(3 + 1 * i, 3 + 1 * i, 3 + 1 * i)
      wait()
    end
    mama.Parent = nil
  end
  ...
  ball = Add.part("White", Vector3.new(1, 1, 1), t.CFrame, char, "Effect", Vector3.new(20, 20, 20), "Block", "Sphere", false, nil, 0.7, Part, "Custom")
  ball.Anchored = false
  anchor = Add.part("White", Vector3.new(5, 5, 5), t.CFrame, char, "anchor", Vector3.new(20, 20, 20), "Block", "Sphere", false, nil, 1, Part, "Custom")
  anchor.Anchored = false
  wind = Add.part("White", Vector3.new(5, 5, 5), t.CFrame, char, "anchor", Vector3.new(20, 20, 20), "Block", "FileMesh", false, "http://www.roblox.com/asset/?id=1051557", 0.6, Part, "Custom")
  wind.Anchored = false
  a = weldIt(t, anchor, CFrame.new(0, 0, 0), (CFrame.new(0, 0, 0)), nil)
  b = weldIt(t, wind, CFrame.new(0, 0, 0), (CFrame.new(0, 0, 0)), nil)
  c = weldIt(t, ball, CFrame.new(0, 0, 0), (CFrame.new(0, 0, 0)), nil)
  already = {}
  weldos = {}
  lepeepz = checkdist(t, 17)
  gage = b.C0
  for i = 1, #lepeepz do
    if lepeepz[i] then
  ...
  for i = 0, 1, 0.0083333333333333 do
    ...
    for i = 0, 1, 0.1 do
      clone.Mesh.Scale = Vector3.new(2.5 + 5 * i, 2.5 + 5 * i, 2.5 + 5 * i)
      clone.Transparency = 0.4 + 0.4 * i
      wait()
    end
    clone.Parent = nil
  end
        ...
        animate("Toso", co - Vector3.new(0, 0, 0), math.rad(0), math.rad(0), math.rad(5760 * i), i)
        b.C0 = gage * CFrame.Angles(0, math.rad(100 * i), 0)
        ball.Transparency = 0.6 - 0.4 * i
        wind.Transparency = 0.6 - 0.4 * i
        for i = 1, #weldos do
          weldos[i].C0 = weldos[i].C0 * CFrame.new(0, 0.0625, 0)
        end
        wait()
        -- DECOMPILER ERROR at PC774: LeaveBlock: unexpected jumping out DO_STMT
  ...
  coroutine.resume(coroutine.create(function(a1, a2, a3, ws, w)
    for i = 0, 1, 0.1 do
      ...
      a1.Mesh.Scale = Vector3.new(20 + 3 * i, 20 + 3 * i, 20 + 3 * i)
      a1.Transparency = 0.2 + 0.8 * i
      a2.Mesh.Scale = Vector3.new(20 + 3 * i, 20 + 3 * i, 20 + 3 * i)
      a2.Transparency = 0.2 + 0.8 * i
      wait()
    end
    a1.Parent = nil
    a2.Parent = nil
...
, function()
  niye = sword:GetChildren()
  guard = true
  br = BrickColor.new("Institutional white")
  if ss then
    br = BrickColor.new("Medium stone grey")
    guard = false
  end
  for i = 1, #niye do
    if niye[i].Name == "Blade" then
      niye[i].BrickColor = br
      ss = guard
    end
  end
end
, function(bik, rotate)
  ...
  coroutine.resume(coroutine.create(function(ilan, ratat)
    yolo = Add.bp(hrp, "BOPOLS", hrp.Position)
    canboost = false
    ...
    coroutine.resume(coroutine.create(function(thing)
      print("yo")
      for i = 0, 1, 0.05 do
        thing.Mesh.Scale = Vector3.new(2.5 + 1 * i, 2.5 + 1 * i, 2.5 + 1 * i)
        thing.Transparency = 0.4 + 0.5 * i
        wait()
      end
      thing.Parent = nil
    end
...
Equip = function(mouse)
  ...
  neck.Parent = nil
  ls.Parent = nil
  rlw = weldIt(t, rl, CFrame.new(0.5, -1.5, 0), CFrame.new(0, 0.5, 0))
  llw = weldIt(t, ll, CFrame.new(-0.5, -1.5, 0), CFrame.new(0, 0.5, 0))
  rw = weldIt(t, ra, CFrame.new(1.5, 0.5, 0), (CFrame.new(0, 0.5, 0)), nil)
  lw = weldIt(t, la, CFrame.new(-1.5, 0.5, 0), CFrame.new(0, 0.5, 0))
  nw = weldIt(t, head, CFrame.new(0, 1, 0), CFrame.new(0, -0.5, 0))
  anim = true
  bw.Parent = nil
  running = false
  idol = true
...
Lerp = function(x, y, inc)
  return x + (y - x) * inc
end

animate = function(mem, cfr, x, y, z, e)
  To[mem].X = Lerp(To[mem].X, x, e)
  To[mem].Y = Lerp(To[mem].Y, y, e)
  To[mem].Z = Lerp(To[mem].Z, z, e)
...
To = {
rr = {X = 0, Y = 0, Z = 0, cf = CFrame.new(1.5, 0.5, 0)}
, 
bw = {X = math.rad(5), Y = math.rad(90), Z = 0, cf = CFrame.new(0, -1, 0)}
, 
lr = {X = 0, Y = 0, Z = 0, cf = CFrame.new(-1.5, 0.5, 0)}
, 
hr = {X = 0, Y = 0, Z = 0, cf = CFrame.new(0, 1.5, 0)}
, 
leg = {X = 0, Y = 0, Z = 0, cf = CFrame.new(-0.5, -1, 0)}
, 
reg = {X = 0, Y = 0, Z = 0, cf = CFrame.new(0.5, -1, 0)}
, 
Toso = {X = 0, Y = 0, Z = 0, cf = co}
}
game:service("RunService").RenderStepped:connect(function()
  if rw then
    rw.C0 = To.rr.cf * CFrame.Angles(To.rr.X, To.rr.Y, To.rr.Z)
  end
  if hw and equip then
    hw.C0 = To.bw.cf * CFrame.Angles(To.bw.X, To.bw.Y, To.bw.Z)
  end
  if lw then
    lw.C0 = To.lr.cf * CFrame.Angles(To.lr.X, To.lr.Y, To.lr.Z)
  end
  if nw then
    nw.C0 = To.hr.cf * CFrame.Angles(To.hr.X, To.hr.Y, To.hr.Z)
  end
  if rlw then
    rlw.C0 = To.reg.cf * CFrame.Angles(To.reg.X, To.reg.Y, To.reg.Z)
  end
  if llw then
    llw.C0 = To.leg.cf * CFrame.Angles(To.leg.X, To.leg.Y, To.leg.Z)
  end
  if hrpw then
    hrpw.C0 = To.Toso.cf * CFrame.Angles(To.Toso.X, To.Toso.Y, To.Toso.Z)
  end
end
)
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property)
  ...
  if h ~= nil and hit.Parent.Name ~= char.Name and hit.Parent:FindFirstChild("Torso") ~= nil and attackdebounce == false then
    attackdebounce = true
    ...
    if block ~= nil and block.Value > 0 then
      blocked = true
...
while 1 do
  ...
  if t.Velocity * Vector3.new(1, 0, 1).magnitude <= 2 and not anim and equip and fell and t.Velocity.Y <= 1 and -1 <= t.Velocity.Y then
    lerun = false
    if rlw and hrpw and llw then
      if lenormal then
        for i = 0, 1, 0.2 do
          if t.Velocity * Vector3.new(1, 0, 1).magnitude <= 2 and not anim and equip and fell and t.Velocity.Y <= 1 and -1 <= t.Velocity.Y then
            normal(i)
        ...
        do
          ...
          if (2 < t.Velocity * Vector3.new(1, 0, 1).magnitude and not anim and equip and fell and t.Velocity.Y <= 1 and -1 <= t.Velocity.Y) or locanrun then
            lenormal = true
            ...
            if 1 < t.Velocity.Y and not anim and equip and not lejump then
              lejump = true
              lenormal = true
              lerun = false
              for i = 0, 1, 0.25 do
              ...
              do
                ...
                if t.Velocity.Y < -1 and not anim and equip and not lejump and not crosh then
                  fell = false
                  lenormal = true
                  lerun = false
                  for i = 0, 1, 0.25 do
                    if not anim and equip and (crosh == nil or not crosh or crosh.CanCollide == false) then
                  ...
                  do
                    ...
                    crosh = Workspace:FindPartOnRay(ray, char)
                    if crosh then
                      lejump = false
                      fell = true
                    end
                    if ss then
                      windy = Add.part("Institutional white", Vector3.new(4, 1.2, 1), hitbox.CFrame, sword, "wind", Vector3.new(math.random(50, 110) / 100, 0.3, 0.3), "Block", "Sphere", false, nil, 0.69999998807907, Part, "Brick")
                      windy.Anchored = false
                      windyweld = weldIt(hitbox, windy, CFrame.new(math.random(-100, 100) / 130, -2, math.random(-100, 100) / 130) * CFrame.Angles(0, 0, math.rad(90)), nil, nil)
  ...
  print("yomama")
...
), windy, windyweld, windyweld.C0)
                    end
                    inf = inf + 1
                    wait()
                    -- DECOMPILER ERROR at PC2700: LeaveBlock: unexpected jumping out DO_STMT

                    -- DECOMPILER ERROR at PC2700: LeaveBlock: unexpected jumping out IF_THEN_STMT

                    -- DECOMPILER ERROR at PC2700: LeaveBlock: unexpected jumping out IF_STMT
                    ...
                    -- DECOMPILER ERROR at PC2700: LeaveBlock: unexpected jumping out IF_ELSE_STMT
