...
----------------------------
--Customize
mindamage = math.random(40,80)
maxdamage = math.random(60,90)
crtmaxdamage = math.random(100,200)
omindamage = mindamage
omaxdamage = maxdamage
ocrtmaxdamage = crtmaxdamage
crtrate = 5
handlecolor = BrickColor.new("White")
bcolor = BrickColor.new("Mid stone greu")
...
--[[The Parts                                                                                                                                                                                                                ]]
chest=Instance.new("Part",suit)
chest:BreakJoints()
chest.FormFactor="Custom"
chest.Anchored=false
chest.CanCollide=false
chest.Locked=true
chest.Size=Vector3.new(2.1,2.1,1.1)
chest.BrickColor=zcolor("Mid stone grey")
wchest=Instance.new("Weld",chest)
wchest.Part0= chest
wchest.Part1= char.Torso
bchest=Instance.new("BlockMesh",chest)
 
larm=Instance.new("Part",suit)
larm.FormFactor="Custom"
larm.Anchored=false
larm.CanCollide=false
larm.Locked=true
larm.Size=Vector3.new(1.1,1.1,1.1)
larm.BrickColor=zcolor("Mid stone grey")
wlarm=Instance.new("Weld",larm)
wlarm.Part0= larm
wlarm.Part1= char["Left Arm"]
wlarm.C1=CFrame.new(0,0.5,0)
blarm=Instance.new("BlockMesh",larm)
 
rarm=Instance.new("Part",suit)
rarm.FormFactor="Custom"
rarm.Anchored=false
rarm.CanCollide=false
rarm.Locked=true
rarm.Size=Vector3.new(1.1,2.1,1.1)
rarm.BrickColor=zcolor("Mid stone grey")
wrarm=Instance.new("Weld",rarm)
wrarm.Part0= rarm
wrarm.Part1= char["Right Arm"]
wrarm.C1=CFrame.new(0,0,0)
brarm=Instance.new("BlockMesh",rarm)
 
rleg=Instance.new("Part",suit)
rleg.FormFactor="Custom"
rleg.Anchored=false
rleg.CanCollide=false
rleg.Locked=true
rleg.Size=Vector3.new(1.1,2.1,1.1)
rleg.BrickColor=zcolor("Mid stone grey")
wrleg=Instance.new("Weld",rleg)
wrleg.Part0= rleg
wrleg.Part1= char["Right Leg"]
wrleg.C1=CFrame.new(0,0,0)
brleg=Instance.new("BlockMesh",rleg)
 
lleg=Instance.new("Part",suit)
lleg.FormFactor="Custom"
lleg.Anchored=false
lleg.CanCollide=false
lleg.Locked=true
lleg.Size=Vector3.new(1.1,2.1,1.1)
lleg.BrickColor=zcolor("Mid stone grey")
wlleg=Instance.new("Weld",lleg)
wlleg.Part0= lleg
wlleg.Part1= char["Left Leg"]
wlleg.C1=CFrame.new(0,0,0)
blleg=Instance.new("BlockMesh",lleg)
 
d1=Instance.new("Part",suit)
d1.FormFactor="Custom"
d1.Anchored=false
d1.CanCollide=false
d1.Locked=true
d1.Reflectance=0.4
d1.Size=Vector3.new(.4,.7,.4)
d1.BrickColor=zcolor("White")
wd1=Instance.new("Weld",d1)
wd1.Part0=d1
wd1.Part1=chest
wd1.C1=CFrame.new(.5,-.6,-.4)
bd1=Instance.new("BlockMesh",d1)
 
d2=Instance.new("Part",suit)
d2.FormFactor="Custom"
d2.Anchored=false
d2.CanCollide=false
d2.Locked=true
d2.Reflectance=0.4
d2.Size=Vector3.new(.4,.7,.4)
d2.BrickColor=zcolor("White")
wd2=Instance.new("Weld",d2)
wd2.Part0=d2
wd2.Part1=chest
wd2.C1=CFrame.new(-.5,-.6,-.4)
bd2=Instance.new("BlockMesh",d2)
 
d3=Instance.new("Part",suit)
d3.FormFactor="Custom"
d3.Anchored=false
d3.CanCollide=false
d3.Locked=true
d3.Reflectance=0.4
d3.Size=Vector3.new(.4,.7,.4)
d3.BrickColor=zcolor("White")
wd3=Instance.new("Weld",d3)
wd3.Part0=d3
wd3.Part1=chest
wd3.C1=CFrame.new(-.5,-.1,-.75)
wd3.C0=CFrame.new(0,0,0) * CFrame.Angles(0,0,9.44)
bd3=Instance.new("SpecialMesh",d3)
bd3.MeshType="Wedge"
 
d4=Instance.new("Part",suit)
d4.FormFactor="Custom"
d4.Anchored=false
d4.CanCollide=false
d4.Locked=true
d4.Reflectance=0.4
d4.Size=Vector3.new(.4,.7,.4)
d4.BrickColor=zcolor("White")
wd4=Instance.new("Weld",d4)
wd4.Part0=d4
wd4.Part1=chest
wd4.C1=CFrame.new(.5,-.1,-.75)
wd4.C0=CFrame.new(0,0,0) * CFrame.Angles(0,0,9.44)
bd4=Instance.new("SpecialMesh",d4)
bd4.MeshType="Wedge"
 
d5=Instance.new("Part",suit)
d5.FormFactor="Custom"
d5.Anchored=false
d5.CanCollide=false
d5.Locked=true
d5.Reflectance=0.4
d5.Size=Vector3.new(2,.84,.4)
d5.BrickColor=zcolor("White")
wd5=Instance.new("Weld",d5)
wd5.Part0=d5
wd5.Part1=chest
wd5.C1=CFrame.new(0,.66,-.74)
bd5=Instance.new("BlockMesh",d5)
 
d6=Instance.new("Part",suit)
d6.FormFactor="Custom"
d6.Anchored=false
d6.CanCollide=false
d6.Locked=true
d6.Reflectance=0.4
d6.Size=Vector3.new(.5,.5,1.5)
d6.BrickColor=zcolor("White")
wd6=Instance.new("Weld",d6)
wd6.Part0=d6
wd6.Part1=chest
wd6.C1=CFrame.new(.7,.84,-.1)
bd6=Instance.new("BlockMesh",d6)
 
d7=Instance.new("Part",suit)
d7.FormFactor="Custom"
d7.Anchored=false
d7.CanCollide=false
d7.Locked=true
d7.Reflectance=0.4
d7.Size=Vector3.new(.5,.5,1.5)
d7.BrickColor=zcolor("White")
wd7=Instance.new("Weld",d7)
wd7.Part0=d7
wd7.Part1=chest
wd7.C1=CFrame.new(-.7,.84,-.1)
bd7=Instance.new("BlockMesh",d7)
 
d8=Instance.new("Part",suit)
d8.FormFactor="Custom"
d8.Anchored=false
d8.CanCollide=false
d8.Locked=true
d8.Reflectance=0.4
d8.Size=Vector3.new(2.3,.4,1.3)
d8.BrickColor=zcolor("White")
wd8=Instance.new("Weld",d8)
wd8.Part0=d8
wd8.Part1=chest
wd8.C1=CFrame.new(0,-1,0)
bd8=Instance.new("BlockMesh",d8)
 
d9=Instance.new("Part",suit)
d9.FormFactor="Custom"
d9.Anchored=false
d9.CanCollide=false
d9.Locked=true
d9.Reflectance=0.4
d9.Size=Vector3.new(.5,2,.5)
d9.BrickColor=zcolor("White")
wd9=Instance.new("Weld",d9)
wd9.Part0=d9
wd9.Part1=chest
wd9.C1=CFrame.new(-.7,-.20,.4)
bd9=Instance.new("BlockMesh",d9)
 
d10=Instance.new("Part",suit)
d10.FormFactor="Custom"
d10.Anchored=false
d10.CanCollide=false
d10.Locked=true
d10.Reflectance=0.4
d10.Size=Vector3.new(.5,2,.5)
d10.BrickColor=zcolor("White")
wd10=Instance.new("Weld",d10)
wd10.Part0=d10
wd10.Part1=chest
wd10.C1=CFrame.new(.7,-.20,.4)
bd10=Instance.new("BlockMesh",d10)
 
hd = Instance.new("Part",suit) 
hd.Anchored = false 
hd.Size = Vector3.new(1,1,1) 
hd.formFactor = "Symmetric" 
hd.CFrame = CFrame.new(3,3,0) 
hd.BrickColor = BrickColor.new("Mid stone grey") 
hd.Reflectance = 0 
...
d11=Instance.new("Part",suit)
d11.FormFactor="Custom"
d11.Anchored=false
d11.CanCollide=false
d11.Locked=true
d11.Reflectance=0.4
d11.Size=Vector3.new(.2,1,.2)
d11.BrickColor=zcolor("White")
wd11=Instance.new("Weld",d11)
wd11.Part0=d11
wd11.Part1=char["Left Arm"]
wd11.C1=CFrame.new(-.6,-.8,.2)
bd11=Instance.new("BlockMesh",d11)
 
d12=Instance.new("Part",suit)
d12.FormFactor="Custom"
d12.Anchored=false
d12.CanCollide=false
d12.Locked=true
d12.Reflectance=0.4
d12.Size=Vector3.new(.2,1,.2)
d12.BrickColor=zcolor("White")
wd12=Instance.new("Weld",d12)
wd12.Part0=d12
wd12.Part1=char["Left Arm"]
wd12.C1=CFrame.new(-.6,-.8,-.2)
bd12=Instance.new("BlockMesh",d12)
 
d13 = Instance.new("Part") 
d13.Parent = suit
d13.Locked = true 
d13.Size = Vector3.new(1, 1, 1) 
d13.formFactor = "Symmetric" 
d13.BrickColor = BrickColor.new("White") 
d13.Reflectance = 0.4
d13.TopSurface = "Smooth" 
d13.BottomSurface = "Smooth"
md13 = Instance.new("SpecialMesh") 
md13.MeshType = "Wedge" 
md13.Parent = d13
md13.Scale = Vector3.new(1.15,1.05,1.15) 
wd13 = Instance.new("Weld") 
wd13.Parent = d13
wd13.Part0 = d13
wd13.Part1 = char["Right Arm"]   
wd13.C0 = CFrame.new(0,0.58,0)*CFrame.Angles(math.rad(90),math.rad(90),math.rad(90)) 
 
d14 = Instance.new("Part") 
d14.Parent = suit
d14.Locked = true 
d14.Size = Vector3.new(1, 1, 1) 
d14.formFactor = "Symmetric" 
d14.BrickColor = BrickColor.new("White") 
d14.Reflectance = 0.4
d14.TopSurface = "Smooth" 
d14.BottomSurface = "Smooth"
md14 = Instance.new("SpecialMesh") 
md14.MeshType = "Wedge" 
md14.Parent = d14
md14.Scale = Vector3.new(1.15,1.05,1.15) 
wd14 = Instance.new("Weld") 
wd14.Parent = d14
wd14.Part0 = d14
wd14.Part1 = char["Left Arm"]   
wd14.C0 = CFrame.new(0,0.07,-0.5) * CFrame.Angles(0,math.rad(90),math.rad(90)) 
...
local part101 =Instance.new("Part",swordholder)
part101.formFactor=3
part101.CanCollide=false
part101.Name="HoldDesign1"
part101.Locked=true
part101.BrickColor=bcolor
part101.Size=Vector3.new(0.4,0.2,0.4)
local Msh=Instance.new("CylinderMesh", part101)
Msh.Scale=Vector3.new(1,1,1)
local part102 =Instance.new("Part",swordholder)
part102.formFactor=3
part102.CanCollide=false
part102.Name="HoldDesign2"
part102.Locked=true
part102.BrickColor=bcolor
part102.Size=Vector3.new(0.4,0.2,0.4)
local Msh2=Instance.new("CylinderMesh", part102)
...
w1.Parent = prt1
w1.Part0 = prt1
local p101 =Instance.new("Weld",part101)
p101.Part0=part101
p101.Part1=prt1
p101.C1=CFrame.new(0,.6,0)
local p102 =Instance.new("Weld",part102)
p102.Part0=part102
p102.Part1=prt1
p102.C1=CFrame.new(0,-.6,0)
...
effectsg.Locked = true
effectsg.Anchored = true
effectsg.Size = Vector3.new(1,2,1)
effectsg.Parent = swordholder
effectsmsh.Parent = effectsg
effectsg.BrickColor = bcolor
effectsg.Reflectance = 0.25
...
for i = 0 , 1 , 0.2 do
wait()
RW.C0 = CFrame.new(1.5-0.8*i, 0.5, -1*i) * CFrame.Angles(math.rad(180-125*i),math.rad(-35), math.rad(45-90*i))
RW.C1 = CFrame.new(0, 0.5, 0) * CFrame.Angles(0, 0, 0)
LW.C0 = CFrame.new(-1*i, 0.5, -1+0.5*i) * CFrame.Angles(math.rad(135-45*i), 0, math.rad(90-80*i))
LW.C1 = CFrame.new(0, 0.5, 0) * CFrame.Angles(0, 0, 0)
w1.C0 = CFrame.Angles(math.rad(-315), math.rad(0), math.rad(0))
