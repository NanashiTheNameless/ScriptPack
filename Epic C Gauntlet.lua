...
local CrystalNumb=0
local Crystals={}
CrystalColor=BrickColor.new("Toothpaste")
crystal = BrickColor.new("Toothpaste")
--player
player = nil
--save shoulders
RSH, LSH = nil, nil
...
local prt3=part(3,modelzorz,0,0,BrickColor.new("White"),"Part3",vt(1,1,1))
local prt4=part(3,modelzorz,0,0,BrickColor.new("White"),"Part4",vt(1,1,1))
...
local prt=part(3,workspace,1,0,BrickColor.new("Toothpaste"),"Part",vt(1,1,1))
prt.Anchored=true
...
if CrystalNumb<1000000000000000 then
so("http://www.roblox.com/asset/?id=106626284",Torso,1,2)
CrystalEffect(prt7)
CrystalNumb=CrystalNumb+1
print(CrystalNumb)
local base=part(3,modelzorz,0,1,BrickColor.new("Toothpaste"),"Part1",vt(1,1,1))
base.Anchored=true
base.CFrame=prt7.CFrame
table.insert(Crystals,base)
local crystall=part(3,base,0.4,0,CrystalColor,"Crystal",vt(2,2,2))
local msh=mesh("SpecialMesh",crystall,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(2,2,2))
glow = Instance.new("PointLight")
...
local mshh=mesh("SpecialMesh",brokecryst,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(math.random()-math.random(),math.random()+math.random(0,1),math.random()-math.random()))
glow = Instance.new("PointLight")
...
local mshh=mesh("SpecialMesh",Shard,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(0.5,1.5,0.5))
glow = Instance.new("PointLight")
glow.Parent = Shard
glow.Range = 9
glow.Brightness = 6
...
glow.Brightness = 4
glow.Color = crystal.Color
local mshh=mesh("SpecialMesh",CrystDerp,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(1+math.random(),math.random(1,2)+math.random(),1+math.random()))
...
local mshh=mesh("SpecialMesh",CrystDerp,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(1+math.random(5,5),math.random(7,9)+math.random(),1+math.random(5,5)))
local mshh1=mesh("SpecialMesh",CrystDerp1,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(1+math.random(5,5),math.random(7,9)+math.random(),1+math.random(5,5)))
...
local mshh=mesh("SpecialMesh",brokecryst1,"FileMesh","http://www.roblox.com/Asset/?id=9982590",vt(0,0,0),vt(math.random()-math.random(),math.random()+math.random(0,1),math.random()-math.random()))
glow = Instance.new("PointLight")
