--[[
A Colt AER Laser rifle, Generation 7. Meant to be
an earlier version of the AER9, from Fallout.
--]]
...
Player = game:GetService("Players").LocalPlayer --< ty localplayer
...
function makeParts(format)
        ...
        m.Scale = Vector3.new(0.5, 1.25, 0.5)
        m.Parent = pm
        if format ~= nil then
        ...
        s.Name = "Fire"
        s.SoundId = "http://www.roblox.com/asset/?id=11998770"
        s.Volume = 1
        s.Pitch = 1.8
        s.Looped = false
        s.Parent = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 0.55, 0.2)
        m.Offset = Vector3.new(0,0,-0.36)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.45, 0.6, 0.45)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.5, 0.2, 0.5)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        s.RiseVelocity = -5
        s.Opacity = 0.1
        s.Color = Color3.new(255 / 0, 0 / 225, 0 / 0)
        s.Size = 0.4
        s.Parent = p
        ...
        f.Name = "Fire"
        f.Heat = -35
        f.Color = Color3.new(220 / 255, 10 / 255, 10 / 255)
        f.SecondaryColor = Color3.new(220 / 255, 10 / 255, 10 / 255)
        f.Size = 1
        f.Parent = p
        local p = Instance.new("Part")
        p.Name = "Silencer"
        ...
        m.Scale = Vector3.new(0.4, 1.8, 0.4)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 1.6, 0.125)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 1.6, 0.175)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 0.2, 0.668)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 2.8, 0.175)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, 1, -0.88)
        w.C1 = CFrame.new()
        w.Parent = p
        local p = Instance.new("Part")
        p.Name = "Rail2"
        ...
        p.Parent = model
        local m = Instance.new("BlockMesh")
        m.Scale = Vector3.new(0.25, 0.2, 0.8)
        m.Parent = p
        local w = Instance.new("Weld")
        w.Part0 = p
        w.Part1 = pm
        w.C0 = CFrame.new(0, 2.38, -0.57)
        w.C1 = CFrame.new()
        w.Parent = p
        return model
end
        ...
        if format == "fire" then
                ...
                if Player.Character[Name]:FindFirstChild("Handle") ~= nil then
                        if silenced then
                                ...
                                Player.Character[Name].Handle.Fire.Pitch = 1.9
                                Player.Character[Name].Handle.Fire:Play()
                                CamShake(10, 25000)
                        end
                else return false end
