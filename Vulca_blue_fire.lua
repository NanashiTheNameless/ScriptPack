...
local cooldownadd3 = 0.10
table.insert(cooldownsadd, cooldownadd3)
local cooldownadd4 = 0.08
table.insert(cooldownsadd, cooldownadd4)
local cooldownmax = 130
player = nil
RSH = nil
combing = false
...
if Character:findFirstChild("Flaming Ignis", true) ~= nil then
  Character:findFirstChild("Flaming Ignis", true).Parent = nil
end
...
local fenbarmana2 = gui("TextLabel", fenframe, "", 0, BrickColor.new("Cyan").Color, UDim2.new(0, 0, 0, 0), UDim2.new(0.4, 0, 0, 0))
...
local prt3 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part03", vt())
local prt4 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part04", vt())
local prt8 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part08", vt())
local prt9 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part09", vt())
local prt10 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part10", vt())
local prt11 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part11", vt())
local prt12 = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part12", vt())
local prt13 = part(3, modelzorz, 0.3, 0.5, BrickColor.new("Cyan"), "Part13", vt())
local prt14 = part(3, modelzorz, 0.3, 0.5, BrickColor.new("Cyan"), "Part14", vt())
local gprt1 = part(3, modelzorz, 0, 0.9, BrickColor.new("Really black"), "Gun Part01", vt())
local gprt2 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part02", vt())
local gprt3 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part03", vt())
local gprt4 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part04", vt())
local gprt5 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part05", vt())
local gprt6 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part06", vt())
local gprt7 = part(3, modelzorz, 0, 0, BrickColor.new("Really black"), "Gun Part07", vt())
local gprt8 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part08", vt())
local gprt9 = part(3, modelzorz, 0, 0, BrickColor.new("Really black"), "Gun Part09", vt())
local gprt10 = part(3, modelzorz, 0.2, 0, BrickColor.new("Really black"), "Gun Part10", vt())
local gprt11 = part(3, modelzorz, 0, 0, BrickColor.new("Black"), "Gun Part11", vt())
local gprt12 = part(3, modelzorz, 0, 0, BrickColor.new("Cyan"), "Gun Part12", vt())
...
local gprt15 = part(3, modelzorz, 0, 0, BrickColor.new("Cyan"), "Gun Part15", vt())
local gprt16 = part(3, modelzorz, 0, 0.2, BrickColor.new("Cyan"), "Gun Part16", vt())
...
parti.Color = cs(Color3.new(0.0156863, 0.686275, 0.92549), Color3.new(0.0156863, 0.686275, 0.92549))
...
Punishment = function()
  ...
  attack = true
        ...
        DecreaseStat(head.Parent, "Defense", 0.3, 300)
          ...
          MagniDamage(head, 1, 7, 9, 0, "aaa", RootPart, 0, 1, 0, nil, nil, false)

        for i = 0, 1, 0.05 do
          swait()
          MagicBlock(BrickColor.new("Cyan"), cf(head.Parent.Torso.Position), 1, 1, 1, 2, 2, 2, 0.1, 1)
...
while head ~= nil and GetDist(head, ref, 3) == true and head.Parent:findFirstChild("Stats") ~= nil and head.Parent.Stats.Stunned.Value == true  do
	wait()
	 MagicBlock(BrickColor.new("Cyan"), cf(head.Parent.Torso.Position), 1, 1, 1, 2, 2, 2, 0.1, 1)
end
  attack = false
...
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0,0,0)*euler(0,0,-1.57),.2)
...
MagicCircle(BrickColor.new("Cyan"),cf(gprt8.Position),5,5,5,1,1,1,0.03)
for i=0,1,0.1 do
      ...
      LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0.5, 0), 0.4)
        ...
        DecreaseStat(Character, "Defense", -0.25, 300)
            ...
            for i = -0.785, 0.785, 0.785 do
              ...
              d.Parent = ref
              d.Texture = "http://www.roblox.com/asset/?id=610906568"
              d.Face = "Top"
              d2 = Instance.new("Decal")
              d2.Parent = ref
              d2.Texture = "http://www.roblox.com/asset/?id=610906568"
              d2.Face = "Bottom"
...
Torso.Velocity = RootPart.CFrame.lookVector * 100
  attack = true
    ...
    dec.Value = 1
        ...
        DecreaseStat(Character, "Damage", 0.1, 400)
        DecreaseStat(Character, "Defense", -0.35, 400)
   
      
        
            
          MagniDamage(RootPart, 30, 7, 9, math.random(-50, -30), "Normal", RootPart, 0, 1, (math.random(5, 15)), nil, nil, false)
          MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0), 1, 2, 1, 10, 1, 10, 0.03)
           for i = 1, 2 do
              MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.5, 12, 0.5, 0.05)
            end
          for i = 1, 10 do
            swait()
          end
...
Torso.Velocity = RootPart.CFrame.lookVector * 100
    ...
    dec.Value = 1
          ...
          MagniDamage(RootPart, 30, 5, 6, math.random(-50, -30), "Normal", RootPart, 0, 1, (math.random(5, 15)), nil, nil, false)
          MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0), 1, 2, 1, 10, 1, 10, 0.03)
           for i = 1, 2 do
              MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.5, 12, 0.5, 0.05)
            end
 ...
 Torso.Velocity = RootPart.CFrame.lookVector * 100
    ...
    dec.Value = 1
          ...
          MagniDamage(RootPart, 30, 3, 4, math.random(-50, -30), "Normal", RootPart, 0, 1, (math.random(5, 15)), nil, nil, false)
          MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0), 1, 2, 1, 10, 1, 10, 0.03)
          for i = 1, 2 do
              MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 0.5, 12, 0.5, 0.05)
            end
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 50 then
...
Torso.Velocity = RootPart.CFrame.lookVector * 150
  attack = true
    ...
    dec.Value = 1
           ...
           for i = 1, 15 do
	       wait(0.2)
	so("87784452",Torso,1,1.2)
              MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0) * euler(math.random(-1, 1), math.random(-1, 1), math.random(-1, 1)), 1, 1, 1, 0.5, 12, 0.5, 0.05)
            end

wait(2)
    so("199144529", prt9, 1, 1)
          MagniDamage(RootPart, 80, 10, 15, math.random(-50, -30), "Normal", RootPart, 0, 1, (math.random(20, 25)), nil, nil, false)
          MagicCircle(BrickColor.new("Cyan"), cf(prt9.Position) * cf(0, 2, 0), 1, 2, 1, 60, 1, 60, 0.03)
          for i = 1, 10 do
            swait()
          end
          dec.Parent = nil
...
RecentEnemy.Value = nil
  ...
  for i = 0, 1, 0.1 do
    ...
    do
      ...
      hitboxCF = prt9.CFrame * cf(0, -1, 0.4)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 10, 15, math.random(5, 10), "Fire", RootPart, 0.5, 2, (math.random(5, 10)), nil, true)
      wld1.C0 = clerp(wld1.C0, euler(0.5, 0, 3.14) * cf(0, 1, 0.2), 0.35)
      Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, -0.6), 0.35)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0.6), 0.35)
      RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.2, 0, -1.2) * euler(0, -1.2, 0), 0.35)
...
if RecentEnemy.Value then
combing = true

RecentEnemy.Value.Torso.Anchored = true	

local BodyPos = Instance.new("BodyPosition", Torso)
BodyPos.MaxForce = Vector3.new(math.huge,math.huge,math.huge)
BodyPos.Position = 	RecentEnemy.Value.Torso.Position + Vector3.new(-5,1,0)

coroutine.resume(coroutine.create(function()
while wait() do
	
if RecentEnemy.Value.Humanoid.Health < 1 then
	
combing = false
BodyPos:remove()
RecentEnemy.Value.Torso.Anchored = false
    ...
    parti.Enabled = true
    DecreaseStat(Character, "Defense", -1, 150)
...
Shootcombo2 = function()
  table.insert(Effects, {gprt16.CFrame.lookVector, "Shoot", 5, gprt8.Position + Vector3.new(math.random(-1,1),math.random(-1,1),math.random(-1,1)), 3, 4, math.random(10, 20), 3})
end
Shoot1 = function()
...
MagicFireWave = function(brickcolor, cframe, x1, y1, z1)
  ...
  d = Instance.new("Decal")
  d.Parent = prt
  d.Texture = "http://www.roblox.com/asset/?id=610906152"
  d.Face = "Top"
  d = Instance.new("Decal")
  d.Parent = prt
  d.Texture = "http://www.roblox.com/asset/?id=610906152"
...
ElecEffect = function(cff, x, y, z)
  local prt = part(3, workspace, 0, 0, BrickColor.new("Cyan"), "Part", vt(1, 1, 1))
  prt.Anchored = true
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, incstun, stagger, staghit, ranged, DecreaseState, DecreaseAmount, Duration)
  ...
  if (Type == "Fire") or (combing) then
MagicFireWave(BrickColor.new("Cyan"), hit.CFrame * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1)
end  
end), h, Damage)
...
Damagefunc(hit,Thing[5],Thing[6],Thing[7],"Fire",RootPart,0,2,math.random(10,20),nil,nil,true)
end
