      ...
      --[[ CREDITS ]]--
--[[ORIGINAL: TheDarkRevenant]]--
  --[[EDIT MAKER: PixelFir3]]--
 --[[SUPPORTER/HELPER: Eurse]]--
...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=237126513"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=237126612"
----------------------------------------------------
...
fx.Size = Vector3.new(3.1,3.1,3.1)
fx.TopSurface = "SmoothNoOutlines"
fx.BottomSurface = "SmoothNoOutlines"
fx.BrickColor = BrickColor.new("Light stone grey")
...
for i,v in pairs(char:children()) do
    if v:IsA("Hat") then
        v.Handle.Mesh.Scale = v.Handle.Mesh.Scale * 1.8
    end
end
--hed.face.Texture = "rbxassetid://27641734"
...
----------------------------------------------------
--[[game:service'InsertService':LoadAsset(192557913):children()[1].Parent=char
char.SparkleWings.Handle.Mesh.Scale = char.SparkleWings.Handle.Mesh.Scale * 1.9
char.SparkleWings.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
]]
----------------------------------------------------
--[[game:service'InsertService':LoadAsset(398674411):children()[1].Parent=char
char.BlackIronAntlers.Handle.Mesh.Scale = char.BlackIronAntlers.Handle.Mesh.Scale * 2.0
char.BlackIronAntlers.Handle.Mesh.VertexColor = Vector3.new(5,5,5)
]]
----------------------------------------------------
z = Instance.new("Sound", char)
z.SoundId = "rbxassetid://0" --204277061, 202092194, 242463565
z.Looped = true
z.Pitch = 1
z.Volume = 10
wait(.01)
...
p1.BrickColor = BrickColor.new("Mid gray")
...
p2.BrickColor = BrickColor.new("Sand blue")
...
p6.Name = "Handle"
p6.BrickColor = BrickColor.new("Sand blue")
...
p7.BrickColor = BrickColor.new("Mid gray")
...
p8.BrickColor = BrickColor.new("Mid gray")
...
p9.BrickColor = BrickColor.new("Sand blue")
...
p10.BrickColor = BrickColor.new("Sand blue")
...
p11.BrickColor = BrickColor.new("Sand blue")
...
p12.BrickColor = BrickColor.new("Mid gray")
...
p13.BrickColor = BrickColor.new("Sand blue")
...
p14.BrickColor = BrickColor.new("Sand blue")
...
p15.BrickColor = BrickColor.new("Sand blue")
...
p16.BrickColor = BrickColor.new("Sand blue")
...
p17.BrickColor = BrickColor.new("Sand blue")
...
p18.BrickColor = BrickColor.new("Mid gray")
p18.Name = "BladePart1"
...
p19.BrickColor = BrickColor.new("Mid gray")
p19.Name = "BladePart2"
...
p20.BrickColor = BrickColor.new("Sand blue")
...
p14.Transparency=0
p15.Transparency=1
p16.Transparency=1 --Arm Pad
p17.Transparency=0
p18.Transparency=0
p19.Transparency=0
p20.Transparency=1 --lastpoint
p21.Transparency=1
p22.Transparency=1
p23.Transparency=0
p24.Transparency=1
p25.Transparency=1 --Ring
p26.Transparency=1
----------------------------------------------------
...
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(-3, 0.9, 0) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(-20)), 0.4)
larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(3, 1.7, 0) * CFrame.Angles(math.rad(90),math.rad(50),math.rad(90)), 0.4)
...
larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(3, 0.9, 0) * CFrame.Angles(math.rad(90),math.rad(0),math.rad(90)), 0.4)
            --larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-3, 0.9, 0) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(-20)), 0.4)
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(-3, 0.9, 0) * CFrame.Angles(math.rad(0),math.rad(0),math.rad(-20)), 0.4)
            hed.Weld.C0 = Lerp(hed.Weld.C0, CFrame.new(0, 3, 0) * CFrame.Angles(math.rad(-14),math.rad(0),0), 0.4)
            torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1.2, 0) * CFrame.Angles(0, math.rad(0), 0), 0.4)
...
mouse.KeyDown:connect(function(key)
         if key == "u" then
        mm = Instance.new("Sound",char)
        mm.SoundId = "rbxassetid://200632875"
        mm.Volume = 1
        mm.Pitch = .8
    wait(1)
    charge()
...
------ SCRIPTPOINT -------
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(3, 0.9, .5) * CFrame.Angles(math.rad(-10-20*math.cos(sine/4)/2), math.rad(-40+10*math.cos(sine/4)/2), math.rad(25-10*math.cos(sine/4)/2)), 0.2)
