mouse = game.Players.XTheShowcaserX:GetMouse()
 
game:GetService("Chat"):Chat(Workspace.XTheShowcaserX.Head,"I'm gonna end your life now...")
wait()
game:GetService("Chat"):Chat(Workspace.XTheShowcaserX.Head,"SUSANOO!")
wait(1)
 
Workspace.XTheShowcaserX.Humanoid.MaxHealth = math.huge
Workspace.XTheShowcaserX.Humanoid.WalkSpeed = 30
Workspace.XTheShowcaserX["Left Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.XTheShowcaserX.Torso.BrickColor = BrickColor.new("Cool yellow")
Workspace.XTheShowcaserX.Head.BrickColor = BrickColor.new("Cool yellow")
Workspace.XTheShowcaserX["Right Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.XTheShowcaserX["Left Leg"].BrickColor = BrickColor.new("Cool yellow")
Workspace.XTheShowcaserX["Right Leg"].BrickColor = BrickColor.new("Cool yellow")
 
 
-- Main
Handle = Instance.new("Part",Workspace.XTheShowcaserX)
...
Weld = Instance.new("Weld",Workspace.XTheShowcaserX)
Weld.Part0 = game.Workspace.XTheShowcaserX["Torso"]
Weld.Part1 = Handle
Weld.C1 = CFrame.new(0, -3, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)
 
RA = Instance.new("Part",Workspace.XTheShowcaserX)
...
LA = Instance.new("Part",Workspace.XTheShowcaserX)
...
Head = Instance.new("Part",Workspace.XTheShowcaserX)
...
Katana = Instance.new("Part",Workspace.XTheShowcaserX)
...
Sphere = Instance.new("Part",Workspace.XTheShowcaserX)
...
H = Instance.new("Part",Workspace.XTheShowcaserX)
H.TopSurface = "Smooth"
...
Shield = Instance.new("ForceField",Workspace.XTheShowcaserX)
 
Shirt = Instance.new("Shirt",Character)
 
Shirt.Parent = game.Workspace.XTheShowcaserX
...
Pant.Parent = game.Workspace.XTheShowcaserX
