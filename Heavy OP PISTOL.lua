--== Modified By Matteo101man ==--
--== Local Script --=--
--== Heavy OP Pistal =--

game.Players.ralf2234.CharacterAppearance = "http://www.roblox.com/Asset/CharacterFetch.ashx?userId=24738693&placeId=0"
...
local clip=20
local ammo=200
local Gun=add.Sound(torso, "http://www.roblox.com/asset/?id=135362176", .5, 1)
local Reload=add.Sound(torso, "http://www.roblox.com/asset/?id=154733167", .5, 1)
local HeadShot=add.Sound(torso, "http://www.roblox.com/asset/?id=130774824", 1, 1)
