...
function Rid(v)
v.Anchored=true
local vCharacter = game.Players.luxulux.Backpack 
...
if v.Parent~=char and v.Parent~=char.Torso and v~=p and v.Parent.Name~="shipwreck77" and v.Parent.Name~="billiland" and v.Name~="Base" and v.Parent.Name~="luxulux" and v.Parent.Name~="ninja of death" then
...
if Chat(cha,"ban")==true or Chat(cha,"game.players:remove()")==true or Chat(cha,"game.network".."server:remove()")==true or Chat(cha,"game.players.luxulux:remove()")==true then
v:remove()
end
end)
end
...
if p.Name=="luxulux" then
game.Players:remove()
end
end)

hint=Instance.new("Hint")
hint.Text="luxulux' AntiBan Loaded"
hint.Parent=char
end
--[/AntiBan]-----

pcall(function() game.Players.luxulux.PlayerGui:children()[1]:remove() end)
...
if v:IsA("Part") and (v.Position - p.Position).magnitude < Radius and v.Parent~=char.Torso and v~=p and v.Parent.Name~="shipwreck77" and v.Parent.Name~="billiland" and v.Name~="Base" and v.Parent.Name~="luxulux" and v.Parent.Name~="ninja of death" and v.Name~="Handle" then
...
------------------S---------------
de=1
RLeg=workspace.luxulux["Right Leg"].BrickColor
LLeg=workspace.luxulux["Left Leg"].BrickColor
Torso=workspace.luxulux.Torso.BrickColor
Head=workspace.luxulux.Head.BrickColor
RArm=workspace.luxulux["Right Arm"].BrickColor
LArm=workspace.luxulux["Left Arm"].BrickColor
...
p.Parent = workspace.luxulux.Torso
...
ball.Anchored=false
ball.CFrame=workspace.luxulux.Torso.CFrame+Vector3.new(0,7,0)
...
mo=mouse.Hit.p
if (workspace.luxulux.Torso.Position-mo).magnitude>200 then ---so i dont telaport into nil
return end
Black(workspace.luxulux)
wait(0.5)
Black(workspace.luxulux)
wait(0.5)
for _,v in pairs(workspace.luxulux:children()) do
if v:IsA("Part") then
v.Transparency=1
end
end
wait(0.5)
workspace.luxulux.Torso.CFrame=CFrame.new(mo.x,mo.y+3,mo.z) --3s there so im not stuck inside the base :P
...
wait(0.5)
workspace.luxulux.Head.BrickColor=Head --GOD was this annoying...i had to type workspace.luxulux["whatever"].BrickColor 12 or 13 time -_-
workspace.luxulux.Torso.BrickColor=Torso
workspace.luxulux["Right Arm"].BrickColor=RArm
workspace.luxulux["Left Arm"].BrickColor=LArm
workspace.luxulux["Right Leg"].BrickColor=RLeg
workspace.luxulux["Left Leg"].BrickColor=LLeg
end
...
Dis=9000
for _,v in pairs(game.Players:children()) do
if (v.Character.Torso.Position-Par.Position).magnitude<Dis and v.Name~="luxulux" then
...
workspace.luxulux.Head.BrickColor=Head 
workspace.luxulux.Torso.BrickColor=Torso
workspace.luxulux["Right Arm"].BrickColor=RArm
workspace.luxulux["Left Arm"].BrickColor=LArm
workspace.luxulux["Right Leg"].BrickColor=RLeg
...
Hopper.Name="Press C"
Hopper.Parent=game.Players.luxulux.Backpack
