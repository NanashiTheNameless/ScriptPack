...
banlist = {{"blackcopper","fly10101"}}
adminlist = {"ldrago9866"}
...
ablist   = {"ldrago9866"}
blocked = {}
guitext    = {"This server belongs to ldrago9866!", "Say cmds/ for commands if you are admin", "Server rules:","No anti-bans.","No orbs of any kind.","No admin scripts.","No server takeovers.","Admins do not have to follow these set rules.","This script is not for sale!","If you ask for the script you will be banned!","blackcopper is an abuser that copy scripts from absurdskinnjackb!","If you should see him in a server, please feel free to ban him.","We are accepting members..","We currently have "..#adminlist.." admins!","Last Updated: 03/12/11"}
function findp(name) 
