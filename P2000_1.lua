--[[
Heckler & Kosh P2000
Compact carry 9mm pistol that holds 10 rounds.
--]]
...
BulletData = [[Velocity_Transfer = 0.3
...
function CreateParts(Parent, Format)
	...
	MasterPart1.Size = Vector3.new(0.2, 1.1, 0.2)
	...
	Weld.Part1 = Player.Character:FindFirstChild(Format == 1 and "Right Arm" or "Left Arm")
	Weld.C1 = CFrame.new(0, -1.4, -0.55)
	...
	Part.BottomSurface = 0
	Part.FormFactor = "Custom"
	Part.Size = Vector3.new(0.21, 0.35, 0.8)
	Part.Parent = Parts
	local Weld = Instance.new("Weld")
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	Weld.C1 = CFrame.new(0, 0.325, 0.4)
	Weld.Parent = Weld.Part0
	...
	Part.BottomSurface = 0
	Part.FormFactor = "Custom"
	Part.Size = Vector3.new(0.2, 0.3, 0.805)
	Part.Parent = Parts
	local Weld = Instance.new("Weld")
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	Weld.C1 = CFrame.new(0, 0.325, 0.41)
	Weld.Parent = Weld.Part0
	...
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(-105), 0, 0)
	Weld.C1 = CFrame.new(0, 0.43, 0.12)
	Weld.Parent = Weld.Part0
	...
	local Mesh = Instance.new("SpecialMesh", Part)
	Mesh.MeshType = "Brick"
	Mesh.Scale = Vector3.new(0.5, 0.1, 1)
	local Weld = Instance.new("Weld")
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	Weld.C1 = CFrame.new(0, -0.135, 0.1)
	Weld.Parent = Weld.Part0
	...
	local Mesh = Instance.new("SpecialMesh", Part)
	Mesh.MeshType = "Brick"
	Mesh.Scale = Vector3.new(0.35, 0.05, 0.5)
	local Weld = Instance.new("Weld")
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(-15), 0, 0)
	Weld.C1 = CFrame.new(0, 0, 0.1)
	Weld.Parent = Weld.Part0
	...
	Weld.Part0 = Part
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.fromEulerAnglesXYZ(math.rad(-50), 0, 0)
	Weld.C1 = CFrame.new(0, 0.5, -0.15)
	Weld.Parent = Weld.Part0
	...
	MasterPart2.Size = Vector3.new(0.2, 1.05, 0.2)
	MasterPart2.Parent = Parts
	local Weld = Instance.new("Weld")
	Weld.Part0 = MasterPart2
	Weld.Part1 = MasterPart1
	Weld.C0 = CFrame.new(0, 0.025, 0.15)
	Weld.C1 = CFrame.new(0, (function()
		if Format == 1 or Format == 2 then
			return script.Magazine.Value > 0 and 0 or 0.3
		elseif Format == 3 or Format == 4 then
			return script.Dual.Main.Magazine.Value > 0 and 0 or 0.3
		end
	end)(), 0)
	Weld.Parent = Weld.Part0
	...
	for i = -1, 1, 2 do
		...
		Weld.C0 = CFrame.new(0.075 * i, -0.55, 0)
		Weld.Parent = Weld.Part0
	end
...
function onButton1Down(Mouse)
	...
	if CanUse == true then
		...
		SoundToServer("Fire", "http://www.roblox.com/Asset/?id=10209798", 2, 0.75, false, Player.Character[ModelName].Handle)
		coroutine.wrap(function()
			pcall(function()
				Player.Character[ModelName].Source.Fire.Enabled = true
				Player.Character[ModelName].Source.Smoke.Enabled = true
				Player.Character[ModelName].Slide.Weld.C1 = CFrame.new(0, 0.3, 0)
			end)
			wait(0.075)
			pcall(function()
		...
		pcall(function() 
			...
			Shell.CFrame = Player.Character[ModelName].Handle.CFrame * CFrame.new(0.5, 0, -0.2) * CFrame.fromEulerAnglesXYZ(math.rad(math.random(0, 360)), math.rad(math.random(0, 360)), math.rad(math.random(0, 360)))
		...
		BodyVelocity.velocity = ((Mouse.Hit.p - Player.Character[ModelName].Source.Position).unit * 240) + Vector3.new(math.random(-1500, 1500) / 1000, math.random(-1500, 1500) / 1000, math.random(-1500, 1500) / 1000)
...
function onButton1Up(Mouse)
	...
	if Dual == true and Button1Down == true and CheckPlayer() == true then
		...
		SoundToServer("Fire", "http://www.roblox.com/Asset/?id=10209798", 2, 0.75, false, Player.Character[ModelName.. " (Dual)"].Handle)
		coroutine.wrap(function()
			pcall(function()
				Player.Character[ModelName.. " (Dual)"].Source.Fire.Enabled = true
				Player.Character[ModelName.. " (Dual)"].Source.Smoke.Enabled = true
				Player.Character[ModelName.. " (Dual)"].Slide.Weld.C1 = CFrame.new(0, 0.3, 0)
			end)
			wait(0.075)
			pcall(function()
		...
		pcall(function() 
			...
			Shell.BrickColor = BrickColor.new("New Yeller")
			Shell.Size = Vector3.new(0.2, 0.3, 0.2)
			Shell.CFrame = Player.Character[ModelName.. " (Dual)"].Handle.CFrame * CFrame.new(0.5, 0, -0.2) * CFrame.fromEulerAnglesXYZ(math.rad(math.random(0, 360)), math.rad(math.random(0, 360)), math.rad(math.random(0, 360)))
	...
	if Button1Down == false and CanUse == true and CheckPlayer() == true then
		...
		elseif Key == "r" then
			...
			if Dual == true then
				...
				SoundToServer("Reload 1", "http://www.roblox.com/Asset/?id=10209813", 2, 0.5, false, Player.Character[ModelName].Handle)
				SoundToServer("Reload 1", "http://www.roblox.com/Asset/?id=10209813", 2, 0.5, false, Player.Character[ModelName.. " (Dual)"].Handle)
				pcall(function()
				...
				if Loaded == false or LoadedDual == false then
					if Loaded == false then
						SoundToServer("Reload 3", "http://www.roblox.com/Asset/?id=10209636", 3, 1, false, Player.Character[ModelName].Handle)
						for i = 1, 0, -0.3 do
					...
					if LoadedDual == false then
						SoundToServer("Reload 3", "http://www.roblox.com/Asset/?id=10209636", 3, 1, false, Player.Character[ModelName.. " (Dual)"].Handle)
						for i = 1, 0, -0.3 do
							pcall(function() Player.Character[ModelName.. " (Dual)"].Slide.Weld.C1 = CFrame.new(0, 0.3 * i, 0) end)
							wait()
						end
		...
		elseif Key == "g" then
			...
			local _, HitConnection = pcall(function() return Player.Character[ModelName].Handle.Touched:connect(function(Hit)
				...
				if Humanoid ~= nil then
					...
					pcall(function()
						Humanoid.Sit = true
						Hit.Parent.Torso.Velocity = (Player.Character.Torso.Position - (Player.Character.Torso.CFrame * CFrame.new(-1, 0.6, 0.5)).p).unit * 80
					end)
					wait()
			...
			for i = 1, 0, -0.2 do
				...
				CameraPunch(0, math.rad(-12))
				wait()
			end
			pcall(function() HitConnection:disconnect() end)
			SetSpeed(2, 0.4, Player.Character)
			SetAngle(2, math.rad(90), Player.Character)
			for i = 0, 1, 0.2 do
				pcall(function()
					Player.Character.Torso["Right Shoulder 2"].C0 =
...
function onDeselected(Mouse)
	...
	if CheckPlayer() == false or pcall(function() local _ = Player.Character.Torso["Right Shoulder 2"] end) == false then
		...
		if Dual == true then RemoveParts(Player.Character, 2) end
...
elseif script.Parent.ClassName == "HopperBin" and Connected == false then
	...
	if Player.Backpack.Ammo:FindFirstChild(AmmoType) == nil then
		...
		Player.Backpack.Ammo[AmmoType].Value = MagazineCapacity * 9
	end
