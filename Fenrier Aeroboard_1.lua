...
local Effects = {}
local Mode = "Normal"
local velCF = vt(0, 0, 0)
local flyanim = false
local overjet = false
player = nil
RSH, LSH = nil, nil
RW, LW = Instance.new("Weld"), Instance.new("Weld")
RHP, LHP = Instance.new("Weld"), Instance.new("Weld")
...
local msh17 = mesh("BlockMesh", prt17, "", "", vt(0, 0, 0), vt(8, 0.5, 2.1))
local msh18 = mesh("BlockMesh", prt18, "", "", vt(0, 0, 0), vt(8, 0.5, 2.1))
...
local hwld2 = weld(hprt2, hprt2, handle, euler(0, 1.57, 0) * cf(0.2, 0, 0.4))
local hwld3 = weld(hprt3, hprt3, handle, euler(0, 1.57, 0) * cf(0.2, 0, -0.4))
local wld1 = weld(prt1, prt1, handle, euler(0, 0, 0) * cf(0.5, 1, 0))
local wld2 = weld(prt2, prt2, prt1, euler(0, 0, 1.57) * cf(0, -2.5, 1.2))
local wld3 = weld(prt3, prt3, prt2, euler(0, 0, 1.57) * cf(-0.5, 0, 0.23))
local wld4 = weld(prt4, prt4, prt3, euler(0, 0, 0) * cf(0, 0, -0.1))
local wld5 = weld(prt5, prt5, prt1, euler(0, 0, 1.57) * cf(0, -2.5, -1.2))
local wld6 = weld(prt6, prt6, prt5, euler(0, 3.14, 1.57) * cf(-0.5, 0, -0.23))
...
local wld10 = weld(prt10, prt10, prt1, euler(1.57, 0, 0) * cf(0, -0.1, 1.3))
local wld11 = weld(prt11, prt11, prt1, euler(1.57, 3.14, 0) * cf(0, -0.1, -1.3))
...
local wld15 = weld(prt15, prt15, prt12, euler(0, 0, 0) * cf(0, 0.2, 0))
local wld16 = weld(prt16, prt16, prt13, euler(0, 0, 0) * cf(0, 0.2, 0))
local wld17 = weld(prt17, prt17, prt12, euler(0, 0, 0) * cf(0, 0.6, 0))
local wld18 = weld(prt18, prt18, prt13, euler(0, 0, 0) * cf(0, 0.6, 0))
local wld19 = weld(prt19, prt19, prt1, euler(0, 0, 0) * cf(0, -2, 0))
local wld20 = weld(prt20, prt20, prt1, euler(3.14, 0, 0) * cf(0, -1.2, 0.4))
local wld21 = weld(prt21, prt21, prt1, euler(0, 0, 3.14) * cf(0, -1.2, -0.4))
local wld22 = weld(prt22, prt22, prt1, euler(0, 0, 0) * cf(0.2, -0.5, 0))
local wld23 = weld(prt23, prt23, prt1, euler(0, 0, 0) * cf(0.2, 1.7, 0))
local wld24 = weld(prt24, prt24, prt1, euler(0, 0, 0) * cf(0, 2.39, 0))
local wld25 = weld(prt25, prt25, prt1, euler(0, 1.57, 0) * cf(0, 0.29, 0))
local bprt1 = part(3, modelzorz, 0, 1, TorsoColor, "Boomerang1", vt())
local bmsh1 = mesh("CylinderMesh", bprt1, "", "", vt(0, 0, 0), vt(40, 1, 40))
local bwld1 = weld(bprt1, bprt1, prt1, euler(0, 0, 1.57) * cf(0, 0.5, 0))
eul = 0
for i = 1, 4 do
...
bg.Parent = nil
bg.maxTorque = Vector3.new(400000, 0, 400000) * math.huge
bg.P = 20000
...
function hideanim()
  ...
  for i = 0, 1, 0.1 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(1.57, -1.57, 3.5) * cf(0.6, 0.4, 1), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(-0.2, 0, -0.8), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.5), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(3.3, 0, -0.1), 0.3)
...
function equipanim()
  ...
  hwld.Part1 = RightArm
  hwld.C0 = euler(1.57, -1.57, 3.5) * cf(0.6, 0.4, 1)
  so("http://roblox.com/asset/?id=161006212", prt1, 1, 0.6)
  for i = 0, 1, 0.1 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(3.14, 3.14, 0) * cf(0, 1, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, -0.3), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0.3), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1.3, 0, -0.3), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.2), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
...
function attackone()
  ...
  for i = 0, 1, 0.1 do
    ...
    RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(2, 0, 0.5), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.57, 0, -0.8), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  Torso.Velocity = RootPart.CFrame.lookVector * 100
  so("http://roblox.com/asset/?id=161006195", prt1, 1, 0.6)
  so("http://roblox.com/asset/?id=2248511", prt1, 1, 1.4)
  MagicCircle(TorsoColor, prt1.CFrame, 1, 1, 1, 5, 5, 5, 0.05)
  hitbox.Parent = modelzorz
  hitbox.Size = vt(2, 7, 4)
  hitbox.Transparency = 1
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 5, 10, 0, "Normal", RootPart, 0.5, 1)
  end)
  num = 0
  for i = 0, 1, 0.1 do
    swait()
    hitbox.CFrame = prt1.CFrame
    if num >= 3 then
      MagicWave(TorsoColor, prt1.CFrame * cf(0, 1, 0) * euler(3.14, 0, 0), 1, 1, 1, 0.5, 1, 0.5, 0.1)
      num = 0
    end
    num = num + 1
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.2) * euler(0.2, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1.2), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1, 0, 0.5), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.8), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.5, -1, 1) * euler(0, 1.57, 0) * euler(0, -1.2, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.5, -1, -1) * euler(0, -1.57, 0) * euler(0, -1.2, 0), 0.3)
  end
  con1:disconnect()
  hitbox.Parent = nil
  swait(10)
...
function attacktwo()
  attack = true
  so("http://roblox.com/asset/?id=147722227", prt1, 1, 0.6)
  for i = 0, 1, 0.1 do
    swait()
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.2) * euler(0.2, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1.2), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, -0.8) * euler(0, 1.57, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  ...
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 10, 15, 0, "Normal", RootPart, 1, 1)
  end)
  for i = 0, 1, 0.1 do
    swait()
    Torso.Velocity = RootPart.CFrame.lookVector * 50
    MagicCircle(TorsoColor, prt1.CFrame * cf(0, 3, 0), 1, 1, 1, 5, 5, 5, 0.1)
    hitbox.CFrame = prt1.CFrame
    ...
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.2, 0, -1), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  for i = 0, 1, 0.1 do
    swait()
    ...
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2, 0, 1) * euler(0, 1.57, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
...
function attackthree()
  ...
  for i = 0, 1, 0.1 do
    ...
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1), 0.3)
    RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.57, 0, -0.6), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.57, 0, 0.8), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.5, -1, 0.5) * euler(0, 1.57, 0) * euler(0, -1, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.5, -1, -0.5) * euler(0, -1.57, 0) * euler(0, -1, 0), 0.3)
  end
  so("http://roblox.com/asset/?id=161006212", prt1, 1, 0.5)
  ...
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 10, 15, 0, "Knockdown2", RootPart, 0.5, 2)
  end)
  num = 0
  for i = 0, 2, 0.1 do
    swait()
    hitbox.CFrame = prt1.CFrame
    if num >= 3 then
      MagicWave(TorsoColor, prt1.CFrame * euler(0, 0, -1.57), 1, 1, 1, 0.8, 0.7, 0.8, 0.1)
      num = 0
    end
    num = num + 1
  end
...
function OverDrive()
  ...
  for i = 0, 1, 0.1 do
    ...
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2, 0, 0.6) * euler(0, 1, 0), 0.4)
    RW.C1 = clerp(RW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.8), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    RH.C0 = clerp(RH.C0, cf(1, -1, -0.2) * euler(0, 1.57, 0) * euler(-0.1, 0.5, -0.6), 0.3)
    LH.C0 = clerp(LH.C0, cf(-1.1, -0.4, -0.1) * euler(0, -1.57, 0) * euler(0.1, 0.5, -0.2), 0.3)
  end
  ...
  for i = 1, 2 do
    ...
    for i = 0, 4, 0.1 do
      ...
      if hit ~= nil then
        if num >= 10 then
          MagicWave(TorsoColor, cf(pos), 1, 1, 1, 0.6, 0.2, 0.6, 0.05)
          num = 0
        end
        num = num + 1
      end
    end
    MagicBlock(TorsoColor, cf(prt1.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 6, 6, 6, 0.1, 2)
  ...
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 10, 15, math.random(1, 5), "OrbBlast", RootPart, 1, 1, 1)
  end)
  for i = 0, 1, 0.1 do
    swait()
    if 5 <= num then
    ...
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.2) * euler(0.2, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1.2), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.57, 0, 1.2), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  ...
  for i = 0, 1, 0.02 do
    ...
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.6) * euler(0.2, 0, 0.5), 0.2)
    Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * euler(0, 0, -0.5) * euler(0.2, 0, 0), 0.2)
    RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1, 0, -0.4) * euler(0, 0.5, 0), 0.2)
    RW.C1 = clerp(RW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(0.5, 0, 0.8), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    RH.C0 = clerp(RH.C0, cf(1.1, -0.4, -0.1) * euler(0, 1.57, 0) * euler(-0.1, -0.5, 0.2), 0.2)
    LH.C0 = clerp(LH.C0, cf(-1, -0.8, -0.2) * euler(0, -1.57, 0) * euler(-0.1, -0.5, 0.4), 0.2)
  end
  vel.Parent = nil
...
function Boomerang()
  ...
  for i = 0, 1, 0.1 do
    ...
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2, 0, 1) * euler(0, 1.5, 0), 0.3)
    RW.C1 = clerp(RW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.6), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(1, -1, -0.2) * euler(0, 1.57, 0) * euler(-0.1, 0.5, -0.6), 0.3)
    LH.C0 = clerp(LH.C0, cf(-1.1, -0.4, -0.1) * euler(0, -1.57, 0) * euler(0.1, 0.5, -0.2), 0.3)
  end
  ...
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 10, 15, math.random(20, 30), "Knockdown2", prt1, 0.5, 2)
  end)
  so("http://roblox.com/asset/?id=10209640", prt1, 1, 0.6)
  for i = 0, 1, 0.03 do
    so("rbxasset://sounds\\swordslash.wav", prt1, 1, 1.5)
    swait()
    hitbox.CFrame = prt1.CFrame
    hwld.C0 = euler(3.14 + 6.28 * i, 3.14, 0) * cf(0, 1 + 40 * i, 0)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(0, 0, 1), 0.3)
    Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * euler(0, 0, -1), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.57, 0, 1) * euler(0, 1.5, 0), 0.3)
    RW.C1 = clerp(RW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.6), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.5, -1, 0.5) * euler(0, 1.57, 0) * euler(0, -1, 0), 0.3)
  ...
  for i = 0, 1, 0.03 do
    ...
    swait()
    hitbox.CFrame = prt1.CFrame
    hwld.C0 = euler(9.42 + 6.28 * i, 3.14, 0) * cf(0, 41 - 40 * i, 0)
  end
  con1:disconnect()
  hitbox.Parent = nil
  for _, c in pairs(modelzorz:children()) do
  ...
  for i = 0, 1, 0.05 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(3.14, 3.14, 0) * cf(0, 1, 0), 0.2)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(0, 0, -1), 0.2)
    Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * euler(0, 0, 1) * euler(0.2, 0, 0), 0.2)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1) * euler(0, 0.5, 0), 0.2)
    RW.C1 = clerp(RW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
...
function EnergyBlades()
  ...
  for i = 0, 1, 0.1 do
    ...
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.3, 1, -0.2) * euler(3.14, 0, -0.3) * euler(0, -0.5, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.2), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  ...
  for i = 0, 1, 0.15 do
    ...
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(3.14, 0, 0) * euler(0, -0.5, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.5), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  MagicCircle(TorsoColor, prt1.CFrame * cf(0, -4.5, 0), 1, 1, 1, 5, 0.5, 5, 0.05)
  so("http://roblox.com/asset/?id=169445602", prt1, 1, 0.8)
  mana = mana - 40
  for i = 100, 300, 50 do
    do
      ...
      MagicCircle(TorsoColor, sord.CFrame, 5, 5, 10, 1, 1, 3, 0.05)
      so("http://roblox.com/asset/?id=2101144", sord, 0.6, 0.7)
      ...
      con = sord.Touched:connect(function(hit)
        ...
        if hit.Name ~= "Sord" then
          ...
          MagicCircle(TorsoColor, cf(ref.Position), 1, 1, 1, 2, 2, 2, 0.01)
          MagniDamage(ref, 15, 5, 10, math.random(10, 30), "Knockdown2")
          for i = 0, 10 do
            MagicBlock(TorsoColor, cf(ref.Position), 1, 1, 1, 1, 1, 1, 0.05, 3)
          end
...
function JetMode()
  ...
  for i = 0, 1, 0.1 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(3.14, 3.14, 0) * cf(0, 1, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.5) * euler(0.2, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.5), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1.5, 0, -0.3), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.5, 0.5, -0.5) * euler(1.6, 0, 1), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  so("http://roblox.com/asset/?id=10209640", prt1, 1, 0.6)
  bg.Parent = RootPart
  ...
  LHP.Parent = Torso
  hwld.Part1 = Torso
  hwld.C0 = euler(-1.57, 3.14, 0) * cf(-1.2, -0.5, 2)
  for i = 0, 1, 0.1 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1, 2.5, 0), 0.2)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.57), 0.2)
    RootJoint.C0 = RootCF * euler(0, 0, -0.5 + 3.4 * i)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.2, 0, 0.1), 0.2)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0.2, 0, -0.1), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
  end
  for i = 0, 1, 0.05 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1.5, 2.5, 0), 0.2)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.2)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.57), 0.2)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 0.3), 0.2)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.3), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0, 0, 0.2), 0.2)
    LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0, 0, -0.2), 0.2)
  end
  attack = false
end
function attackjet()
  ...
  for i = 0, 1, 0.1 do
    swait()
    hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1.5, 2.5, 0), 0.2)
    Neck.C0 = clerp(Neck.C0, necko * euler(0.3, 0, 1.57), 0.2)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.5, 0, -1.57) * euler(0, 0, -0.5), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-1, 0, 0.5), 0.2)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1, 0, -0.5), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0, 0, 0.2), 0.2)
    LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0, 0, -0.2), 0.2)
  end
  so("http://roblox.com/asset/?id=161006221", prt1, 1, 1.1)
  hitbox.Parent = modelzorz
  hitbox.Size = vt(2, 7, 4)
  hitbox.Transparency = 1
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 7, 10, math.random(10, 30), "Knockdown2", RootPart, 0.5, 1)
  end)
  for i = 0, 1, 0.05 do
    swait()
    hitbox.CFrame = prt1.CFrame
    MagicClone(prt1, TorsoColor, prt1.CFrame, 0, 0, 0, 0.2)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.2)
    RootJoint.C0 = RootCF * cf(0, -8 * i, 0) * euler(0.5 - 1.2 * i, 0, -1.57 + 5 * i) * euler(0, 0, -0.5 + 0.5 * i)
  ...
  for i = 0, 1, 0.1 do
    swait()
    hitbox.CFrame = prt1.CFrame
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.1)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.57) * euler(0, 0, 0), 0.1)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.57), 0.1)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.57), 0.1)
...
function OverDriveJet()
  attack = true
  flyanim = true
  overjet = true
  for i = 0, 1, 0.1 do
    swait()
    velCF = vt(RootPart.CFrame.lookVector.x * 50 * (i * 1.5), RootPart.CFrame.lookVector.y * 0, RootPart.CFrame.lookVector.z * 50 * (i * 1.5))
    hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1.5, 2.5, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.2, 0, -1.57), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.57), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.57), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0, 0, 0.2), 0.3)
    LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0, 0, -0.2), 0.3)
  end
  for i = 25, 125 do
    swait()
    velCF = vt(RootPart.CFrame.lookVector.x * 75, RootPart.CFrame.lookVector.y * 0, RootPart.CFrame.lookVector.z * 75)
    if i % 25 == 0 then
      mana = mana - 12
      local ref = part(3, workspace, 0, 0.5, TorsoColor, "Effect", vt())
      ref.Anchored = true
      ref.CFrame = cf(prt1.Position)
      rmsh = mesh("SpecialMesh", ref, "Sphere", "", vt(0, 0, 0), vt(15, 15, 15))
      MagicBlock(TorsoColor, cf(ref.Position), 5, 5, 5, 1, 1, 1, 0.05, 1)
      so("http://roblox.com/asset/?id=160745944", ref, 1, 1)
      game:GetService("Debris"):AddItem(ref, 4)
      coroutine.resume(coroutine.create(function(Part, CF)
        while Part.Parent ~= nil do
          swait()
        end
        local ref = part(3, workspace, 0, 1, TorsoColor, "Effect", vt())
        ref.Anchored = true
        ref.CFrame = CF
        game:GetService("Debris"):AddItem(ref, 1)
        so("http://roblox.com/asset/?id=161006093", ref, 1, 1)
        so("http://roblox.com/asset/?id=10209303", ref, 1, 1)
        MagicCircle(TorsoColor, cf(ref.Position), 20, 20, 20, 15, 15, 15, 0.1)
        MagicBlock(TorsoColor, cf(ref.Position), 20, 20, 20, 1, 1, 1, 0.05, 1)
        coroutine.resume(coroutine.create(function(Part)
          for i = 0, 30 do
            swait()
            MagicBlock(TorsoColor, cf(Part.Position) * cf(math.random(-300, 300) / 100, math.random(-300, 300) / 100, math.random(-300, 300) / 100), 1, 1, 1, 1, 1, 1, 0.1, 3)
          end
        end), ref)
        MagniDamage(ref, 20, 15, 25, math.random(20, 40), "Knockdown")
      end), ref, ref.CFrame)
    end
  end
  overjet = false
...
function BoomerangJet()
  ...
  hwld.Part1 = RootPart
  hwld.C0 = euler(2, 0, -1.57) * cf(0, 2.5, 0)
  hitbox.Parent = modelzorz
  hitbox.Size = vt(1, 10, 10)
  hitbox.Transparency = 1
  hitbox.CFrame = prt1.CFrame
  con1 = hitbox.Touched:connect(function(hit)
    Damagefunc(hit, 10, 20, math.random(30, 40), "Knockdown2", prt1, 0.5, 2)
  end)
  so("http://roblox.com/asset/?id=10209640", prt1, 1, 0.6)
  for i = 0, 1, 0.05 do
    swait()
    so("rbxasset://sounds\\swordslash.wav", prt1, 1, 1.3)
    hitbox.CFrame = prt1.CFrame
    hwld.C0 = euler(2 - 5 * i, 0, -1.57) * cf(0, 2.5 - 2 * i, 30 * i)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
    RootJoint.C0 = RootCF * euler(0.5 - 1.5 * i, 0, -1.57) * euler(0, 0, -0.5 + 4 * i)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.57), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.57), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  ...
  for i = 0, 1, 0.05 do
    ...
    so("rbxasset://sounds\\swordslash.wav", prt1, 1, 1.3)
    hitbox.CFrame = prt1.CFrame
    hwld.C0 = euler(-3 - 5 * i, 0, -1.57) * cf(0, 0.5 + 2 * i, 30 - 35 * i)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.57) * euler(0, 0, 0), 0.1)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1), 0.15)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-1, 0, -1), 0.15)
...
function EnergySwordJet()
  ...
  for i = 0, 1, 0.1 do
    ...
    hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1.5, 2.5, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(-1, 0, -1.57), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.57), 0.2)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.57), 0.2)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
  ...
  for i = 0, 1, 0.01 do
    ...
    if 20 <= num then
      do
        local sord = part(3, modelzorz, 0, 0.5, TorsoColor, "Sord", vt(1, 1, 4))
        local smsh = mesh("SpecialMesh", sord, "FileMesh", "rbxasset://fonts/sword.mesh", vt(0, 0, 0), vt(2, 2, 2))
        sord.Anchored = true
        newCF = cf(math.random(-600, 600) / 100, math.random(-600, 600) / 100, math.random(-600, 600) / 100)
        sord.CFrame = cf(RootPart.Position) * newCF
        sord.CFrame = cf(sord.Position, MMouse.Hit.p) * euler(3.14, 0, 0)
        MagicCircle(TorsoColor, sord.CFrame, 5, 5, 10, 1, 1, 3, 0.05)
        so("http://roblox.com/asset/?id=169445602", sord, 1, 0.7)
        game:GetService("Debris"):AddItem(sord, 5)
        local hitt = false
        con = sord.Touched:connect(function(hit)
          if hitt == true then
            return
            ...
            for _, c in pairs(workspace:children()) do
              ...
              if hum ~= nil then
                ...
                if head ~= nil then
                  ...
                  if mag <= 10 and c.Name ~= Player.Name then
                    Part.Parent = nil
                    local ref = part(3, workspace, 0, 1, TorsoColor, "Effect", vt())
                    ref.Anchored = true
                    ref.CFrame = cf(Part.Position)
                    so("http://roblox.com/asset/?id=161006093", ref, 1, 1)
                    so("http://roblox.com/asset/?id=10209303", ref, 1, 1)
                    MagicCircle(TorsoColor, cf(ref.Position), 1, 1, 1, 2, 2, 2, 0.01)
                    for i = 0, 10 do
    ...
    num = num + 1
    RootJoint.C0 = RootCF * euler(-1, 0, -1.57) * euler(0, 0, 25 * i)
  end
  attack = false
end
function ExitJet()
    ...
    if hum ~= nil then
      ...
      if head ~= nil then
        ...
        if magni >= mag and c.Name ~= Player.Name then
          Damagefunc(head, mindam, maxdam, knock, Type, Part, 0.2, 1, 3, 1)
        end
      end
    end
  end
...
function MagicBlock(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay, Type)
  ...
  elseif Type == 3 then
    table.insert(Effects, {
      ...
      z3,
      msh,
      vt(math.random(-10, 10) / 10, math.random(-10, 10) / 10, math.random(-10, 10) / 10)
    })
  end
end
...
function MagicClone(part, brickcolor, cframe, x3, y3, z3, delay)
  local prt = part:clone()
  for _, v in pairs(prt:children()) do
...
function Damagefunc(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, decreaseblock)
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
    ...
    if Type == "Knockdown" then
      ...
      bodvol.velocity = angle * knockback / 1.5
      bodvol.P = 5000
    ...
    elseif Type == "OrbBlast" then
      if 30 <= mana then
        ...
        MagicCircle(TorsoColor, cf(hit.Position), 1, 1, 1, 2, 2, 2, 0.01)
        coroutine.resume(coroutine.create(function(Part)
          for i = 0, 30 do
            swait()
            MagicBlock(TorsoColor, cf(Part.Position), 1, 1, 1, 1, 1, 1, 0.05, 3)
          end
        end), hit)
        local ref = part(3, workspace, 0, 1, hit.BrickColor, "Effect", vt())
        ref.Anchored = true
        ref.CFrame = cf(hit.Position) * cf(math.random(-10, 10) / 100, -0.1, math.random(-10, 10) / 100)
        game:GetService("Debris"):AddItem(ref, 1)
        MagniDamage(ref, 10, 10, 20, math.random(20, 40), "Knockdown2")
      end
...
function key(key)
  ...
  if Mode == "Normal" then
    if key == "z" and mana >= 20 then
      OverDrive()
    end
    if key == "x" and mana >= 40 then
      Boomerang()
    end
    if key == "c" and mana >= 30 and cansword == true then
      cansword = false
      coroutine.resume(coroutine.create(function()
        swait(500)
        cansword = true
    ...
    if key == "q" then
      ...
      attack = true
      flyanim = true
      velCF = vt(RootPart.CFrame.lookVector.x * 30, 20, RootPart.CFrame.lookVector.z * 30)
      coroutine.resume(coroutine.create(function()
        while holdq == true do
          swait()
          velCF = vt(RootPart.CFrame.lookVector.x * 30, 20, RootPart.CFrame.lookVector.z * 30)
          hwld.C0 = clerp(hwld.C0, euler(0, 0.4, -1.57) * cf(1.2, 2.5, 0.5), 0.2)
          ...
          LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.3), 0.2)
          LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
          RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0.4, 0, 0.2), 0.2)
          LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0.4, 0, -0.2), 0.2)
        end
        attack = false
        flyanim = false
      end))
    ...
    if key == "e" then
      ...
      coroutine.resume(coroutine.create(function()
        while holde == true do
          ...
          RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.2, 0, -1.57), 0.3)
          RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.5), 0.2)
          RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
          LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.5), 0.2)
          LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
          RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0, 0, 0.2), 0.2)
          LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0, 0, -0.2), 0.2)
        end
...
while true do
  ...
  if equipped == true then
    ...
    if Mode == "Jet" then
      if flyanim == false then
        velCF = vt(RootPart.CFrame.lookVector.x * 50, RootPart.CFrame.lookVector.y * 0, RootPart.CFrame.lookVector.z * 50)
      end
      velx.velocity = velCF
      bg.Parent = nil
      if flyanim == false and attack == false then
        Anim = "Fly"
        hwld.C0 = clerp(hwld.C0, euler(0, 0, -1.57) * cf(1.5, 2.5, 0), 0.3)
        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57), 0.3)
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0.1, -1.57), 0.3)
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.5 + donum * 2, 0, 0.3), 0.2)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.5 + donum * 2, 0, -0.3), 0.2)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
        RHP.C0 = clerp(RHP.C0, cf(0.5, -1, 0) * euler(0, 0, 0.2), 0.2)
        LHP.C0 = clerp(LHP.C0, cf(-0.5, -1, 0) * euler(0, 0, -0.2), 0.2)
      end
    elseif 1 < RootPart.Velocity.y and hitfloor == nil then
      ...
      if attack == false then
        ...
        RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1.2, 0, -0.5), 0.2)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.5, 0, -0.5), 0.2)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
    ...
    elseif -1 > RootPart.Velocity.y and hitfloor == nil then
      ...
      if attack == false then
        ...
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 0.3), 0.1)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0.3, 0, -0.2), 0.1)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
    ...
    elseif torvel < 1 and hitfloor ~= nil then
      ...
      if idle >= 300 then
        if attack == false then
          hwld.C0 = clerp(hwld.C0, euler(-0.3, 2.8, 1.4) * cf(-1.5, 0, 0.7), 0.1)
          Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 0), 0.1)
          RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.1)
          RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.3) * euler(0.5, 0, 0), 0.1)
          RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
          LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.2), 0.1)
          LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
        end
      elseif attack == false then
        ...
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0.3), 0.3)
        RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1.3 - donum / 3, 0, -0.3 - donum / 5), 0.3)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.2 + donum / 5), 0.3)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
        RH.C0 = clerp(RH.C0, RHC0, 0.3)
        LH.C0 = clerp(LH.C0, LHC0, 0.3)
      end
    elseif torvel > 2 and torvel < 22 and hitfloor ~= nil then
      ...
      if attack == false then
        hwld.C0 = clerp(hwld.C0, euler(3.14, 3.14, 0) * cf(0, 1, 0), 0.3)
        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.5), 0.3)
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.2, 0, 0.5), 0.3)
        RW.C0 = clerp(RW.C0, cf(1.3, 0.5, -0.2) * euler(1.2, 0, -0.5), 0.3)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-0.2, 0, -0.2), 0.3)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
        ...
        if Thing ~= nil then
          ...
          if 1 >= Thing[1].Transparency then
            ...
            elseif Thing[2] == "Elec" then
              ...
              Thing[1].Transparency = Thing[1].Transparency + Thing[3]
            elseif Thing[2] == "Ring" then
              Mesh = Thing[7]
              Mesh.Scale = Mesh.Scale + vt(Thing[4], Thing[5], Thing[6])
              Thing[1].Transparency = Thing[1].Transparency + Thing[3]
              Thing[1].CFrame = Thing[1].CFrame * cf(0, 0, -Thing[8])
  ...
  elseif mananum <= 8 then
    ...
    elseif Mode == "Jet" then
      mana = mana - 1
      if attack == false then
        MagicRing(Torso.BrickColor, prt22.CFrame * euler(0, 1.57, 0), 1, 1, 1, 0.5, 0.5, 0.5, 0.05, 0.2)
      end
      if overjet == true then
        MagicRing(Torso.BrickColor, prt22.CFrame * euler(0, 1.57, 0), 1, 1, 1, 0.5, 2, 1, 0.1, 0)
      end
    end
  end
