...
Meshes = {
	Coif = {Asset..(81724611), Asset..(73791519)},
	Torso = {Asset..(71440926), Asset..(71440868)},
	Rarm = {Asset..(71440926), Asset..(71440800)},
	Larm = {Asset..(71440926), Asset..(71440752)},
	Rleg = {Asset..(71440926), Asset..(71440824)}, 
	Lleg = {Asset..(71440926), Asset..(71440777)},
	Sword = {Asset..(11442524), Asset..(11442510)},
	Shield = {Asset..(49759449), Asset..(0)},
}
...
Add.Mesh(HatHandle, Meshes.Coif[2], Meshes.Coif[1], V3(1.8,1.8,2.2))
...
function SE(part, cf)
	coroutine.resume(coroutine.create(function()
		...
		while Effect do
			wait()
			local p = Part(Mod, true, false, 0, 0, "Medium stone grey", V3(0.2, 0.2, 0.2))
