...
z.SoundId = "http://www.roblox.com/asset/?id=154564700"--160453802
z.Parent = char
z.Looped = true
z.Pitch = 1
z.Volume = 1
...
x.SoundId = "http://www.roblox.com/asset/?id=154564700"
x.Parent = char.Head
x.Looped = false
x.Pitch = .88
x.Volume = 1
        ...
        if CanAttack == true then
            ...
            torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, 2, 0) * CFrame.Angles(math.rad(-10), math.rad(0), 0), 0.2)
                  ...
                  wait()
                    ...
                    c.SoundId = "http://www.roblox.com/asset/?id=154564700"
                    c.Parent = m
                    c.Looped = false
                    if Daytime == true then
                        c.Pitch = -1
