...
Debounce = true
Hurt = false
ModelName = "get on my level gun"
ToolName = "getonmylevelgun"
Icon = Asset..(58334502)
function ReNew()
if EffectModel then
...
Sounds = {
Fire = {Id = Asset..(130780450), Pitch = 0.92, Volume = 0.8},
Reload = {Id = Asset..(2697295), Pitch = 1, Volume = 0.5},
Slash = {Id = "rbxasset://sounds//swordlunge.wav", Pitch = 1.2, Volume = 0.6},
Out = {Id = "rbxasset://sounds\\clickfast.wav", Pitch = 1.4, Volume = 0.6},
Hit = {Id = Asset..(131864673), Pitch = 1.1, Volume = 0.45},
