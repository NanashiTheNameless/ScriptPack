--I'm a master at fixing these :P ~Pix
...
LW = Instance.new("Motor") LW.Name = "Left Shoulder"
LH = Torso["Left Hip"]
RH = Torso["Right Hip"]
...
attackone = function()
  ...
  for i = 1, 10 do
    ...
    hitboxCF = cf(ref.Position)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 4, 4, 7, math.random(5, 10), "Normal", true, nil, nil, nil, math.random(5, 10), RootPart)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
...
attackthree = function()
  ...
  for i = 1, 10 do
    ...
    hitboxCF = cf(ref.Position)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 7, 4, 10, math.random(5, 10), "Normal", true, nil, nil, nil, math.random(10, 15), RootPart)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      ...
      if hitfloor2 ~= nil then
        ...
        for i = 1, 2 do
          ...
          hitboxCF = cf(ref.Position)
          hitbox.CFrame = hitboxCF
          MagniDamage(hitbox, 5, 4, 10, math.random(5, 10), "Knockdown2", true, nil, nil, nil, math.random(5, 10), RootPart)
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              if StaggerHit.Value == true then
                break
  ...
  while meditating==true do
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      ...
      if medinum3 >= 200 then
        medinum3 = 0
        MagniBuff(RootPart, 30, "Defense", -0.2, 200)
      else
        medinum3 = medinum3 + 1
      end
      if meditatenum >= 5 then
        ...
        if hit ~= nil then
          MagicCircle(BrickColor.new(NewCol), cf(ref.Position), 1, 1, 1, 0.5, 7, 0.5, 0.1)
        end
      else
        meditatenum = meditatenum + 1
      end
      hit2 = rayCast(Torso.Position, CFrame.new(Torso.Position, Torso.Position - Vector3.new(0, 1, 0)).lookVector, 100, Character)
      if hit2 ~= nil then
        swait()
        prt.CFrame = cf(RightLeg.Position) * euler(0, eul, 0)
        eul = eul + 0.1
      end
    end
  end
    ...
    for i = 1, 4 do
      ...
      for i = 0, 1, 0.7 do
        ...
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            ...
            -- DECOMPILER ERROR at PC613: LeaveBlock: unexpected jumping out IF_THEN_STMT

            -- DECOMPILER ERROR at PC613: LeaveBlock: unexpected jumping out IF_STMT
      ...
      if Stagger.Value ~= true then --and StunT.Value > Stun.Value then
        do
          ...
          -- DECOMPILER ERROR at PC669: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC669: LeaveBlock: unexpected jumping out IF_STMT
          ...
          for i = 1, 20 do
            ...
            if Stagger.Value ~= true and StunT.Value > Stun.Value then
              do
                ...
                -- DECOMPILER ERROR at PC1047: LeaveBlock: unexpected jumping out IF_THEN_STMT

                -- DECOMPILER ERROR at PC1047: LeaveBlock: unexpected jumping out IF_STMT
...
cooldowns[3] = 100
  ...
  if cooldownmax <= cooldowns[3] then
    ...
    for i = 0, 1, 0.1 do
      ...
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.4)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.3, -0.5) * euler(1.3, 0, -1.5) * euler(0, 0, 0), 0.4)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.3, -0.5) * euler(1.3, 0, 1.5) * euler(0, 0, 0), 0.4)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, 0, 0), 0.4)
      LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0, 0), 0.4)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
    ...
    for i = 1, 0, -0.05 do
      ...
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.7) * euler(0.2, 0, 0), 0.15)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(-0.2, 0, 0.6), 0.15)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.4, 0, 0.4) * euler(0, 0.4, 0), 0.15)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(-1, 0, -2) * euler(0, 2, 0), 0.15)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
      RH.C0 = clerp(RH.C0, cf(1, -0.7, 0) * euler(0, 1.57, 0) * euler(-0.2, -0.2, 0.2), 0.15)
      LH.C0 = clerp(LH.C0, cf(-1, -0.8, 0) * euler(0, -1.57, 0) * euler(-0.2, 0, 0.4), 0.15)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
            break
    ...
    for i = 0, 1, 0.2 do
      ...
      hitboxCF = LeftArm.CFrame
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 10, 15, math.random(20, 30), "Knockdown2", true, "Movement", 0.4, 400, 100, RootPart)
      ...
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      LW.C0 = clerp(LW.C0, cf(-1.3, 0.5, -0.2) * euler(1.5, 0, 0.2) * euler(0, 0, 0), 0.4)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          ...
          -- DECOMPILER ERROR at PC720: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC720: LeaveBlock: unexpected jumping out IF_STMT
    ...
    for i = 0, 1, 0.1 do
      ...
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.2, 0, -0.8), 0.15)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 0.4), 0.15)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.3, 0, 0.6) * euler(0, 0, 0), 0.15)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
      RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(-0.2, 0.2, -0.4), 0.15)
      LH.C0 = clerp(LH.C0, cf(-1, -0.8, 0) * euler(0, -1.57, 0) * euler(-0.2, 0, -0.2), 0.15)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          if StaggerHit.Value == true then
            break
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    for i = 1, 2 do
      ...
      for i = 0, 1, 0.1 do
        ...
        hitboxCF = LeftArm.CFrame
        hitbox.CFrame = hitboxCF
        MagniDamage(hitbox, 5, 15, 20, 0, "Knockdown2", true, "Defense", 0.3, 100, 20, RootPart)
        if Rooted.Value == false then
        ...
        if Effects[e] ~= nil then
          ...
          if Thing ~= nil then
            ...
            if Thing[2] == "Plasma" then
              ...
              hitflooro = rayCast(Thing[1].Position - vt(0, 1, 0), CFrame.new(Thing[1].Position, Thing[1].Position - Vector3.new(0, 2, 0)).lookVector, 100, Character)
              if hitflooro ~= nil then
                if hitflooro.Anchored == true then
                  Thing[3].CFrame = cf(Torso.Position) * euler(0, Thing[6], 0) --(posflooro) * euler(0, Thing[6], 0)
                else
              ...
              if Thing[4] <= 400 then
                ...
                if 50 <= Thing[5] then
                  ...
                  MagniBuff(Thing[1], 25, "Defense", -0.1, 200)
