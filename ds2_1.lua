...
z.SoundId = "rbxassetid://0"--242463565
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.01)
...
to = char.Absolution.Thingy.Touched:connect(function(ht)
        hit = ht.Parent
...
mouse.KeyDown:connect(function(key)
	...
	for i = 1, 20 do
		...
		torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1, 0) * CFrame.Angles(0, math.rad(0), math.rad(0)), 0.4)
	...
	for i = 1, 20 do
		...
		torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1, 0) * CFrame.Angles(0, math.rad(40), math.rad(0)), 0.4)
		lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -1, 0) * CFrame.Angles(0, 0, math.rad(-8)), 0.4)
		rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(0.5, -1, 0) * CFrame.Angles(0, 0, math.rad(8)), 0.4)
		if Debounces.on == false then break end
		rs:wait()
	...
	for i = 1, 20 do
		...
		torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(0), math.rad(-30), math.rad(0)), 0.3)
	...
	sp2:Destroy()
			for i = 1, 20 do
				...
				torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1, 0) * CFrame.Angles(math.rad(0), math.rad(30), math.rad(0)), 0.4)
...
for i = 1, 2 do
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5,.45,0)*CFrame.Angles(math.rad(0),math.rad(0),math.rad(20)), 0.2)
...
larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5, .60+.1*math.cos(sine/7), -math.sin(sine/14)/2)*CFrame.Angles(math.sin(sine/14)/2, math.rad(1) + -math.sin(sine/14)/2, math.rad(-30)), 0.2)
...
lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -1-0.3*math.cos(sine/14)/2, -.05 + math.sin(sine/14)/6.5) * CFrame.Angles(math.rad(-20) + -math.sin(sine/14)/1.15, 0, 0), .2)
rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(0.5, -1+0.3*math.cos(sine/14)/2, -.05 + -math.sin(sine/14)/6.5) * CFrame.Angles(math.rad(-20) + math.sin(sine/14)/1.15, 0, 0), .2)
cor.Weld.C0 = Lerp(cor.Weld.C0, CFrame.new(0, -1, -1.1) * CFrame.Angles(math.rad(-90), math.rad(-110), math.rad(-70)), 1)
end
elseif animpose == "Running" then
change = 1
...
lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -1-0.3*math.cos(sine/8)/2.4, -.15 + math.sin(sine/8)/6) * CFrame.Angles(math.rad(-20) + -math.sin(sine/8)/1.7, 0, 0), .4)
rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(0.5, -1+0.3*math.cos(sine/8)/2.4, -.15 + -math.sin(sine/8)/6) * CFrame.Angles(math.rad(-20) + math.sin(sine/8)/1.7, 0, 0), .4)
cor.Weld.C0 = Lerp(cor.Weld.C0, CFrame.new(0, -1.85, -.9) * CFrame.Angles(math.rad(-90), math.rad(-90), math.rad(0)), 1)
end
end
