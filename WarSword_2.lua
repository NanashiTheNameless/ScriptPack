while game.Players.yfc.PlayerGui:FindFirstChild("yfc's Sword") == nil do
wait()
if game.Players.yfc.PlayerGui:FindFirstChild("yfc's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.yfc.PlayerGui
screengui.Name = "yfcs's Sword"
