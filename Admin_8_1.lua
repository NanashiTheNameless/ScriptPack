...
adminlist = {"polo1716", "ic3w0lf589"}--Add in the names of the people you want to be able to use the command script here.
--Please keep 'toby151' in there. ;)
...
owner = "BlueCamaro60" --Change this to your name
...
if msg:sub(1,7) == "noobinsert/" then
local player = findplayer(msg:sub(8),speaker)
if player ~= 0 then
for i = 1,#player do
local insert = game:GetService("InsertService"):LoadAsset(62331406)
insert:MakeJoints()
insert["Insert"].Parent = player[i].Backpack
insert:remove()
end end end
