...
local atk = Instance.new("ScreenGui",game.Players.LocalPlayer.PlayerGui)
	...
	atkf.Position = UDim2.new(0.5,-375,1,-140)
...
game.Players.LocalPlayer.PlayerGui.ScreenGui.Frame.TextButton24.MouseButton1Down:connect(function()
