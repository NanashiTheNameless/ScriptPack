...
function makeParts(format)
	...
	if format == "hand" then
		...
		w.C0 = CFrame.new(0, -0.3, 1.1) * CFrame.fromEulerAnglesXYZ(math.rad(90), 0, 0)
		w.C1 = CFrame.new()
...
function onKeyDown(key, mouse)
	...
	if key == "z" and Button1Down == false and canUse == true then
		...
		bodyVelocity.velocity = (mouse.Hit.p - Player.Character[Name].Handle.CFrame.p).unit * 100
