...
if Hair then
        ...
        local Hair = part:Clone()
        Hair.Parent = Model
        Hair.Mesh:Destroy()
        local m = Instance.new("SpecialMesh",Hair)
        m.MeshId = "http://www.roblox.com/asset/?id=62246019"
        --m.TextureId = "http://www.roblox.com/asset/?id=91740209"
        m.Scale = Vector3.new(1,1,1)
        m.VertexColor = Vector3.new(clr.Color.r,clr.Color.g,clr.Color.b)
        weld(hd,Hair,CFrame.new(-0.06,0.3,0.2))
end
if suit then
