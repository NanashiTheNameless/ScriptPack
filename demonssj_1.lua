...
Weld.C0 = CFrame.new(0, -1.2, 4)*CFrame.fromEulerAnglesXYZ(0, 0, 0) 
...
pie.Size = 12
pie.Color = BrickColor.new("Black").Color
pie.SecondaryColor = BrickColor.new("Bright red").Color
pie.SecindarySize = 11
end
...
jun.Character.Torso:findFirstChild("PwnFire"):Remove()
     ...
     p.BrickColor = BrickColor.new("Black","Black")
     for i = 1 , 10 do
      wait(0.05)
...
jun.Chatted:connect(function(Msg)
 msg = Msg:lower()
 if string.sub(msg, 1, 7) == "demon" then
 wait(0.1)
  ssj()
 end
 ...
 if string.sub(msg, 1, 6) == "demon" then
 wait(0.1)
  ssj()
 end
