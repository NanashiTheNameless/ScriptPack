...
handletip1 = Part(Mo, false, false, 0, 0.2, "Really Pink", 0.5, 0.5, 0.5, true)
...
for i = 0, 40, 40 do
	...
	local p = Part(Mo, false, false, 0, 0, "Really Pink", 0.2, 0.2, 0.2, true)
	...
	local p2 = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.2, 0.2, true)
...
fretboard = Part(Mo, false, false, 0, 0, "Pink", 0.45, 2.6, 0.6, true)
...
for i = 0, 2.48, 2.48/10 do
	...
	local p = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.55, 0.2, true)
...
for i = -0.24, 0.24, 0.48/6 do
	...
	local p = Part(Mo, false, false, 0, 0, "Pink", 0.2, 3.7, 0.2, true)
...
stringattach = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.2, 0.8, true)
...
vibra = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.32, 0.2, true)
...
vibra2 = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.62, 0.2, true)
...
for i = 0, 180, 180 do
	...
	for x = -0.4, 0.2, 0.3 do
		...
		local p3 = Part(Mo, false, false, 0, 0, "Pink", 0.2, 0.3, 0.2, true)
...
for i = -0.6, 0.61, 1.2 do
	...
	local p = Part(Mo, false, false, 0, 0, "Really Pink", 0.5, 2.8, 0.2, true)

	Weld(torso, p, 0, 0, i, 0, 0, math.rad(-40))

	local p2 = Part(Mo, false, false, 0, 0, "Really Pink", 0.5, 0.2, 1.1, true)
