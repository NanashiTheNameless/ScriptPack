...
-----ParticleSpawn------
local ps = Instance.new("Part", Character)
ps.Name="PS"
ps.Transparency=1
wld = Instance.new('Weld',Character.PS)
wld.Part0 = Character.Torso
wld.Part1 = ps
wld.C0=CFrame.new(0, 5, 0)*CFrame.Angles(0,0,math.rad(0))
-----Asriel {R} Arm-----
...
----------------
for i,v in pairs(game.Workspace.PixelFir3.wep1:GetChildren()) do
if v.ClassName=="Part" or v.ClassName=="UnionOperation" then
v.Transparency=1
end
end
for i,v in pairs(game.Workspace.PixelFir3.wep2:GetChildren()) do
if v.ClassName=="Part" or v.ClassName=="UnionOperation" then
v.Transparency=1
end
end
...
con:disconnect() ]]
    attack=true
    con1=Hitbox.Touched:connect(function(hit) Damagefunc(hit,12,30,math.random(5,10),"Normal",RootPart,.2,1) end) 
    for i=0,1,0.08 do
        swait()
...
--LaserBarrage(Character.DeathRay,m)
...
wait(0.001)
s:Play()
--n--so("http://www.roblox.com/asset/?id=340722848",Character.DeathRay,1,1)
--so("http://www.roblox.com/asset/?id=345052019",Character.DeathRay,1,1)
for i = 0,1,0.1 do
swait()
RootJoint.C0 = clerp(RootJoint.C0,RootCF*cf(0,0,0)* angles(math.rad(0),math.rad(0),math.rad(-50)),.3)
Torso.Neck.C0 = clerp(Torso.Neck.C0,necko *angles(math.rad(0),math.rad(0),math.rad(50)),.3)
...
wait(0.001)
son:Play()
--so("http://www.roblox.com/asset/?id=401604539",EffectPart2,1,1)
--n--so("http://www.roblox.com/asset/?id=199145659",EffectPart2,1,1)
...
son:Play()
	...
	for i=0,1,.1 do
	swait()
	RootJoint.C0 = clerp(RootJoint.C0,RootCF*cf(0,0,3)* angles(math.rad(-10),math.rad(0),math.rad(0)),.3)
	Torso.Neck.C0 = clerp(Torso.Neck.C0,necko *angles(math.rad(-25),math.rad(0),math.rad(0)),.3)
	RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * angles(math.rad(150), math.rad(-5), math.rad(8)), 0.3)
	LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * angles(math.rad(150), math.rad(5), math.rad(-8)), 0.3)
	RH.C0=clerp(RH.C0,cf(1,-1,0)*angles(math.rad(-10),math.rad(90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
	...
	coroutine.resume(coroutine.create(function() ChargeBall(Character.PS,120) end))
	--coroutine.resume(coroutine.create(function() ChargeBall(EffectPart,120) end))
	local n=2
	local orb=ppart(3,Character,0,1,BrickColor.random(),"Orb",vt())
	local omsh=mesh("SpecialMesh",orb,"Sphere","",vt(0,0,0),vt(15,15,15))
...
elseif attack==false and stanceToggle=="Flight" then
change = 1
...
RH.C0=clerp(RH.C0,cf(0,-.8,0)*angles(math.rad(-0),math.rad(90),math.rad(0)),.3)
LH.C0=clerp(LH.C0,cf(0,-.8,0)*angles(math.rad(-0),math.rad(-90),math.rad(-0)),.3)
...
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(math.rad(-10),math.rad(20),math.rad(20)),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(math.rad(-10),math.rad(20),math.rad(-20)),.3)
RH.C0=clerp(RH.C0,cf(0,-.8,0)*angles(math.rad(-0),math.rad(90),math.rad(-20)),.3)
LH.C0=clerp(LH.C0,cf(0,-.8,0)*angles(math.rad(-0),math.rad(-90),math.rad(20)),.3)
handleweld.C0=clerp(handleweld.C0,cf(0,-0,0)*angles(math.rad(5),math.rad(-10),math.rad(0)),.3) ]]
