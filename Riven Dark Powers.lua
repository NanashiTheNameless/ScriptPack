...
regws=16
bigws=14
hum.MaxHealth=2000000
spawn(function()
    wait() hum.Health=2000000
end)
        ...
        if d then
            ...
            local nct=sw.Touched:connect(function(part)
                if part.Parent and part.Parent:findFirstChild('Humanoid') and not part:IsDescendantOf(ch) and not dmgdealt then
                    dealDamage(part.Parent,40.5,50,20,20)
                    dmgdealt=true
                end
           ...
           if can==true then
    	     ...
    	     game.Debris:AddItem(db,0.5)
    	      ...
    	      if humin then
        	      ...
        	      dealDamage(humin.Parent,30*multiplier,10,1,0.05)
        	      humin.Sit=true
           ...
           if can==true then
    	     ...
    	     game.Debris:AddItem(db,0.5)
    	      ...
    	      if humin then
        	      ...
        	      if humin.Health>=php and humin.MaxHealth~=math.huge then
        	         print('equal')
        	         humin:TakeDamage(40*multiplier)
        	      end
        	  end
    	   end
	   end
