...
function MakeKnife(Arm)
    ...
    local Blade1 = Part(Weapon, false, false, 0, 0, BN("Mid gray"), V3(0.2, 0.5, 0.3))
    local Blade2 = Part(Weapon, false, false, 0, 0, BN("Mid gray"), V3(0.2, 0.4, 0.4))
    local Blade3 = Part(Weapon, false, false, 0, 0, BN("Mid gray"), V3(0.2, 0.8, 0.4))
    local Blade4 = Part(Weapon, false, false, 0, 0, BN("Mid gray"), V3(0.2, 0.7, 0.4))
    Add.Mesh(Handle)
    Add.Cylinder(Derp)
    Add.Block(Blade1)
    Add.Block(Blade2)
