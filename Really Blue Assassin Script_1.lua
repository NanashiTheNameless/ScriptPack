...
f = Instance.new("Fire")
f.Parent = game.Workspace.epicikr.Head  ----Put your username where it says "epicikr"
f.Color = Color3.new(0,0,153) 
f.SecondaryColor = Color3.new(0,0,153) 
f.Size = 3
Players = game.Players
Workspace = game.Workspace
HopperBinName = "the Really blue blade"
Activated = false
Equipped = false
Equipping = false
Unequipping = false
...
Damage = 9999999999
ExplosionVictim = ""
Name = "epicikr"  -----Put your username where it says: "epicikr"
...
Bar2.BackgroundColor = BrickColor.new("Really blue")
...
Grip1.Parent = Tool
Grip1.Locked = true
Grip1.BrickColor = BrickColor.new("Really blue")
...
Grip2.Parent = Tool
Grip2.Locked = true
Grip2.BrickColor = BrickColor.new("Really blue")
...
Grip3.Parent = Tool
Grip3.Locked = true
Grip3.BrickColor = BrickColor.new("Really blue")
...
Grip4.Parent = Tool
Grip4.Locked = true
Grip4.BrickColor = BrickColor.new("Really blue")
...
Grip5.Parent = Tool
Grip5.Locked = true
Grip5.BrickColor = BrickColor.new("Really blue")
...
Grip6.Parent = Tool
Grip6.Locked = true
Grip6.BrickColor = BrickColor.new("Really blue")
...
Grip7.Parent = Tool
Grip7.Locked = true
Grip7.BrickColor = BrickColor.new("Really blue")
...
Grip8.Parent = Tool
Grip8.Locked = true
Grip8.BrickColor = BrickColor.new("Really blue")
...
Grip9.Parent = Tool
Grip9.Locked = true
Grip9.BrickColor = BrickColor.new("Really blue")
...
Grip10.BrickColor = BrickColor.new("Really blue")
...
Grip11.Parent = Tool
Grip11.Locked = true
Grip11.BrickColor = BrickColor.new("Really blue")
...
Grip12.BrickColor = BrickColor.new("Really blue")
...
Grip13.BrickColor = BrickColor.new("Really blue")
...
Grip14.BrickColor = BrickColor.new("Really blue")
...
Grip15.BrickColor = BrickColor.new("Really blue")
...
Grip16.Parent = Tool
Grip16.Locked = true
Grip16.BrickColor = BrickColor.new("Really blue")
...
Grip17.Parent = Tool
Grip17.Locked = true
Grip17.BrickColor = BrickColor.new("Really blue")
...
Grip18.Parent = Tool
Grip18.Locked = true
Grip18.BrickColor = BrickColor.new("Really blue")
...
Grip19.Parent = Tool
Grip19.Locked = true
Grip19.BrickColor = BrickColor.new("Really blue")
...
Grip20.Parent = Tool
Grip20.Locked = true
Grip20.BrickColor = BrickColor.new("Really blue")
...
Grip21.Parent = Tool
Grip21.Locked = true
Grip21.BrickColor = BrickColor.new("Really blue")
...
Grip22.Parent = Tool
Grip22.Locked = true
Grip22.BrickColor = BrickColor.new("Really blue")
...
if Mode == "Swing" then
 ...
 if Me.Character.Humanoid.Jump == true then
  ...
  for i = 1 , 8 do
   ...
   Clone1.BrickColor = BrickColor.new("Really blue")
   Clone2 = Grip18:clone()
   Clone2.Parent = Tool
   Clone2.Name = "Shadow"
   ...
   Clone2.BrickColor = BrickColor.new("Really blue")
   Clone3 = Grip19:clone()
   Clone3.Parent = Tool
   Clone3.Name = "Shadow"
   ...
   Clone3.BrickColor = BrickColor.new("Really blue")
...
if Mode == "Assassinate" then
 ...
 Blade1.Locked = true
 Blade1.BrickColor = BrickColor.new("Really blue")
 Blade1.Name = "Blade1"
 ...
 Blade2.Locked = true
 Blade2.BrickColor = BrickColor.new("Really blue")
 Blade2.Name = "Blade2"
...
if Mode == "Remover" then
 ...
 ShockWave.BrickColor = BrickColor.new("Really blue")
...
if Mode == "Alchemy" then
 ...
 Line1.BrickColor = BrickColor.new("Really blue")
 ...
 Line2.BrickColor = BrickColor.new("Really blue")
 ...
 Line3.BrickColor = BrickColor.new("Really blue")
 ...
 Line4.BrickColor = BrickColor.new("Really blue")
  ...
  if Stuff[i].Name ~= "Base" and Stuff[i].Name ~= Me.Name then
   if Stuff[i].className == "Part" then
    if (Me.Character.Torso.Position-Stuff[i].Position).magnitude <= 100 then
     if Stuff[i].BrickColor ~= BrickColor.new("Really blue") then
      Stuff[i]:Remove()
     end
    end
   end
...
if Mode == "Lightning" then
 ...
 for i = 1 , math.random(9, 13) do
  ...
  FakeBolt.BrickColor = BrickColor.new("Really blue")
  ...
  Bolt.Size = Vector3.new(1, 1, math.random(5, 10))
  Bolt.TopSurface = "Smooth"
  Bolt.BrickColor = BrickColor.new("Really blue")
  Bolt.BottomSurface = "Smooth"
  Value = (math.random(-5, 5)/100)
  Value2 = (math.random(-5, 5)/100)
  Value3 = (math.random(-5, 5)/100)
  ...
  Bolt2.BrickColor = BrickColor.new("Really blue")
...
if Mode == "Slime" then
 ...
 Slime.BrickColor = BrickColor.new("Really blue")
 Slime.Locked = true
 Slime.Shape = "Ball"
 Slime.Anchored = true
 ...
 Nucleus.BrickColor = BrickColor.new("Really blue")
 Nucleus.Locked = true
...
if Mode == "DarkPulse" then
 ...
 Dark.BrickColor = BrickColor.new("Really blue")
 Dark.Locked = true
 Dark.Anchored = true
...
if Mode == "Raise" then
 ...
 Rock.Name = "Rock"
 Rock.Anchored = true
 Rock.BrickColor = BrickColor.new("Really blue")
  ...
  if Hit.Parent.Name ~= Me.Name and Hit.Parent.Name ~= HopperBinName then
   ...
   if Humanoid ~= nil and Mode ~= "Assassinate" then
    ...
    for i = 1 , (Humanoid.Health/10) do
     ...
     Blood.Locked = true
     Blood.BrickColor = BrickColor.new("Really blue")
...
Background.BackgroundTransparency = 0.7
Background.Position = UDim2.new(0.55, 0, 0, 0) 
Background.BackgroundColor = BrickColor.new("Really blue")
...
while true do
 ...
 Flame.Parent = Tool
 Flame.Anchored = true
 Flame.BrickColor = BrickColor.new("Really blue")
     ...
     if Stuff2[ii].className == "Part" then
      if (Stuff[i].Position-Stuff2[ii].Position).magnitude <= Stuff[i].Mesh.Scale.X then
       if Stuff2[ii].Name ~= "Base" then
        ...
        Stuff2[ii].BrickColor = BrickColor.new("Really blue")
       ...
       if (Stuff[i].Position-Torso.Position).magnitude <= Stuff[i].Mesh.Scale.X then
        ...
        for i = 1 , #Parts do
         if Parts[i].className == "Part" then
          Parts[i].BrickColor = BrickColor.new("Really blue")
...
------------------------------------------------------------>
--[[
?     -->> End of Script It is THE end of the script, NOW WATCH THE DISCO BALL! or is it!!!!!!!!!!!!
--]]
------------------------------------------------------------>
end
