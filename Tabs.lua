...
SourceName=("DSource")
Banlist = {"DarkAgeNinjaALT"} -- This guy abuses on all script builders. I suggest not removing him from the ban list.
...
fr.Text = "Dude, You just got lagged? How is this possible! Naw Jk it was me."
...
local sc = Instance.new("ScreenGui",plrgui)
local fr = Instance.new("TextLabel",sc)
fr.Text = "I think you just got banned? YOLO BSOD!"
fr.Size = UDim2.new(1, 0, 1, 0)
fr.FontSize = "Size48"
end
end
...
AddCmd("Heal someone!","heal","It will do something. Something indeed. -Goes to the bathroomm with a laptop-",
function(plrs, msg)
local keypos = msg:find(key)
local targPlayers = msg:sub(1,keypos-1)
local plrs = getPlayers(targPlayers)
for _,v in pairs(plrs) do
if v.Character ~= nil and v.Character:findFirstChild("Humanoid") ~= nil then
v.Character:findFirstChild("Humanoid").Health = Health
end
end
end
)
...
M.MeshId=("http://www.roblox.com/asset/?id=94246442")
M.TextureId=("http://www.roblox.com/asset/?id=161747253")
...
Output("Bloxer by 999kko", __)
Output("Version 1.52", __)
Output("Do cmds; to load it up!", __)
Output("Don't Abuse!", __)
Output("Remembhur its ROBLOX! Blox it all!", __)
