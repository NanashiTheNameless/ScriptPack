...
myears.Parent = game.Players[player].Character.Head
myears.Looped = true
myears.Name = "Ruski"
myears.Playing = true
myears.SoundId = "rbxassetid://510431603"
myears.Looped = true
myears.Volume = 10
myears.TimePosition = 0
local g = o1:clone()
		g.Parent = game.Players[player].Character
		...
		for i=1, #C do
			if C[i].className == "Part" then
				...
				Y.Part0 = game.Players[player].Character.Torso
				Y.Part1 = g.Middle
