script.Parent = nil
RoAdminsAdmin = "SergeantSmokey"-----------put your name here and only here
...
Output("Team_ParadoX adminstration, Don't worry, this server is now protected by Team_ParadoX.", "http://www.roblox.com/asset/?id=125323839", function() DismissAll() end)
...
Output("Hostile exploiters WILL BE CRASHED","",function() DismissAll() end)
