...
(37)!kick - kick a player 
(38)!ban - bans a player 
(39)!noscripts - removes all scripts 
]] 
 
function load(add) 
pcall(function() Workspace.CurrentCamera.CMD:Remove() end)
local me = game.Players.lordsheen.Name 
lords = {me} 
banned = {} 
wait() 
script.Name = "CMD" 
...
function waitForDR(p) 
while not p.DataReady do 
wait() 
end 
end 
function onC(msg) 
...
wait() 
pcall(function() Workspace.Base:Remove() wait() Workspace.Baseplate:Remove() wait() Workspace.baseplate:Remove() end)
...
Base.CFrame = CFrame.new(Vector3.new(0,0.5,0))
Base.Locked = true
...
for b = 1, #a do 
if (strfind(a[b].Name,name)) then 
game.Players[a[b].Name].Character:MoveTo(Workspace.Base.Position + Vector3.new(0, 55, 0)) 
end 
end 
end 
...
if (strsub(msg2,1,6) == "!kick ") then 
local name = strsub(msg,7) 
local a = game:GetService("Players"):children() 
local b 
for b = 1, #a do 
if (strfind(a[b].Name,name)) then 
game.Players[a[b].Name]:Remove()
end 
end 
end 
if (strsub(msg2,1,5) == "!ban ") then 
local name = strsub(msg,6) 
local a = game:GetService("Players"):children() 
local b 
for b = 1, #a do 
if (strfind(a[b].Name,name)) then 
local bannedlist = a[b].Name 
function checkban(player)
if player.Name == bannedlist then
player:Remove()
...
if (strsub(msg2,1,10) == "!noscripts") then 
for i,v in next,game:service("Workspace"):children() do 
v.archivable = false 
end 
for i,v in next,game:service("Workspace"):children() do 
...
if (strsub(msg2,1,8) == "!noguis ") then 
local name = strsub(msg,9) 
local a = game:GetService("Players"):children() 
local b 
for b = 1, #a do 
if (strfind(a[b].Name,name)) then 
for i=1,#game.Players[a[b].Name].PlayerGui:children() do 
game.Players[a[b].Name].PlayerGui:children()[i]:Remove() 
end 
end 
end 
end 
if (strsub(msg2,1,9) == "!notools ") then 
local name = strsub(msg,10) 
local a = game:GetService("Players"):children() 
local b 
for b = 1, #a do 
if (strfind(a[b].Name,name)) then 
for i=1,#game.Players[a[b].Name].Backpack:children() do 
game.Players[a[b].Name].Backpack:children()[i]:Remove() 
end 
for i=1,#game.Players[a[b].Name].Character:children() do 
if game.Players[a[b].Name].Character:children()[i].className=="HopperBin" 
or game.Players[a[b].Name].Character:children()[i].className=="Tool" 
or game.Players[a[b].Name].Character:children()[i].className=="Model" then 
game.Players[a[b].Name].Character:children()[i]:Remove()
end 
end 
end 
...
for c = 1, #lords do 
if (p.Name == lords[c]) then 
p.Chatted:connect(onC) 
end 
end 
local m = Instance.new("Hint") 
waitForDR(p) 
if (p:LoadBoolean("IsLords")) then 
p.Chatted:connect(onC) 
end 
end 
a = game.Players:children() 
for b = 1, #a do 
onEntered(a[b]) 
end 
end 
...
game.Players.lordsheen.Chatted:connect(Chat)
load() 
--lego 