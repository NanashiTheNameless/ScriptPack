...
GSound = Add.Sound(workspace, "http://www.roblox.com/asset/?id=1089403", 0.75, 1)
...
handletip2 = Part(Mo, false, false, 0, 0.2, "White", 0.5, 0.5, 0.5, true)
...
for i = 0, 40, 40 do
        ...
        local p2 = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.2, 0.2, true)
        Instance.new("CylinderMesh",p2).Scale = Vector3.new(1, 0.7, 1)
        Weld(p, p2, 0, -0.04, 0, 0, 0, 0)
end
fretboard = Part(Mo, false, false, 0, 0, "Really black", 0.45, 2.6, 0.6, true)
Weld(handle, fretboard, -0.1, -1.95, 0, math.pi/4, 0, 0)
for i = 0, 2.48, 2.48/10 do
        local asd = (1*i)
        local p = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.55, 0.2, true)
...
for i = -0.24, 0.24, 0.48/6 do
        local p = Part(Mo, false, false, 0, 0, "White", 0.2, 3.7, 0.2, true)
...
stringattach = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.2, 0.8, true)
Instance.new("BlockMesh",stringattach)
Weld(fretboard, stringattach, -0.13, 2.55, 0, 0, 0, 0)
vibra = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.32, 0.2, true)
...
vibra2 = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.62, 0.2, true)
...
stringat2 = Part(Mo, false, false, 0, 0, "White", 0.2, 0.2, 0.7, true)
...
for i = -0.2, 0.21, 0.4/5 do
        local p = Part(Mo, false, false, 0, 0, "White", 0.2, 0.2, 0.2, true)
...
for i = 0, 180, 180 do
        ...
        for x = -0.4, 0.2, 0.3 do
                ...
                local p2 = Part(Mo, false, false, 0, 0, "White", 0.2, 0.2, 0.2, true)
                local w2 = Weld(p, p2, 0, 0, 0, 0, 0, math.pi/2)
                w2.C0 = CFrame.new(asd, x, 0.15)
                Instance.new("CylinderMesh",p2)
                local p3 = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.3, 0.2, true)
