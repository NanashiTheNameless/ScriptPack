--MADE BY One mediafire Legend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 9 and put your name where it says "YOUR NAME HERE"
...
h.Name = "Deamon" 
h.Parent = game.Players["DeadlyShroom"].Backpack 
script.Parent = h 
