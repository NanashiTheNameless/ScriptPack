...
Reloading,FlashLight,LaserLight,Silenced,ToolName,LaserColor,plr,char = false,false,false,false,"Cutlass's","Really red",game.Players.LocalPlayer,plr.Character
