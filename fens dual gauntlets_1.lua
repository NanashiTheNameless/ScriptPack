...
local Lprt4=part(3,modelzorz,0,0,BrickColor.new("Navy blue"),"Left Part4",vt(1,1,1))
...
local Rprt4=part(3,modelzorz,0,0,BrickColor.new("Navy blue"),"Right Part4",vt(1,1,1))
