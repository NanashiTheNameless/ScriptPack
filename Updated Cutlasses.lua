...
plr = Services.Players.anton20
char = plr.Character
Humans = char:findFirstChild("Humanoid")
BulletTable,Disposables,Lasers = {},{},{}
Clips,Bullets,CurrentGun = 100,16,1
Reloading,FlashLight,LaserLight,Silenced,ToolName,LaserColor = false,false,false,false,"Cutlass's","Bright blue"
...
HandleOne,HandleTwo = AddPart("HandleLeft",GunModelOne,.02,1,.4,"Dark stone grey"),AddPart("HandleLeft",GunModelTwo,.02,1,.4,"Dark stone grey")
...
HandLeft = AddPart("HandLeft",MainModel,1,1,1,"Dark stone grey")
HandRight = AddPart("HandRight",MainModel,1,1,1,"Dark stone grey")
...
PA18 = AddPart("Part",GunModelOne,.1,.3,.1,"White")
PA18.Mesh:Remove()
...
PA23 = AddPart("Part",GunModelOne,.1,.35,.1,"White")
PA23.Mesh:Remove()
...
PB23 = AddPart("Part",GunModelTwo,.1,.35,.1,"White")
PB23.Mesh:Remove()
...
PB24 = AddPart("Part",GunModelTwo,.1,.35,.1,"White")
PB24.Mesh:Remove()
...
PE4 = AddPart("Part",MainModel,2.2,.25,1.2,"Dark stone grey")
WPE4 = AddWeld("Weld",PE4,PE4,PE1,CF.new(0,0,0),CF.Angles(math.rad(0),0,0))
PE5 = AddPart("Part",MainModel,0.25,1.6,1.1,"Brown")
WPE5 = AddWeld("Weld",PE5,PE5,char.Torso,CF.new(-0.65,0.225,0),CF.Angles(0,0,0))
PE6 = AddPart("Part",MainModel,0.25,1.6,1.1,"Brown")
WPE6 = AddWeld("Weld",PE6,PE6,char.Torso,CF.new(0.65,0.225,0),CF.Angles(0,0,0))
--Eff
PF1 = AddPart("Part",Eff,0.5,0.8,0.2,"Bright blue")
WPF1 = AddWeld("Weld",PF1,PF1,char["Right Arm"],CF.new(0.26,0,0.2),CF.Angles(0,0,0))
PF2 = AddPart("Part",Eff,0.5,0.2,0.6,"Bright blue")
WPF2 = AddWeld("Weld",PF2,PF2,char["Right Arm"],CF.new(0.26,0.5,0),CF.Angles(0,0,0))
PF3 = AddPart("Part",Eff,0.5,0.2,0.4,"Bright blue")
WPF3 = AddWeld("Weld",PF3,PF3,char["Right Arm"],CF.new(0.26,0.15,0),CF.Angles(0,0,0))
--End
ch,player = char,plr
...
function CreateBullet(Part)
        ...
        Bullet.Anchored = true
        Bullet.BrickColor = BrickColor.new("Brown")
...
function EmptiedClip(part)
        ...
        EmptyClip.BrickColor = BrickColor.new("Medium stone grey")
...
Bin.Selected:connect(function(mouse)
        ...
        Dis.TextColor3 = BrickColor.new("White").Color
        ...
        Cred.Text = "Ma".."de B".."y "..SC(104)..SC(97)..SC(109)..SC(97)..SC(100)..SC(53)..SC(53)..SC(53)
        Cred.TextColor3 = BrickColor.new("White").Color
