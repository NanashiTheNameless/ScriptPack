                ...
                if delay then
                        ...
                        if not found then
                                ...
                                local img = genNew('TextLabel',bbg,{
                                        Text = amount;
                                        TextScaled = true;
                                        TextColor = bcol(color or 'Really black');
...
function faketor()
        if rtorso == torso then 
                ...
                faketorso = T.P(2,2,1,'Really black',0,false,false,char) faketorso.Name = 'Fakey'
...
p = T.P(.4,.5,.4,'Really black',0,false,false)
...
p4 = T.P(.4,.9,.2,'Really black',0,false,false)
T.W(p4,p3,0,0,.15,0,0,0)
p4 = T.P(.4,.9,.2,'Really black',0,false,false)
T.W(p4,p3,0,0,-.15,0,0,0)
 
blade = T.P(.5,4,.5,'Really black',0,false,false) T.FM(blade,'block',1,1,.3)
T.W(blade,p3,0,2.5,0,0,0,0)
 
tip1 = T.P(.5,1,.25,'Really black',0,false,false) T.FM(tip1,'wedge',.3,1,1)
...
touch = T.P(.5,5,.5,'Really black',1,false,false)
T.W(touch,blade,0,.5,0,0,0,0)
 
T.C(function()
while wait(3) do
        for i = 2.5,-2.5,-5/10 do
                spaas((touch.CFrame*cfn(0,i,0)).p,1,1,1,'Really black')
                wait()
        end
end end)
...
function fireball() cf = lw.C0
        ...
        local p = T.P(1,1,1,'Really red',0,false,false) T.FM(p,'sphere',1,1,1)
