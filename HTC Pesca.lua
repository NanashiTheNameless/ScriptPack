...
Orb.BrickColor = BrickColor.new("Sea green")
Orb.Transparency = 0
...
Weld.Part1 = Orb
Weld.C1 = CFrame.new(1, 0, 0)

---------------------------
local LocalPlayer = game:GetService("Players").LocalPlayer
local Character = LocalPlayer.Character or LocalPlayer.CharacterAdded:wait()
 
local Orb2 = Instance.new("Part", Character)
Orb2.Name = "Orb"
Orb2.Shape = Enum.PartType.Ball
Orb2.CanCollide = false
Orb2.BrickColor = BrickColor.new("Institutional white")
Orb2.Transparency = 0
Orb2.Size = Vector3.new(0.5, 0.5, 0.5)
Orb2.TopSurface = Enum.SurfaceType.Smooth
Orb2.BottomSurface = Enum.SurfaceType.Smooth
 
local Weld = Instance.new("Weld", Orb)
Weld.Part0 = Character.Head
Weld.Part1 = Orb2
Weld.C1 = CFrame.new(1.3, -0.2, 0.8)

--------------------------------------
local LocalPlayer = game:GetService("Players").LocalPlayer
local Character = LocalPlayer.Character or LocalPlayer.CharacterAdded:wait()
 
local Orb3 = Instance.new("Part", Character)
Orb3.Name = "Orb"
Orb3.Shape = Enum.PartType.Ball
Orb3.CanCollide = false
Orb3.BrickColor = BrickColor.new("Institutional white")
Orb3.Transparency = 0
Orb3.Size = Vector3.new(0.5, 0.5, 0.5)
Orb3.TopSurface = Enum.SurfaceType.Smooth
Orb3.BottomSurface = Enum.SurfaceType.Smooth
 
local Weld = Instance.new("Weld", Orb)
Weld.Part0 = Character.Head
Weld.Part1 = Orb3
Weld.C1 = CFrame.new(0.5, -0.2, 0.8)
...
local Color2=BrickColor.new("Sea green")
...
local Orbz = Instance.new("Part", Character)
Orbz.Name = "Orb"
Orbz.Shape = Enum.PartType.Ball
Orbz.CanCollide = false
Orbz.BrickColor = BrickColor.new("Sea green")
Orbz.Transparency = 0
Orbz.Size = Vector3.new(0.5, 0.5, 0.5)
Orbz.TopSurface = Enum.SurfaceType.Smooth
Orbz.BottomSurface = Enum.SurfaceType.Smooth
 
local partA = prt6
local attachmentA = Instance.new("Attachment", prt6)
attachmentA.Position = Vector3.new(0, 1.6, 0)
 
local partB = Orbz
local attachmentB = Instance.new("Attachment", Orbz)
attachmentB.Position = Vector3.new(0, 0, 0)
 
local RopeConstraint = Instance.new("RopeConstraint", partA)
RopeConstraint.Attachment0 = attachmentA
RopeConstraint.Attachment1 = attachmentB
RopeConstraint.Length = 2
RopeConstraint.Visible = true
RopeConstraint.Color = BrickColor.new("Sea green")
...
MagicCylinder(BrickColor.new("Sea green"),CFrame.new((prt8.Position+pos)/2,pos)*angles(1.57,0,0),1,mag*5,1,0.2,0,0.2,0.1)
if hit~=nil then
ref=part(3,workspace,0,1,Color3,"Reference",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
game:GetService("Debris"):AddItem(ref,1)
so(Asset.."0",ref,.5,1.5)
so(Asset.."0",ref,.5,1.5)
MagicCircle(BrickColor.new("Sea green"),cf(pos),1,1,1,1,1,1,0.07)
Damagefunc(hit,30,40,0,"Normal",RootPart,0)
end
end
...
MagicCylinder(BrickColor.new("Sea green"),CFrame.new((MainPos+pos)/2,pos)*angles(1.57,0,0),1,mag*5,1,0.5,0,0.5,0.05)]]
num=30
coroutine.resume(coroutine.create(function()
repeat
wait()
...
local mag=(MainPos-pos).magnitude
MagicCylinder2(BrickColor.new("Sea green"),CFrame.new((MainPos+pos)/2,pos)*angles(1.57,0,0),3,mag*5,3,1.5,0,1.5,0.1)
...
MagicBlock(BrickColor.new("Sea green"),cf(pos),20,20,20,5,5,5,0.05)
game:GetService("Debris"):AddItem(ref,1)
...
--                h:TakeDamage(Damage)
                ...
                showDamage(hit.Parent,Damage/2,.5,BrickColor.new("Sea green"))
                end
...
--                vp.velocity=Character.Torso.CFrame.lookVector*Knockback
                ...
                showDamage(hit.Parent,newdam,.5,BrickColor.new("Sea green"))
                end
                end
                end),hit)
                end
