...
local Welds = {}
local manamax = 8
local painbring = false
local painboom = 0
local cataclysm = false
local isjugg = false
local decreaseatk = 0
local decreasedef = 0
...
if Character:findFirstChild("Morning Star", true) ~= nil then
  Character:findFirstChild("Morning Star", true).Parent = nil
end
...
local fenbarmana4 = gui("TextLabel", fenframe, "Stamina(" .. mana.Value .. ")", 1, Color3.new(0, 0, 0), UDim2.new(0, 0, 0.2, 0), UDim2.new(0.4, 0, 0.2, 0))
...
modelzorz.Name = "Morning Star"
local prt1 = part(3, modelzorz, 0, 0, TorsoColor, "Part01", vt())
local prt2 = part(3, modelzorz, 0, 0, BrickColor.new("Dark stone grey"), "Part02", vt())
local prt3 = part(3, modelzorz, 0, 1, TorsoColor, "Part03", vt())
local prt5 = part(3, modelzorz, 0, 0, BrickColor.new("Bright red"), "Part05", vt())
local prt6 = part(3, modelzorz, 0, 0, BrickColor.new("Dark stone grey"), "Part06", vt())
msh1 = mesh("BlockMesh", prt1, "", "", vt(0, 0, 0), vt(1, 1, 1))
msh2 = mesh("CylinderMesh", prt2, "", "", vt(0, 0, 0), vt(3, 30, 3))
msh3 = mesh("CylinderMesh", prt3, "", "", vt(0, 0, 0), vt(3.1, 1, 3.1))
msh5 = mesh("SpecialMesh", prt5, "FileMesh", "3270017", vt(0, 0, 0), vt(0.5, 1, 0.5))
msh6 = mesh("SpecialMesh", prt6, "Sphere", "nil", vt(0, 0, 0), vt(10, 10, 10))
local wld1 = weld(prt1, prt1, Torso, euler(0, 0, 2.5) * cf(0, 0, -0.5))
local wld2 = weld(prt1, prt2, prt1, euler(0, 0, 0) * cf(0, 0, 0))
local wld3 = weld(prt1, prt3, prt2, euler(0, 0, 0) * cf(0, 2, 0))
local wld5 = weld(prt1, prt5, prt3, euler(0, 0, 0) * cf(0, 1, 0))
local wld6 = weld(prt1, prt6, prt2, euler(0, 0, 0) * cf(0, -2.2, 0))
for i = 1, -0.8, -0.2 do
  local prt4 = part(3, modelzorz, 0, 0, TorsoColor, "Part04", vt())
  msh4 = mesh("CylinderMesh", prt4, "", "", vt(0, 0, 0), vt(3.1, 1, 3.1))
  local wld4 = weld(prt1, prt4, prt3, euler(math.random(-10, 10) / 100, 0, math.random(-10, 10) / 100) * cf(0, i, 0))
end
div = 0
for j = 0.785, 3.14, 0.785 do
  local dir = 0
  if div == 0 then
    div = 1
    dir = 0
  ...
  for i = 0.785, 6.28, 0.785 do
    if dir == 0 then
      dir = 1
      local prt7 = part(3, modelzorz, 0, 0, BrickColor.new("Dark stone grey"), "Part07", vt())
      msh7 = mesh("SpecialMesh", prt7, "FileMesh", "1778999", vt(0, 0, 0), vt(0.3, 0.3, 0.3))
      local wld7 = weld(prt1, prt7, prt6, cf(0, -1.2, 0) * euler(i, 0, j))
    else
      do
        do
          dir = 0
          -- DECOMPILER ERROR at PC1607: LeaveBlock: unexpected jumping out DO_STMT

          -- DECOMPILER ERROR at PC1607: LeaveBlock: unexpected jumping out IF_ELSE_STMT

          -- DECOMPILER ERROR at PC1607: LeaveBlock: unexpected jumping out IF_STMT
...
if script.Parent.className ~= "HopperBin" then
  ...
  Tool.Name = "Morning Star"
  script.Parent = Tool
end
Bin = script.Parent
if Bin.Name == "Barbarian" then
  Bin.Name = "Morning Star"
end
...
hideanim = function()
  ...
  for i = 0, 1, 0.3 do
    swait()
    wld1.C0 = clerp(wld1.C0, euler(0.3, 0, 0) * euler(0, 0, 0.8) * cf(0, 1, 0), 0.4)
    wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.4)
    ...
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2.7, 0, -0.2), 0.4)
  ...
  for i = 0, 1, 0.15 do
    ...
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(3.5, 0, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
  wld1.Part1 = Torso
  wld1.C0 = euler(0, 0, 2.5) * cf(0, 0, -0.5)
  wld2.C0 = cf(0, 0, 0)
  for i = 0, 1, 0.1 do
    swait()
...
equipanim = function()
  ...
  wld1.Part1 = LeftArm
  wld1.C0 = euler(0.3, 0, 0) * euler(0, 0, 0.8) * cf(0, 1, 0)
  wld2.C0 = cf(0, -2, 0)
  for i = 0, 1, 0.1 do
    swait()
    wld1.C0 = euler(0.3 + 1.37 * i, 0, 0) * euler(0, 0, 0.8 - 0.8 * i) * cf(0, 1, 0) * euler(0, 7 * i, 0)
    wld2.C0 = cf(0, -2 + 2 * i, 0)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0, 0, 0.2), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.5, 0, 1), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -1), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
  end
end
...
StaggerAnim = function()
  ...
  for i = 0, 1, 0.35 do
    ...
    wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.3)
...
attackone = function()
  ...
  for i = 0, 1, 0.1 do
    swait()
    wld1.C0 = clerp(wld1.C0, euler(2, 0, 0) * cf(0, 1, 0), 0.3)
    wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.3)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.2), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.2), 0.3)
    RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.2) * euler(1.4, 0, -0.1) * euler(0, -1, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.7) * euler(1.1, 0, 0.9) * euler(0, -1.1, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.8, -1, -0.4) * euler(0, 1.57, 0) * euler(0, 1.2, 0) * euler(0, 0, -0.1), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.8, -1, 0.4) * euler(0, -1.57, 0) * euler(0, 1.2, 0), 0.3)
  ...
  so("203691447", prt6, 1, 1.1)
  hbwld.Parent = nil
  hboxpos.Parent = hitbox
  hitbox.Parent = modelzorz
  hitbox.Size = vt(2, 4, 2)
  hitboxCF = prt6.CFrame * cf(0, -1, 0)
  hitbox.CFrame = hitboxCF
  for i = 0, 1, 0.1 do
    swait()
    hitboxCF = prt6.CFrame * cf(0, -1, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 4, 5, 7, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(8, 12)), nil, true)
    ...
    RW.C0 = clerp(RW.C0, cf(0, 0.5, -0.5) * euler(1, 0, -0.6), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.2) * euler(1, 0, -0.3) * euler(0, -1, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.2) * euler(0, 1.57, 0) * euler(0, -0.8, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(-0.2, 0, 0), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
...
attacktwo = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    RW.C0 = clerp(RW.C0, cf(0, 1, -0.5) * euler(3.6, 0, -0.7), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.2) * euler(3, 0, 0.1) * euler(0, -0.5, 0), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
  ...
  for i = 0, 1, 0.1 do
    ...
    RW.C0 = clerp(RW.C0, cf(0.5, 0.3, -0.5) * euler(0.5, 0, -0.3), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.2) * euler(0.3, 0, 0.5) * euler(0, 0.5, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.2) * euler(0, 1.57, 0) * euler(0, 0.5, 0), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.9, -1, 0.2) * euler(0, -1.57, 0) * euler(0, 0.5, 0), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
...
attackthree = function()
  ...
  for i = 0, 1, 0.1 do
    ...
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.8) * euler(0.2, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.8), 0.3)
    RW.C0 = clerp(RW.C0, cf(1.2, 0.5, -0.3) * euler(1.4, 0, -0.6) * euler(0, -1.57, 0), 0.3)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.7) * euler(1.2, 0, 1.3) * euler(0, -2, 0), 0.3)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.2) * euler(0, 1.57, 0) * euler(0, 0.8, 0), 0.3)
  ...
  for i = 0, 1, 0.05 do
    swait()
    --if i < 0.5 or i <= 0.55 then
      hitboxCF = prt6.CFrame * cf(0, -1, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 4, 5, 7, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(8, 12)), nil, true)
      wld1.C0 = clerp(wld1.C0, euler(4, 0, 0) * cf(0, 1, 0), 0.2)
      wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.2)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0.2, 0, 0), 0.2)
      RootJoint.C0 = RootCF * euler(0, 0, -0.8 + 8 * i)
      RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.57, 0, -0.6) * euler(0, -1.57, 0), 0.2)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.57, 0, 0.6) * euler(0, -1.57, 0), 0.2)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
...
attackfour = function()
  ...
  for i = 0, 1, 0.2 do
    ...
    wld2.C0 = clerp(wld2.C0, cf(0, -2, 0) * euler(0.6, -0.8, 0), 0.5)
  ...
  hitboxweld()
  hboxpos.Parent = nil
      hitfloor2d, posfloor2 = rayCast(prt6.Position, CFrame.new(prt6.Position, prt6.Position - Vector3.new(0, 1, 0)).lookVector, 2, Character)
      if hitfloor2d ~= nil then
        ref = part(3, workspace, 0, 1, BrickColor.new("Black"), "Reference", vt())
        ref.Anchored = true
        ref.CFrame = cf(posfloor2)
        so("157878578", ref, 0.6, 1.6)
        game:GetService("Debris"):AddItem(ref, 1)
        MagicWave(BrickColor.new("Medium stone grey"), cf(ref.Position), 3, 3, 3, 0.5, 0.5, 0.5, 0.05)
        MagniDamage(ref, 10, 5, 7, math.random(20, 30), "Knockdown2", ref, 0, 1, (math.random(8, 15)), nil, nil, false)
      end
      swait(10)
      dec.Parent = nil
      attack = false
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 2 then
    attack = true
    local ref = part(3, workspace, 0, 1, BrickColor.new("Black"), "Effect", vt())
    ref.Anchored = true
    ref.CFrame = RootPart.CFrame * cf(0, 0, -3)
    game:GetService("Debris"):AddItem(ref, 20)
    for _,c in pairs(workspace:children()) do
      local hum = c:findFirstChild("Humanoid")
      if hum ~= nil then
        local head = c:findFirstChild("HumanoidRootPart")
        if head ~= nil and GetDist(head, ref, 8) == true and head.Parent:findFirstChild("Stats") ~= nil and head.Parent.Stats:findFirstChild("Stunned") ~= nil and head.Parent.Stats.Stunned.Value == true then
          cando = true
          if Player.Neutral == false and game.Players:GetPlayerFromCharacter(head.Parent) ~= nil and game.Players:GetPlayerFromCharacter(head.Parent).TeamColor == Player.TeamColor then
            cando = false
          end
          local dec = Instance.new("NumberValue", Decrease)
          dec.Name = "DecreaseMvmt"
          dec.Value = 10
          print(GetDist(head, ref, 8))
          Val = head.Parent.Stats.Stunned
            if head.Parent ~= nil and Val.Value == true and GetDist(head, ref, 3) == true and cando == true and mana.Value >= 5 then
              ref.CFrame = RootPart.CFrame * cf(0, 0, -3)
              swait()
            if Stagger.Value ~= true and StunT.Value > Stun.Value then
              if StaggerHit.Value == true then
              ...
              for i = 0, 1, 0.2 do
                ...
                hitboxCF = prt6.CFrame * cf(0, -1, 0)
                hitbox.CFrame = hitboxCF
                MagniDamage(hitbox, 4, 7, 10, 0, "Normal", RootPart, 0.5, 1, (math.random(8, 12)), nil, true)
                wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.5)
                wld2.C0 = clerp(wld2.C0, cf(0, -2, 0) * euler(0.6, -0.8, 0), 0.5)
                Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0), 0.5)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.4, 0, 0), 0.5)
              ...
              if hitfloor2d ~= nil then
                ...
                game:GetService("Debris"):AddItem(ref, 1)
                MagicWave(BrickColor.new("Medium stone grey"), cf(ref.Position), 3, 3, 3, 0.5, 0.5, 0.5, 0.05)
                MagniDamage(ref, 10, 8, 10, math.random(20, 30), "Knockdown2", ref, 0, 1, (math.random(8, 15)), nil, nil, false)
              end
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 30 then
    ...
    for i = 0, 1, 0.1 do
      swait()
      wld1.C0 = clerp(wld1.C0, euler(2.4, 0, 0) * cf(0, 1, 0), 0.2)
      wld2.C0 = clerp(wld2.C0, cf(0, -1.5, 0), 0.2)
      Neck.C0 = clerp(Torso.Neck.C0, necko * euler(0, 0, 1.4) * euler(0.2, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -1.4), 0.3)
      RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.4, -1.4, 0) * euler(-0.6, 0, 0), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1, -1, 0) * euler(0.5, 0, 0) * euler(0, -0.6, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
      RH.C0 = clerp(RH.C0, cf(0.8, -1, -0.4) * euler(0, 1.57, 0) * euler(0, 1.4, 0) * euler(0, 0, -0.1), 0.3)
      LH.C0 = clerp(LH.C0, cf(-0.8, -1, 0.4) * euler(0, -1.57, 0) * euler(0, 1.4, 0), 0.3)
    end
    ...
    so("2767090", Torso, 1, 0.7)
    MagicWave(BrickColor.new("Medium stone grey"), RootPart.CFrame * euler(1.57, 0, 0), 1, 1, 1, 1, 1, 1, 0.05)
    hit = nil
    for i = 1, 20 do
      if hit == nil then
        swait()
      ...
      if hit ~= nil and hit.Parent:findFirstChild("Humanoid") == nil then
        hit = nil
      end
    end
    ...
    if hit ~= nil and hit.Parent:findFirstChild("Humanoid") ~= nil then
      ...
      Damagefunc(hit, 4, 6, 0, "Knockdown2", RootPart, 0, 1, (math.random(50, 50)), nil, nil, nil, "Movement", 0.1, 100)
      for i = 0, 1, 0.1 do
        swait()
        wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.4)
        wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.4)
      ...
      for i = 0, 1, 0.2 do
        ...
        hitboxCF = prt6.CFrame * cf(0, -1, 0)
        hitbox.CFrame = hitboxCF
        MagniDamage(hitbox, 4, 4, 6, 0, "Normal", RootPart, 0.5, 1, (math.random(100, 100)), nil, true)
        wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.5)
        wld2.C0 = clerp(wld2.C0, cf(0, -2, 0) * euler(0.6, -0.8, 0), 0.5)
        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0), 0.5)
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0.4, 0, 0), 0.5)
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 20 then
    ...
    for i = 0, 1, 0.1 do
      ...
      wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.3)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.8) * euler(0.2, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, -0.8) * cf(0, 1.5, 0), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.2, 0.5, -0.3) * euler(1.4, 0, -0.6) * euler(0, -1.57, 0), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-0.8, 0.5, -0.7) * euler(1.2, 0, 1.3) * euler(0, -2, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
    ...
    do
      ...
      for i = 0, 5.1, 0.05 do
        ...
        hitboxCF = prt6.CFrame * cf(0, -1, 0)
        hitbox.CFrame = hitboxCF
        MagniDamage(hitbox, 4, 4, 5, math.random(10, 15), "Normal", RootPart, 0.5, 2, (math.random(15, 20)), nil, true)
        wld1.C0 = clerp(wld1.C0, euler(4, 0, 0) * cf(0, 1, 0), 0.2)
        wld2.C0 = clerp(wld2.C0, cf(0, -3, 0), 0.2)
        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0.2, 0, 0), 0.2)
        RootJoint.C0 = RootCF * euler(0, 0, -0.8 + 8 * i) * cf(0, 1.5, 0)
        RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.57, 0, -0.6) * euler(0, -1.57, 0), 0.2)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
        LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.57, 0, 0.6) * euler(0, -1.57, 0), 0.2)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    for i = 0, 1, 0.4 do
      swait()
      wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.6)
      wld2.C0 = clerp(wld2.C0, cf(0, 0, 0), 0.6)
      Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 0), 0.4)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(-0.1, 0, 0), 0.4)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.2, 0, 0.4) * euler(0, 0, 0), 0.4)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2.9, 0, -0.3) * euler(0, 0, 0), 0.4)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      RH.C0 = clerp(RH.C0, cf(0.8, -0.8, 0) * euler(0, 1.57, 0) * euler(-0.4, 0, 0), 0.4)
      LH.C0 = clerp(LH.C0, cf(-0.8, -0.8, 0) * euler(0, -1.57, 0) * euler(-0.4, 0, 0), 0.4)
    end
    snum = 3
    for i = 0, 1, 0.1 do
      swait()
      if snum >= 3 then
        snum = 0
        so("199145913", prt6, 1, 1.4)
      end
      snum = snum + 1
      if Rooted.Value == false then
        Torso.Velocity = vt(0, 1, 0) * 50
      end
      wld2.C0 = euler(0, 0, 9.9 * i)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -0.4) * euler(0.2, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0.4) * euler(-0.1, 0, 0), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.2, 0, 0.8) * euler(0, 0, 0), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2.9, 0, -0.3) * euler(0, 0, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(0.8, -0.8, 0) * euler(0, 1.57, 0) * euler(-0.4, 0, 0), 0.3)
      LH.C0 = clerp(LH.C0, cf(-0.8, -0.8, 0) * euler(0, -1.57, 0) * euler(-0.4, 0, 0), 0.3)
    end
    hit = nil
    while hit == nil do
      swait()
      hit = rayCast(prt6.Position, CFrame.new(prt6.Position, prt6.Position - Vector3.new(0, 1, 0)).lookVector, 4, modelzorz)
      wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.3)
      wld2.C0 = clerp(wld2.C0, cf(0, -0.5, 0) * euler(0, 0, 3.14), 0.3)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0.1, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.4) * euler(0.2, 0, 0), 0.3)
      RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1.77, 0, -0.785) * euler(0, 0, 0), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.77, 0, 0.785) * euler(0, 0, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(0.9, -0.9, 0) * euler(0, 1.57, 0) * euler(-0.2, 0, 0), 0.3)
      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0) * euler(0, -1.57, 0) * euler(-0.2, 0, 0), 0.3)
    end
    mana.Value = mana.Value - 50
    print("dai")
    ref = part(3, workspace, 0, 1, BrickColor.new("Black"), "Reference", vt())
    ref.Anchored = true
    ref.CFrame = cf(prt6.Position)
    game:GetService("Debris"):AddItem(ref, 5)
    so("168586621", ref, 1, 0.5)
    MagicWave(BrickColor.new("Medium stone grey"), cf(prt6.Position), 5, 2, 5, 2, 0.1, 2, 0.02)
    cataclysm = true
    dist = 10
    for i = 1, 4 do
      MagniDamage(prt6, dist, 6, 7, math.random(20, 30), "Knockdown2", RootPart, 0, 1, (math.random(8, 10)), nil, nil, true)
      swait(5)
      dist = dist + 15
    end
    swait(10)
...
while 1 do
  ...
  staggeranim = false
    ...
    passive1.Value = 0 - 0.3 * math.sin(math.pi * mana.Value / 100 / 2)
    passive2.Value = -0.4 + 0.2 * math.sin(math.pi * mana.Value / 100 / 2)
    if cooldowns[3] <= cooldownmax / 2 and painbring == true then
      MagicCircle(BrickColor.new("Medium stone grey"), euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, -0.1, 5, -0.5, 0.1, 3, modelzorz, prt6)
    else
      painbring = false
    end
    painboom = painboom + 1
  ...
  stunanim = false
          ...
          if torvel < 1 and hitfloor ~= nil then
            ...
            if idle <= 500 then
              ...
              if attack == false then
                ...
                wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.2)
                Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0, 0, 0), 0.2)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0.1, 0, 0), 0.2)
                RW.C0 = clerp(RW.C0, cf(1.2, 0.5, -0.3) * euler(2 - (donum) / 5, 0, -0.4 - (donum) / 5) * euler(0, -1, 0), 0.2)
                RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
                LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.2 - (donum) / 5, 0, 0.1 - (donum) / 5) * euler(0, -1, 0), 0.2)
                LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.2)
                RH.C0 = clerp(RH.C0, cf(1.1, -0.9, -0.2) * euler(0, 1.57, 0) * euler(0, 0, 0.2) * euler(0, 0, 0), 0.2)
              ...
              if attack == false then
                wld1.C0 = clerp(wld1.C0, euler(1.57, 0, 0) * cf(0, 1, 0), 0.2)
                wld2.C0 = clerp(wld2.C0, cf(0, -2, 0), 0.2)
                Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * euler(0.1 + (donum) / 3, 0, 0), 0.1)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -1.5) * euler(0.1, 0, 0), 0.1)
                RW.C0 = clerp(RW.C0, cf(1.2, 0.5, -0.3) * euler(1.4, 0, -0.8), 0.1)
                LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -0.2), 0.1)
                RH.C0 = clerp(RH.C0, cf(1.1, 0.4, -0.8) * euler(-0.05, 1.57, 0), 0.15)
                LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(-1.2, -1.57, 0), 0.15)
              end
            end
          else
            if 2 < torvel and torvel < 30 and hitfloor ~= nil then
              ...
              passive3.Parent = nil
              if attack == false then
                hitfloor2, posfloor2 = rayCast(prt6.Position, CFrame.new(prt6.Position, prt6.Position - Vector3.new(0, 1, 0)).lookVector, 2, Character)
                floornum = floornum + 1
                if 5 <= floornum then
                  floornum = 0
                  if hitfloor2 ~= nil then
                    MagicBlock(hitfloor2.BrickColor, cf(posfloor2), 1, 1, 1, 1, 1, 1, 0.1, 1, workspace)
                  end
                end
                wld1.C0 = clerp(wld1.C0, euler(2.8, 0, 0) * euler(0, -2.8, 0) * cf(0, 1, 0), 0.2)
                wld2.C0 = clerp(wld2.C0, cf(0, -1.5, 0), 0.2)
              ...
              if 30 <= torvel and hitfloor ~= nil then
                ...
                if attack == false then
                  wld1.C0 = clerp(wld1.C0, euler(-1.57, 0, 0) * cf(0, 1, 0), 0.2)
                  wld2.C0 = clerp(wld2.C0, cf(0, -0.5, 0), 0.2)
                  Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0), 0.4)
    ...
    do
      ...
      fenbarmana4.Text = "Stamina(" .. mana.Value .. ")"
      ...
      if 100 <= mana.Value then
        ...
        if mananum <= manamax + 1 then
          mananum = mananum + 1
        else
          if manamax <= mananum then
            mananum = 0
      ...
      -- DECOMPILER ERROR at PC4881: LeaveBlock: unexpected jumping out DO_STMT
