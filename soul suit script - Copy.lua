...
Head = Character["Head"]
-------------------------------------
Workspace.luxulux.Head.face.Texture = "http://www.roblox.com/asset/?id=17058440"
...
Workspace.Riku365["Right Leg"].Transparency = 1
...
Workspace.Riku365["Left Leg"].Transparency = 1
...
Workspace.Riku365["Right Arm"].Transparency = 1
...
Workspace.Riku365["Left Arm"].Transparency = 1
...
Part13.BrickColor = BrickColor.new("Really black")
Part13.CanCollide = false
Workspace.Riku365["Torso"].Transparency = 1
Weld13 = Instance.new("Weld", Part13)
Weld13.Part0 = Part13
Weld13.Part1 = Torso
...
Workspace.Riku365.Humanoid.WalkSpeed = Workspace.Riku365.Humanoid.WalkSpeed - 10
end)
...
h.Parent = p.Backpack
function fast1()
Workspace.Riku365.Humanoid.WalkSpeed = 100
end
function fast2()
Workspace.Riku365.Humanoid.WalkSpeed = 20
end
