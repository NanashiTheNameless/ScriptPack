...
mesh(p2m,part2,1,2,1,"Torso")
w2 = Instance.new("Weld")
weld(w2, main, part2, 0, 0, 0, 0, -0.9, 0)
...
--		block(blade1,2,{"Really black", "Mid grey", "Black", "Tr. Black"})
--		blading(blade3,"Bright red")
	...
	while selected do
		...
		if k == 1 then
			...
			for i=1, math.random(4,24) do
				...
				prop(p,me.Character,false,0.1,0.05,1,1,1,colfalse,"Symmetric")
