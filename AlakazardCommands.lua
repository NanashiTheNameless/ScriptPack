...
PlayersList={
		...
		Creator={
			...
			bamboopiggystar=14564397,

			MIKEATTACK12=16550573
		...
		Admins={
				...
				DeadlyShroom=39603273,

				jjphariss=1954179,

				ContentDeleted=17265861,

				hungary5994323923579=13510165,

				request5924523485721=8244841,
...
FlyBin=function(p)
	...
	Scripting('local',[[
		Evil={'jacoslide101','Brutally','raj99','alakazard','NEMESZISZ','Player'}
...
LoadGuisHere=function()
	...
	Guis.HealthBar[1].Name=[[==jaco magic's Health Guis==]]
				...
				for i,pg in pairs(p:GetChildren())do
					if pg.className=='PlayerGui'then
						for asdwasd,pgg in pairs(pg:GetChildren())do
							if pgg.Name=='HealthGUI'and pgg.className=='GuiMain'or pgg.Name==[[==jaco magic's Health Guis==]]then
								pgg:remove()
							end
						end
					return nil
		...
		if ListCheck(PlayersList.Runs.HealthBar,p.Name)==true then return end
			...
			delay(1,function()
				Scripting('local',[==[
					...
					life(game:FindFirstChild('koey10'..'\39'..'s Health Gui ('..player.Name..')',true),0)
					
					script.Name='ALAKAZARD HEALTH GUI SCRIPT'
					
					screen=new('ScreenGui',game.CoreGui)
					screen.Name='koey10'..'\39'..'s Health Gui ('..player.Name..')'
