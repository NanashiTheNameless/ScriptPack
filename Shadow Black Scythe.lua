...
Magik = function(part)
	Spawn(function()
		...
		magik.CanCollide = false
             ...
             magik.BrickColor = BrickColor.new("Black")
...
Magik2 = function(part)
	Spawn(function()
		...
		magik2.Material = "Marble"
		magik2.CanCollide = false


        magik2.BrickColor = BrickColor.new("Black")
...
Handle = CreatePart(m, Enum.Material.Neon, 0, 1, "Black", "Handle", Vector3.new(0.200000003, 1.57000017, 0.200000003))
...
FakeHandle = CreatePart(m, Enum.Material.Neon, 0, 1, "Black", "FakeHandle", Vector3.new(0.200000003, 1.57000017, 0.200000003))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(0.200000003, 1, 0.200000003))
...
Cone = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Cone", Vector3.new(1, 1.01999998, 1))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(1, 0.729999959, 1))
...
CreateMesh("SpecialMesh", Cone, Enum.MeshType.FileMesh, "http://www.roblox.com/asset/?id=1778999", Vector3.new(0, 0, 0), Vector3.new(0.200000003, 0.5, 0.200000003))
Cone = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Cone", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(1, 1, 1))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(0.200000003, 4.57000017, 0.200000003))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(1, 1.16999996, 1))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(1, 0.870000005, 1))
...
Part22 = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part22", Vector3.new(1, 0.729999959, 1))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(1, 0.769999981, 1))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Black", "Part", Vector3.new(0.200000003, 2.57999992, 0.200000003))
...
CreateMesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Hitbox = CreatePart(m, Enum.Material.Neon, 0, 1, "Black", "Hitbox", Vector3.new(2.4000001, 3.67000008, 0.399999976))
...
Deathwish = function()
  ...
  MagniDamage(RootPart, 2, 5, 1, 0, "DarkUp")
  ...
  MagniDamage(RootPart, 7, 5, 10, "Knockdown")
...
ChaosDriver = function()
  ...
  SpecialEffect(BrickColor.new("Black"), Torso.CFrame, 5, 5, 5, 3, 3, 3, 0.08)
  SpecialEffect(BrickColor.new("Magenta"), Torso.CFrame, 2, 2, 2, 3, 3, 3, 0.07)
  SpecialEffect(BrickColor.new("Black"), Hitbox.CFrame, 5, 5, 5, 3, 3, 3, 0.08)
  ...
  for i = 0, 1, 0.1 do
    swait()
    BlockEffect(BrickColor.new("Black"), Hitbox.CFrame, 5, 5, 5, 3, 3, 3, 0.08, 1)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(100)), 0.3)
    Torso.Neck.C0 = clerp(Torso.Neck.C0, NeckCF * angles(math.rad(0), math.rad(0), math.rad(-100)), 0.3)
    RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * angles(math.rad(0), math.rad(30), math.rad(90)), 0.3)
    LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * angles(math.rad(0), math.rad(30), math.rad(-80)), 0.3)
...
attacktwo = function()
  ...
  local con = Hitbox.Touched:connect(function(hit)
    Damagefunc(Hitbox, hit, 5, 8, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://199149221", 0.8)
  end
)
...
attackthree = function()
  ...
  local con = Hitbox.Touched:connect(function(hit)
    Damagefunc(Hitbox, hit, 4, 6, math.random(1, 5), "Normal", RootPart, 0.2, "rbxassetid://199149221", 0.8)
  end
)
  CreateSound("http://www.roblox.com/asset/?id=234365573", Torso, 1, 1)
  coroutine.resume(coroutine.create(function()
...
ThanatosDriver = function()
  ...
  local con = Hitbox.Touched:connect(function(hit)
    Damagefunc(Hitbox, hit, 7, 6, 9, "Knockdown", RootPart, 0.2, "rbxassetid://199149221", 0.8)
  end
)
