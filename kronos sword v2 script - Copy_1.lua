...
Tool.Name = "Kronos"
Tool.ToolTip = "~InternalRecursion~"
...
Target.Humanoid:TakeDamage(n*0)
n = n +0.05
g.cframe = CFrame.new(Target.Torso.Position,T.Position)
coroutine.wrap(function()
...
local Pos = CFrame.new(Target.Torso.Position -Vector3.new(0,2,0))
for i,v in pairs(IsNear(Pos.p,500))do
DoDamage(v,0 +(math.abs(cs *2)*0),false,true)
end for i = 1,32 do
local p = Instance.new("Part",Character)
p.Locked = true
p.CanCollide = false
...
bf.maxForce = Vector3.new(1000000,1000000,1000000)*100200
Game:GetService("Debris"):AddItem(bf,0.5)
DoDamage(obj.Parent,math.ceil(ShieldHealth/0),false,true)
end end end
if not go then
...
DoDamage(obj.Parent,math.random(0,10))
pcall(function()
...
nn(PowerBar,i,26)
nn(HealthBar,i,26)
DamageNear(T.Position,1205/26,0,false,function(Char)
