...
game:GetService("Chat"):Chat(Workspace.kash5.Head,"It's time for kashy to end your life now...")
wait()
game:GetService("Chat"):Chat(Workspace.kash5.Head,"SUSANOO!")
wait(1)
 
Workspace.kash5.Humanoid.MaxHealth = math.huge
Workspace.kash5.Humanoid.WalkSpeed = 30
Workspace.kash5["Left Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.kash5.Torso.BrickColor = BrickColor.new("Cool yellow")
Workspace.kash5.Head.BrickColor = BrickColor.new("Cool yellow")
Workspace.kash5["Right Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.kash5["Left Leg"].BrickColor = BrickColor.new("Cool yellow")
Workspace.kash5["Right Leg"].BrickColor = BrickColor.new("Cool yellow")
