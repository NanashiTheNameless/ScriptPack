...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=92526961"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=92527064"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
----------------------------------------------------
game:service'InsertService':LoadAsset(87261753):children()[1].Parent=char
char.MorticaisTeaching.Handle.Mesh.Scale = char.MorticaisTeaching.Handle.Mesh.Scale * 1.8
char.MorticaisTeaching.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
...
----------------------------------------------------
game:service'InsertService':LoadAsset(215719598):children()[1].Parent=char
char.EpicWings.Handle.Mesh.Scale = char.EpicWings.Handle.Mesh.Scale * 1.8
char.EpicWings.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
----------------------------------------------------
z = Instance.new("Sound", char)
z.SoundId = "rbxassetid://170822236"--242463565
z.Looped = true
z.Pitch = .58
z.Volume = 1
wait(.01)
...
p7.BrickColor = BrickColor.new("Dark red")
...
p21.BrickColor = BrickColor.new("Dark red")
...
b7.Name = "Mesh"
p10 = Instance.new("Part", m)
p10.BrickColor = BrickColor.new("Dark red")
...
p18.BrickColor = BrickColor.new("Dark red")
p18.FormFactor = Enum.FormFactor.Symmetric
...
p19.BrickColor = BrickColor.new("Dark red")
p19.FormFactor = Enum.FormFactor.Symmetric
