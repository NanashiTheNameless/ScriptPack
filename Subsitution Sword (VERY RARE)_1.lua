...
local prt2=part(3,modelzorz,0,0,BrickColor.new("Really blue"),"Part2",vt(1,1,1))
local prt3=part(3,modelzorz,0,0,BrickColor.new("Really blue"),"Part3",vt(1,1,1))
local prt4=part(3,modelzorz,0,0,BrickColor.new("Really blue"),"Part4",vt(1,1,1))
local prt5=part(3,modelzorz,0,0,BrickColor.new("Really blue"),"Part5",vt(1,1,1))
local prt6=part(3,modelzorz,0.3,0,BrickColor.new("Really blue"),"Part6",vt(1,2,1))
local prt7=part(3,modelzorz,0.3,0,BrickColor.new("Really blue"),"Part7",vt(1,2,1))
local prt8=part(3,modelzorz,0.3,0,BrickColor.new("Really blue"),"Part8",vt(1,1,1))
local prt9=part(3,modelzorz,0.3,0,BrickColor.new("Really blue"),"Part9",vt(1,1,1))
local prt10=part(3,modelzorz,0,0.5,BrickColor.new("Really blue"),"Part10",vt(1,1,1))
...
derp=-0.4
for i=1,5 do
local prt=part(3,modelzorz,0,0,BrickColor.new("Really blue"),"Part",vt(1,1,1))
...
con1=prt7.Touched:connect(function(hit) Damagefunc2(hit,10000,10000) end) 
...
effect("Really blue ",0.5,LastPoint,Point)
LastPoint = Point
end
con1:disconnect()
vel2.Parent=nil
...
CF = Torso.CFrame 
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc1(hit,10000,0.1) end) 
...
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc1(hit,10000,10000) end) 
so("http://roblox.com/asset/?id=10209640",LeftArm,1,1) 
for i=0,1,0.2 do
wait()
...
MagicCircle(BrickColor.new("Really blue"),basepart.CFrame,3,3,3,0,0,0,7,7,7)
MagicCircle(BrickColor.new("Really blue"),basepart.CFrame,5,1,1,0,0,0,9,1,1)
MagicCircle(BrickColor.new("Really blue"),basepart.CFrame,1,5,1,0,0,0,1,9,1)
MagicCircle(BrickColor.new("Really blue"),basepart.CFrame,1,1,5,0,0,0,1,1,9)
...
local prt=part(3,workspace,1,0,BrickColor.new("Really blue"),"Part",vt(1,1,1))
prt.Anchored=true
...
showDamage=function(Char,Dealt,du)
        ...
        if CRIT==true then
                c.BrickColor=BrickColor.new("Really blue")
        end
        c.Name="Head"
        c.TopSurface=0
        c.BottomSurface=0
