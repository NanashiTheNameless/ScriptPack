...
handle=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","Handle",Vector3.new(0.200000003, 1.61857152, 0.200000003))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(0.200000003, 0.257142872, 0.911428571))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.200000003, 3.74285722, 0.571428657))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(0.200000003, 3.74285722, 0.514285743))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(0.200000003, 0.914285779, 0.254285723))
...
mesh("SpecialMesh",Part,Enum.MeshType.Wedge,"",Vector3.new(0, 0, 0),Vector3.new(0.571428537, 1, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.200000003, 0.942857206, 0.28285715))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.200000003, 0.285714328, 0.940000057))
...
mesh("SpecialMesh",Part,Enum.MeshType.Wedge,"",Vector3.new(0, 0, 0),Vector3.new(0.285714298, 1, 1))
Part=part(Enum.FormFactor.Brick,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(1, 1.20000005, 1))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.483492821, 0.539954185, 0.539909601))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(0.892679513, 0.539954185, 0.771299422))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.892679513, 0.539954185, 0.771299422))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.483492851, 0.539954185, 0.539909601))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.493492872, 0.539954185, 0.539909601))
...
mesh("SpecialMesh",Part,Enum.MeshType.Wedge,"",Vector3.new(0, 0, 0),Vector3.new(1, 0.285714179, 0.285714269))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(1.46267962, 0.200000003, 0.200000003))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(1.06267953, 0.200000003, 0.200000003))
...
mesh("BlockMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(1, 1, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.662679553, 0.200000003, 0.200000003))
...
mesh("BlockMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(1, 1, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(1.46267951, 0.200000003, 0.200000003))
...
mesh("BlockMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(1, 1, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.372464359, 0.762464345, 0.762464285))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.382464379, 0.762464345, 0.762464285))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(0.40246433, 0.762464345, 0.762464285))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Deep orange","SwordPart",Vector3.new(1.26045096, 0.762464345, 0.762464285))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,0,"Royal purple","SwordPart",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Hitbox=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,1,"Royal purple","Hitbox",Vector3.new(0.650000036, 4.19999981, 0.200000003))
...
EffectPart=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,1,"Deep orange","EffectPart",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
EffectPart2=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,1,"Royal purple","EffectPart2",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
effectsg.BrickColor = BrickColor.new("Deep orange")
...
coroutine.resume(coroutine.create(function()
	...
	for i=0,200 do
	wait()
	DerpMagic(Part,1,i/3,1,0,i/3,0,BrickColor.new("Deep orange")) 
	...
	for i=0,100 do
	wait()
	DerpMagic(Part,1,fff/3,1,0,fff/3,0,BrickColor.new("Deep orange")) 
	Part.CFrame=cframe*CFrame.fromEulerAnglesXYZ(math.random(-50,50),math.random(-50,50),math.random(-50,50))
	end
	for i=0,1,0.05 do
	wait()
...
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,4,4,4,0.2,0.2,0.2,0.01)
MagicWaveThing(BrickColor.new("Royal purple"),parent.CFrame,4,4,4,0.2,0.2,0.2,0.01)
end
...
if size==3 then
MagicRing(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
elseif size==2 then
MagicRing(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
end
end
if counter%5==0 then
if size==1 then
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
elseif size==2 then
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
elseif size==3 then
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
...
if size==1 then
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
MagicWave(BrickColor.new("Deep orange"),cf(Torso.Position)*cf(0,-1,0)*euler(0,math.random(-50,50),0),1,1,1,1,.5,1,0.05)
elseif size==2 then
MagicBlock(BrickColor.new("Royal purple"),parent.CFrame,.5,.5,.5,1,1,1,0.1,3,parent)
MagicWave(BrickColor.new("Deep orange"),cf(Torso.Position)*cf(0,-1,0)*euler(0,math.random(-50,50),0),1,1,1,1,.5,1,0.05)
elseif size==3 then
...
local function boom()
local pprt=ppart(3,game.Workspace,0,1,BrickColor.new("Royal purple"),"Effect",vt(1,1,1))
pprt.Anchored=true
pprt.CFrame=EffectPart.CFrame
game:GetService("Debris"):AddItem(pprt,2)
MagicCircle(BrickColor.new("Royal purple"),EffectPart.CFrame,20,20,20,-0.01,-0.01,-0.01,0.01)
so("http://roblox.com/asset/?id=228343412",EffectPart,1,0.6) 
so("http://roblox.com/asset/?id=228343408",EffectPart,1,1.4) 
local wave=part(3,game.Workspace,"Neon",0,.7,BrickColor.new("Royal purple"),"Effect",vt(1,1,1))
...
for i=0,80 do
swait()
MagicBlock(BrickColor.new("Royal purple"),EffectPart.CFrame,7,7,7,-0.5,-0.5,-0.5,0.05)
MagicCircle(BrickColor.new("Royal purple"),EffectPart.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50))*cf(0,5,0),0.5,1,0.5,0.02,1,0.02,0.05)
...
efprt=part(Enum.FormFactor.Custom,game.Workspace,Enum.Material.Neon,0,0,"Royal purple","BallEffect",Vector3.new(2, 2, 2))
...
makeShockwave(0.5,BrickColor.new("Deep orange"),30,1000,0)
MagicWave(BrickColor.new("Deep orange"),cf(Torso.Position)*cf(0,-1,0)*euler(0,math.random(-50,50),0),2,2,2,.5,.3,.5,0.01)
...
makeShockwave(4,BrickColor.new("Royal purple"),10,2000,1)
attack=false
...
function SolSiderea()
	...
	local n=2
	local orb=ppart(3,Character,0,1,BrickColor.new("Deep orange"),"Orb",vt())
	...
	MagicBlock(BrickColor.new("Deep orange"),orb.CFrame,15,15,15,2,2,2,0.1)
	local ef=ppart(3,workspace,0,0,BrickColor.new("Deep orange"),"Effect",vt())
	ef.Anchored=true
	...
	MagicCylinder(BrickColor.new("Deep orange"),CFrame.new((orb.Position+pos)/2,pos)*euler(1.57,0,0),10,mag*5,10,0.5,0,0.5,0.01)
	for i=1,2 do
	end
	for i=1,5 do
	...
	local ref=ppart(3,workspace,0,1,BrickColor.new("Deep orange"),"Effect",vt())
	ref.CFrame=cf(pos)
	coroutine.resume(coroutine.create(function(Part) 
	wait(1)
	Part.Parent=nil
	...
	local n=2
	MagicWave(BrickColor.new("Deep orange"),cf(pos)*euler(0,math.random(-50,50),0),2,2,2,.5,.3,.5,0.01)
	swait(75)
	Humanoid.WalkSpeed=16
	attack=false
end
