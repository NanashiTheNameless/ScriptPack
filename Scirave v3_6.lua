...
local ball2=part(1,nil,0,0.5,BrickColor.new("Magenta"),"DarkBall",vt(2,2,2))
 
local bmesh2=mesh("SpecialMesh",ball2,"Sphere","",vt(0,0,0),vt(1,0.8,1))
 
local bweld2=weld(ball2,ball2,nil,cf(0,0,0))
 
local bigsword=part(1,workspace,0,0,BrickColor.new("Magenta"),"Sword",vt(70,500,20))
 
bigsword.Parent=nil
 
local sword1=part(1,workspace,0,0.5,BrickColor.new("Magenta"),"Sword",vt(2,2,2))
 
sword1.Parent=nil
 
local sword2=part(1,workspace,0,0.5,BrickColor.new("Magenta"),"Sword",vt(2,2,2))
...
han = pa(su,"","Block",0.4,0.4,0.4,false,false,1,0,"Magenta") it('CylinderMesh',han)
...
GroundEffect(bla2,1,0.1,1,0,1,0,0,0,0,BrickColor.new("Magenta")) 
...
MMMAGIC(TargetTors,5,5,5,0,0,0,BrickColor.new("Magenta")) 
...
MMMAGIC(TargetTors,3,3,3,0,0,0,BrickColor.new("Magenta")) 
...
local d=part(1,workspace,0,0,BrickColor.new("Magenta"),"Poot",vt(1,1,1))
...
Lightning(ball.Position,ball.Position+Vector3.new(math.random(-4,4),math.random(-4,4),math.random(-4,4)),3,5,"Magenta",0.3,0.1)
 
MMMAGIC(RightArm,1,1,1,0,-1,0,BrickColor.new("Magenta")) 
...
MMMAGIC(hit2,5,5,5,0,0,0,BrickColor.new("Magenta"))
...
Lightning(ball.Position,hit2.Position,5,2,"Magenta",0.3,0.1)
...
Lightning(ball.Position,pos+Vector3.new(math.random(-10,10),math.random(-10,10),math.random(-10,10)),5,math.random(1,10),"Magenta",0.3,0.1)
...
MMMAGIC(RightArm,3,3,3,math.random(-3,3),math.random(-5,1),math.random(-3,3),BrickColor.new("Magenta")) 
...
MMMAGIC(Torso,3,3,3,math.random(-3,3),math.random(-1,5),math.random(-3,3),BrickColor.new("Magenta")) 
...
MMMAGIC(Torso,2,2,2,math.random(-7,7),math.random(-7,7),math.random(-7,7),BrickColor.new("Magenta")) 
...
MMMAGIC(Torso,9,9,9,0,0,0,BrickColor.new("Magenta")) 
...
con1=sword1.Touched:connect(function(hit) Damagefunc1(hit,10,10) if hit.Parent:findFirstChild("Humanoid")~= nil and hitted==false then hitted=true comboee=hit.Parent MMMAGIC(hit,2,2,2,0,0,0,BrickColor.new("Magenta")) end end) 
 
con2=sword2.Touched:connect(function(hit) Damagefunc1(hit,10,10) if hit.Parent:findFirstChild("Humanoid")~= nil and hitted==false then hitted=true comboee=hit.Parent MMMAGIC(hit,2,2,2,0,0,0,BrickColor.new("Magenta")) end end) 
...
local sword=part(1,workspace,0,0.5,BrickColor.new("Magenta"),"Sword",vt(3,3,3))
...
GroundEffect(sword,3,3,3,0,0,0,0,0,0,BrickColor.new("Magenta")) 
...
GroundEffect(sword,1,1,1,0,0,0,0,0,0,BrickColor.new("Magenta")) 
...
effectsg.BrickColor = BrickColor.new("Magenta") 
...
MMMAGIC(effectsg,5,5,5,0,0,0,BrickColor.new("Magenta")) 
...
local sword=part(1,modelzorz,0,0.5,BrickColor.new("Magenta"),"Sword",vt(3,3,3))
