...
local special = {
	...
	--rigletto = {"Cyan","Toothpaste",0,0,false,Color3.new(1,0,0),Color3.new(0,0,0)},
	noobmaster936 = {"Really black","Bright green",0,0,false,Color3.new(1,0,0),Color3.new(0,0,0)},
	...
	rigletto = {"Light stone grey","White",0,0,false,Color3.new(1,150/225,0)},
}

local topcolor = BrickColor.new("Really black")--invcol(char.Torso.BrickColor)
local feacolor = BrickColor.new("Really black")--char.Torso.BrickColor
