  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 25 then
    ...
    for i = 0, 1, 0.1 do
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        ...
        MagniDamage(Torso, 30, 3, 4, math.random(50, 60), "Knockdown2", Torso, 0, 1, (math.random(10, 15)), nil, nil, true, "Damage", 0.2, 300)
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 50 then
    ...
    MagniDamage(ref, 10, 8, 15, math.random(50, 70), "Knockdown2", ref, 2, 1, 100, nil, nil, false)
    ...
    ref.Transparency = 1
    swait(10)
    MagniDamage(ref, 30, 8, 15, math.random(50, 70), "Knockdown2", RootPart, 2, 1, 100, nil, true, false, nil, nil, nil)
    swait(10)
    MagniDamage(ref, 40, 8, 15, math.random(50, 70), "Knockdown2", RootPart, 2, 1, 100, nil, true, false, nil, nil, nil)
    ref.Parent = nil
    ref.Parent = nil
  end
end
...
while 1 do
  ...
  do
    ...
    if 300 <= passivenum then
      ...
      if 0 < Val then
        if Mode == "Defensive" then
          MagniBuff(RootPart, 60, "Defense", -Val, 300, true)
        else
          MagniBuff(RootPart, 60, "Damage", -Val, 300, true)
        end
      end
    else
