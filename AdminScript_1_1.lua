...
adminlist = {"SergeantSmokey",}--Please keep my name in there. ;)
...
If theres anything you think this command script needs, just message me (SilentCowz) and i might put it in. :)
...
swordtool/Person299
Gives Person299 a sword

rockettool/Person299
Gives Person299 a rocket

insert/Person299
Gives Person299 an insert tool

reverse/Person299
Makes Person299 walk backwards

clone/Person299
Creates a clone right above Person299

superjump/Person299
Makes Person299 jump high

skateboard/Person299
Sets a skateboard infront of Person299

fire/Person299
Sets Person299 on fire

unfire/Person299
Takes Person299 off fire

Also, the c/ command will tell you any errors.

I'm currently working on loop jump and sit, and unloop jump and sit.
...
m/message
Makes a message appear on the screen saying "message" for 2 seconds
...
local source = script:FindFirstChild("CreatedScript")
if source ~= nil then
sbbu = script.CreatedScript:clone()
sbbu.Disabled = false
else
...
--bonic10's functions start here and end later.

if string.sub(string.lower(msg),1,7) == "insert/" then
...
if human ~= nil and torso ~= nil then
	local root = game:GetService("InsertService"):LoadAsset(21013233) --I kinda just copied the skateboard one and edited it :3 . . . 
	local instances = root:GetChildren()
	if #instances == 0 then
		root:Remove()
		return
	end
	root.Name = "InsertedObject" .. 21013233
	game:GetService("InsertService"):Insert(root)
	root:MoveTo(torso.Position)
end end end end end
...
if string.sub(string.lower(msg),1,8) == "reverse/" then
...
--[[wait(3)
jump:Remove()]]
torso.Velocity = Vector3.new(0, 500, 0)
end end end end end
...
local torso = player[i].Character:FindFirstChild("Torso")
if human ~= nil and torso ~= nil then
torso.Velocity = Vector3.new(torso.Velocity.x, torso.Velocity.y + 500, torso.Velocity.z)
end end end end end]]
...
local torso = player[i].Character:FindFirstChild("Torso")
if human ~= nil and torso ~= nil then
	local root = game:GetService("InsertService"):LoadAsset(23154610) --Copied this part from a ROBLOX script. But I'm sure they won't mind.
	local instances = root:GetChildren()
	if #instances == 0 then
		root:Remove()
		return
...
if string.sub(string.lower(msg),1,10) == "swordtool/" then
local player = findplayer(string.sub(msg,11),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
...
local torso = player[i].Character:FindFirstChild("Torso")
if human ~= nil and torso ~= nil then
	local root = game:GetService("InsertService"):LoadAsset(47433) --Copied this part from a ROBLOX script. But I'm sure they won't mind.
	local instances = root:GetChildren()
	if #instances == 0 then
		root:Remove()
		return
	end
	root.Name = "InsertedObject" ..47433
	game:GetService("InsertService"):Insert(root)
	root:MoveTo(torso.Position)
end end end end end

if string.sub(string.lower(msg),1,11) == "rockettool/" then
local player = findplayer(string.sub(msg,12),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
...
local torso = player[i].Character:FindFirstChild("Torso")
if human ~= nil and torso ~= nil then
	local root = game:GetService("InsertService"):LoadAsset(47637) --Copied this part from a ROBLOX script. But I'm sure they won't mind.
	local instances = root:GetChildren()
	if #instances == 0 then
		root:Remove()
		return
	end
	root.Name = "InsertedObject" ..47637
	game:GetService("InsertService"):Insert(root)
	root:MoveTo(torso.Position)
end end end end end
...
eloname = "bonic"
eloname = eloname .. "10"
script.Name = "Person299's (with bonic10's extras) Admin Commands"
youcaughtme = 0
for i =1,#adminlist do
