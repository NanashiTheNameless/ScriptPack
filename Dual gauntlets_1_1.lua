...
colah = BrickColor.new("Really black") 
combo = 0 
mana = 400 
...
wait(0.1) 
WaveEffect(Torso,3,3,3,0,-1,0,0,0,0,BrickColor.new("Really black")) 
magicsound(1.2) 
for i = 0,1,0.2 do 
wait() 
...
GroundEffect(Torso,1,6,1,3,-3,0,0,0,0,BrickColor.new("Gold")) 
for i = 1,4 do 
GroundEffect2(Torso,0.5,3,0.5,3,-3,0,math.random(-50,50),math.random(-50,50),math.random(-50,50),BrickColor.new("Gold")) 
end 
spikesound(7)  
for i = 0,1,0.2 do 
wait() 
...
boulder.BrickColor = BrickColor.new("Gold") 
