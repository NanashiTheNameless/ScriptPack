...
local cooldownsadd = {}
local cooldownadd1 = 5000
table.insert(cooldownsadd, cooldownadd1)
local cooldownadd2 = 5000
table.insert(cooldownsadd, cooldownadd2)
local cooldownadd3 = 5000
table.insert(cooldownsadd, cooldownadd3)
local cooldownadd4 = 5000
table.insert(cooldownsadd, cooldownadd4)
local cooldownmax = 5000
player = nil
RSH = nil
...
NewCol = BrickColor.new("Purple").Color
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 50 then
    attack = true
    doingcomb = true
    cooldowns[1] = 0
    for i = 0, 1, 0.15 do
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 5000 then
    attack = true
    doingcomb = true
    cooldowns[2] = 0
    for i = 0, 1, 0.15 do
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 5000 and RecentEnemy.Value ~= nil then
    decreasemana = true
    hits = 0
    num1 = 0
    hits2 = 0
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 5000 and RecentEnemy.Value ~= nil then
    attack = true
    doingcomb = true
    move4do = true
    cooldowns[4] = 0
...
while 1 do
  ...
  stunanim = false
    ...
    do
      ...
      if 5000 <= mana.Value then
        mana.Value = 5000
      else
        if mananum <= 5000 then
          mananum = mananum + 5000
        else
          mananum = 5000
          mana.Value = mana.Value + 5000
        end
