-----[[Magix Staff]] 
madeby = "DoogleFox" --Heh. 
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ 
user = "hippiekid93" --Put your name here 
...
b.BrickColor = BrickColor.new("Deep blue") 
b.Shape = ("Ball") 
...
f.Parent = b 
f.Name = "Fire" 
f.Color = Color3.new(0,0.1,0.8) 
f.SecondaryColor = Color3.new(0.5,0.6,0.6) 
f.Heat = 3 
f.Size = 3.2 
...
maker = l1..l2a3..l4..l5a6..l7..l8..l9 
if madeby == maker then 
wait() 
else 
...
m.Parent = workspace 
m.Name = "Copyright Message" 
m.Text = madeby.." is trying to steal credit for DoogleFox's Staff!!!!" 
wait(4) 
m:remove() 
end 
