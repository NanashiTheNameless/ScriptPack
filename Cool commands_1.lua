...
ErrorMessage.Text = "[ic3w0lf589.NewSource.Value, " ..string.sub(Error, 9)
...
CoolCMDs.Functions.CreateGroup("guest", 5, "Guest", "The guest group has no privilages.")
CoolCMDs.Functions.CreateGroup("pguest", 5, "Privilaged Guest", "A privilaged guest has a few abilities.")
CoolCMDs.Functions.CreateGroup("miniadmin", 5, "Mini-Administrator", "The Mini-Administrator group can only use some low-level commands.")
CoolCMDs.Functions.CreateGroup("admin", 5, "Administrator", "The Administrator group can use most commands.")
...
coroutine.wrap(function()
local StatusMessage = CoolCMDs.Functions.CreateMessage("Hint")
local StatusMessagePrefix = "[AntiBan.Players." ..Self.Players[i].. "] "
StatusMessage.Changed:connect(function(Property)
if Property == "Text" then
if string.sub(StatusMessage.Text, 0, string.len(StatusMessagePrefix)) == StatusMessagePrefix then return false end
StatusMessage.Text = StatusMessagePrefix .. StatusMessage.Text
...
wait(5)
CoolCMDs.Functions.CreateMessage("Hint", "CoolCMDs version created by Calze900 " ..CoolCMDs.Data.Version.. " loaded successfully.", 5)
