...
if Character:findFirstChild("Magna",true) ~= nil then 
Character:findFirstChild("Magna",true).Parent = nil 
end 
...
modelzorz.Name = "Magna" 
BaseColour=Torso.BrickColor
...
local prt9b=part(3,modelzorz,0,0,BrickColor.new("Really Really black"),"Part9b",vt(0.6,1.01,0.6))
...
local prt22b=part(3,modelzorz,0,0,BrickColor.new("Really Really black"),"Part22b",vt(0.8,1.01,0.8))
...
wait(0.3)
so("http://roblox.com/asset/?id=10209257",prt7,1,0.3) 
...
so("http://www.roblox.com/asset/?id=2697295",prt9,1,0.5) 
wldbul.Part1=prt9
