...
ang = CFrame.Angles
Colors = {}
Colors.Fire = 'Lime green'
Colors.Handle = 'Really black'
Colors.Handle2 = 'Lime green'
Colors.Ball = 'Really black'
Colors.Ball2 = 'Lime green'
Colors.Ring = 'Lime green'
Meshes = {Diamond = 'rbxassetid://9756362'}
...
if which == 'R' then
if not rw then
        rabr = Part(1,1,1,'Lime green',1,false,false)
...
elseif which == 'L' then
if not lw then
        labr = Part(1,1,1,'Lime green',1,false,false)
...
function wave()
        ...
        local p = Part(3,3,3,'Lime green',0,true,true)
        ...
        for i = 0,1,.15 do
                ...
                local cl = Part(3,3,3,'Lime green',0,true,true)
...
function spin()
        ...
        bb = Part(.1,.1,.1,'Really black',0,false,false)
        msh = Mesh(bb,2,1,1,1)
        Weld(bb,ball,0,0,0,0,0,0)
        bb2 = Part(.1,.1,.1,'Really black',0,false,false)
...
function teleport() 
p = Part(1,1,1,'Lime green',.5,false,false)
...
function beam()
        ...
        Grow:Play()
        for o = 1,10 do wait()
        local spike = Part(5,1,5,'Lime green',.5,true,true)
...
function shoot()
        ...
        r = 15 walls = {}
        for i = 1,360,30 do
                po = Part(((r*2)*math.pi/(360/30)),10,3,'Lime green',0,true,true)
...
function tidal()
        ...
        Charge:Play()
        for i = 1,20 do wait()
                p = Part(3,3,3,'Lime green',.7,false,true)
        ...
        Tide:Play()
        mp = Part(20,10,1,'Lime green',0,false,true)
        stopped = false
        coroutine.wrap(function()
                while wait() and not stopped do
                        local cl = Part(20,10,1,'Lime green',0,false,true)
