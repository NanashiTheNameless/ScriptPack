...
if (string.match(Player.Unlocks.Value,"Dekagren Walkspeed+") ~= nil) then
ws = 40
else
ws = 40
end
if (string.match(Player.Unlocks.Value,"Dekagren Charge") ~= nil) then
if (string.match(Player.Unlocks.Value,"Dekagren MoreCharge") ~= nil) then
maxCharge = 5
else
maxCharge = 3
end
...
handlecolor = BrickColor.new("Royal purple")
bcolor = BrickColor.new("Alder")
...
backing.BackgroundColor3 = BrickColor.new("Royal purple").Color
