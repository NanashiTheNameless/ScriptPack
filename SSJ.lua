while game.Players.TheGreenLabs.PlayerGui:FindFirstChild("SuperSaiyan") == nil do
wait()
if game.Players.TheGreenLabs.PlayerGui:FindFirstChild("SuperSaiyan") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.TheGreenLabs.PlayerGui
screengui.Name = "SuperSaiyan"

local textbutton = Instance.new("TextButton")
textbutton.Parent = screengui
textbutton.Position = UDim2.new(0,686,0,15)
textbutton.Size = UDim2.new(0,70,0,25)
textbutton.Text = "SuperSaiyan"
textbutton.TextColor3 = Color3.new(0/0, 0/0, 0/0)
textbutton.BorderColor3 = Color3.new(0/0, 0/0, 0/0)
textbutton.BackgroundColor = BrickColor.new("Bright yellow")
textbutton.MouseButton1Down:connect(function()


jun = game.Players.TheGreenLabs -- Name here
Stuff = false
--password
function ssj()
if Stuff == false then
