...
adminlist = {"ImTheCop","Darkshadow35","NITR0US","Thunder162","tompengu","pillzhereyum14"}	-- Add in the names of the people you want to be able to use the command script here.
