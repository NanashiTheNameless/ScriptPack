--[[
Magnum Research Desert Eagle, most powerful production automatic handgun.
Uses obscenely large .50 Action Express rounds, 7 round magazines.
--]]
...
MC = BrickColor.new("Light stone grey")
GC = BrickColor.new("Light stone grey")
...
function makeParts(format)
	...
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.042, -0.43) * CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Wood"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Brick"
	m.Scale = Vector3.new(0.3, 0.45, 0.58)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0, -0.48) * CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Magazine"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Brick"
	m.Scale = Vector3.new(0.24, 0.38, 0.8)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.04, -0.4) * CFrame.fromEulerAnglesXYZ(math.rad(10), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "TriggerGuard"
	...
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-0.25, 0.24, 0) * CFrame.fromEulerAnglesXYZ(0, math.rad(90), 0)
	w.C1 = CFrame.new()
	w.Parent = p	
	local p = Instance.new("Part")
	p.Name = "Trigger"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.2, 1.2, 0.14)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.35, -0.1)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Base"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 0.1, 0.18)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.9, -0.088)
	w.C1 = CFrame.new()
	w.Parent = p
	...
	pb.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.15, 0.65, 0.18)
	m.Parent = pb
	local w = Instance.new("Weld")
	w.Part0 = pb
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.625, 0.06)
	w.C1 = CFrame.new()
	w.Parent = pb
	local p = Instance.new("Part")
	p.Name = "Base"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Wedge"
	m.Scale = Vector3.new(0.65, 0.075, 0.18)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pb
	w.C0 = CFrame.new(0, -0.1125, 0) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(90))
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Base"
	...
	m.Scale = Vector3.new(0.32, 0.2, 0.32)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Sphere"
	m.Scale = Vector3.new(0.32, 0.32, 0.32)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	local m = Instance.new("BlockMesh")
	m.Name = "Mesh"
	m.Scale = Vector3.new(0.3, 0.4, 0.33)
	m.Parent = ps
	local w = Instance.new("Weld")
	w.Part0 = ps
	w.Part1 = pm
	if magazine.Value ~= 0 then
		w.C0 = CFrame.new(0, -0.06, -0.015)
	else
		w.C0 = CFrame.new(0, -0.36, -0.015)
	end
	w.C1 = CFrame.new()
	w.Parent = ps
	local p = Instance.new("Part")
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 1, 0.15)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = ps
	w.C0 = CFrame.new(0, 0.47, -0.088)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "RearSight"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.06, 0.08, 0.08)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = ps
	w.C0 = CFrame.new(0.08, -0.1, 0.16)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "RearSight"
	...
	p.Parent = model
	local m = Instance.new("CylinderMesh")
	m.Scale = Vector3.new(0.1, 0.82, 0.1)
	m.Offset = Vector3.new(0, 0, 0)	
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.544, 0.05)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Muzzle"
	...
	p.Parent = model
	local m = Instance.new("CylinderMesh")
	m.Scale = Vector3.new(0.11, 0.1, 0.11)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1, 0.07)
	w.C1 = CFrame.new()
	w.Parent = p
...
function playAnimation(format, mouse)
	...
	if format == "rightHold" then
		if Player.Character:FindFirstChild("Torso") ~= nil then
			if Player.Character.Torso:FindFirstChild("Right Shoulder 2") ~= nil then
				Player.Character.Torso["Right Shoulder 2"].C0 = CFrame.new()
				Player.Character.Torso["Right Shoulder 2"].C1 =  CFrame.new(-0.7, 0.5, 0.6) * CFrame.fromEulerAnglesXYZ(math.rad(-90), math.rad(-5), 0)
			else return false end
		else return false end
	end
	if format == "leftHold" then
		if Player.Character:FindFirstChild("Torso") ~= nil then
			if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil then
				Player.Character.Torso["Left Shoulder 2"].C0 = CFrame.new()
				Player.Character.Torso["Left Shoulder 2"].C1 =  CFrame.new(0.7, 0.5, 0.6) * CFrame.fromEulerAnglesXYZ(math.rad(-90), math.rad(5), 0)
			else return false end
		else return false end
	end
	if format == "reload" then
		...
		if magazine.Value == 0 then
			...
			Player.Character[Name].Slide.Weld.C0 = CFrame.new(0, -0.06, -0.015)
			CamShake(1, 50000)	
			CamShake(1, -50000)								
			wait(0.24)
		else end		
	...
	if format == "reloadDual" then
		...
		if magazine.Value == 0 then
			...
			Player.Character[Name].Slide.Weld.C0 = CFrame.new(0, -0.36, -0.015)
			Player.Character[Name.. " (Left)"].Slide.Weld.C0 = CFrame.new(0, -0.36, -0.015)
		else end
		wait(0.1)
		CamShake(1, 40000)													
		Player.Character[Name].Handle.Release:Play()
		...
		if magazine.Value == 0 then
			...
			Player.Character[Name].Handle.Lock:Play()
			Player.Character[Name].Slide.Weld.C0 = CFrame.new(0, -0.06, -0.015)
			Player.Character[Name.. " (Left)"].Slide.Weld.C0 = CFrame.new(0, -0.06, -0.015)
			CamShake(1, 30000)	
			CamShake(1, -30000)											
		else end
		for i = 25, 0, -5 do
	...
	if format == "fire" then
		...
		if Player.Character[Name]:FindFirstChild("Handle") ~= nil then
			if silenced then
				...
				Player.Character[Name].Handle.Fire.Pitch = math.random(12, 15) / 20
				Player.Character[Name].Handle.Fire:Play()
				CamShake(15, 5000)
			end
		else return false end
	...
	if format == "leftFire" then
		...
		if Player.Character[Name.. " (Left)"]:FindFirstChild("Handle") ~= nil then
			if silenced then
				...
				Player.Character[Name.. " (Left)"].Handle.Fire.Pitch = math.random(12, 15) / 20
				Player.Character[Name.. " (Left)"].Handle.Fire:Play()
				CamShake(15, 50000)
			end
		end
...
function makeShell(part)
	...
	mesh.Scale = Vector3.new(0.42, 1, 0.42)
	mesh.Parent = casing
