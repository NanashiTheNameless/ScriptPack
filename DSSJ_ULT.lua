	--[[
SSJ_ULT --Credits to TheDarkRevenant for the main script, and _RHas for editing it.
]]

--[[
Hi has, I have some things here for ya
-----SSJ 100----
top: 365942224403445112
bottom: 365942308
face: 105702096
music: 403443852
hair: Really black
colors: Earth green & Really black
------SSJ10----------
Top:324383273
Bottom: 324580114
face: 439123648
music: 407426418   pitch .55
SKIN: Sand blue
Hair: Dark stone grey
Attack colors: Mid grey
-------GDSSGJ-----
Pants: 343069229
Shirt: 363749654
face: 471907208
attack colors: Institutional white, Really black
music: 245043810    pitch .77

i told you, i'd study up o.o 
I already made the music functions, ssj10, ssj100, GDSSGJ, you can check all that if you want.
Was also hoping you could make a key to make it to back to the orig. If not, das oki.  (just make it the last rotation if you can)
For ssj10, I requested the body parts have a different color than the others, I dunno if that's possible or not.
There's another thing I was hoping you could do for me
so, yknow how genkadda has that little arm effect, the blocks. uh, this; https://gyazo.com/b489dac8f0da3ccf5b91ad249d01a8ab
I was hoping you could use that as the leg effect, since that's what it's supposed to be, looking at TDR's updated ssj.
Normie - DSSJ8 - SSJ15 - SSJ 100 - SSJ 10 - GDSSGJ     
^thinking of a rotation thing for H, where it cycles through those like it went rotated between DSSJ8 and ssj15
...
USSJG.SoundId = "rbxassetid://146040281"
USSJG.Looped = true
USSJG.Pitch = 1
USSJG.Volume = 1
USSJG.Looped=true
...
GDSSGJ.SoundId = "rbxassetid://466308245"
GDSSGJ.Looped = true
GDSSGJ.Pitch = .9
GDSSGJ.Volume = 1
GDSSGJ.Looped=true
...
FSSJ.SoundId = "rbxassetid://248000653"
FSSJ.Looped = true
FSSJ.Pitch = .9
FSSJ.Volume = 1
FSSJ.Looped=true
...
LSSJ3.SoundId = "rbxassetid://386058260"
LSSJ3.Looped = true
LSSJ3.Pitch = 1
LSSJ3.Volume = 1
LSSJ3.Looped=true
...
SSJP.SoundId = "rbxassetid://381770604"
SSJP.Looped = true
SSJP.Pitch = .9
SSJP.Volume = 1
SSJP.Looped=true
...
ssj100.SoundId = "rbxassetid://403445112"
ssj100.Looped = true
ssj100.Pitch = .9
ssj100.Volume = 1
ssj100.Looped=true
...
ssj15.SoundId = "rbxassetid://403419189"
ssj15.Looped = true
ssj15.Pitch = .9
...
ssj10.SoundId = "rbxassetid://407426418"
ssj10.Looped = true
ssj10.Pitch = .55
ssj10.Volume = 1
ssj10.Looped=true
...
ssj8.SoundId = "rbxassetid://432534193"
ssj8.Looped = true
ssj8.Pitch = .9
ssj8.Volume = 1
ssj8.Looped=true
...
starter.SoundId = "rbxassetid://474217262"
...
local forms={
	normie={
	Face=hed:FindFirstChild'face'.Texture,
	HairCol='Mulberry',
...
--hed.face.Texture = "rbxassetid://105701482"
...
fx.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
p1.BrickColor = BrickColor.new("Gold")
...
p3.BrickColor = BrickColor.new("Gold")
...
b3.MeshId = "http://www.roblox.com/asset/?id=rbxassetid://"
b3.TextureId = ""
...
p4.BrickColor = BrickColor.new("Gold")
...
p5.BrickColor = BrickColor.new("Gold")
...
p6.BrickColor = BrickColor.new("Gold")
...
p7.BrickColor = BrickColor.new("Gold")
...
p8.BrickColor = BrickColor.new("Gold")
...
p9.BrickColor = BrickColor.new("Gold")
...
p10.BrickColor = BrickColor.new("Gold")
...
p11.BrickColor = BrickColor.new("Gold")
...
p12.BrickColor = BrickColor.new("Gold")
...
p13.BrickColor = BrickColor.new("Gold")
...
p14.BrickColor = BrickColor.new("Gold")
...
p15.BrickColor = BrickColor.new("Gold")
...
p16.BrickColor = BrickColor.new("Gold")
...
p17.BrickColor = BrickColor.new("Gold")
...
p18.BrickColor = BrickColor.new("Gold")
...
b18.MeshId = "http://www.roblox.com/asset/?id="
b18.TextureId = ""
...
m:MakeJoints()
for _,v in pairs(char.Hair:GetChildren()) do
	if v:IsA'BasePart' and v.Name=='Part' then v.BrickColor=BrickColor.new('Mulberry') end
end
----------------------------------------------------
...
GroundWave = function()
        if Transforming == true then
                local wave = Instance.new("Part", torso)
                wave.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
                wave.Anchored = true
                wave.CanCollide = false
                wave.Locked = true
                wave.Size = Vector3.new(1, 1, 1)
                ...
                if hit.Name ~= p.Name then
                    if Debounces.RPunch == true and Debounces.RPunched == false then
                            Debounces.RPunched = true
                                hit:FindFirstChild("Humanoid"):TakeDamage(math.random(5,8)*forms[mode].DamageMultiplier)
    ...
    elseif ht and hit:IsA("Hat") then
        if hit.Parent.Name ~= p.Name then
            if hit.Parent:FindFirstChild("Humanoid") then
                   if Debounces.RPunch == true and Debounces.RPunched == false then
                            Debounces.RPunched = true
                            hit.Parent:FindFirstChild("Humanoid"):TakeDamage(math.random(5,8)*forms[mode].DamageMultiplier)
                                    if Debounces.ks==true then
                                    z = Instance.new("Sound",hed)
                                    z.SoundId = "rbxassetid://169380525"
                                                                        z.Pitch = ptz[math.random(1,#ptz)]
                ...
                if hit.Name ~= p.Name then
                    if Debounces.LPunch == true and Debounces.LPunched == false then
                            Debounces.LPunched = true
                                hit:FindFirstChild("Humanoid"):TakeDamage(math.random(4,8)*forms[mode].DamageMultiplier)
    ...
    elseif ht and hit:IsA("Hat") then
        if hit.Parent.Name ~= p.Name then
            if hit.Parent:FindFirstChild("Humanoid") then
                   if Debounces.LPunch == true and Debounces.LPunched == false then
                            Debounces.LPunched = true
                            hit.Parent:FindFirstChild("Humanoid"):TakeDamage(math.random(4,8)*forms[mode].DamageMultiplier)
                                    if Debounces.ks2==true then
                                    z = Instance.new("Sound",hed)
                                    z.SoundId = "rbxassetid://169380525"
                                                                        z.Pitch = ptz[math.random(1,#ptz)]
...
function Punch()
    ...
    part.Transparency=.7
    part.BrickColor=BrickColor.new(eColors[math.random(1,#eColors)])
    ...
    part2.BrickColor=BrickColor.new(eColors[math.random(1,#eColors)])
    mesh2=Instance.new('SpecialMesh',part2)
    mesh2.MeshId='http://www.roblox.com/asset/?id=20329976'
    mesh2.Scale=Vector3.new(3,1.5,3)
    for i,v in pairs(FindNearestTorso(torso.CFrame.p,4))do
        if v:FindFirstChild('Humanoid') then
            v.Humanoid:TakeDamage(math.random(2,6)*forms[mode].DamageMultiplier)
        end
    end
...
mouse.KeyDown:connect(function(key)
	...
	sp.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
	spm = Instance.new("SpecialMesh",sp)
	spm.MeshType = "Sphere"
	spm.Scale = Vector3.new(21,21,21)
	sp2 = Instance.new("Part", rarm)
	sp2.Name = "Energy"
	sp2.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
	...
	V.Value = char
	V.Name = "creator"
	X.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
	...
	Explode = X.Touched:connect(function(hit)
		if hit ~= char and hit.Name ~= "Shell" then
			...
			part3.BrickColor=BrickColor.new(eColors[math.random(1,#eColors)])
			...
			part7.BrickColor=BrickColor.new(eColors[math.random(1,#eColors)])
		...
		X.Touched:connect(function(ht)
			...
			if ht and hit:IsA("Model") then
					if hit:FindFirstChild("Humanoid") then
						if hit.Name ~= p.Name then
							hit:FindFirstChild("Humanoid"):TakeDamage(math.random(4,6)*forms[mode].DamageMultiplier)
							wait(.3)
						end
					end
			elseif ht and hit:IsA("Hat") then
				if hit.Parent.Name ~= p.Name then
					if hit.Parent:FindFirstChild("Humanoid") then
						hit.Parent:FindFirstChild("Humanoid"):TakeDamage(math.random(4,6)*forms[mode].DamageMultiplier)
						wait(.3)
					end
				end
			end
		...
		for i,v in pairs(FindNearestTorso(X.CFrame.p,140))do
			if v:FindFirstChild('Humanoid') then
				v.Humanoid:TakeDamage(math.random(60,90)*forms[mode].DamageMultiplier)
		...
		function Crater(Torso,Radius)
			...
			function explosion(col1,col2,cfr,sz,rng,dmg)
				...
				blast.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
				blast.Anchored = true
				...
				blast2.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
				...
				blast3.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
                    ...
                    if hit:FindFirstChild("Humanoid") then
                        if hit.Name ~= p.Name then
                            --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    ...
                                    hit:FindFirstChild("Humanoid"):TakeDamage(2*forms[mode].DamageMultiplier)
            ...
            elseif ht and hit:IsA("Hat") then
                if hit.Parent.Name ~= p.Name then
                    if hit.Parent:FindFirstChild("Humanoid") then
                           --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit.Parent:FindFirstChild("Humanoid"):TakeDamage(2*forms[mode].DamageMultiplier)
                                    hit:FindFirstChild("Torso").Velocity = hit:FindFirstChild("Torso").CFrame.lookVector * -300
                            --Debounces.Slashed = false
                        --end
                    end
...
rng.Anchored = true
rng.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
bem.Anchored = true
bem.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
out.Anchored = true
out.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
bnd.Anchored = true
bnd.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
hit:FindFirstChild("Humanoid"):TakeDamage(math.random(24,73)*forms[mode].DamageMultiplier)
end)()
	...
	if key == "x" then
		if Debounces.CanAttack == true then
			...
			Debounces.on = true
				...
				shell.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
					...
					if v:IsA'Model' and v:FindFirstChild'Humanoid' and v:FindFirstChild'Torso' and v~=pchar then
						local mag=(v.Torso.CFrame.p-shell.CFrame.p).magnitude
							if mag <= shell.Size.x then
								v.Humanoid.Health=v.Humanoid.Health-(v.Humanoid.MaxHealth/7)*forms[mode].DamageMultiplier
							end
						end
					end
			end end))
...
bl.Locked = true
bl.Name = "Shell"
bl.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
bl.Anchored = true
bl.CanCollide = false
bl.Transparency = 0
bl.Reflectance = 0
...
--hed.face.Texture = "rbxassetid://439123648"
               b = Instance.new("Sound")
                        b.SoundId = "http://www.roblox.com/asset/?id=262498472"
                        b.Parent = char.Head
                        b.Looped = true
	...
	if key == "g" then
		if Debounces.CanAttack == true then
			...
			Debounces.on = true
				...
				shell2.BrickColor = BrickColor.new(eColors[math.random(1,#eColors)])
...
Explode = X.Touched:connect(function(hit)
		...
		for i,v in pairs(FindNearestTorso(X.CFrame.p,40))do
			if v:FindFirstChild('Humanoid') then
				v.Humanoid:TakeDamage(math.random(6,12)*forms[mode].DamageMultiplier)
			end
		end
			for i = 1, (40) do rs:wait()
				X.Transparency = X.Transparency + (1/40)
...
spawn(function()
while wait(0.0001) do if stanceToggle=="Normal" then -- Emit the Lightning effects randomly, (math.random(1,10)/10) if you want original
	...
	Lightning(SPos1, SPos2, 1, .5, eColors[math.random(1,#eColors)], .3, .56)
        --Lightning(SPos1, SPos2, 4, 3, "Really red", .3, .56)
end
end end)
spawn(function() --_RHas
	local ef1=Instance.new('Part',lleg)
	local am=Instance.new('BlockMesh',ef1)
	ef1.Anchored,ef1.CanCollide=false,false
	ef1.Transparency=.6
	am.Scale=Vector3.new(7,7,7)
	ef1.Size=Vector3.new(.2,.2,.2)
	local ef2=ef1:Clone()
	local ef3=ef2:Clone()
	local ef4=ef3:Clone()
	ef3.Parent,ef4.Parent=rleg,rleg
	ef2.Parent=lleg
	local wa,wb=Instance.new('Weld',lleg),Instance.new('Weld',lleg)
	local wc,wd=Instance.new('Weld',rleg),Instance.new('Weld',rleg)
	wa.Part0,wb.Part0=lleg,lleg
	wa.Part1,wb.Part1=ef1,ef2
	wc.Part0,wd.Part0=rleg,rleg
	...
	while wait(0) do
		...
		ef1.BrickColor,ef3.BrickColor=BrickColor.new(eColors[math.random(1,#eColors)]),BrickColor.new(eColors[math.random(1,#eColors)])
	end
end)
script.Parent=char