...
Tprt03 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part03", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.14, 12.14, 4, euler(mr(90), 0, 0) * cf(0, -0.01, 0))
Tprt04 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part04", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.15, 12.15, 2, euler(mr(90), 0, 0) * cf(0, -0.01, 0))
...
Tprt06 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part06", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.5, 12.5, 2, euler(mr(90), 0, 0) * cf(0, 1.03, 0))
Tprt07 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part07", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.6, 12.6, 1, euler(mr(90), 0, 0) * cf(0, 1.14, 0))
Tprt08 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part08", "SmoothPlastic", "SpecialMesh", "Cylinder", "nil", 1, 5, 5, euler(mr(90), 0, 0) * cf(-0.562, 0.82, 0))
...
Tprt10 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part10", "SmoothPlastic", "SpecialMesh", "FileMesh", "9756362", 0.2, 1, 0.4, euler(mr(90), 0, 0) * cf(-0.662, 0.82, 0))
...
Tprt12 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part12", "SmoothPlastic", "SpecialMesh", "FileMesh", "26340522", 1, 1, 1.4, euler(0, mr(90), 0) * cf(0, -0.34, 0))
Tprt13 = AesthPart(modelzorz, Tprt01, 0, 0, "Really red", "Torso Part13", "SmoothPlastic", "SpecialMesh", "FileMesh", "189759018", 3, 4, 3.5, euler(0, mr(90), 0) * cf(0, -0.55, -0.06))
...
for i = -1, 1, 2 do
  ...
  Aprt02 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part02", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.5, 4, 3, euler(mr(90), mr(90), 0) * cf(-0.23, -0.93, 0))
  Aprt03 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part03", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.5, 3, 7, euler(mr(90), mr(90), 0) * cf(0.43, -0.82, 0))
  Aprt04 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part04", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 6.5, 3, 3, euler(mr(-90), mr(-90), mr(59.815)) * cf(0.23, 0.01, 0))
  Aprt05 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part05", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 6.5, 3, 3, euler(mr(-90), mr(-90), mr(90)) * cf(0.43, 0.18, 0))
  Aprt06 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part06", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 6.5, 3, 3, euler(mr(-90), mr(-90), mr(32.321)) * cf(0.05, -0.2, 0))
  ...
  Aprt08 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part08", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.3, 3, 6.3, euler(0, mr(90), 0) * cf(0, 0.82, 0))
  Aprt09 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part09", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 7, 5, 5, euler(0, mr(90), mr(103.229)) * cf(-0.1, -0.87, 0))
  Aprt10 = AesthPart(modelzorz, thPart, 0, 0, "Really red", "Arm Part10", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 7, 5, 5, euler(0, mr(90), mr(90)) * cf(0.26, -0.85, 0))
  ...
  Lprt02 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part02", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.3, 6.3, 3, euler(0, 0, 0) * cf(0, 0, -0.92))
  ...
  Lprt04 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part04", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 3, 2, euler(0, 0, mr(180)) * cf(0.53 * i, 0.33, -0.42))
  Lprt05 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part05", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 3, 2, euler(0, 0, 0) * cf(0.53 * i, -0.33, -0.42))
  Lprt06 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part06", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 3, 2, euler(0, 0, mr(180)) * cf(-0.53 * i, 0.33, -0.42))
  Lprt07 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part07", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 3, 2, euler(0, 0, 0) * cf(-0.53 * i, -0.33, -0.42))
  Lprt08 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part08", "SmoothPlastic", "BlockMesh", "nil", "nil", 6.6, 6.6, 3, euler(0, 0, 0) * cf(0, 0, 0.37))
  ...
  Lprt13 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part13", "SmoothPlastic", "CylinderMesh", "nil", "nil", 2, 1, 2, euler(0, 0, mr(90)) * cf(-0.62 * i, 0, 0.03))
  Lprt14 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part14", "SmoothPlastic", "CylinderMesh", "nil", "nil", 1.7, 1.1, 1.7, euler(0, 0, mr(90)) * cf(-0.62 * i, 0, 0.03))
  ...
  Lprt16 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part16", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 1.5, 4, euler(0, 0, mr(180)) * cf(-0.6 * i, 0.14, 0.35))
  Lprt17 = AesthPart(modelzorz, thPart2, 0, 0, "Really red", "Leg Part17", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 1.5, 4, euler(0, 0, 0) * cf(-0.6 * i, -0.16, 0.35))
...
LAprt12 = AesthPart(modelzorz, LAprt01a, 0, 0, "Really red", "Left Arm Part12", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 7, 2, euler(mr(180), mr(-90), mr(103.229)) * cf(1.05, -1.48, 0.71))
LAprt13 = AesthPart(modelzorz, LAprt01a, 0, 0, "Really red", "Left Arm Part13", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 1, 7, 2, euler(mr(180), mr(-90), mr(103.229)) * cf(1.05, -1.48, -0.71))
RAprt12 = AesthPart(modelzorz, RAprt01a, 0, 0, "Really red", "Right Arm Part12", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 6.5, 3, 6, euler(mr(180), mr(90), mr(9.214)) * cf(1.217, -1.384, 0))
RAprt13 = AesthPart(modelzorz, RAprt01a, 0, 0, "Really red", "Right Arm Part13", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 6, 3, 6, euler(mr(180), mr(90), mr(-10.361)) * cf(1.108, -1.116, 0))
RAprt14 = AesthPart(modelzorz, RAprt01a, 0, 0, "Really red", "Right Arm Part14", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 5.5, 3, 6, euler(mr(180), mr(90), mr(-42.832)) * cf(1.002, -0.856, 0))
...
RAprt21 = AesthPart(modelzorz, RAprt01a, 0, 0, "Really red", "Right Arm Part21", "SmoothPlastic", "CylinderMesh", "nil", "nil", 3.5, 1, 3.5, euler(mr(90), mr(90), 0) * cf(0.55, 0.82, 0))
...
Hprt03 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part03", "SmoothPlastic", "CylinderMesh", "nil", "nil", 9, 1, 9, euler(mr(9.321), 0, 0) * cf(0, -0.15, 0.03))
Hprt04 = AesthPart(modelzorz, Hprt01, 0, 0, "Bright red", "Head Part04", "Neon", "CylinderMesh", "nil", "nil", 9.1, 0.2, 9.1, euler(mr(9.321), 0, 0) * cf(0, -0.15, 0.03))
Hprt05 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part05", "SmoothPlastic", "BlockMesh", "nil", "nil", 1, 4, 3, euler(mr(90), 0, 0) * cf(0.82, -0.07, 0.06))
Hprt06 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part06", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 3, 1, 2, euler(0, mr(180), mr(-90)) * cf(1.02, -0.07, -0.14))
Hprt07 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part07", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 3, 1, 2, euler(0, 0, mr(-90)) * cf(1.02, -0.07, 0.26))
Hprt08 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part08", "SmoothPlastic", "BlockMesh", "nil", "nil", 1, 4, 3, euler(mr(90), 0, 0) * cf(-0.81, -0.07, 0.06))
Hprt09 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part09", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 3, 1, 2, euler(0, mr(180), mr(90)) * cf(-1.01, -0.07, -0.14))
Hprt10 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part10", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 3, 1, 2, euler(0, 0, mr(90)) * cf(-1.01, -0.07, 0.26))
Hprt11 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part11", "SmoothPlastic", "CylinderMesh", "nil", "nil", 3, 1, 3, euler(mr(90), 0, 0) * cf(0, 0.02, 0.86))
...
Hprt13 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part13", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 0.5, 1, 4, euler(mr(90), mr(-90), 0) * cf(0.1, 0.59, 0.91))
Hprt14 = AesthPart(modelzorz, Hprt01, 0, 0, "Really red", "Head Part14", "SmoothPlastic", "SpecialMesh", "Wedge", "nil", 0.5, 1, 4, euler(mr(90), mr(90), 0) * cf(-0.1, 0.59, 0.91))
...
z.SoundId = "rbxassetid://301999080" -- Put Music ID Here.
z.Looped = true
z.Pitch = .82
z.Volume = 1
wait(.1)
...
Claw = CreatePart2(m, Enum.Material.Neon, 0.30000001192093, 0, "Part", "Really red", "Claw", Vector3.new(1, 1, 1))
...
CreateMesh("SpecialMesh", Claw, Enum.MeshType.FileMesh, "http://www.roblox.com/Asset/?id=9756362", Vector3.new(0, 0, 0), Vector3.new(1, 0.709999979, 0.100000001))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 0.200000003))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 1.04200566))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.445813209, 0.210449979, 1.04200566))
...
CreateMesh("BlockMesh", ClawMaterial, "", "", Vector3.new(0, 0, 0), Vector3.new(0.821169853, 0.388499111, 1.00999999))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.664211631, 0.210449979, 1.04200566))
...
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.627083898, 0.210449979, 1.04200566))
...
CreateMesh("BlockMesh", ClawMaterial, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.388499111, 1.00999999))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "Part", "Really red", "ClawMaterial", Vector3.new(0.210449979, 0.210449979, 0.329999983))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.961425304, 0.961427808, 1))
Part = CreatePart2(m, Enum.Material.Neon, 0, 0, "Part", "Black", "Part", Vector3.new(1, 1, 1))
...
CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.225887179, 0.543544471, 0.369591445))
ClawMaterial = CreatePart2(m, Enum.Material.SmoothPlastic, 0.30000001192093, 0, "WedgePart", "Really red", "ClawMaterial", Vector3.new(1.0507766, 0.342107773, 0.210450009))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Wedge, "", Vector3.new(0, 0, 0), Vector3.new(1, 0.961427808, 0.961421788))
MotorOne = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 1, "Really red", "MotorOne", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Shard = CreatePart2(m, Enum.Material.Neon, 0.30000001192093, 0, "Part", "Really red", "Shard", Vector3.new(1, 1, 1))
...
MotorTwo = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 1, "Really red", "MotorTwo", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
MotorThumb = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 0, "Really red", "MotorThumb", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
MotorThumbTwo = CreatePart(m, Enum.Material.Neon, 0.30000001192093, 0, "Really red", "MotorThumbTwo", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
MagniHit = CreatePart(m, Enum.Material.Neon, 0, 1, "Medium stone grey", "MagniHit", Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
TornadoHat = CreatePart(demon, Enum.Material.Neon, 0.20000000298023, 0.5, "Black", "TornadoHat", Vector3.new(3, 0.400000006, 3))
    ...
    if do2target ~= nil then
      ...
      do
        do
          ...
          MotorThumbWeld.C0 = clerp(MotorThumbWeld.C0, cf(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
          MotorThumbTwoWeld.C0 = clerp(MotorThumbTwoWeld.C0, cf(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
          -- NIGH-OMNI FATAL ERROR at PC391: LeaveBlock: unexpected jumping out DO_STMT

          -- NIGH-OMNI FATAL ERROR at PC391: LeaveBlock: unexpected jumping out IF_ELSE_STMT

          -- NIGH-OMNI FATAL ERROR at PC391: LeaveBlock: unexpected jumping out IF_STMT
