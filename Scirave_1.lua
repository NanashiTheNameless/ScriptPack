...
Chat2.Visible = false 
Chat2.Text = " " 
--[[if Player.userId~=29696302
 and Player.userId~=17613036 then 
...
-- shit This acts as a chat filter. Don't ask why I do it. I just do >.> 
-- mediafire STOOPID ROBLOX, Y U ALLOW LEGO NAO 
--[[ 
Copyrighted (C) jsdhla 2011 
This script is copyrighted for jsdhla. Any use of this script is breaking 
this copyright. 
All Rights Reserved. 
]] 
--mediafire 
