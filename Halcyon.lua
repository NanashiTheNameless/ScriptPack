...
healthcover = makeframe(healthbar, 0, UDim2.new(0, 0, 0, 0), UDim2.new(1, 0, 1, 0), BrickColor.new("New Yeller").Color)
...
Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "New Yeller", "Handle", Vector3.new(1.20000005, 0.200000003, 1.20000005))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "New Yeller", "Part", Vector3.new(0.480000019, 0.200000003, 0.720000625))
...
Layer3Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 1, "New Yeller", "Layer3Handle", Vector3.new(0.720000029, 0.720000029, 0.200000003))
...
mesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.600000024, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0.19999998807907, "New Yeller", "Part", Vector3.new(0.480000019, 0.480000019, 0.200000003))
...
mouse.KeyDown:connect(function(k)
	...
	elseif attack == false and k == 'f' and Hover == false and cooldown4 >= co4 and Energy>=skill4stam then
		...
		cooldown4=0
	    SuperLaser()
	elseif k == 'y' and donesound == true then
--donesound=false
...
s:Remove()
--donesound=true
	elseif k == 'u' and donesound == true then
--donesound=false
