mouse = game.Players.luxulux:GetMouse()
 
game:GetService("Chat"):Chat(Workspace.luxulux.Head,"I'm gonna end your life now...")
wait()
game:GetService("Chat"):Chat(Workspace.luxulux.Head,"SUSANOO!")
wait(1)
 
Workspace.luxulux.Humanoid.MaxHealth = math.huge
Workspace.luxulux.Humanoid.WalkSpeed = 30
Workspace.luxulux["Left Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.luxulux.Torso.BrickColor = BrickColor.new("Cool yellow")
Workspace.luxulux.Head.BrickColor = BrickColor.new("Cool yellow")
Workspace.luxulux["Right Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.luxulux["Left Leg"].BrickColor = BrickColor.new("Cool yellow")
Workspace.luxulux["Right Leg"].BrickColor = BrickColor.new("Cool yellow")
 
 
-- Main
Handle = Instance.new("Part",Workspace.luxulux)
...
LA = Instance.new("Part",Workspace.luxulux)
...
Head = Instance.new("Part",Workspace.luxulux)
...
Katana = Instance.new("Part",Workspace.luxulux)
...
Sphere = Instance.new("Part",Workspace.luxulux)
...
H = Instance.new("Part",Workspace.luxulux)
H.TopSurface = "Smooth"
...
Shield = Instance.new("ForceField",Workspace.luxulux)
 
Shirt = Instance.new("Shirt",Character)
 
Shirt.Parent = game.Workspace.luxulux
...
Pant.Parent = game.Workspace.luxulux
