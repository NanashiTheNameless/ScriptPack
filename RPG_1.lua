--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 20 and 1610 and put your name where it says "YOUR NAME HERE"
------------------------------------------------------------------------------------------------------
if script == nil then return end


Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("goboombitlk") --Replace my name with yours for the RPG to work.
...
--lego
game.Workspace.ic3w0lf589.Humanoid.MaxHealth = math.huge  -----Replace my name with yours for INF HP
print(lego)