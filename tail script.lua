...
TailDecoration.BrickColor = BrickColor.new("Really red")
...
TailStrype.BrickColor = BrickColor.new("Lime green")
...
--------------------
for i = 2, 12 do
TailParts[i].BrickColor = BrickColor.new("Really red")
end
TailParts[13].BrickColor = BrickColor.new("Lime green")
-----------------------
--Animation Smoothing--
-----------------------
