...
Changelog:
 o 1.0
    o Started changelog.
    o Modified my grenade code to make this.
    o This was the first soda made.
--]]
...
function makeParts(format)
	...
	pm.BrickColor = BrickColor.new("Dark green")
	pm.Reflectance = 0.2
	pm.Locked = true
	pm.TopSurface = 0
	pm.BottomSurface = 0
	...
	d.Texture = "http://www.roblox.com/Asset/?id=34395075"
	d.Parent = pm
