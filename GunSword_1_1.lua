...
Hitbox=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0.20000000298023,1,"Really black","Hitbox",Vector3.new(0.200000003, 4.79999971, 1))
...
attack = true
local con=Hitbox.Touched:connect(function(hit) Damagefunc(hit,20,30,math.random(5,5),"Normal",RootPart,.2,1) end) 
for i = 0,1,0.1 do
swait()
