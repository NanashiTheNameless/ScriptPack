...
local prt1 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part1",Vector3.new(1,1,1))
local prt2 = part(1,modelzorz,0,0,BrickColor.new("Black"),"Part2",Vector3.new(1,1,1))
local prt3 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part3",Vector3.new(1,1,1))
local prt4 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part4",Vector3.new(1,1,1))
local prt5 = part(1,modelzorz,0,0,BrickColor.new("Black"),"Part5",Vector3.new(1,1,1))
local prt6 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part6",Vector3.new(1,1,1))
...
local prt9 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part9",Vector3.new(1,1,1))
local prt10 = part(1,modelzorz,0.5,0,BrickColor.new("Really red"),"Part10",Vector3.new(1,1,1))
local prt11 = part(1,modelzorz,0,0,BrickColor.new("Black"),"Part11",Vector3.new(1,1,1))
local prt12 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part12",Vector3.new(1,1,1))
local prt13 = part(1,modelzorz,0,0,BrickColor.new("Black"),"Part13",Vector3.new(1,1,1))
local prt14 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part14",Vector3.new(1,1,1))
local prt15 = part(1,modelzorz,0,0,BrickColor.new("Black"),"Part15",Vector3.new(1,1,1))
local prt16 = part(1,modelzorz,0,0,BrickColor.new("Really red"),"Part16",Vector3.new(1,1,1))
...
local ppart = part(1,workspace,0,1,BrickColor.new("Really red"),"DerpPart",Vector3.new(1,1,1))
ppart.Anchored=true
