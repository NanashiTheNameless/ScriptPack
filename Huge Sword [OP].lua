...
e.Hit:connect(function(hit) damage2(hit,100000000,100000000,1000000000) end)
c:Remove()
end)
end
...
c.Touched:connect(function(hit) damage2(hit,1000000000,1000000000,1000000000) end)
