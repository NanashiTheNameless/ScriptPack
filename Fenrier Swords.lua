...
r_a1.BrickColor = BrickColor.new("Royal purple")
r_a1.Reflectance = .2
...
l_a1.BrickColor = BrickColor.new("Royal purple")
l_a1.Reflectance = .2
                ...
                Spawn(function()
                        ...
                        local hf = function(d,hit)
                                ...
                                if s and s:IsA("NumberValue") and s.Value > 0 then
                                        ...
                                        local crit = math.random(1,5) == 4
                                        local dmg = math.ceil((math.random(25,50))*(crit and 2 or 1))
