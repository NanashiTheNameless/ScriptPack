--[[local loadscr = Instance.new("ScreenGui",game.Players.LocalPlayer.PlayerGui)
	loadscr:ClearAllChildren()
	loadscr.Name = "Load"
	local loadframe = Instance.new("Frame",loadscr)
	loadframe.Size = UDim2.new(0,750,0,125)
	loadframe.Position = UDim2.new(0.5,-375,1,-900)
	loadframe.BackgroundColor3 = Color3.new(0,0,0)
	loadframe.BorderColor3 = Color3.new(1,1,1)
	loadframe.Visible = true
	loadframe.BorderSizePixel = 5
	local loadtxt = Instance.new("TextLabel",loadframe)
	loadtxt.Size = UDim2.new(1,-210,1,-10)
	loadtxt.Position = UDim2.new(0,200,0,5)
	loadtxt.BackgroundTransparency = 1
	loadtxt.ZIndex = 2
	loadtxt.Font = Enum.Font.SourceSansBold
	loadtxt.FontSize = Enum.FontSize.Size36
	loadtxt.TextColor3 = Color3.new(1,1,1)
	loadtxt.TextXAlignment = Enum.TextXAlignment.Left
	loadtxt.TextYAlignment = Enum.TextYAlignment.Top
	loadtxt.TextWrapped = true
wait(0.2)
loadtxt.Text="Surf.."
wait(2)
loadtxt.Text="I trust you with this script so please do not leak this."
wait(6)
loadtxt.Text="Remember.. this script will get updated more so please wait on edits."
wait(7)
loadtxt.Text="After v1 of the edit is done then you are allowed to edit this."
wait(6)
loadtxt.Text="Enjoy! :3"
wait(3)
loadscr:Destroy()
wait(1)
print":3" ]]
