--MADE BY X9n (NOT THE SCRIPT) LOCAL SCRIPT: YOU DONT GOT TO CHANGE NOTHING! JUST MAKE THIS LOCAL AND RUN IT
...
RestingAnim = false
AbleG = true
Prop = {Damage = 9999999999, Legdmg = 9999999999, AS = 9999999999, ShockDMG = 99999999999999, Rage = 9999999999999, RageIncome = 1, MaxRage = 99999999999999}
Prop.AS = Prop.AS/300
