...
ModelName = "Really red Katana"
if script.Name ~= "PlaySound" then
PlayerName = "epicikr"  ------------------------------------------------------ YOUR epicikr --------
end
...
if script.Parent.className == "HopperBin" then
		script.Parent.Name = "Really red Katana"
		script.Name = "Main"
...
function CreateParts(Parent, Format)
	...
	MasterPart2.BrickColor = BrickColor.new("Really red")
	...
	if Button1Down == false and CanUse == true and CheckPlayer() == true then
		...
		if Key == "y" then
			...
			while KeyYDown == true and Mouse ~= nil and Selected == true do
				...
				Ghost.Name = "Ghost"
				Ghost.BrickColor = BrickColor.new("Really red")
				Ghost.Anchored = true
...
function onSelected(Mouse)
	...
	while true do
		if Player.Character:findFirstChild("Really red Katana (Holstered)") and Player.Character:findFirstChild("Back Katana") then
			Player.Character:findFirstChild("Really red Katana (Holstered)"):remove()
		end
		if CheckPlayer() == true then
