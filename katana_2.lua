...
local prt6=part(3,modelzorz,0.3,0,BrickColor.new("Royal purple"),"Part6",vt(1,2,1))
local prt7=part(3,modelzorz,0.3,0,BrickColor.new("Really red"),"Part7",vt(1,2,1))
local prt8=part(3,modelzorz,0.3,0,BrickColor.new("Royal purple"),"Part8",vt(1,1,1))
local prt9=part(3,modelzorz,0.3,0,BrickColor.new("Really red"),"Part9",vt(1,1,1))
local prt10=part(3,modelzorz,0,0.5,BrickColor.new("Royal purple"),"Part10",vt(1,1,1))
...
derp=-0.4
for i=1,5 do
local prt=part(3,modelzorz,0,0,BrickColor.new("Royal purple "),"Part",vt(1,1,1))
...
con1=prt7.Touched:connect(function(hit) Damagefunc2(hit,30,10) end) 
...
CF = Torso.CFrame 
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc1(hit,10,0.1) end) 
...
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc1(hit,5,10) end) 
so("http://roblox.com/asset/?id=10209640",LeftArm,1,1) 
for i=0,1,0.2 do
wait()
...
MagicCircle(BrickColor.new("Royal purple"),basepart.CFrame,3,3,3,0,0,0,7,7,7)
MagicCircle(BrickColor.new("Royal purple"),basepart.CFrame,5,1,1,0,0,0,9,1,1)
MagicCircle(BrickColor.new("Royal purple"),basepart.CFrame,1,5,1,0,0,0,1,9,1)
MagicCircle(BrickColor.new("Royal purple"),basepart.CFrame,1,1,5,0,0,0,1,1,9)
...
local prt=part(3,workspace,1,0,BrickColor.new("Royal purple"),"Part",vt(1,1,1))
prt.Anchored=true
...
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc1(hit,10,10) end) 
so("http://roblox.com/asset/?id=10209640",LeftArm,1,1) 
for i=0,1,0.2 do
wait(0)
...
local LastPoint = prt7.CFrame * CFrame.new(0,-prt7.Size.Y,0)
con1=prt7.Touched:connect(function(hit) Damagefunc2(hit,15,10) end) 
