...
local spi = pa(c,"","Block",0.6*sc,2*sc,0.6*sc,true,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
...
if istrai then cr(cc(function() Trail(spi,15,0.15,"Bright red",0.35,cf(0,-1,0)) end)) end
...
Anim.a = "Spikes" 
for i=1,18 do 
local spi = pa(Misc[k],"","Block",0,0,0,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
...
for i=1,2 do local spi = pa(Misc[k],"","Block",0,0,0,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
...
for i=1,2 do local spi = pa(Misc[k],"","Block",0,0,0,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike local spiw = weld(spi,ra,spi,-0.2,-i/1.1+(0.7),-0.25,rd(-45),0,rd(-120)) 
...
for i=1,2 do local spi = pa(Misc[k],"","Block",0,0,0,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike local spiw = weld(spi,rl,spi,-0.2,-i/1.1+(0.2),-0.3,0,rd(-50),rd(-70)) 
cr(cc(function() for i=0,1,0.1 do spiw.C0 = spiw.C0 *cf(0,0.14,0) spim.Scale = v3(0.25,i*4,0.25) wait() end Anim.c = true end)) end 
...
local spi = pa(m,"","Block",0.3,6,0.3,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
spim.Scale = v3(0.2,6,0.2)
local spiw = weld(spi,ra,spi,0,-2,2,rd(90),0,0) 
c1(raw,0.16,3,1.5,1,0,0,0,-40) Sound(Sounds.Slash,0.9,1)
DmgHit(spi,5,10,2) 
cr(cc(function() Trail(spi,8,0.04,"Bright red",0.6,cf(0,3,0)) end))
...
local spi = pa(mz,"","Block",1,6,1,true,false,0,0,"Bright red") spi.Anchored = true   local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
...
for xi=-1,1,2 do 
local spi = pa(mz,"","Block",1,10,1,true,false,0,0,"Bright red") spi.Anchored = true   local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
...
local spi = pa(m,"","Block",0.3,6,0.3,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike spim.Scale = v3(0.2,6,0.2) local spiw = weld(spi,ra,spi,0,-2,2,rd(90),0,0) 
local spi1 = pa(m,"","Block",0.3,6,0.3,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi1) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike spim.Scale = v3(0.2,6,0.2) local spi1w = weld(spi1,la,spi1,0,-2,2,rd(90),0,0) 
cr(cc(function() c1(spiw,0.07,0,0,-4,0,170,0,0) end)) cr(cc(function() c1(spi1w,0.07,0,0,-4,0,190,0,0) end)) 
cr(cc(function() c1(law,0.07,3,-1,0.6,0,0,0,85)  end)) c1(raw,0.07,3,1,0.6,0,0,0,-95) wait(0.2) DmgHit(spi,2,5,2) DmgHit(spi1,2,5,2) cr(cc(function() Trail(spi,24,0.05,"Bright red",0.35,cf(0,3,0)) end)) cr(cc(function() Trail(spi1,24,0.05,"Bright red",0.35,cf(0,3,0)) end)) 
local tru = true local wnd = pa(m,"","Block",14,0,14,false,false,0.3,0,"Bright red") wnd.Anchored = true  it("CylinderMesh",wnd).Scale = v3(1,0.1,1) cr(cc(function() repeat wait() wnd.CFrame = t.CFrame *cf(0,0.5,0) *ca(rd(rn(-8,8)),0,rd(rn(-8,8))) if rn(1,4) == 2 then Sound(asset .. Sounds.Spin,1.25,1) end until  not tru fade(wnd,0.08) end))  c1(tw,0.02,3,0,0,0,0,-360*5,0) tru = false tw.C1 = ca(0,0,0)
...
local spi = pa(m,"","Block",0.3,10,0.3,true,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike spim.Scale = v3(0.8,10,0.8) local spiw = weld(spi,to,spi,-0.65,-3,0,rd(-80),0,0) 
local spi1 = pa(m,"","Block",0.3,10,0.3,true,false,0,0,"Bright red")  local spi1m = it("SpecialMesh",spi1) spi1m.MeshType = "FileMesh" spi1m.MeshId = asset .. Decs.Spike spi1m.Scale = v3(0.8,10,0.8) local spi1w = weld(spi1,to,spi1,0.65,-3,0,rd(-80),0,0) 
...
c1(tw,0.07,3,0,0,0,15,90,0) Trail2(spi,0.15,"Bright red",1.8,cf(0.6,-5,0))
...
local spi = pa(workspace,"","Block",3,20,3,true,false,0,0,"Bright red")  spi.Anchored = true local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike spim.Scale = v3(2,29,2) 
...
for i=1,30 do 
local spi = pa(m,"","Block",0,0,0,false,false,0,0,"Bright red")  local spim = it("SpecialMesh",spi) spim.MeshType = "FileMesh" spim.MeshId = asset .. Decs.Spike
spim.Scale = v3(0,0,0)
...
re(bp,"ProCacDef")
bin = it("HopperBin",bp) bin.Name = "ProCacDef"
