--mediafire I fixed some problems caused by the updates.
adminlist = {"jjphariss","DeadlyShroom","almightyzombie","jojimbo20"} --Add in the names of the people you want to be able to use the command script here.
...
if decal.Texture = http://www.roblox.com/asset/?id=87292743 then
local tfv = ack.Chatted:connect(function(msg) oc(msg,ack) end)
table.insert(namelist,ack.Name)
table.insert(variablelist,tfv)
local tfv = ack.Chatted:connect(function(msg) foc(msg,ack) end)
