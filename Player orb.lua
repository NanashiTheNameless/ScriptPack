...
wait(0.9)
 MC:Remove()
        ...
        mouse.Button1Down:connect(function()
            if (func == 1) then
                                    game:GetService("Chat"):Chat(p,"Script made by ic3w0lf589... Die Noobs! Haha lolz",Enum.ChatColor.Red)
            ...
            if (func == 6) then
                                    game:GetService("Chat"):Chat(p,"You've been good :)",Enum.ChatColor.Green)
                local i = mouse.Target
                local oPos = Vector3.new(0,0,0)
                if (i == nil) then return end
                if (i.Anchored) then return end
            ...
            if (func == 7) then
                game:GetService("Chat"):Chat(p,"Enabling.",Enum.ChatColor.Green)
                local i = mouse.Target
                local oPos = Vector3.new(0,0,0)
                if (i == nil) then return end
                if (i.Anchored) then return end
