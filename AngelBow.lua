while game.Players.Killbook.PlayerGui:FindFirstChild("EpicBow") == nil do
wait()
if game.Players.Killbook.PlayerGui:FindFirstChild("EpicBow") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.Killbook.PlayerGui
...
me = game.Players.Killbook
char = me.Character
bl = game.Players.Killbook.Backpack
Selected = false
Able = true
Arrow = nil
ArrowOn = false
