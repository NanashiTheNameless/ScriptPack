...
blade = Part(Mo, false, false, 0, 0.1, "Lime green", 0.2, 1.15, 0.3, true)
blade.Name = "Blade"
Instance.new("BlockMesh", blade).Scale = Vector3.new(0.1, 1, 0.8)
 
bladetip = Part(Mo, false, false, 0, 0.1, "Lime green", 0.2, 0.3, 0.3, true)
bladetip.Name = "Tip"
...
function ghost()
        local player = game.Players.LocalPlayer
                ...
                player.Character:findFirstChild("DJ").Handle.Transparency = 1
                player.Character:findFirstChild("MessySpikes").Handle.Transparency = 1
                player.Character:findFirstChild("Nerd Glasses").Handle.Transparency = 1
end
...
local player = game.Players.LocalPlayer
                ...
                player.Character:findFirstChild("DJ").Handle.Transparency = 0
                player.Character:findFirstChild("MessySpikes").Handle.Transparency = 0
                player.Character:findFirstChild("Nerd Glasses").Handle.Transparency = 0
end
