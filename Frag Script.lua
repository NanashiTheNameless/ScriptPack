--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 10 and put your name where it says "YOUR NAME HERE"
--[[
M67 Fragmentation Grenade. Pull the pin / Drop it in / Let it wash away their sins.
--]]
...
Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("YOUR NAME HERE")
Name = "M67 Frag"
selected = false
Button1Down = false
thrown = false
...
function makeParts(format)
	...
	pm.BrickColor = BrickColor.new("Camo")
	pm.Locked = true
	pm.TopSurface = 0
	pm.BottomSurface = 0
	pm.Parent = grenade
	...
	m.MeshType = "Sphere"
	m.Scale = Vector3.new(0.6, 0.7, 0.6)
	m.Parent = pm
	...
	m.Scale = Vector3.new(0.22, 0.2, 0.22)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	m.Scale = Vector3.new(0.45, 0.5, 0.8)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0.12, -0.18, 0)
	w.C1 = CFrame.new()
	w.Parent = p		
	...
	w.Part0 = pm2
	w.Part1 = pm
	w.C0 = CFrame.new(0.15, -0.6, 0) * CFrame.fromEulerAnglesXYZ(0, math.rad(90), 0)
	w.C1 = CFrame.new()
	w.Parent = pm2
end
...
function onButton1Down(mouse)
	...
	if Player.Character:FindFirstChild(Name) ~= nil and Button1Down ~= true and thrown ~= true then
		...
		wait(0.2)
		Player.Character[Name].Handle.Ready:Play()		
