...
Breeds = {
    ...
    { 
        ...
        saddle=BrickColor.new("Institutional White"),
        reins=BrickColor.new("Dark Green"),
...
local HasHat = true
local HatMeshId = "http://www.roblox.com/asset/?id=13640868"
local HatTexId = ""
...
local startpos = workspace.ralf2234.Head.CFrame * CFrame.new(0,Height+1.5,10)--script.Parent:IsA("BasePart") and script.Parent.CFrame * CFrame.new(0,Height,0) or CFrame.new(0,Height+1,20)
