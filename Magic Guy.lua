...
function DoAll()
        ...
        function MakeObjects(Position, ...)
                ...
                if P1 == nil and P2 == nil then
                        ...
                        BG.Name = "BG"
                        local partic = Instance.new("ParticleEmitter",P1)
                        partic.Color = ColorSequence.new(Color3.new(20/225,0,100/255),Color3.new(20/255,0,205/100))
                        partic.LightEmission = .95
                        partic.VelocityInheritance = 0
                        partic.Rate = 60
                        partic.Texture = "rbxassetid://56561915"
                        partic.Lifetime = NumberRange.new(0.1,0.1)
                        partic.RotSpeed = NumberRange.new(100,100)
                        partic.Speed = NumberRange.new(2,3)
                        partic.Enabled = true
                        partic.LockedToPart = true
                        P2 = P1:Clone()
                        P2.Parent = Char
                                ...
                                elseif Position == "Cannon" then
                                        if Mouse.Target ~= nil then
                                                ...
                                                for i = 1,8 do
                                                        ...
                                                        Bomb.BrickColor = BrickColor.new("Dark indigo")
                                                        wait(0.1)
                                ...
                                elseif Position == "Nuke" then
                                        if Mouse.Target ~= nil then
                                                ...
                                                function NukeIt(Pos, Size, GoTo)
                                                        ...
                                                        Nuke.BrickColor = BrickColor.new("Lime ")
                                                        Nuke.Shape = "Ball"
                                                        ...
                                                        if GoTo == true then
                                                                ...
                                                                for i = 1,7 do
                                                                        ...
                                                                        Sound2.Pitch = 2.3
                                                                        Sound2.SoundId = "http://www.roblox.com/asset/?id=15666462"
                                                                        Nuke.BrickColor = BrickColor.new("Dark indigo")
                                                                        wait(0.15)
                                                                        Nuke.BrickColor = BrickColor.new("Lime ")
                                                                        wait(0.15)
                                                                        Sound2:Play()
