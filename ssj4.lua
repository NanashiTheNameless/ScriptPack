...
Hair22.BrickColor = BrickColor.Black()
...
Hair4.BrickColor = BrickColor.Black()
...
Hair45.BrickColor = BrickColor.Black()
...
Weld.Part0 = jun.Character.Head
Weld.Part1 = Hair45
Weld.C0 = CFrame.new(0, -1, 0.35)*CFrame.fromEulerAnglesXYZ(3, 0, 0) 
Mesh = Instance.new("SpecialMesh")
Mesh.Parent = Hair45
Mesh.Scale = Vector3.new(1.15, 2.5, 1.26)
Mesh.MeshType = "FileMesh"
Mesh.MeshId = "http://www.roblox.com/asset/?id=12212520"
Mesh.TextureId = ""
...
Hair232.BrickColor = BrickColor.Black()
Weld = Instance.new("Weld") 
Weld.Part0 = jun.Character.Head 
Weld.Part1 = Hair232
Weld.Parent = jun.Character.Head 
...
Mesh.Scale = Vector3.new(1.3, 1.3, 1.3)
     ...
     Effect.BrickColor = BrickColor.Red()
     ...
     EffectMesh.Scale = Vector3.new(2, 1500, 2)
...
jun.Character.Humanoid.MaxHealth = jun.Character.Humanoid.MaxHealth*1.8
wait(0.3)
jun.Character.Humanoid.Health = jun.Character.Humanoid.Health*1.8
end
end
function nossj()
if Stuff == true then
...
jun.Chatted:connect(function(Msg)
 msg = Msg:lower()
 if string.sub(msg, 1, 7) == "super saiyan 4" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 13) == "ssj4" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 10) == "off4" then
 wait(0.1)
  nossj()
 end
 if string.sub(msg, 1, 3) == "off4" then
 wait(0.1)
  nossj()
 end
end)
