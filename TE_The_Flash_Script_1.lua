...
TOS(By trig):
Do not Leak 
Do not trade or sell
Do not add to your personal archive
If showing off tell who made it
Do not use on script builder at all
Do not use in script builder EVER
Ask if Joining Trig to use before using! [IMPORTANT]
Do not tell Flirty Teemie that you have this!
--]]
wait()
