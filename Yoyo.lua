...
numb2=0
for i=1,16 do
local prt3=part(3,modelzorz,0.5,0,BrickColor.new("Really black"),"Part3",vt(1,1,1))
...
Damage=Damage+math.random(50,60)
-- h:TakeDamage(Damage)
...
print("Yoyo loaded.")
--[[
Copyright (c) Fenrier. Any use of this script is breaking the copyright.
]] 