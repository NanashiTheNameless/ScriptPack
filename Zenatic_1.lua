...
CREDITS:
 ...
 - Citrus for the Modified Cape
 - PixelFir3 for his Gauntlet
 - Spectroxis for the sword build 
 - Savagemunkey's Legacy rings
 - Tyrantv for his GUI (I removed the gui for now)
...
Version 2 - 9/3/16
 ...
 - Added Variables
 - Cleaned up Script
 - added cape, hood, and the suit (all toggleable)
 - made the script use less fps because all the welds crash sometimes
 - removed armor
 - removed blood
 - anims should be good now
 - removed intro
 - no more errors as all variables should be set correctly now
 - P.S fuck you Lapis
...
Version 1 - 7/24/16
 ...
 - Added blood
 - Added sound
 - Tried (?) to add walking sounds

]]

print'Zenatic Loaded.'

--Variables
Gui = true -- change true to false for no gui
Cape = true --change true to false for no cape
Hood = true --change true to false for no hood
PrimaryColor = 'Really black' --Choose the color of the rings under you
SecondaryColor = 'Institutional white' --Choose the color of the rings under you
Suit = true --If you want the suit or not
...
HName.Text = "Zenatic, master of minds"
...
m.TextureId = 'http://www.roblox.com/asset/?id=85855750'
