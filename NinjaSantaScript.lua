--DarkKnight Gifted by Rosemarijohn2, Local Script!																									
me = game:GetService("Players").SergeantSmokey VC = Vector3.new CF = CFrame.new hop = Instance.new("HopperBin",me.Backpack) hop.Name = "Knight" 
...
function armor()
local hat = Instance.new("Hat",me.Character) hat.Name = "Knight Helm" hat.AttachmentPos = VC(0,0,0)
...
local msh = Instance.new("SpecialMesh",han) msh.MeshType = "FileMesh" msh.MeshId = "http://www.roblox.com/asset/?id=100456022" msh.Scale = VC(3,3,3) msh.VertexColor = VC(0,0,0)
msh.TextureId = "http://www.roblox.com/asset/?id=37516014"
local charm = Instance.new("CharacterMesh",me.Character) charm.BodyPart = "Torso" charm.MeshId = 100455410 charm.OverlayTextureId = 37516014
local charm = Instance.new("CharacterMesh",me.Character) charm.BodyPart = "RightLeg" charm.MeshId = 100455667 charm.OverlayTextureId = 37516014
local charm = Instance.new("CharacterMesh",me.Character) charm.BodyPart = "LeftLeg" charm.MeshId = 100455608 charm.OverlayTextureId = 37516014
local charm = Instance.new("CharacterMesh",me.Character) charm.BodyPart = "RightArm" charm.MeshId = 100459051 charm.OverlayTextureId = 37516014
local charm = Instance.new("CharacterMesh",me.Character) charm.BodyPart = "LeftArm" charm.MeshId = 100455486 charm.OverlayTextureId = 37516014
...
swordweld.C0 = CFrame.new(.3,.6,.6)*CFrame.Angles(math.pi/2,math.rad(-35),0) mesh2sword = Instance.new("SpecialMesh",sword) mesh2sword.MeshType = "FileMesh" mesh2sword.MeshId = "http://www.roblox.com/asset/?id=49754655" mesh2sword.TextureId = "http://www.roblox.com/asset/?id=37516014" mesh2sword.Scale = VC(3,2,3)
...
swordweld2.C0 = CFrame.new(-.3,.6,.6)*CFrame.Angles(math.pi/2,math.rad(35),0) mesh2sword2 = Instance.new("SpecialMesh",sword2) mesh2sword2.MeshType = "FileMesh" mesh2sword2.MeshId = "http://www.roblox.com/asset/?id=49754655" mesh2sword2.TextureId = "http://www.roblox.com/asset/?id=37516014" mesh2sword2.Scale = VC(3,2,3)
...
shieldweld.C0 = CFrame.new(0,0,.8)*CFrame.Angles(math.pi/2,0,math.pi/1)  shieldmesh2 = Instance.new("SpecialMesh",shield) shieldmesh2.MeshType = "FileMesh" shieldmesh2.MeshId = "http://www.roblox.com/asset/?id=49757732" shieldmesh2.TextureId = "http://www.roblox.com/asset/?id=37516014" shieldmesh2.Scale = VC(1.2,1.1,1.2)
end 
...
local HIKE = Instance.new("Part",Model) HIKE.Size = Vector3.new(1,1,1) HIKE.Shape = "Ball" HIKE.CFrame = CFrame.new(arms[1].CFrame.x,arms[1].CFrame.y,arms[1].CFrame.z) HIKE.CanCollide = true HIKE.Reflectance = 1
local wld = Instance.new("Weld",arms[2]) wld.Part0 = wld.Parent wld.Part1 = HIKE wld.C0 = CFrame.new(-.1,-1.1,-.1) wait(.2) local f = Instance.new("Fire",HIKE) f.Color = BrickColor.new("Really black").Color f.SecondaryColor = BrickColor.new("Really black").Color f.Size = 3 f.Heat = 15 for i = 1,5 do f:clone().Parent = HIKE end
...
for i = 0,2,.1 do shieldweld.C0 = CFrame.new(0-i-.3,5-i-i,.8-i)*CFrame.Angles(math.pi/2,0,math.rad(270)) wait() end HIKE:Destroy() shieldweld.Part0 = nil shieldweld.Part0 = arms[2] shieldweld.C0 = CFrame.new(-.5,0,0)*CFrame.Angles(0,0,math.pi/-2)
...
armsMD[1].Part1 = nil holdarmright2.Part1 = arms[1] armsMD[2].Part1 = nil holdarmleft2.Part1 = arms[2] damageallowed = false me.Character.Humanoid.WalkSpeed = 50
end
end 
