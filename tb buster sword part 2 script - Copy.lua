...
--move = hold key ad cilckmouse
--[[By TigerBlodd]]
loadstring(_G[" bust"..'er '])()
...
function ClearClass(Object,Class) for _,v in pairs(Object:GetChildren()) do if v:IsA(Class) then v:Destroy() end end end ti=table.insert tr=table.remove ec={"Bright blue","Really blue","Really black"}
...
c["Right Leg"].BrickColor=BrickColor.new(legcol)
c["Left Leg"].BrickColor=BrickColor.new(legcol)
c.Head.BrickColor=BrickColor.new(lcol)
c.Torso.BrickColor=BrickColor.new(lcol)
--[[bg22 = Instance.new("BillboardGui", he)
bg22.Adornee = bg22.Parent
bg22.Size = UDim2.new(1, 0, 2, 0)
bg22.SizeOffset = Vector2.new(0, 2)
bg22.AlwaysOnTop = true
fru = Instance.new("Frame", bg22)
fru.Size = UDim2.new(1, 0, 1, 0)
fru.BackgroundTransparency = 1
pns = Instance.new("TextLabel", fru)
pns.BackgroundTransparency = 1
pns.Position = UDim2.new(0, 0, 0.5, 0)
pns.Size = UDim2.new(1, 0, 0.5, 0)
pns.TextColor3 = Color3.new(0, 0, 0)
pns.TextStrokeColor3 = Color3.new(1, 1, 1)
pns.TextStrokeTransparency = 0
pns.FontSize = Enum.FontSize.Size12
pns.Text="Buster By TigerBloodd"]]--
...
sig=pa(m,"Eff","Block",0.01,1,0.25,false,false,0,0,scol) weld(sig,ra,sig,0.5,-1,-0,0,0,0) qi({"BlockMesh",sig,Scale=v3(0.25,1,1)})
...
ef1.Size=10
ef1.Color=Color3.new(255, 128, 0)
ef1.SecondaryColor=Color3.new(255, 0, 0)
local prom = qi({"SpecialMesh",pro,Scale=v3(2*sc,2*sc,2*sc),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=83661651",TextureId="http://www.roblox.com/asset/?id=83662236"}) 
...
CreateBuster=function(lolpart,x,y,z,a,b,c) col1="Medium grey" col2="Dark stone grey" col3="Really black" col4="Really black"
...
for i=1,20 do SpawnSword(FindGround(to.CFrame*cn(0,-2.75,-0.5+(-i*4)-i)),1+(i/10),15,"Really black",20,35) wait(0.07) end
...
w(0.05) end end)
SplashDmg(false,to.Position,rn(100,250),125,50)
wait(5) 
...
Trail2(9,xBlade,0.05,"Really black",0.1,cf(0,-2,-0.5)) rayHit(1,2,xBlade,ca(0,0,0),5,25,40)
BusterPose(0.08) a.c=true a.b="None"
...
if antidmg%5==0 then GlowMesh(false,"sphere",t,v3(1.5,1.5,1.5),"Really black",la.CFrame*cn(0,-3,0),0.3,1,0.1) end
GlowMesh(false,"block",t,v3(10,10,10),"Really black",mouse.Hit*ca(rn(-360,360),rn(-360,360),rn(-360,360)),0.3,1,0.05)
if (to.Position - mouse.Hit.p).magnitude < 2500 then Lightning(la.Position,mouse.Hit.p,5,1,"Really black",0.3,0) if antidmg%5==0 then SplashDmg(false,mouse.Hit.p,rn(25,35),7.5,50) end end
until ky=="g" or mp<=10
...
repeat w() if tb.userId then mp=mp-0 else mp=mp-5 end
q(function() Trail2(1,b5,0.03,"Dark stone grey",0.1,cf(-0.25,0.75,0)) end) 
q(function() Trail2(1,b7,0.03,"Dark stone grey",0.1,cf(0.25,0.75,0)) end)
...
elseif mp>=50 and fkey and a.a=="Buster" and a.b=="Hoverboard" and Button then if tb.userId then mp=mp-0 else mp=mp-50 end gunshot(10,3,rn(10,20),ca1.CFrame*ca(0,0,rd(180)))
...
hu.Jump=true 
GlowMesh(false,asset .. "20329976",t,v3(5,2,5),"Really black",FindGround(t.CFrame)*cn(0,1,0),0,1,0.1)
GlowMesh(false,asset .. "3270017",t,v3(10,10,4),"Really black",FindGround(t.CFrame)*ca(rd(90),0,0),0,1,0.08)
c2(raw,0.14,3,1,0.5,-0.25,-90,-35,0) c2(law,0.14,3,-1,0.5,-0.25,-90,35,0) c1(hw,0.14,3,0,1.5,0,10,0,0)
local hdp=pa(xmod,"","Block",1,1,1,false,false,0,0,"Really black") weld(hdp,xBlade,hdp,0,0,0,0,0,0) hdpm=qi({"SpecialMesh",hdp,MeshType="Sphere",Scale=v3(1,4.5,2)}) 
for i=0,1,0.08 do hdpm.Scale=v3(i*1,i*5,i*2) hdp.Transparency=i w() end de(hdp,0) for i,v in pairs(xmod:GetChildren()) do if v.Name=="e" then v.BrickColor=bc("Really black") end end
