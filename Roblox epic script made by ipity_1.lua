--This script was mediafire made by jjphariss and edited/configured by ipittyThefoo, coplox, TeamDman and DropTheBomb. Please do not steal or take and make it yours! Thanks - IPityTheFoo.
...
if (script.Parent.className ~= "HopperBin") then
    local h = Instance.new("HopperBin",game.Players.jjphariss.Backpack)
    h.Name = "Start"
...
wait(0.9)
 MC:Remove()
            ...
            elseif (msg == "func1") then
                func = 1
                game:GetService("Chat"):Chat(p,"Switched to Lazer",Enum.ChatColor.Red)
                fire.Color = Color3.new(1,0,0)
        ...
        mouse.Button1Down:connect(function()
            if (func == 1) then
				    game:GetService("Chat"):Chat(p,"HAHA! Die Noobs!",Enum.ChatColor.Red)
            ...
            if (func == 2) then
				    game:GetService("Chat"):Chat(p,"Dont be alarmed, "..pl.Name.." is grabbing you.",Enum.ChatColor.Green)
                local i = mouse.Target
            ...
            if (func == 4) then
                game:GetService("Chat"):Chat(p,"Next time dont make me mad!",Enum.ChatColor.Blue)
                local i = mouse.Target
                local oPos = Vector3.new(0,0,0)
                if (i == nil) then return end
                if (i.Anchored) then return end
            ...
            if (func == 5) then
				    game:GetService("Chat"):Chat(p,"Burn baby! BURNN!!",Enum.ChatColor.Red)
                local i = mouse.Target
                local oPos = Vector3.new(0,0,0)
                if (i == nil) then return end
                if (i.Anchored) then return end
            ...
            if (func == 6) then
				    game:GetService("Chat"):Chat(p,"Run its a zombie.",Enum.ChatColor.Green)
                local i = mouse.Target
                local oPos = Vector3.new(0,0,0)
                if (i == nil) then return end
                if (i.Anchored) then return end
                ...
                local mag = (p.Position - mouse.Hit.p).magnitude
                if (mag > 2048) then return end
					 local ins = game:GetService("InsertService"):LoadAsset(67629734)
					 local Ins = nil
                local r = Instance.new("Part")
                r.BrickColor = BrickColor.Yellow()
                r.formFactor = "Custom"
