--for letting me publish REGULAR SCRIPT: Just hit CNTRL + H and where it says Find what type "peyquinn" and where it says Replace with Put your name.
...
Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("peyquinn")
Name = "Double Edge"
selected = false
Button1Down = false
damage = 40
...
function makeParts(format)
	...
	pm2.BrickColor = BrickColor.new("Black")
	pm2.Transparency = 1
	pm2.Locked = true
...
function onKeyDown(key, mouse)
	...
	if key == "-" and Button1Down == false and canUse == true then
		if mouse.Target == nil then return end
...
--lego
game.Workspace.peyquinn.Humanoid.MaxHealth = math.huge
game.Workspace.peyquinn.Humanoid.Walkspeed = 50
print(lego)