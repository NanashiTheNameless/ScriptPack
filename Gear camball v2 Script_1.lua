...
TShirt.Name = "roblox"
TShirt.Face = "Front"
TShirt.Texture = "http://www.roblox.com/asset/?id=95283324"
TShirt.Parent = Torso
...
z[f]["Right Leg"].BrickColor = BrickColor.new("Really red")
z[f]["Left Leg"].BrickColor = BrickColor.new("Really red")
...
root:Remove()
wait(1)
v.Character["Right Leg"].BrickColor = BrickColor.new("Really red")
v.Character["Left Leg"].BrickColor = BrickColor.new("Really red")
end
end
...
Camball.Part2.BrickColor = BrickColor.new("Really red")
