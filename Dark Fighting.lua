local box = "Hi "..game.Players.LocalPlayer.Name..". [Injecting Memes...]"
game:service'Chat':Chat(game.Players.LocalPlayer.Character.Head,box,Enum.ChatColor.Blue)
wait(1)
local box1 = "(Modded by IoIman616)"
game:service'Chat':Chat(game.Players.LocalPlayer.Character.Head,box1,Enum.ChatColor.Red)
game.Lighting.Ambient = Color3.new(0.3,0.1,0.1)
local time_=tonumber(1)
game.Lighting:SetMinutesAfterMidnight(time_*60)

local PCHAR = game.Players.LocalPlayer.Character
if PCHAR:FindFirstChild('Humanoid') then PCHAR.Humanoid.JumpPower = 100 end


local s = Instance.new("Sound")


s.Name = "u got sp00ked"
...
s.Parent = game.Players.LocalPlayer.Character.Head
...
l.Name = "sp000ky o3o"
l.Color = Color3.new(10,0.1,0.1)
l.Brightness = 30


l.Parent = game.Players.LocalPlayer.Character.Torso
...
Finger1Connector=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,1,"Really red","Finger1Connector",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Finger2Connector=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,1,"Really red","Finger2Connector",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Finger3Connector=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,1,"Really red","Finger3Connector",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Finger4Connector=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,1,"Really red","Finger4Connector",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Finger5Connector=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,1,"Really red","Finger5Connector",Vector3.new(0.200000003, 0.200000003, 0.200000003))
...
Finger1=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,0,"Really red","Finger1",Vector3.new(0.200000003, 0.400000006, 0.200000003))
...
Finger2=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,0,"Really red","Finger2",Vector3.new(0.200000003, 0.600000024, 0.200000003))
...
Finger3=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,0,"Really red","Finger3",Vector3.new(0.200000003, 0.600000024, 0.200000003))
...
Finger4=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,0,"Really red","Finger4",Vector3.new(0.200000003, 0.600000024, 0.200000003))
...
Finger5=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0.5,0,"Really red","Finger5",Vector3.new(0.200000003, 0.600000024, 0.200000003))
...
function attackone()
attack = true
local con = Hitbox.Touched:connect(function(hit) Damagefunc(Hitbox,hit,999,999,math.random(999,999),"Normal",RootPart,.2,1) end) 
for i = 0,1,0.1 do
swait()
...
function GrabNSlam()
attack = true
so("http://roblox.com/asset/?id=444667824",Hitbox,1,.9)
if Grab == false then
gp = nil
...
MagniDamage(ref,ref,0,0,0,math.random(0,0),"Knockdown")
