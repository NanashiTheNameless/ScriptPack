...
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,15,20,math.random(5,10),"Normal",RootPart,.5,1) end) 
...
hitbox.Transparency=1
hitbox.CFrame=prt26.CFrame
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,15,20,math.random(10,20),"Normal",RootPart,.5,1) end) 
...
hitbox.Transparency=1
hitbox.CFrame=prt26.CFrame
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,15,25,math.random(10,20),"Normal",RootPart,.5,1) end) 
...
so("http://roblox.com/asset/?id=2101137",LeftArm,1,.8) 
local num=0
while holdz==true do
swait()
...
orbnum=orbnum-1
so("http://roblox.com/asset/?id=2248511",prt20,1,.8) 
...
table.remove(ActiveOrbs,num)
orbnum=orbnum-1
so("http://roblox.com/asset/?id=2248511",prt20,.6,1.4) 
...
so("http://roblox.com/asset/?id=2248511",prt20,1,1.4)
MagicBlock(InverseCol,prt15.CFrame,1,1,1,1.5,1.5,1.5,.02,1)
MagicCircle(InverseCol,prt15.CFrame,1,1,1,8,8,8,.1)
upvel.Parent=Torso
