--[[
Earth Mage
Use the powers of the planet to take over your opponents.
--]]
...
function onButton1Down(Mouse)
	...
	if CanUse == true then
		...
		while (Button1Down == true or First == true) and Selected == true and CheckPlayer() == true do
			...
			pcall(function()
				Arm = not Arm
				SoundToServer("Fire", "http://www.roblox.com/Asset/?id=10209897", 2, 1, false, Player.Character.Torso)
				Mana = Mana - 1
				local Bullet = Instance.new("Part", Workspace)
				Bullet.Name = "Bullet"
				Bullet.TopSurface = 0
				Bullet.BottomSurface = 0
				Bullet.BrickColor = BrickColor.new("Pastel brown")
				...
				BodyVelocity.velocity = ((Mouse.Hit.p - Player.Character[(Arm == true and "Right" or "Left").. " Arm"].Position).unit * 200) + Vector3.new(math.random(-400, 400) / 1000, math.random(-400, 400) / 1000, math.random(-400, 400) / 1000)
