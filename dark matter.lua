script.Parent = workspace.yfc --put ur name here 
...
local dbr=it("Model",workspace) local colz2="Bright red" if ts(dmge)=="Block!" then colz2="Bright black" end
...
local bal = pa(c,"","Ball",4*sc,4*sc,4*sc,false,true,0.16,0,"Really black") bal.CFrame = pos
local spi = pa(c,"","Ball",0,0,0,false,true,0.16,0,"Really black") spi.CFrame = bal.CFrame local spm = qi({"SpecialMesh",spi,MeshType="FileMesh",MeshId=asset .. Decs.SpikeBall})
local dia = pa(bal,"","Block",0,0,0,false,true,0.3,0,"Really black") qi({"SpecialMesh",dia,Scale=v3(1*sc,2*sc,1*sc),MeshType="FileMesh",MeshId=asset .. Decs.Diamond})
...
local cor = db1:Clone() cor.Mesh.Scale=v3(sc,sc,sc)*5 local cor2 = db2:Clone() cor2.Mesh.Scale = cor.Mesh.Scale*1.55 qi({"Fire",cor,Color=bc('Really black').Color,SecondaryColor=bc('Really black').Color,Size=sc*3.5,Heat=0})
...
local lolpos = FindGround(cor.CFrame) if lolpos and i%rn(2,3)==0 then GlowMesh(false,asset .. Decs.Crown,t,v3(2.6*sc,0.8*sc,2.6*sc),'Really black',cn(lolpos.p+v3(0,0.15*sc,0)),0.1,1,0.05) end
wait() end cor.Fire:Remove()
q(function() 
local n1 = pa(su,"","Block",0,0,0,true,true,0.3,0,"Really black") qi({"SpecialMesh",n1,Scale=v3(3.5,3.5,8),MeshType="FileMesh",MeshId=asset .. Decs.Chakram})
...
local rip = pa(su,"","Block",1,1,1,false,true,0.2,0,"Really black") ripm = qi({"SpecialMesh",rip,MeshType="Sphere"})
...
local fis = pa(su,"","Block",0,0,0,false,true,0.2,0,"Really black") fism = qi({"SpecialMesh",fis,Scale=v3(8*sc,8*sc,8*sc),MeshType="FileMesh",MeshId=asset .. Decs.Fist})
for i=0.5,5.5,1 do fism.Scale = v3(8*sc,((8*sc)/5.5)*i,8*sc) fis.CFrame = pos*cn(0,0,-i*sc)*ca(rd(-90),rd(-90),0) wait() end 
fism.Scale = fism.Scale+v3(1*sc,1*sc,1*sc) fis.CFrame = pos*cn(0,5*sc,-5*sc)*ca(rd(45),0,0)*ca(rd(-90),rd(-90),0) rip.CFrame=pos*ca(rd(45),0,0) qi({"Fire",fis,Heat=-25,Size=15,Color=bc('Really black').Color,SecondaryColor=bc('Really black').Color})
local arm = pa(su,"","Block",1,1,1,false,true,0.2,0,"Really black") armm = it('CylinderMesh',arm)
...
local worm0 = pa(mm,"","Block",0,60,0,true,true,tr,0,"Really black") qi({"SpecialMesh",worm0,Scale=v3(9*sca,12*sca,9*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=12137531"})
local worm1 = pa(mm,"","Block",10*sca,6*sca,10*sca,true,true,tr,0,"Really black") it('CylinderMesh',worm1)
local worm2 = pa(mm,"","Block",9.5*sca,6*sca,9.5*sca,true,true,tr,0,"Really black") it('CylinderMesh',worm2)
local worm3 = pa(mm,"","Block",9*sca,6*sca,9*sca,true,true,tr,0,"Really black") it('CylinderMesh',worm3)
local worm4 = pa(mm,"","Block",8.5*sca,6*sca,8.5*sca,true,true,tr,0,"Really black") it('CylinderMesh',worm4)
local worm5 = pa(mm,"","Block",8*sca,6*sca,8*sca,true,true,tr,0,"Really black") it('CylinderMesh',worm5)
local worm6 = pa(mm,"","Block",7.2*sca,6*sca,7.2*sca,true,true,tr,0,"Really black") qi({"SpecialMesh",worm6,Scale=v3(4*sca,18.5*sca,4*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=1033714"})
...
local tor = pa(su,"","Block",0,0,0,true,true,1,0,"Really black") qi({"SpecialMesh",tor,Scale=v3(6.4*sc,8*sc,6.5*sc),MeshType="FileMesh",MeshId=asset .. Decs.Tornado})
...
wait(tyms) tpos = tor.Position local torm = tor.Mesh.Scale tor:Remove() GlowMesh(false,asset .. Decs.Tornado,t,torm*3,'Really black',cn(tpos),0.2,1,0.05) 
end) end
...
---- TUT01LOL
han = pa(su,"","Block",0.4,0.4,0.4,false,false,0,0,"Really black") it('CylinderMesh',han)
...
han3 = pa(su,"","Block",0,0,0,false,false,0,0,"Really black") qi({"SpecialMesh",han3,MeshType="Sphere",Scale=v3(0.4,0.4,0.4)*5})
...
for i=1,7 do 
des = pa(su,"","Block",0.4,0.2,0.4,false,false,0,0,"Really black") it('CylinderMesh',des).Scale = v3(1,0.4,1)
...
han8 = pa(su,"","Block",0,0,0,false,false,0.3,0.1,"Really black") qi({"SpecialMesh",han8,MeshType="Sphere",Scale=v3(0.7,0.7,0.7)*5})
han8w = qi({"Weld",han2,Part0=han2,Part1=han8,C0=cn(0,2.9,0)*ca(0,0,0)})
han9 = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",han9,Scale=v3(0.25,1,0.25),MeshType="FileMesh",MeshId = asset .. Decs.Chakram3})
...
for i=0,2 do 
des = pa(su,"","Block",0,0,0,false,false,0,0.05,"Really black") qi({"SpecialMesh",des,MeshType="FileMesh",Scale=v3(0.2,1,0.2),MeshId=asset .. Decs.Diamond})
...
clawa1 = pa(su,"","Block",0,0,0,false,false,0,0,"Really black") qi({"SpecialMesh",clawa1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawa1w = qi({"Weld",han2,Part0=laa,Part1=clawa1,C0=ca(rd(180),0,0)*cn(-0.2,1.25,0)})
clawa2 = pa(su,"","Block",0,0,0,false,false,0,0,"Really black") qi({"SpecialMesh",clawa2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawa2w = qi({"Weld",han2,Part0=laa,Part1=clawa2,C0=ca(rd(180),0,0)*cn(0.2,1.25,0)})
clawb1 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Really black") qi({"SpecialMesh",clawb1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawb1w = qi({"Weld",han2,Part0=clawa1,Part1=clawb1,C0=cn(0,0.15,0)})
clawb2 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Really black") qi({"SpecialMesh",clawb2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=asset .. Decs.Spike})
clawb2w = qi({"Weld",han2,Part0=clawa2,Part1=clawb2,C0=cn(0,0.15,0)})

badge = pa(su,"","Block",0,0,0,false,false,0,0,"Really black") qi({"SpecialMesh",badge,MeshType="FileMesh",Scale=v3(0.15,1,0.5),MeshId=asset .. Decs.Diamond})
badgew = qi({"Weld",han2,Part0=laa,Part1=badge,C0=cn(-0.5,0,0)*ca(rd(25),0,0)})
badge2 = pa(su,"","Block",0,0,0,false,false,0,0,"Really black") qi({"SpecialMesh",badge2,MeshType="FileMesh",Scale=v3(0.149,1,0.495),MeshId=asset .. Decs.Diamond})
badge2w = qi({"Weld",han2,Part0=badge,Part1=badge2})

ef = pa(su,"","Block",0,0,0,false,true,1,0,"Really black") qi({"SpecialMesh",ef,MeshType="FileMesh",Scale=v3(7,7,4),MeshId=asset .. Decs.Chakram2})
...
db2 = pa(su,"","Block",0,0,0,false,false,1,0.1,"Really black") qi({"SpecialMesh",db2,MeshType="Sphere",Scale=v3(1.2,1.2,1.2)*5})
...
chak2 = pa(su,"","Block",0,0,0,false,false,0.1,0.1,"Really black") qi({"SpecialMesh",chak2,Scale=v3(0.15,0.15,0.05)*5,MeshType="FileMesh",MeshId=asset .. Decs.Chakram2}) 
...
c1(raw,spd,3,1,0.5,0,0,0,-80) c2(raw,spd,3,1,0.4,0,0,0,-140) for i=1,5 do SpawnSword(FindGround(to.CFrame*cn(0,-2.75,-0.5+(-i*8)-i)),1+(i/10),15,"Really black") wait(0.06) end 
...
Trail(bla3,15,0,"Really black",0.65,cn(0,-0.2,-1)) rayHit(0.6,1,ra,ca(rd(-90),0,0),8,1.3) 
...
local tpos = mouse.hit.p if (tpos - bla2.Position).magnitude < 2000 then q(function() local to = pa(su,"","Block",2,1,2,false,true,0.1,0,"Really black") it('CylinderMesh',to) local to2 = pa(su,"","Block",0,0,0,false,true,0.1,0,"Really black") qi({"SpecialMesh",to2,Scale=v3(2,2,2),MeshType="FileMesh",MeshId=asset .. Decs.Totem}) 
...
for i=1,8 do Lightning(bla2.Position,tpos,math.floor((bla2.Position-tpos).magnitude/18)+1,1.5,"Really black",0.3,0) wait(0.12) end fac = false
caw = true q(function() wait(1) WormDrill(cn(tpos),rn(25,30)/10) end) c1(law,spd,3,-1.5,0.25,0,0,0,180) q(function() local to = pa(su,"","Block",1.5,1.5,1.5,false,true,0.1,0,"Really black") qi({"SpecialMesh",to,MeshType="Sphere"}) for i=1,15,1 do to.Size=v3(1.5,i*2,1.5) to.CFrame=la.CFrame*cn(0,-2+(-i),0) wait() end GlowMesh(false,"Sphere",t,v3(35,35,35),'Really black',la.CFrame*cn(0,-32,0),0.1,1,0.1) fade(to,0.1) end)
...
local to = pa(su,"","Block",0,0,0,false,false,0.2,0,"Really black") it('CylinderMesh',to).Scale=v3(9,0.2,9)*5 local tom = qi({"Weld",to,Part0=ra,Part1=to})
