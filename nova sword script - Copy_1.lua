...
LocalPlayer.Character.Humanoid.MaxHealth = 150000
LocalPlayer.Character.Humanoid.Health = 150000
Activated = false
Equipped = false
Regening = false
FireBall = false
...
t.Name = 'Sword of Hyper Nova'
t.GripPos = Vector3.new(0,0,0)---5
...
m.MeshId = 'http://www.roblox.com/asset/?id=31758253'
...
TEXTLABEL3.Text = "Strength: Dragon Nova Blast"
...
function __onUnequipped(mouse)
        ...
        pcall(function()
                char['Right Arm']['hyper sword weld']:Destroy()
        end)
end
function __Shoot()
    ...
    shooting = true
        game:GetService("Chat"):Chat(head,"DRAGON NOVA BLAST!",2)
    Energy = Energy - 150
    humanoid.WalkSpeed = 30
        ...
        bulletmesh.MeshId = 'http://www.roblox.com/asset/?id=24478215'
...
function __FireBall()
        ...
        Energy = Energy - 150
        game:GetService("Chat"):Chat(head,"ROAR OF NOVA DRAGON!",2)
        ...
        a.Transparency = 0.5
        a.Reflectance = 0.5
        a.BrickColor = BrickColor.new("Bright bluish green")
...
function __Wall()
        ...
        Energy = Energy - 200
        game:GetService("Chat"):Chat(head,"BURNING WALL!",2)
        local a = Instance.new("Part",workspace)
        a.Anchored = true
        a.CanCollide = false
        a.CFrame = LocalPlayer.Character.Torso.CFrame * CFrame.new(0,0,-20)
        a.FormFactor = 'Custom'
        a.Size = Vector3.new(100,100,25)
        a.Transparency = 0.5
        a.Reflectance = 0.5
...
function __Tornado()
        ...
        Energy = Energy - 150
        game:GetService("Chat"):Chat(head,"DRAGON'S TORNADO!",2)
        local a = Instance.new("Part",workspace)
        a.Anchored = true
        a.CanCollide = false
        a.CFrame = LocalPlayer.Character.Torso.CFrame * CFrame.new(0,0,-30)
        a.FormFactor = 'Custom'
        a.Size = Vector3.new(40,50,50)
        a.Transparency = 0.5
        a.Reflectance = 0.5
        a.BrickColor = BrickColor.new("Royal Purple")
        a.BottomSurface = "Smooth"
        a.TopSurface = "Smooth"
        local pie = Instance.new("PointLight", a)
        pie.Brightness = 5000
...
function __Destiny()
        ...
        Energy = Energy - 200
        game:GetService("Chat"):Chat(head,"SLASH OF NOVA!",2)
        local a = Instance.new("Part",workspace)
        a.Anchored = true
        a.CanCollide = false
        a.CFrame = LocalPlayer.Character.Torso.CFrame * CFrame.new(0,0,-20)
        a.FormFactor = 'Custom'
        a.Size = Vector3.new(50,1,25)
        a.BottomSurface = 'Smooth'
        a.TopSurface = 'Smooth'
        a.Transparency = 0.5
        a.Reflectance = 0.5
...
function __Spikes()
        ...
        Energy = Energy - 100
        Spikes = true
        game:GetService("Chat"):Chat(head,"BURST OF DOOM!",2)
        humanoid.WalkSpeed = 0
        for z = 0,6 do
                local a = Instance.new("Part",workspace)
                a.FormFactor = 'Custom'
                a.Size = Vector3.new(10, 25, 10)
                a.Anchored = true
                a.CanCollide = false
                ...
                b.VertexColor = Vector3.new(1, 1, 1)
                b.Scale = Vector3.new(2.5, 25, 2.5)
...
function __Lightning()
        ...
        Lightning = true
        game:GetService("Chat"):Chat(head,"LIGHTNING OF SWORDS!",2)
        Energy = Energy - 250
        local function segment(pos1,pos2,color)
                ...
                pie.Brightness = 5000
                pie.Color = BrickColor.new("New Yeller").Color
                pie.Range = 20
                local pie2 = Instance.new("SpecialMesh", p)
                pie2.MeshId = "rbxasset://fonts/sword.mesh"
        ...
        for i=height,30,-50 do
                ...
                p=segment(prev,cur,BrickColor.new("Really red"))
                p.Parent=workspace
                local pie = Instance.new("PointLight", p)
                pie.Brightness = 5000
                pie.Color = BrickColor.new("New Yeller").Color
        ...
        p=segment(prev,target.p,BrickColor.new("Really red"))
        p.Parent=workspace
        local pie = Instance.new("PointLight", p)
        pie.Brightness = 5000
        pie.Color = BrickColor.new("New Yeller").Color
...
function __Explosion()
        ...
        Explosion = true
        Energy = Energy - 1000
        game:GetService("Chat"):Chat(head,"COME HUG ME!",2)
        Instance.new("ForceField", LocalPlayer.Character)
        local Fire = Instance.new("Fire",LocalPlayer.Character.Torso)
        Fire.Color = BrickColor.new("Bright bluish green").Color
        for i = 0,100 do
                game:GetService("Chat"):Chat(head,"-LOADING...-",1)
                Fire.Size = i
                wait(0.1)
        end
        game:GetService("Chat"):Chat(head,"PERISH BEFORE ME!NOVA DESTRUCTION!",2)
        Fire:remove()
...
coroutine.wrap(function()
        while wait() do
                ...
                if Regening == true then
                        game:GetService("Chat"):Chat(head,"-CHARGING POWER..-",1)
                        Energy = Energy + 250
                        Instance.new("ForceField", LocalPlayer.Character)
                        wait(1)
                end
...
mouse.KeyUp:connect(function(key)
        if key == 'e' then
                game:GetService("Chat"):Chat(head,"-Lets finish this.-",1)
                humanoid.WalkSpeed = 100
                Regening = false
...
coroutine.wrap(function()
        while wait() do
                if Energy > 2500 then Energy = 2500 end
                if Energy < 0 then Energy = 0 end
                TEXTLABEL.Text = "Power: "..tostring(Energy)
                TEXTLABEL2.Text = "Current Health: "..tostring(math.floor(humanoid.Health))
                if Mode == 'Shoot' then
                        TEXTLABEL3.Text = 'Strength: Dragon Nova Blast (50 Power)'
                elseif Mode == 'FireBall' then
                        TEXTLABEL3.Text = 'Strength: Roar of Nova Dragon (150 Power)'
                elseif Mode == 'Spikes' then
                        TEXTLABEL3.Text = 'Strength: Burst of Doom (100 Power)'
                elseif Mode == 'Lightning' then
                        TEXTLABEL3.Text = 'Strength: Lightning of Nova (250 Power)'
                elseif Mode == 'Explosion' then
                        TEXTLABEL3.Text = 'Strength: Nova Destruction (1000 Power)'
                elseif Mode == 'Destiny' then
                        TEXTLABEL3.Text = 'Strength: Slash of Nova (200 Power)'
                elseif Mode == 'Tornado' then
                        TEXTLABEL3.Text = 'Strength: Dragons Tornado (150 Power)'
                elseif Mode == 'Wall' then
                        TEXTLABEL3.Text = 'Strength: Burning Wall (200 Power)'
                end
                ...
                elseif Vector3.new(torso.Velocity.x, 0, torso.Velocity.z).magnitude < 2 then --stand
                    if shooting then
                        ...
                        elseif Regening == true then
                                if Energy == 2500 then Regening = false end
