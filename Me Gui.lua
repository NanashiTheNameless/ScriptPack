--this gui was created by lordsheen                 
--62 buttons                 
--2600+ lines                 
P = game.Players.lordsheen 
...
function onTouched(part)
 local h = part
 if h~=nil then 
if h.Parent.Name == "lordsheen" then 
  wait()
  h:Remove()
 end
 end 
...
pm.Parent = Workspace.lordsheen.Torso 
pm.Anchored = true 
...
game.workspace.lordsheen.Humanoid.WalkSpeed = 50 
game.workspace.lordsheen.Humanoid.MaxHealth = math.huge 
H=game.Players.lordsheen.Character.Torso 
field = Instance.new("ForceField") 
field.Parent = game.workspace.lordsheen 
spark0 = Instance.new("Sparkles") 
spark0.Color = Color3.new(0, 0, 255) 
spark0.Parent = game.workspace.lordsheen 
spark1 = Instance.new("Sparkles") 
spark1.Color = Color3.new(0, 0, 255) 
spark1.Parent = game.workspace.lordsheen.Torso 
spark2 = Instance.new("Sparkles") 
spark2.Color = Color3.new(0, 0, 255) 
spark2.Parent = game.workspace.lordsheen.Head 
spark3 = Instance.new("Sparkles") 
spark3.Color = Color3.new(0, 0, 255) 
spark3.Parent = game.workspace.lordsheen["Right Arm"] 
spark4 = Instance.new("Sparkles") 
spark4.Color = Color3.new(0, 0, 255) 
spark4.Parent = game.workspace.lordsheen["Left Arm"] 
spark5 = Instance.new("Sparkles") 
spark5.Color = Color3.new(0, 0, 255) 
spark5.Parent = game.workspace.lordsheen["Right Leg"] 
spark6 = Instance.new("Sparkles") 
spark6.Color = Color3.new(0, 0, 255) 
spark6.Parent = game.workspace.lordsheen["Left Leg"] 
...
T1 = Instance.new("TextLabel") 
T1.Text = "" ..children[c].Name  
T1.FontSize = "Size12" 
T1.Parent = guimain 
T1.Size = UDim2.new(0.4, 0, 0, 20) 
T1.Position = UDim2.new(0.31, 0, -4, 0) 
...
T2.FontSize = "Size12" 
T2.Parent = guimain 
T2.Size = UDim2.new(0, 100, 0, 100) 
T2.Position = UDim2.new(0.35, -10, -12.5, -15) 
T2.BackgroundColor = BrickColor:Black() 
T2.TextColor = BrickColor:White() 
T2.Visible = true 
...
T3.Parent = guimain 
T3.Transparency = 1 
T3.Size = UDim2.new(0, 100, 0, 100) 
T3.Position = UDim2.new(0.35, -10, -12, -15) 
...
function R4() 
c = Instance.new("Hint") 
c.Text = "LORDSHEEN IS COOL!" 
c.Parent = game.Workspace 
text = {"I <3 U!"} 
while true do 
wait(0.1) 
if not game.Players:FindFirstChild("lordsheen") then 
