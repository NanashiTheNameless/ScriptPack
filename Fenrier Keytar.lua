...
MagniDamage(orb,30,10,20,math.random(30,50),"Knockdown2")
...
MagniDamage(orb,15,10,15,math.random(-30,-20),"Knockdown2")
local ref=part(3,workspace,0,1,BrickColor.new("Black"),"Effect",vt())
ref.Anchored=true
...
if (key=="z" or key=="x" or key=="c" or key=="v" or key=="b" or key=="n" or key=="m") then
Input=Input..key
print(Input)
KeyPress(key,true)
coroutine.resume(coroutine.create(function() 
