--RPG Gifted by TheRedAngel, Regular Script!

if script == nil then return end


Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("peyquinn") --Replace my name with yours for the RPG to work.
...
--lego
game.Workspace.peyquinn.Humanoid.MaxHealth = math.huge  -----Replace my name with yours for INF HP
print(lego)