--MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 4 and 1351 and put your name where it says "BRICKER24alt"

Players = game:GetService("Players")
Player = Players.BRICKER24alt
Bp = Player.Backpack
Pg = Player.PlayerGui
...
Rage = 100000
wait(5)
Workspace.BRICKER24alt.Humanoid.MaxHealth = math.huge