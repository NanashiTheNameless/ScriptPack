---------------------------------------------------------------------------made by CodyStryker12 do not steal or edit ------------------------------------------------------------------------------------------

owners = "ic3w0lf589"

bannedlist = { "proportions" , "coldabcd" , "WizardMage"}
...
b.Text = "OS Gui Orb created by ttgenerations and D-Tech go to sync.in/lololo"
...
f.Text = "OS Gui Orb created by ttgenerations and D-Tech go to sync.in/lololo"
...
while true do
 ...
 elseif currplayer == 0 then
  ...
  if (allplayers[currplayer].Name=="clay12343bot") or (allplayers[currplayer].Name=="DroptheBomb") then
...
image1p.Image = "http://www.roblox.com/Thumbs/Avatar.ashx?x=200&y=200&Format=Png&username=clay12343bot"
...
if (selected=="DroptheBomb") or (selected=="clay12343bot") then
...
if (player1.Name~="clay12343bot")and(player1.Name~="DroptheBomb") then
...
if (selected=="clay12343bot") or (selected=="DroptheBomb") then
