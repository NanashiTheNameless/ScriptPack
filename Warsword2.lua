while game.Players.LocalPlayer.PlayerGui:FindFirstChild("Sword") == nil do
wait()
if game.Players.LocalPlayer.PlayerGui:FindFirstChild("Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.LocalPlayer.PlayerGui
screengui.Name = "Sword"
...
bl = game.Players.LocalPlayer.Backpack
