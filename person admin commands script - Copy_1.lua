:ls local Settings={["Un_Removable"]= "On"}
...
adminlist = {"luxulux"}--Add in the names of the people you want to be able to use the command script here.
...
eloname = "Owne"
eloname = eloname .. "r"
script.Name = eloname .. "'s Commands"
youcaughtme = 0
for i =1,#adminlist do
