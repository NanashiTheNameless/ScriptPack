...
Handle1=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Institutional Cyan","Handle1",Vector3.new(0.874639988, 0.200000003, 0.538240016))
...
HitboxA=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,1,"Really black","HitboxA",Vector3.new(1.0092001, 0.201839983, 0.672799945))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Really black","Part",Vector3.new(1.0092001, 0.200000003, 0.672799945))
...
mesh("SpecialMesh",Part,Enum.MeshType.FileMesh,"http://www.roblox.com/Asset/?id=9756362",Vector3.new(0, 0, 0),Vector3.new(0.0242207684, 0.0511327684, 0.0235479958))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Institutional Cyan","Part",Vector3.new(0.200000003, 0.200000003, 0.200000003))
Partweld=weld(m,Handle1,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-0.168125153, -0.100980163, 0.0336675644, 0.000573056866, 2.98486214e-008, -1.0000056, 1.00000012, 2.69930268e-007, 0.000581997563, 2.69947321e-007, -1.00000715, -2.96909342e-008))
...
Handle2=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Institutional Cyan","Handle",Vector3.new(0.874639988, 0.200000003, 0.538240016))
...
HitboxB=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,1,"Really black","HitboxB",Vector3.new(1.0092001, 0.201839983, 0.672799945))
...
Handle3=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0,"Institutional Cyan","Handle",Vector3.new(0.874639988, 0.200000003, 0.538240016))
...
HitboxC=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,1,"Really black","HitboxC",Vector3.new(1.0092001, 0.201839983, 0.672799945))
...
attack = true
Throwing = true
local con1=HitboxA.Touched:connect(function(hit) Damagefunc(hit,25,20,math.random(152,152),"Normal",RootPart,.2,1) end) 
local con2=HitboxB.Touched:connect(function(hit) Damagefunc(hit,5,20,math.random(152,152),"Normal",RootPart,.2,1) end) 
local con3=HitboxC.Touched:connect(function(hit) Damagefunc(hit,5,20,math.random(152,152),"Normal",RootPart,.2,1) end) 
for i = 0,1,0.1 do
swait()
...
local string1=part(3,m,"Neon",0,0.8,BrickColor.new("Cyn"),"String1",vt(1,1,1))
...
local string2=part(3,m,"Neon",0,0.8,BrickColor.new("Cyn"),"String2",vt(1,1,1))
...
local string3=part(3,m,"Neon",0,0.8,BrickColor.new("Can"),"String2",vt(1,1,1))
