...
speed = 200
jump = 200
if Character.Name=="olefson" then
ColorVariation = "olefson"
...
ColorVariation = "Really black"
end
if ColorVariation == "Really black" then
handlecolor = BrickColor.new("Really blue")
bcolor = BrickColor.new("Bright red")
beakcolor = BrickColor.new("Bright pink")
ropecolor = BrickColor.new("Bright black")
eyecolor = BrickColor.new("Bright orange")
elseif ColorVariation == "violet" then
handlecolor =BrickColor.new("Really black")
bcolor = BrickColor.new("orange")
beakcolor = BrickColor.new("Bright violet")
ropecolor = BrickColor.new("Really purple")
eyecolor = BrickColor.new("Bright red")
elseif ColorVariation == "Black" then
handlecolor = BrickColor.new("red")
bcolor = BrickColor.new("Really red")
beakcolor = BrickColor.new("Bright orange")
ropecolor = BrickColor.new("Really black")
eyecolor = BrickColor.new("Bright blue")
elseif ColorVariation == "Really black" then
handlecolor = BrickColor.new("Alder")
bcolor = BrickColor.new("Really black")
beakcolor = BrickColor.new("Bright violet")
ropecolor = BrickColor.new("White")
eyecolor = BrickColor.new("Bright blue")
elseif ColorVariation == "olefson" then
handlecolor =BrickColor.new("White")
bcolor = BrickColor.new("Really red")
beakcolor = BrickColor.new("Bright violet")
ropecolor = BrickColor.new("Really pink")
eyecolor = BrickColor.new("Navy blue")
elseif ColorVariation == "Bright violet" then
handlecolor =BrickColor.new("Bright violet")
...
bcolor = BrickColor.new("Bright violet")
beakcolor = BrickColor.new("Really blue")
ropecolor = BrickColor.new("Really black")
eyecolor = BrickColor.new("Bright blue")
else
--Custom
