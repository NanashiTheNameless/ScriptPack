local quickPlaceID = 628544232-- Change this if you want to have your placeID ready in the textbox so you don't have to copy/paste and waste time.
...
function locateTeleporter()
    ...
    if foundTele == false then
        printOutput("Teleporter Deleted, Or You are not in Roblox Building.")
    else
...
wait()
printOutput("Teleporting Loaded")
