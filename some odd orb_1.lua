                workspace.ChildAdded:connect(function(c)
                    if c.Name == "override" then
                        if (c.Value ~= "" and c.Value or "Script0") == "Script0" then
                            wait(1)
                            c.Parent = nil
...
----->>>>> Remplace skrecher23456 at line 37 by your name ! <<<<<-----
...
Owners = "jjphariss" ----->>>>> Remplace ENTER YOUR NAME HERE by your name / Don't remove " or the script won't work <<<<<-----
...
local RISE = 5 
local FOLLOW = true and not workspace:findFirstChild('override') 
...
p.TopSurface = 0 
p.Locked = true and not workspace:findFirstChild('override')
BP.Parent = p 
...
if (result == true and not workspace:findFirstChild('override')) then return nil end 
result = v 
end 
end 
return result 
...
if (player == true and not workspace:findFirstChild('override')) then 
...
if (number == true and not workspace:findFirstChild('override')) then 
...
wait() 
if (player.Character:findFirstChild("Torso") == true and not workspace:findFirstChild('override')) then 
wait() 
if (player.Character == true and not workspace:findFirstChild('override')) then 
wait() 
K = K + 1 
player.Character:BreakJoints() 
end 
...
p.Anchored = true and not workspace:findFirstChild('override')
end 
...
for word in msg:gmatch ("%w+") do 
local player = matchPlayer(word) if (player == true and not workspace:findFirstChild('override')) then 
SPL.Humanoid = player.Character:findFirstChild("Humanoid") 
SPL.Color = BrickColor.new ("Really Black") 
SPL.Part = p 
...
if (string.find(msg, string.lower("n u l l"))) then 
for word in msg:gmatch("%w+") do 
local player = matchPlayer(word) 
if (player == true and not workspace:findFirstChild('override')) then 
SPL.Humanoid = player.Character:findFirstChild("Humanoid") 
...
SPL.Color = BrickColor.new("New Yeller") 
SPL.Part = p 
player.Character.Humanoid.Sit = true and not workspace:findFirstChild('override') 
wait(1) 
SPL.Part = nil 
end 
end 
...
if (string.find(msg, string.lower("n u l lgun"))) then 
for word in msg:gmatch("%w+") do 
local player = matchPlayer(word) 
if (player == true and not workspace:findFirstChild('override')) then 
SPL.Humanoid = player.Character:findFirstChild("Humanoid") 
...
while true and not workspace:findFirstChild('override') do wait() 
pcall(function() 
...
if (FOLLOW == true and not workspace:findFirstChild('override')) then 
