...
Obelisk = function()
  ...
  if cando == true then
    ...
    domana = true
    --[[if d ~= nil then
      Prt1 = d:findFirstChild("Obelisk Part01")
      if Prt1 ~= nil then
        domana = false
        ...
        MagniDamage(Prt1, 15, 7, 10, math.random(20, 30), "Knockdown2", Prt1, 0, 1, (math.random(5, 8)), nil, nil, true)
      ...
      do
        ...
        if hitfloor ~= nil then
          ...
          local omsh8 = mesh("SpecialMesh", oprt8, "FileMesh", "71494804", vt(0, 0, 0), vt(2, 2, 2))
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 20 and #Obelisks > 0 then
    ...
    if d ~= nil then
      ...
      MagicRing(BrickColor.new(NewCol2), cf(posfloor2) * euler(1.57, 0, 0), 80, 80, 1, 0.1, 0.1, 2, 0.02)
      ...
      ref2.CFrame = cf(ref.Position)
      game:GetService("Debris"):AddItem(ref2, 1)
      so("161006182", ref2, 1, 0.2)
      so("158210228", ref2, 1, 0.4)
      ref.Parent = nil
    end
    swait(10)
    dec.Parent = nil
...
while 1 do
  ...
  stunanim = false
                  ...
                  do
                    ...
                    do
                      do
                        ...
                        -- DECOMPILER ERROR at PC5772: LeaveBlock: unexpected jumping out DO_STMT

                        -- DECOMPILER ERROR at PC5772: LeaveBlock: unexpected jumping out DO_STMT

                        -- DECOMPILER ERROR at PC5772: LeaveBlock: unexpected jumping out IF_ELSE_STMT

                        -- DECOMPILER ERROR at PC5772: LeaveBlock: unexpected jumping out IF_STMT
                        ...
                        -- DECOMPILER ERROR at PC5772: LeaveBlock: unexpected jumping out IF_THEN_STMT
    ...
    -- DECOMPILER ERROR at PC6136: LeaveBlock: unexpected jumping out DO_STMT
