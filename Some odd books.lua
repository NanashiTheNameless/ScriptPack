--mediafire------------------------------------------------------------------------------------------------------------------------------------------------
local scAdmins = {"jjphariss","ttyyuu12345","Hetica","Player","ItsTheLittleThings","robogod100","djdjdj","tommy8112000"} --Enter admins here
local pdc = {"dhakiller10","Calze900","lollypop8089"} --Enter banned here
...
function AntiFall(player, sp)
	if intablestr(af, player.Name) then
