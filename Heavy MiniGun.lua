...
Break = {Create = function(brickcolor, cframe, x1, y1, z1)
			...
			do
				if num <= 0 then
					...
					if hit ~= nil then
						...
						MagniDamage(refpart2, 10, 10, 10, 0, "Normal")
					end
				end
			end
		until num <= 0
	...
	if target1 ~= nil then
		...
		d1.Anchored = true
		d1.CFrame = cn(pos2)
		MagniDamage(d1, 10, 10, 10, -10, "Normal")
	...
	if target1 ~= nil then
		...
		d1.Anchored = true
		d1.CFrame = cn(pos2)
		MagniDamage(d1, 10, 10, 10, 0, "Normal")
	...
	k = k:lower()
	if attack == true and aiming == true and hot == false and k == "c" then
		fire()
	else
		if attack == false and aiming == false and hot == false and k == "v" and co3 <= cooldown3 then
			cooldown3 = 0
			baka()
		else
			if attack == false and aiming == false and hot == false and k == "b" and co4 <= cooldown4 then
				cooldown4 = 0
				bulletrain()
			else
				if attack == false and aiming == false and hot == false and k == "n" and co2 <= cooldown2 then
					cooldown2 = 0
					reload()
				end
			end
	...
	k = k:lower()
	if attack == true and aiming == true and hot == true and k == "c" then
		shoot = false
	end
end
)
