-- http://hastebin.com/raw/ukaqojoguc
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 0 then
    attack = true
    doing2 = true
    lifesteal = true
    lifesteal2 = 1
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 0 then
    attack = true
    cooldowns[3] = 100
    mana.Value = mana.Value - 0
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 0 then
    attack = true
    cooldowns[4] = 100
