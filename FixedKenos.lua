...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 20 then
    ...
    for i = 0, 1, 0.13 do
      ...
      MagniDamage(rprt1, 5, 6, 8, math.random(20, 30), "Normal", RootPart, 0.2, 1, (math.random(8, 10)), nil, true)
      MagniDamage(lprt1, 5, 6, 8, math.random(20, 30), "Normal", RootPart, 0.2, 1, (math.random(8, 10)), nil, true)
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 25 then
    ...
    for i = 0, 1, 0.08 do
      ...
      if i > 0.3 then
        ...
        MagniDamage(rprt1, 20, 8, 10, math.random(-25, -20), "Normal", RootPart, 0.2, 1, (math.random(8, 10)), nil, true)
      end
