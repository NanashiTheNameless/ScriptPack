function onChatted(msg) 
    ...
    elseif msg:sub(1,3)=='vis' then
        ...
        elseif msg:sub(1,6)=='noclip' then
          --[[NoClip for my chatted cmds]]--
game:service('RunService').Stepped:connect(function()
        ...
        elseif msg:sub(1,4)=='sel/' then
            for _,v in pairs(game.Players.LocalPlayer.Character:children()) do
                if v.className=='Part' then
                    local color=msg:sub(5) 
...
dist.CFrame = CFrame.new(LocalPlayer.Character.Torso.Positin)
...
game:service'Debris':AddItem(dist, 0)
        ...
        elseif msg:sub(1,9)=='functions' then
   end
end
game.Players.LocalPlayer.Chatted:connect(function(msg) onChatted(msg,game.Players.LocalPlayer) end)