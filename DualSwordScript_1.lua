...
local prt6=part(3,modelzorz,0.3,0,BrickColor.new("Hot pink"),"Part6",vt(0.25,3,0.16))
local prt7=part(3,modelzorz,0.3,0,BrickColor.new("Hot pink"),"Part7",vt(0.1,0.5,0.25))
...
local aprt6=part(3,modelzorz,0.3,0,BrickColor.new("Hot pink"),"aPart6",vt(0.25,3,0.16))
local aprt7=part(3,modelzorz,0.3,0,BrickColor.new("Hot pink"),"aPart7",vt(0.1,0.5,0.25))
...
local prt=part(3,workspace,1,0,BrickColor.new("Hot pink"),"Part",vt(1,1,1))
prt.Anchored=true
...
--                        hs(hit,1.2) 
                ...
                Damage=Damage+math.random(10000,10000)
--                h:TakeDamage(Damage)
                blocked=false
...
--                h:TakeDamage(Damage)
                ...
                showDamage(hit.Parent,Damage,.10000)
                else
                h:TakeDamage(1)
...
effect("Hot pink",0.5,LastPoint,Point)
LastPoint=Point
local Point2=aprt6.CFrame*CFrame.new(0,aprt6.Size.Y/1.5,0)
effect("Hot pink",0.5,LastPoint2,Point2)
LastPoint2=Point2
end
con1:disconnect()
con2:disconnect()
