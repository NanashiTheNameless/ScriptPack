...
local cooldownsadd = {}
local cooldownadd1 = 0.15
table.insert(cooldownsadd, cooldownadd1)
local cooldownadd2 = 0.42
...
local gunpart2 = rprt22
  ...
  script.Parent = Tool
Bin = script.Parent
if Bin.Name == "Trooper: Rambo Gunner" then
  Bin.Name = "Joy"
end
...
attackone = function()
  ...
  for i = 0, 1, 0.5 do
    ...
    hitboxCF = lprt17.CFrame * cf(0, -0.2, 0)
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 3, 7, 9, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 8)), nil, true, false)
    Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 1.2), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.2), 0.3)
  ...
  for i = 0, 1, 0.3 do
    ...
    hitbox.CFrame = hitboxCF
    MagniDamage(hitbox, 3, 7, 9, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 8)), nil, true, false)
    Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 1.2), 0.4)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.2), 0.4)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.2, 0, 1) * euler(0, 1.7, 0), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1, 0, 0.2) * euler(0, -1.57, 0), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
...
attacktwo = function()
  ...
  for i = 0, 1, 0.3 do
    ...
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1.2), 0.4)
    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2.8, 0, 0) * euler(0, 1.5, 0) * euler(0, -0.2, 0), 0.4)
    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0.2, 0, -0.6), 0.4)
    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.47, -0.1), 0.3)
    LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.67, 0.4), 0.3)
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      do
        if StaggerHit.Value == true then
          break
...
attackfour = function()
  ...
  if Ammo >= 2 then
    for i = 0, 1, 0.15 do
      ...
      RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1, 0, -0.8) * euler(0, 1.5, 0), 0.4)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.7, 0, 0.8) * euler(0, -1.5, 0), 0.4)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.4)
    ...
    if Stagger.Value ~= true and StunT.Value > Stun.Value then
      if StaggerHit.Value ~= true or Rooted.Value == false then
        Torso.Velocity = RootPart.CFrame.lookVector * -50
      end
      Ammo = Ammo - 2
      Explosion(true, true, 8, 10)
    end
    for i = 0, 1, 0.1 do
      swait()
      GunRight(0.4)
    ...
    for i = 0, 1, 0.15 do
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          ...
          -- DECOMPILER ERROR at PC693: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC693: LeaveBlock: unexpected jumping out IF_STMT
    ...
    for i = 0, 1, 0.13 do
      ...
      if Stagger.Value ~= true and StunT.Value > Stun.Value then
        do
          ...
          -- DECOMPILER ERROR at PC1020: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC1020: LeaveBlock: unexpected jumping out IF_STMT
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] then
    ...
    for i = 0, 1, 0.15 do
      ...
      RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.57, -0.1), 0.2)
      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.57, 0.4), 0.2)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then do
          if StaggerHit.Value == true then
            break
          end
        end
    ...
    for i = 0, 1, 0.4 do
      ...
      hitboxCF = lprt17.CFrame * cf(0, -0.2, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 3, 5, 10, math.random(10, 20), "Normal", RootPart, 0.3, 1, (math.random(3, 8)), nil, true, false, "Movement", 0.4, 200)
      Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 1.2), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.2), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -1) * euler(0, -0.5, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.2)
      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.2)
      if Stagger.Value ~= true and StunT.Value > Stun.Value then do
    ...
    for i = 0, 1, 0.15 do
      ...
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2.5, 0, -1) * euler(0, -1, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.2)
      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.2)
          if StaggerHit.Value == true or mana.Value <= 20  then
            break
      end
end
end
print("umadeit")
    ...
    hboxpos.Parent = nil
    cooldowns[2] = 50
    if mana.Value >= 20 and Ammo >= 2 then--1
      Torso.Velocity = vt(0, 0, 0)
      local dec = Instance.new("NumberValue", Decrease)
      dec.Name = "DecreaseMvmt"
      dec.Value = 10
      for i = 0, 1, 0.1 do--2
        ...
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1) * euler(0, -0.5, 0) * euler(-0.5, 0, 0), 0.3)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
...
print("Faster")
            ...
            for i = 0, 1, 0.1 do
              ...
              Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1) * euler(-0.4, 0, 0), 0.3)
              RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1), 0.3)
              RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1) * euler(0, -0.5, 0) * euler(1.5, 0, 0), 0.3)
              RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 20 then
    ...
    mana.Value = mana.Value - 20
    cooldowns[3] = 0
    if overcharge == true then
      for i = 0, 1, 0.15 do
        swait()
        GunRight(1)
        GunLeft(1)
        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1) * euler(0.5, 0, 0), 0.5)
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1.57), 0.5)
        RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.8) * euler(0.2, 0, -1) * euler(0, 2, 0), 0.5)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.57, 0, -1.57) * euler(-0.6, 0, 0), 0.5)
      ...
      Explosion(true, true, 6, 8)
      Look = RootPart.CFrame.lookVector
      Humanoid.Jump = true
      if Rooted.Value == false then
        Torso.Velocity = RootPart.CFrame.lookVector * 80 + vt(0, 1, 0) * 70
      end
      for i = 0, 1, 0.4 do
        swait()
        GunRight(1)
        ...
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * euler(3.14, 0, 0), 0.6)
        RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.5) * euler(1, 0, -1.2) * euler(0, 1.5, 0), 0.6)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.6)
        LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.7, 0, 1.2) * euler(0, -1.5, 0), 0.6)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.6)
        RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.57, -0.1), 0.6)
        LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.57, 0.4), 0.6)
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            if StaggerHit.Value == true then
              break
      ...
      for i = 0, 1, 0.07 do
        swait()
        RootJoint.C0 = RootJoint.C0 * euler(0, 0, 1)
        Neck.C0 = clerp(Neck.C0, necko * euler(-1, 0, 0), 0.1)
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(3.2, 0, 0.5) * euler(0, 2, 0), 0.1)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(3.6, 0, -0.5) * euler(0, -2, 0), 0.1)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.1)
        RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.1)
        LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.1)
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            if StaggerHit.Value == true then
              break
      ...
      for i = 0, 1, 0.15 do
        ...
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.4) * euler(0, 0, 0), 0.5)
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2, 0, 2.2) * euler(0, 2, 0), 0.5)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -2.2) * euler(0, -2, 0), 0.5)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
        RH.C0 = clerp(RH.C0, cf(1.1, -1, -0.2) * euler(0, 1.57, 0.4), 0.5)
      ...
      Humanoid.Jump = true
      if Rooted.Value == false then
        Torso.Velocity = RootPart.CFrame.lookVector * 60 + vt(0, 1, 0) * 50
      end
      for i = 0, 1, 0.15 do
        swait()
        GunRight(0.6)
        GunLeft(0.6)
        RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 1) * euler(3.14, 0, 0), 0.6)
        Neck.C0 = clerp(Neck.C0, necko * euler(-1, 0, 0), 0.5)
        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(3.2, 0, 0.1) * euler(0, 2, 0), 0.5)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(3.6, 0, -0.1) * euler(0, -2, 0), 0.5)
        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
        RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.5)
        LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.5)
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            if StaggerHit.Value == true then
              break
            end
            -- DECOMPILER ERROR at PC1022: LeaveBlock: unexpected jumping out IF_THEN_STMT
      ...
      Explosion(true, true, 8, 10)
      if Rooted.Value == false then
        Torso.Velocity = RootPart.CFrame.lookVector * 30 + vt(0, 1, 0) * 60
      end
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 1) * euler(4, 0, 0), 0.6)
    end
    attack = false
  end
end
            ...
            for i = 0, 1, 0.15 do
              ...
              if Stagger.Value ~= true and StunT.Value > Stun.Value and StaggerHit.Value ~= true then
                do
                  ...
                  GunLeft(1)
                  if Rooted.Value == false then
                    Torso.Velocity = Look * 25
                  end
                  if anim == 1 then
                    Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, -1.2), 0.5)
                    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1.2), 0.5)
                    RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.6, 0, 1) * euler(0, 1.7, 0), 0.5)
                    RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                    LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.5, 0, -0.7) * euler(0, -1.57, 0), 0.5)
                    LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                    RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.57, -0.1), 0.5)
                    LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.57, 0.4), 0.5)
                  else
                    if anim == 2 then
                      Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 1.2), 0.5)
                      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.2), 0.5)
                      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.2, 0, 1) * euler(0, 1.7, 0), 0.5)
                      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                      LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.5) * euler(1.5, 0, -0.7) * euler(0, -1.57, 0), 0.5)
                      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                      RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.5)
                      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.5)
                    else
                      if anim == 3 then
                        ...
                        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(-0.4, 0, 1), 0.5)
                        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.57, 0, -1.57) * euler(0, -1.57, 0), 0.5)
                        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                        ...
                        if anim == 4 then
                          ...
                          RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0.4, 0, 1), 0.5)
                          RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                          LW.C0 = clerp(LW.C0, cf(-0.5, 0.5, -0.5) * euler(1.57, 0, 1) * euler(0, -1.57, 0), 0.5)
                          LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                          RH.C0 = clerp(RH.C0, cf(1, -1, 0) * euler(0, 1.57, 0) * euler(0, 0.5, -0.4), 0.5)
                          LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0.5, 0.1), 0.5)
                        else
                          if anim == 5 then
                            Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(-0.05, 0, 0), 0.5)
                            RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 0), 0.5)
                            RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2.5, 0, 0) * euler(0, 1.4, 0) * euler(0, -0.2, 0), 0.5)
                            RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                            LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.5, 0, -0.6), 0.5)
                            LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                            RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.67, -0.1), 0.5)
                            LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.47, 0.4), 0.5)
                          else
                            if anim == 6 then
                              Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 0), 0.5)
                              RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 0), 0.5)
                              ...
                              if anim == 7 then
                                ...
                                RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                LW.C0 = clerp(LW.C0, cf(-1, 0.5, -0.8) * euler(1.7, 0, 1) * euler(0, -1, 0), 0.5)
                                LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                RH.C0 = clerp(RH.C0, cf(0.6, -1, 0.4) * euler(0, 1.57, 0) * euler(0.2, -1.57, 0), 0.5)
                                LH.C0 = clerp(LH.C0, cf(-0.6, -1, -0.4) * euler(0, -1.57, 0) * euler(-0.4, -1.57, 0), 0.5)
                              else
                                if anim == 8 then
                                  Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 1.57) * euler(0.1, 0, 0), 0.5)
                                  RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.57), 0.5)
                                  RW.C0 = clerp(RW.C0, cf(1, 0.5, -0.8) * euler(1.7, 0, -1) * euler(0, 1, 0), 0.5)
                                  RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                  ...
                                  if anim == 9 then
                                    ...
                                    if anim == 10 then
                                      Neck.C0 = clerp(Neck.C0, necko * euler(0.2, 0, 1.2), 0.5)
                                      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, -1.2), 0.5)
                                      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1), 0.5)
                                      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -1) * euler(0, -0.5, 0), 0.5)
                                      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                      RH.C0 = clerp(RH.C0, cf(0.9, -1, -0.4) * euler(0, 2.57, -0.4), 0.5)
                                      LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, 0.4) * euler(0, -0.57, 0.1), 0.5)
                                    else
                                      if anim == 11 then
                                        Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1) * euler(0.4, 0, 0), 0.5)
                                        RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 1), 0.5)
                                        RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1, 0, 1) * euler(0, 1, 0), 0.5)
                                        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                        LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0.5, 0, -1), 0.5)
                                        LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                        RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.4) * euler(0, 0.57, -0.1), 0.5)
                                        LH.C0 = clerp(LH.C0, cf(-0.9, -0.9, -0.4) * euler(0, -2.57, 0.4), 0.5)
                                      else
                                        if anim == 12 then
                                          ...
                                          RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0, 0, 0), 0.5)
                                          RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(2, 0, 1.8) * euler(0, 2, 0), 0.5)
                                          RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                          LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(2, 0, -1.8) * euler(0, -2, 0), 0.5)
                                          LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.5)
                                          RH.C0 = clerp(RH.C0, cf(1.1, -1, 0) * euler(0, 1.57, -0.1), 0.5)
                                          LH.C0 = clerp(LH.C0, cf(-1, -0.9, 0) * euler(0, -1.57, 0.4), 0.5)
                                        end
                  ...
                  -- DECOMPILER ERROR at PC2256: LeaveBlock: unexpected jumping out IF_THEN_STMT

                  -- DECOMPILER ERROR at PC2256: LeaveBlock: unexpected jumping out IF_STMT

                end
              end
            end
            Explosion(true, true, 4, 5)
            -- DECOMPILER ERROR at PC2263: LeaveBlock: unexpected jumping out IF_THEN_STMT

            -- DECOMPILER ERROR at PC2263: LeaveBlock: unexpected jumping out IF_STMT
...
Explosion = function(left, right, dam1, dam2)
  if left == true then
    Bullet(lprt22)
    so("203691837", lprt36, 1, math.random(80, 120) / 100)
    MagniDamage(lprt36, 10, dam1, dam2, 0, "Normal", RootPart, 0.2, 1, (math.random(1, 5)), nil, nil, true)
    MagicBlock(BrickColor.new(NewCol), cf(lprt36.Position), 1, 1, 1, 5, 5, 5, 0.1, 1)
    MagicCircle(BrickColor.new(NewCol), cf(lprt36.Position), 1, 1, 1, 5, 5, 5, 0.1)
    MagicRing(BrickColor.new("Bright yellow"), cf(lprt36.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 0.1, 2, 2, 0.1, 0.1)
  end
  if right == true then
    Bullet(rprt22)
    so("203691837", rprt36, 1, math.random(80, 120) / 100)
    MagniDamage(rprt36, 10, dam1, dam2, 0, "Normal", RootPart, 0.2, 1, (math.random(1, 5)), nil, nil, true)
    MagicBlock(BrickColor.new(NewCol), cf(rprt36.Position), 1, 1, 1, 5, 5, 5, 0.1, 1)
    MagicCircle(BrickColor.new(NewCol), cf(rprt36.Position), 1, 1, 1, 5, 5, 5, 0.1)
    MagicRing(BrickColor.new("Bright yellow"), cf(rprt36.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 0.1, 2, 2, 0.1, 0.1)
  end
end
Shootcombo = function()
  spread = vt(math.random(-50, 50) / 100, math.random(-50, 50) / 100, math.random(-50, 50) / 100) * (gunpart.Position - MMouse.Hit.p).magnitude / 100
  local MouseLook = cf((gunpart.Position + MMouse.Hit.p) / 2, MMouse.Hit.p + spread)
  table.insert(Effects, {MouseLook.lookVector, "Shoot", 30, gunpart.Position, 5, 7, 0, 1})
  Bullet(gunpart2)
end
XVShot = function()
  local MouseLook = cf((gunpart.Position + MMouse.Hit.p) / 2, MMouse.Hit.p)
  table.insert(Effects, {MouseLook.lookVector, "Shoot", 30, gunpart.Position, 5, 7, 0, 2})
  Bullet(gunpart2)
end
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, incstun, stagger, staghit, ranged, DecreaseState, DecreaseAmount, Duration, Sound)
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
	...
	hit.Parent.Humanoid:TakeDamage(Damage)
      ...
      if obliterate == false then
        if overcharge == true then
          passive.Value = passive.Value - 0.08
        else
...
while 1 do
  swait()
  if 60 <= cooldowns[1] then
    overcharge = false
    if rprt4n.Transparency < 1 and obliterate == false then
      rprt4n.Transparency = rprt4n.Transparency + 0.1
      rprt9n.Transparency = rprt4n.Transparency
      rprt14n.Transparency = rprt4n.Transparency
      rprt15n.Transparency = rprt4n.Transparency
      rprt16n.Transparency = rprt4n.Transparency
      rprt23n.Transparency = rprt4n.Transparency
      rprt24n.Transparency = rprt4n.Transparency
      rprt25n.Transparency = rprt4n.Transparency
      lprt4n.Transparency = rprt4n.Transparency
      lprt9n.Transparency = rprt4n.Transparency
      lprt14n.Transparency = rprt4n.Transparency
      lprt15n.Transparency = rprt4n.Transparency
      lprt16n.Transparency = rprt4n.Transparency
      lprt23n.Transparency = rprt4n.Transparency
      lprt24n.Transparency = rprt4n.Transparency
      lprt25n.Transparency = rprt4n.Transparency
    end
  end
  if Humanoid.Health <= 0 then
    attack = true
  ...
  stunanim = false
        ...
        if Effects[e] ~= nil then
          ...
          if Thing ~= nil then
            ...
            if Thing[2] == "Shoot" then
              local Look = Thing[1]
              local hit, pos = rayCast(Thing[4], Look, 30, modelzorz)
              ...
              if hit ~= nil then
                ...
                if Thing[8] == 1 then
                  ...
                  if Thing[8] == 2 then
                    Damagefunc(hit, Thing[5], Thing[6], Thing[7], "Normal", RootPart, 0.1, 2, (math.random(3, 8)), nil, nil, true, "Defense", 0.05, 100)
                    if (hit.Parent:findFirstChild("Humanoid")) ~= nil or (hit.Parent.Parent:findFirstChild("Humanoid")) ~= nil then
                      ...
                      MagniDamage(ref, 15, Thing[5] / 1.5, Thing[6] / 1.5, 0, "Normal", ref, 0, 1, (math.random(3, 8)), nil, nil, true, "Defense", 0.025, 100)
                    end
                  end
                end
                ref = part(3, workspace, 0, 1, BrickColor.new("Really red"), "Reference", vt())
            ...
            do
              do
                ...
                -- DECOMPILER ERROR at PC9148: LeaveBlock: unexpected jumping out DO_STMT

                -- DECOMPILER ERROR at PC9148: LeaveBlock: unexpected jumping out IF_THEN_STMT

                -- DECOMPILER ERROR at PC9148: LeaveBlock: unexpected jumping out IF_STMT
    ...
    -- DECOMPILER ERROR at PC9514: LeaveBlock: unexpected jumping out DO_STMT
