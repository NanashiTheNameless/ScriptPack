Basic Stat Change (credit to whoever found this before me) - 
game.Workspace.Stats.SetStat:FireServer("Statname", Stat, "math.random() is the best thing ever")
Stat list: Gender, Magic, Magic2, Reputation, Bounty, Magic Power, EXP, Level, Strength, Defense, Lamina, Aurem.
For Gender, Magic and Magic2 you need to make sure the stat has quotes.

Aurem - 
while true do
wait(0.2)
game.Workspace.Stats.SetStat:FireServer("Aurem", 500, "math.random() is the best thing ever") 
end

Regen MP and Stamina - 
while true do
wait(1)
...
No stats wipe upon new game (everything but level will be wiped) - 
...
No stat wipe on renew (except level) -
game.Workspace.Stats.WipeInventory:Remove()
Instance.new("RemoteEvent", game.Workspace.Stats)
game.Workspace.Stats.RemoteEvent.Name = "WipeInventory"
