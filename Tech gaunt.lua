...
local cone=part(3,modelzorz,0,1,BrickColor.new("Purple"),"Cone",vt(1,1,1))
local conemsh=mesh("SpecialMesh",cone,"FileMesh","http://www.roblox.com/asset/?id=1778999",vt(0,0,0),vt(0.5,0.5,0.5))
local screen1=part(3,modelzorz,0,1,BrickColor.new("Bright red"),"Screen1",vt(1,1,1))
...
local screen3=part(3,modelzorz,0,1,BrickColor.new("Bright green"),"Screen3",vt(1,1,1))
...
local prt6=part(3,modelzorz,0,0,BrickColor.new("White"),"Part6",vt(1,1,1))
...
local prt10=part(3,modelzorz,0,0,BrickColor.new("Bright red"),"Part10",vt(1,1,1))
...
local sprt1=part(3,sword,0,0,BrickColor.new("Bright red"),"Part1",vt(1,1,1))
local sprt2=part(3,sword,0,0,BrickColor.new("Bright red"),"Part2",vt(1,1,1))
local sprt3=part(3,sword,0,0,BrickColor.new("Bright red"),"Part3",vt(1,1,1))
local sprt4=part(3,sword,0,0,BrickColor.new("Bright red"),"Part4",vt(1,1,1))
local sprt5=part(3,sword,0,0,BrickColor.new("Bright red"),"Part5",vt(1,1,1))
local sprt6=part(3,sword,0,0,BrickColor.new("Bright red"),"Part6",vt(1,1,1))
local sprt7=part(3,sword,0,0,BrickColor.new("Bright red"),"Part7",vt(1,1,1))
local sprt8=part(3,sword,0,0,BrickColor.new("Bright red"),"Part8",vt(1,1,1))
local sprt9=part(3,sword,0,0,BrickColor.new("Bright red"),"Part9",vt(1,1,1))
local sprt10=part(3,sword,0,0,BrickColor.new("Bright red"),"Part10",vt(1,1,1))
local sprt11=part(3,sword,0,0,BrickColor.new("Bright red"),"Part11",vt(1,1,1))
local sprt12=part(3,sword,0,0,BrickColor.new("Bright red"),"Part12",vt(1,1,1))
local sprt13=part(3,sword,0,0,BrickColor.new("Bright red"),"Part13",vt(1,1,1))
local sprt14=part(3,sword,0,0,BrickColor.new("Bright red"),"Part14",vt(1,1,1))
local sprt15=part(3,sword,0,0,BrickColor.new("Bright red"),"Part15",vt(1,1,1))
local sprt16=part(3,sword,0,1,BrickColor.new("Bright red"),"Hitbox",vt(1,7,1.5))
local sprt17=part(3,sword,0,0,BrickColor.new("Bright red"),"Top",vt(1,1,1))
local sprt18=part(3,sword,0,1,BrickColor.new("Bright red"),"Mid",vt(0.1,0.1,0.1))
local sprt19=part(3,sword,0,0,BrickColor.new("Bright red"),"Bottom",vt(1,1,1))
...
local snprt1=part(3,sniper,0,0,BrickColor.new("White"),"Part1",vt(1,1,1))
local snprt2=part(3,sniper,0,0,BrickColor.new("White"),"Part2",vt(1,1,1))
local snprt3=part(3,sniper,0,0,BrickColor.new("White"),"Part3",vt(1,1,1))
local snprt4=part(3,sniper,0,0,BrickColor.new("White"),"Part4",vt(1,1,1))
local snprt5=part(3,sniper,0,0,BrickColor.new("White"),"Part5",vt(1,1,1))
local snprt6=part(3,sniper,0,0,BrickColor.new("White"),"Part6",vt(1,1,1))
local snprt7=part(3,sniper,0,0,BrickColor.new("White"),"Part7",vt(1,1,1))
local snprt8=part(3,sniper,0,0,BrickColor.new("White"),"Part8",vt(1,1,1))
local snprt9=part(3,sniper,0,0,BrickColor.new("White"),"Part9",vt(1,1,1))
local snprt10=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part10",vt(1,1,1))
local snprt11=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part11",vt(1,1,1))
local snprt12=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part12",vt(1,1,1))
local snprt13=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part13",vt(1,1,1))
local snprt14=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part14",vt(1,1,1))
local snprt15=part(3,sniper,0,0,BrickColor.new("White"),"Part15",vt(1,1,1))
local snprt16=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part16",vt(1,1,1))
local snprt17=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part17",vt(1,1,1))
local snprt18=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part18",vt(1,1,1))
local snprt19=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part19",vt(1,1,1))
local snprt20=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part20",vt(1,1,1))
local snprt21=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part21",vt(1,1,1))
local snprt22=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part22",vt(1,1,1))
local snprt23=part(3,sniper,0,0,BrickColor.new("White"),"Part23",vt(1,1,1))
local snprt24=part(3,sniper,0,0,BrickColor.new("Bright blue"),"Part24",vt(1,1,1))
local snprt25=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part25",vt(1,1,1))
local snprt26=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part26",vt(1,1,1))
local snprt27=part(3,sniper,0,0,BrickColor.new("White"),"Part27",vt(1,1,1))
local snprt28=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part28",vt(1,1,1))
local snprt29=part(3,sniper,0,0,BrickColor.new("Bright red"),"Part29",vt(1,1,1))
...
ammo.Name="Ammo"
local aprt1=part(3,ammo,0,0,BrickColor.new("Really blue"),"Part1",vt(1,1,1))
local amsh1=mesh("CylinderMesh",aprt1,"","",vt(0,0,0),vt(0.7,0.2,0.7))
local awld1=weld(aprt1,aprt1,RightArm,cf(0,1,0))
numb=0
for i=1,10 do
local aprt2=part(3,ammo,0,0,BrickColor.new("Really blue"),"Part2",vt(1,1,1))
...
Bg.Parent=Head
Bg.cframe=Head.CFrame
con1=sprt16.Touched:connect(function(hit) Damagefunc1(hit,100,100) end) 
...
attack=true
CF=Head.CFrame
con1=sprt16.Touched:connect(function(hit) Damagefunc1(hit,122,122) end) 
...
con1=sprt16.Touched:connect(function(hit) Damagefunc1(hit,122,222) end) 
...
local string1=part(3,sword,0,1,BrickColor.new("Really blue"),"String1",vt(0.5,1,0.5))
...
local string2=part(3,sword,0,1,BrickColor.new("Really blue"),"String2",vt(0.5,1,0.5))
...
Lightning(sprt17.Position,sprt18.Position,3,0.2,"Really Blue",0.00001,0.4)
Lightning(sprt19.Position,sprt18.Position,3,0.2,"Really Blue",0.00001,0.4)
arrowdebounce=true
wait(0.1)
arrowdebounce=false
end
...
swld18.C0=cf(0,1,0)
local arrow=part(3,sword,0,1,BrickColor.new("Really blue"),"Arrow",vt(1,1,1))
...
local ammo=part(3,workspace,0,0,BrickColor.new("Really blue"),"Ammo",vt(1,1,1))
...
effectsg.BrickColor = BrickColor.new("Really blue")
