...
local feacolor = BrickColor.new("Neon orange")
...
function Lightning(Part0,Part1,Times,Offset,Color,Thickness,Trans) -- Lightning module
    ...
    for i=1,Times do
        local li = Instance.new("Part", game.Players.LocalPlayer.Character.Torso)
		li.Name = "Lightning"
		li.TopSurface =0
		li.Material = "Neon"
		li.BottomSurface = 0
...
for _, v in pairs(modref:GetChildren()) do
...
while wait(math.random(0.1,0.2)) do 
	...
	Lightning(SPos1, SPos2, 4, 3, "Cyan", .01, .56) 
end