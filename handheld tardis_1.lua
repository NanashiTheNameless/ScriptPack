-- acb227's TARDIS Vortex Manipulator (Personal Teleport Adaptaton)

-- Added a fix for stupid ROBLOX and their local position bugs.

-- Initial checks.

TeleportPlayer = game:GetService("Players"):FindFirstChild("acb227")
