...
CritMultiplier = 9999999999999.9999999999999
...
Attack = 99999999999999

AddDamage = 99999999999999

AddDamageX =99999999999999

AddShield = 9999999999999

Dmgs = {Smash = {"Smash", 99999999999,999999999999, 999999999999, false}, Slash = {"Slash", 999999999, 999, 999, false}, SideSlash = {"SideSlash", 18, 1, 3, false},

DoubleSlash = {"Double Slash", 999999999999, 999999999999,9999999999999, false}, Spin = {"Spin Slash", 99999, 2, 5, true, 30}, Boom = {"Boom", 99999, 999, 6, true, 50999, 1699},

RageMode = {"RAGE", 99999, 1.35, 1, 50}, Counter = {"Counter", 9999999, 1, 1, true, 1995}, RageSlash = {"Rage Slash", 99999,99999999,99999999999, true, 30}}
