...
m.Parent = h 
m.Scale = Vector3.new(1.1, 0.3, 1.1) 
-----------------------------------------weldling 
w1 = Instance.new("Weld") 
w1.Parent = Workspace.acb227.Torso 
w1.Part0 = h 
w1.Part1 = Workspace.acb227.Torso 
w1.C0 = CFrame.fromEulerAnglesXYZ(7.75, 0, 3) + Vector3.new(0, -0.4, 0) 
...
m = Instance.new("BlockMesh") 
m.Parent = h 
m.Scale = Vector3.new(0.2, 0.1, 0.1) 
-----------------------------------------weldling 
w1 = Instance.new("Weld") 
w1.Parent = Workspace.acb227.Head 
w1.Part0 = h 
w1.Part1 = Workspace.acb227.Head 
w1.C0 = CFrame.fromEulerAnglesXYZ(0, 0, 0.3) + Vector3.new(0.3, -0.2, 0.7) 
