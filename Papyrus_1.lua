-- sethcuzzone5 messed with me, and he thinks he is all cool.
-- Worry not! I, the great Papyrus, has LEAKED HIS SCRIPT.
...
------
hed.face.Texture = "rbxassetid://248526322"
char["Body Colors"].HeadColor = BrickColor.new("Really white")
char["Body Colors"].TorsoColor = BrickColor.new("Really white")
char["Body Colors"].LeftArmColor = BrickColor.new("Really white")
char["Body Colors"].RightArmColor = BrickColor.new("Really white")
------
ypcall(function()
char.Shirt:Destroy()
char.Pants:Destroy()
...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=344743696"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=345049845"
end)
------
dot = false
des = false
...
asd.SoundId = "http://www.roblox.com/asset/?id = 417464011"

asd1 = Instance.new("Sound",player.Character.Torso)
asd1.SoundId = "http://www.roblox.com/asset/?id = 417464011"

asd2 = Instance.new("Sound",player.Character.Torso)
asd2.SoundId = "http://www.roblox.com/asset/?id = 300140664"
asd2.Looped = true
asd3 = Instance.new("Sound",player.Character.Torso)
asd3.SoundId = "http://www.roblox.com/asset/?id = 300140664"
asd3.Looped = true
asd4 = Instance.new("Sound",player.Character.Torso)
asd4.SoundId = "http://www.roblox.com/asset/?id = 300140664"
asd4.Looped = false
asd5 = Instance.new("Sound",player.Character.Torso)
asd5.SoundId = "http://www.roblox.com/asset/?id = 300140664"
asd5.Looped = true
dunkd = Instance.new("Sound",player.Character.Torso)
dunkd.SoundId = "http://www.roblox.com/asset/?id = 300140664"
dunkd.Looped = false
function play(play)
asd:Play()
asd1:Play()
...
eye.BrickColor = BrickColor.new("Crimson")
eye.Material = "Neon"
eye.FormFactor = 3
eye.Shape = "Ball"
...
img.Image = "rbxassetid://398910187"
end
end)
m.KeyDown:connect(function(k)
if k == "c" then
