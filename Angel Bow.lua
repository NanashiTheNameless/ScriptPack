--MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to Line 3,5,21, and 23 and put your name where it says "ic3w0lf589"

while game.Players.ic3w0lf589.PlayerGui:FindFirstChild("EpicBow") == nil do
wait()
if game.Players.ic3w0lf589.PlayerGui:FindFirstChild("EpicBow") == nil then
