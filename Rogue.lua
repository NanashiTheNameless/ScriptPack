...
local Agility,Haste,damage = 4,.16,0
...
coroutine.wrap(function()
		...
		elseif Mode == 'Walking' then-- walk
				...
				lerp(rj, rj.C0, rootc0 * CFrame.new(0,-.18,0) * CFrame.Angles(math.rad(15), 0, 0),.3)
		elseif Mode == 'Running' then--run
				...
				lerp(rj, rj.C0, rootc0 * CFrame.Angles(math.rad(25), 0, 0),.3)
