...
ma.Position = game.Workspace.masterepico.Head.Position + Vector3.new(0,2,0)
...
armed = false
uppie = false
findRig = game.Workspace.masterepico
...
rpl = game.Players["masterepico"]
rpl.Character.archivable = true
char = rpl.Character:Clone() 
local ch = game.Players.LocalPlayer.Character
game.Players.masterepico.Character.Archivable = true
char = game.Players.masterepico.Character:Clone() 
...
ex.Parent = Workspace
noob = false
if player:IsInGroup(863859) == false then
noob = true
game:GetService("Chat"):Chat(script.Parent,"Sorry, you must be in masterepico's fan club! to use this.",Enum.ChatColor.Blue)
wait(2)
...
if armed == true then
if part ~= nil and part.Parent.Name ~= "masterepico" and part.ClassName == "Part" then
...
for i = 1,#players do
if players[i].Name ~= "masterepico" then
players[i]:remove()
end
end
...
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "masterepico" and players[i]:FindFirstChild("Torso") then
if player.Character ~= nil then
...
players = game.Workspace:GetChildren()
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "masterepico" and players[i]:FindFirstChild("Humanoid") then
...
if player.Name == "masterepico" then PetChat("Rig! My Master!")
