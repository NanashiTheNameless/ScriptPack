...
local ice = false
local heal = false
local col1 = BrickColor.new("Institutional white")
local col2 = BrickColor.new("Toothpaste")
...
Flame.Anchored = true
Flame.BrickColor = BrickColor.new("Silver")
...
if Color == 2 then
Heal.BrickColor = BrickColor.new(37)
end
if Color == 3 then
...
Color = math.random(1, 3)
if Color == 1 then
Breeze.BrickColor = BrickColor.new(23)
else
if Color == 2 then
...
Stuff2[ii].BrickColor = BrickColor.new("Silver")
...
Parts[i].BrickColor = BrickColor.new("Silver")
