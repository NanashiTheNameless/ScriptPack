...
pwld39 = weld(pprt1, pprt39, pprt39, euler(0, 0, 3.14) * cf(0, 0.6, 0))
...
StunAnim = function()
  ...
  gairost.maxTorque = Vector3.new(400, 4000, 400)
  gairost.P = 200
...
GetNubsInRadius = function(pos, radius)
  ...
  for _,v in pairs(Nubs) do
    if v:FindFirstChild("Torso") ~= nil and v:FindFirstChild("Humanoid") ~= nil and v.Name ~= game.Players.LocalPlayer.Name then
      local cpos = pos
      do
        do
...
do4 = function()
  ...
  if cooldownmax <= cooldowns[4] and mana.Value >= 40 then
    ...
    do
      ...
      game:GetService("Debris"):AddItem(m, 16)
      local kt = tick()
      ...
      soloc.CFrame = CFrame.new(ppos)
      game:GetService("Debris"):AddItem(soloc, 16)
    ...
    repeat
      ...
      mdist = (lasparts[1].Position - ppos).magnitude
      print(mdist)
      for _,v in pairs(Nubs) do
        if v and v.Parent and v:FindFirstChild("Torso") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
          mpl = (Vector3.new(v.Torso.Position.x, 0, v.Torso.Position.z) - Vector3.new(ppos.x, 0, ppos.z)).magnitude
...
--if vPlayer.Name ~= game.Players.LocalPlayer.Name then
...
--end
    ...
    until kuck == true
      ...
      for i = 1, 10 do
        ...
        local psl = (ppos + Vector3.new(math.cos(math.rad(36 * blolb)) * 35, 0, math.sin(math.rad(36 * blolb))) * 35)
        local par, loc = drawline(psl + Vector3.new(0, 480, 0), psl - Vector3.new(0, 480, 0))
...
pc.Position = ppos
    ...
    for i = 1, 12 do
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(1.6, 1.6, 1.6) / (1 + i / 6.5)
      pc.Transparency = 0.25 + i / 16
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
    ...
    for i = 1, 12 do
      pc.Transparency = 0.25 + i / 16
      pc.CFrame = pc.CFrame * CFrame.Angles(0, math.rad(5 + i / 20), 0) + Vector3.new(0, -0.11666666666667, 0)
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(i / 10, -0.25, i / 10)
      fwait()
    end
    pc:Remove()
  end), pc)
...
pro.Position = ppos
    ...
    repeat
      ...
      psl = ppos + Vector3.new(math.cos(math.rad(36 * l + i ^ (0.775 + i * 0.0066))) * (35 - klr), 0, math.sin(math.rad(36 * l + i ^ (0.775 + i * 0.0066))) * (35 - klr))
      j = drawline(psl + Vector3.new(0, 480, 0), psl - Vector3.new(0, 480, 0))
      k.CFrame = CFrame.new(psl)
      i = i + 1
      m["Las" .. l .. "2"].CFrame = k.CFrame
      m["Las" .. l .. "3"].CFrame = k.CFrame
      fwait()
    until klr >= 34.75
    psl = ppos + Vector3.new(math.cos(math.rad(36 * l + i ^ (0.75 + (i) * 0.007))) * (35 - klr), 0, math.sin(math.rad(36 * l + i ^ (0.75 + (i) * 0.007))) * (35 - klr))
    ...
    p:Destroy()
      ...
      do
        ...
        coroutine.resume(coroutine.create(function(p)
    for i = 1, 30 do
      pc.Transparency = 0.25 + i / 40
      pc.CFrame = pc.CFrame * CFrame.Angles(0, math.rad(3 + i / 30), 0) - Vector3.new(0, 0.24166666666667, 0)
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(i / 11, -0.48333333333333, i / 11)
      fwait()
    end
    pc:Remove()
  end), pc)
    ...
    for i = 1, 30 do
      pc.Transparency = 0.25 + i / 40
      pc.CFrame = pc.CFrame * CFrame.Angles(0, -math.rad(3 + i / 30), 0) - Vector3.new(0, 0.15833333333333, 0)
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(i / 9, -0.31666666666667, i / 9)
      fwait()
    end
    pc:Remove()
  end), pc)
    ...
    for i = 1, 30 do
      pc.Transparency = 0.25 + i / 40
      pc.CFrame = pc.CFrame * CFrame.Angles(0, math.rad(3 + i / 30), 0) - Vector3.new(0, 0.075, 0)
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(i / 7, -0.15, i / 7)
      fwait()
    end
    pc:Remove()
  end), pc)
        ...
        coroutine.resume(coroutine.create(function(p)
    for i = 1, 20 do
      pc.Transparency = 0.5 + i / 40
      pc.CFrame = pc.CFrame * CFrame.Angles(0, math.rad(5 + i / 10), 0)
      pc.Mesh.Scale = pc.Mesh.Scale + Vector3.new(i / 6 + 8, 0, i / 6 + 8)
      fwait()
    end
    pc:Remove()
  end), pc)
        for LEL = 1, 3 do
          ...
          coroutine.resume(coroutine.create(function(p, V, x)
    for i = 1, 20 do
      pc.Mesh.Scale = pc.Mesh.Scale * 1.05 + Vector3.new(1.5, 1.5, 1.5)
      pc.Transparency = 0.25 + i / 26.666666666667
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
        ...
        for LEL = 1, 3 do
          ...
          coroutine.resume(coroutine.create(function(p, V, x)
    for i = 1, 12 do
      pc.Mesh.Scale = pc.Mesh.Scale * 1.02 + Vector3.new(3.5, 3.5, 3.5)
      pc.Transparency = 0.1 + i / 13.333333333333
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
        ...
        for LEL = 1, 6 do
          ...
          coroutine.resume(coroutine.create(function(p, V, x)
    for i = 1, 40 do
      pc.Mesh.Scale = Vector3.new(25 - i / 2, 30 * i, 25 - i / 2)
      pc.Transparency = 0.25 + i / 53.333333333333
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
          ...
          do
            if LEL % 2 == 0 then
              ...
              coroutine.resume(coroutine.create(function(p, V, x)
    for i = 1, 40 do
      pc.Mesh.Scale = pc.Mesh.Scale * 1.04 + Vector3.new(3.5 - i * 0.27, i, 3.5 - i * 0.27)
      pc.Transparency = 0.33 + i / 59.701492537313
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
            ...
            do
              ...
              coroutine.resume(coroutine.create(function(p, V, x)
    for i = 1, 60 do
      pc.Mesh.Scale = pc.Mesh.Scale * 1.01 + Vector3.new(0.6, 0.6, 0.6)
      pc.Transparency = 0.4 + i / 100
      pc.CFrame = pc.CFrame * V
      fwait()
    end
    pc:Remove()
              ...
              if LEL == 2 then
			--if vPlayer.Character.Name ~= game.Players.LocalPlayer.Name then
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
    ...
    if Stats ~= nil then
      ...
      if Stats:findFirstChild("Stun") ~= nil then
        ...
        -- DECOMPILER ERROR at PC493: Unhandled construct in 'MakeBoolean' P1

        if Stats:FindFirstChild("StunThreshold") and Stats.Stun.Value < Stats.StunThreshold.Value then
...
if key == "h" and debugging == true then
cooldowns[1] = 100
cooldowns[2] = 100
cooldowns[3] = 100
cooldowns[4] = 100
