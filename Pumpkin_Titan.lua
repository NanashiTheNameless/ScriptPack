...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=133081718"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=133081733"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
----------------------------------------------------
game:service'InsertService':LoadAsset(132809431):children()[1].Parent=char
char.TheDusekkar.Handle.Mesh.Scale = char.TheDusekkar.Handle.Mesh.Scale * 1.8
char.TheDusekkar.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
hed.face.Texture = "rbxassetid://46282671"
g = Instance.new('Fire',game.Players.localPlayer.Character.Head)
g.Size = 10
g.Color = Color3.new(0,255,0)
game:service'InsertService':LoadAsset(120507280):children()[1].Parent=char
char.WebbedWings.Handle.Mesh.Scale = char.WebbedWings.Handle.Mesh.Scale * 2
char.WebbedWings.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
hed.face.Texture = "rbxassetid://46282671"
game:service'InsertService':LoadAsset(215718515):children()[1].Parent=char
char.FlamingHorns.Handle.Mesh.Scale = char.FlamingHorns.Handle.Mesh.Scale * 2
char.FlamingHorns.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
hed.face.Texture = "rbxassetid://1"
p.Character.Head.Transparency = 1313131
z=Instance.new('Decal',hed)
z.Face = 'Front'
z.Texture='rbxassetid://1'
hed.BrickColor = BrickColor.new("Industrial White")
...
z.SoundId = "rbxassetid://143382469"
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.01)
...
function Landing()
    ...
    for i,v in pairs(FindNearestTorso(torso.CFrame.p,40))do
        if v:FindFirstChild('Humanoid') then
            v.Humanoid:TakeDamage(math.random(99999999,399999990))
...
function GroundPound()
    ...
    for i,v in pairs(FindNearestTorso(torso.CFrame.p,12))do
        if v:FindFirstChild('Humanoid') then
            v.Humanoid:TakeDamage(math.random(99999999,9999999999))
        end
    end
    coroutine.resume(coroutine.create(function() 
...
function Stomp()
    ...
    for i,v in pairs(FindNearestTorso(torso.CFrame.p,50))do
        if v:FindFirstChild('Humanoid') then
            v.Humanoid:TakeDamage(math.random(99999,99999999))
            v.Humanoid.PlatformStand = true
            v:FindFirstChild("Torso").Velocity = hed.CFrame.lookVector * 100
        end
    end 
                    ...
                    if hit.Name ~= p.Name then
                        --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(999999999)
                                wait(1)
        ...
        elseif ht and hit:IsA("Hat") then
            if hit.Parent.Name ~= p.Name then
                if hit.Parent:FindFirstChild("Humanoid") then
                       --[[ if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                hit.Parent:FindFirstChild("Humanoid"):TakeDamage(999999999)
                                wait(1)
                    --Debounces.Slashed = false
                end
            end
        ...
        Spawn(function()
            ...
            for Y = -5,5 do
                ...
                --[[P.Touched:connect(function(ht)
                    local hit = ht.Parent
                    if hit:FindFirstChild("Humanoid") then
                        hit.Humanoid:TakeDamage(math.random(2323232,3232323))
                    end
                end)]]--
        ...
        if ht and hit:IsA("Model") then
                if hit:FindFirstChild("Humanoid") then
                    if hit.Name ~= p.Name then
                        --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(math.random(323232,323232323))
        ...
        elseif ht and hit:IsA("Hat") then
            if hit.Parent.Name ~= p.Name then
                if hit.Parent:FindFirstChild("Humanoid") then
                        --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                hit.Parent:FindFirstChild("Humanoid"):TakeDamage(math.random (32323,3232323))
                                hit:FindFirstChild("Humanoid").PlatformStand = true
                                wait(1)
                    --Debounces.Slashed = false
                --end
            ...
            if ht and hit:IsA("Model") then
                    if hit:FindFirstChild("Humanoid") then
                        if hit.Name ~= p.Name then
                            --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(3232323)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
            ...
            elseif ht and hit:IsA("Hat") then
                if hit.Parent.Name ~= p.Name then
                    if hit.Parent:FindFirstChild("Humanoid") then
                           --[[ if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit.Parent:FindFirstChild("Humanoid"):TakeDamage(3232323)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
                                    hit:FindFirstChild("Torso").Velocity = hit:FindFirstChild("Torso").CFrame.lookVector * -120
                        --Debounces.Slashed = false
                    end
...
hit:FindFirstChild("Humanoid"):TakeDamage(math.random(32323,3232323))
end)()
        ...
        if Debounces.CanAttack == true then
            ...
            PTZ = {0.7, 0.8, 0.9, 1}
                ...
                for i,v in pairs(FindNearestTorso(torso.CFrame.p,25))do
                    if v:FindFirstChild('Humanoid') then
                        v.Humanoid:TakeDamage(math.random(32323,323232323))
                        v.Humanoid.PlatformStand = true
                        v:FindFirstChild("Torso").Velocity = hed.CFrame.lookVector * 100
                    end
                end
