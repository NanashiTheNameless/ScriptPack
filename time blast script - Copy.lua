...
function onButton1Down(mouse)
	...
	fer.Size = 30
	fer.Heat = 18
	fer.Color = BrickColor.new("Really black").Color
	fer.SecondaryColor = BrickColor.new("Really black").Color
	local smk = Instance.new("Smoke",Torso)
	smk.Opacity = 1
	smk.RiseVelocity = 25
	smk.Size = 12
	smk.Color = BrickColor.new("Really black").Color
...
function MidCharge()
	...
	wow2.BrickColor = BrickColor.new("Really black")
	...
	wow11.BrickColor = BrickColor.new("Really black")
	...
	Taco.Visible = true
	Taco.Color = BrickColor.new("Really black")
	...
	Taco5.Color = BrickColor.new("Really black")
