-- (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 5 and 6 and put your name where it says "YOUR NAME HERE"



Names = "peyquinn"--------your name goes here
Player = game:GetService("Players").peyquinn---------------------------your name goes also here
...
RightArm.BrickColor = BrickColor.new("Camo")
LeftArm.BrickColor = BrickColor.new("Camo")
RightLeg.BrickColor = BrickColor.new("Brown")
LeftLeg.BrickColor = BrickColor.new("Brown")
Torso.Reflectance = 0
Head.Reflectance = 0
