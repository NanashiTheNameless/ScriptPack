...
venabled = true
zenabled = true
pathcolor = BrickColor.new("Royal purple")
shoot = false
...
fenbarmana4.TextColor = BrickColor.new("Royal purple")
local fengui = it("GuiMain")
fengui.Parent = Player.PlayerGui
fengui.Name = "WeaponGUI"
  ...
  if h ~= nil and hit.Parent.Name ~= Character.Name and hit.Parent:FindFirstChild("Torso") ~= nil then
    ...
    if CRITTING == false then
      if blocked == false then
        ...
        showDamage(hit.Parent, Damage, 0.5, BrickColor.new("Black"))
        if HitHealth ~= h.Health and HitHealth ~= 0 and h.Health <= 0 and h.Parent.Name ~= "Lost Soul" then
          print("gained kill")
        ...
        h.Health = h.Health - math.huge
        showDamage(hit.Parent, math.huge, 0.5, BrickColor.new("Royal purple"))
      end
    else
      MagicRing1(BrickColor.new("Royal purple"), h.Parent.Torso.CFrame * angles(math.rad(math.random(1, 360)), math.rad(math.random(1, 360)), math.rad(math.random(1, 360))), 2, 2, 1, 1, 1, 0, 0.2)
      h.Health = h.Health - math.huge
      HitHealth = h.Health
      showDamage(hit.Parent, math.huge, 0.5, BrickColor.new("Royal purple"))
      if HitHealth ~= h.Health and HitHealth ~= 0 and h.Health <= 0 and h.Parent.Name ~= "Lost Soul" then
...
HandleA = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 1, "Royal purple", "Handle", Vector3.new(0.200000003, 0.399999917, 0.200000003))
...
HitboxA = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 1, "Royal purple", "HitboxA", Vector3.new(1.01999998, 0.600000024, 1.01999998))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.800000012, 0.200000003, 1))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Really black", "Part", Vector3.new(0.400000036, 0.200000003, 1))
...
mesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.620000005))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.600000024))
Partweld = weld(m, HandleA, Part, CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1), CFrame.new(-0.399993896, -0.500012636, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.399999917, 0.200000003))
Partweld = weld(m, HandleA, Part, CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1), CFrame.new(-0.399993896, -0.800000429, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.99999994, 0.220000014))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.819999993, 0.200000003, 0.200000003))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(1.01999998, 0.200000003, 1.01999998))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.400000036))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0.5, "Really black", "Part", Vector3.new(0.800000012, 0.800000012, 0.800000012))
...
Blood.Color = ColorSequence.new(Color3.new(17/255,0,1))
Blood.Name = "Blood"
...
Blood.ZOffset = 4
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.99999994, 0.200000003))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.420000017))
...
HandleB = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 1, "Royal purple", "Handle", Vector3.new(0.200000003, 0.399999917, 0.200000003))
...
HitboxB = part(Enum.FormFactor.Custom, m, Enum.Material.SmoothPlastic, 0, 1, "Royal purple", "HitboxB", Vector3.new(1.01999998, 0.600000024, 1.01999998))
...
mesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
moosic = Instance.new("Sound",Character)
moosic.SoundId, moosic.Volume, moosic.Looped = "rbxassetid://148515294", 1.25, true
moosic:Play()
attackone = function()
  attack = true
  for i = 0, 1, 0.2 do
  ...
  local con = HitboxA.Touched:connect(function(hit)
    Damagefunc(hit, math.huge, math.huge, 0, "Normal", RootPart, 0.2, 1)
  end
)
  for i = 0, 1, 0.2 do
    swait()
...
attackthree = function()
  ...
  local con = RightLeg.Touched:connect(function(hit)
    Damagefunc(hit, math.huge, math.huge, math.random(5, 10), "Normal", RootPart, 0.2, 1)
  end
)
  for i = 0, 1, 0.2 do
    swait()
...
DashRun = function()
  ...
  so("http://roblox.com/asset/?id=200632370", Torso, 1, 1)
  so("rbxassetid://291088606", Torso, 1.5, 1)
  MagicRing1(BrickColor.new("Royal purple"), RootPart.CFrame * angles(math.rad(0), math.rad(0), math.rad(0)), 5, 5, 1, 5, 5, 0, 0.2)
...
Invisa = function()
  ...
  MagicBlock(BrickColor.new("Black"), RootPart.CFrame, 5, 5, 5, 0.7, 0.7, 0.7, 0.1)
  MagicBlock(BrickColor.new("Dark indigo"), RootPart.CFrame, 3, 3, 3, 1, 1, 1, 0.1)
  coroutine.resume(coroutine.create(function()
    invisle()
  end
))
...
crittle = function()
  ...
  coroutine.resume(coroutine.create(function()
    while CRITTING do
      wait(0.75)
      MagicBlock(BrickColor.new("Black"), HitboxA.CFrame, 1, 1, 1, 0.7, 0.7, 0.7, 0.2)
      MagicBlock(BrickColor.new("Dark indigo"), HitboxA.CFrame, 1, 1, 1, 1, 1, 1, 0.2)
      MagicBlock(BrickColor.new("Black"), HitboxB.CFrame, 1, 1, 1, 0.7, 0.7, 0.7, 0.2)
      MagicBlock(BrickColor.new("Dark indigo"), HitboxB.CFrame, 1, 1, 1, 1, 1, 1, 0.2)
    end
  end
))
  for i = 1, 500 do
...
critt = function()
  ...
  so("http://roblox.com/asset/?id=200632370", Torso, 1, 1)
  MagicRing1(BrickColor.new("Royal purple"), HitboxA.CFrame * angles(math.rad(math.random(1, 360)), math.rad(math.random(1, 360)), math.rad(math.random(1, 360))), 1, 1, 1, 1, 1, 0, 0.2)
  MagicRing1(BrickColor.new("Black"), HitboxA.CFrame * angles(math.rad(math.random(1, 360)), math.rad(math.random(1, 360)), math.rad(math.random(1, 360))), 1, 1, 1, 1, 1, 0, 0.2)
  MagicRing1(BrickColor.new("Royal purple"), HitboxB.CFrame * angles(math.rad(math.random(1, 360)), math.rad(math.random(1, 360)), math.rad(math.random(1, 360))), 1, 1, 1, 1, 1, 0, 0.2)
  MagicRing1(BrickColor.new("Black"), HitboxB.CFrame * angles(math.rad(math.random(1, 360)), math.rad(math.random(1, 360)), math.rad(math.random(1, 360))), 1, 1, 1, 1, 1, 0, 0.2)
  coroutine.resume(coroutine.create(function()
    crittle()
  end
))
...
FlipKick = function()
  ...
  local con = RightLeg.Touched:connect(function(hit)
    Damagefunc(hit, math.huge, math.huge, 0, "Knockdown", RootPart, 0.2, 1)
  end
)
  for i = 0, 1, 0.1 do
    swait()
...
UpperCutKick = function()
  ...
  so("http://roblox.com/asset/?id=200632370", Torso, 1, 0.9)
  local con = RightLeg.Touched:connect(function(hit)
    Damagefunc(hit, math.huge, math.huge, math.random(5, 10), "Knockdown", RootPart, 0.2, 1)
  end
)
  MagicRing1(BrickColor.new("Royal purple"), RootPart.CFrame * angles(math.rad(90), math.rad(0), math.rad(0)) + vt(0, -3, 0), 5, 5, 1, 5, 5, 0, 0.2)
  for i = 0, 1, 0.05 do
    swait()
    MagicBlock(BrickColor.new("Black"), RightLeg.CFrame, 2, 2, 2, 0.7, 0.7, 0.7, 0.1)
    MagicBlock(BrickColor.new("Dark indigo"), RightLeg.CFrame, 3, 3, 3, 1, 1, 1, 0.1)
  ...
  MagicRing1(BrickColor.new("Royal purple"), RootPart.CFrame * angles(math.rad(90), math.rad(0), math.rad(0)) + vt(0, -3, 0), 2, 2, 1, 5, 5, 0, 0.2)
  for i = 0, 1, 0.1 do
    swait()
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, 0) * angles(math.rad(-30), math.rad(0), math.rad(0)), 0.3)
    Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(math.rad(20), math.rad(0), math.rad(0)), 0.3)
