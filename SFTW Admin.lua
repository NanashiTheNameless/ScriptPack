...
function makecmd(Command,Func)
    table.insert(Commands,{Command=Command,Func=Func})
end
 
function shutdown()
        local AVariableIDoNotNeed = Instance.new("ManualSufaceJointInstance",workspace)
end
    ...
    s.Chatted:connect(function(c)
        SearchCommand(c,s)
                if CheckAdmin(s) then
                        if Bubble==true then
                                Game:GetService("Chat"):Chat(game.Workspace[s.Name].Head,c,Enum.ChatColor.Blue) 
                        end
                end
    end)
end
...
makecmd("k",Kill)
makecmd("kill",Kill)
makecmd("administrator",Admin)
makecmd("fre",Fire)
makecmd("unfre",UnFire)
makecmd("forcefield",ForceField)
makecmd("unforcefield",UnForceField)
makecmd("ff",ForceField)
makecmd("unff",UnForceField)
makecmd("s",NewScript)
makecmd("base",CreateBase)
makecmd("kck",Kick)
makecmd("tp",Teleport)
makecmd("pnish",Punish)
makecmd("unpnish",UnPunish)
makecmd("removescript",ScriptRemove)
makecmd("m",Message)
makecmd("noob",Noobify)
makecmd("zombie",Zombify)
makecmd("ex",Bomb)
makecmd("bomb",Bomb)
makecmd("sit",Sit)
makecmd("jmp",Jump)
makecmd("afk",Punish)
makecmd("back",UnPunish)
makecmd("ban",Ban)
makecmd("fakeff",SelectBody)
makecmd("unfakeff",UnSelectBody)
makecmd("invisible",Invisible)
makecmd("visible",UnInvisible)
makecmd("frz",Freeze)
makecmd("thaw",UnFreeze)
makecmd("unfrz",UnFreeze)
makecmd("debug",Debug)
makecmd("getip",FindIP)
makecmd("sdk",SDeek)
makecmd("undk",UnDeek)
makecmd("dk",Deek)
makecmd("hdk",HDeek)
makecmd("removehats",RemoveHats)
makecmd("sound",Music)
makecmd("name",Rename)
makecmd("rename",Rename)
makecmd("n",Rename)
makecmd("health",Health)
makecmd("shutdown",Shutdown)
makecmd("commands",GetCommands)
makecmd("bc",ChangeBCType)
makecmd("2w",Rpe)
makecmd("rpe",Rpe)
makecmd("rocket",Rocket)
makecmd("stickman",StickFigure)
makecmd("enablechat",EnableBubbleChat)
makecmd("disablechat",DisableBubbleChat)
makecmd("enablepri",EnablePri)
makecmd("disablepri",DisablePri)
makecmd("respawn",Respawn)
makecmd("unadmin",UnAdmin)
makecmd("h",Hint)
makecmd("seeplayers",PrintPlayers)
makecmd("clone",Rename)
makecmd("copy",Rename)
--[[Connections]]--
for i,v in pairs(game.Players:GetPlayers()) do
    Chatted(v)
