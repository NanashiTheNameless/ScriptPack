...
Colors = {}
Colors.Fire = 'Medium blue'
Colors.Handle = 'Medium blue'
Colors.Handle2 = 'Medium blue'
Colors.Ball = 'Medium blue'
Colors.Ball2 = 'Medium blue'
Colors.Ring = 'Medium blue'
...
if which == 'R' then
if not rw then
        rabr = Part(1,1,1,'Medium blue',1,false,false)
...
elseif which == 'L' then
if not lw then
        labr = Part(1,1,1,'Medium blue',1,false,false)
...
function wave()
        ...
        local p = Part(3,3,3,'Teal',0,true,true)
        ...
        for i = 0,1,.15 do
                ...
                local cl = Part(3,3,3,'Teal',0,true,true)
...
function spin()
        ...
        bb = Part(.1,.1,.1,'Medium blue',0,false,false)
        msh = Mesh(bb,2,1,1,1)
        Weld(bb,ball,0,0,0,0,0,0)
        bb2 = Part(.1,.1,.1,'White',0,false,false)
...
function teleport() 
p = Part(1,1,1,'Deep blue',.5,false,false)
...
function beam()
        ...
        Grow:Play()
        for o = 1,10 do wait()
        local spike = Part(5,1,5,'Teal',.5,true,true)
...
function shoot()
        ...
        r = 15 walls = {}
        for i = 1,360,30 do
                po = Part(((r*2)*math.pi/(360/30)),10,3,'Cyan',0,true,true)
...
function tidal()
        ...
        Charge:Play()
        for i = 1,20 do wait()
                p = Part(3,3,3,'Deep blue',.7,false,true)
        ...
        Tide:Play()
        mp = Part(20,10,1,'Deep blue',0,false,true)
        stopped = false
        coroutine.wrap(function()
                while wait() and not stopped do
                        local cl = Part(20,10,1,'Deep blue',0,false,true)
