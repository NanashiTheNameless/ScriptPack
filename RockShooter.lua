...
Prt12=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part12",vt(1,1,1))
Prt13=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part13",vt(1,1,1))
Prt14=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part14",vt(1,1,1))
Prt15=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part15",vt(1,1,1))
Prt16=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part16",vt(1,1,1))
Prt17=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part17",vt(1,1,1))
...
Prt20=part(1,Main,0.5,0,BrickColor.new("Neon orange"),"Part20",vt(1,1,1))
Prt21=part(1,Main,0.5,0,BrickColor.new("Neon orange"),"Part21",vt(1,1,1))
Prt22=part(1,Main,0,0,BrickColor.new("Neon orange"),"Part22",vt(1,1,1))
...
MMMAGIC(RightArm,3,3,3,0,-math.random(0,3)-math.random(),0,BrickColor.new("Neon orange")) 
end
equipweld() 
for i = 0,1,0.1 do 
wait()  
...
MOREMAGIX(Ballprt,0,2,2,2,BrickColor.new("Neon orange")) 
local pos4 = vt(MMouse.Hit.p.x,Head.Position.Y,MMouse.Hit.p.z)
bg.cframe = cf(Torso.Position,pos4)*euler(0,0,0)*cf(0,0,0)
bg.Parent = Torso
offset=(Torso.Position.y-MMouse.Hit.p.y)/60
...
effectsg.BrickColor = BrickColor.new("Neon orange") 
...
MOREMAGIX(effectsg,0,2,2,2,BrickColor.new("Neon orange")) 
coroutine.resume(coroutine.create(function()
--[[for i = 0 , 1 , 0.1 do
wait()
