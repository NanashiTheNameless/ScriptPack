...
local prt2=part(3,modelzorz,0,0,Color1,"Part2",vt())
...
local prt11=part(3,modelzorz,0,0,Color1,"Part11",vt())
...
local prt14=part(3,modelzorz,0.6,0.4,Color1,"Part14",vt())
prt14.Material="Plastic"
local prt15=part(3,modelzorz,0,0,BrickColor.new("Dark stone grey"),"Part15",vt())
local prt16=part(3,modelzorz,0.6,0.4,Color1,"Part16",vt())
prt16.Material="Plastic"
local prt17=part(3,modelzorz,0.6,0.4,Color1,"Part17",vt())
prt17.Material="Plastic"
...
n2=n2+1
Name="Part"..n2
local prt6=part(3,modelzorz,0,0,Color1,Name,vt())
...
MagniDamage(Torso,13,10,20,math.random(20,40),"Knockdown")
so("http://www.roblox.com/Asset?ID=87784452",Torso,1,1.2)
for i=1,3 do
MagicBlock(Color1,Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,3,3,3,0.03,2,Torso)
MagicCircle(Color1,Torso.CFrame,1,1,1,3,3,3,0.01)
end
end
if explode==false then
MagniDamage(ef,5,5,10,math.random(10,20),"Charge")
end
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-0.2-1.37*i,2.5+0.2*i,0)*cf(-0.2+0.2*i,1,-0.2+0.2*i)
Torso.Neck.C0=necko*euler(0,0,-1+0.5*i)
...
MagniDamage(ef,6,5,10,math.random(5,10),"Normal")
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-0.2-1.37*i,2.5+0.2*i,0)*cf(-0.2+0.2*i,1,-0.2+0.2*i)
Torso.Neck.C0=necko*euler(0,0,-1+0.5*i)
Torso.Neck.C1=necko2*euler(-0.2,0,0)
...
Humanoid.WalkSpeed=10
CF=RootPart.CFrame
local ef=part(3,workspace,0,0.2,Color1,"Effect",vt(1,1,1))
ef.Anchored=true
ef.CFrame=CF
...
MagicBlock(Color1,ef.CFrame*cf(math.random(-100,100)/100,math.random(-100,100)/100,math.random(-100,100)/100)*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,1,1,1,0.05,2,ef)
Part.Transparency=i
end
ef.Parent=nil
end),ef,efmsh,CF)
...
print("boop")
MagicBlock(Color1,Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),3,3,3,1,1,1,0.02,2,Torso)
...
Damagefunc(Tors,20,40,math.random(40,70),"Knockdown",RootPart,1,1,9999,0)
--for i=1,2 do
MagicCircle(Color1,Tors.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),5,5,5,-.05,4,-.05,0.01)
--end
for i=0,1,0.2 do
swait()
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
...
MagicCircle(Color1,Part.CFrame,150,150,150,-2,-2,-2,0.03)
for i=1,20 do
wait()
for i=1,2 do
MagicBlock(Color1,Part.CFrame*cf(math.random(-20,20),math.random(-20,20),math.random(-20,20))*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,1,1,1,0.05,2,Part)
end
end
end),RootPart)
...
if i==0.6 and explode==true then
MagniDamage(Torso,10,10,15,math.random(20,40),"Knockdown")
so("http://www.roblox.com/Asset?ID=87784452",Torso,1,1.2)
for i=1,3 do
MagicBlock(Color1,Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,3,3,3,0.05,2,Torso)
MagicCircle(Color1,Torso.CFrame,1,1,1,3,3,3,0.03)
end
end
if explode==false then
MagniDamage(ef,5,5,10,math.random(5,10),"Charge")
end
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
...
MagniDamage(ef,7,5,10,1,"Normal")
...
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
MagicCircle(Color1,RightArm.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.2,2,.2,.2,8,.2,0.05)
...
ef.Anchored=true
ef.CFrame=RightArm.CFrame*cf(0,-2,0)
MagniDamage(ef,7,10,15,1,"Normal")
game:GetService("Debris"):AddItem(ef,1)
RW.C0=cf(1.5+num2,0.5+num3,-i)*euler(1.3,1.07+num,0)
