...
local prt3=part(3,modelzorz,0,0,BrickColor.new("Black"),"Part3",vt(0.55,0.5,0.55))
local prt7=part(3,modelzorz,0,0.3,BrickColor.new("White"),"Part7",vt(1,1,1))
local prt8b=part(3,modelzorz,0,1,BrickColor.new("Black"),"Skill Crystal Reference",vt(0.2,0.2,0.2))
local prt8=part(3,modelzorz,0,0.5,BrickColor.new("Bright red"),"Skill Crystal 1",vt(1,1,1))
local prt9b=part(3,modelzorz,0,1,BrickColor.new("Black"),"Skill Crystal Reference",vt(0.2,0.2,0.2))
local prt9=part(3,modelzorz,0,0.5,BrickColor.new("Bright blue"),"Skill Crystal 2",vt(1,1,1))
local prt10b=part(3,modelzorz,0,1,BrickColor.new("Black"),"Skill Crystal Reference",vt(0.2,0.2,0.2))
local prt10=part(3,modelzorz,0,0.5,BrickColor.new("Bright green"),"Skill Crystal 3",vt(1,1,1))
local prt11b=part(3,modelzorz,0,1,BrickColor.new("Black"),"Skill Crystal Reference",vt(0.2,0.2,0.2))
local prt11=part(3,modelzorz,0,0.5,BrickColor.new("Black"),"Skill Crystal 4",vt(1,1,1))
local prt14b=part(3,modelzorz,0,1,BrickColor.new("Black"),"Skill Crystal Reference",vt(0.2,0.2,0.2))
...
local prt13=part(3,modelzorz,0,1,BrickColor.new("Black"),"Hitbox",vt(1,7,1))
...
local prt4=part(3,modelzorz,0,0,BrickColor.new("Black"),"Part4",vt(0.2,0.8,0.2))
local prt5=part(3,modelzorz,0,0,BrickColor.new("Black"),"Part5",vt(0.2,0.2,0.2))
local prt6=part(3,modelzorz,0,0,BrickColor.new("Black"),"Part6",vt(0.2,0.8,0.2))
...
CrystalEffect(prt11)
ChangeBaseColor("Black")
local basepart=part(3,workspace,0,0.1,BrickColor.new("Black"),"BasePart",vt(1,1,1))
...
Lightning(prt7.Position,basepart.Position+vt(math.random(-numb,numb),math.random(-numb,numb),math.random(-numb,numb)),5,1,"Black",0.3,0.1)
numb=numb+0.05
end
...
for i=1,300 do
wait()
MagicBlock(BrickColor.new("Black"),Partt.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,0.2,10,0.2)
MagicCircle(BrickColor.new("Black"),Partt.CFrame*cf(math.random(-50,50),-8,math.random(-50,50)),1,1,1,0,0,0,0.2,5,0.2)
end
rifting=false
basepart.Parent=nil
end),Part)
