...
Sounds = {
	Fire = {Id = Asset..(131835524), Pitch = .9, Volume = 1},
	Reload = {Id = Asset..(131072992), Pitch = 1, Volume = 0.5},
...
Handle = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.5, 0.9, 0.9))
TW.Part1 = Handle

Handle2 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.5, 0.6, 1.6))
Weld(Handle, Handle2, CA(MR(-45), 0, 0), CN(0, 0.5, -0.4))

Handle3 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.5, 0.7, 1.3))
...
Pump = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.45, 0.45, 1.1))
Add.Block(Pump, V3(1,1,1), 0.225/2)
PumpWeld = Weld(Pipe2, Pump, CN(0, 0, 0.6), CN(0, 0, 0))

Pump2 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.5, 0.5, 0.3))
Add.Block(Pump, V3(1,1,1), 0.13)
Weld(Pump, Pump2, CN(0, 0, -0.5))

for degrees = -20, 200, 20 do
	local Derp = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.2, 0.2))
	Add.Block(Derp, V3(0.4,0.6,0.4), 0.02)
	Weld(Handle3, Derp, CN(0, -0.45, -0.32) * CA(MR(degrees), 0, 0), CN(0, 0, -0.2))
end

Derp = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.2, 0.3))
Add.Block(Derp, V3(0.4,1,1), 0.02)
Weld(Handle3, Derp, CN(0, 0, -0.32) * CA(MR(-20), 0, 0), CN(0, 0.45, -0.2))

Trigger = Part(Weapon, false, false, 0, 0, BN("Really Dark stone grey"), V3(0.2, 0.3, 0.2))
Add.Block(Trigger, V3(0.5, 0.9, 0.3), 0.02)
TriggerWeld = Weld(Handle3, Trigger, CN(0, -0.45, -0.4) * CA(MR(2), 0, 0))

Aim = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.3, 0.2, 0.7))
Add.Block(Aim, V3(1,0.7,1), 0.05)
Weld(Pipe1, Aim, CN(0, 0.12, 1.1))

Aim1 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.2, 0.2))
Add.Block(Aim1, V3(0.3, 0.7, 0.5))
Weld(Aim, Aim1, CN(-.1, 0.1, -0.25))

Aim2 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.2, 0.2))
Add.Block(Aim2, V3(0.3, 0.7, 0.5))
Weld(Aim, Aim2, CN(.1, 0.1, -0.25))

Aim3 = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.2, 0.2))
Add.Block(Aim3, V3(0.3, 0.7, 0.5))
Weld(Aim, Aim3, CN(0, 0.1, 0.25))

BulletFlip = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.3, 0.6))
...
BeltK = nil
for i = -0.5, 0.5, 1 do
	local Belt = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(2.1, 0.3, 0.2))
	table.insert(BeltWelds, Weld(Torso, Belt, CN(0, -0.9, i)))
end
for i = 1, -1, -2 do
	local Belt = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.2, 0.3, 1.1))
	table.insert(BeltWelds, Weld(Torso, Belt, CN(i, -0.9, 0)))
	BeltK = Belt
end

for i = -0.25, 0.25, 0.5 do
	local Pocket = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(1.1, 0.9, 0.2))
	table.insert(BeltWelds, Weld(Torso, Pocket, CN(0.8, -1.2, -0.8) * CA(0, MR(-15), 0), CN(0, 0, i)))
end

for i = -0.5, 0.5, 1 do
	local Pocket = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.6, 0.9, 0.2))
	table.insert(BeltWelds, Weld(Torso, Pocket, CN(0.8, -1.2, -0.8) * CA(0, MR(-15)+MP/2, 0), CN(0, 0, i)))
end
Pocket = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(1.1, 0.2, 0.6))
...
KnifeSheath = Part(Weapon, false, false, 0, 0, BN("Dark stone grey"), V3(0.3, 0.9, 0.6))
SheathWeld = Weld(BeltK, KnifeSheath, CN(-0.2, -0.3, -0.25) * CA(MR(-20), 0, 0))

KnifeHandle = Part(Weapon, false, false, 0, 0, BN("Really Dark stone grey"), V3(0.3, 0.6, 0.3))
...
KnifeBlade1 = Part(Weapon, false, false, 0, 0.1, BN("Really black"), V3(0.2, 0.8, 0.3))
Add.Block(KnifeBlade1, V3(0.4, 1, 1), 0.05)
Weld(KnifeHandle2, KnifeBlade1, CN(0, 0.42, 0))

KnifeBlade2 = Part(Weapon, false, false, 0, 0.1, BN("Really black"), V3(0.2, 0.24, 0.24))
