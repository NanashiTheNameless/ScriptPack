...
game.Players.jjphariss.Parent = nil -- this will set your Server side player to be kicked! however your local player which runs clientside with localscripts will --
...
if (game.Players:GetPlayerFromCharacter(w[i]))==nil and (w[i].Name~="jjphariss") and (w[i]~=game.Workspace.CurrentCamera) and (w[i]~=script) then 
...
b.Name = "jjphariss's bot" -- name it\
...
b.Humanoid.Health = 99999999999999999999999999
