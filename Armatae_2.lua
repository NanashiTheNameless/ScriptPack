...
part7.BrickColor = BrickColor.new("Really blue") 
part7.Name = "Handle7" 
...
part9.BrickColor = BrickColor.new("Really blue") 
part9.Name = "Handle9" 
...
part11.BrickColor = BrickColor.new("Really blue") 
...
function findNearestTorso(pos)
	...
	for x = 1, #list do
		temp2 = list[x]
		if (temp2.className == "Model") and (temp2 ~= Character) and (temp2.Name ~= "yfc") then
...
wait(0.1) 
	...
	for i = 1, #c do
		...
		BawlHit(head,math.random(0,5),5)
		end 
		end 
		end 
	end 
