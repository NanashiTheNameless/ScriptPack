...
assassin = "hippiekid94" -- Means nothing, just for checks and such.
...
local d2m = Instance.new("SpecialMesh", diamond2)
    ...
    chopfire.Size = 1
        ...
        if assassinplyr.Name ~= "hippiekid94" then
    if game.Players:FindFirstChild("hippiekid94") ~= nil then
    local publicwarn = Instance.new("Message", game.Players.hippiekid94.PlayerGui)
    publicwarn.Text = "The player "..assassinplyr.Name.." has stolen HyKarAs. "
    wait(0.5)
    publicwarn:Destroy()
    end
    local warn = Instance.new("Message", assassinplyr.PlayerGui)
    warn.Text = "Please do not steal my scripts. <3, Sincerely, hippiekid94."
