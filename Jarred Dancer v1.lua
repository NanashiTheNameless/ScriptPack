--royalwiryman's (edited) dancer
--Credit to madiik for his nice clerp function :3
do
...
mouse.KeyDown:connect(function(k)
    if k == "q" then
        if not sound.IsPlaying then
            game:service'InsertService':LoadAsset(1029025):children()[1].Parent = char
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=233613098"
            wait()
            sound:play()
        end
    end
    if k == "e" then
        if not sound.IsPlaying then
            ...
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=132752887"
            wait()
            sound:play()
        end
    end
        ...
        if not sound.IsPlaying then
            ...
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=130998447"
            wait()
            sound:play()
        end
    end
        ...
        if not sound.IsPlaying then
            ...
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=178856837"
            wait()
            sound:play()
        end
    end
        ...
        if not sound.IsPlaying then
         ...
         if k == "u" then
        if not sound.IsPlaying then
            game:service'InsertService':LoadAsset(87261721):children()[1].Parent = char
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=142288396"
            wait()
            sound:play()
        end
    end
         if k == "p" then
        if not sound.IsPlaying then
            game:service'InsertService':LoadAsset(22432792):children()[1].Parent = char
            sound:stop()
            sound.SoundId = "http://www.roblox.com/asset/?id=137560955"
            wait()
            sound:play()
        end
    end
...
elseif humanoid.Sit then
        if sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=233613098" then
        anglespeed = 2
        ...
        elseif sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=132752887" then
        anglespeed = 6
        ...
        rlcf = rlc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, math.rad(20))
        llcf = llc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, -math.rad(20))
        elseif sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=130998447" then
        anglespeed = 6
        ncf = neckc0 * CFrame.Angles(math.pi/5-math.sin(angle)*0.1, 0, 0)
        rjcf = CFrame.new(0, -0.8, 0) * CFrame.Angles(-math.pi/5, 0, 0)
        rscf = rsc0 * CFrame.new(-.45, 0.2, -.3) * CFrame.Angles(math.pi/3, 0, -math.rad(15))
        ...
        rlcf = rlc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, math.rad(20))
        llcf = llc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, -math.rad(20))
        elseif sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=178856837" then
        anglespeed = 6
        ncf = neckc0 * CFrame.Angles(math.pi/5-math.sin(angle)*0.1, 0, 0)
        rjcf = CFrame.new(0, -0.8, 0) * CFrame.Angles(-math.pi/5, 0, 0)
        rscf = rsc0 * CFrame.new(-.45, 0.2, -.3) * CFrame.Angles(math.pi/3, 0, -math.rad(15))
        ...
        rlcf = rlc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, math.rad(20))
        llcf = llc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, -math.rad(20))
        elseif sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=142288396" then
        anglespeed = 6
        ncf = neckc0 * CFrame.Angles(math.pi/5-math.sin(angle)*0.1, 0, 0)
        rjcf = CFrame.new(0, -0.8, 0) * CFrame.Angles(-math.pi/5, 0, 0)
        rscf = rsc0 * CFrame.new(-.45, 0.2, -.3) * CFrame.Angles(math.pi/3, 0, -math.rad(15))
        ...
        rlcf = rlc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, math.rad(20))
        llcf = llc0 * CFrame.Angles(math.pi/2+math.pi/5, 0, -math.rad(20))
        elseif sound.IsPlaying and sound.SoundId == "http://www.roblox.com/asset/?id=137560955" then
        anglespeed = 6
        ncf = neckc0 * CFrame.Angles(math.pi/5-math.sin(angle)*0.1, 0, 0)
        rjcf = CFrame.new(0, -0.8, 0) * CFrame.Angles(-math.pi/5, 0, 0)
        rscf = rsc0 * CFrame.new(-.45, 0.2, -.3) * CFrame.Angles(math.pi/3, 0, -math.rad(15))
