...
--col = {"Really blue,"Really blue"}
--col = {"Really blue","Really blue","Really blue"}
col = {"Really blue","Really blue","Really blue"}
Anims = {}
act = {key = {}}
...
prt3.BrickColor = BrickColor.new("Really blue") 
prt3.Name = "Part3" 
...
wait(0.1)
for i = 1,3 do
DerpMagic(prt7,Prop.LegWide*4,Prop.LegWide*4,Prop.LegWide*4,0,1,0,BrickColor.new("Really blue")) 
shoottrail2(prt7) 
wait(0.5)
end
for i=0,1,0.1 do
...
EVENMOARMAGIX(effectsg,Prop.LegLength*3,Prop.LegLength*2,Prop.LegLength*3,0,0,0,0,0,0,BrickColor.new("Really blue")) 
for i = 0,5 do 
wait() 
MMMAGIC(effectsg,Prop.LegLength*3,Prop.LegLength*2,Prop.LegLength*3,0,0,0,BrickColor.new("Really blue")) 
end 
end))
coroutine.resume(coroutine.create(function()
wait(3)
