...
mana=0
local Mode="Gun"
eenabled=true qenabled=true renabled=true venabled=false
...
Hitbox=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0.20000000298023,1,"Crimson","Hitbox",Vector3.new(0.200000003, 4.79999971, 1))
...
BladePart=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0.20000000298023,0,"Crimson","BladePart",Vector3.new(0.220000014, 0.200000003, 3.4000001))
...
BladePart=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0.20000000298023,0,"Crimson","BladePart",Vector3.new(0.200000003, 0.220000014, 0.800000072))
...
mesh("CylinderMesh",BladePart,"","",Vector3.new(0, 0, 0),Vector3.new(1, 1, 1))
BladePart=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0.20000000298023,0,"Crimson","BladePart",Vector3.new(0.220000014, 0.200000003, 0.399999976))
...
MagicCylinder2(BrickColor.new("Crimson"),CFrame.new((MainPos+pos)/2,pos)*angles(1.57,0,0),3,mag*5,3,1.5,0,1.5,0.1)
...
MagicBlock(BrickColor.new("Crimson"),cf(pos),20,20,20,5,5,5,0.05)
...
local prt=part(3,workspace,"SmoothPlastic",0,0,BrickColor.new("Crimson"),"Part",vt(1,1,1))
prt.Anchored=true
...
WingHandleAweld.C0 = clerp(WingHandleAweld.C0, CFrame.new(0, 0, 0) * angles(math.rad(-90), math.rad(0), math.rad(0)), 0.3)
WingHandleBweld.C0 = clerp(WingHandleBweld.C0, CFrame.new(0, 0, 0) * angles(math.rad(-90), math.rad(0), math.rad(0)), 0.3)
WingHandle2Aweld.C0 = clerp(WingHandle2Aweld.C0, CFrame.new(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
WingHandle2Bweld.C0 = clerp(WingHandle2Bweld.C0, CFrame.new(0, 0, 0) * angles(math.rad(0), math.rad(0), math.rad(0)), 0.3)
...
elseif k=='q' and qenabled==true then
qenabled=false
coroutine.resume(coroutine.create(function()
for i=1,0,-0.003 do
swait()
...
MagicHead(BrickColor.new("Crimson"),CFrame.new((Thing[4]+pos)/2,pos)*angles(1.57,0,0),1,mag*5,1,.5,0,.5,0.1)
...
ref=part(3,workspace,"SmoothPlastic",0,1,BrickColor.new("Crimson"),"Reference",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
MagicCircle(BrickColor.new("Crimson"),cf(pos),5,5,5,1,1,1,0.03)
game:GetService("Debris"):AddItem(ref,1)
end
if Thing[3]<=0 then
table.remove(Effects,e)
