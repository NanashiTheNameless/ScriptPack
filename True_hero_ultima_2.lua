-- removed Charing, annoying af, korblox.
...
elseif v:IsA("Pants") then v:remove() 
elseif v:IsA("Hat") then v:remove() 
elseif v:IsA("Part") and v.Name == "Head" then v.Material = "SmoothPlastic"
elseif v:IsA("Part") then v.Material = "SmoothPlastic"
...
pants.Name = "Pants"
Char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=359117260"
Char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=382152006"
end
end
		...
		if hum ~= nil then
			...
			if head ~= nil then
				...
				if mag <= magni and c.Name ~= Ply.Name then 
					Damage(head.Parent, math.random(mindam,maxdam), 0, BrickColor.new("Really black"), BrickColor.new("Crimson"), "rbxassetid://199149186", 1)
				end
			end
		end
	end
...
attack = true
   ...
   local HitDeb = Hitbox.Touched:connect(function(hit)
    Damage(hit.Parent, math.random(30,50), 0.1, BrickColor.new("Really black"), BrickColor.new("New Yeller"), "rbxassetid://154965973", 1)
   end)
   for i = 0,1,0.1 do
    wait()
...
attack = true
   local HitDeb = Hitbox.Touched:connect(function(hit)
    Damage(hit.Parent, math.random(10,30), 0.1, BrickColor.new("Really black"), BrickColor.new("New Yeller"), "rbxassetid://154965973", 1)
   end)
for i = 1,4 do
   for i = 0,1,0.3 do
    wait()
...
attack = true
   ...
   local HitDeb = Hitbox.Touched:connect(function(hit)
    Damage(hit.Parent, math.random(20,30), 0, BrickColor.new("Really black"), BrickColor.new("New Yeller"), "rbxassetid://154965973", 1)
   end)
for i = 1,2 do
...
function Shoot(asd, spread1, spread2)
	...
	coroutine.resume(coroutine.create(function(Spreaded) 
		repeat
			...
			CylinderEffect(BrickColor.new("New Yeller"), CFrame.new((MainPos + pos) / 2, pos) * CFrame.Angles(1.57, 0, 0), 3, mag * 5, 3, .5, 0, 1.5, 0.1)
