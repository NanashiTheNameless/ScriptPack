...
pip2.Material = "SmoothPlastic"
local pip1 = Instance.new("Part")
pip1.Material = "SmoothPlastic"
local mainp = Instance.new("Part")
mainp.Material = "SmoothPlastic"
...
function findNearestTorso(pos)
	...
	for x = 1, #list do
		temp2 = list[x]
		if (temp2.className == "Model") and (temp2 ~= Character) and (temp2.Name ~= "Ucalegen") then
...
--	local main = Instance.new("Part")
	...
	for i=-1, 1, 2 do
		...
		prop(fir,mod,true,0,0,1,1.8,1,"Really black",false,"Custom")
	...
	while true do
		wait()
		if mode==1 then
			if workspace.Ucalegen.Torso then
