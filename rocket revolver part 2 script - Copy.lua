...
gemcolor = BrickColor.new("New Yeller")
...
prt21.BrickColor = BrickColor.new("Really black") 
...
prt22.BrickColor = BrickColor.new("Really black") 
...
prt23.BrickColor = BrickColor.new("White") 
...
prt24.BrickColor = BrickColor.new("Really black") 
...
prt25.BrickColor = BrickColor.new("White") 
...
prt26.BrickColor = BrickColor.new("White") 
...
prt27.BrickColor = BrickColor.new("Really black") 
...
prt28.BrickColor = BrickColor.new("Really black") 
...
prt29.BrickColor = BrickColor.new("Really black") 
...
prt30.BrickColor = BrickColor.new("Lime green") 
...
prt31.BrickColor = BrickColor.new("Really black") 
...
function damagesplat(dmg,hit,crit,blocked)
    ...
    pa.BrickColor = BrickColor.new("Lime green")
    elseif critical==false then
    pa.BrickColor = BrickColor.new("Bright red")
    end
    if blocked then pa.BrickColor = BrickColor.new("Lime green") end
...
WaveEffect2(cf(newpos),15,15,15,0,0,0,1,0,0,BrickColor.new("Lime green")) 
WaveEffect2(cf(newpos),15,15,15,0,0,0,-1,0,0,BrickColor.new("Lime green")) 
local c = game.Workspace:GetChildren();
for i = 1, #c do
local hum = c[i]:findFirstChild("Humanoid")
