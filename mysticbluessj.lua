...
Hair45.BrickColor = BrickColor.new("Cyan") 
...
Hair232.BrickColor = BrickColor.new("Cyan") 
Weld = Instance.new("Weld") 
Weld.Part0 = jun.Character.Head 
Weld.Part1 = Hair232 
Weld.Parent = jun.Character.Head 
...
Mesh.TextureId = "http://www.roblox.com/asset/?id=15392970" 
...
pie.SecondaryColor = BrickColor.new("Magenta").Color
pie.SecondarySize = 8
end 
...
msg = Msg:lower() 
if string.sub(msg, 1, 7) == "mystic" then 
wait(0.1) 
ssj() 
end 
if string.sub(msg, 1, 13) == "mystic" then 
wait(0.1) 
ssj() 
end 
