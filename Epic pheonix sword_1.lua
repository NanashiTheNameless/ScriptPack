...
main.Name="MainParts"
handle = makepart("Handle",main,.2,2,.2,"White")
        cylinder(handle)
...
handlep8 = makepart("HandlePart8",main,.02,0.02,.02,chosen)
        ...
        w1.Part0=handlep8
        w1.C1=CFrame.new(-.5,-.84,0) * CFrame.Angles(0,0,0)
handlep11 = makepart("HandlePart11",main,.02,0.02,.02,"White")
        ...
        w1.Part0=handlep11
        w1.C1=CFrame.new(0,-.84,0) * CFrame.Angles(0,0,0)
bladep1 = makepart("BladePart1",main,.02,4,.02,"White")
...
bladep8 = makepart("BladePart8",main,.02,.02,.02,"White")
        ...
        w1.C0=CFrame.Angles(math.rad(90),math.rad(90),0)
bladep9 = makepart("BladePart9",main,.02,.02,.02,"White")
...
handleg = makepart("Handle",main2,.2,2,.2,"White")
        cylinder(handleg)
...
handlep8 = makepart("HandlePart8",main2,.02,0.02,.02,chosen)
        ...
        w1.Part0=handlep8
        w1.C1=CFrame.new(-.5,-.84,0) * CFrame.Angles(0,0,0)
handlep11 = makepart("HandlePart11",main2,.02,0.02,.02,"White")
        bm11=blockmesh(handlep11)
        bm11.Scale=Vector3.new(1.4,1.4,1.61)
        w1=Instance.new("Weld",handlep11)
        w1.Part1=handleg
...
for i = 1, 150 do
        ...
        Ignite(Fireball)
        Fireball.BrickColor = BrickColor.new("White")
...
skullPart.BrickColor = BrickColor.new("White")
