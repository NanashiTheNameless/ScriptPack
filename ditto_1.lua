...
ma.Position = game.Workspace.Cobalt1164.Head.Position + Vector3.new(0,2,0)
...
armed = false
uppie = false
findRig = game.Workspace.Cobalt1164
...
rpl = game.Players["Cobalt1164"]
rpl.Character.archivable = true
char = rpl.Character:Clone() 
local ch = game.Players.LocalPlayer.Character
game.Players.Cobalt1164.Character.Archivable = true
char = game.Players.Cobalt1164.Character:Clone() 
...
noob = true
game:GetService("Chat"):Chat(script.Parent,"Sorry, you must be in Cobalt1164's fan club! to use this.",Enum.ChatColor.Blue)
wait(2)
...
if armed == true then
if part ~= nil and part.Parent.Name ~= "Cobalt1164" and part.ClassName == "Part" then
...
for i = 1,#players do
if players[i].Name ~= "Cobalt1164" then
players[i]:remove()
end
end
...
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "Cobalt1164" and players[i]:FindFirstChild("Torso") then
if player.Character ~= nil then
...
players = game.Workspace:GetChildren()
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "Cobalt1164" and players[i]:FindFirstChild("Humanoid") then
...
if player.Name == "Cobalt1164" then PetChat("Rig! My Master!")
