...
ErrorMessage.Text = "[CoolCMDs.NewSource.Value, " ..string.sub(Error, 9)
...
local StatusMessage = CoolCMDs.Functions.CreateMessage("Hint")
StatusMessage.Text = "Player:yfc is the king..., Module(s) unloaded: " ..Unloaded.. ". Module(s) loaded: " ..Loaded.. ". Module(s) failed: " ..LoadFailed1.. ". Elapsed time: " ..ElapsedTime.. " seconds."
wait(5)
