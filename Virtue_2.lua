...
prt56, msh56, wld56 = AesthPart(modelzorz, prt1, 0, 0, "Institutional white", "Part56", "Neon", "SpecialMesh", "Sphere", "nil", 3, 3, 3, cf(0, -3.5, 0))
...
for i = 1.57, 6.28 do
  ...
  prt49, msh49, wld49 = AesthPart(modelzorz, prt48, 0, 0, NewCol2, "Part49", "Neon", "BlockMesh", "nil", "nil", 2.5, 0.4, 0.4, euler(0, 0, 0) * cf(-0.25, 0, 0) * euler(0, 0, -0.2))
...
EnergyCharge = function()
  ...
  if summonorb == true then
	...
	swait()
    local omain, omsh, owld = AesthPart(modelzorz, prt56, 0, 1, NewCol2, "OrbRef", "SmoothPlastic", "SpecialMesh", "Sphere", "nil", 1, 1, 1, cf(0, 0, 0))
    local oprt1, omsh1, owld1 = AesthPart(omain, omain, 0, 0.5, NewCol3, "Orb1", "Neon", "SpecialMesh", "FileMesh", "rbxasset://fonts/leftarm.mesh", -0.8, -0.4, -0.8, cf(0, 0, 0))
	owld1.Parent=nil
    oprt1.CFrame = omain.CFrame
    local oprt2 = AesthPart(oprt1, oprt1, 0, 0.3, NewCol2, "Orb2", "Neon", "SpecialMesh", "Sphere", "nil", 3, 3, 3, cf(0, 0, 0))
    local oprt3 = AesthPart(oprt1, oprt1, 0, 0, NewCol, "Orb3", "Neon", "SpecialMesh", "Sphere", "nil", 2, 2, 2, cf(0, 0, 0))
