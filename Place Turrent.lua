--(NOT THE SCRIPT) LOCAL SCRIPT: Go to line 4 and put your name where it says "YOUR NAME HERE"
...
function placeturret(mainplace)
...
while true do
	...
	if target ~= nil then
		...
		if meh == 1 then
			...
			huo:TakeDamage(math.random(huo.MaxHealth/34,huo.MaxHealth/8))
