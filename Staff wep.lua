...
c.Fire.Size = 19 
c.Fire.Heat = 6.5 
c.Fire.Color = Color3.new(5,5,5.7) 
c.Fire.SecondaryColor = Color3.new(0.3,0,0.9) 
coroutine.resume(coroutine.create(Del), c, 1.3) 
coroutine.resume(coroutine.create(AnimP), 2) 
mods = workspace:GetChildren() 
...
if (mods[e].Torso.Position - c.Position).magnitude < 10 then 
if mods[e]:findFirstChild("Humanoid") ~= nil then 
mods[e].Humanoid.MaxHealth = math.huge 
mods[e].Humanoid.Health = math.huge 
end 
end 
end 
end 
...
coroutine.resume(coroutine.create(Del), c, 1.3) 
coroutine.resume(coroutine.create(AnimP), 2) 
mods = Players:GetChildren() 
for e = 1, #mods do 
if mods[e].className == "Model" then 
if mods[e].Character.Name == bin.Parent.Parent.Name then 
wait() 
else 
if mods[e].Character:findFirstChild("Torso") ~= nil then 
if (mods[e].Character.Torso.Position - c.Position).magnitude < 10 then 
if mods[e].Character:findFirstChild("Humanoid") ~= nil then 
mods[e]:Remove() 
end 
end 
end 
