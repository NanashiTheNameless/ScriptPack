...
LastPoint = Point
LastPoint2 = Point2
MMMAGIC(prt5,3,3,3,0,0,0,BrickColor.new("Really black")) 
MMMAGIC(prt15,3,3,3,0,0,0,BrickColor.new("Really black")) 
until floor
...
spikesound(1) 
magicsound(0.8) 
MMMAGIC(prt5,15,15,15,0,0,0,BrickColor.new("Really black")) 
MMMAGIC(prt15,15,15,15,0,0,0,BrickColor.new("Really black")) 
...
wait(0.1)
mana=mana+1
MMMAGIC(prt5,1,1,1,0,0,0,BrickColor.new("Really black")) 
MMMAGIC(prt15,1,1,1,0,0,0,BrickColor.new("Really black")) 
    p=Instance.new("Part")
...
magicsound(0.8) 
MMMAGIC(Head,15,15,15,0,0,0,BrickColor.new("Really black")) 
...
for i = 0,1,0.2 do 
wait() 
MMMAGIC(LeftLeg,3,3,3,0,1,0,BrickColor.new("Really black")) 
MMMAGIC(RightLeg,3,3,3,0,1,0,BrickColor.new("Really black")) 
Torso.Neck.C0=necko*CFrame.fromEulerAnglesXYZ(0,0,0)
...
for i=0,1,0.1 do
wait()
MMMAGIC(LeftLeg,1,1,1,0,-1,0,BrickColor.new("Really black")) 
MMMAGIC(RightLeg,1,1,1,0,-1,0,BrickColor.new("Really black")) 
wld1.C0 = CFrame.fromEulerAnglesXYZ(1.57-1.57*i,0,0) * CFrame.new(0,1,0) 
wld11.C0 = CFrame.fromEulerAnglesXYZ(1.57-1.57*i,0,0) * CFrame.new(0,1,0) 
...
spikesound(0.6) 
magicsound(0.5) 
MMMAGIC2(prt5,40,40,40,0,0,0,BrickColor.new("Really black")) 
MMMAGIC2(prt15,40,40,40,0,0,0,BrickColor.new("Really black")) 
...
EVENMOARMAGIX(prt15,60,60,60,0,0,0,0,0,0,BrickColor.new("Really black")) 
wait(1)
gairo.Parent=nil
attack=false
end
