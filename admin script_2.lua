...
adminlist = {"Killbook"}--Add in the names of the people you want to be able to use the command script here.
--Please keep my name in there. ;)
bannedlist = { ""}--If you want someone not to be able to enter your place, put thier name in here.
texture = "http://www.roblox.com/My/Item.aspx?ID=46526931"--If you want someone wearing a certain t-shirt to be an admin, put the t-shirt's texture in here.
...
if string.sub(msg,1,7) == "unfire/" then
local player = findplayer(string.sub(msg,8),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
...
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(36691580) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end

if string.sub(msg,1,10) == "blackhole/" then
...
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(36709198) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end

if string.sub(msg,1,12) == "cleanernuke/" then
...
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(36779045) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end

if string.sub(msg,1,4) == "ufo/" then
local player = findplayer(string.sub(msg,5),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(36832906) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end

if string.sub(msg,1,7) == "aliens/" then
local player = findplayer(string.sub(msg,8),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(36838264) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end

if string.sub(msg,1,8) == "sunnuke/" then
...
local torso = player[i].Character:FindFirstChild("Torso")
if torso ~= nil then
local g = game:GetService("InsertService"):LoadAsset(25881205) 
g.Parent = game.Workspace 
g:MoveTo(torso.Position) 
end end end end end
...
if string.lower(msg) == "stopsunnuke" then
local imgettingtiredofmakingthisstupidscript = PERSON299(speaker.Name)
if imgettingtiredofmakingthisstupidscript == true then
local c = game.Workspace:GetChildren()
for i =1,#c do
local sun = c[i]:FindFirstChild("SBSun")
if sun ~= nil then
sun:Remove()
end end end end

if string.lower(msg) == "stopsunnuke" then  --for if some one inserted a sun nuke :-)
local imgettingtiredofmakingthisstupidscript = PERSON299(speaker.Name)
if imgettingtiredofmakingthisstupidscript == true then
local c = game.Workspace:GetChildren()
for i =1,#c do
if c[i].Name == "SBSun" then
if c[i] ~= nil then
c[i]:Remove()
end end end end end
...
if string.sub(msg,1,11) == "brightness/" then
game.Lighting.Brightness = string.sub(msg,12)
end
...
if string.sub(msg,1,7) == "shadow/" then
local danumber1 = nil
local danumber2 = nil
for i = 8,100 do
if string.sub(msg,i,i) == "/" then
...
if danumber2 == nil then return end
game.Lighting.ShadowColor = Color3.new(-string.sub(msg,8,danumber1 - 1),-string.sub(msg,danumber1 + 1,danumber2 - 1),-string.sub(msg,danumber2 + 1))
end

if string.sub(msg,1,9) == "topcolor/" then
local danumber1 = nil
local danumber2 = nil
for i = 10,100 do
if string.sub(msg,i,i) == "/" then
...
if danumber2 == nil then return end
game.Lighting.ColorShift_Top = Color3.new(-string.sub(msg,10,danumber1 - 1),-string.sub(msg,danumber1 + 1,danumber2 - 1),-string.sub(msg,danumber2 + 1))
end

if string.sub(msg,1,12) == "bottomcolor/" then
local danumber1 = nil
local danumber2 = nil
for i = 13,100 do
if string.sub(msg,i,i) == "/" then
...
if danumber2 == nil then return end
game.Lighting.ColorShift_Bottom = Color3.new(-string.sub(msg,13,danumber1 - 1),-string.sub(msg,danumber1 + 1,danumber2 - 1),-string.sub(msg,danumber2 + 1))
end
...
if string.sub(msg,1,9) == "unfreeze/" then -- for those people that can't remember thaw/me :-/
local player = findplayer(string.sub(msg,10),speaker)
if player ~= 0 then
for i = 1,#player do
if player[i].Character ~= nil then
