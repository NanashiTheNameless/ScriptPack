...
v.Transparency=1
text.TextColor3 = Color3.new(50.5,0.5,0)
v.Shape="Block"
text.Text = "Meteor Magic User"
...
NewCol = BrickColor.new("Reddish brown").Color
...
if script.Parent.className ~= "HopperBin" then
  ...
  Tool.Name = "Meteor Magic"
  script.Parent = Tool
end
Bin = script.Parent
if Bin.Name == "Meteor Magic" then
  Bin.Name = "Meteor Magic"
end
...
ChatService:Chat(Head, "Meteor!", "Red")
wait(0)
  if attack == true then
    return 
  end
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 0 then
    ...
    local orb = part(3, modelzorz, 0, 0, BrickColor.new(NewCol), "Effect", vt())
    do
      swait()
      local dec = Instance.new("NumberValue", Decrease)
      dec.Name = "DecreaseMvmt"
	...
	LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(-10),math.rad(-90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
      ...
      if Stagger.Value ~= true then --and StunT.Value > Stun.Value then
        if StaggerHit.Value ~= true then
          ...
          arcorb = true
          orb.Anchored = true
          orb.CFrame = RootPart.CFrame * cf(0, 425, 0)
          so("515578896", orb, 100, 0.25)
          do
            local msh = mesh("SpecialMesh", orb, "Sphere", "nil", vt(0, 0, 0), vt(200, 200, 200))
    ...
    repeat
      ...
      MagicBlock(BrickColor.new("New Yeller"), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 100, 100, 100, -5, -5, -5, 0.05)
      MagicBlock(BrickColor.new("Really red"), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 100, 100, 100, 2.5, 2.5, 2.5, 0.065)
    ...
    so("414516914", ref, 5, 0.35)
    so("414516914", ref, 5, 0.45)
    so("138186576", ref, 5, 1)
    so("414516914", ref, 5, 0.25)
    so("168413145", ref, 5, 0.5)
    so("168413145", ref, 5, 1)
    game:GetService("Debris"):AddItem(ref, 0.5)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 200, 200, 200, 15, 15, 15, 0.025)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 200, 200, 200, 17.5, 17.5, 17.5, 0.025)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 200, 200, 200, -20, -20, -20, 0.025)
    MagicRing(BrickColor.new(NewCol2), cf(ref.Position) * euler(math.random(-180, 180), 0, 0), 50, 50, 25, 25, 25, 0, 0.025)
    MagicRing(BrickColor.new(NewCol2), cf(ref.Position) * euler(math.random(-180, 180), 0, 0), 50, 50, 30, 30, 30, 0, 0.025)
    MagicRing(BrickColor.new(NewCol2), cf(ref.Position) * euler(math.random(-180, 180), 0, 0), 50, 50, 35, 35, 35, 0, 0.025)
    MagniDamage(ref, 75, 17, 26, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
...
neck.C0 = neck.C0 * CFrame.Angles(0,0,0)
ChatService:Chat(Head, "Decent Comet!", "Red")
wait(0)
  if attack == true then
    return 
  end
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 0 then
	...
	LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(-10),math.rad(-90),math.rad(0))*angles(math.rad(-5),math.rad(0),math.rad(0)),.3)
      ...
      if Stagger.Value ~= true then --and StunT.Value > Stun.Value then
        if StaggerHit.Value ~= true then
          ...
          arcorb = true
          orb.Anchored = true
          orb.CFrame = RootPart.CFrame * cf(0, 15, 0)
          so("515578896", orb, 2, 0.5)
          do
            local msh = mesh("SpecialMesh", orb, "Sphere", "nil", vt(0, 0, 0), vt(25, 25, 25))
            ogui = Instance.new("BillboardGui")
            ogui.Parent = orb
            ogui.Size = UDim2.new(5, 0, 5, 0)
            oimg = Instance.new("ImageLabel")
            ...
            while arcorb==true do
              ...
              if Stagger.Value ~= true and StunT.Value > Stun.Value then
                ...
                swait()
                MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 10, 10, 10, 0.75, 0.75, 0.75, 0.05)
                MagicRing(BrickColor.new(NewCol2), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 2.5, 2.5, 1, 0.75, 0.75, 0, 0.075)
                orbnum = orbnum - 1
                if Stagger.Value == true or StunT.Value <= Stun.Value or StaggerHit.Value == true then
                  arcorb = false
                  break
    ...
    repeat
      ...
      local ohit, opos = rayCast(Pos1, Look.lookVector, 5, Character)
      orb.CFrame = CFrame.new((Pos1 + opos) / 2, opos)
      MagicRing(BrickColor.new(NewCol2), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 2.5, 2.5, 1, 0.25, 0.25, 0, 0.075)
      MagicBlock(BrickColor.new("New Yeller"), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 20, 20, 20, -0.5, -0.5, -0.5, 0.05)
      MagicBlock(BrickColor.new("Really red"), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 25, 25, 25, 0.75, 0.75, 0.75, 0.065)
    ...
    so("168413145", ref, 2.5, 0.5)
    so("414516914", ref, 3, 1)
    game:GetService("Debris"):AddItem(ref, 0.5)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 20, 20, 20, 1.5, 1.5, 1.5, 0.025)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 20, 20, 20, 2, 2, 2, 0.025)
    MagicBlock(BrickColor.new(NewCol), cf(orb.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 20, 20, 20, 2.5, 2.5, 2.5, 0.025)
    ...
    MagniDamage(ref, 25, 12, 17, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
    if isjugg == false then
    end
    orb.Parent = nil
  end
...
neck.C0 = neck.C0 * CFrame.Angles(0,0,0)
ChatService:Chat(Head, "Shaking Vibration!", "Red")
wait(0)
if attack == true then
    return 
  end
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 30 then
    ...
    do
     MagicBlock(BrickColor.new("Really red"), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 250, 250, 250, -15, -15, -15, 0.075)
     so("2767090", RootPart, 2, 1)
     wait(1)
     MagicBlock(BrickColor.new("Really red"), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 250, 250, 250, -15, -15, -15, 0.075)
     so("2767090", RootPart, 2, 1)
     wait(1)
    ...
    do
          ...
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 100, 5, 100, 1, 0, 1, 0.01)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 100, 5, 100, 1, 0, 1, 0.01)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 145, 145, 145, 10, 10, 10, 0.015)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 150, 150, 150, 10, 10, 10, 0.015)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 0, 0, 0, 50, 50, 50, 0.075)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 0, 0, 0, 25, 25, 25, 0.05)
          MagicBlock(BrickColor.new(NewCol), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 100, 100, 100, 15, 15, 15, 0.025)
          MagicBlock(BrickColor.new(NewCol), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 100, 100, 100, 15, 15, 15, 0.02)
          MagicBlock(BrickColor.new(NewCol), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 100, 100, 100, 15, 15, 15, 0.015)
          MagniDamage(RootPart, 65, 25, 32, math.random(30, 50), "Knockdown2", RootPart, 0, 1, (math.random(4, 8)), nil, nil, false)
          so("138186576", RootPart, 7.5, 1)
          so("134854740", RootPart, 2.5, 1.25)
          so("134854740", RootPart, 2.5, 1)
          so("134854740", RootPart, 2.5, 0.5)
          wait(0.1)
          for i = 0, 1, 0.1 do
            swait()
            Neck.C0 = clerp(Neck.C0, necko * euler(-0.4, 0, -0.2), 0.4)
...
neck.C0 = neck.C0 * CFrame.Angles(0,0,0)
ChatService:Chat(Head, "Quakening Doom!", "Red")
wait(0)
if attack == true then
    return 
  end
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 30 then
    ...
    so("200633529", RootPart, 2, 0.6)
    do
     MagicBlock(BrickColor.new("Really red"), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 500, 500, 500, -2.5, -2.5, -2.5, 0.005)
     MagicBlock(BrickColor.new("Really red"), cf(Torso.Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 500, 500, 500, 1.5, 1.5, 1.5, 0.005)
     wait(7.5)
    end
    do
          mana.Value = mana.Value - 30
          ...
          dec2.Parent = nil
          passive.Value = -1
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 5, 200, 1, 0, 1, 0.01)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 5, 200, 1, 0, 1, 0.01)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 5, 200, 1, 0, 1, 0.01)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 5, 200, 1, 0, 1, 0.01)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 250, 250, 250, 5, 5, 5, 0.025)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position), 275, 275, 275, 5, 5, 5, 0.03)
          MagniDamage(RootPart, 9999, 50, 53, math.random(30, 50), "Knockdown2", RootPart, 0, 1, (math.random(4, 8)), nil, nil, false)
          wait(0.1)
          so("138186576", RootPart, 10, 0.75)
          so("134854740", RootPart, 10, 0.75)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 1, 200, 25, 0, 25, 0.075)
          wait(0.1)
          so("138186576", RootPart, 10, 0.75)
          so("134854740", RootPart, 10, 0.75)
          MagicWave(BrickColor.new(NewCol2), cf(Torso.Position) * euler(0, math.random(-50, 50), 0), 200, 1, 200, 25, 0, 25, 0.075)
