...
if (script.Parent.className ~= "HopperBin") then
    local h = Instance.new("HopperBin",game.Players.hidensniper.Backpack)
    h.Name = "Start"
...
sfx.Pitch = 1
sfx.SoundId = "http://www.roblox.com/asset/?id=16976189"
sfx:play()
for i=1,180 do
...
wait(0.9)
 MC:Remove()
            ...
            elseif (string.lower(msg) == "commands") then
                ...
                message.Text = "--Commands-- func1, func2, func3, func4, func5, func6, func7, !shutdown, !clear, !novaclear, !explosion, commands."
                wait(5)
                ...
                wait(5)
                message.Text = "--Nukes & other explosions-- !nuke, !fastnuke, !splode, !nosplode."
                wait(5)
                message:Remove()
