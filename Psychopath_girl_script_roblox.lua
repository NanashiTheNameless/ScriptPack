-- You found this script, noice .-.
-- Please don't leak it, is rare
-- if you leak it i will kill you, anyways.
-- Psychopath girl! by PaintfulfreeMLG! Let's start!
...
char.Head.face.Texture = "rbxassetid://635120692"
...
mesh3.MeshId = "http://www.roblox.com/asset/?id=1374148"
mesh3.Parent = rh3
mesh3.Scale = Vector3.new(1.15,1.15,1.15)
local weld3 = Instance.new("Weld")
weld3.Parent = rh3
rh3.Transparency = 0
weld3.Part0 = rh3
weld3.Part1 = Player.Character.Head
weld3.C0 = CFrame.new(0, -0.75, 0)*CFrame.Angles(0, 0, 0)


if p.Name == "Player1" or p.Name == "jerrychan123" then
	char.Head.face.Texture = "rbxassetid://381091841"
Reapern = Instance.new("Model")
Reapern.Parent = Player.Character
Reapern.Name = "Reapern"
rhn = Instance.new("Part")
rhn.Parent = Reapern
rhn.BrickColor = char.Torso.BrickColor
rhn.Locked = true
rhn.CanCollide = false
meshn = Instance.new("SpecialMesh")
rhn.formFactor =  "Symmetric"
meshn.MeshType = "FileMesh"
meshn.MeshId = "http://www.roblox.com/asset/?id=192551369"
meshn.TextureId = "rbxassetid://269748808"
meshn.VertexColor = Vector3.new(rhn.BrickColor.r,rhn.BrickColor.g,rhn.BrickColor.b)
meshn.Parent = rhn
local weldn = Instance.new("Weld")
weldn.Parent = rhn
rhn.Transparency = 0
weldn.Part0 = rhn
weldn.Part1 = Player.Character.Torso
weldn.C0 = CFrame.new(0, -1.25, -1)*CFrame.Angles(0, 0, 0)

neonproxy = Instance.new("Part",Reapern)
neonproxy.Material = "Neon"
neonproxy.Locked = true
neonproxy.CanCollide = false
neonproxy.Size = Vector3.new(0.2,0.2,0.2)
neonproxy.Transparency = 0.9
local welda = Instance.new("Weld")
welda.Parent = neonproxy
welda.Part0 = neonproxy
welda.Part1 = Player.Character.Torso
welda.C0 = CFrame.new(0, 0.1, 0)*CFrame.Angles(0, 0, 0)
end

Reaper4 = Instance.new("Model")
Reaper4.Parent = Player.Character
Reaper4.Name = "Reaper4"
rh4 = Instance.new("Part")
rh4.Parent = Reaper4
rh4.BrickColor = char.Torso.BrickColor
rh4.Locked = true
rh4.CanCollide = false
mesh4 = Instance.new("SpecialMesh")
rh4.formFactor =  "Symmetric"
mesh4.MeshType = "FileMesh"
mesh4.MeshId = "http://www.roblox.com/asset/?id=164382853"
mesh4.Parent = rh4
local weld4 = Instance.new("Weld")
weld4.Parent = rh4
rh4.Transparency = 0
weld4.Part0 = rh4
weld4.Part1 = Player.Character.Head
weld4.C0 = CFrame.new(0.05, 0.575, -0.05)*CFrame.Angles(0, 0, 0)
end
...
tecks3.TextColor3 = BrickColor.new("Hot pink").Color
tecks3.TextStrokeColor3 = Color3.new(0,0,0)
tecks3.Size = UDim2.new(1,0,0.5,0)
for i = 1,string.len(text),1 do
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=274118116", Character, 0.85, 1.2)
...
imgl.Image = "http://www.roblox.com/asset/?id=866992773"
imgl.BackgroundTransparency = 1
imgl.ImageColor3 = BrickColor.new("Hot pink").Color
imgl2 = Instance.new("ImageLabel",abss)
imgl2.Position = UDim2.new(-0.5,0,-0.5,0)
imgl2.Size = UDim2.new(2,0,2,0)
imgl2.Image = "http://www.roblox.com/asset/?id=866992773"
imgl2.BackgroundTransparency = 1
imgl2.ImageColor3 = BrickColor.new("Hot pink").Color
img2 = Instance.new("ImageLabel",abss)
img2.Position = UDim2.new(0,0,0,0)
img2.Size = UDim2.new(1,0,1,0)
img2.Image = "http://www.roblox.com/asset/?id=866992773"
img2.BackgroundTransparency = 1
img2.ImageColor3 = BrickColor.new("Hot pink").Color
...
function attackone()
    ...
    CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=136523485", Character, 0.75, 0.485)
    dmg(targetted)
	...
	chatfunc("Sorry...~")
	elseif sel == 2 then	
	chatfunc("I wont do that again...~")
	elseif sel == 3 then
	chatfunc("It was a mistake...~")
	end
	for i = 0, 5, 0.1 do
		swait()
		PlayAnimationFromTable({
...
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=200632211", RootPart, 1.5, .5)
		...
		if grab.Name ~= "NoobyGames12" then
	...
	sel = math.random(1,8)
	if sel == 1 then	
	chatfunc("You're not having fun with me.~")
	elseif sel == 2 then	
	chatfunc("Heh.~")
	elseif sel == 3 then
	chatfunc("Denied.~")
	elseif sel == 4 then
        local randquote = math.random(1,2)
        if randquote == 1 then
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=309176789", Character, 1.45, 1)
	chatfunc("NO!~")
       elseif randquote == 2 and p.Name == "NoobyGames12" then
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=313205934", Character, 1.45, 1)
	chatfunc("SAY!~")
       elseif randquote == 2 and p.Name ~= "NoobyGames12" then
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=309176789", Character, 1.45, 1)
	chatfunc("NO!~")
	...
	chatfunc("hehehehe.~")
	elseif sel == 6 then
	chatfunc("Stop looking at me... I'm just shy..~")
	elseif sel == 7 then
	chatfunc("Whats wrong?~")
	elseif sel == 8 then
	chatfunc("Your sacrifice.~")
	end
	for i = 0, 2, 0.1 do
		swait()
				if Grabbed == true then
...
sel = math.random(1,3)
if sel == 1 then	
chatfunc("I'm so sorry...~")
elseif sel == 2 then	
chatfunc("Oh... nevermind...~")
elseif sel == 3 then
chatfunc("No... i cant do this...~")
end
		for i = 0, 5, 0.1 do
		swait()
		PlayAnimationFromTable({
...
wait(.5)
	...
	chatfunc("No.~")
	elseif sel == 3 then
	chatfunc("Do you even regret it?~")
	elseif sel == 4 then
	chatfunc("Stop looking at me.~")
	elseif sel == 5 then
        local randquote = math.random(1,2)
        if randquote == 1 then
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=309176789", Character, 1.45, 1)
...
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=309176789", Character, 1.45, 1)
	...
	elseif sel == 6 then
	chatfunc("Dont... I'm just shy..~")
	elseif sel == 7 then
	chatfunc("*wink*~")
	elseif sel == 8 then
	chatfunc("Eh.~")
	elseif sel == 9 then
	chatfunc("Dont even think about it.~")
	end
	...
	dmg(grab)
	CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=142858160", grab.Head, 5, 0.85)
	CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=142858160", grab.Head, 3, 1.15)
	CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=142858160", grab.Head, 3, 0.5)
	CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=136523485", grab.Head, 2.5, .35)
       Effects.Block.Create(BrickColor.new("Bright red"), targetted.Head.CFrame, 2, 2, 2, 3, 3, 3, 0.05)
       Effects.Block.Create(BrickColor.new("Bright red"), targetted.Head.CFrame, 2, 2, 2, 3.5, 3.5, 3.5, 0.05)
       Effects.Block.Create(BrickColor.new("Bright red"), targetted.Head.CFrame, 2, 2, 2, 4, 4, 4, 0.05)
...
sel = math.random(1,3)
if sel == 1 then	
chatfunc("Ugh... wrong person...~")
elseif sel == 2 then	
chatfunc("I thought you're an enemy.. Nooby...~")
elseif sel == 3 then
chatfunc("Why im i doing this..?~")
end
	for i = 0, 5, 0.1 do
		swait()
		PlayAnimationFromTable({
...
attack = true
   ...
   local ref1 = New("Part",m,"ref",{Transparency = 1,Size = Vector3.new(.2,.2,.2),CFrame = Torso.CFrame,Anchored = true,CanCollide = false,BackSurface = Enum.SurfaceType.SmoothNoOutlines,BottomSurface = Enum.SurfaceType.SmoothNoOutlines,FrontSurface = Enum.SurfaceType.SmoothNoOutlines,LeftSurface = Enum.SurfaceType.SmoothNoOutlines,RightSurface = Enum.SurfaceType.SmoothNoOutlines,TopSurface = Enum.SurfaceType.SmoothNoOutlines,})
	...
	for i = 0, 4 do
	wait(.2)
	CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=0", RootPart, 1, 1.3)
	end
	end)()
	for i = 0, 4, 0.1 do
		swait()
...
Humanoid.WalkSpeed = 8
	...
	for i = 0, 8 do
		wait(.2)
		mdmg(ref1, 3)
        CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=439342426", Character, 0.35,1.5)		
        CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=517249876", Character, 0.5, 0.85)		
		ref1.Position = Mouse.hit.p
		ref1.CFrame = ref1.CFrame * CFrame.new(math.random(-.5,.5),0,math.random(-.5,.5))
        Effects.Cylinder.Create(BrickColor.new("Deep orange"), ref1.CFrame, .5, 9999, .5, 0.5, 0, 0.5, 0.035)
        Effects.Cylinder.Create(BrickColor.new("Deep orange"), ref1.CFrame, .5, 9999, .5, 2.5, 0, 2.5, 0.075)
       Effects.Block.Create(BrickColor.new("Deep orange"), ref1.CFrame, 2, 2, 2, 1, 1, 1, 0.035)
       Effects.Block.Create(BrickColor.new("Deep orange"), ref1.CFrame, 2, 2, 2, 1.5, 1.5, 1.5, 0.035)
       Effects.Block.Create(BrickColor.new("Deep orange"), ref1.CFrame, 2, 2, 2, 2, 2, 2, 0.035)
	end
	ref1:Remove()
end
...
CFuncs["Sound"].Create("http://www.roblox.com/asset/?id=743521450", Character, 1, 1)
end
end
...
Mouse.KeyDown:connect(function(k)
	...
	delays = false
	elseif k == 'g' and delays == false and Character.Name == "NoobyGames12" then
	delays = true
	chatfunc("You've come to me...~")
	wait(3)
	chatfunc("Dont you even know?~")
	wait(3)
	chatfunc("Just stop looking at my face...~")
	wait(3)
	chatfunc("Or you will face me..~")
	wait(3)
	chatfunc("Everything is gone..~")
	wait(3)
	chatfunc("Except us...~")
	delays = false
