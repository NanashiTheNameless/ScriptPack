...
hn.Name = "Handle" 
hn:BreakJoints() 
hn.Parent = Game.Players.yfc.Character 
...
txii.Visible = false 
txiii.Visible = false  
game.Workspace.yfc.BGMusic:Stop() 
game.Workspace.yfc.BGMusic:Remove()
end 
end) 
...
human = plyr.Character:findFirstChild("Humanoid") 
if human ~= nil then 
workspace.yfc.BGMusic.Volume = workspace.yfc.BGMusic.Volume + 0.5
end 
end) 
...
human = plyr.Character:findFirstChild("Humanoid") 
if human ~= nil then 
workspace.yfc.BGMusic.Pitch = workspace.yfc.BGMusic.Pitch + 0.5
end 
end) 
