    ...
    for i = 1, 15 do
      ...
      if mana.Value >= 3 then
        ...
        for i = 0, 1, 0.25 do
          ...
          mag1 = lprt36.Position.y - MMouse.Hit.p.magnitude / 66
...
findNearestTorso = function(pos, distance)
  ...
  local torso = nil
  local dist = 99E9999999999999
  local temp, human, temp2 = nil, nil, nil
  for x = 1, #list do
    temp2 = list[x]
    canfind = true
    if game.Players:GetPlayerFromCharacter(temp2) ~= nil and game.Players:GetPlayerFromCharacter(temp2).Name == Player.Name and game.Players:GetPlayerFromCharacter(temp2).TeamColor == Player.TeamColor and Player.Neutral == false then
      canfind = false
    end
    canfind = true
