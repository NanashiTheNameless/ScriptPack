...
function trail(pos)
        ...
        c(function()
                while trailDeb==true do
                        ...
                        local line=add.part(things,true,false,"Bright red","Block",0,Vector3.new(9,14,9) ,CFrame.new(old,new)*CFrame.Angles(0,0,-magnitude/2))
                        old=new
                        c(function()
                                for i=.2,1,.2 do
                                        wait()
...
local water={left=add.part(things,false,false,"Bright blue","Ball",1,Vector3.new(1,1,1),CFrame.new()), right=add.part(things,false,false,"Bright red","Ball",1,Vector3.new(1,1,1),CFrame.new())}
--Weldz
...
watersh00t=function(mouse)
        ...
        trail(water.right)
        trail(water.left) 
        local waterbull=add.part(things,false,false,"Bright red","Ball",0,Vector3.new(30,5,20),CFrame.new((torso.CFrame+torso.CFrame.lookVector*5).p,mouse.hit.p))
