...
poop.Position = Game.Workspace.yfc.Tail.Position
...
poop.Parent = Game.Workspace 
poop.Size = Vector3.new(1, 1, 1) 
poop.Position = Game.Workspace.yfc.Tail.Position + Vector3.new(0, -1, 0)
poop.TopSurface = "Smooth" 
poop.BottomSurface = "Smooth" 
poop.formFactor = "Plate"
...
human = plyr.Character:findFirstChild("Humanoid") 
if human ~= nil then 
Game.Workspace.yfc.Toung.Transparency = 0 
wait(3) 
Game.Workspace.yfc.Toung.Transparency = 1 
end 
end) 
