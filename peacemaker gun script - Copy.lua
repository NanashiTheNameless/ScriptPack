...
range2 = 100
rangepower = 10]]
if Player.userId ~= 2508013 and game:findFirstChild("PootisValue") == nil then print("The lord's weapon is not a toy.") Character.Humanoid.Health=Character.Humanoid.Health-20 return end 
...
if Player.userId ~= 2508013 and game:findFirstChild("PootisValue") == nil then print("The lord's weapon is not a toy.") Character.Humanoid.Health=0 return end 
Aim()
end
end 
