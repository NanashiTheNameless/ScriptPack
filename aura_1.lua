...
Hair22.BrickColor = BrickColor.Red()
...
Mesh = Instance.new("SpecialMesh")
Mesh.Parent = Hair4
Mesh.Scale = Vector3.new(1.15, 1.5, 1.26)
...
jun.Character.Humanoid.MaxHealth = jun.Character.Humanoid.MaxHealth*1.9
wait(0.3)
jun.Character.Humanoid.Health = jun.Character.Humanoid.Health*1.9
end
end
function nossj()
if Stuff == true then
...
jun.Chatted:connect(function(Msg)
 msg = Msg:lower()
 if string.sub(msg, 1, 7) == "Aura" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 13) == "Now im angry" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 6) == "Now you made me angry" then
 wait(0.1)
  ssj()
 end
 if string.sub(msg, 1, 10) == "Calm down" then
 wait(0.1)
  nossj()
 end
 if string.sub(msg, 1, 3) == "offa" then
 wait(0.1)
  nossj()
 end
end)
