...
colors={"Institutional white","Gold"}
...
local ball=part(1,nil,0,0.5,BrickColor.new("Institutional white"),"DarkBall",vt(1,1,1))
...
local handle=part(1,modelzorz,0,0,BrickColor.new("Institutional white"),"Part1",vt(0.35, 4, 0.35))
...
han2 = pa(su,"","Block",0.35,4,0.35,false,false,0,0,"Institutional white") it('CylinderMesh',han2)
...
han5 = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",han5,MeshType="Sphere",Scale=v3(0.35,0.6,0.35)*5})
 
han5w = qi({"Weld",han2,Part0=han2,Part1=han5,C0=cn(0,2,0)})
 
han6 = pa(su,"","Wedge",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",han6,MeshType="Wedge",Scale=v3(0.1,1,0.5)*5})
...
des = pa(su,"","Block",0,0,0,false,false,0,0.05,"Institutional white") qi({"SpecialMesh",des,MeshType="FileMesh",Scale=v3(0.2,1,0.2),MeshId=Decs.Diamond})
...
han10 = pa(su,"","Block",0,0,0,false,false,0,1,"Institutional white") it('CylinderMesh',han10).Scale = v3(1.2,0.57,1.2)
...
clawa1 = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",clawa1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike})
 
clawa1w = qi({"Weld",han2,Part0=laa,Part1=clawa1,C0=ca(rd(180),0,0)*cn(-0.2,1.25,0)})
 
clawa2 = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",clawa2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike})
...
badge2 = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",badge2,MeshType="FileMesh",Scale=v3(0.149,1,0.495),MeshId=Decs.Diamond})
...
db1 = pa(su,"","Block",0,0,0,false,false,1,0,"Institutional white") qi({"SpecialMesh",db1,MeshType="Sphere",Scale=v3(1,1,1)*5})
...
sho = pa(su,"","Block",0,0,0,false,false,0,0,"Institutional white") qi({"SpecialMesh",sho,Scale=v3(1.1,1.1,1.1)*5,MeshType="Wedge"}) 
...
local spike=part(1,nil,0,0.5,BrickColor.new("Institutional white"),"DarkBall",vt(1,1,1))
...
GroundEffect(Torso,0,1.5,0,math.random(-5,5),-3,math.random(-5,5),0,0,0,BrickColor.new("Institutional white")) 
...
GroundEffect(Torso,8,8,8,0,0,0,0,0,0,BrickColor.new("Institutional white")) 
...
MMMAGIC(bla3,3,3,3,0,-2,0,BrickColor.new("Institutional white")) 
 
MMMAGIC2(bla3,1,3,1,0,-2,0,BrickColor.new("Institutional white")) 
...
effect("Institutional white",0.5,LastPoint,Point)
 
LastPoint = Point
 
local Point2 = bla3.CFrame * CFrame.new(1,bla3.Size.Y/2,0)
 
effect("Institutional white",0.5,LastPoint2,Point2)
 
LastPoint2 = Point2
 
local Point3 = bla3.CFrame * CFrame.new(-1,bla3.Size.Y/2,0)
 
effect("Institutional white",0.5,LastPoint3,Point3)
...
MMMAGIC3(bla3,2,4,6,0,-2,0,1.57,0,0,BrickColor.new("Institutional white")) 
...
cloud=part(1,workspace,0,1,BrickColor.new("Institutional white"),"Cloud",Vector3.new(50,5,50))
...
MMMAGIC(LeftArm,1,1,1,0,-1,0,BrickColor.new("Institutional white")) 
 
MMMAGIC(RightArm,1,1,1,0,-1,0,BrickColor.new("Institutional white")) 
 
GroundEffect(LeftArm,0.1,0.1,0.1,math.random(-1,0)+math.random(),math.random(-1,0)+math.random(),math.random(-1,0)+math.random(),0,0,0,BrickColor.new("Institutional white")) 
 
GroundEffect(RightArm,0.1,0.1,0.1,math.random(-1,0)+math.random(),math.random(-1,0)+math.random(),math.random(-1,0)+math.random(),0,0,0,BrickColor.new("Institutional white")) 
 
if count==3 then
 
WaveEffect2(Torso,3,8,3,0,-2,0,0,0,0,BrickColor.new("Institutional white")) 
...
MMMAGIC(TargetTors,8,8,8,0,0,0,BrickColor.new("Institutional white")) 
...
MMMAGIC(TargetTors,5,5,5,0,0,0,BrickColor.new("Institutional white")) 
...
WaveEffect(Torso,1,2,1,0,0,0,-1.57,0,0,BrickColor.new("Institutional white")) 
...
blackhoel=part(1,workspace,0,1.11,BrickColor.new("Institutional white"),"Hole Thingy",Vector3.new(50,5,50))
...
WaveEffect3(TargetTors,40,50,20,0,0,0,0,0,0,BrickColor.new("Institutional white")) 
...
MMMAGIC(RightArm,2,2,2,0,-1,0,BrickColor.new("Institutional white"))
...
--GroundEffect(Torso,1,0,1,0,0,0,0,1.57,0,BrickColor.new("Institutional white")) 
 
WaveEffect(Torso,3,1,3,0,0,0,0,0,-1.57,BrickColor.new("Institutional white")) 
...
local dd=part(1,workspace,0,0,BrickColor.new("Institutional white"),"Part",Vector3.new(1,1,1))
...
MMMAGIC(RightArm,5,5,5,math.random(-3,3),math.random(-5,1),math.random(-3,3),BrickColor.new("Institutional white"))
...
MMMAGIC(Torso,5,5,5,math.random(-3,3),math.random(-1,5),math.random(-3,3),BrickColor.new("Institutional white"))
...
MMMAGIC(Torso,4,4,4,math.random(-7,7),math.random(-7,7),math.random(-7,7),BrickColor.new("Institutional white"))
 
GroundEffect(Torso,0.1,2,0.1,math.random(-10,10),math.random(-6,-2),math.random(-10,10),0,0,0,BrickColor.new("Institutional white")) 
...
GroundEffect(Torso,3.5,3.5,3.5,0,0,0,0,0,0,BrickColor.new("Institutional white")) 
...
MMMAGIC(Torso,12,12,12,0,0,0,BrickColor.new("Institutional white"))
...
MMMAGIC(sword,1,1,1,0,0,-3,BrickColor.new("Institutional white")) 
...
WaveEffect(sword,1,1,1,0,0,0,-1.57,0,0,BrickColor.new("Institutional white")) 
...
local pderp=part(1,modelzorz,0,1,BrickColor.new("Institutional white"),"DarkBall",vt(1,1,1))
...
MMMAGIC(effectsg,3,3,3,0,0,0,BrickColor.new("Institutional white")) 
 
MMMAGIC(effectsg,5,5,5,0,0,0,BrickColor.new("Gold")) 
 
for i=1,5 do
 
MMMAGIC2(effectsg,1,3,1,0,0,0,BrickColor.new("Institutional white")) 
