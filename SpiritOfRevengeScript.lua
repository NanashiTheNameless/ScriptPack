--MADE BY OneLegend (NOT THE SCRIPT) Credits to CyberFromLU for letting me publish REGULAR SCRIPT: Just hit CNTRL + H and where it says Find what type "BRICKER24alt" and where it says Replace with Put your name.
...
--lego
game.Workspace.BRICKER24alt.Humanoid.MaxHealth = math.huge  -----Replace BRICKER24alt with your name, it gives you INF health, enjoy. C:
print(lego)
