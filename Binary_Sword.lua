...
local Colorr3=BrickColor.new("Really Black")
...
prtd1=part(3,model2,0,0.4,BrickColor.new("Really Black"),"DPart1",vt())
...
prtd7=part(3,model2,0.8,0,BrickColor.new("Really Black"),"DPart7",vt())
prtd8=part(3,model2,0.8,0,BrickColor.new("Really Black"),"DPart8",vt())
prtd9=part(3,model2,0.5,0.2,BrickColor.new("Really Black"),"DPart9",vt())
prtd10=part(3,model2,0.5,0.2,BrickColor.new("Really Black"),"DPart10",vt())
prtd11=part(3,model2,0.5,0,BrickColor.new("Really Black"),"DPart11",vt())
...
--light.Color=BrickColor.new("Really Black")
light.Range=10
light.Parent=prtd9
...
MagicWave(BrickColor.new("Really Black"),cf(Torso.Position)*cf(0,-1,0),1,1,1,1.5,1,1.5,0.05)
...
MagicWave(BrickColor.new("Really Black"),cf(Torso.Position)*cf(0,-1,0)*euler(0,math.random(-50,50),0),1,1,1,.5,.3,.5,0.01)
Mode="Demon"
...
Lightning(pos1,pos2,5,3,"Really Black",.1,.5,.5)
MagicCircle(BrickColor.new("Really Black"),cf(pos1),5,5,5,1,1,1,.1)
MagicBlood(BrickColor.new("Really Black"),Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.1,.1,.1,.1,2,.1,0.05)
...
num2=num2+magik
if num2>=50 then
MagicBlood(BrickColor.new("Really Black"),cf(prtd8.Position)*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.1,.1,.1,.1,1,.1,0.1)
num2=0
end
--MagicBlock(BrickColor.new("Really Black"),cf(prtd8.Position)*cf(math.random(-100,100)/100,math.random(-100,100)/100,math.random(-100,100)/100)*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),magik/5,magik/5,magik/5,magik/8,magik/8,magik/8,.1)
end
...
local blockprt=part(3,Character,0,1,BrickColor.new("Really Black"),"Block",vt(8,.1,8))
...
if num>10 then
num=0
MagicBlock(BrickColor.new("Really Black"),LeftArm.CFrame*cf(0,-1,0),1,1,1,.7,.7,.7,0.05)
MagicCircle(BrickColor.new("Really Black"),LeftArm.CFrame*cf(0,-1,0),1,.1,1,6,0,6,0.1)
end
blockprt.CFrame=LeftArm.CFrame*cf(0,-1,0)
num=num+1
end
...
--                vp.velocity=Character.Torso.CFrame.lookVector*Knockback
                ...
                for i=1,5 do
                MagicBlood(BrickColor.new("Really Black"),hit.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.1,.1,.1,.1,2,.1,0.05)
                end
                vp=Instance.new("BodyVelocity")
                vp.P=500
                vp.maxForce=Vector3.new(math.huge,0,math.huge)
