...
Handle = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Handle", Vector3.new(0.700000048, 0.369999945, 0.280000091))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(0.700000048, 0.369999945, 0.280000091))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(1, 1.19999993, 1.20000005))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(0.200000018, 0.919999897, 0.929999948))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pearl", "Part", Vector3.new(0.600000024, 0.299999893, 0.300000012))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Barrel = CreatePart(m, Enum.Material.Neon, 0, 0, "Pastel yellow", "Barrel", Vector3.new(0.299999952, 0.299999952, 0.49999997))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Pastel yellow", "Part", Vector3.new(0.299999952, 0.299999952, 0.49999997))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pearl", "Part", Vector3.new(0.300000012, 0.299999893, 0.300000012))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Pearl", "Part", Vector3.new(0.299999952, 0.299999952, 0.49999997))
...
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pearl", "Part", Vector3.new(0.400000006, 0.299999893, 0.300000012))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.FileMesh, "http://www.roblox.com/asset/?id=3270017", Vector3.new(0, 0, 0), Vector3.new(1, 1, 2))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pearl", "Part", Vector3.new(1.23000002, 1.24000001, 1.20000005))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Sphere, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pearl", "Part", Vector3.new(2.21000004, 0.299999893, 0.300000012))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Pastel yellow", "Part", Vector3.new(1, 0.789999902, 0.709999919))
...
Part = CreatePart(m, Enum.Material.Neon, 0, 0, "Pastel yellow", "Part", Vector3.new(0.220000029, 0.919999897, 0.929999948))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(1.48000002, 0.819999933, 1.20000005))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(1, 0.789999902, 0.709999919))
PartWeld = CreateWeld(m, Handle, Part, CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1), CFrame.new(0.140090942, -1.10543823, 1.39955378, 0.000366366556, -0.000121983321, 1.00000107, 1.00000107, -0.000305830443, -0.000366173568, 0.000304477202, 1.00000131, 0.000122066587))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 0.5))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(0.220000058, 0.619999945, 0.710000098))
...
CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = CreatePart(m, Enum.Material.SmoothPlastic, 0, 0, "Pastel yellow", "Part", Vector3.new(2.1500001, 0.819999933, 0.780000031))
