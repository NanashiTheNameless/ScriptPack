--[[
H&K M417 Carbine; developed as a reliable Designated Marksman Rifle.
Essentially a scaled-up M416
7.62x51mm NATO, H&K Polymer 20 Round Magazines.
Under review by the US Military.
...
Name = "Alive"
MC = BrickColor.new("Brick yellow")
...
function makeParts(format)
	...
	elseif Magazine == "H&K" then
		...
		pm2.Parent = model
		local m = Instance.new("BlockMesh")
		m.Scale = Vector3.new(0.25, 0.28, 0.6)
		m.Offset = Vector3.new(0, 0.08, 0)
		m.Parent = pm2
		local w = Instance.new("Weld")
		w.Part0 = pm2
		w.Part1 = pm
		...
		p.Parent = model
		local m = Instance.new("BlockMesh")
		m.Scale = Vector3.new(0.2, 0.41, 0.6)
		m.Parent = p
		local w = Instance.new("Weld")
		w.Part0 = p
		w.Part1 = pm2
		...
		p.Parent = model
		local m = Instance.new("BlockMesh")
		m.Scale = Vector3.new(0.26, 0.446, 0.1)
		m.Parent = p
		local w = Instance.new("Weld")
		w.Part0 = p
		w.Part1 = pm2
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.38, 0.8, 0.18)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.18, 1.88, 0.38)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.54, -0.04)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Center" --------------
