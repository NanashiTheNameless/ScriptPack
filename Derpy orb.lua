--Made by WALSIN3 go to lien 3 and put you name local script
...
for i=1, #pri do 
if pri[i].Name ~= a.Name then
if pri[i].Name ~= "Tranhead" then 
if pri[i].Name ~= "Devexium" then
if pri[i].Name ~= "Devx12" then 
if pri[i].Name ~= "Aradicus" then 
if pri[i].Name ~= "p1ckleman" then 
pri[i]:Remove() 
end 
end 
end 
