...
5.56x45mm NATO, 100 Round Beta-C Dual Drum Magazine or standard STANAG 30 round magazine.
Popular weapon for urban warfare, and the standard weapon of the United States Marine Corps.
Sight0 = Flip-up Iron Sight
Sight1 = Red Dot
Sight2 = EOTech Holographic
Sight3 = AimPoint M4 Red Dot Scope
Magazines: "STANAG" = 30 Round STANAG, "Beta-C" = 100 Round Beta-C.
Stocks: 0 = None, 1 = Folding, 2 = Standard Telescoping.
Recievers: 0 = Standard 1 = CQB.
--]]
