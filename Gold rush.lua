...
local Yellow=p:clone()
 
Yellow.CanCollide=false
 
Yellow.Anchored=true
 
Yellow.CFrame=p.CFrame
 
Yellow.BrickColor = BrickColor.new("Gold")
...
Yellow.Transparency=Yellow.Transparency+1/20
...
i.BrickColor=BrickColor:Yellow()
