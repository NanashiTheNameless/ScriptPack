...
z.SoundId = "rbxassetid://338700363" --190470714, 242463565
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.01)
...
change = 0.5
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(3,.9,0)*CFrame.Angles(math.rad(0+0*math.cos(sine/14)),math.rad(0),math.rad(20)), 0.2)
...
if stanceToggle == "Normal" then
change = 1
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(3, .9+.1*math.cos(sine/7), 0) * CFrame.Angles(math.rad(0+0*math.cos(sine/7)), math.rad(0), math.rad(20)), 0.2)
