...
o7 = System.Create("IntValue",{
["Name"] = "Right1",
["Parent"] = o1,
["Value"] = 39,
})
o8 = System.Create("IntValue",{
["Name"] = "Right2",
["Parent"] = o1,
["Value"] = 19,
})
...
game:GetObjects("rbxassetid://536629683")[1].Parent = script

--cape create \\\\\\\\\\\\\\\\\\\\\\\\

game:GetObjects("rbxassetid://536628496")[1].Parent = script.Armor
...
clothinganim=function()
	...
	script.Initial.Value = -6 - math.deg(fluidback*1.5) + (jumpeff)
	script.Progression.Value = gottagofast*1.5 + - (jumpeff * 2) - 1
	
	script.Right1.Value=40-gottagofast*17.5 + (jumpeff * 3)
	script.Right2.Value=20-gottagofast*8 + (jumpeff * 4)
	script.Left1.Value=40-gottagofast*17.5 + (jumpeff * 3)
	script.Left2.Value=20-gottagofast*8 + (jumpeff * 4)
end
...
-- cape script create\\\\\\\\\\\\\\\\\\\
	...
	--SazErenos
asdf=armor.Cloak --Ihaveaproblemsendhelp
...
t1w,t2w,t3w,t4w,t5w,l1w,l2w,r1w,r2w,t4l,t4r,t5r,t5l,t6r,t6l=nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil
	...
	t1w.Part0=Nub.Torso
	t1w.Part1=Tier1M
	t1w.C0=CFrame.new(0,1.15,0.5)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(-90),math.rad(0))
	t1w.C1=CFrame.new(0,.28,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t1w.MaxVelocity=.08
	t1w.DesiredAngle=.4
	
	w=Instance.new("Motor6D",Tier1M)
	w.Name="TierWeldF"
	w.Part0=Tier1M
	w.Part1=armor.Cloak.Tier1F
	w.C0 = w.C0 * CFrame.Angles(math.pi/2,0,0)
	
	wait(.1)

	t2w=Instance.new("Motor6D",Tier3M)
	t2w.Name="TierWeld"
	t2w.Part0=Tier1M
	t2w.Part1=Tier2M
	t2w.C0=CFrame.new(0,-.3,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t2w.C1=CFrame.new(0,0,.19)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(90),math.rad(90))
	t2w.MaxVelocity=.08
	t2w.DesiredAngle=-.05
	
	t3w=Instance.new("Motor6D",Tier2M)
	t3w.Name="TierWeld"
	t3w.Part0=Tier2M
	t3w.Part1=Tier3M
	t3w.C0=CFrame.new(0,0,-.2)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(90),math.rad(90))
	t3w.C1=CFrame.new(0,0,.19)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(-90),math.rad(-90))
	t3w.MaxVelocity=.08
	t3w.DesiredAngle=-.05
	
	t4w=Instance.new("Motor6D",Tier3M)
	t4w.Name="TierWeld"
	t4w.Part0=Tier3M
	t4w.Part1=Tier4M
	t4w.C0=CFrame.new(0,0,-.2)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(-90),math.rad(0))
	t4w.C1=CFrame.new(0,0,-.29)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(90),math.rad(0))
	t4w.MaxVelocity=.08
	t4w.DesiredAngle=-.05
	
	t4l=Instance.new("Motor6D",Tier4M)
	t4l.Name="TierWeldL"
	t4l.Part0=Tier4M
	t4l.Part1=asdf.Tier5L
	t4l.C0=CFrame.new(1.19,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(180),math.rad(180),math.rad(90))
	t4l.C1=CFrame.new(0,-.1,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t4l.MaxVelocity=.08
	t4l.DesiredAngle=.8
	
	t4r=Instance.new("Motor6D",Tier4M)
	t4r.Name="TierWeldR"
	t4r.Part0=Tier4M
	t4r.Part1=asdf.Tier5R
	t4r.C0=CFrame.new(-1.19,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(90))
	t4r.C1=CFrame.new(0,-.1,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t4r.MaxVelocity=.08
	t4r.DesiredAngle=-.8
	
	t5w=Instance.new("Motor6D",Tier4M)
	t5w.Name="TierWeld"
	t5w.Part0=Tier4M
	t5w.Part1=Tier5M
	t5w.C0=CFrame.new(0,0,.3)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(90),math.rad(0))
	t5w.C1=CFrame.new(0,.0,-.39)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(90),math.rad(0))
	t5w.MaxVelocity=.08
	t5w.DesiredAngle=-.05
	
	t5p=Instance.new("Motor6D",Tier5M)
	t5p.Name="AttachWeld"
	t5p.Part0=Tier5M
	t5p.Part1=asdf.Tier6R
	t5p.C0=CFrame.new(-.1,0,.7)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(180),math.rad(90))
	t5p.C1=CFrame.new(0,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t5p.MaxVelocity=0
	t5p.DesiredAngle=0
	...
	t5p.Name="AttachWeld"
	t5p.Part0=Tier5M
	t5p.Part1=asdf.Tier6L
	t5p.C0=CFrame.new(.1,0,.7)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(180),math.rad(-90))
	t5p.C1=CFrame.new(0,0,0)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(0))
	t5p.MaxVelocity=0
	t5p.DesiredAngle=0
	
	t5l=Instance.new("Motor6D",Tier5M)
	t5l.Name="TierWeldL"
	t5l.Part0=Tier5M
	t5l.Part1=asdf.L1
	t5l.C0=CFrame.new(1.18,0,.5)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(180))
	t5l.C1=CFrame.new(0,0,0.28)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(90))
	t5l.MaxVelocity=.08
	t5l.DesiredAngle=0
	
	t5r=Instance.new("Motor6D",Tier5M)
	t5r.Name="TierWeldL"
	t5r.Part0=Tier5M
	t5r.Part1=asdf.R1
	t5r.C0=CFrame.new(-1.18,0,.5)*CFrame.fromEulerAnglesXYZ(math.rad(0),math.rad(0),math.rad(180))
	t5r.C1=CFrame.new(0,0,-.28)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(90))
	t5r.MaxVelocity=.08
	t5r.DesiredAngle=-0
	
	t6l=Instance.new("Motor6D",asdf.L1)
	t6l.Name="TierWeldL"
	t6l.Part0=asdf.L1
	t6l.Part1=asdf.L2
	t6l.C0=CFrame.new(0,-.56,-.28)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(0))
	t6l.C1=CFrame.new(0,0,0.18)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(0))
	t6l.MaxVelocity=.08
	t6l.DesiredAngle=0.8
	
	t6r=Instance.new("Motor6D",asdf.R1)
	t6r.Name="TierWeldR"
	t6r.Part0=asdf.R1
	t6r.Part1=asdf.R2
	t6r.C0=CFrame.new(0,-.56,.28)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(0))
	t6r.C1=CFrame.new(0,0,-.18)*CFrame.fromEulerAnglesXYZ(math.rad(90),math.rad(0),math.rad(0))
	t6r.MaxVelocity=.08
	t6r.DesiredAngle=0.8
wait()
...
game:GetObjects("rbxassetid://530870142")[1].Parent = script
wait(0.5)
...
for _, v in pairs (vPlayer.Character.Armor.Cloak:GetChildren()) do
	for _, b in pairs (v:GetChildren()) do
...
--SazErenos
asdf=vPlayer.Character.Armor.Cloak --Ihaveaproblemsendhelp
Nub=game.Players.LocalPlayer.Character
Tier1M=asdf.Tier1
Tier2M=asdf.Tier2
--nope
...
t1w,t2w,t3w,t4w,t5w,l1w,l2w,r1w,r2w,t4l,t4r,t5r,t5l,t6r,t6l=nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil
	...
	w.Name="TierWeldF"
	w.Part0=Tier1M
	w.Part1=vPlayer.Character.Armor.Cloak.Tier1F
	w.C0 = w.C0 * CFrame.Angles(math.pi/2,0,0)
...
return
	...
	t1w.DesiredAngle=math.rad(script.Initial.Value + script.Progression.Value + script.Hard.Value)
	t2w.DesiredAngle=math.rad(script.Progression.Value/2)
	t3w.DesiredAngle=math.rad(script.Progression.Value/2)
	t4w.DesiredAngle=math.rad(script.Progression.Value/2)
	t5w.DesiredAngle=math.rad(script.Progression.Value/2)
	
	t4r.DesiredAngle=-math.rad(script.Right1.Value/2)
	t5r.DesiredAngle=-math.rad(script.Right1.Value/2)
	t6r.DesiredAngle=-math.rad(script.Right2.Value/2)
	
	t4l.DesiredAngle=math.rad(script.Left1.Value/2)
	t5l.DesiredAngle=math.rad(script.Left1.Value/2)
	t6l.DesiredAngle=math.rad(script.Left2.Value/2)
