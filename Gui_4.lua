...
FullEXP.MouseButton1Down:connect(function(open)
    while true do
    wait(5)
    game.ReplicatedStorage.Remotes.SetStat:FireServer("EXP", 99999, "math.random() is the best thing ever")
end
end)
...
Nowipe.MouseButton1Down:connect(function(open)
    game.ReplicatedStorage.Remotes.WipeInventory:Remove()
    Instance.new("RemoteEvent", game.Workspace.Stats)
    game.ReplicatedStorage.Remotes.RemoteEvent.Name = "WipeInventory"
end)
...
SetBounty.MouseButton1Down:connect(function(open)
    BountyA = Namee.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Bounty", tonumber(BountyA) + 0, "math.random() is the best thing ever")
end)
...
InfiniteLamina.MouseButton1Down:connect(function(open)
    LaminaA = Namee_2.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Lamina", tonumber(LaminaA) + 0, "math.random() is the best thing ever")
end)
...
Legendary.MouseButton1Down:connect(function(open)
    LegendaryA = Namee_3.Text
game.ReplicatedStorage.Remotes.SetStat:FireServer("Reputation", tonumber(LegendaryA) + 0, "math.random() is the best thing ever")
end)
...
Level.MouseButton1Down:connect(function(open)
    LevelA = Namee_4.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Level", tonumber(LevelA) + 0, "math.random() is the best thing ever")
end)
...
SetMagic.MouseButton1Down:connect(function(open)
    MagicA = Namee_5.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Magic", tostring(MagicA), "math.random() is the best thing ever")
end)
...
SetSecondMagic.MouseButton1Down:connect(function(open)
    MagicA2 = Namee_6.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Magic2", tostring(MagicA2), "math.random() is the best thing ever")
end)
...
AnimationPack.MouseButton1Down:connect(function(open)
    AP = Level.Namee_8.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("Current Pack", tostring(AP), "math.random() is the best thing ever")
end)
 
SPA = Level.Namee_7.Text
SkillPoints.MouseButton1Down:connect(function(open)
    SPA = Level.Namee_7.Text
    game.ReplicatedStorage.Remotes.SetStat:FireServer("SP", tonumber(SPA) + 0, "math.random() is the best thing ever")
end)
