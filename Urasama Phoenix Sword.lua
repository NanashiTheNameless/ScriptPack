...
clr = BrickColor.new("Really red").Color
...
function attackone()
	attack = true
	MagnitudeDamage(RightArm, 40000000, 60000000, 150000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
	...
	MagnitudeDamage(LeftArm, 300000000, 50000000, 1500000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
...
function TheWorld(Mode)
     if Mode == "World Time Stop" then
        ...
        TimeStop.SoundId = "rbxassetid://576124533"
...
function attacktwo()
	...
	MagnitudeDamage(LeftLeg, 300000000, 5000000000, 150000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
	...
	MagnitudeDamage(RightLeg, 3000000000, 50000000000, 15000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.13 do
		swait()
		PlayAnimationFromTable({
...
function attackthree()
	...
	CFuncs["Sound"].Create("rbxassetid://169445092", RightArm, 1, 1)
	MagnitudeDamage(RightArm, 300000000, 500000000, 150000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.2 do
		swait()
		PlayAnimationFromTable({
	...
	MagnitudeDamage(RightLeg, 3000000000, 5000000000, 1000000500000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.13 do
		swait()
		PlayAnimationFromTable({
...
function attackfour()
	...
	MagnitudeDamage(LeftLeg, 3000000000, 5000000000, 1500000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.2 do
		swait()
		PlayAnimationFromTable({
	...
	MagnitudeDamage(LeftLeg, 3000000000, 50000000000, 1500000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.2 do
		swait()
		PlayAnimationFromTable({
...
function BladeAttackOne()
    ...
    MagnitudeDamage(Hitbox, 10000000000, 20000000000, 300000000005, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.13 do
		swait()
		PlayAnimationFromTable({
...
function BladeAttackTwo()
	attack = true
	CFuncs["Sound"].Create("rbxassetid://0", Head,1,.95)
    MagnitudeDamage(Hitbox, 10000000000000, 2000000000000, 30000000000000005, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
...
function BladeAttackThree()
	attack = true
	CFuncs["Sound"].Create("rbxassetid://0", Head,1,.95)
    MagnitudeDamage(Hitbox, 10000000000, 200000000000, 30000000000000005, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
...
function BladeAttackFour()
	...
	parti.Enabled = false
	CFuncs["Sound"].Create("rbxassetid://0", Head,1,.95)
	MagnitudeDamage(Hitbox, 100000000000, 200000000000, 350000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
	...
	parti.Enabled = true
	MagnitudeDamage(Hitbox, 100000000, 20000000, 350000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.13 do
		swait()
		PlayAnimationFromTable({
	...
	parti.Enabled = false
	MagnitudeDamage(Hitbox, 1000000, 200000000, 300000005, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.15 do
		swait()
		PlayAnimationFromTable({
	...
	parti.Enabled = true
	MagnitudeDamage(Hitbox, 100000000, 200000000, 3500000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.13 do
		swait()
		PlayAnimationFromTable({
	...
	MagnitudeDamage(Hitbox, 100000000, 20000000, 3000000005, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	parti.Enabled = false
	Humanoid.WalkSpeed = 16
	FakeHandleWeld.C0 = CFrame.Angles(0, 0, 0)
	HandleWeld:remove()
...
function Hate_Wave()
	...
	if WaveNum == 1 then -- first wave anim
		...
		coroutine.resume(coroutine.create(function()
			...
			local hit = WHB.Touched:connect(function(part) 	MagnitudeDamage(WHB, 3000000, 25000000, 35000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	...
	elseif WaveNum == 2 then
		...
		coroutine.resume(coroutine.create(function()
			debServ:AddItem(Wave, 2)
			local hit = WHB.Touched:connect(function(part) 	MagnitudeDamage(WHB, 300000, 2500000, 350000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
			repeat swait() until Wave.Parent == nil
			end)
			end))
	...
	FakeHandleWeld.C0 = CFrame.Angles(0, 0, 0)
		...
		coroutine.resume(coroutine.create(function()
			debServ:AddItem(Wave, 2)
			local hit = WHB.Touched:connect(function(part) 	MagnitudeDamage(WHB, 3000000, 2500000000, 350000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
			repeat swait() until Wave.Parent == nil
			end)
			end))
	...
	FakeHandleWeld.C0 = CFrame.Angles(0, 0, 0)
		...
		coroutine.resume(coroutine.create(function()
			debServ:AddItem(Wave, 2)
			local hit = WHB.Touched:connect(function(part) 	MagnitudeDamage(WHB, 300000, 25000000, 35000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
			repeat swait() until Wave.Parent == nil
			end)
			end))
	end
...
function Corrupt_Guard()
	...
	repeat
		...
		if Guard and GuardHealth and GDB and GDT and DBM and not DontHeal and Guard.Parent ~= nil and GuardHealth.Parent ~= nil and GDB.Parent ~= nil and GDT.Parent ~= nil and DBM.Parent ~= nil and GuardHealth.Health ~= 0 then
			...
			DBM.Parent = F2
			MagnitudeDamage(RootPart, 100000, 25000000, 350000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
...
function UNSHEATH()
	...
	CFuncs["Sound"].Create("rbxassetid://186112092", Hitbox, 1, .7)
	CFuncs["Sound"].Create("rbxassetid://0", Head,1,.95)
		MagnitudeDamage(Hitbox, 7000000, 2000000, 35000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.08 do
		swait()
		PlayAnimationFromTable({
			CFrame.new(9.59262252e-006, -0.207597882, -0.0868234336, 0.642787039, 9.57827169e-008, -0.766045034, 0.13302201, 0.984807849, 0.11161866, 0.754407108, -0.173647866, 0.633021653),
		...
		coroutine.resume(coroutine.create(function()
			debServ:AddItem(Wave, 2)
			local hit = WHB.Touched:connect(function(part) 	MagnitudeDamage(WHB, 30000000, 25000000, 3500009000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
			repeat swait() until Wave.Parent == nil
			end)
			end))
	parti.Enabled = false
...
function Sear()
	...
	MagnitudeDamage(Hitbox, 100000000, 400000000, 5000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.014 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(0, -0, -0, 0.76604414, 0, -0.642788053, 0, 1, 0, 0.642788053, 0, 0.76604414),
	...
	parti.Enabled = true
	MagnitudeDamage(Hitbox, 1000000000, 4000000000, 500000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 1, 4 do
	...
	MagnitudeDamage(Hitbox, 100000000, 4000000000000, 50000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.2 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(-3.45729177e-006, -1.07288361e-006, -1.61215644e-006, 0.422617137, 0, 0.906308293, 0, 1, 0, -0.906308293, 0, 0.422617137),
	...
	MagnitudeDamage(Hitbox, 100000000, 4000000000, 500000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	CFuncs["Sound"].Create("rbxassetid://199144647", Hitbox, 1, 1)
	for i = 0, 1, 0.2 do
		swait()
		PlayAnimationFromTable({
	...
	MagnitudeDamage(Hitbox, 1000000000, 40000000000, 500000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.25 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(0, -0, -0, 0.573575675, 0, -0.819152594, 0, 1, 0, 0.819152594, 0, 0.573575675),
	...
	CFuncs["Sound"].Create("rbxassetid://199144647", Hitbox, 1, 1.2)
	MagnitudeDamage(Hitbox, 100000000, 40000000000, 50000000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.23 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(-0, -0.179999992, 0, 0.707106352, 0, 0.707107365, 0, 1, 0, -0.707107365, 0, 0.707106352),
	...
	CFuncs["Sound"].Create("rbxassetid://199144647", Hitbox, 1, 1)
	parti.Enabled = true
	MagnitudeDamage(Hitbox, 10000000000000, 4000000000000000, 5000000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.23 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(6.67199492e-006, -0.207597449, -0.0868210196, 0.642787039, 9.57827169e-008, -0.766045034, 0.13302201, 0.984807849, 0.11161866, 0.754407108, -0.173647866, 0.633021653),
	...
	MagnitudeDamage(Hitbox, 100000000000000, 400000000000000, 500000000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
	for i = 0, 1, 0.25 do
		swait()
		PlayAnimationFromTable({
         CFrame.new(0, -0, -0, 0.76604414, 0, -0.642788053, 0, 1, 0, 0.642788053, 0, 0.76604414),
	...
	MagnitudeDamage(Hitbox, 10000000000000, 40000000000000, 5000000000000000, BrickColor.new("Really black"), BrickColor.new("Red"), "rbxassetid://199149137", 0)
