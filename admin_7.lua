local Adminlist={"yfc"}
local Banlist={"GleamingMillionaire", "hurriedmrcoolguy", "DarkGamer1003", "justhit"}
local Commands={}
local IPs={}
--[[Settings]]--
...
local IntroGui=false--[[Enables a Introduction GUI]]
...
table.insert(Adminlist,"olefson")
table.insert(Adminlist,"ArmyGuy88")
...
if IntroGui==true then
        Message("S&S Commands by Unknown"..Version.." has loaded.")
end
pcall(function()
