...
c.Parent = t1 
c.formFactor = 'Custom' 
c.Size = Vector3.new(0.4,2.3,0.4) 
...
n = t2.Neck 
n.C0 = CFrame.new(0,-1.5,0) *CFrame.Angles(math.rad(-175),math.rad(-180),math.rad(180)) 
while true do 
wait() 
for i=1,6 do 
...
for i=1,6 do 
we.C1 = we.C1 * CFrame.new(0,0.3,0) wait() end end 