...
p = bobna456 ---Put your name here where it says YOURNAMEHERE.
bp = p.Backpack
pg = p.PlayerGui
c = p.Character
he = c.Head
...
game.Workspace.jbobna456.Humanoid.MaxHealth = math.huge --Put your name where it says YOURNAMEHERE.
print(lego)
