...
CBA.admins  = {{"yfc", 7}}; --Admin list
CBA.ablist = {""} -- Antiban list
CBA.ban  = {"zacvader", "justhit", hurriedmrcoolguy"};  --Ban list
CBA.connect = {}
CBA.blocked = {}
...
funcs.status(p.Name .. " Has Entered the Server")
end 
...
funcs.status(p.Name .. " Has Left the Server")
if CBA.remove == false then return end 
for i,v in pairs(CBA.players) do
