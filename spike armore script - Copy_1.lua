:ls --MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 421 and put your name where it says "YOUR NAME HERE"
...
local g = game.Players.luxulux.Character.Suit:GetChildren()
