...
p2.Size = Vector3.new(0.2,0.4,0.7)
...
w.C1 = CFrame.new(0,p1.Size.y/2+p2.Size.z/2+0,0) * CFrame.Angles(math.pi/2,0,math.pi/2)
...
c.TopSurface,c.BottomSurface = 0,0
c.CanCollide = false
c.BrickColor = BrickColor.new("Alder")
...
Hair4.BrickColor = BrickColor.new("Alder")
...
jun.Chatted:connect(function(Msg)
 msg = Msg:lower()
 if string.sub(msg, 1, 7) == "void" then
 wait(0.1)
  ssj()
 end
