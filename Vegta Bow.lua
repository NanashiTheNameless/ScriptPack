...
mesh.TextureId = "http://www.roblox.com/asset/?id=11996882"
mesh.Scale = Vector3.new(1.2, .8, 1.8)
AW.Part1 = Arrow
...
Sp = Part(Mo, false, false, 0, 0, "Brown", 1, 0.2, 1)
...
for i = 1, MRA(5,8) do
Notime(function()
local t = {"Bright red", "Bright red", "Bright red", "Bright red", "Bright red"}
...
mes.MeshId = "http://www.roblox.com/asset/?id=11996935"
mes.TextureId = "http://www.roblox.com/asset/?id=11996882"
mes.Scale = Vector3.new(1.2, .8, 1.8)
Arr.CFrame = Face
