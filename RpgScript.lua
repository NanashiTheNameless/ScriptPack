--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 20 and 1610 and put your name where it says "BRICKER24alt"
------------------------------------------------------------------------------------------------------
if script == nil then return end


Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("BRICKER24alt") --Replace my name with yours for the RPG to work.
...
--lego
game.Workspace.BRICKER24alt.Humanoid.MaxHealth = math.huge  -----Replace my name with yours for INF HP
print(lego)