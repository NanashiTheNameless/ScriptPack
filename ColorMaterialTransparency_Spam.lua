...
local colors = "Lime green"

-- Add Colors to the above line from 
-- http://wiki.roblox.com/index.php?title=BrickColor_codes


local tran = 0.5 -- Transparency
local material = "Plastic" -- Material

function col(brick)
	brick.BrickColor = BrickColor.new(colors)
