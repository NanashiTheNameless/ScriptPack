--[[
Remington M40A3 Sniper Rifle. A proven and reliable American hunting rifle, adapted by 
the USMC as a bolt-action sniper. Based on the Remington 700, but with more militarized 
modifications. Has been in service since 1966, and is still favored by Marine snipers.
Uses 7.62x51mm [.308] rounds, 5 round integral magazine.
--]]
...
WC = BrickColor.new("Brick yellow")
...
function makeParts(format)
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 0.38, 0.6)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.3, -0.52) * CFrame.fromEulerAnglesXYZ(math.rad(15), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-0.32, -0.1, 0) * CFrame.fromEulerAnglesXYZ(0, math.rad(90), 0)
	w.C1 = CFrame.new()
	w.Parent = p			
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 1.2, 0.36)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.3, -0.11)
	w.C1 = CFrame.new()
	w.Parent = p	
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Brick"
	m.Scale = Vector3.new(0.32, 1.1, 0.2)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.3, -0.09)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Wedge"
	m.Scale = Vector3.new(0.3, 0.1, 1)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.27, 0.25) * CFrame.fromEulerAnglesXYZ(math.rad(270), 0, math.rad(180))
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Wedge"
	m.Scale = Vector3.new(0.3, 0.1, 0.2)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.24, -0.6) * CFrame.fromEulerAnglesXYZ(math.rad(270), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p		
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	m.Scale = Vector3.new(0.2, 0.9, 0.2)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.28, 0.8, 0.4)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.6, -0.62) * CFrame.fromEulerAnglesXYZ(math.rad(15), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 0.42, 0.2)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.32, -0.13)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	local m = Instance.new("SpecialMesh")
	m.MeshType = "Wedge"
	m.Scale = Vector3.new(0.3, 0.38, 0.1)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.34, 0.02)
	w.C1 = CFrame.new()
	w.Parent = p	
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.28, 0.64, 0.5)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.87, -0.4)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 0.75, 0.65)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -1.115, -0.325)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Material = "SmoothPlastic"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.31, 0.5, 0.3)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.31, 0.2, 0.66)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -1.42, -0.325)
	w.C1 = CFrame.new()
	w.Parent = p	
...
function playAnimation(format, mouse)
	...
	if format == "reload" then
		...
		if ammo.Value >= 6 then
			for i = 1, (magazineMax.Value - magazine.Value) do 
				Player.Character[Name].Handle.Reload:Play()		
				for i = 0, 1, 0.25 do
					if Player.Character:FindFirstChild("Torso") ~= nil then
						if Player.Character.Torso:FindFirstChild("Right Shoulder 2") ~= nil then
							Player.Character.Torso["Right Shoulder 2"].C0 = CFrame.new()
							Player.Character.Torso["Right Shoulder 2"].C1 =  CFrame.new(-1.2, 0.3 + (i / 2.2), 0.835) * CFrame.fromEulerAnglesXYZ(math.rad(-90), math.rad(-5), 0)
							wait()
						else return false end
					else return false end
				end	
...
function onButton1Down(mouse)
	...
	if Player.Character:FindFirstChild(Name) ~= nil and Button1Down == false and canFire == true and (function() if dual == true then if Player.Character:FindFirstChild(Name.. " (Left)") ~= nil then return true else return false end else return true end end)() == true then
		...
		while canFire2 == true do
			...
			if Chambered == true and Ready == true then
				Chambered = false
				magazine.Value = magazine.Value - 1
				updateGui()				
...
function onKeyDown(key, mouse)
	...
	if key == "c" and Button1Down == false and canFire == true then
		...
		if magazine.Value ~= 0 then
			...
			burstCount = 0
			playAnimation("bolt")
			if Chambered == true and magazine.Value ~= 0 then 
				magazine.Value = magazine.Value - 1
				updateGui()
			end
			if magazine.Value ~= 0 then
