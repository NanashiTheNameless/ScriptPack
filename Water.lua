...
local Modelname = "WaterModel"
local Toolname = "Water"
...
function CreateModel()
        ...
        handle2 = Part(modc, false, false, 0, 0, "Bright blue", 1, 1.15, 1, true)
        handle2.Name = "Handle2"
        Instance.new("CylinderMesh", handle2).Scale = Vector3.new(0.9, 0.9, 0.9)
        
        tip = Part(modc, false, false, 1, 0, "Bright blue", 0.2, 0.2, 0.2, true)
        tip.Name = "Tip"
...
function splem(p, w)
        local slem = Part(Mo, true, false, 0.3, 0.1, "Bright blue", w, 0.2, w, true)
...
function spill()
        if able and sable1 then
                ...
                wait()
                local slem = Part(Mo, false, false, 0.3, 0.1, "Bright blue", 0.2, 0.2, 0.2, true)
