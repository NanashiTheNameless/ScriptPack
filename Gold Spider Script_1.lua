...
--col = {"New Yeller,"New Yeller"}
--col = {"New Yeller","New Yeller","New Yeller"}
col = {"New Yeller","New Yeller","New Yeller"}
Anims = {}
act = {key = {}}
...
prt4.BrickColor = BrickColor.new("New Yeller") 
prt4.Name = "Part4" 
...
wait(0.1)
for i = 1,3 do
DerpMagic(prt7,Prop.LegWide*4,Prop.LegWide*4,Prop.LegWide*4,0,1,0,BrickColor.new("New Yeller")) 
shoottrail2(prt7) 
wait(0.5)
end
for i=0,1,0.1 do
...
EVENMOARMAGIX(effectsg,Prop.LegLength*3,Prop.LegLength*2,Prop.LegLength*3,0,0,0,0,0,0,BrickColor.new("New Yeller")) 
for i = 0,5 do 
wait() 
MMMAGIC(effectsg,Prop.LegLength*3,Prop.LegLength*2,Prop.LegLength*3,0,0,0,BrickColor.new("New Yeller")) 
end 
end))
coroutine.resume(coroutine.create(function()
wait(3)
