...
Player = game:GetService("Players").Scriptmuch
...
local AilaParts={}
local AilaWelds={}
local AilaWeaponWelds={}
ailatargetting=false
TargetTorso=Torso
local blocked=false
--player 
player = nil 
...
if Character:findFirstChild("Aila's Halberd",true) ~= nil then 
Character:findFirstChild("Aila's Halberd",true).Parent = nil 
end 
...
local Aila=Instance.new("Model")
Aila.Parent=nil
Aila.Name="Aila"
local AHumanoid=Instance.new("Humanoid")
AHumanoid.Parent=Aila
AHumanoid.Name="Humanoid"
AilaHealth=100
AHumanoid.MaxHealth=AilaHealth
AHumanoid.Health=AilaHealth
--AHumanoid.Died:connect(function() swait(5) if Aila==nil then return end Aila:Remove() end) 
 
local ARootPart=part("Symmetric",Aila,0,1,BrickColor.new("Bright blue"),"HumanoidRootPart",vt(2,2,1))
local AHead=part("Symmetric",Aila,0,0,BrickColor.new("Pastel brown"),"Head",vt(2,1,1))
local AHat=part("Symmetric",Aila,0,0,BrickColor.new("Bright blue"),"Hat",vt(2,2,2))
local ATorso=part("Symmetric",Aila,0,0,BrickColor.new("Bright blue"),"Torso",vt(2,2,1))
local ALeftArm=part("Symmetric",Aila,0,0,BrickColor.new("Medium stone grey"),"Left Arm",vt(1,2,1))
local ALeftLeg=part("Symmetric",Aila,0,0,BrickColor.new("Medium stone grey"),"Left Leg",vt(1,2,1))
local ARightArm=part("Symmetric",Aila,0,0,BrickColor.new("Medium stone grey"),"Right Arm",vt(1,2,1))
local ARightLeg=part("Symmetric",Aila,0,0,BrickColor.new("Medium stone grey"),"Right Leg",vt(1,2,1))
for _,c in pairs(Aila:children()) do
table.insert(AilaParts,c)
if c.className=="Part" then
c.Material="Plastic"
end
end
 
AilaShirt=Instance.new("Shirt")
AilaShirt.Parent=Aila
AilaShirt.ShirtTemplate="http://www.roblox.com/asset/?id=23077769"
AilaPants=Instance.new("Pants")
AilaPants.Parent=Aila
AilaPants.PantsTemplate="http://www.roblox.com/asset/?id=23080092"
...
table.insert(AilaWelds,c)
end
 
local modelzorz2 = Instance.new("Model") 
modelzorz2.Parent = Aila
modelzorz2.Name = "Aila's Halberd" 
...
table.insert(AilaWeaponWelds,c)
end
end
...
local ailaef=part(1,workspace,0,1,BrickColor.new("Black"),"Ef",vt(1,1,1))
ailaef.CFrame=Torso.CFrame
ailaef.Anchored=true
game:GetService("Debris"):AddItem(ailaef,2)
--so("http://www.roblox.com/asset/?id=153092315",ailaef,0.5,1)
so("http://www.roblox.com/asset/?id=161006033",ailaef,0.5,1)
for i=1,2 do
...
function AilaTeleport(AilaPos)
AilaEffect()
local LastPoint2=ATorso.CFrame
--ATorso.CFrame=AilaPos 
--Aila:MoveTo(AilaPos)
ATorso.CFrame=CFrame.new(AilaPos)*cf(math.random(-1,0)+math.random(),math.random(-1,0)+math.random(),math.random(-1,0)+math.random())
...
swait(0)
AHumanoid.Parent=Aila
for a=1,#AilaWeaponWelds do
AilaWeaponWelds[a].Parent=aprt1
end
for a=1,#AilaParts do
AilaParts[a].Parent=Aila
end
for a=1,#AilaWelds do
AilaWelds[a].Parent=ATorso
end
...
if v:FindFirstChild("Torso")~=nil and v:FindFirstChild("Humanoid")~=nil and v~=Character and v~=Aila then
...
--[[so("http://www.roblox.com/asset/?id=2101148",ailaef,1,1.1) 
so("http://www.roblox.com/asset/?id=153092334",ailaef,0.7,1) ]]
so("http://www.roblox.com/asset/?id=161006093",ailaef,1,1)
for i=1,3 do
Lightning(ailaef.Position,ailaef.Position+vt(math.random(-numb2*2,numb2*2),math.random(-numb2*2,numb2*2),math.random(-numb2*2,numb2*2)),numb2,1,"White",0.3,0.1,0.2)
end
for _,v in pairs(ALLCHILD()) do
if v.className=="Model" then
if v:FindFirstChild("Torso")~=nil and v:FindFirstChild("Humanoid")~=nil and v~=Character and v~=Aila then
if (v.Torso.Position-ailaef.Position).magnitude<=numb2*3 then
attackdebounce=false
coroutine.resume(coroutine.create(function(Hit)
...
function findNearestTorso(pos)
        ...
        for x = 1, #list do
                temp2 = list[x]
                if (temp2.className == "Model") and (temp2 ~= Character) and (temp2.Name ~= "IoneIinessDoL") then
...
Damagefunc=function(hit,minim,maxim,knockback,Type,Property)
        ...
        if h~=nil and hit.Parent.Name~=Character.Name and hit.Parent.Name~=Aila.Name and hit.Parent:FindFirstChild("Torso")~=nil then
...
for i=0,1,0.1 do
swait()
print(RW.C0.CFrame.fromEulerAnglesXYZ)
RW.C0=cf(1.5,0.5,0)*euler(0,0,0.5)
RW.C1=cf(0,0.5,0)*euler(0,0,0)
LW.C0=cf(-1.5,0.5,0)*euler(0,0,-0.5)
LW.C1=cf(0,0.5,0)*euler(0,0,0)
...
if ailaattack==true then return end
if key=="c" then
--AilaTeleport(TargetTorso.CFrame)
AilaTeleport(TargetTorso.Position)
end
if key=="v" then
AilaSlash4()
end
...
swait(0.1)
Hum.Died:connect(function() ATorso.Parent=nil; UnsummonAila() end)
end),Humanoid)
print("Fen & Aila loaded.")
...
if ailatargetting==false then
Abg.Parent=nil
if magnidist >= 20 then 
if math.random(1,3)==1 and Aila.Parent~=nil then
--AilaTeleport(TargetTorso.CFrame)
AilaTeleport(TargetTorso.Position)
end
...
if magnidist >= 20 then 
if math.random(1,2)==1 and Aila.Parent~=nil then
--AilaTeleport(TargetTorso.CFrame)
AilaTeleport(TargetTorso.Position)
slash=math.random(1,4)
if slash==1 then
