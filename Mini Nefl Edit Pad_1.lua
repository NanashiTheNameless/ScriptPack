...
music.SoundId = "http://www.roblox.com/asset/?id=0" --340106355
music.Volume = 0
music.Looped = true
wait(0.1)
music:Play()
...
music2.SoundId = "http://www.roblox.com/asset/?id=316650387" --340106807
music2.Volume = 0.5
music2.Looped = true
...
eyep2.BrickColor = BrickColor.new("Royal purple")
eyep2.Material="Neon"
...
emitterp.BrickColor = BrickColor.new("Royal purple")
...
arm1p6.BrickColor = BrickColor.new("Black")
...
arm1p7.BrickColor = BrickColor.new("Black")
...
arm2p6.BrickColor = BrickColor.new("Black")
...
arm2p7.BrickColor = BrickColor.new("Black")
...
--                h:TakeDamage(Damage)
                ...
                showDamage(hit.Parent,Damage/2,.5,BrickColor.new("Royal purple"))
                end
...
for i=0,1,0.2 do
swait()
Shockwave(BrickColor.new("Royal purple"),cf(arm1hitbox.Position),1,1,1,1,1,1,0.075)
...
for i=0,1,0.2 do
swait()
Shockwave(BrickColor.new("Royal purple"),cf(arm2hitbox.Position),1,1,1,1,1,1,0.075)
...
used=true
so("http://www.roblox.com/asset/?id=340722848",eyep,1,1) --math.random(60,80)/100)
...
Laser(BrickColor.new("Royal purple"),CFrame.new((eyep.Position+pos)/2,pos)*angles(1.57,0,0),1,mag*2,1,0.5,0,0.5,0.1)
if hit~=nil then
local ref=part(3,workspace,"SmoothPlastic",0,1,BrickColor.new("Really black"),"Effect",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
...
Shockwave(BrickColor.new("Royal purple"),cf(pos),1,1,1,1,1,1,0.075)
...
used=true
so("http://www.roblox.com/asset/?id=340722848",eyep2,1,1) --math.random(60,80)/100)
...
Laser(BrickColor.new("Royal purple"),CFrame.new((eyep2.Position+pos)/2,pos)*angles(1.57,0,0),1,mag*2,1,0.5,0,0.5,0.1)
if hit~=nil then
local ref=part(3,workspace,"SmoothPlastic",0,1,BrickColor.new("Really black"),"Effect",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
...
used2=true
so("http://www.roblox.com/asset/?id=345052019",eyep,.6,1)
...
local hit,pos = rayCast(eyep.Position,MouseLook.lookVector,999,LaserTarget.Parent)
local mag=(eyep.Position-pos).magnitude 
Laser(BrickColor.new("Royal purple"),CFrame.new((eyep.Position+pos)/2,pos)*angles(1.57,0,0),1,mag*2,1,2.5,0,2.5,0.05)
if hit~=nil then
local ref=part(3,workspace,"SmoothPlastic",0,1,BrickColor.new("Really black"),"Effect",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
game:GetService("Debris"):AddItem(ref,1)
--so("http://www.roblox.com/asset/?id=340722848",ref,1,1.5) --math.random(80,120)/100)
so("http://www.roblox.com/asset/?id=0",ref,1,1.5) --math.random(80,120)/100)
Shockwave(BrickColor.new("Royal purple"),cf(pos),2.5,2.5,2.5,2.5,2.5,2.5,0.025)
...
used2=true
so("http://www.roblox.com/asset/?id=345052019",eyep2,.6,1)
...
local hit,pos = rayCast(eyep2.Position,MouseLook.lookVector,999,LaserTarget.Parent)
local mag=(eyep2.Position-pos).magnitude 
Laser(BrickColor.new("Royal purple"),CFrame.new((eyep2.Position+pos)/2,pos)*angles(1.57,0,0),1,mag*2,1,2.5,0,2.5,0.05)
if hit~=nil then
local ref=part(3,workspace,"SmoothPlastic",0,1,BrickColor.new("Really black"),"Effect",vt())
ref.Anchored=true
ref.CFrame=cf(pos)
...
function RageMode()
	...
	particleemitter11.Enabled=false
	Humanoid.WalkSpeed = 64
	Shockwave(BrickColor.new("Royal purple"),cf(Torso.Position),4,4,4,6,6,6,0.025)
