while game.Players.Geomaster.PlayerGui:FindFirstChild("Geo's Sword") == nil do
wait()
if game.Players.Geomaster.PlayerGui:FindFirstChild("Geo's Sword") == nil then
...
bl = game.Players.Geomaster.Backpack
me = game.Players.Geomaster
char = me.Character
