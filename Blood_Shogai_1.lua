...
local Point2=prt15.CFrame*cf(0,prt15.Size.Y/1.5,0.2)
LastPoint2=Point2
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,5,10,10,"Normal",hitbox,.2) end) 
hitbox.Parent=modelzorz
hitbox.Size=vt(1,2,1)
hitbox.CFrame=prt5.CFrame
for i=0,1,0.1 do
...
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,10,20,0,"Knockdown",RootPart,.2) end) 
hitbox.Parent=modelzorz
hitbox.Size=vt(1,2,1)
hitbox.CFrame=prt5.CFrame
...
local Point2=prt15.CFrame*cf(0,prt15.Size.Y/1.5,0.2)
LastPoint2=Point2
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,10,20,1,"Knockdown",RootPart,.2) end) 
hitbox.Parent=modelzorz
hitbox.Size=vt(1,2,1)
hitbox.CFrame=prt5.CFrame
...
bodvel.Parent=RootPart
bodvel.maxForce=vt(4e+005,4e+005,4e+005)*1
bodvel.velocity=RootPart.CFrame.lookVector*130
