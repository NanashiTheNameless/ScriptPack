--[[
	...
	1.) Should be local.
	2.) Should be Split.
	3.) Any stealing will result in a permadent ban
	4.) So yeah, here.
--]]
...
function Output(Text,Color,OnClicked)
	...
	Mesh.Scale=Vector3.new(2,2.5,0.12)
	local PointLight = Instance.new("PointLight", Part)
	...
	TextLabel.FontSize = "Size24"
	TextLabel.TextStrokeTransparency = 0
	local Edge = Instance.new("SelectionBox", Part)
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new(1)
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function DiamondCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("Toothpaste")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function OCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("Deep orange")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function BlCrystal(Text,Color,OnClicked)
	...
	Edge.Transparency=0.5
	Edge.Adornee = Edge.Parent
	Edge.Color = BrickColor.new(1003)
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function BCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("Deep blue")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function PCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("Bright violet")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function GCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("Lime green")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function YCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new("New Yeller")
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
function RCrystal(Text,Color,OnClicked)
	...
	Edge.Adornee = Edge.Parent
	Edge.Transparency=0.5
	Edge.Color = BrickColor.new(1004)
	local ClickDetector = Instance.new("ClickDetector", Part)
	Tabs[#Tabs+1] = Part
	ClickDetector.MaxActivationDistance = math.huge
	ClickDetector.MouseHoverEnter:connect(function(Player)
...
BCrystal("UnMute", "Deep blue", function()
...
AddCmd("Remove the admin","remv","g'day m8",
	function()
		for i = 0,50,1 do
			pcall(function()
...
AddCmd("Nuke","nuke","Brings out da big bang.",
    function(plrs)
        for _, plr in pairs(plrs) do
            if plr then
