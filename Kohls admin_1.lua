...
-----------------------------------
local owners = {"Megavip1337"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"MrSevenGuy"} -- Sets admins who can use ban/kick/admin or shutdown
