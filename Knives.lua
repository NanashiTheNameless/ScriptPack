...
part5.BrickColor = BrickColor.new("Really blue") 
...
HitSound.SoundId = "http://roblox.com/asset/?id=10209590" 
...
function attackone() 
attack = true 
con1=part5.Touched:connect(function(hit) Damagefunc1(hit,5,1) end)
con2=part6.Touched:connect(function(hit) Damagefunc1(hit,5,1) end)
con3=part9.Touched:connect(function(hit) Damagefunc2(hit,5,1) end)
con4=part10.Touched:connect(function(hit) Damagefunc2(hit,5,1) end)
for i = 0 , 1 , 0.2 do 
wait(0) 
...
function attacktwo() 
attack = true 
con1=part5.Touched:connect(function(hit) Damagefunc1(hit,1,1) end)
con2=part6.Touched:connect(function(hit) Damagefunc1(hit,1,1) end)
con3=part9.Touched:connect(function(hit) Damagefunc2(hit,1,1) end)
con4=part10.Touched:connect(function(hit) Damagefunc2(hit,1,1) end)
for i = 0,1,0.1 do 
wait(0) 
...
con1=part5.Touched:connect(function(hit) Damagefunc1(hit,30,1) end)
con2=part6.Touched:connect(function(hit) Damagefunc1(hit,30,1) end)
ss(part5,1.3) 
coroutine.resume(coroutine.create(function() 
wait(0)
...
con3=part9.Touched:connect(function(hit) Damagefunc2(hit,30,1) end)
con4=part10.Touched:connect(function(hit) Damagefunc2(hit,30,1) end)
ss(part9,1.3) 
coroutine.resume(coroutine.create(function() 
wait(0)
...
con1=part5.Touched:connect(function(hit) Damagefunc1(hit,1,20) end)
con2=part6.Touched:connect(function(hit) Damagefunc1(hit,1,20) end)
con3=part9.Touched:connect(function(hit) Damagefunc2(hit,1,20) end)
con4=part10.Touched:connect(function(hit) Damagefunc2(hit,1,20) end) 
ss(part5,1.3) 
ss(part9,1.3) 
...
con1=part5.Touched:connect(function(hit) Damagefunc1(hit,10,1) end)
con2=part6.Touched:connect(function(hit) Damagefunc1(hit,10,1) end)
con3=part9.Touched:connect(function(hit) Damagefunc2(hit,10,1) end)
con4=part10.Touched:connect(function(hit) Damagefunc2(hit,10,1) end)
...
Damagefunc1=function(hit,Damage,Knockback)
	...
	if h~=nil and hit.Parent.Name~="yfc" and hit.Name~="SlashEffect" and hit.Parent:FindFirstChild("Torso")~=nil then
		Damage=Damage
