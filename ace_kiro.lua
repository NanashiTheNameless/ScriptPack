...
function attackone()
	...
	local Con1 = HitboxL.Touched:connect(function(hit)
		Damage(hit.Parent, math.random(10, 45), .1, BrickColor.new("Really black"), BrickColor.new("Mid gray"), "rbxassetid://199149186" ,1)
	end)
	for i = 0, 1, 0.13 do
		swait()
...
function attackfour()
	...
	MagnitudeDamage(RootPart, 30, 20, 35, BrickColor.new("Really black"), BrickColor.new("Mid gray"), "rbxassetid://199149186" ,1)
	...
	coroutine.resume(coroutine.create(function() 
		repeat
			...
			if hit ~= nil then
                ...
                MagnitudeDamage(ref, 30, 25, 50, BrickColor.new("Really black"), BrickColor.new("Mid gray"), "rbxassetid://199149186" ,1)
