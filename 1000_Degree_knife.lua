...
blade.Material = "Neon"
prop(blade, bricks, false, 0, 0, 0.1, 2.5, 0.25, "Really red", false, "Custom")
...
prop(blade2, bricks, false, 0, 0, 0.1, 0.4, 0.25, "Really red", false, "Custom")
...
inform("1000 Degree knife aquired",2)