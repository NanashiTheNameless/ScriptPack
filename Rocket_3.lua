...
ha=pa(Weapon,"","Block",0.25,0.9,0.4,false,false,0,0,"Gold") weld(ha,hp,ha,0,0,0,0,rd(90),0)
 
p=pa(Weapon,"","Block",0.35,0.5,0.45,false,false,0,0,"Really black") weld(p,ha,p,0,0.45+0.25,0,0,0,0) qi{'BlockMesh',p}
 
p=pa(Weapon,"","Block",0.35,0.4,0.8,false,false,0,0,"Really black") weld(p,ha,p,0,0.9+0.25,-0.175,0,0,0) qi{'BlockMesh',p}
 
p=pa(Weapon,"","Block",0.35,0.2,0.2,false,false,0,0,"Really black") weld(p,ha,p,0,1.05,0.325,rd(180),0,0) qi{'SpecialMesh',p,MeshType="Wedge"}
 
p=pa(Weapon,"","Block",0.35,0.2,0.2,false,false,0,0,"Really black") weld(p,ha,p,0,1.25,0.325,0,0,0) qi{'BlockMesh',p}
 
tr=pa(Weapon,"","Block",0.2,0.2,0.2,false,false,0,0,"Really black") weld(tr,ha,tr,0,0.8,-0.35,0,rd(90),0) qi{'SpecialMesh',tr,MeshId=ids.Ring,Scale=v3(0.4,0.4,1)}
 
p=pa(Weapon,"","Block",0.2,0.25,0.2,false,false,0,0,"Really black") weld(p,tr,p,-0.15,0,0,0,0,rd(10)) qi{'BlockMesh',p,Scale=v3(1,1,0.5)}
 
bp=pa(Weapon,"","Block",0.7,2.5,0.7,false,false,0,0,"Really black") weld(bp,ha,bp,0,1.6,-0.5-0.125,rd(90),0,0) qi{'CylinderMesh',bp}
 
p=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Gold") weld(p,bp,p,0,1.25,0,rd(180),0,0) qi{'SpecialMesh',p,Scale=v3(0.4,4,0.4),MeshId=ids.Spike}
 
p=pa(Weapon,"","Block",0.9,0.2,0.9,false,false,0,0,"Really black") weld(p,bp,p,0,2.7,0,0,0,0) qi{'CylinderMesh',p}
 
p=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Gold") weld(p,bp,p,0,3.1,0,0,0,0) qi{'SpecialMesh',p,Scale=v3(0.4,1,0.4),MeshId=ids.Spike}
 
p=pa(Weapon,"","Block",0.6,0.5,0.6,false,false,0,0,"Really black") weld(p,bp,p,0,3.35,0,0,0,0) qi{'CylinderMesh',p}
 
p=pa(Weapon,"","Block",0.7,0.2,0.7,false,false,0,0,"Really black") weld(p,bp,p,0,3.25,0,0,0,0) qi{'CylinderMesh',p,Scale=v3(1,0.5,1)}
 
p=pa(Weapon,"","Block",0.7,0.2,0.7,false,false,0,0,"Really black") weld(p,bp,p,0,3.45,0,0,0,0) qi{'CylinderMesh',p,Scale=v3(1,0.5,1)}
 
for i=0,360,360/10 do
 
local p=pa(Weapon,"","Block",0.2,1,0.5,false,false,0,0,"Really black") local pw=weld(p,bp,p,0,0,0,0,0,0) qi{'BlockMesh',p,Scale=v3(0.5,1,1)}pw.C0=cn(0,3.9,0)*ca(0,rd(i),0)*cn(0.5,0,0)*ca(0,0,rd(-35))
 
local p=pa(Weapon,"","Block",0.3,0.2,0.7,false,false,0,0,"Really black") local pw=weld(p,bp,p,0,0,0,0,0,0) qi{'BlockMesh',p,Scale=v3(1,0.5,1)}pw.C0=cn(0,4.3,0)*ca(0,rd(i),0)*cn(0.9,0,0)
 
end
 
bar=pa(Weapon,"","Block",0.65,1.2,0.65,false,false,0,0,"Really black") weld(bar,bp,bar,0,-1.5,0,0,0,0) qi{'CylinderMesh',bar}
...
p=pa(Weapon,"","Block",0.25,1.5,0.4,false,false,0,0,"Gold") weld(p,ha,p,0,0.3,-1.8,0,0,0) qi{'BlockMesh',p}
 
p=pa(Weapon,"","Block",0.35,0.5,0.9,false,false,0,0,"Really black") weld(p,ha,p,0,1.1,-1.8,0,0,0) qi{'BlockMesh',p}
 
p=pa(Weapon,"","Block",0.2,0.3,0.4,false,false,0,0,"Really black") weld(p,bar,p,-0.1,0,-0.3,rd(90),0,0) qi{'BlockMesh',p}
 
pb=pa(Weapon,"","Block",0.3,0.2,0.5,false,false,0,0,"Really black") weld(pb,bar,pb,-0.1,0,-0.5,rd(-90),0,0) qi{'BlockMesh',pb,Scale=v3(1,0.5,1)}
 
p=pa(Weapon,"","Block",0.2,0.3,0.5,false,false,0,0,"Really black") weld(p,pb,p,-0.125,0.2,0,0,0,0) qi{'SpecialMesh',p,MeshType="Wedge",Scale=v3(0.25,1,1)}
 
p=pa(Weapon,"","Block",0.2,0.3,0.5,false,false,0,0,"Really black") weld(p,pb,p,0.125,0.2,0,0,0,0) qi{'SpecialMesh',p,MeshType="Wedge",Scale=v3(0.25,1,1)}
 
p=pa(Weapon,"","Block",0.25,0.6,0.2,false,false,0,0,"Really black") weld(p,pb,p,0,0.2,0,rd(-15),0,0) qi{'BlockMesh',p,Scale=v3(1,1,0.25)}
 
p=pa(Weapon,"","Block",0.25,0.3,0.2,false,false,0,0,"Really black") weld(p,pb,p,0,0.6,0,rd(25),0,0) qi{'BlockMesh',p,Scale=v3(1,1,0.25)}
 
p=pa(Weapon,"","Block",0.3,0.2,0.2,false,false,0,0,"Really black") weld(p,bp,p,0.4,-0.75,0,0,0,0) qi{'BlockMesh',p,Scale=v3(1,0.5,0.5)}
 
p=pa(Weapon,"","Block",0.3,0.2,0.2,false,false,0,0,"Really black") weld(p,bp,p,0.4,0.75,0,0,0,0) qi{'BlockMesh',p,Scale=v3(1,0.5,0.5)}
 
pl=pa(Weapon,"","Block",0.2,2,0.7,false,false,0,0,"Really black") weld(pl,bp,pl,0.6,0,0,0,0,0) qi{'BlockMesh',pl,Scale=v3(0.5,1,1)}
 
p=pa(Weapon,"","Block",0.2,2,0.6,false,false,0,0,"Really black") weld(p,pl,p,-0.275,0,-0.5,0,rd(60),0) qi{'BlockMesh',p,Scale=v3(0.5,1,1)}
...
bb = pa(workspace,"bullet","Block",0.5*sc,2.8*sc,0.5*sc,false,true,0,0,"Gold") qi{"SpecialMesh",bb,MeshId=ids.Rocket} bb.CanCollide=false
...
GlowMesh(false,"block",Weapon,v3(1,1,1),"Gold",bb.CFrame*cn(rn(-5,5),rn(-5,5),rn(1,3))*ca(rn(-5,5),rn(-5,5),rn(-5,5)),0.1,1,0.07)
