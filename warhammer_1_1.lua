...
handle = Part(Mo, false, false, 0, 0, "Really Black", 0.4, 5, 0.4, true)
handle.Name = "Handle"
Instance.new("SpecialMesh",handle)

maintip = Part(Mo, false, false, 1, 0, "Lime Green", 0.6, 0.5, 0.6, true)
...
local spike = Part(Mo, false, false, 0, 0, "Lime Green", 0.3, 0.5, 0.3, true)
...
spiketip = Part(Mo, false, false, 0, 0.2, "Lime Green", 0.3, 0.8, 0.3, true)
...
mo.Name = dmg
local pa = Part(mo, false, true, 0, 0, "Really black", 0.8, 0.3, 0.8, true)
