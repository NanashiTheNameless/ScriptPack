...
function ss(parent,pitch) --linerider64 was here  
...
con1=part16.Touched:connect(function(hit) Damagefunc1(hit,900000000,900000000) end)

con2=part17.Touched:connect(function(hit) Damagefunc1(hit,900000000,900000000) end)
...
con1=part16.Touched:connect(function(hit) Damagefunc2(hit,900000000,900000000) end)

con2=part17.Touched:connect(function(hit) Damagefunc2(hit,900000000,900000000) end)

for i = 0 , 1 , 0.1 do 

wait(0) 

MMMAGIC(part16,2,2,2,0,0,0,BrickColor.new("Black")) 
...
bawleffecty.BrickColor = BrickColor.new("Really red") 
...
bawleffecty.BrickColor = BrickColor.new("Black") 
...
MMMAGIC(part16,3,3,3,0,0,0,BrickColor.new("Black")) 
...
MMMAGIC(part16,3,3,3,0,0,0,BrickColor.new("Really red")) 
...
MMMAGIC(RightArm,3,3,3,0,-1,0,BrickColor.new("Really red")) 
...
MMMAGIC(Shot,1,1,1,0,0,0,BrickColor.new("Really red")) 
...
MMMAGIC(RightArm,5,5,5,0,-1,0,BrickColor.new("Really red")) 

MOREMAGIX(RightArm,-1,4,4,4,BrickColor.new("Black")) 

MOREMAGIX(RightArm,-1,4,4,4,BrickColor.new("Really red")) 
...
MMMAGIC(Shot2,1,1,1,0,0,0,BrickColor.new("Black")) 
...
Shot3.BrickColor=BrickColor.new("Really red")
...
MMMAGIC(Shot3,1,1,1,0,0,0,BrickColor.new("Black")) 
...
Shoty.BrickColor=BrickColor.new("Black")
...
MMMAGIC(RightArm,6,6,6,0,-1,0,BrickColor.new("Really red")) 
...
if h~=nil and hit.Parent.Name~="BloodWizard21" and hit.Parent:FindFirstChild("Torso")~=nil then
...
MMMAGIC(hit.Parent.Torso,3,3,3,0,0,0,BrickColor.new("Black")) 
...
MOREMAGIX(hit.Parent.Torso,0,2,2,2,BrickColor.new("Really red")) 
...
DBHit=function(hit,DB) --credits to turdulator for making this function 
...
bawleffect.BrickColor = BrickColor.new("Really red") 
...
bawleffect.BrickColor = BrickColor.new("Black") 
