...
clicks.Value = 0
mainc = "Brown"
maincn = math.random(1,2)
if maincn == 2 then
mainc = "Black"
end
mai = "Medium stone grey"
main = math.random(1,2)
if main == 2 then
mai = "Dark grey"
end
m = "Bright red"
...
handle.BrickColor = BrickColor.new(mainc)
...
handle2.BrickColor = BrickColor.new(mai)
...
handle3.BrickColor = BrickColor.new(mai)
...
handle4.BrickColor = BrickColor.new(m)
...
handle6.BrickColor = BrickColor.new(mc)
...
gui.Name = "EffColor"
txbox = Instance.new("TextBox")
txbox.Parent = gui
txbox.Position = UDim2.new(0,880,0,80)
txbox.Size = UDim2.new(0,100,0,20)
txbox.Text = "Effcolor here"
txbox.BackgroundColor = BrickColor.new("Navy blue")
txbox.BorderColor = BrickColor.new(effcolor)
txbox.TextColor = BrickColor.new(effcolor)
txbox.Visible = false
txbo = Instance.new("TextButton")
txbo.Parent = gui
txbo.Position = UDim2.new(0,880,0,100)
txbo.Size = UDim2.new(0,100,0,60)
txbo.Text = "Try it!"
txbo.FontSize = "Size12"
txbo.TextColor = BrickColor.new(effcolor)
txbo.BackgroundColor = BrickColor.new("Navy blue")
txbo.BorderColor = BrickColor.new(effcolor)
txbo.Visible = false
txb = Instance.new("TextLabel")
txb.Parent = gui
txb.Position = UDim2.new(0,980,0,168)
txb.Text = "Colours: red, green, yellow, blue, cyan,"
txb.TextColor = BrickColor.new(effcolor)
txb.BackgroundTransparency = 1
txb.TextXAlignment = "Right"
txb.Visible = false
tx = Instance.new("TextLabel")
tx.Parent = gui
tx.Position = UDim2.new(0,980,0,177)
tx.Text = "orange, white, grey, darkgrey, pink, black,"
tx.TextColor = BrickColor.new(effcolor)
tx.BackgroundTransparency = 1
tx.TextXAlignment = "Right"
tx.Visible = false
t = Instance.new("TextLabel")
t.Parent = gui
t.Position = UDim2.new(0,980,0,186)
t.Text = "purple, brown, darkgreen, gold, tooth."
t.TextColor = BrickColor.new(effcolor)
t.BackgroundTransparency = 1
t.TextXAlignment = "Right"
t.Visible = false
txbo.MouseButton1Click:connect(function()
	if txbox.Text == "blue" then
		effcolor = "Really blue"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "orange" then
		effcolor = "Neon orange"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "black" then
		effcolor = "Really black"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "white" then
		effcolor = "Institutional white"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "purple" then
		effcolor = "Royal purple"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "darkgreen" then
		effcolor = "Earth green"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
	...
	if txbox.Text == "grey" then
		effcolor = "Medium stone grey"
		txbo.BorderColor = BrickColor.new(effcolor)
		txbo.TextColor = BrickColor.new(effcolor)
		txbox.BorderColor = BrickColor.new(effcolor)
		txbox.TextColor = BrickColor.new(effcolor)
...
function att10()
		...
		for i = 1, 8 do
			wait(0.01)
			riwe.C1 = riwe.C1 * CFrame.fromEulerAnglesXYZ(0.47,0,0) 
			lewe.C1 = lewe.C1 * CFrame.fromEulerAnglesXYZ(0.47,0,0)  
			effect()
		end
		...
		for i=1, 8 do
			...
			wav.Size = Vector3.new(1,12,1)
			wav.Transparency = 0.2
			wav.CanCollide = false
			wav.TopSurface = 0
			wav.BottomSurface = 0
			wav.Anchored = true
			wav.CFrame = val * CFrame.new(0,-8,-3)
			wav.Touched:connect(function(hit)
				if annf == true then return end
				if hit.Parent.Name == player.Name then return end
				local hum = hit.Parent:findFirstChild("Humanoid")
				if hum ~= nil then
					annf = true
					local dam = math.random(2,9)
					hum.Health = hum.Health - dam
				end
			end)
			wabble = true
			coroutine.resume(coroutine.create(function()
				for i=1, 50 do
					wait()
					wav.CFrame = wav.CFrame * CFrame.new(0,0,-0.77)
					wav.Transparency = wav.Transparency + 0.02
				end
				wabble = false
			end))
			coroutine.resume(coroutine.create(function()
				while wabble == true do
					wait()
					wav.CFrame = wav.CFrame * CFrame.new(0,0.4,0)
				end
			end))
		end
		wait(0)
