...
Arm={Character["Right Leg"],Character["Left Leg"]}
C=function(f)
...
BlockMesh=function(Parent,x,y,z)
BM=Instance.new("BlockMesh",Parent)
BM.Scale=Vector3.new(x,y,z)
return BM
end
...
Mesh=BallMesh(Ball,i*10,i*10,i*10)
end
