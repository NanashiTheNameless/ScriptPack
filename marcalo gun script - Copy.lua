lp=game.Players.luxulux
pl=lp.Character
tol=Instance.new("HopperBin",lp.Backpack)
tol.Name="Marcalo"--jarredbcv
...
Gpa= Part(.25,3,.25,'Really black',0,false,false,mo)
m=Mesh(Gpa,'http://www.roblox.com/asset/?id=22963494',1,1,1)m.TextureId="http://www.roblox.com/asset/?id=23326832"
Gwl= Weld(Gpa,pl.Torso,1.1,-1.3,-0.1,math.pi/1.5,0,0,mo)
-- arm
...
function flame()
s2:Play()
local fpa= Part(.25,3,.25,'Bright red',0.5,false,false,mo)
m=Mesh(fpa,'http://www.roblox.com/asset/?id=22963494',1.1,1.1,1.1)
wl= Weld(fpa,Gpa,0,0,-.05,0,0,0,mo)
LerpTo = CFrame.new(-1.5,0,0) * CFrame.Angles(math.rad(-90),0,0) * CFrame.new(0,-.5,0.5)
for i=1,10 do wait(.05)
fxpa= Part(.3,.3,.3,'Bright red',0.5,false,true,mo)
fxpa.CFrame= fpa.CFrame*CFrame.new(math.random(-100/math.random(100,150),100/math.random(100,150)),math.random(-100/math.random(100,150),100/math.random(100,150)),1)*CFrame.Angles(math.random(),math.random(),math.random())
game.Debris:AddItem(fxpa,.5) end
game.Debris:AddItem(fpa,.1)
LerpTo = CFrame.new(-1.5,0,0) * CFrame.Angles(math.rad(-110),0,0) * CFrame.new(0,-.5,0.5)
local firept= Part(.25,3,.25,'Bright red',0.5,false,false,mo)
m=Mesh(firept,'http://www.roblox.com/asset/?id=1323306',.2,2,.2)
wl= Weld(firept,Gpa,0,2,.4,0,0,0,mo)
local bm= Part(.25,3,.25,'Bright red',0.5,false,false,mo)
bmm=Mesh(bm,'http://www.roblox.com/asset/?id=3270017',0,0,0)
wl= Weld(bm,Gpa,0,1,.4,math.pi/2,0,0,mo)
s3:play()
...
bm.CFrame= Gpa.CFrame*CFrame.new(0,i*8,0)*CFrame.Angles(math.random(),math.random(),math.random())
...
function pos()
s10:play()
local fpa= Part(.25,3,.25,'Bright green',0.5,false,false,mo)
m=Mesh(fpa,'http://www.roblox.com/asset/?id=22963494',1.1,1.1,1.1)
wl= Weld(fpa,Gpa,0,0,-.05,0,0,0,mo)
LerpTo = CFrame.new(-1.5,0,0) * CFrame.Angles(math.rad(-90),0,0) * CFrame.new(0,-.5,0.5)
for i=1,10 do wait(.05)
...
wl= Weld(erpt,Gpa,0,2,.4,0,0,0,mo)
...
bom.CFrame=Gpa.CFrame
kaz.CFrame=Gpa.CFrame*CFrame.new(0,30,-4)
coroutine.wrap(function()
for i=1,15 do wait()
...
function ice()
s4:play()
local fpa= Part(.25,3,.25,'Bright blue',0.5,false,false,mo)
m=Mesh(fpa,'http://www.roblox.com/asset/?id=22963494',1.1,1.1,1.1)
wl= Weld(fpa,Gpa,0,0,-.05,0,0,0,mo)
LerpTo = CFrame.new(-1.5,0,0) * CFrame.Angles(math.rad(-90),0,0) * CFrame.new(0,-.5,0.5)
for i=1,10 do wait(.05)
...
wl= Weld(icept,Gpa,0,2,.4,0,0,0,mo)
...
game.Debris:AddItem(sfx,.1) 
bm.CFrame= Gpa.CFrame*CFrame.new(0,i*8,-5)*CFrame.Angles(math.pi/2,0,0)*CFrame.Angles(math.random(-50,50)/100,0,math.random(-50,50)/100)
for i,v in pairs(workspace:children()) do
if v:IsA("Model") and v:findFirstChild("Humanoid") then
if v:findFirstChild("Head") and v:findFirstChild("Torso") then
if (v:findFirstChild("Torso").Position - bm.Position).magnitude < 10 and v.Name ~= pl.Name then
...
function light()
s7:play()
local fpa= Part(.25,3,.25,'Bright yellow',0.5,false,false,mo)
m=Mesh(fpa,'http://www.roblox.com/asset/?id=22963494',1.1,1.1,1.1)
wl= Weld(fpa,Gpa,0,0,-.05,0,0,0,mo)
LerpTo = CFrame.new(-1.5,0,0) * CFrame.Angles(math.rad(-90),0,0) * CFrame.new(0,-.5,0.5)
for i=1,10 do wait(.05)
...
wl= Weld(lightpt,Gpa,0,2,.4,0,0,0,mo)
...
angl.CFrame=Gpa.CFrame*CFrame.new(0,25,0)
for i=1,10 do wait()Lightning(Gpa.Position,angl.Position,math.random(5,10),math.random(-2.5,2.5),"Bright yellow",0.05,0.35)end 
...
Gwl.Part1 = pl['Right Arm']
Gwl.C1 = CFrame.new(0,-1.8,-.5)*CFrame.Angles(math.pi/1,0,0)
cfoff=false
end)
