...
--col = {"Hot pink,"Black"}
--col = {"pink","Hot pink","Black"}
col = {"Hot pink","Hot pink","pink"}
Anims = {}
act = {key = {}}
...
prt2.BrickColor = BrickColor.new("pink") 
prt2.Name = "Part2" 
...
prt3.BrickColor = BrickColor.new("Hot pink") 
prt3.Name = "Part3" 
...
prt4.BrickColor = BrickColor.new("pink") 
prt4.Name = "Part4" 
...
prt7.BrickColor = BrickColor.new("Hot pink") 
prt7.Name = "Part7" 
...
for i=0,1,0.02 do
wait()
MMMAGIC(prt4,Prop.BallSize*2,Prop.BallSize*2,Prop.BallSize*2,0,Prop.LegLength/2,0,BrickColor.new("Hot pink")) 
...
MMMAGIC(prt4,Prop.BallSize*4,Prop.BallSize*4,Prop.BallSize*4,0,Prop.LegLength/2,0,BrickColor.new("Hot pink")) 
wait(0.5) 
con1:disconnect()
con2:disconnect()
for i=0,1,0.1 do
...
effectsg.BrickColor = BrickColor.new("Hot pink") 
