...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=9368495"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=9368495"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
----------------------------------------------------
game:service'InsertService':LoadAsset(100932574):children()[1].Parent=char
char.ReptiliaSpeciesAnalyst.Handle.Mesh.Scale = char.ReptiliaSpeciesAnalyst.Handle.Mesh.Scale * 1.8
char.ReptiliaSpeciesAnalyst.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
game:service'InsertService':LoadAsset(120507280):children()[1].Parent=char
char.WebbedWings.Handle.Mesh.Scale = char.WebbedWings.Handle.Mesh.Scale * 1.8
char.WebbedWings.Handle.Mesh.VertexColor = Vector3.new(0.3,0.3,0.3)
...
z.SoundId = "rbxassetid://319430400"--319430400
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.01)
                    ...
                    if hit.Name ~= p.Name then
                        --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(10000000)
                                wait(1)
        ...
        elseif ht and hit:IsA("Hat") then
            if hit.Parent.Name ~= p.Name then
                if hit.Parent:FindFirstChild("Humanoid") then
                       --[[ if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                hit.Parent:FindFirstChild("Humanoid"):TakeDamage(10000000)
                                wait(1)
                    --Debounces.Slashed = false
                end
            end
        ...
        if ht and hit:IsA("Model") then
                if hit:FindFirstChild("Humanoid") then
                    if hit.Name ~= p.Name then
                        --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(40000000)
                                wait(1)
                                --Debounces.Slashed = false
                        --end
                    end
        ...
        Spawn(function()
            ...
            for Y = -5,5 do
                ...
                --[[P.Touched:connect(function(ht)
                    local hit = ht.Parent
                    if hit:FindFirstChild("Humanoid") then
                        hit.Humanoid:TakeDamage(math.random(100000,1000000))
                    end
                end)]]--
            ...
            if ht and hit:IsA("Model") then
                    if hit:FindFirstChild("Humanoid") then
                        if hit.Name ~= p.Name then
                            --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(100000)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
...
hit:FindFirstChild("Humanoid"):TakeDamage(math.random(100000,1000000))
end)()
            ...
            if ht and hit:IsA("Model") then
                    if hit:FindFirstChild("Humanoid") then
                        if hit.Name ~= p.Name then
                            --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit:FindFirstChild("Humanoid"):TakeDamage(50000)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
            ...
            elseif ht and hit:IsA("Hat") then
                if hit.Parent.Name ~= p.Name then
                    if hit.Parent:FindFirstChild("Humanoid") then
                           --[[ if Debounces.Slashing == true and Debounces.Slashed == false then
                                    Debounces.Slashed = true]]--
                                    hit.Parent:FindFirstChild("Humanoid"):TakeDamage(50000)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
                                    hit:FindFirstChild("Torso").Velocity = hit:FindFirstChild("Torso").CFrame.lookVector * -70
                        --Debounces.Slashed = false
                    end
                    ...
                    if hit:FindFirstChild("Humanoid") then
                        if hit.Name ~= p.Name then
                            --[[if Debounces.Slashing == true and Debounces.Slashed == false then
                                    ...
                                    hit:FindFirstChild("Humanoid"):TakeDamage(10000)
                                    hit:FindFirstChild("Humanoid").PlatformStand = true
                                    hit:FindFirstChild("Torso").Velocity = hit:FindFirstChild("Torso").CFrame.lookVector * -70
                            --Debounces.Slashed = false
                        --end
        ...
        if Debounces.CanAttack == true then
            ...
            PTZ = {0.7, 0.8, 0.9, 1}
                ...
                for i,v in pairs(FindNearestTorso(torso.CFrame.p,25))do
                    if v:FindFirstChild('Humanoid') then
                        v.Humanoid:TakeDamage(math.random(100000,500000))
                        v.Humanoid.PlatformStand = true
                        v:FindFirstChild("Torso").Velocity = hed.CFrame.lookVector * 100
                    end
                end
...
mouse.KeyDown:connect(function(key)
    if key == "b" then
        ...
        v.SoundId = "rbxassetid://131172215"
        v.Parent = char
        v.Looped = false
        v.Pitch = 1.04
        v.Volume = 3
...
z = Instance.new("Sound",char)
z.SoundId = "rbxassetid://260433346"
z.Volume = 1
wait(.1)
z:Play()
Landing()
