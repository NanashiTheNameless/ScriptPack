Game.Workspace.acbalt.Head.Transparency = 1
Game.Workspace.acbalt.Torso.Transparency = 1
Game.Workspace.acbalt["Right Leg"].Transparency = 1
Game.Workspace.acbalt["Right Arm"].Transparency = 1
Game.Workspace.acbalt["Left Arm"].Transparency = 1
Game.Workspace.acbalt["Left Leg"].Transparency = 1
Game.Workspace.acbalt.Head.face:Remove()
Game.Workspace.acbalt["Right Arm"].CanCollide = false
Game.Workspace.acbalt["Left Arm"].CanCollide = false
Game.Workspace.acbalt.Torso.CanCollide = false
--Game.Workspace.acb227.Fedora:Remove()
--Game.Workspace.acb227.Bandana:Remove()
script.Parent = workspace.acbalt

w1 = Instance.new("Weld") 
w1.Parent = Workspace.acbalt.Torso 
w1.Part0 = Workspace.acbalt.Head 
w1.Part1 = Workspace.acbalt.Torso 
w1.C0 = CFrame.fromEulerAnglesXYZ(0, 0, 0) + Vector3.new(0, 0.5, 0) 

--Torso-- 
local h = Instance.new("Part") 
h.Name = "Handle" 
h.Parent = Workspace.acbalt 
...
-----------------------------------------weldling 
w1 = Instance.new("Weld") 
w1.Parent = Workspace.acbalt["Right Leg"] 
w1.Part0 = h 
w1.Part1 = Workspace.acbalt["Right Leg"]
...
-----------------------------------------weldling 
w1 = Instance.new("Weld") 
w1.Parent = Workspace.acbalt["Left Leg"] 
w1.Part0 = h 
w1.Part1 = Workspace.acbalt["Left Leg"]
w1.C0 = CFrame.fromEulerAnglesXYZ(0, 0, 0) + Vector3.new(0, 0.3, 1) 
--Left Leg-- 
local h = Instance.new("Part") 
h.Name = "Handle" 
...
-----------------------------------------weldling 
w1 = Instance.new("Weld") 
w1.Parent = Workspace.acbalt.Head 
w1.Part0 = h 
w1.Part1 = Workspace.acbalt.Head 
...
tx.Name = "Text - Reset" 
tx.Parent = sc 
tx.Position = UDim2.new(0, 57, 0, 100) 
...
poop.Position = Game.Workspace.acbalt.Tail.Position
...
tx.Name = "Text - Reset" 
tx.Parent = sc 
tx.Position = UDim2.new(0, 75, 0, 50) 
tx.Size = UDim2.new(0, 99, 0, 20) 
tx.Text = "Pee" 
...
poop.Parent = Game.Workspace 
poop.Size = Vector3.new(1, 1, 1) 
poop.CFrame = Game.Workspace.acbalt.Tail.CFrame * CFrame.new(0, -1, 0)
poop.TopSurface = "Smooth" 
poop.BottomSurface = "Smooth" 
poop.formFactor = "Plate"
...
tx.Name = "Text - Reset" 
tx.Parent = sc 
tx.Position = UDim2.new(0, 50, 0, 75) 
tx.Size = UDim2.new(0, 99, 0, 20) 
tx.Text = "Lick" 
...
human = plyr.Character:findFirstChild("Humanoid") 
if human ~= nil then 
Game.Workspace.acbalt.Toung.Transparency = 0 
wait(3) 
Game.Workspace.acbalt.Toung.Transparency = 1 
end 
end) 
...
t = Instance.new("Tool") 
t.Parent = game.Players.acbalt.Backpack 
t.Name = "Bite" 
