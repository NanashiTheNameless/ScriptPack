...
--
--]]
local owners = {"Regium"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"LordMeowsers"} -- Sets admins who can use ban/kick/admin or shutdown
...
if msg:lower() == "xd" or msg:lower() == "cmdgui" then
coroutine.resume(coroutine.create(function()
