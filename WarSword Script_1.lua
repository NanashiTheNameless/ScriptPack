--MADE BY YOUR NAME HERE (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 3,4,7,8,21, and 22 and put your name where it says "YOUR NAME HERE"

while game.Players.YOUR NAME HERE.PlayerGui:FindFirstChild("YOUR NAME HERE's Sword") == nil do
wait()
if game.Players.YOUR NAME HERE.PlayerGui:FindFirstChild("YOUR NAME HERE's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.YOUR NAME HERE.PlayerGui
screengui.Name = "YOUR NAME HEREs's Sword"
...
bl = game.Players.YOUR NAME HERE.Backpack
