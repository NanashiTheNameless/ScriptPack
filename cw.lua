...
Energycover = makeframe(Energybar, 0, UDim2.new(0, 0, 0, 0), UDim2.new(1, 0, 1, 0), BrickColor.new("Lime green").Color)
...
Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Lime green", "Handle", Vector3.new(1.20000005, 0.200000003, 1.20000005))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Lime green", "Part", Vector3.new(0.480000019, 0.200000003, 0.720000625))
...
Layer3Handle = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 1, "Lime green", "Layer3Handle", Vector3.new(0.720000029, 0.720000029, 0.200000003))
...
mesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.600000024, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0.19999998807907, "Lime green", "Part", Vector3.new(0.480000019, 0.480000019, 0.200000003))
