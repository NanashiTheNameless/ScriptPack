--[[ Frostftw, Revys Dual Cutlass's <3 ]]-- --Epic.. Going to test them 
wait();
...
Reloading,FlashLight,LaserLight,Silenced,ToolName,LaserColor,plr,char = false,false,false,false,"Cutlass's","Bright blue",game.Players.LocalPlayer,plr.Character
...
PA16 = AddPart("Part",GunModelOne,.02,1,.3,"Cool yellow")
PA16.Mesh.Scale = V3(1.1,.9,1)
WPA16 = AddWeld("Weld",PA16,PA16,HandleOne,CF.new(0,0,0),CF.new(0,0,0))
PA17 = AddPart("Part",GunModelOne,.1,.3,.3,"Cool yellow")
PA17.Mesh:Remove()
...
PB16 = AddPart("Part",GunModelTwo,.02,1,.3,"Cool yellow")
PB16.Mesh.Scale = V3(1.1,.9,1)
WPB16 = AddWeld("Weld",PB16,PB16,HandleTwo,CF.new(0,0,0),CF.new(0,0,0))
PB17 = AddPart("Part",GunModelTwo,.1,.3,.3,"Cool yellow")
PB17.Mesh:Remove()
...
function AddShell(Part)
        ...
        Shell.BrickColor = BrickColor.new("Cool yellow")
                                ...
                                if v:IsA("BasePart") then
                                        ...
                                        if Hit and Hit.Parent then
                                                ...
                                                elseif Human and Head and Torso then
                                                        if Hit == Head then
                                                                Damage = math.random(999999999,999999999)
                                                        else
                                                                Damage = math.random(999999999,999999999)
                                                        end
                                                        Human:TakeDamage(Damage)
