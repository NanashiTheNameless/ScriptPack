...
HopperBinName = "the orange blade"
Activated = false
Equipped = false
Equipping = false
Unequipping = false
...
Bar2.BackgroundColor = BrickColor.new("Deep orange")
...
Grip1.Parent = Tool
Grip1.Locked = true
Grip1.BrickColor = BrickColor.new("Deep orange")
...
Grip2.Parent = Tool
Grip2.Locked = true
Grip2.BrickColor = BrickColor.new("Deep orange")
...
Grip3.Parent = Tool
Grip3.Locked = true
Grip3.BrickColor = BrickColor.new("Deep orange")
...
Grip4.Parent = Tool
Grip4.Locked = true
Grip4.BrickColor = BrickColor.new("Deep orange")
...
Grip5.Parent = Tool
Grip5.Locked = true
Grip5.BrickColor = BrickColor.new("Deep orange")
...
Grip6.Parent = Tool
Grip6.Locked = true
Grip6.BrickColor = BrickColor.new("Deep orange")
...
Grip7.Parent = Tool
Grip7.Locked = true
Grip7.BrickColor = BrickColor.new("Deep orange")
...
Grip8.Parent = Tool
Grip8.Locked = true
Grip8.BrickColor = BrickColor.new("Deep orange")
...
Grip9.Parent = Tool
Grip9.Locked = true
Grip9.BrickColor = BrickColor.new("Deep orange")
...
Grip10.BrickColor = BrickColor.new("Deep orange")
...
Grip11.Parent = Tool
Grip11.Locked = true
Grip11.BrickColor = BrickColor.new("Deep orange")
...
Grip12.BrickColor = BrickColor.new("Deep orange")
...
Grip13.BrickColor = BrickColor.new("Deep orange")
...
Grip14.BrickColor = BrickColor.new("Deep orange")
...
Grip15.BrickColor = BrickColor.new("Deep orange")
...
Grip16.Parent = Tool
Grip16.Locked = true
Grip16.BrickColor = BrickColor.new("Deep orange")
...
Grip17.Parent = Tool
Grip17.Locked = true
Grip17.BrickColor = BrickColor.new("Deep orange")
...
Grip18.Parent = Tool
Grip18.Locked = true
Grip18.BrickColor = BrickColor.new("Deep orange")
...
Grip19.Parent = Tool
Grip19.Locked = true
Grip19.BrickColor = BrickColor.new("Deep orange")
...
Grip20.Parent = Tool
Grip20.Locked = true
Grip20.BrickColor = BrickColor.new("Deep orange")
...
Grip21.Parent = Tool
Grip21.Locked = true
Grip21.BrickColor = BrickColor.new("Deep orange")
...
Grip22.Parent = Tool
Grip22.Locked = true
Grip22.BrickColor = BrickColor.new("Deep orange")
...
if Mode == "Swing" then
 ...
 if Me.Character.Humanoid.Jump == true then
  ...
  for i = 1 , 8 do
   ...
   Clone1.BrickColor = BrickColor.new("Deep orange")
   Clone2 = Grip18:clone()
   Clone2.Parent = Tool
   Clone2.Name = "Shadow"
   ...
   Clone2.BrickColor = BrickColor.new("Deep orange")
   Clone3 = Grip19:clone()
   Clone3.Parent = Tool
   Clone3.Name = "Shadow"
   ...
   Clone3.BrickColor = BrickColor.new("Deep orange")
...
if Mode == "Spin" then
 ...
 Wave.BrickColor = BrickColor.new("Deep orange")
...
if Mode == "Assassinate" then
 ...
 Blade1.Locked = true
 Blade1.BrickColor = BrickColor.new("Deep orange")
 Blade1.Name = "Blade1"
 ...
 Blade2.Locked = true
 Blade2.BrickColor = BrickColor.new("Deep orange")
 Blade2.Name = "Blade2"
...
if Mode == "Alchemy" then
 ...
 Line1.BrickColor = BrickColor.new("Deep orange")
 ...
 Line2.BrickColor = BrickColor.new("Deep orange")
 ...
 Line3.BrickColor = BrickColor.new("Deep orange")
 ...
 Line4.BrickColor = BrickColor.new("Deep orange")
  ...
  if Stuff[i].Name ~= "Base" and Stuff[i].Name ~= Me.Name then
   if Stuff[i].className == "Part" then
    if (Me.Character.Torso.Position-Stuff[i].Position).magnitude <= 100 then
     if Stuff[i].BrickColor ~= BrickColor.new("Deep orange") then
      Stuff[i]:Remove()
     end
    end
   end
...
if Mode == "Lightning" then
 ...
 for i = 1 , math.random(9, 13) do
  ...
  FakeBolt.BrickColor = BrickColor.new("Deep orange")
  ...
  Bolt.Size = Vector3.new(1, 1, math.random(5, 10))
  Bolt.TopSurface = "Smooth"
  Bolt.BrickColor = BrickColor.new("Deep orange")
  Bolt.BottomSurface = "Smooth"
  Value = (math.random(-5, 5)/100)
  Value2 = (math.random(-5, 5)/100)
  Value3 = (math.random(-5, 5)/100)
  ...
  Bolt2.BrickColor = BrickColor.new("Deep orange")
...
if Mode == "Slime" then
 ...
 Slime.BrickColor = BrickColor.new("Deep orange")
 Slime.Locked = true
 Slime.Shape = "Ball"
 Slime.Anchored = true
 ...
 Nucleus.BrickColor = BrickColor.new("Deep orange")
 Nucleus.Locked = true
...
if Mode == "DarkPulse" then
 ...
 Dark.BrickColor = BrickColor.new("Deep orange")
 Dark.Locked = true
 Dark.Anchored = true
...
if Mode == "Raise" then
 ...
 Rock.Name = "Rock"
 Rock.Anchored = true
 Rock.BrickColor = BrickColor.new("Deep orange")
...
Background.BackgroundTransparency = 0.7
Background.Position = UDim2.new(0.55, 0, 0, 0) 
Background.BackgroundColor = BrickColor.new("Deep orange")
     ...
     if Stuff2[ii].className == "Part" then
      if (Stuff[i].Position-Stuff2[ii].Position).magnitude <= Stuff[i].Mesh.Scale.X then
       if Stuff2[ii].Name ~= "Base" then
        ...
        Stuff2[ii].BrickColor = BrickColor.new("Deep orange")
       ...
       if (Stuff[i].Position-Torso.Position).magnitude <= Stuff[i].Mesh.Scale.X then
        ...
        for i = 1 , #Parts do
         if Parts[i].className == "Part" then
          Parts[i].BrickColor = BrickColor.new("Deep orange")
