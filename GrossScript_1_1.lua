--BY whatTHEhaxx REGULAR SCRIPT: 
--Go down to line 175 and put two names into "YOURNAME HERE", and "THE OTHER PERSONS HERE" (One of them doesn't have to be you)
--Please don't ban me this took time to peice up
--So, you can insert this into games, but, I think ROBLOX patched it
--Oh yeah, I exploit sword fighting tournament, sometimes you might see me there
--Please give me credit, therefore; if I get banned, don't edit this without giving me credit
--This works! However; it only works with the script insert!
--Have fun mating :D xD LOL
----------------------------------------------------------------------------------------
...
fun("SergeantSmokey","OTHER PERSONS HERE")
