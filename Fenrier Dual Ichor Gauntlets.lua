-- http://hastebin.com/raw/ocoziroziv
...
Transposition = function()
  ...
  hum = nil
  local gud2go = false
  if Player:FindFirstChild("Training") and Player.Training.Value and MMouse.Target and MMouse.Target.Parent:findFirstChild("Humanoid") ~= nil and MMouse.Target.Parent:findFirstChild("Torso") ~= nil then
    if MMouse.Target.Parent.Name == "Kactus Man" then
      gud2go = true
    else
      if game.Players:GetPlayerFromCharacter(MMouse.Target.Parent) and game.Players:GetPlayerFromCharacter(MMouse.Target.Parent):FindFirstChild("Training") and game.Players:GetPlayerFromCharacter(MMouse.Target.Parent).Training.Value then
        gud2go = true
      end
    end
  end
  gud2go = true
  gud2go = true
  if MMouse.Target ~= nil and gud2go and MMouse.Target.Parent:findFirstChild("Humanoid") ~= nil and MMouse.Target.Parent:findFirstChild("Torso") ~= nil then
        ...
        for i = 0, 50 do
          ...
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC628: LeaveBlock: unexpected jumping out IF_THEN_STMT

              -- DECOMPILER ERROR at PC628: LeaveBlock: unexpected jumping out IF_STMT
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 20 then
    ...
    for di = 1, 2 do
      ...
      for i = 0, 1, 0.15 do
        ...
        if di == 2 and Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            if StaggerHit.Value == true then
              break
            end
      ...
      if bloodtrue == true then
        ...
        MagniDamage(ref, 10, 6, 7, math.random(10, 15), "Knockdown2", ref, 0, 1, (math.random(10, 15)), nil, nil, true, "Defense", 0.05, 200)
      ...
      do
        ...
        for i = 0, 1, 0.15 do
          ...
          RH.C0 = clerp(RH.C0, cf(0.9, -1, 0.3) * euler(0, 1.57, 0) * euler(0, -1, -0.1), 0.4)
          LH.C0 = clerp(LH.C0, cf(-0.9, -1, -0.3) * euler(0, -1.57, 0) * euler(0, -1, 0.1), 0.4)
          -- DECOMPILER ERROR at PC1095: Unhandled construct in 'MakeBoolean' P1
          ...
          if di == 2 and Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC1096: LeaveBlock: unexpected jumping out IF_THEN_STMT

              -- DECOMPILER ERROR at PC1096: LeaveBlock: unexpected jumping out IF_STMT
        ...
        do
          do
            ...
            hitboxweld()
            hboxpos.Parent = nil
            -- DECOMPILER ERROR at PC1235: LeaveBlock: unexpected jumping out DO_STMT
      ...
      for i = 0, 1, 0.2 do
        ...
        if Stagger.Value ~= true and StunT.Value > Stun.Value then
          do
            ...
            -- DECOMPILER ERROR at PC471: LeaveBlock: unexpected jumping out IF_THEN_STMT

            -- DECOMPILER ERROR at PC471: LeaveBlock: unexpected jumping out IF_STMT
        ...
        for i = 0, 1, 0.2 do
          ...
          if Stagger.Value ~= true and StunT.Value > Stun.Value then
            do
              ...
              -- DECOMPILER ERROR at PC864: LeaveBlock: unexpected jumping out IF_THEN_STMT
              -- DECOMPILER ERROR at PC864: LeaveBlock: unexpected jumping out IF_STMT
    ...
    for i = 0, 40 do
      ...
      if i % 10 == 0 then
        ...
        if hitfloor2 ~= nil then
          ...
          MagniDamage(ref, 10, 6, 8, math.random(10, 20), "Knockdown2", ref, 0, 1, (math.random(10, 15)), nil, nil, true, "Damage", 0.1, 200)
        ...
        do
          ...
          hitboxCF = RightArm.CFrame
          hitbox.CFrame = hitboxCF
          MagniDamage(hitbox, 3, 10, 10, math.random(20, 40), "Knockdown2", RootPart, 0.5, 2, math.random(20, 20), true, true)
          if Rooted.Value == false then
...
while 1 do
  ...
  stunanim = false
        ...
        if 1 < RootPart.Velocity.y and hitfloor == nil then
          ...
          if RootPart.Velocity.y < -1 and hitfloor == nil then
            ...
            if torvel < 1 and hitfloor ~= nil then
              Anim = "Idle"
              if attack == false then
                Neck.C0 = clerp(Neck.C0, necko * euler(-0.1, 0, 0) * euler(0, 0, -0.2), 0.3)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.2) * euler(0.2, 0, 0) * euler(0, 0, 0.2), 0.3)
                RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(1.7 - (donum) / 5, 0, 0.2 + (donum) / 5) * euler(0, 1.57, 0), 0.3)
                RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
                LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(1.5 - (donum) / 5, 0, 0.1 - (donum) / 5) * euler(0, -1.57, 0), 0.3)
                LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
                RH.C0 = clerp(RH.C0, cf(1.1, -0.8, -0.2) * euler(0, 1.57, 0) * euler(-0.1, 0, 0.2) * euler(0, 0, 0), 0.2)
                LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * euler(0, -1.57, 0) * euler(0, 0, 0.1), 0.2)
              end
              ...
              if Thing[2] == "Transposition" then
                if 0 < Thing[3] or hitfloor == nil then
                  ...
                  do
                    ...
                    if (Thing[1]:findFirstChild("Stats")) ~= nil and (Thing[1].Stats:findFirstChild("Rooted")) ~= nil and Thing[1].Stats.Rooted.Value == true then
                      cantele = false
                    end
                        ...
                        if Thing[4].Parent == nil or Thing[4] == nil or Thing[4].Parent.Parent == nil then
                          ...
                          do
                            do
                              ...
                              -- DECOMPILER ERROR at PC4943: LeaveBlock: unexpected jumping out DO_STMT

                              -- DECOMPILER ERROR at PC4943: LeaveBlock: unexpected jumping out IF_ELSE_STMT

                              -- DECOMPILER ERROR at PC4943: LeaveBlock: unexpected jumping out IF_STMT

                              -- DECOMPILER ERROR at PC4943: LeaveBlock: unexpected jumping out IF_THEN_STMT
      ...
      -- DECOMPILER ERROR at PC5334: LeaveBlock: unexpected jumping out DO_STMT
