...
local fx=Hitbox.Touched:connect(function(part)
	...
	if human~=nil and bounce==false then
		...
		local r=rndm
		so("http://www.roblox.com/asset/?id="..hitsounds[r],Hitbox,1,.5)
		bounce=true
	end
end)
for i = 0,1,0.05 do
...
local fx=Hitbox.Touched:connect(function(part)
	...
	if human~=nil and bounce==false then
		local rndm=math.random(1,#hitsounds)
		local r=rndm
		so("http://www.roblox.com/asset/?id="..hitsounds[r],Hitbox,1,.6)
		bounce=true
	end
end)
for i = 0,1,0.05 do
...
local fx=Hitbox.Touched:connect(function(part)
	...
	if human~=nil and bounce==false then
		local rndm=math.random(1,#hitsounds)
		local r=rndm
		so("http://www.roblox.com/asset/?id="..hitsounds[r],Hitbox,1,.7)
		bounce=true
	end
end)
for i = 0,1,0.05 do
