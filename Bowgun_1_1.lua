Player = game:GetService("Players").FangxWulf
...
RH = Torso["Right Hip"] 
bladecolor = BrickColor.new("Really black") --Lolol I don't use this :P
part2color = BrickColor.new("Gold") --Neither do I-- oh wait, I think I use these ._.
attack = false 
attacktype = 1 
...
NormFrame.BackgroundColor = BrickColor.new("White") 
...
PoisFrame.BackgroundColor = BrickColor.new("Black") 
...
HealFrame.BackgroundColor = BrickColor.new("Dark red") 
...
BoomFrame.BackgroundColor = BrickColor.new("Deep blue") 
...
ElecFrame.BackgroundColor = BrickColor.new("Really black") 
...
RapidFrame.BackgroundColor = BrickColor.new("Navy blue") 
...
shell.BrickColor = BrickColor.new("Dark red") 
elseif shot == "Explosion" then 
shell.BrickColor = BrickColor.new("Deep blue") 
elseif shot == "Rapid" then 
shell.BrickColor = BrickColor.new("Navy Blue") 
...
freakingbullet.BrickColor = BrickColor.new("Navy blue") 
...
for i = 1, #decoyz do 
if decoyz[i].Name == "FighterXC1002" then 
...
Jarate2.BrickColor = BrickColor.new("black") 
...
piss.BrickColor = BrickColor.new("Bright red") 
...
end)) --[[Bowgun Script created by: 
linerider64:Bowgun model CFrame 
ace28545:Shooting st00f 
turdulator:damage shower, DBHit function 
Rhysmon: For his very epic and awesome cola xD
...
Percent done: uhh...% [Idk if this is finished or not. Might add more stuff, might not ._.] 
 ]] 
...
RS = Torso["Right Shoulder"] 
RH = Torso["Right Hip"] 
bladecolor = BrickColor.new("Black") --Lolol I don't use this :P
part2color = BrickColor.new("Black") --Neither do I-- oh wait, I think I use these ._.
attack = false 
attacktype = 1 
damage = 50 --I Don't use this..
oridamage = 50 --Or this...
