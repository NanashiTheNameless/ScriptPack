...
look[i].Character.Torso.CFrame = CFrame.new(0, 15, 0) 
end 
end 
end 
...
Model0.Name = "acbazor" 
Model0.Parent = game.Workspace.acb227 
...
Part7.Size = Vector3.new(84,20,60) 
Z = 30 
X = 0 
...
v.Character.Torso.CFrame = v.Character.Torso.CFrame + Vector3.new(0,50,0) 
end 
end 
end