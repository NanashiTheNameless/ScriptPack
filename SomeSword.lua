...
Me.Character.Humanoid.Health = math.huge
char = Me.Character
name = Me.Name 
Torso = char.Torso
Rarm = char["Right Arm"]
...
pcall(function() char["Prt2"]:remove() end)
pcall(function() char["Prt1"]:remove() end) 
...
local RABW = Instance.new("Weld",RAB) 
RABW.Part0 = Torso
RABW.Part1 = RAB
...
local LABW = Instance.new("Weld",LAB) 
LABW.Part0 = Torso
LABW.Part1 = LAB
LABW.C1 = CFrame.new(1.5, -0.5, 0)

local RAW = Instance.new("Weld",RAB) 
RAW.Part0 = RAB
RAW.Part1 = nil
RAW.C1 = CFrame.new(0, 0.5, 0)

local LAW = Instance.new("Weld",LAB) 
LAW.Part0 = LAB
LAW.Part1 = nil
...
prop(handle, Model2, false, 0, 0, 0.35, 0.2, 0.35, "Really red", false, "Custom") 
...
prop(handle2, Model2, false, 0, 0, 0.3, 1, 0.3, "Really red", false, "Custom") 
...
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(180-50*i), math.rad(-90+0*i), math.rad(0*i)) 
hurt(2, 7.5, shaft) 
wait() 
end 
for i = 0, 1, 0.1 do 
...
Atk = true 
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(200+45*i), math.rad(-90*i), math.rad(0*i)) 
wait() 
end 
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(200-140*i), math.rad(-90+0*i), math.rad(0*i)) 
hurt(2, 7.5, shaft) 
wait() 
end 
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(10+100*i), math.rad(-90+90*i), math.rad(0*i)) 
wait() 
end 
Atk = false 
end 
...
Atk = true 
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(70+0*i), math.rad(-10*i), math.rad(0*i)) 
wait() 
end 
for i = 0, 1, 0.15 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(50+0*i), math.rad(-90+420*i), math.rad(0*i)) 
hurt(2, 7.5, shaft) 
eft(shaft, 0.1) 
wait() 
end 
for i = 0, 1, 0.15 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(30+0*i), math.rad(360-400*i), math.rad(0*i)) 
hurt(2, 7.5, shaft) 
eft(shaft, 0.1) 
wait() 
end 
for i = 0, 1, 0.1 do 
RAW.C0 = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(10+0*i), math.rad(-60+30*i), math.rad(0*i)) 
wait() 
end 
Atk = false 
end 
