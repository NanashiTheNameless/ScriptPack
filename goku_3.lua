...
----------------------------------------------------
--[[local scr = Instance.new("ScreenGui", p.PlayerGui)
scr.Name="Ki"
scr.Archivable=true
local fr1=Instance.new("Frame", scr)
fr1.Active=false
fr1.BackgroundColor3=Color3.fromRGB(0,0,0)
fr1.BackgroundTransparency=0
fr1.BorderSizePixel=1
fr1.Name="fr1"
fr1.Position=UDim2.new(1,-100,0.1,0)
fr1.Selectable=false
fr1.Size=UDim2.new(0,60,0,500)
fr1.Style="Custom"
fr1.Visible=true
fr1.ZIndex=1
fr1.Draggable=false
...
fr2.Active=false
fr2.BackgroundColor3=Color3.fromRGB(170,0,255)
fr2.BackgroundTransparency=0
fr2.BorderSizePixel=1
fr2.Name="fr2"
fr2.Position=UDim2.new(1, -100,0.61, 0)
fr2.Selectable=false
fr2.Size=UDim2.new(0,60,0,-500)
fr2.Style="Custom"
fr2.Visible=true
fr2.ZIndex=2
fr2.Draggable=false
fr2.Archivable=true
local tl=Instance.new("TextLabel", fr1)
tl.BackgroundTransparency=1
tl.Name="tl"
tl.Position=UDim2.new(0,0,0,-40)
tl.Size=UDim2.new(0,60,0,30)
tl.Visible=true
tl.Draggable=false
tl.Archivable=true
...
tl.FontSize="Size28"
tl.Text="Ki"
tl.TextColor3=Color3.fromRGB(27,42,53)
tl.TextStrokeTransparency=1
tl.TextTransparency=0
t2=Instance.new("TextLabel", fr1)
t2.BackgroundTransparency=1
t2.Name="tl2"
t2.Position=UDim2.new(0,0,0,500)
t2.Size=UDim2.new(0,60,0,30)
t2.Visible=true
t2.Draggable=false
t2.Archivable=true
t2.Font="SourceSansBold"
t2.FontSize="Size28"
t2.Text="{0}"
t2.TextColor3=Color3.fromRGB(27,42,53)
t2.TextStrokeTransparency=1
t2.TextTransparency=0
local kiupdater = coroutine.wrap(function()
while wait() do
		fr2.Size=UDim2.new(0,60,0,ki-ki*2*3)
		t2.Text=("{" .. ki .."}")
		if ki > 100 then
			ki = 100
		end
...
z.SoundId = "rbxassetid://275282542"--303570180
z.Looped = true
z.Pitch = 1
z.Volume = 1
wait(.1)
...
GroundWave1 = function()
	...
	local Colors = {"Royal purple", "Really black"}
		...
		for i = 1, 30, 1 do
		wm.Scale = Vector3.new(1 + i*2, 1 + i*2, 1)
		wave.Size = wm.Scale
		wave.CFrame = HandCF
				...
				if v.Name~=char.Name then
					for j,k in pairs(v.Character:GetChildren()) do
						if k:IsA("BasePart") and k.Transparency >= 1 then
							...
							bawx.Color = BrickColor.new("Royal purple")
							bawx.Transparency = .5
							bawx.Adornee = k
						end
                    end
