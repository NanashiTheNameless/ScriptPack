...
Scripted by Fenrier.
"I always liked you..... But you, you never liked me"
"I never thought this day would come... goodbye old friend."
]]
...
local Color2=BrickColor.new("Institutional white")
local Colorr3=BrickColor.new("Really red")
local Color4=BrickColor.new("Institutional white")
...
prtd9=part(3,model2,0.5,0.2,BrickColor.new("Institutional white"),"DPart9",vt())
prtd10=part(3,model2,0.5,0.2,BrickColor.new("Institutional white"),"DPart10",vt())
...
MagicWave(BrickColor.new("Institutional white"),cf(Torso.Position)*cf(0,-1,0),1,1,1,1.5,1,1.5,0.05)
...
local blockprt=part(3,Character,0,1,BrickColor.new("Really red"),"Block",vt(8,.1,8))
