...
grabbed = nil
mode = "drop"
bloodcolors = {"Bright yellow", "Bright yellow"}
...
gi.BackgroundColor3 = Color3.new(0,0,1)
gi.Position = UDim2.new(0.04,0,0.042,0)
gi.TextColor3 = Color3.new(0,0,0)
gi.FontSize = "Size12"
gi.Text = text
...
prop(righthold, bricks, false, 1, 0, 1.1, 1.1, 0.1, "Really black", false, "Custom")
w11 = Instance.new("Weld")
weld(w11, rarm, righthold, 0, 0, 0, 0, 1, 0)

lefthold = Instance.new("Part")
prop(lefthold, bricks, false, 1, 0, 1.1, 1.1, 0.1, "Really black", false, "Custom")
w12 = Instance.new("Weld")
weld(w12, larm, lefthold, 0, 0, 0, 0, 1, 0)

hold = Instance.new("Part")
prop(hold, bricks, false, 0, 0, 0.6, 1.4, 0.7, "Really black", false, "Custom")
oh = Instance.new("Weld")
weld(oh, lleg, hold, -math.pi/1.4, 0, math.rad(35), 0.55, -0.9, 0.3)

knife = Instance.new("Part")
prop(knife, bricks, false, 0, 0, 0.35, 2.1, 0.5, "Bright red", false, "Custom")
...
prop(blade, bricks, false, 0, 0, 0.1, 4.5, 0.4, "Navy blue", false, "Custom")
Instance.new("BlockMesh",blade).Scale = Vector3.new(0.3,1,1)
w2 = Instance.new("Weld")
weld(w2, knife, blade, 0, 0, 0, 0, -3, 0)

blade2 = Instance.new("Part")
prop(blade2, bricks, false, 0, 0, 0.1, 3.5, 0.4, "Navy blue", false, "Custom")
local mew = Instance.new("SpecialMesh",blade2)
mew.MeshType = "Wedge"
mew.Scale = Vector3.new(0.3,1,1)
w3 = Instance.new("Weld")
weld(w3, blade, blade2, 0, 0, 0, 0, -4, 0)




rb = Instance.new("Part")
prop(rb, bricks, false, 1, 0, 0.1, 0.1, 0.1, "Bright green", false, "Custom")
w13 = Instance.new("Weld")
weld(w13, torso, rb, 0, 0, 0, -1.5, -0.5, 0)

lb = Instance.new("Part")
prop(lb, bricks, false, 1, 0, 0.1, 0.1, 0.1, "Bright green", false, "Custom")
