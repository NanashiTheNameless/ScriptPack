--MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 5,316, and 320 and put your name where it says "BRICKER24alt"



jun = game.Players.BRICKER24alt
Stuff = false 
--password 
function ssj() 
if Stuff == false then 
...
owner,name = 'BRICKER24alt','The Epic tool'
