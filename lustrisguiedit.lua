...
b.BorderSizePixel=3
b.Position=UDim2.new(0.75, 0, 0.75, 0)
...
d.Position=UDim2.new(0.875, 0, 0.865, 0)
...
e.Position=UDim2.new(0.75, 0, 0.865, 0)
...
k=k:lower()
if skillattack == false and attack == false and k == 'x' then
...
if skillattack2 == false and attack == false and k == 'v' and deeznuts==false then
...
if skillattack3 == false and attack == false and k == 'c' and cooldown==false then
...
for i = 1, 200 do
	skillattack3=true
	e.Size=e.Size+UDim2.new(0, 1, 0, 0)
	wait()
end
skillattack3=false
end
