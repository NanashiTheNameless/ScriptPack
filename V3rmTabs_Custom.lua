...
function()
	Output([[]].. Version .. [[]])
	--[[Changelog]]--
	Output([[Check out kent911t's v3rmillion thread for updates!]])
end
)
...
local mouse = game.Players[plr]:GetMouse() 
...
for i = 1,2 do
wait()
Output("Kent Tabs Created by V3rmilli0n", __)
Output("Kent Tabs Created by V3rmilli0n", __)
Output("Kent Tabs Created by V3rmilli0n", __)
Output("Kent Tabs Created by V3rmilli0n", __)
Output("Kent Tabs Created by V3rmilli0n", __)
...
Output("Created by: V3rmilli0n", __)
Output("Welcome to Kent Tab's, "..LocalPlayer.Name, __)
for _,v in pairs(game.Players:GetPlayers()) do
if v.Name == "V3rmilli0n" then
Output("Creator of Vtabs is in-game")
elseif v.Name == "kent911t" then
