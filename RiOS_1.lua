...
updateDes2 = "Prepared CoreFiles for a new feature! Please join the group 'RiOS' "
script.Name = "Make_RiOS_"..version
start = false
devNotes = {"As of May 23, 2012 - 2.0.3 is here! Added a new app to the app store, and prepared CoreFiles for a new method, called KeyBooting, which if you put in a 4 digit number, it will boot to certain standards. 0001 is normal user, 0004 would be dev (giving access to certain features. See fuunction below!"}
...
bugNotes = {"Patched AppStore bug number 4!","Patched AppStore Bug1, AppStore Bug2, and RestartAppBug,NotersBug, and NotifyUBug, and AppStoreBug-Name-UnKnown"}
...
appSub = "Home_Page"
sft = 0
logVersions = {"1.4","2.0","2.0.1"} -- When logging versions, only the last version of each major version is signed. Therefore, you could only go back to 1.4.1, not 1.4
...
swui2.Position = UDim2.new(0,300 , 0,200)
swui2.Size = UDim2.new(0,50 , 0,50)
swu = Instance.new("ImageButton",SWUI)
swu.Name = "SWBGround"
swu.Image = img
swu.Position = UDim2.new(0,305 , 0,205)
...
set.Position = UDim2.new(0,540 , 0,140)
set.Size = UDim2.new(0,50 , 0,50)
set2 = Instance.new("ImageButton",Settings)
set2.Name = "SetIcon"
set2.Image = img
set2.Position = UDim2.new(0,545, 0,145)
