-----------------------------------------------------------------------------------------
-- Thanx for using mah mediafire admin script I'd appreciate credit if you used in your place c: --
-----------------------------------------------------------------------------------------
local owners = {"DeadlyShroom"} -- Are able to set admins who can ban/etc... using :pa name
