...
local Character = Player.Character
	...
	Handle = CreatePart(m, Enum.Material.SmoothPlastic, 0, 1, "White", "Handle", Vector3.new(0.200000003, 0.200000003, 1.10801423))
	...
	FakeHandle = CreatePart(m, Enum.Material.SmoothPlastic, 0, 1, "White", "FakeHandle", Vector3.new(0.200000003, 0.200000003, 1.10801423))
	...
	Hitbox = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 1, "Bright yellow", "Hitbox", Vector3.new(6.04899979, 0.200000003, 6.03399992))
	...
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "Bright yellow", "Part", Vector3.new(0.200000003, 0.443205714, 0.598327696))
	...
	CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(0.99999994, 1, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "Bright yellow", "Part", Vector3.new(0.200000003, 0.200000003, 1.18188214))
	...
	CreateMesh("SpecialMesh", Part, Enum.MeshType.Cylinder, "", Vector3.new(0, 0, 0), Vector3.new(0.99999994, 1, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0 , "Bright yellow", "Part", Vector3.new(0.317630798, 0.443205714, 0.598327696))
	...
	CreateMesh("SpecialMesh", Part, Enum.MeshType.FileMesh, "http://www.roblox.com/Asset/?id=9756362", Vector3.new(0, 0, 0), Vector3.new(0.369338065, 0.369338065, 0.738676131))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.200000003, 0.200000003, 0.443205714))
	...
	CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.73867619, 0.73867619, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.200000003, 0.200000003, 0.590941012))
	...
	CreateMesh("SpecialMesh", Part, Enum.MeshType.FileMesh, "http://www.roblox.com/Asset/?id=9756362", Vector3.new(0, 0, 0), Vector3.new(0.369338065, 0.369338065, 0.738676131))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.317630887, 0.200000003, 0.200000003))
	...
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.317630827, 0.200000003, 0.200000003))
	...
	CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 0.73867619, 0.73867619))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.200000003, 0.200000003, 2.22341561))
	...
	CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.73867619, 0.73867619, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.200000003, 0.200000003, 2.37115026))
	...
	CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.73867619, 0.73867619, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "White", "Part", Vector3.new(0.200000003, 0.200000003, 2.07567978))
	...
	CreateMesh("BlockMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(0.73867619, 0.73867619, 1))
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "Bright yellow", "Part", Vector3.new(0.613101304, 0.457979202, 0.30285719))
	...
	Part = CreatePart(m, Enum.Material.SmoothPlastic, 0.5, 0, "Bright yellow", "Part", Vector3.new(1.20404208, 0.457979202, 0.598327696))
...
ParticleEmitter = {Create = function(Parent, Color1, Color2, LightEmission, Size, Texture, Transparency, ZOffset, Accel, Drag, LockedToPart, VelocityInheritance, EmissionDirection, Enabled, LifeTime, Rate, Rotation, RotSpeed, Speed, VelocitySpread)
	...
	MagniDamage = function(Part, magni, mindam, maxdam, knock, Type, Property, Delay)
		...
		if hum ~= nil then
			...
			if head ~= nil then
				...
				if mag <= magni and c.Name ~= Player.Name then
					Damagefunc(head, head, mindam, maxdam, knock, Type, Property,Delay, "http://www.roblox.com/asset/?id=231917784", 1)
				end
			end
		end
	end
	...
	CreateSwordStay = function(BaseCFrame)

	local basepart = CreatePart(workspace, "SmoothPlastic", 0, 1, "Black", "BasePart", Vector3.new(1, 1, 1))
	basepart.Anchored = true
	game:GetService("Debris"):AddItem(basepart, 0.2)
	local icepart = CreatePart(workspace, "SmoothPlastic", 0.5, 0.5, "Bright yellow", "IceSword", Vector3.new(4, 12, 4))
	...
	coroutine.resume(coroutine.create(function(Part)
		...
		wait(10)
		Effects.Sphere.Create(BrickColor.new("Bright yellow"), Part.CFrame, 10, 10, 10, 5, 5, 5, 0.07)
		Part.Parent = nil
	end
), icepart)
	end
	
		CreateSwordStay2 = function(BaseCFrame)
...
Break = {Create = function(brickcolor, cframe, x1, y1, z1)
	...
	Effects.Ring.Create(BrickColor.new("Bright yellow"), RootPart.CFrame * angles(0, 0, 0), 5, 5, 5, 1, 1, 1, 0.07)
	Effects.Wave.Create(BrickColor.new("Bright yellow"), RootPart.CFrame * angles(1.47, 0, 0), 5, 1, 5, 0.2, 0.5, 0.2, 0.07)
	CFuncs.Sound.Create("http://roblox.com/asset/?id=191395561", Torso, 1, 1)
	for i = 0, 1, 0.5 do
		swait()
		Effects.Sphere.Create(BrickColor.new("Bright yellow"), FakeHandle.CFrame, 46, 0.5, 46, 5, 0.1, 5, 0.3)
		PlayAnimationFromTable({CFrame.new(-0.00892008841, -0.0430538058, -0.194138944, 0.481576502, -0.0958696082, 0.871144831, -0.244872004, 0.939692378, 0.238780618, -0.841499925, -0.328310072, 0.429058075), CFrame.new(-0.019540526, 1.47107708, -0.184671223, 0.594002783, 0.0319824666, -0.803827167, -0.0492451973, 0.998781085, 0.00334861875, 0.802954376, 0.0375955552, 0.59485364), CFrame.new(1.44977772, 1.05570471, -0.579476237, -0.248055339, -0.684091806, 0.685920715, 0.938187659, -0.346077472, -0.00586999068, 0.241397351, 0.642066121, 0.727652669), CFrame.new(-1.00610232, 0.414793789, -0.808649838, 0.390035987, -0.254886776, -0.88481909, -0.920793831, -0.111371592, -0.373811543, -0.00326408446, 0.960535944, -0.278137147), CFrame.new(0.500006855, -1.99999928, -6.67572021e-06, 0.939693093, -1.34110451e-06, -0.342019081, 9.983778e-07, 1, -1.13248825e-06, 0.342018992, 7.74860382e-07, 0.939692974), CFrame.new(-0.848742545, -1.53879189, 0.340080202, 1.00000012, -1.43051147e-06, 5.96046448e-08, 3.42726707e-07, 0.275636345, 0.961261988, -1.37090683e-06, -0.961262047, 0.275636375)}, 0.3, false)
...
attacktwo = function()
	...
	local con = Hitbox.Touched:connect(function(hit)
		...
		Damagefunc(Hitbox, hit, 8, 10, math.random(10, 30), "Normal", RootPart, 0.2, "rbxassetid://199149221", 0.8)
	end
)
	for i = 0, 1, 0.5 do
		swait()
	...
	for i = 0, 8 do
		...
		for i = 0, 1, 1 do
			swait()
			Effects.Wave.Create(BrickColor.new("Bright yellow"), FakeHandle.CFrame * angles(3.14, 0, 0), 5, 1, 5, 0.2, 0.1, 0.2, 0.07)
	...
	Clone()
	Effects.Block.Create(BrickColor.new("Bright yellow"), Torso.CFrame, 5, 5, 5, 7, 7, 7, 0.09)
	Effects.Block.Create(BrickColor.new("Bright yellow"), Torso.CFrame, 5, 5, 5, 7, 7, 7, 0.07)
	Cloak()
	for i = 0, 10 do
		...
		for i = 0, 1,1 do
			...
			MagniDamage(Hitbox, 10, 8, 12, 0, "Normal", RootPart, 0.3)
			Effects.Block.Create(BrickColor.new("Bright yellow"), Torso.CFrame, 35, 35, 35, 1, 1, 1, 0.1)
			Effects.Wave.Create(BrickColor.new("Bright yellow"), FakeHandle.CFrame * angles(3.14, 0, 0), 8, 0, 8, -0.5, 0, -0.5, 0.07)
			Torso.Velocity = RootPart.CFrame.lookVector * 50
			PlayAnimationFromTable({CFrame.new(0.125863791, -0.915276229, -2.1584549, 0.982593358, -0.0348575413, -0.182470411, 0.154622063, 0.697892964, 0.69931215, 0.102968521, -0.715353429, 0.691134751), CFrame.new(-0.213870525, 1.34581661, 0.092140317, 0.936451197, -0.146561041, 0.318714857, 0.308226287, 0.77757287, -0.548066795, -0.167498767, 0.611473918, 0.773333013), CFrame.new(1.76334226, 0.526868582, 0.0277193785, -0.0887514204, -0.95147109, 0.294662774, 0.787864506, -0.248058081, -0.563681602, 0.609420121, 0.18212676, 0.771645665), CFrame.new(-1.65707111, -0.0971298218, -1.16121268, 0.927877128, 0.369196832, 0.0523248352, -0.208833575, 0.630765319, -0.747344494, -0.308921874, 0.682516575, 0.662373364), CFrame.new(0.30006063, -2.10434723, -0.640750527, 0.955899656, -0.120036975, 0.268043309, -0.0415630005, 0.848187268, 0.528063416, -0.290738046, -0.515916288, 0.805792689), CFrame.new(-0.893812895, -1.52909434, -0.510264993, 0.8758955, 0.0110150054, 0.482375145, 0.0557557605, 0.990731537, -0.123864494, -0.479268581, 0.135387495, 0.867163181)}, 0.3, false)
	...
	for i = 0, 1, 0.05 do
		swait()
		MagniDamage(Hitbox, 10, 5, 10, 0, "Normal", RootPart, 0.3)

		CreateSwordStay(Hitbox.CFrame *  CFrame.new(0, 0, -1))
				CreateSwordStay(Hitbox.CFrame  *  CFrame.new(0, 0, -1) * CFrame.Angles(3.2,0,0))

		CreateSwordStay(Hitbox.CFrame *  CFrame.new(0, -10, 0) * CFrame.Angles(1.6,0,0))
				CreateSwordStay(Hitbox.CFrame  *  CFrame.new(0,10, 0) * CFrame.Angles(1.6,0,0))

		Effects.Block.Create(BrickColor.new("Bright yellow"), FakeHandle.CFrame * angles(0, 0, 0), 5, 5, 5, 5, 5, 5, 0.07)
		Effects.Wave.Create(BrickColor.new("Bright yellow"), FakeHandle.CFrame * angles(0, 0, 0), 5, 0, 5, 0.2, 0, 0.2, 0.2)
		PlayAnimationFromTable({CFrame.new(0.0565546378, -0.0999990329, -0.367125988, 0.961260855, -0.0573087893, -0.269617409, 0, 0.978147745, -0.207911134, 0.275640815, 0.199856818, 0.940255046), CFrame.new(-0.113377631, 1.58891118, -0.22031498, 0.979420662, -0.132742718, 0.152035505, 0.0793425888, 0.945866108, 0.314709842, -0.185580641, -0.296170384, 0.936932743), CFrame.new(1.06543005, 0.449709594, -0.841737628, 0.954402268, 0.290145159, 0.0702303126, 0.00985579193, 0.204505116, -0.978815973, -0.298361093, 0.934876263, 0.192320511), CFrame.new(0.0129491575, 0.461974859, -0.712421119, 0.674041271, -0.727749646, -0.126684859, -0.125153482, 0.0565113388, -0.990526795, 0.728014529, 0.68351084, -0.0529894382), CFrame.new(0.491102874, -1.78353405, 0.747602224, 0.939692736, 0.128122747, -0.317115575, 0.0711097792, 0.833735287, 0.547566354, 0.334546119, -0.537094116, 0.774344087), CFrame.new(-0.566793799, -1.99725187, -0.257866234, 1.00000012, 0, 4.76837158e-07, -9.68575478e-08, 0.978147745, 0.207911164, -4.76837158e-07, -0.207911134, 0.978147745)}, 0.3, false)
	...
	for i = 0, 100, 1 do
		CreateSwordStay(Hitbox.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), 18) * angles(math.rad(90), 0, -90))
		CreateSwordStay(Hitbox.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), 18) * angles(math.rad(90), 0, -140))
	end
	for i = 0, 1, 0.5 do
		swait()
		PlayAnimationFromTable({CFrame.new(-0.00892008841, -0.0430538058, -0.194138944, 0.481576502, -0.0958696082, 0.871144831, -0.244872004, 0.939692378, 0.238780618, -0.841499925, -0.328310072, 0.429058075), CFrame.new(-0.019540526, 1.47107708, -0.184671223, 0.594002783, 0.0319824666, -0.803827167, -0.0492451973, 0.998781085, 0.00334861875, 0.802954376, 0.0375955552, 0.59485364), CFrame.new(1.44977772, 1.05570471, -0.579476237, -0.248055339, -0.684091806, 0.685920715, 0.938187659, -0.346077472, -0.00586999068, 0.241397351, 0.642066121, 0.727652669), CFrame.new(-1.00610232, 0.414793789, -0.808649838, 0.390035987, -0.254886776, -0.88481909, -0.920793831, -0.111371592, -0.373811543, -0.00326408446, 0.960535944, -0.278137147), CFrame.new(0.500006855, -1.99999928, -6.67572021e-06, 0.939693093, -1.34110451e-06, -0.342019081, 9.983778e-07, 1, -1.13248825e-06, 0.342018992, 7.74860382e-07, 0.939692974), CFrame.new(-0.848742545, -1.53879189, 0.340080202, 1.00000012, -1.43051147e-06, 5.96046448e-08, 3.42726707e-07, 0.275636345, 0.961261988, -1.37090683e-06, -0.961262047, 0.275636375)}, 0.3, false)
	...
	local icepart1 = CreatePart(EffectModel, "SmoothPlastic", 0.5, 0, BrickColor.new("Bright yellow"), "Ice", Vector3.new(2, 4, 2))
	...
	Effects.Wave.Create(BrickColor.new("Bright yellow"), RootPart.CFrame * cn(0, 0, 5) * angles(1.47, 0, 0), 5, 10, 5, 0.5, 0.1, 0.5, 0.07)
	Effects.Ring.Create(BrickColor.new("Bright yellow"), RootPart.CFrame * angles(0, 0, 0), 5, 5, 5, 1, 1, 1, 0.07)
	for i = 0, 1, 0.1 do
		swait()
...
Humanoid.AutoRotate = false
	for i = 0, 1, 0.1 do
		swait()
		Effects.Block.Create(BrickColor.new("Bright yellow"), LeftArm.CFrame * cn(0, -1, 0), 1, 1, 1, 1, 1, 1, 0.07)
	...
	Effects.Wave.Create(BrickColor.new("Bright yellow"), RootPart.CFrame * cn(0, -1, 0), 1, 1, 1, 2, 1, 2, 0.07)
	MagniDamage(RootPart, 20, 10, 20, 0, "Snare")
	for i = 0, 230, 1 do
		swait()
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -18) * angles(math.rad(90), 0, -90))
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -18) * angles(math.rad(90), 0, -140))
	end
	for i = 0, 300, 1 do
		swait()
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -40) * angles(math.rad(90), 0, -90))
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -40) * angles(math.rad(90), 0, -140))
	end

	for i = 0, 500, 1 do
		swait()
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -120) * angles(math.rad(90), 0, -90))
		CreateSwordStay2(RootPart.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), math.random(-5, 5), -120) * angles(math.rad(90), 0, -140))
	end
						...
						if ShootEffects[e] ~= nil then
							...
							if Thing ~= nil then
								...
								if Thing[2] == "Blast" then
									...
									Thing[3] = Thing[3] - 1
									Effects.Ring.Create(BrickColor.new("Bright yellow"), Thing[8].CFrame * angles(1.47, 0, 0), 10, 10, 10, 0.5, 0.5, 0.5, 0.07)
									if hit ~= nil or Thing[3] <= 0 then
										...
										MagniDamage(ref, 20, Thing[5], Thing[6], Thing[7], "Knockdown", RootPart, 0.3)
									for i = 0, 320, 20 do		
										
												CreateSwordStay(ref.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), 0, -10) * angles(math.rad(90), 0, -90))
		CreateSwordStay(ref.CFrame * CFrame.Angles(0, 0, math.rad(90)) * CFrame.Angles(math.rad(i), 0, 0) * CFrame.new(math.random(-5, 5), 0, -10) * angles(math.rad(90), 0, -140))
		end 
										freeze = false
										for i = 1, 8 do
											Effects.Break.Create(BrickColor.new("Bright yellow"), ref.CFrame * cn(math.random(-200, 200) / 100, math.random(-200, 200) / 100, math.random(-200, 200) / 100), math.random(20, 50) / 100, math.random(1, 5), math.random(20, 50) / 100)
										end
										if Thing[10] == 2 then
											Effects.Sphere.Create(BrickColor.new("Bright yellow"), cn(ref.Position), 30, 30, 30, 5, 5, 5, 0.02)
											Effects.Block.Create(BrickColor.new("Bright yellow"), cn(ref.Position), 30, 30, 30, 5, 5, 5, 0.03)
										end
									end
									if Thing[3] <= 0 then
