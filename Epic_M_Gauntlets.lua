...
Player = game:GetService("Players").DrMigos 
...
--[[LEFT GAUNTLET]]--
local Lprt1=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Left Part1",vt(1,1,1))
...
local Lprt7=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Left Part7",vt(1,1,1))
...
local Lprt4=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Left Part4",vt(1,1,1))
...
--[[RIGHT GAUNTLET]]--
local Rprt1=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Right Part1",vt(1,1,1))
...
local Rprt7=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Right Part7",vt(1,1,1))
...
local Rprt4=part(3,modelzorz,0,0,BrickColor.new("Lime green"),"Right Part4",vt(1,1,1))
...
local actualcube=part(3,Cube,0,0.3,BrickColor.new("Lime green"),"Cube",vt(1,1,1))
...
--                h:TakeDamage(Damage)
                ...
                showDamage(hit.Parent,Damage/2,.5,BrickColor.new("Lime green"))
                end
