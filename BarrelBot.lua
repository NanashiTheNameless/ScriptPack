-- Gaster <3
-- [Your Cancer Has Evolved Into... AIDS]

-- Gaster <3
-- STAWP IT, THIS IS CANCERRR.
holy = false
print("DSSJ4 Loading..")
...
function Lightning(Part0,Part1,Times,Offset,Color,Thickness,Trans)
    ...
    for i=1,Times do
        local li = Instance.new("Part", char)
		li.Name = "Lightning"
		li.TopSurface =0
		li.Material = "Neon"
		li.BottomSurface = 0
...
HitboxA = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 1, "Royal purple", "HitboxA", Vector3.new(1.22000003, 1.00999999, 1.01999998))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.399999917, 0.210000008))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.210000008))
...
mesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.620000005, 0.200000003, 0.819999993))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.400000006))
...
mesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.620000005))
...
mesh("CylinderMesh", Part, "", "", Vector3.new(0, 0, 0), Vector3.new(1, 1, 1))
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.399999917, 0.620000005))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.200000003, 0.200000003, 0.400000036))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.600000024, 0.200000003, 1))
...
Part = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 0, "Royal purple", "Part", Vector3.new(0.600000024, 0.200000003, 0.200000003))
...
HitboxB = part(Enum.FormFactor.Custom, m, Enum.Material.Neon, 0, 1, "Royal purple", "HitboxB", Vector3.new(1.22000003, 1.00999999, 1.01999998))
...
b5.Name = "Mesh"
p8 = Instance.new("Part", m)
p8.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
p8.FormFactor = Enum.FormFactor.Symmetric
p8.Size = Vector3.new(1, 1, 1)
...
b7.Name = "Mesh"
p10 = Instance.new("Part", m)
p10.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
p10.FormFactor = Enum.FormFactor.Symmetric
p10.Size = Vector3.new(1, 1, 1)
...
b11.Name = "Mesh"
p14 = Instance.new("Part", m)
p14.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
p14.FormFactor = Enum.FormFactor.Symmetric
...
b15.Name = "Mesh"
p18 = Instance.new("Part", m)
p18.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
p18.FormFactor = Enum.FormFactor.Symmetric
...
p19 = Instance.new("Part", m)
p19.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
p19.FormFactor = Enum.FormFactor.Symmetric
...
p25.BrickColor = BrickColor.new("Royal purple") --("Bright blue")
...
for i,v in pairs (char.Absolution:GetChildren()) do
if v:IsA("Part") then
                v.Anchored=false
                v.CanCollide=false
...
outm.MeshId = "http://www.roblox.com/asset/?id=9982590"
...
for i,v in pairs (char.Claw:GetChildren()) do
        if v:IsA("WedgePart") then
                ...
                for i = 1, 20 do
                        ...
                        larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,0.55,0)*CFrame.Angles(math.rad(170),math.rad(-20),math.rad(-30)), 0.2)
                ...
                for i = 1, 14 do
                        larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,0.55,0)*CFrame.Angles(math.rad(0),math.rad(0),math.rad(-90)), 0.6)
                        if Debounces.on == false then end
                        rs:wait()
                    end
                coroutine.wrap(function()
                for i = 1, 20 do
                        ...
                        larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,0.55,0)*CFrame.Angles(math.rad(70),math.rad(20),math.rad(50)), 0.6)
                ...
                for i=0,160,3 do
                        ...
                        cfx.Mesh.MeshId="rbxassetid://9982590"
                        ...
                        rn1.Transparency=1
                        rn1.Mesh.MeshId="rbxassetid://9982590"
                        local rn2=nwPrt(cnOrb,Vector3.new(1,1,1),cnOrb.CFrame,"Really black")
                        rn2.Transparency=1
                        rn2.Mesh.MeshId="rbxassetid://9982590"
                        local nt=0
                        local cs=nil
                        for i=0,1,0.05 do
                                cs=cnOrb.Mesh.Scale
                                ...
                                if nt>=6 then
                                        ...
                                        pffx.Mesh.MeshId="rbxassetid://9982590"
...
msh.MeshId='http://www.roblox.com/asset/?id=9982590'
...
for i,v in pairs (char.Wings:GetChildren()) do
if v:IsA("Part") then
...
for i,v in pairs (char.Hair:GetChildren()) do
if v:IsA("Part") then
                v.BrickColor=BrickColor.new('Cyan')
        end
end
...
for i,v in pairs (larm.LeftArm:GetChildren()) do
        if v:IsA("WedgePart") then
                v.BrickColor = BrickColor.new("Cyan")
        end
end
...
for i,v in pairs (rarm.RightArm:GetChildren()) do
        if v:IsA("WedgePart") then
                v.BrickColor = BrickColor.new("Cyan")
        end
end
...
for i,v in pairs (rleg.RightLeg:GetChildren()) do
        if v:IsA("WedgePart") then
                v.BrickColor = BrickColor.new("Cyan")
        end
end
...
for i,v in pairs (lleg.LeftLeg:GetChildren()) do
        if v:IsA("WedgePart") then
                v.BrickColor = BrickColor.new("Cyan")
        end
end
...
while holy == true do -- Emit the Lightning effects randomly
wait()
...
wait()
	...
	local SPos1 = Body1.Position + Pos1
	local SPos2 = Body2.Position + Pos2
	Lightning(SPos1, SPos2, 4, 3, "Royal purple", .3, .56)
end
unholy = false
...
for i = 1, 2 do
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5,0.55,0)*CFrame.Angles(math.rad(88+2*math.cos(sine/14)),math.rad(0),math.rad(20)), 0.2)
larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,0.62,0)*CFrame.Angles(math.rad(-6),math.rad(6),math.rad(-8)), 0.4)
hed.Weld.C0 = Lerp(hed.Weld.C0, CFrame.new(0,1.5,-.2)*CFrame.Angles(math.rad(-14),math.rad(0),0), 0.4)
torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, 0, 0) * CFrame.Angles(0, math.rad(0), math.rad(0)), 0.4)
lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -1, 0) * CFrame.Angles(0, 0, math.rad(-8)), 0.4)
...
torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, 1-0.1*math.cos(sine/14), 0) * CFrame.Angles(math.rad(-10),0, math.rad(0)), 0.05)
...
--[[local HP1 = Instance.new("Part",larm)
HP1.Size = Vector3.new(-0.25,0.5,0.25)
HP1.BrickColor = BrickColor.new("Royal purple")
local HP1W = Instance.new("Weld", HP1)
HP1W.Part0 = larm
HP1W.Part1 = HP1
HP1W.C0 = CFrame.new(-1, .45, 0) ]]
...
torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, 1-0.1*math.cos(sine/14), 0) * CFrame.Angles(0, math.rad(-40), math.rad(0)), 0.05)
...
elseif animpose == "Running" then
change = 1
rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1,0.35,.3)*CFrame.Angles(math.rad(-30),math.rad(-14),math.rad(-30+2*math.cos(sine/18))), 0.2)
larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1,0.35,.2)*CFrame.Angles(math.rad(-30),math.rad(14),math.rad(30+2*math.cos(sine/18))), 0.2)
--larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1,0.35,.2)*CFrame.Angles(math.rad(-30),math.rad(14),math.rad(30+2*math.cos(sine/18))), 0.2)
...
hed.Weld.C0 = Lerp(hed.Weld.C0, CFrame.new(0, 1.53, -.1) * CFrame.Angles(math.rad(-5),0,0), 0.4)
--hed.Weld.C0 = Lerp(hed.Weld.C0, CFrame.new(0, 1.5, .2) * CFrame.Angles(math.rad(20),math.rad(10),0), 0.4)
torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, 0-0.1*math.cos(sine/24), 0) * CFrame.Angles(math.rad(-10),math.rad(-0), math.rad(0)), 0.2)

lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -1, 0) * CFrame.Angles(math.rad(-4), 0, math.rad(-1)), 0.4)
rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(0.5, -1, 0) * CFrame.Angles(math.rad(-4), 0, math.rad(1)), 0.4)

--[[lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, -0.8, 0.1) * CFrame.Angles(math.rad(-10), math.rad(10), math.rad(0)), 0.4)
rleg.Weld.C0 = Lerp(rleg.Weld.C0, CFrame.new(0.5, -0.8, 0.1) * CFrame.Angles(math.rad(-10), math.rad(10), math.rad(0)), 0.4) ]]
