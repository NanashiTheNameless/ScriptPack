...
blalol.Parent = game.Workspace.acb227
dronelol = game.Workspace:FindFirstChild(dronenamelol)
...
if pri[i].Name ~= "lolnoobsroflmao" then 
if pri[i].Name ~= "lolnoobsroflmao" then
if pri[i].Name ~= "someoneuhate" then 
if pri[i].Name ~= "noob" then 
if pri[i].Name ~= "lololopl" then 
pri[i]:Remove() 
end 
end 
end 
