...
hit.Parent.Torso.Velocity = Vector3.new(math.random(-0,00),math.random(140,150),math.random(-00,00)) 
end 
end) 
Stone.CFrame = Stone.CFrame*CFrame.new(0,0,0) 
for i=1,25 do 
Stone.CFrame = Stone.CFrame*CFrame.new(8,0.8,0) 
wait() 
end 
wait(0.05) 
for i=1,25 do 
...
S.Reflectance = 0 
S.CanCollide = true 
S.Size = Vector3.new(math.random(5, 7),math.random(5, 7),math.random(5, 7)) 
