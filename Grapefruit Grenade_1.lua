...
Grapefruit grenade, a nickname that US Army troops named their
fragmentation grenades because they (somewhat) resembled grapefruits.

Script by DarkShadow6

Changelog:
 o 2.1
    o Updated with love from Five-seveN. Limb controllers fixed.
 o 2.0
    o Started changelog.
    o Revamped script. The hopperbin no longer stays in your backpack after you throw it for like 3 seconds.
    o Made it blue.
--]]
...
function makeParts(format)
	...
	pm.BrickColor = BrickColor.new("Earth green")
	pm.Locked = true
	pm.TopSurface = 0
	pm.BottomSurface = 0
	pm.Parent = grenade
