...
MaxAmmo = 8, 
Ammo = 150000, 
Ammoleft = 999999999999999999999999, 
} 
Images = { 
Asset..(64291927), 
Asset..(64291941), 
...
RAB = Part(Model, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
LAB = Part(Model, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
RLB = Part(Model, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
LLB = Part(Model, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
...
local hh = Part(Model, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
hh.Name = "Head" 
Weld(FTorso, hh) 
Weapon = Instance.new("Model") 
Weapon.Name = "Weapon" 
HB = Part(Weapon, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
HBW = Weld(Rarm, HB, CN(0, -0.7, 0), CA(MR(-90), MR(180), 0)) 
HW = Weld(HB, nil, CA(MR(38), MR(-28), MR(-90)) * CN(0, -0.2, -3.8)) 
LHB = Part(Weapon, false, false, 1, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
...
Handle = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.5, 0.9, 0.9)) 
TW.Part1 = Handle 
Handle2 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.5, 0.6, 1.6)) 
Weld(Handle, Handle2, CA(MR(-45), 0, 0), CN(0, 0.5, -0.4)) 
Handle3 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.5, 0.7, 1.3)) 
Weld(Handle2, Handle3, CA(MR(45), 0, 0), CN(0, -0.4, -0.9)) 
Pipe1 = Part(Weapon, false, false, 0, 0.1, BN("Lime green"), V3(0.3, 0.3, 3.2)) 
Add.Block(Pipe1, V3(1,1,1), 0.08) 
Weld(Handle3, Pipe1, CN(0, 0.15, 1.6+0.55)) 
Pipe2 = Part(Weapon, false, false, 0, 0.1, BN("Lime green"), V3(0.3, 0.3, 1.7)) 
Add.Block(Pipe2, V3(1,1,1), 0.08) 
Weld(Handle3, Pipe2, CN(0, -0.15, 0.85+0.55)) 
Pipe3 = Part(Weapon, false, false, 0, 0.1, BN("Lime green"), V3(0.25, 0.25, 1.6)) 
Add.Block(Pipe3, V3(1,1,1), 0.065) 
Weld(Pipe2, Pipe3, CN(0, 0, 0.8+0.7)) 
Pump = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.45, 0.45, 1.1)) 
Add.Block(Pump, V3(1,1,1), 0.225/2) 
PumpWeld = Weld(Pipe2, Pump, CN(0, 0, 0.6), CN(0, 0, 0)) 
Pump2 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.5, 0.5, 0.3)) 
Add.Block(Pump, V3(1,1,1), 0.13) 
Weld(Pump, Pump2, CN(0, 0, -0.5)) 
for degrees = -20, 200, 20 do 
local Derp = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.2, 0.2)) 
Add.Block(Derp, V3(0.4,0.6,0.4), 0.02) 
Weld(Handle3, Derp, CN(0, -0.45, -0.32) * CA(MR(degrees), 0, 0), CN(0, 0, -0.2)) 
end 
Derp = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.2, 0.3)) 
...
Aim = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.3, 0.2, 0.7)) 
Add.Block(Aim, V3(1,0.7,1), 0.05) 
Weld(Pipe1, Aim, CN(0, 0.12, 1.1)) 
Aim1 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.2, 0.2)) 
Add.Block(Aim1, V3(0.3, 0.7, 0.5)) 
Weld(Aim, Aim1, CN(-.1, 0.1, -0.25)) 
Aim2 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.2, 0.2)) 
Add.Block(Aim2, V3(0.3, 0.7, 0.5)) 
Weld(Aim, Aim2, CN(.1, 0.1, -0.25)) 
Aim3 = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.2, 0.2)) 
Add.Block(Aim3, V3(0.3, 0.7, 0.5)) 
Weld(Aim, Aim3, CN(0, 0.1, 0.25)) 
BulletFlip = Part(Weapon, false, false, 0, 0, BN("Lime green"), V3(0.2, 0.3, 0.6)) 
Flip = Weld(Handle3, BulletFlip, CN(-0.18, 0.1, 0.2) * CA(0, MR(-10), 0)) 
---POCKET 
BeltWelds = {} 
BeltK = nil 
for i = -0.5, 0.5, 1 do 
local Belt = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(2.1, 0.3, 0.2)) 
table.insert(BeltWelds, Weld(Torso, Belt, CN(0, -0.9, i))) 
end 
for i = 1, -1, -2 do 
local Belt = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.2, 0.3, 1.1)) 
table.insert(BeltWelds, Weld(Torso, Belt, CN(i, -0.9, 0))) 
BeltK = Belt 
end 
for i = -0.25, 0.25, 0.5 do 
local Pocket = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(1.1, 0.9, 0.2)) 
table.insert(BeltWelds, Weld(Torso, Pocket, CN(0.8, -1.2, -0.8) * CA(0, MR(-15), 0), CN(0, 0, i))) 
end 
for i = -0.5, 0.5, 1 do 
local Pocket = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(0.6, 0.9, 0.2)) 
table.insert(BeltWelds, Weld(Torso, Pocket, CN(0.8, -1.2, -0.8) * CA(0, MR(-15)+MP/2, 0), CN(0, 0, i))) 
end 
Pocket = Part(Weapon, false, false, 0, 0, BN("Really black"), V3(1.1, 0.2, 0.6)) 
...
KnifeBlade1 = Part(Weapon, false, false, 0, 0.1, BN("Lime green"), V3(0.2, 0.8, 0.3)) 
Add.Block(KnifeBlade1, V3(0.4, 1, 1), 0.05) 
Weld(KnifeHandle2, KnifeBlade1, CN(0, 0.42, 0)) 
KnifeBlade2 = Part(Weapon, false, false, 0, 0.1, BN("Lime green"), V3(0.2, 0.24, 0.24)) 
...
Pellet.CFrame = Face 
Drop = Drop + 0.04 
local Effect = Part(EffectModel, true, false, 0, 0, BN("New Yeller"), V3(0.2, 0.2, 0.2)) 
...
Show_Damage(HitObj.Position, math.floor(Dmg), 10000.0) 
else 
PlaySound(Sounds.PartHit) 
local BulletHole = Part(EffectModel, true, false, 1, 0, BN("New Yeller"), V3(0.8, 0.2, 0.8)) 
