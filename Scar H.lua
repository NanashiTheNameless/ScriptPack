--[[
Fabrique Nationale de Herstal Special Operations Forces Combat Assault Rifle, Heavy Carbine (SCAR-H); 
developed as an alternative to the aging M4/M16 platforms.
7.62x51mm NATO, 30 Round Mag.
Standard issue US Army Rangers service rifle.
Sight0 = Iron Sight
Sight1 = Red Dot
...
function makeParts(format)
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.3, 1.2, 0.34)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.2, -0.035)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Rail" --------------
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.18, 1.19, 0.32)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.18, 2.19, 0.3)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.7, 0.02)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "BoltC1"
	...
	m.Scale = Vector3.new(0.08, 0.4, 0.08)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-1.6, 0, 0.05) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(90))
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "BoltB1"
	...
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-1.4, 0, 0.05) * CFrame.fromEulerAnglesXYZ(0, 0, math.rad(90))
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "BoltC" --------------
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.26, 0.3, 0.08)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-0.04, 0.4, -0.04)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "BoltB" --------------
	...
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part") -- Normal Stock
	p.Name = "Stock 1"
	p.CanCollide = false
	p.formFactor = "Symmetric"
	p.Size = Vector3.new(1, 1, 1)
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.28, 1.4, 0.15)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.825, -0.1)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Stock 2"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.28, 0.2, 0.6)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -1.425, -0.45)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "StockAngle1"
	...
	m.MeshType = "Wedge"
	m.Scale = Vector3.new(0.28, 0.6, 0.45)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.44, -1.1) * CFrame.fromEulerAnglesXYZ(math.rad(270), 0, math.rad(180))
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "StockAngle2"
...
function playAnimation(format, mouse)
	...
	if format == "reload" then
		...
		if magazine.Value == 0 then
			...
			wait(0.1)
			Player.Character[Name].BoltB1.Transparency = 0
			Player.Character[Name].BoltC1.Transparency = 1
			for i = 0, 10, 1.5 do
				if Player.Character:FindFirstChild("Torso") ~= nil then
					if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil then
						Player.Character.Torso["Left Shoulder 2"].C0 = CFrame.new()
			...
			Player.Character[Name].BoltB.Transparency = 1
			Player.Character[Name].BoltC.Transparency = 0
			Player.Character[Name].BoltB1.Transparency = 1
			Player.Character[Name].BoltC1.Transparency = 0			
			for i = 10, 0, -1.5 do
				if Player.Character:FindFirstChild("Torso") ~= nil then
					if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil then
						Player.Character.Torso["Left Shoulder 2"].C0 = CFrame.new()
	...
	if format == "fire" then
		...
		if Player.Character[Name]:FindFirstChild("Handle") ~= nil then
			if silenced then
				...
				Player.Character[Name].Handle.Fire.Pitch = 0.7
