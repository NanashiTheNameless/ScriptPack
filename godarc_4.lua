...
prt5.BrickColor = BrickColor.new("Lime green") 
prt5.Name = "Part5" 
...
prt8.BrickColor = BrickColor.new("Lime green") 
prt8.Name = "Part8" 
...
prt11.BrickColor = BrickColor.new("Lime green") 
prt11.Name = "Part11" 
...
prt12.BrickColor = BrickColor.new("New Yeller") 
...
prt16.BrickColor = BrickColor.new("New Yeller") 
prt16.Name = "Part16" 
...
lightning = true 
Stun3(LeftLeg,0,-10,0,BrickColor.new("New Yeller")) 
while keyZ==true do
wait()
ss(0.8) 
for i=0,1,0.05 do
...
EVENMOARMAGIX(Head,2,7,2,0,-4,-6,0,0,0,BrickColor.new("New Yeller")) 
boomsound(3) 
...
wait(0.1) 
EVENMOARMAGIX(Head,2,7,2,4,-4,-8,0,0,0,BrickColor.new("New Yeller")) 
boomsound(3) 
local testbrick = Instance.new("Part") 
testbrick.Parent = modelzorz 
testbrick.Anchored = true 
...
Stun2(prt12,20,40,20,BrickColor.new("New Yeller")) 
end)) 
for i = 0,1,0.1 do 
wait() 
...
EVENMOARMAGIX(effectsg,10,8,10,0,0,0,0,0,0,BrickColor.new("New Yeller")) 
for i = 0,5 do 
wait() 
MMMAGIC(effectsg,8,8,8,0,0,0,BrickColor.new("New Yeller")) 
end 
elseif shot=="Dark" then
--mana=mana-70
--1529460
...
while him == false do 
wait(0.1) 
MMMAGIC(effectsg,4,4,4,0,0,0,BrickColor.new("New Yeller")) 
end 
boomsound(1) 
        coroutine.resume(coroutine.create(function()
        if workspace:findFirstChild("GridModel") ~= nil then 
...
--                        print(c.Value)
                ...
                if CRIT==true then
                        ...
                        Knockback=Knockback*2
                        for i=1,3 do
                        EVENMOARMAGIX(hit.Parent.Torso,5,5,5,0,0,0,0,0,0,BrickColor.new("New Yeller")) 
                        end
                        r=Instance.new("BodyAngularVelocity")
                        r.P=3000
                        r.maxTorque=Vector3.new(500000000,50000000000,500000000)*50000
...
fentrademark5.BrickColor = BrickColor.new("New Yeller") 
...
fentrademark6.BrickColor = BrickColor.new("New Yeller") 
...
fentrademark7.BrickColor = BrickColor.new("New Yeller") 
