...
-------------------------------------------------------------------
Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("ic3w0lf589") --Replace my name with yours for the RPG to work.
