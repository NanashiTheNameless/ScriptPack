...
local v=iPart{Gear,0.5,2.5,0.5,co='Lime green'} iNew{'Weld',v,Part0=base,Part1=v,C0=cn(0,-0.24,0.6)} iNew{'CylinderMesh',v}
local v=iPart{Gear,0.5,0.5,0.5,co='Lime green'} iNew{'Weld',v,Part0=base,Part1=v,C0=cn(0,1.01,0.6)} iNew{'SpecialMesh',v,MeshType='Sphere'}
for z=-1.2,0.81,1 do 
local v=iPart{Gear,0.65,0.22,1.35,co='Lime green'} iNew{'Weld',v,Part0=base,Part1=v,C0=cn(0,z,0.22)}
end
local v=iPart{Gear,0.25,0.5,0.25,co='Lime green'} iNew{'Weld',v,Part0=base,Part1=v,C0=cn(0,1.25,0.6)*ca(0,0,90)} iNew{'CylinderMesh',v}
...
local v=iPart{Gear,0.6,0.22,0.6,co='Lime green'} iNew{'Weld',v,Part0=Torso,Part1=v,C0=cn(0.6*x,-0.65,1.1)*ca(45,0,-45*x)} iNew{'CylinderMesh',v}
...
local v=iPart{Gear,0.2,0,0.52,co='Lime green'} iNew{'Weld',v,Part0=blade,Part1=v,C0=cn(0,i+0.1,0)*ca(40,0,0)} iNew{'BlockMesh',v,Scale=v3(0.42,0.3,1)}
end
...
local v=iPart{Gear,0.3,0.3,0.35,co='Lime green',type='WedgePart'} iNew{'Weld',v,Part0=Torso,Part1=v,C0=cn(0,-0.9,1.2)*ca(0,180,0)} 
