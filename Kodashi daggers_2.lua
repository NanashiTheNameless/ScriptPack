...
han1.BrickColor = BrickColor.new('Royal purple')
...
if v ~= han1 then v.BrickColor = BrickColor.new('Royal purple') v.Reflectance = .1 end
end
local bladepar = han1
local bl1 = han1:Clone()
bl1.Parent = lm
bl1.BrickColor = BrickColor.new('Royal purple')
bl1.Reflectance = .2
...
han2.Parent = rm
han2.BrickColor = BrickColor.new('Royal purple')
...
if v ~= han2 then v.BrickColor = BrickColor.new('Royal purple') v.Reflectance = .1  end
end
local bladepar = han2
