...
local Hitbox=part(3,nil,0,0,BrickColor.new("Royal purple"),"Hitbox",vt(1,1,1))
...
--[[LEFT GAUNTLET]]--
local Lprt1=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Left Part1",vt(1,1,1))
local Lprt3=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part3",vt(1,1,1))
local Lprt5=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part5",vt(1,1,1))
local Lprt6=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part6",vt(1,1,1))
local Lprt7=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Left Part7",vt(1,1,1))
local Lprt8=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Left Part8",vt(1,1,1))
local Lprt9=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part9",vt(1,1,1))
local Lprt10=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part10",vt(1,1,1))
local Lprt11=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part11",vt(1,1,1))
...
numb=0.4
for i=1,4 do
local Lprt2=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part2",vt(1,1,1))
Lmsh2=mesh("BlockMesh",Lprt2,"","",vt(0,0,0),vt(1.06,1.05,0.1))
local Lwld2=weld(Lprt2,Lprt2,Lprt1,euler(0,0,0)*cf(0,0,numb))
local Lprt4=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part4",vt(1,1,1))
...
numb=0
for i=1,4 do
local Lprt7=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Left Part7",vt(1,1,1))
...
--[[RIGHT GAUNTLET]]--
local Rprt1=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Right Part1",vt(1,1,1))
local Rprt3=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part3",vt(1,1,1))
local Rprt5=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part5",vt(1,1,1))
local Rprt6=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part6",vt(1,1,1))
local Rprt7=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Right Part7",vt(1,1,1))
local Rprt8=part(3,modelzorz,0,0,BrickColor.new("Hot pink"),"Right Part8",vt(1,1,1))
local Rprt9=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part9",vt(1,1,1))
local Rprt10=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part10",vt(1,1,1))
local Rprt11=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part11",vt(1,1,1))
...
numb=0.4
for i=1,4 do
local Rprt2=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part2",vt(1,1,1))
Rmsh2=mesh("BlockMesh",Rprt2,"","",vt(0,0,0),vt(1.06,1.05,0.1))
local Rwld2=weld(Rprt2,Rprt2,Rprt1,euler(0,0,0)*cf(0,0,numb))
local Rprt4=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part4",vt(1,1,1))
...
numb=0
for i=1,4 do
local Rprt7=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Right Part7",vt(1,1,1))
...
function attackone()
attack=true
local armprt=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Part",vt(1,1,1))
...
local boom=part(3,workspace,0,0,BrickColor.new("Royal purple"),"Part",vt(1,1,1))
boom.Transparency=1
boom.Anchored=true
...
MagicBlock(BrickColor.new("Royal purple"),Part.CFrame,1,1,1,0.1,0.1,0.1)
...
local boom=part(3,modelzorz,0,0,BrickColor.new("Royal purple"),"Part",vt(1,1,1))
boom.Transparency=0.5
...
for i=0,20 do
wait()
MagicBlock(BrickColor.new("Royal purple"),Part.CFrame,0.5,0.5,0.5,1,1,1)
if numb>=8 then
MagicRing(BrickColor.new("Royal purple"),Part.CFrame,1,1,1,math.random(-50,50),math.random(-50,50),math.random(-50,50),0.5,0.5,0.5)
numb=0
end
numb=numb+1
end
...
MagicBlock(BrickColor.new("Royal purple"),hit.CFrame*cf(0,-1,0),0.5,0.5,0.5,1,1,1)
for i=1,3 do
Lightning(hit.Position,hit.Position+vt(math.random(-10,10),math.random(-10,10),math.random(-10,10)),5,1,"Royal purple",0.3,0.1)
end
...
for i=0,1,0.2 do
wait()
MagicBlock(BrickColor.new("Royal purple"),RightArm.CFrame*cf(0,-2.5,0),0.5,0.5,0.5,0.6,0.6,0.6)
...
local prt=part(3,workspace,0,0,BrickColor.new("Royal purple"),"Part",vt(1,1,1))
prt.Anchored=true
xval=math.random()
yval=math.random()
zval=math.random()
...
--                h:TakeDamage(Damage)
                ...
                showDamage(hit.Parent,1,.5,BrickColor.new("Hot pink"))
                end
