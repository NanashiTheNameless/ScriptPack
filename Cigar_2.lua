...
game:GetService("Chat"):Chat(Workspace.itachi2843.Head,"It's time for kashy to get his blunt")
wait()
game:GetService("Chat"):Chat(Workspace.itachi2843.Head,"Yee Stoner All the way")
wait(1)
 
Name=game.Workspace.itachi2843--Put your name here
