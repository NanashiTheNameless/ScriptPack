...
function ghost()
        local player = game.Players.LocalPlayer
                ...
                ---------------------------------------Useless--
                player.Character:findFirstChild("Wolf Squire").Handle.Transparency = 1
                player.Character:findFirstChild("Scarf01").Handle.Transparency = 1
end
...
local player = game.Players.LocalPlayer
                ...
                ---Uselessssssss---------------------------
                player.Character:findFirstChild("Wolf Squire").Handle.Transparency = 0
                player.Character:findFirstChild("Scarf01").Handle.Transparency = 0
end
