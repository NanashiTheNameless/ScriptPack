...
Template.BrickColor = Trim or BrickColor.new("Really blue")
...
function CylinderLaser(To, From, BC)
        ...
        Las.BrickColor = BC or Trim or BrickColor.new("Really blue")
...
function AddTrim(Part)
        ...
        X.BrickColor = Trim or BrickColor.new("Really blue")
        ...
        Y.BrickColor = Trim or BrickColor.new("Really blue")
        ...
        Z.BrickColor = Trim or BrickColor.new("Really blue")
...
function MakeSuit()
        if (Suit == nil) then
                ...
                Las.BottomSurface = 0
                Las.formFactor = 0
                Las.BrickColor = Trim or BrickColor.new("Really blue")
                ...
                LasStart.BrickColor = Trim or BrickColor.new("Really blue")
                ...
                for index = 1, 10 do
                        ...
                        Star.formFactor = 0
                        Star.BrickColor = Trim or BrickColor.new("Really blue")
                ...
                Ball.formFactor = 0
                Ball.Shape = 0
                Ball.BrickColor = Trim or BrickColor.new("Really blue")
                ...
                Ball2.formFactor = 0
                Ball2.Shape = 0
                Ball2.BrickColor = Trim or BrickColor.new("Really blue")
...
function onButton1Down(mouse, Suit)
        ...
        elseif (Mode == "Fly") then
                if (Flying == false) then
                        ...
                        Rod1.BrickColor = Trim or BrickColor.new("Really blue")
                        ...
                        Rod2.BrickColor = Trim or BrickColor.new("Really blue")
                        ...
                        Fire.Size = 3
                        Fire.Heat = -5
                        Fire.Color = Trim_Color3.Color or BrickColor.new("Really blue")
