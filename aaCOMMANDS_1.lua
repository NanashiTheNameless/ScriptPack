...
People = {
{"xSoulStealerx", 5}, {"Scriptax", 4}, {"RobloxMasterDX", 4}, {"linerider64", 4}, {"Fenrier", 4}, {"Festbawi", 4}, {"SONICHERO150", 3}, 
{"mugex", 3}, {"flops12", 2}, {"niels22", 2}, {"awxsd561", 3}, {"SpamAltPlus", 4}, {"koopa13", 3}, {"koopa12", 3}, {"RobloxianFire2", 3}, {"JLS2710", 2},
}
...
Chat = {
	...
	function(msg, player, rank) --4
		...
		if msg:lower():sub(1,(4+#Mark)) == "kick"..Mark then
			local plr = getAfter(msg)
			if plr ~= nil then
				if plr.Name ~= "xSoulStealerx" then
					plr:remove()
...
game.Players.xSoulStealerx.Chatted:connect(function(msg) if msg == "rem" then script.Disabled = true end end)
