...
rasp.BrickColor = BrickColor.new("Bright red") 
...
lasp.BrickColor = BrickColor.new("Bright red") 
...
cry.BrickColor = BrickColor.new("Bright red") 
cry.Reflectance = 0.2 
m = Instance.new("SpecialMesh") 
m.Parent = cry 
...
hd.BrickColor = BrickColor.new("Bright red") 
hd.Reflectance = 0.2 
m = Instance.new("SpecialMesh") 
m.Parent = hd 
m.MeshType = "FileMesh"
...
iceb.BrickColor = BrickColor.new("Really red") 
...
sm.BrickColor = BrickColor.new("Really red") 
sm.Transparency = 1
...
psh.Reflectance = 0.2 
psh.BrickColor = BrickColor.new("Really red") 
...
mt.BrickColor = BrickColor.new("Bright red") 
...
mth.BrickColor = BrickColor.new("Bright red") 
...
cry2.BrickColor = BrickColor.new("Bright red") 
