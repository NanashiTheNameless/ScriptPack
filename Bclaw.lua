...
maxmana = 6000000;mana = maxmana;impact = nil;chargeskill =false;tdown=false;
...
c2p7 = Add.part("Really black",Vector3.new(0.2, 0.2, 0.855),CFrame.new(-9.7409029, 1.860000000658, 34.3299866, -1, 0, -7.1055146e-015, 0, 1, 0, 7.1055146e-015, 0, -1),clawe2,"Part",Vector3.new(1, 0.091, 1),"Block","Brick",false,nil,0,nil,"Custom")
