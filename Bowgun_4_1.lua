--[[Bowgun Script created by: 
linerider64:Bowgun model CFrame 
Fenrier:Shooting st00f 
...
--		kabewmsound:Play() 
		...
		for i = 1, #ch do
                local humm = ch[i]:findFirstChild("Humanoid")
                if humm ~= nil and humm.Health ~= 0 then
		local headd = ch[i]:findFirstChild("Head");
                if headd ~= nil then
		local targg = headd.Position - KABEWM.Position;
		local magg = targg.magnitude;
		if magg <= 10 and ch[i].Name ~= Player.Name then
...
for i = 1, #decoyz do 
if decoyz[i].Name == Player.Name then 
...
local UMGEZABOMB = Instance.new("Part") 
...
if PoisonUpgraded.Value == true then 
PoisText1.Text = "Poison Ammo" 
PoisText2.Text = "Ammo("..poisonammo..")" 
end 
if HealUpgraded.Value == true then 
HealText1.Text = "Heal Ammo" 
HealText2.Text = "Ammo("..healammo..")" 
end 
if ExplosionUpgraded.Value == true then 
BoomText1.Text = "Explosion Ammo" 
BoomText2.Text = "Ammo("..explosionammo..")" 
end 
if ElectricUpgraded.Value == true then 
ElecText1.Text = "Electric Ammo" 
ElecText2.Text = "Ammo("..elecammo..")" 
end 
if RapidUpgraded.Value == true then 
RapidText1.Text = "Rapid Ammo" 
