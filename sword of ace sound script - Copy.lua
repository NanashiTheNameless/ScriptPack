...
game:GetService("Chat"):Chat(Workspace.luxulux.Head,"Behold.. the swords of Sound")
wait(2)
game:GetService("Chat"):Chat(Workspace.luxulux.Head,"Fear me...")
wait(1)
...
animation.AnimationId = "http://www.roblox.com/asset/?id=74909528"
...
Weld.Part0 = game.Workspace.luxulux["Right Arm"]
Weld.Part1 = Handle
Weld.C1 = CFrame.new(0, .75, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)

D = Instance.new("Part",Workspace.luxulux)
D.TopSurface = "Smooth"
...
L = Instance.new("Part",Workspace.luxulux)
L.TopSurface = "Smooth"
...
Blade = Instance.new("Part",Workspace.luxulux)
...
Point = Instance.new("Part",Workspace.luxulux)
...
Ring = Instance.new("Part",Workspace.luxulux)
...
Handle2 = Instance.new("Part",Workspace.luxulux)
...
Weld = Instance.new("Weld",Workspace.luxulux)
Weld.Part0 = game.Workspace.luxulux["Left Arm"]
Weld.Part1 = Handle2
Weld.C1 = CFrame.new(0, .75, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)

d2 = Instance.new("Part",Workspace.luxulux)
...
L2 = Instance.new("Part",Workspace.luxulux)
...
P2 = Instance.new("Part",Workspace.luxulux)
...
Blade2 = Instance.new("Part",Workspace.luxulux)
...
Point2 = Instance.new("Part",Workspace.luxulux)
...
Ring2 = Instance.new("Part",Workspace.luxulux)
