...
--AHumanoid.Died:connect(function() wait(5) if Aila==nil then return end Aila:Remove() end) 
...
--Aila:MoveTo(AilaPos)
ATorso.CFrame=CFrame.new(AilaPos)
