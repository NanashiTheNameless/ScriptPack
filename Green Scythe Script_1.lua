...
function RandomExplosionColor() colz={"New Yeller","Bright yellow","Neon orange","Deep orange","Lime green","Really red"} return colz[rn(1,#colz)] end 
...
local bal = pa(c,"","Ball",4*sc,4*sc,4*sc,false,true,0.16,0,"Lime green") bal.CFrame = pos 
local spi = pa(c,"","Ball",0,0,0,false,true,0.16,0,"Lime green") spi.CFrame = bal.CFrame local spm = qi({"SpecialMesh",spi,MeshType="FileMesh",MeshId=Decs.SpikeBall}) 
...
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(25,0,0).p,4,2.5,"Lime green",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(-25,0,0).p,4,2.5,"Lime green",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,25,0).p,4,2.5,"Lime green",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,-25,0).p,4,2.5,"Lime green",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,0,25).p,4,2.5,"Lime green",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,0,-25).p,4,2.5,"Lime green",0.3,0) 
...
q(function() 
local n1 = pa(su,"","Block",0,0,0,true,true,0.3,0,"Lime green") qi({"SpecialMesh",n1,Scale=v3(3.5,3.5,8),MeshType="FileMesh",MeshId=Decs.Chakram}) 
...
local rip = pa(su,"","Block",1,1,1,false,true,0.2,0,"Lime green") local ripm = qi({"SpecialMesh",rip,MeshType="Sphere"}) 
...
local fis = pa(su,"","Block",0,0,0,false,true,0.2,0,"Lime green") local fism = qi({"SpecialMesh",fis,Scale=v3(8*sc,8*sc,8*sc),MeshType="FileMesh",MeshId=Decs.Fist}) 
...
local worm0 = pa(mm,"","Block",0,60,0,true,true,tr,0,"Lime green") qi({"SpecialMesh",worm0,Scale=v3(9*sca,12*sca,9*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=12137531"}) 
local worm1 = pa(mm,"","Block",10*sca,6*sca,10*sca,true,true,tr,0,"Lime green") it('CylinderMesh',worm1) 
local worm2 = pa(mm,"","Block",9.5*sca,6*sca,9.5*sca,true,true,tr,0,"Lime green") it('CylinderMesh',worm2) 
local worm3 = pa(mm,"","Block",9*sca,6*sca,9*sca,true,true,tr,0,"Lime green") it('CylinderMesh',worm3) 
local worm4 = pa(mm,"","Block",8.5*sca,6*sca,8.5*sca,true,true,tr,0,"Lime green") it('CylinderMesh',worm4) 
local worm5 = pa(mm,"","Block",8*sca,6*sca,8*sca,true,true,tr,0,"Lime green") it('CylinderMesh',worm5) 
local worm6 = pa(mm,"","Block",7.2*sca,6*sca,7.2*sca,true,true,tr,0,"Lime green") qi({"SpecialMesh",worm6,Scale=v3(4*sca,18.5*sca,4*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=1033714"}) 
...
local tor = pa(su,"","Block",0,0,0,true,true,1,0,"Lime green") qi({"SpecialMesh",tor,Scale=v3(6.4*sc,8*sc,6.5*sc),MeshType="FileMesh",MeshId=Decs.Tornado}) 
...
local hol = pa(su,"","Block",1,1,1,false,true,0.1,0,"Lime green") qi({"SpecialMesh",hol,MeshType="Sphere"}) 
...
local swr = {} for i=1,14 do local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Lime green") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(4,4,4),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) ti(swr,swor) end 
local swr2 ={} for i=1,8 do local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Lime green") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(4,4,4),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) ti(swr2,swor) end 
local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Lime green") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(10,14,7.5),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) 
...
---- TUT01LOL 
han = pa(su,"","Block",0.4,0.4,0.4,false,false,0,0,"Lime green") it('CylinderMesh',han) 
...
han3 = pa(su,"","Block",0,0,0,false,false,0,1,"Lime green") qi({"SpecialMesh",han3,MeshType="Sphere",Scale=v3(0.4,0.4,0.4)*5}) 
...
for i=1,7 do 
des = pa(su,"","Block",0.4,0.2,0.4,false,false,0,0,"Lime green") it('CylinderMesh',des).Scale = v3(1,0.4,1) 
...
han8 = pa(su,"","Block",0,0,0,false,false,0.3,0.1,"Lime green") qi({"SpecialMesh",han8,MeshType="Sphere",Scale=v3(0.7,0.7,0.7)*5}) 
han8w = qi({"Weld",han2,Part0=han2,Part1=han8,C0=cn(0,2.9,0)*ca(0,0,0)}) 
han9 = pa(su,"","Block",0,0,0,false,false,0,0,"Lime green") qi({"SpecialMesh",han9,Scale=v3(0.25,1,0.25),MeshType="FileMesh",MeshId = Decs.Chakram3}) 
...
clawb1 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Lime green") qi({"SpecialMesh",clawb1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike}) 
clawb1w = qi({"Weld",han2,Part0=clawa1,Part1=clawb1,C0=cn(0,0.15,0)}) 
clawb2 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Lime green") qi({"SpecialMesh",clawb2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike}) 
...
db1 = pa(su,"","Block",0,0,0,false,false,1,0,"Lime green") qi({"SpecialMesh",db1,MeshType="Sphere",Scale=v3(1,1,1)*5}) 
db1w = qi({"Weld",han2,Part0=laa,Part1=db1,C0=cn(0,-2,0)}) 
db2 = pa(su,"","Block",0,0,0,false,false,1,0.1,"Lime green") qi({"SpecialMesh",db2,MeshType="Sphere",Scale=v3(1.2,1.2,1.2)*5}) 
...
chak2 = pa(su,"","Block",0,0,0,false,false,0.1,0.1,"Lime green") qi({"SpecialMesh",chak2,Scale=v3(0.15,0.15,0.05)*5,MeshType="FileMesh",MeshId=Decs.Chakram2}) 
...
Trail(bla3,15,0,"Lime green",0.65,cn(0,-0.2,-1)) rayHit(0.6,1,ra,ca(rd(-90),0,0),8,1.3) 
...
block.Value = true repeat wait(0.4) GlowMesh(true,chak2.Mesh.MeshId,chak2,chak2.Mesh.Scale*1.5,'Lime green',cn(0,0,0),chak2.Transparency,1,0.025) until not ky[k] for i=11,1,-1 do chak2.Reflectance = i/40 chak2.Mesh.Scale = spm*i wait() end chak2.Reflectance = 0 
...
local tpos = mouse.hit.p if (tpos - bla2.Position).magnitude < 350 then q(function() local to = pa(su,"","Block",2,1,2,false,true,0.1,0,"Lime green") it('CylinderMesh',to) local to2 = pa(su,"","Block",0,0,0,false,true,0.1,0,"Lime green") qi({"SpecialMesh",to2,Scale=v3(2,2,2),MeshType="FileMesh",MeshId=Decs.Totem}) 
...
local to = pa(su,"","Block",0,0,0,false,false,0.2,0,"Lime green") it('CylinderMesh',to).Scale=v3(9,0.2,9)*5 local tom = qi({"Weld",to,Part0=ra,Part1=to}) 
...
local das = pa(su,"","Block",1.5,2.5,1.5,false,true,0.1,0,"Lime green") qi({"SpecialMesh",das,MeshType="Sphere"}) 
...
local pla = pa(su,"","Block",7,1,7,true,true,1,0,"Lime green") 
function ButtonDown() if Anim~="None" then return end 
to.Velocity=v3(0,0,0) if hu.Jump then GlowMesh(false,"Sphere",t,v3(8,2,8),'Lime green',to.CFrame*cn(0,-2,0),0.1,1,0.05) GlowMesh(false,Decs.Crown,t,v3(5,3,5),'Lime green',to.CFrame*cn(0,-1.5,0)*ca(rd(180),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,20,0) 
...
GlowMesh(false,Decs.Crown,t,v3(5,3,5),'Navy blue',to.CFrame*cn(0,0,1)*ca(rd(90),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,0,-12) GlowMesh(false,"Sphere",t,v3(8,10,2),'Lime green',to.CFrame*cn(0,0,1),0.1,1,0.05) end 
