...
Tablet("Loading Aerx Tablets.", Colors.Toothpaste)
Tablet("Loading Aerx Tablets..", Colors.Toothpaste)
Tablet("Loading Aerx Tablets...", Colors.Toothpaste)
Tablet("Loaded!", Colors.Toothpaste)
Tablet("Aerx Tablets Version: gus14657"..Version, Colors.Toothpaste)
Tablet("Initializing...", Colors.Toothpaste)
