...
iPlayer = game.Players.LocalPlayer.Name -- xiPlayzix
...
Credits.Text = 'Credits to - Phemzy'
Credits.Position = UDim2.new(0,0,1,0)
Credits.Size = UDim2.new(1,0,0,10)
...
print('Teleported ' .. PlayerName.Text .. ' to you.')
end)
...
print('Teleported to ' .. PlayerName.Text)
end)]]--
