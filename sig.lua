...
g.Parent = workspace.acb227.torso 
...
for i = 1, #look do 
if string.find(string.lower(look[i].Name), said) == 1 then 
workspace.acb227.Torso.Smoke:Remove() 
siga.Transparency = 1 
sigb.Transparency = 1 
end 
end 
...
for i = 1, #look do 
if string.find(string.lower(look[i].Name), said) == 1 then 
workspace.acb227.torso.Smoke.Color = Color3.new(100, 100, 100) 
workspace.acb227.Humanoid.WalkSpeed = 35 
wait(15) 
workspace.acb227.Humanoid.WalkSpeed = 16
workspace.acb227.torso.Smoke.Color = Color3.new(1, 5, 5) 
end 
end 
end 
end 
...
for i = 1, #look do 
if string.find(string.lower(look[i].Name), said) == 1 then 
workspace.acb227.Humanoid.PlatformStand = true 
end 
end 
end 
end 
