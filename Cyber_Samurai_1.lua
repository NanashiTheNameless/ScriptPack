...
local handle=part(3,modelzorz,0,0.5,BrickColor.new("Black"),"Handle",vt())
...
n2=n2+1
Name="Part"..n2
local prt6=part(3,modelzorz,0,0,BrickColor.new("Black"),Name,vt())
...
handlewld.C1=clerp(handlewld.C1,euler(0,0,0)*cf(0,0,0),.4)
...
RH.C0=clerp(RH.C0,cf(0.5,-1,0)*euler(0,1.57,0),.2)
LH.C0=clerp(LH.C0,cf(-0.5,-1,0)*euler(0,-1.57,0),.2)
...
swait()
handlewld.C0=clerp(handlewld.C0,euler(1.57,0,0)*cf(0,1,0),.4)
handlewld.C1=clerp(handlewld.C1,euler(0.2,0,0)*cf(0,0,0),.4)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*euler(0,0,-1),.4)
Torso.Neck.C1=clerp(Torso.Neck.C1,necko2*euler(-0.2,0,0),.4)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,1),.4)
RW.C0=clerp(RW.C0,cf(.5,0.2,-0.5)*euler(0.7,0,-0.6),.4)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(0,-1.57,0),.4)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.8,0),.4)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.1,0,0),.4)
RH.C0=clerp(RH.C0,cf(0.5,-1,0)*euler(0,.57,0),.4)
RH.C1=clerp(RH.C1,cf(0,1,0)*euler(0,1.57,0),.4)
LH.C0=clerp(LH.C0,cf(-0.5,-1,0)*euler(-0.2,-2.57,0),.4)
LH.C1=clerp(LH.C1,cf(0,1,0)*euler(0,-1.57,0),.4)
end
handlewld.C0=euler(1.5,0,0)*cf(0,1,0)
...
MagniDamage(ef,5,50,50,math.random(10,20),"Normal")
...
LW.C0=cf(-1.3,0.5,-0.3)*euler(0,-0.8,0)
LW.C1=cf(0,0.5,0)*euler(0.1,0,0)
--[[wld11.C0=clerp(wld11.C0,euler(0,2.7,0)*cf(0,1,0),.4)
Neck.C0=clerp(Neck.C0,necko*euler(0,0,-.5),.4)
Neck.C1=clerp(Neck.C1,necko2*euler(-0.2,0,0),.4)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,.5),.4)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(2.1,0,.8),.4)
RW.C1=clerp(LW.C1,cf(0,4.5,0)*euler(0,-2,0),.4)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.8,0),.4)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.1,0,0),.4)]]
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
...
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(2.3,0,1),.3)
RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,-2.27,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.8,-0.4),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.1,0,0),.3)
RH.C0=clerp(RH.C0,cf(0.5,-1,0)*euler(0,1.57,0),.3)
RH.C1=clerp(RH.C1,cf(0,1,0)*euler(0,1.57,0),.3)
LH.C0=clerp(LH.C0,cf(-0.5,-1,0)*euler(0,-1.57,0),.3)
LH.C1=clerp(LH.C1,cf(0,1,0)*euler(0,-1.57,0),.3)
n=n-0.05
end
for i=0,1,0.1 do
swait()
...
Neck.C0=clerp(Neck.C0,necko*euler(0,0,-.5),.3)
Neck.C1=clerp(Neck.C1,necko2*euler(0,0,0),.3)
handlewld.C1=clerp(handlewld.C1,euler(0,0,0),.3)
wld11.C0=clerp(wld11.C0,euler(1.57,3.14,0)*cf(0,1,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,.5),.3)
RW.C0=clerp(RW.C0,cf(1,0.5,-0.5)*euler(1.3,1.57,0),.3)
RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(-0.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.6,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.1,0,0),.3)
end
attack=false
end
...
for i=0,1,0.1 do
swait()
Neck.C0=clerp(Neck.C0,necko*euler(0,0,-0.7),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,0.8),.3)
wld11.C0=clerp(wld11.C0,euler(1.57,3.14,0)*cf(0,1,0),.3)
RW.C0=clerp(RW.C0,cf(.5,0.5,-0.5)*euler(1.5,1.57,0),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.6,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.3,0,0),.3)
end
con1=hitbox.Touched:connect(function(hit) Damagefunc(hit,50,50,math.random(5,10),"Normal",RootPart,.2,1,nil,1) end) 
...
for i=0,1,0.2 do
swait()
wld11.C0=clerp(wld11.C0,euler(0,3.14,0)*cf(0,1,0),.3)
Torso.Neck.C0=clerp(Neck.C0,necko*euler(0,0,-0.5),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,0.5),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(1.7,1.57,0),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(1.5,0.5,0),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(0,-0.4,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.5,0,0),.3)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
effect("Bright red",0.4,LastPoint,Point)
LastPoint=Point
hitbox.CFrame=prt16.CFrame
...
MagniDamage(Torso,5,50,50,math.random(20,40),"Knockdown")
so("http://www.roblox.com/Asset?ID=87784452",Torso,1,1.2)
for i=1,3 do
MagicBlock(BrickColor.new("Black"),Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,3,3,3,0.03,2,Torso)
MagicCircle(BrickColor.new("Black"),Torso.CFrame,1,1,1,3,3,3,0.01)
end
end
if explode==false then
MagniDamage(ef,5,50,50,math.random(10,20),"Charge")
end
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-0.2-1.37*i,2.5+0.2*i,0)*cf(-0.2+0.2*i,1,-0.2+0.2*i)
Torso.Neck.C0=necko*euler(0,0,-1+0.5*i)
...
MagniDamage(ef,5,50,50,math.random(5,10),"Normal")
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-0.2-1.37*i,2.5+0.2*i,0)*cf(-0.2+0.2*i,1,-0.2+0.2*i)
Torso.Neck.C0=necko*euler(0,0,-1+0.5*i)
Torso.Neck.C1=necko2*euler(-0.2,0,0)
...
Humanoid.WalkSpeed=10
CF=RootPart.CFrame
local ef=part(3,workspace,0,0.2,BrickColor.new("Black"),"Effect",vt(1,1,1))
ef.Anchored=true
ef.CFrame=CF
...
for i=0,1,0.05 do
swait()
MagniDamage(Part,5,55,50,20,"Up")
Mesh.Scale=vt(3,3+3*i,3)
Part.CFrame=CeEf*cf(0,0,-50*i)*euler(0,15*i,0)
MagicBlock(BrickColor.new("Black"),ef.CFrame*cf(math.random(-100,100)/100,math.random(-100,100)/100,math.random(-100,100)/100)*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,1,1,1,0.05,2,ef)
Part.Transparency=i
end
ef.Parent=nil
end),ef,efmsh,CF)
...
Torso.Neck.C1=necko2*euler(0,0,0)
RootJoint.C0=RootCF*euler(0,0,0.5+0.5*i)
RW.C0=cf(1.5,0.5,0)*euler(2.3-0.2*i,0,1.2-0.4*i)
RW.C1=cf(0,0.5,0)*euler(0,-2.2+0.2*i,0)
LW.C0=cf(-1.3,0.5,-0.3)*euler(0,-0.8,-0.4)
LW.C1=cf(0,0.5,0)*euler(0.1+0.2*i,0,0)
end
swait(5)
...
for i=0,1,0.1 do
swait()
Torso.Neck.C0=necko*euler(0,0,-1+0.8*i)
Torso.Neck.C1=necko2*euler(-0.2+0.1*i,0,0)
RootJoint.C0=RootCF*euler(0,0,1-0.8*i)
RW.C0=cf(.5+0.5*i,0.2+0.3*i,-0.5+0.5*i)*euler(0.7+1.4*i,0,-0.6+0.2*i)
RW.C1=cf(0,0.5,0)*euler(0,-1.57,0)
LW.C0=cf(-1.3,0.5,-0.3)*euler(0,-0.8-0.2*i,-0.2*i)
LW.C1=cf(0,0.5,0)*euler(0.1-1*i,0,0)
RH.C0=cf(0.5,-1,0)*euler(0,1.57-1+1*i,0)
RH.C1=cf(0,1,0)*euler(0,1.57,0)
LH.C0=cf(-0.5,-1,0)*euler(-0.2+0.2*i,-1.57-1+1*i,0)
LH.C1=cf(0,1,0)*euler(0,-1.57,0)
...
print("boop")
MagicBlock(BrickColor.new("Black"),Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),3,3,3,1,1,1,0.02,2,Torso)
local LastPoint=Torso.CFrame
local Point=Torso.CFrame
Torso.CFrame=Tors.CFrame*cf(0,0,5)
MagicBlock(BrickColor.new("Black"),Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),3,3,3,1,1,1,0.02,2,Torso)
wld11.Part1=RightArm
so("http://roblox.com/asset/?id=2767090",Torso,1,1.5) 
swait(10)
wld11.C0=euler(1.57,3.14,0)*cf(0,1,0)
Torso.Neck.C0=necko*euler(0,0,-0.7)
RootJoint.C0=RootCF*euler(0,0,0.7)
RW.C0=cf(.5,0.5,-0.5)*euler(1.7,1.57,0)
RW.C1=cf(0,0.5,0)*euler(-1.1,0.5,0)
LW.C0=cf(-1.5,0.5,0)*euler(0,-0.4,-0.2)
LW.C1=cf(0,0.5,0)*euler(0.5,0,0)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
so("http://www.roblox.com/asset/?id=161006195",prt11,1,1)
so("rbxasset://sounds\\unsheath.wav",prt11,1,1.5)
so("http://www.roblox.com/asset/?id=28144425",Tors,1,0.6)
Damagefunc(Tors,50,50,math.random(40,70),"Knockdown",RootPart,1,1,9999,0)
--for i=1,2 do
MagicCircle(BrickColor.new("Black"),Tors.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),5,5,5,-.05,4,-.05,0.01)
--end
for i=0,1,0.2 do
swait()
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
Torso.Neck.C0=necko*euler(0,0,-0.7+0.7*i)
RootJoint.C0=RootCF*euler(0,0,0.7-0.7*i)
...
swait()
Humanoid.WalkSpeed=0
wld11.C0=clerp(wld11.C0,euler(1.57,0,0)*cf(0,1,0),.3)
handlewld.C1=clerp(handlewld.C1,euler(0,0,0),.3)
Torso.Neck.C0=clerp(Neck.C0,necko*euler(0,0,0),.3)
Torso.Neck.C1=clerp(Neck.C1,necko2*euler(-0.2,0,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,0),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(2.7,0,-0.2),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(0,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(-0.5,-0.4,0),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0,0,0.4),.3)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
effect("Bright red",0.4,LastPoint,Point)
LastPoint=Point
end
...
MagicCircle(BrickColor.new("Black"),Part.CFrame,150,150,150,-2,-2,-2,0.03)
for i=1,20 do
wait()
for i=1,2 do
MagicBlock(BrickColor.new("Black"),Part.CFrame*cf(math.random(-20,20),math.random(-20,20),math.random(-20,20))*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,1,1,1,0.05,2,Part)
end
end
end),RootPart)
so("http://www.roblox.com/asset/?id=2974000",prt11,1,0.8)
MagniDamage(RootPart,5,50,50,math.random(-40,-20),"Knockdown")
swait(10)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
for i=0,1,0.05 do
...
for i=0,1,0.1 do
swait()
Torso.Neck.C0=clerp(Neck.C0,necko*euler(0,0,.1),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,-.1),.3)
handlewld.C1=clerp(handlewld.C1,euler(0,0,0),.3)
wld11.C0=clerp(wld11.C0,euler(1.57,3.14,0)*cf(0,1,0),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(1.3,-1.5,0),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(-1.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(0,-0.4,-0.4),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.2,0,0),.3)
end
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
so("rbxasset://sounds\\unsheath.wav",prt11,1,1.7)
so("http://www.roblox.com/asset/?id=161006195",prt11,1,1.1)
if Charge>=3 then
Charge=0
explode=true
...
local ef=part(3,workspace,0,1,BrickColor.new("Black"),"Effect",vt())
ef.Anchored=true
ef.CFrame=RightArm.CFrame*cf(0,-1.5,0)
if i==0.6 and explode==true then
MagniDamage(Torso,5,50,50,math.random(20,40),"Knockdown")
so("http://www.roblox.com/Asset?ID=87784452",Torso,1,1.2)
for i=1,3 do
MagicBlock(BrickColor.new("Black"),Torso.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,3,3,3,0.05,2,Torso)
MagicCircle(BrickColor.new("Black"),Torso.CFrame,1,1,1,3,3,3,0.03)
end
end
if explode==false then
MagniDamage(ef,5,50,50,math.random(5,10),"Charge")
end
game:GetService("Debris"):AddItem(ef,2)
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
Torso.Neck.C0=necko*euler(0,0,0.3-1.1*i)
RootJoint.C0=RootCF*cf(0,-10*i,0)*euler(0,0,-0.3+1.1*i)
RW.C0=cf(1.5-0.5*i,0.5,-0.5*i)*euler(1.3,-1.57,0)
RW.C1=cf(0,0.5,0)*euler(-1.5+2.4*i,0,0)
LW.C0=cf(-1.5,0.5,0)*euler(0,-0.4,-0.4)
LW.C1=cf(0,0.5,0)*euler(0.3,0,0)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
effect("Bright red",0.4,LastPoint,Point)
LastPoint=Point
end
RootJoint.C0=RootCF*euler(0,0,0.8)
...
Torso.Neck.C0=clerp(Neck.C0,necko*euler(0,0,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,0),.3)
RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(1.57,1.57,0),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(-0.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(0,0,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.3,0,0),.3)
end
mana=mana-5
so("rbxasset://sounds\\unsheath.wav",prt11,1,math.random(120,160)/100)
so("http://www.roblox.com/asset/?id=161006195",prt11,1,math.random(90,110)/100)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
for i=0,1,0.1 do
local ef=part(3,workspace,0,1,BrickColor.new("Black"),"Effect",vt())
ef.Anchored=true
ef.CFrame=RightArm.CFrame*cf(0,-2,0)
MagniDamage(ef,5,50,50,1,"Normal")
game:GetService("Debris"):AddItem(ef,1)
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
RW.C0=cf(1.5,0.5,0)*euler(1.57,1.57,0)
RW.C1=cf(0,0.5,0)*euler(-0.3+1.87*i,0,0)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
effect("Bright red",0.4,LastPoint,Point)
LastPoint=Point
end
...
swait()
wld11.C0=euler(1.57,3.14,0)*cf(0,1,0)
RW.C1=cf(0,0.5,0)*euler(1.57+0.2*i*n,0,0)
n=n-0.1
end
local spinnum=0
coroutine.resume(coroutine.create(function()
local num=0
while holdx==true and spinnum<=5 do
swait()
RootJoint.C0=RootCF*euler(0,0,num)
num=num-(math.random(10,30)/100)
end
RootJoint.C0=RootCF
end))
while holdx==true and spinnum<=5 do
spinnum=spinnum+1
num=math.random(-100,100)/100
mana=mana-5
so("rbxasset://sounds\\unsheath.wav",prt11,1,math.random(120,160)/100)
so("http://www.roblox.com/asset/?id=161006195",prt11,1,math.random(90,110)/100)
wld11.C0=euler(1.57,3.14,0)*cf(0,1,0)
RW.C0=cf(1.5,0.5,0)*euler(1.57,1.57+num,0)
...
ef.Anchored=true
ef.CFrame=RightArm.CFrame*cf(0,-2,0)
MagniDamage(ef,7,50,50,1,"Normal")
game:GetService("Debris"):AddItem(ef,1)
wld11.C0=euler(1.57-1.57*i,3.14,0)*cf(0,1,0)
RW.C0=cf(1.5,0.5,0)*euler(1.57,1.57+num,0)
RW.C1=cf(0,0.5,0)*euler(-0.3+1.87*i,0,0)
...
for i=0,1,0.1 do
swait()
wld11.C0=euler(1.57+0.93*i,3.14-0.44*i,0)*cf(0,1,0)
Torso.Neck.C0=necko*euler(0,0,-1*i)
RootJoint.C0=RootCF*euler(0,0,1*i)
RW.C0=cf(1.5,0.5,0)*euler(1.57+0.53*i,1.57-1.57*i,0.8*i)
RW.C1=cf(0,0.5,0)*euler(1.77-1.77*i,-2*i,0)
LW.C0=cf(-1.5,0.5,0)*euler(0,-0.8*i,-0.2-0.2*i)
LW.C1=cf(0,0.5,0)*euler(0.3,0,0)
end
swait(5)
so("rbxasset://sounds\\unsheath.wav",prt11,1,1)
...
Torso.Neck.C0=clerp(Neck.C0,necko*euler(0,0,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(0,0,0),.3)
RW.C0=clerp(RW.C0,cf(.5,0.5,-0.5)*euler(1.3,1.07,0),.3)
RW.C1=clerp(RW.C1,cf(0,0.5,0)*euler(-1.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.6,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.3,0,0),.3)
end
...
MagniDamage(ef,5,50,50,1,"Normal")
game:GetService("Debris"):AddItem(ef,1)
RW.C0=cf(1+0.5*i,0.5,-0.5+0.5*i)*euler(1.3,1.07,0)
RW.C1=cf(0,0.5,0)*euler(-1.3+3*i,0,0)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
effect("Bright red",0.4,LastPoint,Point)
LastPoint=Point
end
...
num2=math.random(-500,500)/100
num3=math.random(-500,500)/100
RW.C0=cf(1.5+num2,0.5+num3,-i)*euler(1.3,1.07+num,0)
RW.C1=cf(0,0.5,0)*euler(-1.3,0,0)
so("rbxasset://sounds\\unsheath.wav",prt11,.6,math.random(120,160)/100)
local Point=prt17.CFrame*cf(0,prt17.Size.Y,0)
LastPoint=Point
MagicCircle(BrickColor.new("Black"),RightArm.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.2,2,.2,.2,8,.2,0.05)
--MagicBlock(BrickColor.new("Bright red"),RightArm.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),1,1,1,.5,.5,.5,0.05)
for j=0,1,1 do
local ef=part(3,workspace,0,1,BrickColor.new("Black"),"Effect",vt())
ef.Anchored=true
ef.CFrame=RightArm.CFrame*cf(0,-2,0)
...
game:GetService("Debris"):AddItem(ef,1)
RW.C0=cf(1.5+num2,0.5+num3,-i)*euler(1.3,1.07+num,0)
RW.C1=cf(0,0.5,0)*euler(-1.3+3*j,0,0)
end
RW.C0=cf(1.5,0.5,0)*euler(1.3,1.07,0)
RW.C1=cf(0,0.5,0)*euler(-1.3+3,0,0)
end
attack=false
end
...
--                        hs(hit,1.2) 
                ...
                MagicCircle(BrickColor.new("Black"),hit.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.2,2,.2,.2,6,.2,0.1)
                end
                        c=Instance.new("ObjectValue")
                        c.Name="creator"
...
--                vp.velocity=Character.Torso.CFrame.lookVector*Knockback
                ...
                MagicCircle(BrickColor.new("Black"),hit.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),.2,2,.1,.2,8,.1,0.05)
...
if key=="v" and ripostestance==true then
ripostestance=false
con1:disconnect()
for i=0,1,0.1 do
swait()
Torso.Neck.C0=necko*euler(0,0,-0.2-0.8*i)
Torso.Neck.C1=necko2*euler(-0.1-0.1*i,0,0)
RootJoint.C0=RootCF*euler(0,0,0.2+0.8*i)
RW.C0=cf(1-0.5*i,0.5-0.3*i,-0.5*i)*euler(2.1-1.4*i,0,-0.4-0.2*i)
RW.C1=cf(0,0.5,0)*euler(0,-1.57,0)
LW.C0=cf(-1.3,0.5,-0.3)*euler(0,-1+0.2*i,-0.2+0.2*i)
LW.C1=cf(0,0.5,0)*euler(-0.9+1*i,0,0)
RH.C0=cf(0.5,-1,0)*euler(0,1.57-1*i,0)
RH.C1=cf(0,1,0)*euler(0,1.57,0)
LH.C0=cf(-0.5,-1,0)*euler(-0.2*i,-1.57-1*i,0)
LH.C1=cf(0,1,0)*euler(0,-1.57,0)
...
if key=="z" and mana>=15 then
IaidoDash()
end
if key=="x" and mana>=15 then
Wilt()
end
if key=="" and mana>=20 then
Rose()
end
if key=="c" and mana>=40 then
Riposte()
end
...
if key=="x" and mana>=35 then
Sheathed=true
Wilt2()
end
if key=="c" and mana>=15 then
Rose2()
end
if key=="v" and mana>=40 then
ElecStorm()
--Endium()
end
end
...
Anim="Jump"
if attack==false and Sheathed==false then
RW.C0=clerp(RW.C0,cf(.7,0.5,-0.5)*euler(1,1.57,0)*euler(.8,0,0),.3)
RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(-0.3,0,0),.3)
...
Anim="Fall"
if attack==false and Sheathed==false then
RW.C0=clerp(RW.C0,cf(.5,0.5,-0.5)*euler(1.6,1.57,0)*euler(1,0,0),.3)
RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(-0.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*euler(-.2,0,-0.5),.3)
...
handlewld.C1=clerp(handlewld.C1,euler(0,0,0),.3)
wld11.C0=clerp(wld11.C0,euler(1.57,3.14,0)*cf(0,1,0),.3)
RootJoint.C0=clerp(RootJoint.C0,RootCF*euler(.2,0,.5),.3)
RW.C0=clerp(RW.C0,cf(1,0.5,-0.5)*euler(1.3,1.57,0)*euler(.6,0,0),.3)
RW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(-0.3,0,0),.3)
LW.C0=clerp(LW.C0,cf(-1.3,0.5,-0.3)*euler(0,-0.6,-0.2),.3)
LW.C1=clerp(LW.C1,cf(0,0.5,0)*euler(0.4,0,0),.3)
end
...
Mesh=Thing[1].Mesh
Mesh.Scale=Mesh.Scale-vt(Thing[4],0,Thing[6])
Thing[1].Transparency=Thing[1].Transparency+Thing[3]
