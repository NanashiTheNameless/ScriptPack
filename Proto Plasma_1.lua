...
local etheral = false
local overheat = 0
local searslash = false
local markstab = false
local Marked = nil
local canetheral = false
local move1 = "(Z)\nSearing"
local move2 = "(X)\nReaping"
local move3 = "(C)\nMarking Stab"
local move4 = "(V)\nEtheral Blades"
...
local fenbarmove1b = gui("TextLabel", fenbarmove1, "", 0.55, BrickColor.new("Bright blue").Color, UDim2.new(0, 0, 0, 0), UDim2.new(0, 0, 1, 0))
local fenbarmove2 = gui("TextButton", fenframe3, move2, 0.55, Color3.new(0.5, 0.5, 0.5), UDim2.new(0.6, 0, 0.1, 0), UDim2.new(0.4, 0, 0.4, 0))
fenbarmove2.ZIndex = 2
local fenbarmove2b = gui("TextLabel", fenbarmove2, "", 0.55, BrickColor.new("Bright blue").Color, UDim2.new(0, 0, 0, 0), UDim2.new(0, 0, 1, 0))
local fenbarmove3 = gui("TextButton", fenframe3, move3, 0.55, Color3.new(0.5, 0.5, 0.5), UDim2.new(0.1, 0, 0.6, 0), UDim2.new(0.4, 0, 0.4, 0))
fenbarmove3.ZIndex = 2
local fenbarmove3b = gui("TextLabel", fenbarmove3, "", 0.55, BrickColor.new("Bright blue").Color, UDim2.new(0, 0, 0, 0), UDim2.new(0, 0, 1, 0))
local fenbarmove4 = gui("TextButton", fenframe3, move4, 0.55, Color3.new(0.5, 0.5, 0.5), UDim2.new(0.6, 0, 0.6, 0), UDim2.new(0.4, 0, 0.4, 0))
fenbarmove4.ZIndex = 2
local fenbarmove4b = gui("TextLabel", fenbarmove4, "", 0.55, BrickColor.new("Bright blue").Color, UDim2.new(0, 0, 0, 0), UDim2.new(0, 0, 1, 0))
...
rprt18 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Right Part18", vt())
rprt19 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Right Part19", vt())
rprt20 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Right Part20", vt())
rprt21 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Right Part21", vt())
rprt22 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Right Part22", vt())
...
lprt18 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Left Part18", vt())
lprt19 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Left Part19", vt())
lprt20 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Left Part20", vt())
lprt21 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Left Part21", vt())
lprt22 = part(3, modelzorz, 0.7, 1, BrickColor.new("Really blue"), "Left Part22", vt())
...
bprt8 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part08", vt())
bprt9 = part(3, modelzorz, 0, 0, BrickColor.new("Black"), "Booster Part09", vt())
bprt10 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part10", vt())
...
for i = 1, 2 do
  ...
  bprt12 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part12", vt())
  ...
  for i = 1, 2 do
    bprt15 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part15", vt())
    bprt16 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part16", vt())
    bprt17 = part(3, modelzorz, 0.5, 0, BrickColor.new("Bright blue"), "Booster Part17", vt())
...
parti.Color = cs(Color3.new(0, 0, 1), Color3.new(0.3921568627451, 0.3921568627451, 1))
...
parti4.Parent = bprt1
parti5 = parti:Clone()
parti5.Texture = "rbxassetid://241650934"
parti5.LightEmission = 0.5
parti5.Size = ns({NumberSequenceKeypoint.new(0, 5), NumberSequenceKeypoint.new(0.2, 0), NumberSequenceKeypoint.new(0.4, 2), NumberSequenceKeypoint.new(0.6, 0), NumberSequenceKeypoint.new(0.8, 2), NumberSequenceKeypoint.new(1, 0)})
parti5.Acceleration = vt(0, -1, 0)
parti5.Rate = 20
parti5.Speed = nr(2)
parti5.VelocitySpread = 180
parti5.Parent = nil
...
attackone = function()
  ...
  do
    ...
    for i = 0, 1, 0.2 do
      ...
      hitboxCF = rprt5.CFrame * cf(0, -1.5, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 7, 8, math.random(5, 10), "Normal", RootPart, 0.3, 2, (math.random(2, 5)), nil, true)
...
Flight = function()
  ...
  Vel = vt(ex, why, ze)
  local mananum = 0
  while overheat <= 50 and flight == true and mana.Value > 1 and overheat <= 100 do
    swait()
    overheat = overheat + 1
    if mananum >= 3 then
      mananum = 0
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 15 then
    ...
    for i = 0, 1, 0.15 do
      ...
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0), 0.3)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.3)
      RW.C0 = clerp(RW.C0, cf(1.5, 0.5, 0) * euler(0, 0, 1.57) * euler(0, 3.14, 0), 0.3)
      RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      LW.C0 = clerp(LW.C0, cf(-1.5, 0.5, 0) * euler(0, 0, -1.57) * euler(0, 0, 0), 0.3)
      LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.3)
      RH.C0 = clerp(RH.C0, cf(1, -0.8, 0) * euler(0, 1.57, 0) * euler(-0.2, 0, 0), 0.3)
      LH.C0 = clerp(LH.C0, cf(-1, -0.8, 0) * euler(0, -1.57, 0) * euler(-0.2, 0, 0), 0.3)
      if StunT.Value > Stun.Value then
        do
    ...
    for i = 0, 1, 0.05 do
      ...
      hitboxCF = lprt5.CFrame * cf(0, -1.5, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 9, 11, math.random(5, 10), "Normal", RootPart, 0.2, 2, (math.random(1, 4)), nil, false)
      hitboxCF = rprt5.CFrame * cf(0, -1.5, 0)
      hitbox.CFrame = hitboxCF
      MagniDamage(hitbox, 6, 9, 11, math.random(5, 10), "Normal", RootPart, 0.2, 2, (math.random(1, 4)), nil, false)
      if Rooted.Value == false then
      ...
      RootJoint.C0 = RootCF * euler(0, 0, 12 * i)
      ...
      if StunT.Value > Stun.Value then
        do
          ...
          if etheral == true and Marked ~= nil and Marked:findFirstChild("Torso") ~= nil and canetheral == true then
            EtheralSlash(Marked.Torso.CFrame * cf(math.random(-600, 600) / 100, math.random(-600, 600) / 100, math.random(-600, 600) / 100))
          end
          -- DECOMPILER ERROR at PC548: LeaveBlock: unexpected jumping out IF_THEN_STMT

          -- DECOMPILER ERROR at PC548: LeaveBlock: unexpected jumping out IF_STMT
    ...
    do
      ...
      for i = 1, 3 do
        ...
        for i = 0, 1, 0.2 do
          ...
          hitboxCF = lprt5.CFrame * cf(0, -1.5, 0)
          hitbox.CFrame = hitboxCF
          MagniDamage(hitbox, 6, 5, 10, math.random(5, 10), "Normal", RootPart, 0.25, 2, (math.random(2, 5)), nil, true, false, "Defense", 0.02, 100)
            ...
            do
              ...
              do
                do
                  ...
                  -- DECOMPILER ERROR at PC1117: LeaveBlock: unexpected jumping out DO_STMT
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 20 then
    ...
    do
      ...
      hitbox.CFrame = hitboxCF
      for i = 0, 1, 0.1 do
        if StunT.Value <= Stun.Value and Marked ~= nil then
          break
        end
        swait()
        hitboxCF = rprt5.CFrame * cf(0, -1.5, 0)
...
EtheralSlash = function(CF)
  ...
  MagicCircle(BrickColor.new("Really blue"), cf(ref.Position), 2, 2, 2, 0.1, 0.1, 0.1, 0.1)
  table.insert(Effects, {ref, "EthSlash", 20})
end
...
Damagefunc = function(hit, minim, maxim, knockback, Type, Property, Delay, KnockbackType, incstun, stagger, staghit, ranged, DecreaseState, DecreaseAmount, Duration)
  ...
  for _,v in pairs(hit.Parent:children()) do
    ...
    if blocked == true then
      ...
      if searslash == true then
        cooldowns[1] = cooldowns[1] + Damage * 2
      end
      if markstab == true then
        Marked = hit.Parent
        print(Marked)
        cooldowns[4] = cooldowns[4] + 50
        table.insert(Effects, {hit.Parent, "Marking", 300})
      end
...
ob1d = function(mouse)
  ...
  if combo == 0 then
    ...
    for i = 1, 3 do
      for i = 1, 2 do
        if EthCF ~= nil and canetheral == true and EthCF:findFirstChild("Torso") ~= nil then
          EtheralSlash(EthCF.Torso.CFrame * cf(math.random(-600, 600) / 100, math.random(-600, 600) / 100, math.random(-600, 600) / 100))
        end
      end
      swait(2)
    end
...
while 1 do
  swait()
  if Marked ~= nil and (Marked:findFirstChild("Torso")) ~= nil then
    parti5.Parent = Marked.Torso
    parti5.Enabled = true
  else
    parti5.Parent = Torso
  ...
  stunanim = false
          ...
          if Thing ~= nil then
            ...
            do
              do
                ...
                if Thing[2] == "Marking" then
                  if Marked ~= nil and (Marked:findFirstChild("Torso")) == nil then
                    Marked = nil
                    table.remove(Effects, e)
                  end
                  if markstab == true and Thing[3] <= 150 then
                    Marked = nil
                    table.remove(Effects, e)
                  end
                  if Marked ~= nil then
                    if (RootPart.Position - Marked.Torso.Position).magnitude <= 50 and Thing[3] % 10 == 0 then
                      canetheral = true
                      Lightning(RootPart.Position, Marked.Torso.Position, 5, 1, "Really blue", 0.05, 0.8, 0.1)
                    else
                      if 50 < (RootPart.Position - Marked.Torso.Position).magnitude then
                        canetheral = false
                      end
                    end
                  end
                ...
                if Thing[2] == "EthSlash" then
                  if 0 <= Thing[3] then
                    Thing[3] = Thing[3] - 1
                  else
                    so("200632992", Thing[1], 1, math.random(100, 130) / 100)
                    MagicCircle(BrickColor.new("Really blue"), cf(Thing[1].Position) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 0.1, 1, 0.1, 0.2, 12, 0.2, 0.1)
                    MagniDamage(Thing[1], 5, 4, 7, 0, "Normal", RootPart, 0.2, 1, 1, nil, nil, false)
                    table.remove(Effects, e)
                  end
                end
                if Thing[2] ~= "Shoot" and Thing[2] ~= "DecreaseStat" and Thing[2] ~= "Wave" and Thing[2] ~= "FireWave" and Thing[2] ~= "showDamage" and Thing[2] ~= "Blood" and Thing[2] ~= "Marking" and Thing[2] ~= "EthSlash" then
    ...
    -- DECOMPILER ERROR at PC8000: LeaveBlock: unexpected jumping out DO_STMT
