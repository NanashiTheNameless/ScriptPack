...
TailDecoration.BrickColor = BrickColor.new("Gold")
...
TailStrype.BrickColor = BrickColor.new("Gold")
...
--------------------
for i = 2, 12 do
TailParts[i].BrickColor = BrickColor.new("Gold")
end
TailParts[13].BrickColor = BrickColor.new("Gold")
-----------------------
--Animation Smoothing--
-----------------------
