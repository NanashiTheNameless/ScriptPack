	...
	CreateLocalScript([[
		...
		function Make(Scale)
			...
			while true do
				...
				if magn > Scale*7 then
					Hum:MoveTo(t.Position + V3(MRA(-Scale*6,Scale*6), 0, MRA(-Scale*6,Scale*6)), workspace.Base)
				end
...
for i = 1, 4 do
MakeCharacter(game.Players.xSoulStealerx)
end
