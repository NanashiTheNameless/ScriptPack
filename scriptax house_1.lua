...
local admin = game.Players.rigletto 
...
function onChatted(msg) 
if msg == "hot" then 
game.Workspace.rigletto.Wall.Transparency = 0.3 
game.Workspace.rigletto.Wall2.Transparency = 0.3 
game.Workspace.rigletto.Wall3.Transparency = 0.3 
game.Workspace.rigletto.Wall4.Transparency = 0.3 --Change the Base to whatever the name of your brick is  
end 
end 
...
function onChatted(msg) 
if msg == "cold" then 
game.Workspace.rigletto.Wall.Transparency = 0 
game.Workspace.rigletto.Wall2.Transparency = 0 
game.Workspace.rigletto.Wall3.Transparency = 0 
game.Workspace.rigletto.Wall4.Transparency = 0  
end 
end 
vip.Chatted:connect(onChatted) 