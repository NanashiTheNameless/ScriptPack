...
Player = game:GetService("Players").FIuffz
...
numb2=-0.4
for i=1,9 do
local Tprt3=part(3,suit,0,0,BrickColor.new("Bright red"),"Torso Part3",vt(1,1,1))
...
local Tprt10=part(3,suit,0,0,BrickColor.new("Bright red"),"Torso Part10",vt(1,1,1))
...
local Tprt12=part(3,suit,0,0,BrickColor.new("Bright red"),"Torso Part12",vt(1,1,1))
...
local LAprt2=part(3,suit,0,0,BrickColor.new("Bright red"),"Left Arm Part2",vt(1,1,1))
...
local RAprt2=part(3,suit,0,0,BrickColor.new("Bright red"),"Right Arm Part2",vt(1,1,1))
...
local LLprt2=part(3,suit,0,0,BrickColor.new("Bright red"),"Left Leg Part2",vt(1,1,1))
...
local LLprt5=part(3,suit,0,0,BrickColor.new("Bright red"),"Left Leg Part5",vt(1,1,1))
...
local RLprt2=part(3,suit,0,0,BrickColor.new("Bright red"),"Right Leg Part2",vt(1,1,1))
...
local RLprt5=part(3,suit,0,0,BrickColor.new("Bright red"),"Right Leg Part5",vt(1,1,1))
