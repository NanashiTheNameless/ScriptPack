...
Player = game:GetService("Players").hippiekid94
...
function findNearestTorso(pos)
	...
	for x = 1, #list do
		temp2 = list[x]
		if (temp2.className == "Model") and (temp2 ~= Character) and (temp2.Name ~= "hippiekid94") then
...
--	local main = Instance.new("Part")
	...
	while true do
		wait()
		if mode==1 then
			if workspace.hippiekid94.Torso then
