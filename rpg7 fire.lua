Player = game:GetService("Players"):FindFirstChild("olefson")
Name = "RPG-7i"
selected = false
canDual = false
dual = false
			...
			coroutine.wrap(function()
				while true do
					if Part.Parent:FindFirstChild("Humanoid") ~= nil then
						...
						if math.random(1, 25) == 1 then Part.Parent.Humanoid.Sit = true end
						if math.random(1, 25) == 1 then Part.Parent.Humanoid.Jump = true end
						Part.Parent.Humanoid:TakeDamage(0.1)
						delay(0.1, function() untagHumanoid(Part.Parent.Humanoid) end)
					end
					if math.random(1, 50) == 1 then Part:BreakJoints() end
					if math.random(1, 35) == 1 then Part.BrickColor = BrickColor.new("Really black") end
