...
Damage(hit.Parent, math.random(10,30), 0.5, BrickColor.new("Fossil"), BrickColor.new("Toothpaste"), "rbxassetid://199149137" ,1)
end)
for i = 0,1,0.1 do
wait()
...
local HitDeb = Hitbox.Touched:connect(function(hit)
Damage(hit.Parent, math.random(10,30), 0.5, BrickColor.new("Fossil"), BrickColor.new("Toothpaste"), "rbxassetid://199149186" ,1)
end)
for i = 0,1,0.1 do
wait()
...
local HitDeb = Hitbox.Touched:connect(function(hit)
Damage(hit.Parent, math.random(10,30), 0.1, BrickColor.new("Fossil"), BrickColor.new("Toothpaste"), "rbxassetid://199149221" ,1)
end)
for i = 1,4 do
CreateSound("http://roblox.com/asset/?id=199145327",Hitbox,.7,1)
for i = 0,1,0.2 do
wait()
				RJ.C0 = clerp(RJ.C0, RootCF * CFrame.new(0, -1.5, 0) * CFrame.Angles(math.rad(-.5), math.rad(0), math.rad(70)), .3)
				Ne.C0 = clerp(Ne.C0, NeckCF * CFrame.Angles(math.rad(5), math.rad(0), math.rad(-70)), .3)
...
function WaveEffect(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay)
	local prt = CreatePart("Custom", workspace, "Neon", 0, 0, brickcolor, "Effect", Vector3.new())
	prt.Anchored = true
	prt.CFrame = cframe
...
function SummonShards(Color)
attack=true
for i=0,1,0.1 do
wait()
				RJ.C0 = clerp(RJ.C0, RootCF * CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(-.5), math.rad(0), math.rad(80)), .3)
				Ne.C0 = clerp(Ne.C0, NeckCF * CFrame.Angles(math.rad(5), math.rad(0), math.rad(-80)), .3)
				RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(80)), .3)
				LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(-50)), .3)
				RH.C0 = clerp(RH.C0, CFrame.new(1, -1, .3) * RHCF * CFrame.Angles(math.rad(-5), math.rad(-60), math.rad(-.5)), .3)
				LH.C0 = clerp(LH.C0, CFrame.new(-.9, -1, -.2) * LHCF * CFrame.Angles(math.rad(-5), math.rad(-60), math.rad(-.5)), .3)
				FakeHandleweld.C0 = clerp(FakeHandleweld.C0, CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(0)), .8)
				BladeHandleweld.C0 = clerp(BladeHandleweld.C0, CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(0)), .3)
end
Hu.WalkSpeed = 0
for i=1,5 do
local Shard=CreatePart(3,m,"Neon",0,0.5,Color,"Shard",Vector3.new(5,5,5))
local smsh=CreateMesh("SpecialMesh",Shard,"FileMesh","http://www.roblox.com/Asset/?id=9756362",Vector3.new(0,0,0),Vector3.new(.5,.5,3))
Shard.Anchored=true
...
SphereEffect(Color,Shard.CFrame,5,5,10,1,1,3,.1)
...
SphereEffect(Color,CFrame.new(ref.Position),1,1,1,2,2,2,.05)
...
wait()
				...
				Ne.C0 = clerp(Ne.C0, NeckCF * CFrame.Angles(math.rad(.5), math.rad(0), math.rad(70)), .3)
				RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * CFrame.Angles(math.rad(0), math.rad(30), math.rad(90)), .3)
				LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * CFrame.Angles(math.rad(0), math.rad(-20), math.rad(-70)), .3)
				RH.C0 = clerp(RH.C0, CFrame.new(1, -1, 0) * RHCF * CFrame.Angles(math.rad(-5), math.rad(70), math.rad(-.5)), .3)
				LH.C0 = clerp(LH.C0, CFrame.new(-.9, -1, .2) * LHCF * CFrame.Angles(math.rad(-5), math.rad(70), math.rad(-.5)), .3)
				FakeHandleweld.C0 = clerp(FakeHandleweld.C0, CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(150), math.rad(0), math.rad(0)), .8)
				BladeHandleweld.C0 = clerp(BladeHandleweld.C0, CFrame.new(0, -.1, 0) * CFrame.Angles(0, math.rad(0), math.rad(0)), .3)
end
local HitDeb = Hitbox.Touched:connect(function(hit)
Damage(hit.Parent, math.random(10,30), 0, BrickColor.new("Fossil"), BrickColor.new("Toothpaste"), "rbxassetid://199149186" ,1)
end)
for i = 1,5 do
CreateSound("http://roblox.com/asset/?id=199145095",Hitbox,1,1.3)
for i = 0,1,0.2 do
wait()
SphereEffect(BrickColor.new("Toothpaste"),CFrame.new(BladeHandle.Position),.3,.3,.3,.2,.2,.2,.05)
				RJ.C0 = clerp(RJ.C0, RootCF * CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0), math.rad(0), math.rad(70)), .3)
				Ne.C0 = clerp(Ne.C0, NeckCF * CFrame.Angles(math.rad(.5), math.rad(0), math.rad(-70)), .3)
				RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0) * CFrame.Angles(math.rad(0), math.rad(30), math.rad(90)), .3)
				LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0) * CFrame.Angles(math.rad(0), math.rad(-20), math.rad(-30)), .3)
				RH.C0 = clerp(RH.C0, CFrame.new(1, -1, 0) * RHCF * CFrame.Angles(math.rad(-5), math.rad(-70), math.rad(-.5)), .3)
				LH.C0 = clerp(LH.C0, CFrame.new(-.9, -1, .2) * LHCF * CFrame.Angles(math.rad(-5), math.rad(-70), math.rad(-.5)), .3)
				FakeHandleweld.C0 = clerp(FakeHandleweld.C0, CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(90), math.rad(0), math.rad(0)), .3)
				BladeHandleweld.C0 = clerp(BladeHandleweld.C0, CFrame.new(0, 7, 0) * CFrame.Angles(6*i, math.rad(0), math.rad(0)), .8)
end
end
HitDeb:disconnect()
attack = false
