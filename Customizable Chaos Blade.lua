...
function Create_Moves_In_List()
	...
	move = Title:Clone() move.Parent = Moves move.Name = "A Move" move.Text = "ASDEA - Kogeki Sokudo Kojo" move.Position = Ud2(0, 0, ah, 0) move.TextXAlignment = "Left" ah = ah+am
	move = Title:Clone() move.Parent = Moves move.Name = "A Move" move.Text = "ASDDC - Awaken" move.Position = Ud2(0, 0, ah, 0) move.TextXAlignment = "Left" ah = ah+am 
...
function KeyStrokesAttacks()
	if InputTable[1] == "a" and InputTable[2] == "s" and InputTable[3] == "d" and InputTable[4] == "d" and InputTable[5] == "c" then
	...
	elseif InputTable[1] == "a" and InputTable[2] == "s" and InputTable[3] == "d" and InputTable[4] == "e" and InputTable[5] == "a" then
