--Made by w666bsharp
local p = game.Players:findFirstChild("SPEZ23") 
...
if string.find(msg, "push") and go == true then
go = false
...
game:GetService("Debris"):AddItem(fus, 15)
elseif string.find(msg, "fire") and go == true then
go = false
fus = Instance.new("Part")
fus.formFactor = "Custom"
fus.Size = Vector3.new(3, 3, 6)
...
elseif string.find(msg, "kirin") and skygo == true then
skygo = false
local clouds = {}
...
go = true
elseif string.find(msg, "blood") then
for i = 1, 30 do
...
elseif string.find(msg, "fear") and go == true then
go = false
fus = Instance.new("Part")
fus.formFactor = "Custom"
fus.Size = Vector3.new(1, 1, 4)
