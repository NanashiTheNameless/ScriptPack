...
B1=qi{'Part',Suit,sc=v3(0.2,BLen,BLenT),bn=bn'Really black',ref=0.15} qi{'BlockMesh',0,sca=v3(0.3,1,1)}
...
BB1=qi{'WedgePart',Suit,sc=v3(0.2,BLen2,BLenT),bn=bn'Really black',ref=0.15} qi{'SpecialMesh',0,MeshType='Wedge',sca=v3(0.3,1,1)}
...
local b1=qi{'Part',workspace,n='DarkWaveBall',sc=v3(1,1,1),bn=bn'Gold',tra=0.3,ref=0.1,cf=tcf,an=true} local b1m=qi{'SpecialMesh',0,MeshType='Sphere'}
local b2=b1:Clone() b2.Parent=b1 local b2m=b2.Mesh b2.BrickColor=bn'Really black' b2.Transparency=0 b2.CFrame=tcf
-----
local SBT={}
...
count=count+1 
if count%3==0 then 
Lightning(b1,Bl[2].Position,b1.Position,5,0.3,'Really black',0.15,1) 
Lightning(b1,Br[2].Position,b1.Position,5,0.3,'Really black',0.15,1) 
...
MeshEffect(b1,b1.CFrame*cn(mran(-15,15)/15,mran(-15,15)/15,2)*ca(90,mran(-360,360),0),21,27,21,0.15,'Gold',ids.Crown,cn(0,2,0)*ca(0,11,0)) 
MeshEffect(b1,b1.CFrame*cn(mran(-15,15),mran(-15,15),mran(-25,6))*ca(mran(-360,360),mran(-360,360),mran(-360,360)),mran(2,6),mran(2,4),mran(2,7),0.15,'Really black','Block') 
end end,Char,true)
local sca=Hit and Hit.Name=='DarkWaveBall' and Hit~=b1 and 3 or 1
MeshEffect(b1,b1.CFrame*ca(60,0,0),70*sca,70*sca,60*sca,0.05,'Really black',ids.Ring)
MeshEffect(b1,b1.CFrame*cn(0,-2,0),30*sca,5*sca,30*sca,0.05,'Really black',ids.Crown,ca(0,12,0))
if sca==3 then 
...
MeshEffect(pTorso,Torso.CFrame*ca(130,0,0),8,6,8,0.15,'Gold',ids.Crown)
...
for x=-1,1,2 do 
MeshEffect(pTorso,pTorso.CFrame*ca(45*x,0,0),10,15,15,0.2,'Really black',ids.Ring)
end
MeshEffect(pTorso,pTorso.CFrame,5,10,5,0.15,'Gold','Sphere')
if eff~=0 then MeshEffect(pTorso,pTorso.CFrame*cn(0,-3,0),10,4,10,0.15,'Gold',ids.Crown) end
end
telef()
Torso.CFrame=cf
