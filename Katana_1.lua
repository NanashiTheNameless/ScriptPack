...
Combo = 1
StartTrail(Tip)
pcall(function() Hitdmg=Hitbox.Touched:connect(function(hit) Damage(hit, 1000, hit.CFrame.p) end) end) 
Walk()
...
pcall(function() Hitdmg=Hitbox.Touched:connect(function(hit) Damage(hit, 1000, hit.CFrame.p,0)
