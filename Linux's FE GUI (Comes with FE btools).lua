...
local LinuxMenu = Instance.new("ScreenGui")
...
LinuxMenu.Name = "SnowyMenu"
LinuxMenu.Parent = game.CoreGui

Opener.Name = "Opener"
Opener.Parent = LinuxMenu
...
Open.MouseButton1Click:connect(function()
	game.CoreGui.LinuxMenu.Opener.Visible = false
	game.CoreGui.LinuxMenu.MainFrame.Visible = true
	game.CoreGui.LinuxMenu.Closer.Visible = true
end)

Close.MouseButton1Click:connect(function()
	game.CoreGui.LinuxMenu.Opener.Visible = true
	game.CoreGui.LinuxMenu.MainFrame.Visible = false
	game.CoreGui.LinuxMenu.Closer.Visible = false
end)
