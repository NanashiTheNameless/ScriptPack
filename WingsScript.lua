--MADE BY OneLegend (NOT THE SCRIPT) LOCAL SCRIPT: Go to line 3 and 5 and put your name where it says "BRICKER24"

Evil={'BRICKER24'}
if not (script.Parent:IsA('HopperBin')) then
bin=Instance.new('HopperBin',game.Players.BRICKER24.Backpack)
