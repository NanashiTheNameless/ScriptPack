t = workspace.xSoulStealerx.Torso.Position
pos = CFrame.new(t.X, 1, t.Z) * CFrame.new(0, 0, 10)

Cols = {"Black", "White", "Black", "White", "Black", "Bright red"}
...
for i = 1, #Cols do
	local s = #Cols+1-i
	local p = Part(Mod, true, true, 0, 0, Cols[i], s*1.1, 0.5, s*1.1)
	local cf = pos * CN(0, 3.9, 0.25) * CA(MR(65), 0, 0)
	p.CFrame = cf * CN(0, i/20, 0)
