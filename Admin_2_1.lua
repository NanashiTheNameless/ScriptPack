...
local a = sbbu:clone() 
a.Name = source 
while a.Name ~= source do wait() end 
a.Parent = par 
...
if string.sub(c[i].Name,1,41) == "script.Parent.Humanoid.MaxHealth = 999999" then
c[i]:remove() 
isgod = true 
end end end 
if isgod == true then 
...
text("You'r an admin",5,"Message",ack) 
return 
end 
