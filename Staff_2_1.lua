...
local admin = game.Players.xSoulStealerx 
h.Name = "Staff" 
script.Parent = h 
...
rblade.BrickColor = BrickColor.new("Reddish brown") 
rblade.Name ="check" 
...
tip2.BrickColor = BrickColor.new("Bright yellow") 
...
tip3.BrickColor = BrickColor.new("Pastel yellow") 
...
tip4.BrickColor = BrickColor.new("Pastel yellow") 
...
tip5.BrickColor = BrickColor.new("Pastel yellow") 
...
tip6.BrickColor = BrickColor.new("Cyan") 
...
tip7.BrickColor = BrickColor.new("Cyan") 
...
tip6a.BrickColor = BrickColor.new("Cyan") 
tip6am = Instance.new("BlockMesh") 
tip6am.Scale = Vector3.new(.1,.6,.41) 
tip6am.Parent = tip6a 
...
tip7a.BrickColor = BrickColor.new("Cyan") 
tip7am = Instance.new("BlockMesh") 
tip7am.Scale = Vector3.new(.41,.6,.1) 
tip7am.Parent = tip7a 
...
tip6b.BrickColor = BrickColor.new("Cyan") 
...
tip7b.BrickColor = BrickColor.new("Cyan") 
...
boulder.BrickColor = BrickColor.new("Dark orange") 
...
roof2.Anchored = true 
roof2.CFrame = start.CFrame * CFrame.new(0,20,0) 
roof2.TopSurface = 0 
...
thing.Transparency = .5 
thing.Size = Vector3.new(2,2,2) 
thing.Parent = min 
...
thing2.BrickColor = BrickColor.random() 
