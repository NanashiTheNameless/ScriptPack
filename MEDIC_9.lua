me = game.workspace.rigletto
me.Humanoid.WalkSpeed = 20
...
function up()
if down == false then
if debdown == true then
debdown = false
speak = {"I'm up and ready to go!","Feeling better..","Managed to live!","Oh yeah!!","Yus!"}
local colors = {"Blue","Blue","Blue"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
game.workspace.rigletto.Torso.crouch:remove()
game.workspace.rigletto.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.rigletto.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
end
end
end
function downed()
if down == true then
if debdown == false then
debdown = true
game.workspace.rigletto.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(1.3,-1.6,0)
game.workspace.rigletto.Torso["Right Hip"].C0 = CFrame.new(1,0,0)*CFrame.fromEulerAnglesXYZ(.7,1.6,0)
local sg = Instance.new("BodyPosition")
sg.maxForce = Vector3.new(104000,2004000, 1044000) 

                        sg.Name = "crouch"
                        sg.position = game.workspace.rigletto.Torso.Position + Vector3.new(0,-1.3,0)
                        sg.Parent = game.workspace.rigletto.Torso
speak = {"I'm down!","X_X","Sadly I can't heal my self..","Noo! I have a family that needs me! Don't shoot!","I..Can't..Feel..My..Faic..","My spine!!!","Last two words. : I'm screwed ._.","Spare me! D:"}
...
if knife == true then
        ...
        if h ~= nil then 
h.Health = h.Health - 13
h.Parent.Torso.Velocity = Vector3.new(math.random(-30,30),math.random(0,0),math.random(-30,30))
wait(0.4)
h.PlatformStand = false
end
end
end
game.workspace.rigletto.hit.Touched:connect(KillPlayer)
function knifes()
healing = true
knife = true
...
wait(1)
game.workspace.rigletto.bl:remove()
game.workspace.rigletto.bsz:remove()
knife = false
healing = false
game.workspace.rigletto.left:remove()
end
if attack == 2 then
me = game.workspace.rigletto
me.Humanoid.WalkSpeed = 60
...
weld2d6.Parent = me["left"] 
l = weld2d6
l.C0 = CFrame.new(-1.5,0,0)*CFrame.fromEulerAnglesXYZ(-0.3,0,-0.8)
wait(0.01)
l.C0 = CFrame.new(-1.5,0.3,0)*CFrame.fromEulerAnglesXYZ(0,0,-0.8)
wait(0.01)
l.C0 = CFrame.new(-1.5,0.5,0)*CFrame.fromEulerAnglesXYZ(0.3,0,-1.6)
wait(0.01)
l.C0 = CFrame.new(-1.5,0.5,-0.3)*CFrame.fromEulerAnglesXYZ(0.3,-0.3,-1.6)
wait(0.01)
l.C0 = CFrame.new(-1.5,0.5,-0.5)*CFrame.fromEulerAnglesXYZ(0.3,-0.5,-1.6)
game.workspace.rigletto.Humanoid.WalkSpeed = 16
wait(0.01)
l.C0 = CFrame.new(-1.3,0.5,-0.7)*CFrame.fromEulerAnglesXYZ(0.3,-0.7,-1.6)
wait(0.01)
l.C0 = CFrame.new(-1.3,0.5,-0.7)*CFrame.fromEulerAnglesXYZ(0.3,-1,-1.6)
wait(0.01)
l.C0 = CFrame.new(-1.2,0.5,-0.7)*CFrame.fromEulerAnglesXYZ(0.3,-1.8,-1.6)
wait(0.01)
wait(1)
game.workspace.rigletto.bl:remove()
game.workspace.rigletto.bsz:remove()
...
function healn()
la = game.workspace.rigletto.Torso["Left Shoulder"]
ra = game.workspace.rigletto.Torso["Right Shoulder"]
...
function revspeech()
speak = {"Don't leave me now! damn it!","Oh god.Hang in there!","CLEAR!! >:O","BREATHE MAN BREATHE!!","Whatever you do! DON'T GO TO THE LIGHT!"}
local colors = {"Red","Red","Red"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
...
if life ~= nil then
dis = (game.workspace.rigletto.Torso.Position - mouse.Hit.p).magnitude
if dis<7 then
...
man.Torso.CFrame = game.workspace.rigletto.d.CFrame + Vector3.new(0,0,0)
...
sg.maxForce = Vector3.new(104000,2004000, 1044000) 
                        ...
                        sg.position = game.workspace.rigletto.Torso.Position + Vector3.new(0,-1.3,0)
                        sg.Parent = game.workspace.rigletto.Torso
game.workspace.rigletto.Torso["Left Hip"].C0 = CFrame.new(-1,-1,-1)*CFrame.fromEulerAnglesXYZ(-1.3,-1.6,0)
game.workspace.rigletto.Torso["Right Hip"].C0 = CFrame.new(1,0,-0.8)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
me = game.workspace.rigletto
...
game.workspace.rigletto.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.rigletto.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.rigletto.Torso["Right Shoulder"].C0 = CFrame.new(1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.rigletto.Torso["Left Shoulder"].C0 = CFrame.new(-1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.rigletto.bottem:remove()
game.workspace.rigletto.botle:remove()
game.workspace.rigletto.botle:remove()
game.workspace.rigletto.botle:remove()
lg:remove()
sg:remove()
...
game.workspace.rigletto.d:remove()
...
man.Humanoid.WalkSpeed = 16
game.workspace.rigletto.Humanoid.WalkSpeed = 16
game.workspace.rigletto.fib:remove()
game.workspace.rigletto.fib:remove()
game.workspace.rigletto.fib:remove()
game.workspace.rigletto.fib:remove()
game.workspace.rigletto.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
...
belt1.BottomSurface = 0 
m6 = Instance.new("SpecialMesh") 
m6.Scale = Vector3.new(2,0.7,1.3)
m6.MeshType = "Brick" 
m6.Parent = belt1 
weld6 = Instance.new("Weld") 
weld6.Part0 = me["Torso"] 
...
weld6.Parent = me["Left Leg"] 
belt1.Reflectance = 0
weld6.C0 = CFrame.new(0,math.random(-0.2,0.2),0)*CFrame.fromEulerAnglesXYZ(math.random(0,0),0,math.random(-1,1))
wait(0)
end
if choose == 6 then
me = man
...
local mypos = game.workspace.rigletto.Torso.Position + Vector3.new(0,0,0) 
local magn = (mypos - mousepos).magnitude/-2.2
local offset = (mypos.y - mousepos.y)/1.5
offset = offset/magn 
if lookaround == true then
game.workspace.rigletto.Torso.Neck.C0 =  CFrame.new(0,1,0)*CFrame.fromEulerAnglesXYZ(math.pi/2 ,math.pi,offset) 
else
game.workspace.rigletto.Torso.Neck.C0 =  CFrame.new(0,1,0)*CFrame.fromEulerAnglesXYZ(math.pi/2,math.pi,0) 
end

if game.workspace.rigletto.Humanoid.Health<30 then
down = true
downed()
else
down = false
...
wait(0.1)
game.workspace.ch405.Torso.Velocity = Vector3.new(math.random(-40,40),math.random(40,60),math.random(-40,40))
speak = {"Look out!!","ARGh!","Missed me!","Ninja medic!","Cant touch dis.","Matrix >:O","Take cover!!!","Too fast for ya?","Dodging D:","EEK?","Of course. Attack the medic -_-",">:O"}
colors = {"Red","Red","Red"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
wait(0.4)
...
if key == "e" then
if knife == false then
speak = {"Quick attack!","Sneak attack!","pwned?","Up you go!","Hmhmhahaha!","Argh!Die!","Ha!","Gimmi the spleen! :D","Die! >:D","I'm armed foo!","Take this!","Shanked!"}
...
if speak == false then
speak = true
speak = {"Attack? Yes sir! :D","Co-op","Let's roll!","Ready!","Move out!"}
colors = {"Green","Green","Green"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
wait(2)
speak = false
...
lookaround = true
speak = {"I'ma look around the place.","I wonder whats here.","Enjoyin the view!"}
colors = {"Blue","Blue","Blue"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )

else
speak = {"Enough site seeing!","Back to exploring","Well it was a nice break."}
colors = {"Blue","Blue","Blue"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.rigletto.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
...
mouse.Move:connect(function() Aim(mouse) end)
