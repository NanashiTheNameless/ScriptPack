--NSword Gifted by Rosemarijohn2, Local Script!
...
local shirtColor = "White"
local pantsColor = "White"
local attachColor = "White"
local sheathColor = "White"
local swordHandleColor = "White"
local gunColor = "White"
...
function JoinInit()
        ...
        part.ftor.BrickColor = BrickColor.new("White")
...
function LoadSuit()
        ...
        if not suited then
                ...
                CreatePart(prt, "sheath_4", "White", 0, 0.3,Vector3.new(0.2,0.6,0.2),CFrame.new(0,1.3,0.1),CFrame.Angles(0,0,math.rad(27)),false,false,"Brick",true,prt.sheath_1.part)
                ...
                CreatePart(prt, "sheath_6", "White", 0, 0.3,Vector3.new(0.2,0.6,0.2),CFrame.new(0,0.9,0.1),CFrame.Angles(0,0,math.rad(27)),false,false,"Brick",true,prt.sheath_1.part)
                ...
                CreatePart(prt, "gunbullet", "White", 0, 0, Vector3.new(0.325,0.2,0.325), CFrame.new(0,0,-0.42), CFrame.Angles(math.rad(90),0,0),false,false, "Cylinder",true,prt.gun_7.part)
                ...
                CreatePart(prt, "sword_4", "White", 0, 0, Vector3.new(0.9,0.3,0.55), CFrame.new(0,-0.4,0), CFrame.Angles(0,0,0),false, false,"Brick",true,prt.sword_1.part)
...
function LightingGen(init,target,ran,delay,size,damage)
        local CL = function()
                ...
                lght.BrickColor = BrickColor.new("White")
