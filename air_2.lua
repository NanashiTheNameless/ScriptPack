...
XAdminsAdmin = "Cobalt1164"-----------put your name here and only here
...
{ID = "http://www.roblox.com/Asset/?id=133517131",PITCH = 1,NAME = "swordland or whatevr u call it"};
{ID = "http://www.roblox.com/Asset/?id=155183751",PITCH = 1,NAME = "crossing field(umad)"};
{ID = "http://www.roblox.com/Asset/?id=155319906",PITCH = 1,NAME = "other favorite"};
{ID = "http://www.roblox.com/Asset/?id=155104467",PITCH = 1,NAME = "my favorite"};
...
{ID = "http://www.roblox.com/Asset/?id=149811427",PITCH = 1,NAME = "MMM Yeah Yeah <3"};
};
};
ExplorerServices = {
...
tab.Anchored = true
tab.BrickColor = BrickColor.new("Really pink")
...
DismissAll()
wait()
Output("Are you sure you want to do this?","",nil)
...
Output("hey boi|have a good time using this|kthxbyenow", "http://www.roblox.com/Thumbs/Avatar.ashx?x=100&y=100&Format=Png&username=Cobalt1164", function() DismissAll() end)
...
--[[Added a new rotation(Still working on it but its mostly done also tell me if you like the new one c; if not I'll make a differnt one)--]]
--[[UbrHaxrOGMHaxr is a part of this script now he helped with the rotation alot.)--]]
--[[Added differnt music--]]