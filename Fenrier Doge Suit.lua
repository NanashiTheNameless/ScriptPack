...
Player = game:GetService("Players").XTheShowcaserX
...
--[[HOOD]]--
local Hprt1=part(3,suit,0,0,BrickColor.new("Bright orange"),"Hood",vt(1,1,1))
Hmsh1=mesh("SpecialMesh",Hprt1,"FileMesh","http://www.roblox.com/asset/?id=151778863",vt(0,0,0),vt(1,1,1))
--Hmsh1.TextureId="http://www.roblox.com/asset/?id=151778895"
...
numb2=-0.4
for i=1,9 do
local Tprt3=part(3,suit,0,0,BrickColor.new("Bright orange"),"Torso Part3",vt(1,1,1))
...
local Tprt4=part(3,suit,0,0,BrickColor.new("Bright orange"),"Torso Part4",vt(1,1,1))
...
local Tprt10=part(3,suit,0,0,BrickColor.new("Bright orange"),"Torso Part10",vt(1,1,1))
Tmsh10=mesh("BlockMesh",Tprt10,"","",vt(0,0,0),vt(0.2,0.8,0.1))
local Twld10=weld(Tprt10,Tprt10,Tprt7,euler(0,0,0)*cf(0.2,0.2,0.01))
numb=0.3
for i=1,4 do
local Tprt11=part(3,suit,0,0,BrickColor.new("Bright orange"),"Torso Part11",vt(1,1,1))
...
local Tprt12=part(3,suit,0,0,BrickColor.new("Bright orange"),"Torso Part12",vt(1,1,1))
Tmsh12=mesh("BlockMesh",Tprt12,"","",vt(0,0,0),vt(0.2,0.8,0.1))
local Twld12=weld(Tprt12,Tprt12,Tprt5,euler(0,0,0)*cf(-0.2,0.2,0.01))
numb=0.3
for i=1,4 do
local Tprt13=part(3,suit,0,0,BrickColor.new("White"),"Torso Part13",vt(1,1,1))
...
local Tprt23=part(3,suit,0,0,BrickColor.new("Really black"),"Torso Part23",vt(1,1,1))
...
local LLprt3=part(3,suit,0,0,BrickColor.new("Bright orange"),"Left Leg Part3",vt(1,1,1))
LLmsh3=mesh("BlockMesh",LLprt3,"","",vt(0,0,0),vt(1.02,0.1,1.02))
local LLwld3=weld(LLprt3,LLprt3,LLprt1,euler(0,0,0)*cf(0,-0.75,0))
local LLprt4=part(3,suit,0,0,BrickColor.new("Bright orange"),"Left Leg Part4",vt(1,1,1))
...
local RLprt3=part(3,suit,0,0,BrickColor.new("White"),"Right Leg Part3",vt(1,1,1))
RLmsh3=mesh("BlockMesh",RLprt3,"","",vt(0,0,0),vt(1.02,0.1,1.02))
local RLwld3=weld(RLprt3,RLprt3,RLprt1,euler(0,0,0)*cf(0,-0.75,0))
local RLprt4=part(3,suit,0,0,BrickColor.new("White"),"Right Leg Part4",vt(1,1,1))
