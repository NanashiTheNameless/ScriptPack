...
swait()
if num==8 then
ShootRocket(5,10,math.random(50,300))
num=0
end
...
Damagefunc(head,15,30,math.random(20,40),"Knockdown",fireball,.2,1)
end
end
end
end
...
if n==5 then
MagicRing(BrickColor.new("Really red"),Part.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),10,10,10,0.5,0.5,0.5,0.01,1)
n=0
end
n=n+1
end
...
for i=0,1,0.1 do
swait()
MagicBlock(BrickColor.new("Bright red"),cf(TehPos),1,1,1,2,2,2,0.05,1)
end
end),pos)
end
end
end),rockt)
hit,pos=rayCast(Head.Position,Head.CFrame.lookVector,1000,modelzorz)
if Targetting==false then
