...
pcall(function()Player.Backpack["MoonRise Blades"]:Destroy()end)
Hb = Instance.new("HopperBin",Player.Backpack)Hb.Name = "MoonRise Blades"
...
----------------Sword 1--------------------------
local Color1 = "Really black" local Color2 = "Really black" local BladeC = "Navy blue"
...
----------------Sword 2--------------------------
Color1 = "Really black" local Color2 = "Really black" BladeC = "Navy blue"
...
Hb.Selected:connect(function(Mouse)
        ...
        Mouse.KeyDown:connect(function(Key)
                ...
                elseif Key == "e" then
                        ...
                        local p = part(Main,v3(.1,3,.5),"Navy blue",0,false)w(p,Handle2,p,true,cf(0,1+1.5,-.15))
                        local p = part(Main,v3(.1,3,.1),"Navy blue",0,false)w(p,Handle2,p,true,cf(0,1+1.5,.3))
                ...
                elseif Key == "r" and Attacking == false then
                        ...
                        cw(function()
                                wait(.1)
                                B1 = makeBall("Really black",v3(2.5,2.5,2.5),3,.5)
