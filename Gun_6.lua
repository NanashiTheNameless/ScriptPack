...
Player = script:FindFirstChild("Player") ~= nil and script.Player.Value or game:GetService("Players"):FindFirstChild("yfc") --Change my name to your name for the wep to work in SB.
...
--lego
game.Workspace.yfc.Humanoid.MaxHealth = math.huge  -----Replace CyberFromLU with your name, it gives you INF health, enjoy. C:
print(lego)