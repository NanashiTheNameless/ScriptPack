...
hed.face:Destroy()
local glowz = Instance.new("Fire",torso)
glowz.Size = 15
glowz.Heat = 0
local glowz = Instance.new("Fire",torso)
glowz.Size = 15
...
ss.Looped = true
ss.Pitch = 1
ss.SoundId = "rbxassetid://336633750"
ss:Play()
...
spawn(function() --_RHas
	...
	ef3.Material = "Sand"
	ef4.Material = "Sand"
	ef3.Parent,ef4.Parent=larm,rarm
	ef2.Parent=lleg
	local wa,wb=Instance.new('Weld',larm),Instance.new('Weld',larm)
	local wc,wd=Instance.new('Weld',rarm),Instance.new('Weld',rarm)
	wa.Part0,wb.Part0=larm,rarm
	wa.Part1,wb.Part1=ef1,ef2
	wc.Part0,wd.Part0=larm,rarm
	...
	while wait(0) do
		...
		ef1.BrickColor=BrickColor.new("Dark red")
		ef3.BrickColor=BrickColor.new("Dark red")
		ef4.BrickColor=BrickColor.new("Dark red")
		ef2.BrickColor=BrickColor.new("Dark red")
	end
end)
spawn(function() --_RHas
...
spawn(function() --_RHas
	local ef1=Instance.new('Part',hed)
	local am=Instance.new('BlockMesh',ef1)
	ef1.Anchored,ef1.CanCollide=false,false
	ef1.Transparency=0.7
	ef1.Material = "Sand"
	am.Scale=Vector3.new(40,40,40)
	ef1.Size=Vector3.new(.2,.2,.2)
	local ef2=ef1:Clone()
	local ef3=ef2:Clone()
	local ef4=ef3:Clone()
	...
	ef3.Material = "Neon"
	ef4.Material = "Neon"
	ef3.Parent,ef4.Parent=hed,hed
	ef2.Parent=lleg
	local wa,wb=Instance.new('Weld',hed),Instance.new('Weld',hed)
	local wc,wd=Instance.new('Weld',hed),Instance.new('Weld',hed)
	wa.Part0,wb.Part0=hed,hed
	wa.Part1,wb.Part1=ef1,ef2
	wc.Part0,wd.Part0=hed,hed
	wc.Part1,wd.Part1=ef3,ef4
	wa.C0,wb.C0=CFrame.new(0,-2,0),CFrame.new(0,-3,0)
	wc.C0,wd.C0=CFrame.new(0,-2,0),CFrame.new(0,-3,0)
	while wait(0) do
		wa.C0,wb.C0=wa.C0*CFrame.Angles(math.rad(math.random(-20,20)),math.rad(math.random(-20,20)),math.rad(math.random(-20,20))),wb.C0*CFrame.Angles(math.rad(math.random(-20,20)),math.rad(math.random(-20,20)),math.rad(math.random(-20,20)))
		wc.C0,wd.C0=wc.C0*CFrame.Angles(math.rad(math.random(-20,20)),math.rad(math.random(-20,20)),math.rad(math.random(-20,20))),wd.C0*CFrame.Angles(math.rad(math.random(-20,20)),math.rad(math.random(-20,20)),math.rad(math.random(-20,20)))
		ef1.BrickColor=BrickColor.new("Dark red")
...
HBar.BackgroundColor3 = Color3.new(1, 0, 0)
...
pr.BrickColor = BrickColor.new("Dark red")
pr.Material = "Neon"
pr.Reflectance = 0
pr.Anchored = false
pr.CanCollide = false
...
spawn(function() --_RHas
	local ef1=Instance.new('Part',part1)
	local am=Instance.new('BlockMesh',ef1)
	ef1.Anchored,ef1.CanCollide=false,false
	ef1.Transparency=0.3
	ef1.Material = "Sand"
	am.Scale=Vector3.new(0.1,0.1,0.1)
	ef1.Size=Vector3.new(0.1)
	local ef2=ef1:Clone()
	local ef3=ef2:Clone()
	local ef4=ef3:Clone()
	ef2.Material = "Sand"
	ef3.Material = "Sand"
	ef4.Material = "Sand"
	ef3.Parent,ef4.Parent=part1,part1
	ef2.Parent=part1
	local wa,wb=Instance.new('Weld',part1),Instance.new('Weld',part1)
	local wc,wd=Instance.new('Weld',part1),Instance.new('Weld',part1)
	wa.Part0,wb.Part0=part1,part1
	wa.Part1,wb.Part1=ef1,ef2
	wc.Part0,wd.Part0=part1,part1
	wc.Part1,wd.Part1=ef3,ef4
	wa.C0,wb.C0=CFrame.new(0,-1,0),CFrame.new(0,-1,0)
	wc.C0,wd.C0=CFrame.new(0,-1,0),CFrame.new(0,-1,0)
	while wait(0) do
        ...
        Spawn(function()
            ...
            for Y = 1,1 do
                ...
                local Emitter = Instance.new("ParticleEmitter", P)
  				...
  				Emitter.Size = NumberSequence.new(20)
  				...
  				Emitter.VelocitySpread = 360
                local i = (Y+5)/(10)
                i = 0-math.cos(math.pi*i-(math.pi/10))
                P.CFrame = char.HumanoidRootPart.CFrame*CFrame.new(0,Y,-15+(i*5))*CFrame.Angles(math.rad(Y*1),0,math.rad(180))
        ...
        elseif ht and hit:IsA("Hat") then
            ...
            for i = 1,100 do
                for i2,v in pairs(Parts) do
                    ...
                    local cf = v.CFrame
                    v.Size = v.Size+Vector3.new(0.1,0.1,10)
                    v.CFrame = cf
                    ...
                    if v.Name == "0" then
                        ...
                        local ray = Ray.new(v.Position+Vector3.new(0,20,0),Vector3.new(0,-500,0))
                        local Hit,Pos,SurfaceNorm = Workspace:FindPartOnRayWithIgnoreList(ray,Ignore)
                        if Hit ~= nil then
                            if #Rocks == 1 then
                                for i = 1,5 do
                                    ...
                                    P.TopSurface = "Smooth"
                                    P.BottomSurface = "Smooth"
                                    P.Size = Vector3.new(3,3,3)*(math.random(500,900)/100)
                                end
                            end
...
rs:connect(function()
	...
	if Debounces.NoIdl == false then
		if animpose == "Idle" then
			change = 0.2
			rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5,0.62+0.1*math.cos(sine/10),0)*CFrame.Angles(math.rad(0),math.rad(40),math.rad(20+10*math.cos(sine/10))), 0.4)
			larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.5,0.62+0.1*math.cos(sine/10),0)*CFrame.Angles(math.rad(20),math.rad(0),math.rad(-40-20*math.cos(sine/10))), 0.4)
			...
			lleg.Weld.C0 = Lerp(lleg.Weld.C0, CFrame.new(-0.5, 0-0.1*math.cos(sine/10), -0.55) * CFrame.Angles(math.rad(-10+1*math.cos(sine/10)), math.rad(30), math.rad(-10-2*math.cos(sine/10))), 0.4)
			...
			if animpose == "Walking" then
				change = 0.5
				rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5, 0.5 + 0.05 * math.cos(sine / -4), -math.sin(sine / -4) / -4) * CFrame.Angles(math.sin(sine / -4) / -2.8, -math.sin(sine / -4) / -3, math.rad(5 - -7 * math.cos(sine / -2)) + root.RotVelocity.Y / -15), 0.4)
				...
				if animpose == "Running" then
					...
					larm.Weld.C0 = Lerp(larm.Weld.C0, CFrame.new(-1.24 + 0.6 * math.cos(sine / 4) / 1.4, 0.54, 0 - 0.8 * math.cos(sine / 4)) * CFrame.Angles(math.rad(6 + 140 * math.cos(sine / 4) / 1.2), math.rad(90), math.rad(20 + 70 * math.cos(sine / 4))), 0.2)
					...
					if animpose == "Jumping" then
						...
						lleg.Weld.C1 = Lerp(lleg.Weld.C1, CFrame.new(0, 1, 0) * CFrame.Angles(math.rad(0), math.rad(30), math.rad(0)), 0.4)
