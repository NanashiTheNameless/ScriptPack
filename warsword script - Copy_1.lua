...
while game.Players.luxulux.PlayerGui:FindFirstChild("luxulux's Sword") == nil do
wait()
if game.Players.luxulux.PlayerGui:FindFirstChild("luxulux's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.luxulux.PlayerGui
screengui.Name = "luxulux's Sword"
...
bl = game.Players.luxulux.Backpack
