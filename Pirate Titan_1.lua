...
pants.Name = "Pants"
char.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=320604115"
char.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=320604107"
----------------------------------------------------
Debounces = {
on = false;
ks = false;
...
----------------------------------------------------
game:service'InsertService':LoadAsset(1028859):children()[1].Parent=char
char.PirateHat.Handle.Mesh.Scale = char.PirateHat.Handle.Mesh.Scale * 2.5
char.PirateHat.Handle.Mesh.VertexColor = Vector3.new(1,1,1)
...
z.SoundId = "rbxassetid://150575966 "--242463565
z.Looped = true
z.Pitch = 1
z.Volume = 10
wait(.01)
...
p4.BrickColor = BrickColor.new("Bright Orange")
...
p5.BrickColor = BrickColor.new("Bright Orange")
...
p7.BrickColor = BrickColor.new("Bright Orange")
...
p8.BrickColor = BrickColor.new("Bright Orange")
...
p18.BrickColor = BrickColor.new("Bright Orange")
p18.FormFactor = Enum.FormFactor.Symmetric
