...
colors={"Really black","Really red"}
...
local ball2=part(1,nil,0,0.5,BrickColor.new("Really red"),"DarkBall",vt(2,2,2))
 
local bmesh2=mesh("SpecialMesh",ball2,"Sphere","",vt(0,0,0),vt(1,0.8,1))
 
local bweld2=weld(ball2,ball2,nil,cf(0,0,0))
 
local bigsword=part(1,workspace,0,0,BrickColor.new("Really red"),"Sword",vt(70,500,20))
 
bigsword.Parent=nil
 
local sword1=part(1,workspace,0,0.5,BrickColor.new("Really red"),"Sword",vt(2,2,2))
 
sword1.Parent=nil
 
local sword2=part(1,workspace,0,0.5,BrickColor.new("Really red"),"Sword",vt(2,2,2))
...
han = pa(su,"","Block",0.4,0.4,0.4,false,false,1,0,"Really red") it('CylinderMesh',han)
...
han3 = pa(su,"","Block",0,0,0,false,false,0,0,"Really red") qi({"SpecialMesh",han3,MeshType="Sphere",Scale=v3(0.4,0.4,0.4)*5})
...
clawb1 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Really red") qi({"SpecialMesh",clawb1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike})
 
clawb1w = qi({"Weld",han2,Part0=clawa1,Part1=clawb1,C0=cn(0,0.15,0)})
 
clawb2 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Really red") qi({"SpecialMesh",clawb2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike})
...
ef = pa(su,"","Block",0,0,0,false,true,1,0,"Really red") qi({"SpecialMesh",ef,MeshType="FileMesh",Scale=v3(7,7,4),MeshId=Decs.Chakram2})
...
chak2 = pa(su,"","Block",0,0,0,false,false,0.1,0.1,"Really red") qi({"SpecialMesh",chak2,Scale=v3(0.15,0.15,0.05)*5,MeshType="FileMesh",MeshId=Decs.Chakram2}) 
...
GroundEffect(bla2,1,0.1,1,0,1,0,0,0,0,BrickColor.new("Really red")) 
...
MMMAGIC(TargetTors,5,5,5,0,0,0,BrickColor.new("Really red")) 
...
MMMAGIC(TargetTors,3,3,3,0,0,0,BrickColor.new("Really red")) 
...
local d=part(1,workspace,0,0,BrickColor.new("Really red"),"Poot",vt(1,1,1))
...
Lightning(ball.Position,ball.Position+Vector3.new(math.random(-4,4),math.random(-4,4),math.random(-4,4)),3,5,"Really red",0.3,0.1)
 
MMMAGIC(RightArm,1,1,1,0,-1,0,BrickColor.new("Really red")) 
...
MMMAGIC(hit2,5,5,5,0,0,0,BrickColor.new("Really red"))
...
Lightning(ball.Position,hit2.Position,5,2,"Really red",0.3,0.1)
...
Lightning(ball.Position,pos+Vector3.new(math.random(-10,10),math.random(-10,10),math.random(-10,10)),5,math.random(1,10),"Really red",0.3,0.1)
...
MMMAGIC(RightArm,3,3,3,math.random(-3,3),math.random(-5,1),math.random(-3,3),BrickColor.new("Really red")) 
...
MMMAGIC(Torso,3,3,3,math.random(-3,3),math.random(-1,5),math.random(-3,3),BrickColor.new("Really red")) 
...
MMMAGIC(Torso,2,2,2,math.random(-7,7),math.random(-7,7),math.random(-7,7),BrickColor.new("Really red")) 
...
MMMAGIC(Torso,9,9,9,0,0,0,BrickColor.new("Really red")) 
...
con1=sword1.Touched:connect(function(hit) Damagefunc1(hit,10,10) if hit.Parent:findFirstChild("Humanoid")~= nil and hitted==false then hitted=true comboee=hit.Parent MMMAGIC(hit,2,2,2,0,0,0,BrickColor.new("Really red")) end end) 
 
con2=sword2.Touched:connect(function(hit) Damagefunc1(hit,10,10) if hit.Parent:findFirstChild("Humanoid")~= nil and hitted==false then hitted=true comboee=hit.Parent MMMAGIC(hit,2,2,2,0,0,0,BrickColor.new("Really red")) end end) 
...
local sword=part(1,workspace,0,0.5,BrickColor.new("Really red"),"Sword",vt(3,3,3))
...
GroundEffect(sword,3,3,3,0,0,0,0,0,0,BrickColor.new("Really red")) 
...
GroundEffect(sword,1,1,1,0,0,0,0,0,0,BrickColor.new("Really red")) 
...
MMMAGIC(effectsg,5,5,5,0,0,0,BrickColor.new("Really red")) 
...
local sword=part(1,modelzorz,0,0.5,BrickColor.new("Really red"),"Sword",vt(3,3,3))
