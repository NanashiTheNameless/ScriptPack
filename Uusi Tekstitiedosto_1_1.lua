...
h.Name = "JetPack!" 
h.Parent = game.Players["xSoulStealerx"].Backpack 
script.Parent = h 
...
Person.Character.Engine.BodyVelocity.maxForce = Vector3.new(10000, 10000, 10000) 
...
Position = Position + 1 * 3 * Direction 
error = Position - Person.Character.Engine.Position 
Person.Character.Engine.BodyVelocity.velocity = 1 * error 
wait() 
end 
BodyP.position = Engine.Position 
Person.Character.Engine.BodyPosition.maxForce = Vector3.new(1e+050, 1e+050, 1e+050) 
...
Bomb.Size = Vector3.new(2, 4, 2) 
Bomb.TopSurface = 0 
Bomb.BottomSurface = 0 
Bomb.BrickColor = BrickColor.new("Black") 
Bomb.CFrame = CFrame.new(Person.Character:findFirstChild("Left Arm").Position + Vector3.new(20, -10, -20))
...
M.Parent = game.Players.xSoulStealerx.PlayerGui 
local K = Instance.new("Frame") 
K.Parent = M 
K.Position = UDim2.new(0,5,0,200) 
K.Size = UDim2.new(0,250,0,90) 
...
t.Text = "Size:  "  
x2 = math.ceil(mouse.Hit.p.X) 
y2 = math.ceil(mouse.Hit.p.Y) 
z2 = math.ceil(mouse.Hit.p.Z) 
local vc = Instance.new("TextLabel")
vc.Parent = M 
vc.Position = UDim2.new(0,110,0,270) 
vc.Size = UDim2.new(0,40,0,10) 
...
BodyP.Parent = Engine 
BodyP.position = Engine.Position + Vector3.new(0, 2, 0) 
BodyP.maxForce = Vector3.new(2e+050, 2e+050, 2e+050) 
