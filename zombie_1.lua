...
local was = Instance.new("Weld") 
was.Parent = game.Players.acb227.Character.Torso 
was.Part1 = game.Players.acb227.Character.Torso
...
was.Part0 = game.Players[hit.Parent.Name].Character.Torso 
was.C0 = CFrame.new(0,-2,-2) * CFrame.fromEulerAnglesXYZ(0, 3, 0) 
wait(5) 
was.Part0 = nil 
