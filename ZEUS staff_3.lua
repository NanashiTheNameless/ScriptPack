...
Tip2.BrickColor = BrickColor.new("Really red")
        ...
        for i,v in pairs(Obj:GetChildren()) do
                if v:IsA("BasePart") and (v.Position-Base.Position).Magnitude <= Dis then
                        if v.Name ~= "Base" and v.Parent ~= Char and v.Parent.Parent ~= Char and v ~= Base then
                                v.BrickColor = BrickColor.new("Really Really red")
                                v.Anchored = false
                                v:BreakJoints()
...
function KeyDown(Key)
        if Key:lower() == "q" and not DB then
                ...
                if Activated == false then
                        ...
                        for i = Bolt.Size.Y,5,0.1 do
                                ...
                                TW2.C1 = CFrame.new(0,-(i/2+0.175+(Mesh2.Scale.Y-0.5)/2.75),0) * CFrame.Angles(0,0,math.rad(180))
                                TW2.Parent = Tip2
                                local Color = Vector3.new(BrickColor.new("Really red").r,BrickColor.new("Really red").g,BrickColor.new("Really red").b):lerp(Vector3.new(BrickColor.new(MainColor).r,BrickColor.new(MainColor).g,BrickColor.new(MainColor).b),i/5)
                        ...
                        for i = Bolt.Size.Y,2,-0.1 do
                                ...
                                TW2.C1 = CFrame.new(0,-(i/2+0.175+(Mesh2.Scale.Y-0.5)/2.75),0) * CFrame.Angles(0,0,math.rad(180))
                                TW2.Parent = Tip2
                                local Color = Vector3.new(BrickColor.new(MainColor).r,BrickColor.new(MainColor).g,BrickColor.new(MainColor).b):lerp(Vector3.new(BrickColor.new("Really red").r,BrickColor.new("Really red").g,BrickColor.new("Really red").b),(2/i))
                                Bolt.Color = Color3.new(Color.X,Color.Y,Color.Z)
                                Tip.Color = Bolt.Color
                                Tip2.Color = Bolt.Color
                        end
        ...
        elseif Key:lower() == "e" and Activated and not DB then
                ...
                LightningEffectOn = false
                for i = 0,1,0.15 do
                        local Color = Vector3.new(BrickColor.new(MainColor).r,BrickColor.new(MainColor).g,BrickColor.new(MainColor).b):lerp(Vector3.new(BrickColor.new("Really red").r,BrickColor.new("Really red").g,BrickColor.new("Really red").b),(i/1))
                        Bolt.Color = Color3.new(Color.X,Color.Y,Color.Z)
                        Tip.Color = Bolt.Color
                        Tip2.Color = Bolt.Color
                        wait(0.0001)
                ...
                for i = 0,1,0.15 do
                        local Color = Vector3.new(BrickColor.new("Really red").r,BrickColor.new("Really red").g,BrickColor.new("Really red").b):lerp(Vector3.new(BrickColor.new(MainColor).r,BrickColor.new(MainColor).g,BrickColor.new(MainColor).b),i/1)
                        Bolt.Color = Color3.new(Color.X,Color.Y,Color.Z)
                        Tip.Color = Bolt.Color
                        Tip2.Color = Bolt.Color
                        wait(0.0001)
