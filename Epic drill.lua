                                                                                                                                                                                                     plyr = game:GetService("Players").LocalPlayer --password
...
createPart(Vector3.new(1,1,1),"Really red",mod) 
RightDrill = Part 
                ...
                if debounce == false then debounce = true 
                        ...
                        elseif string.byte(key) == 116 then 
                                if (plyr.Character.Torso.Position-mouse.Hit.p).magnitude < 2000 then 
                                        ...
                                        createPart(Vector3.new(1,1,1),"Really red",workspace) 
                                        Partz = Part 
                                        Partz.Name = "Line" 
                                        Partz.Anchored = true 
