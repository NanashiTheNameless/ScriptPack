...
statid = 66598281
startupid  = 66598295
texts     = {"Made by ic3w0lf589.","Check out ic3w0lf589's profile!","ic3w0lf589 Admin Commands.","I am programmed to say random things.","Don't ask for this script because you will be banned!","I'm trapped in a cage!","Scripts are disabled in this server!","The brick is a lie.","GO ic3w0lf589!!"}
...
priServ = off
scriptid = 64305985
priServList = {"TheUltiScripter","The6Scripter","absurdskinnyjackb","dakotakim","lewiswd","ThePC8110","trogdor343","simecody","RobloxNewb01","jacoslide101","LandenRox2","Bob444732","mackan44","polo1716"} 
banlist = {{"blackcopper","GoldRoyal"}}
adminlist = {"ic3w0lf589","polo1716","moxy367","dakotakim","lewiswd","ThePC8110","trogdor343","simecody","RobloxNewb01","jacoslide101","LandenRox2","Bob444732","mackan44","McJaggerxD","samsonson300"}
commands = {"ic3w0lf589","polo1716","unragdoll","ban","kick","kill","lag","admin", "respawn","base","tele","clean","clone","shutdown","m","ab","unff","ff","cmds","time","invisible","visible","punish","unpunish","s","prion","prioff","add","insert","install","jk","bbon","bboff","delete","deletec","disable","enable","unban","unab","whisper","banlist","adminlist","blockx", "blocky", "blockz","sym","symrem--","speedkill","tbon","tboff", "size","scriptsoff","scriptson","orb","resetlighting","scr","overide","loopkill","sink","walkspeed","check","maxplayers","status","worb","quicksand","tree","rain","trees","block","fat","control", "pancake", "skybase","nuke","fly","music","stop","killorbs","makeblock","bomb","opendoor","closedoor","spawncage","killscripts","fix","plat","cave","staff","newteam","changeteam","house","block","bc","nbc","tbc","obc","removeteam","fire","cape","ghost","norb","name"} 
ablist   = {"ic3w0lf589","polo1716","lewiswd","ThePC8110","trogdor343","simecody","RobloxNewb01","jacoslide101","LandenRox2","Bob444732","McJaggerxD"}
blocked = {}
guitext    = {"This server belongs to ic3w0lf589!", "Say cmds/ for commands if you are admin", "Server rules:","No anti-bans.","No orbs of any kind.","No admin scripts.","No server takeovers.","Admins do not have to follow these set rules.","This script is not for sale!","If you ask for the script you will be banned!","blackcopper is an abuser that copy scripts from absurdskinnjackb!","If you should see him in a server, please feel free to ban him.","We are accepting members..","We currently have "..#adminlist.." admins!","Last Updated: 03/12/11"}
function findp(name) 
