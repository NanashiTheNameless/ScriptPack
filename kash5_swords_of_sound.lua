...
game:GetService("Chat"):Chat(Workspace.kash5.Head,"Behold.. the swords of Sound")
wait(2)
game:GetService("Chat"):Chat(Workspace.kash5.Head,"Fear me...")
wait(1)
...
Weld.Part0 = game.Workspace.kash5["Right Arm"]
Weld.Part1 = Handle
Weld.C1 = CFrame.new(0, .75, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)

D = Instance.new("Part",Workspace.kash5)
D.TopSurface = "Smooth"
...
L = Instance.new("Part",Workspace.kash5)
L.TopSurface = "Smooth"
...
P = Instance.new("Part",Workspace.kash5)
P.TopSurface = "Smooth"
...
Blade = Instance.new("Part",Workspace.kash5)
...
Point = Instance.new("Part",Workspace.kash5)
...
Ring = Instance.new("Part",Workspace.kash5)
...
Handle2 = Instance.new("Part",Workspace.kash5)
...
Weld = Instance.new("Weld",Workspace.kash5)
Weld.Part0 = game.Workspace.kash5["Left Arm"]
Weld.Part1 = Handle2
Weld.C1 = CFrame.new(0, .75, 0)*CFrame.fromEulerAnglesXYZ(0, 0, 0)

d2 = Instance.new("Part",Workspace.kash5)
...
L2 = Instance.new("Part",Workspace.kash5)
...
P2 = Instance.new("Part",Workspace.kash5)
...
Blade2 = Instance.new("Part",Workspace.kash5)
...
Point2 = Instance.new("Part",Workspace.kash5)
...
Ring2 = Instance.new("Part",Workspace.kash5)
