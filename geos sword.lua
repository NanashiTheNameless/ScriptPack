while game.Players.bnmpoi.PlayerGui:FindFirstChild("Geo's Sword") == nil do
wait()
if game.Players.bnmpoi.PlayerGui:FindFirstChild("Geo's Sword") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.bnmpoi.PlayerGui
screengui.Name = "Geo's Sword"
...
bl = game.Players.bnmpoi.Backpack
me = game.Players.bnmpoi
char = me.Character
...
local fakeHandle = Part(Mo, false, false, 0, 0, "Bright green", 0.3, 2.8, 0.3, true)
...
local bladeEdge = Part(Mo, false, false, 0, 0.6, "Bright green", 0.02, 8.5, 0.5, true)
Weld(bladeEdge, handle, 0, 3.6, 0, 0, 0, 0)
Add.Mesh(bladeEdge, "http://www.roblox.com/asset/?id=1033714", 0.02, 8.5, 0.5)

local bladeGem = Part(Mo, false, false, 0, 0.6, "Bright green", .3, .6, .3, true)
...
function showdmg(dmg, p, pos)
        ...
        mo.Name = dmg
        local pa = Part(mo, false, true, 0, 0, "Bright green", 0.8, 0.3, 0.8, true)
