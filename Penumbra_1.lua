...
local handle = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle",vt(1,1,1))
local handle1 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle1",vt(1,1,1))
local handle2 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle2",vt(1,1,1))
local handle3 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle3",vt(1,1,1))
local handle4 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle4",vt(1,1,1))
local handle5 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle5",vt(1,1,1))
local handle7 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle7",vt(1,1,1))
local handle8 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle8",vt(1,1,1))
local handle9 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle9",vt(1,1,1))
local handle10 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle10",vt(1,1,1))
local handle11 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle11",vt(1,1,1))
local handle12 = part(1,modelzorz,0.25,0,BrickColor.new("Gold"),"PHandle12",vt(1,1,1))
local handle13 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle13",vt(1,1,1))
local handle14 = part(1,modelzorz,0.25,0,BrickColor.new("Gold"),"PHandle14",vt(1,1,1))
local handle15 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle15",vt(1,1,1))
local handle16 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle16",vt(1,1,1))
local handle17 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle17",vt(1,1,1))
local handle18 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle18",vt(1,1,1))
local handle19 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle19",vt(1,1,1))
local handle20 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle20",vt(1,1,1))
local handle21 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle21",vt(2,2.4,1))
local handle22 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle22",vt(2,2.4,1))
local handle23 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle23",vt(2,2.4,1))
local handle24 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle24",vt(1,1,1))
local handle25 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle25",vt(1,1,1))
local handle26 = part(1,modelzorz,0,1,BrickColor.new("Gold"),"PHandle26",vt(1,1,1))
local handle27 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle27",vt(0.2,0.2,1.76))
local handle28 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle28",vt(0.2,0.2,1.76))
local handle29 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle29",vt(0.2,0.2,1.76))
local handle30 = part(1,modelzorz,0,0,BrickColor.new("Gold"),"PHandle30",vt(0.2,0.2,1.76))
local handle31 = part(1,modelzorz,0,0,BrickColor.new("Really black"),"PHandle31",vt(1,1,1))
local handle32 = part(1,modelzorz,0.25,0.5,BrickColor.new("Gold"),"PHandle32",vt(1,1,1))
local handle33 = part(1,modelzorz,0,0.5,BrickColor.new("Gold"),"PHandle33",vt(1,1,1))
local handle34 = part(1,modelzorz,0,0.5,BrickColor.new("Gold"),"PHandle34",vt(1,1,1))
local Spar=it("Sparkles")
Spar.Parent=handle32
Spar.Enabled=false
Spar.SparkleColor=Color3.new(255, 255, 127)
...
elseif type==2 then
Sayings={"Come at me, bro.","Show me what you got.","Come on, i'm getting bored.","No nubs.","Go away.","Stop being such a Butternub..."}
game:GetService("Chat"):Chat(Character,Sayings[math.random(1,#Sayings)],2)
end
end
...
for i=1,30 do
wait()
ChargeEffect(handle34,2,2,2,math.random(-10,10),math.random(-10,10),math.random(-10,10),0,0,0,BrickColor.new("Gold")) 
end
wait(0.2)
...
derpsparkles.SparkleColor=Color3.new(255, 255, 127)
...
derpsmoke.Color=Color3.new(189, 189, 0)
...
local SlashSound = it("Sound") 
SlashSound.SoundId = "http://www.roblox.com/asset/?id=131200904" 
SlashSound.Parent = Head
--game:service'Lighting'["Lolsound"].Value=SlashSound
SlashSound.Volume = 1 
SlashSound.Pitch = pitch 
...
local SlashSound = it("Sound") 
SlashSound.SoundId = "http://www.roblox.com/asset/?id=137976315" 
SlashSound.Parent = Head
--game:service'Lighting'["Lolsound"].Value=SlashSound
SlashSound.Volume = 1
SlashSound.Pitch =  1
...
local SlashSound = it("Sound") 
SlashSound.SoundId = "http://www.roblox.com/asset/?id=97848255" 
SlashSound.Parent = Head
--game:service'Lighting'["Lolsound"].Value=SlashSound
SlashSound.Volume = 1 
SlashSound.Pitch = 1 
...
--[[                        Knockback=Knockback*2
                ...
                h:TakeDamage(Damage) 
                showDamage(hit.Parent,Damage,300) 
                vl=it("BodyVelocity")
                vl.P=4500
...
--[[                        Knockback=Knockback*2
                ...
                h:TakeDamage(Damage) 
                showDamage(hit.Parent,Damage,250) 
                vl=it("BodyVelocity")
                vl.P=4500
                vl.maxForce=vt(math.huge,math.huge,math.huge)
...
--[[                        Knockback=Knockback*2
                ...
                h:TakeDamage(Damage) 
                showDamage(hit.Parent,Damage,440) 
                vl=it("BodyVelocity")
                vl.P=4500
                vl.maxForce=vt(math.huge,math.huge,math.huge)
...
Damagefunc1=function(hit,Damage,Knockback)
        ...
        CPlayer=Bin 
        h=hit.Parent:FindFirstChild("Humanoid")
        if h~=nil and hit.Parent.Name~="luxulux" and hit.Parent:FindFirstChild("Torso")~=nil then
                Damage=Damage
...
--[[                        Knockback=Knockback*2
                ...
                Damage=Damage+math.random(0,250)
...
--        CPlayer=Bin 
        ...
        attackdebounce = false 
                ...
                EVENMOARMAGIX3(Part,size,size,size,0,0,0,0,0,0,BrickColor.new("Gold")) 
                for i=0,5 do
                MMMAGIC3(Part,0.3,size*2,0.3,0,0,0,BrickColor.new("Gold")) 
                end
                Damage=Damage
--[[                if game.Players:GetPlayerFromCharacter(hit.Parent)~=nil then
                        return
...
--                Blood(hit.CFrame*cf(math.random(-10,10)/10,math.random(-10,10)/10,0),math.floor(Damage/2))
                h:TakeDamage(Damage)
                showDamage(hit.Parent,Damage,900)
                vp=it("BodyVelocity")
                vp.P=500
                vp.maxForce=vt(math.huge,0,math.huge)
--                vp.velocity=Character.Torso.CFrame.lookVector*Knockback
...
wait(0.5) 
bewm(workspace,3) 
MMMAGIC(Torso,3,3,3,0,0,0,BrickColor.new("Really black")) 
MMMAGIC(Torso,6,6,6,0,0,0,BrickColor.new("Gold")) 
        for _,v in pairs(Torso.Parent:children()) do
                if v.className=="Part" then
                v.Transparency=0
                elseif v.className=="Hat" then
...
las.BrickColor=BrickColor.new("Gold") 
las.Size=vt(1,1,1) 
...
bewm(1.2) 
bewm(0.8) 
MMMAGIC(hit,10,10,10,0,0,0,BrickColor.new("Really black")) 
EVENMOARMAGIX(hit,10,10,10,0,0,0,0,0,0,BrickColor.new("Really black")) 
BlastEffect(hit,15,10,15,0,0,0,-1.57,0,0,BrickColor.new("Really black")) 
for i=1,10 do
ChargeEffect2(hit,3,3,3,0,0,0,0,0,0,BrickColor.new("Really black")) 
end
...
range2 = 100
rangepower = 10]]
if Player.userId ~= 3996133 and game:findFirstChild("PootisValue") == nil then print("The lord's weapon is not a toy.") Character.Humanoid.Health=Character.Humanoid.Health-20 return end 
...
until rangepos <= 0
EVENMOARMAGIX2(cf(newpos),2,2,2,0,0,0,0,0,0,BrickColor.new("Gold")) 
if hit2 ~= nil then
local effectsmsh = it("SpecialMesh")
...
if Player.userId ~= 3996133 and game:findFirstChild("PootisValue") == nil then print("The lord's weapon is not a toy.") Character.Humanoid.Health=0 return end 
Aim()
end
end 
