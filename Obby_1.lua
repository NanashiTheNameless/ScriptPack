...
Obelisk = function()
  ...
  if #Obelisks < maxobelisks then
    ...
    if hitfloor ~= nil and mana.Value >= 10 then
      ...
      MagniDamage(oprt1, 20, 0, 0, math.random(-15, -10), "Knockdown2", RootPart, 0, 1, (math.random(3, 4)), nil, nil, true, "Defense", 0.03, 300)
            ...
            do
              do
                if hit ~= nil then
                  ...
                  Col = hit.BrickColor
                  MagicWave(Col, cf(pos), 1, 1, 1, 1.5 * d, 1, 1.5 * d, 0.1)
                    ...
                    do
                      do
                        if hit2 ~= nil then
                          ...
                          groundpart.CFrame = cf(pos2) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50))
    ...
    do
      ...
      for i = 1, 5 do
        ...
        if hitfloor ~= nil and mana.Value >= 5 then
          ...
          MagicBlock(BrickColor.new(NewCol2), cf(oprt1.Position) * cf(0, 1, 0) * euler(math.random(-50, 50), math.random(-50, 50), math.random(-50, 50)), 1, 1, 1, 4, 4, 4, 0.05, 2)
          MagniDamage(oprt1, 20, 0, 0, math.random(10, 20), "Knockdown2", oprt1, 0, 1, (math.random(5, 8)), nil, nil, true, "Defense", 0.02, 300)
          table.insert(Effects, {obe, "Obelisk", 0, 0, oprt1, 0, #Obelisks})
        end
      end
      swait(10)
                ...
                if Thing[2] == "Obelisk" then
                  if Thing[6] <= 400 and Thing[1].Parent ~= nil then
                    ...
                    if 100 <= Thing[4] then
                      ...
                      MagniDamage(Thing[5], 20, 2, 2, 0, "Normal", Thing[5], 0, 1, 1, nil, nil, true)
