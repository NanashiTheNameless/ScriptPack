...
sn = table.concat({"Bat","tt","l","e","Power"})
...
Decs.Sword1 = "rbxasset://fonts/sword.mesh" 
Decs.EF1 = "64467174" 
...
wait() end
if glo then GlowMesh(false,"Sphere",t,v3(glo,glo,glo),'Bright red',cn(bpos),0.1,1,0.08) end
...
local cor = db1:Clone() cor.Mesh.Scale=v3(sc,sc,sc)*5 local cor2 = db2:Clone() cor2.Mesh.Scale = cor.Mesh.Scale*1.55 qi({"Fire",cor,Color=bc('Bright red').Color,SecondaryColor=bc('Bright red').Color,Size=sc*3.5,Heat=0})
...
local lolpos = FindGround(cor.CFrame) if lolpos and i%rn(2,3)==0 then GlowMesh(false,Decs.Crown,t,v3(2.6*sc,0.8*sc,2.6*sc),'Bright red',cn(lolpos.p+v3(0,0.15*sc,0)),0.1,1,0.05)  end
...
fism.Scale = fism.Scale+v3(1*sc,1*sc,1*sc) fis.CFrame = pos*cn(0,5*sc,-5*sc)*ca(rd(45),0,0)*ca(rd(-90),rd(-90),0) rip.CFrame=pos*ca(rd(45),0,0) qi({"Fire",fis,Heat=-25,Size=15,Color=bc('Bright red').Color,SecondaryColor=bc('Bright red').Color})
...
wait(tyms) tpos = tor.Position local torm = tor.Mesh.Scale tor:Remove() GlowMesh(false,Decs.Tornado,t,torm*3,'Bright red',cn(tpos),0.2,1,0.05) 
end) end
...
swor.CFrame = hol.CFrame*cn(0,i-1,0)*ca(rd(90),0,0) GlowMesh(false,Decs.Crown,t,v3(5,10,5),'Bright red',swor.CFrame*ca(rd(-90),0,0),0.1,1,0.1)
...
for i=0,7.5,2.5 do GlowMesh(false,Decs.Ring,t,v3(85-i,85-i,60-i),'Bright red',hol.CFrame*cn(0,3,0)*ca(rd(-90),0,0),0.1,1,0.05) wait(0.1) end
...
GlowMesh(false,"Sphere",t,v3(12,12,12),'Bright red',v.CFrame,0.1,1,0.1)
...
wait(rn(23,30))
for i,v in pairs({{"Bright red",v3(30,30,30)},{"Really black",v3(20,20,20)}}) do  GlowMesh(false,"Sphere",t,v[2],v[1],bl.CFrame,0.1,1,0.1) end
...
c1(raw,spd,3,1,0.5,0,0,0,-80) c2(raw,spd,3,1,0.4,0,0,0,-140)  for i=1,5 do SpawnSword(FindGround(to.CFrame*cn(0,-2.75,-0.5+(-i*8)-i)),1+(i/10),15,"Bright red") wait(0.06) end 
...
caw = true q(function() wait(1) WormDrill(cn(tpos),rn(25,30)/10) end) c1(law,spd,3,-1.5,0.25,0,0,0,180) q(function() local to = pa(su,"","Block",1.5,1.5,1.5,false,true,0.1,0,"Bright red") qi({"SpecialMesh",to,MeshType="Sphere"}) for i=1,15,1 do to.Size=v3(1.5,i*2,1.5) to.CFrame=la.CFrame*cn(0,-2+(-i),0) wait() end GlowMesh(false,"Sphere",t,v3(35,35,35),'Bright red',la.CFrame*cn(0,-32,0),0.1,1,0.1)  fade(to,0.1)  end)
...
c2(raw,spd,3,1,0.5,-0.5,-70,-25,0) c2(law,spd,3,-1,0.5,-0.5,-70,25,0)  c1(tw,spd,3,0,0,0,30,0,0) wait(0.2) GlowMesh(false,"Sphere",t,v3(9,15,12),'Bright red',to.CFrame,0.1,1,0.05) CrownSwords(to.CFrame*cn(0,-2.5,-3)) to.CFrame = to.CFrame*cn(0,0,30) GlowMesh(false,"Sphere",t,v3(9,15,12),'Bright red',to.CFrame,0.1,1,0.05)
...
c2(raw,spd*1.4,3,1,0.5,-0.5,-45,-25,0) c1(law,spd*1.4,3,-1,0.5,-0.5,-45,25,0) GlowMesh(false,"Sphere",t,v3(15,1,15),'Bright red',to.CFrame*cn(0,-2.8,-5.5),0.1,1,0.03)
...
if ty%6==0 then GlowMesh(false,Decs.Crown,t,v3(3,6,3),'Bright red',to.CFrame*cn(0,0,3)*ca(rd(90),0,0),0.1,1,0.05) end
end) ws(16)
...
hu.Jump=false GlowMesh(false,"Sphere",t,v3(8,2,8),'Bright red',to.CFrame*cn(0,-4,0),0.1,1,0.05)
else GlowMesh(false,"Sphere",t,v3(8,10,2),'Bright red',to.CFrame,0.1,1,0.05)
GlowMesh(false,Decs.Crown,t,v3(5,3,5),'Bright red',to.CFrame*cn(0,0,1)*ca(rd(90),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,0,-12) GlowMesh(false,"Sphere",t,v3(8,10,2),'Bright red',to.CFrame*cn(0,0,1),0.1,1,0.05) end
pla.CFrame= to.CFrame*cn(0,-3.4,0) local orpos = pla.Position repeat wait(0.5) GlowMesh(false,"Sphere",t,v3(14,1,14),'Bright red',cn(orpos)*cn(0,0.5,0),0.1,1,0.02) until pla.Position~=orpos or (pla.Position-to.Position).magnitude>10
