local owners = {"XboxLive1239"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"frank2108"} -- Sets admins who can use ban/kick/admin or shutdown
