...
Reset()
bannedlist = {"YesJoey100", "YesAnthony"}
...
hats = {39247498,62692030,77443491,80661504,83704165,73829193,69499437,77443704,61459718,73232803}
for i = 1, #hats do
