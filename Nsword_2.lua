...
function LoadSuit()
    ...
    if not suited then
        ...
        CreatePart(prt, "torso_4", "White", 0, 1, Vector3.new(0.3,0.2,0.3), CFrame.new(0.6,0,-0.45), CFrame.Angles(math.rad(90),0,0),false,false, "Cylinder",false,prt.torso_3.part)
        ...
        CreatePart(prt, "sheath_3", "Royal purple", 0, 0,Vector3.new(0.25,0.6,0.2),CFrame.new(0,1.8,0.05),CFrame.Angles(0,0,0),false,false,"Diamond",true,prt.sheath_1.part)
        ...
        CreatePart(prt, "sheath_11", "White", 0, 1,Vector3.new(0.25,0.425,0.25),CFrame.new(0,0.085,0),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_9.part)
        CreatePart(prt, "sheath_12", "White", 0, 1,Vector3.new(0.25,0.425,0.25),CFrame.new(0,0.085,0),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_10.part)
        CreatePart(prt, "sheath_13", "White", 0, 1,Vector3.new(0.2,0.7,0.2),CFrame.new(0,0,0),CFrame.Angles(math.rad(-145),0,0),false,false,"Brick",true,prt.sheath_2.part)
         CreatePart(prt, "sheath_14", "White", 0, 1,Vector3.new(0.2,1.11,0.2),CFrame.new(0.072,-0.025,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        ...
        CreatePart(prt, "gunsheath_2", "White", 0, 1, Vector3.new(0.3,0.2,0.3), CFrame.new(0.1,0.2,-0.225), CFrame.Angles(0,0,0),false,false, "Brick",true,prt.gunsheath_1.part)
        CreatePart(prt, "gunsheath_3", "White", 0, 1, Vector3.new(0.3,0.2,0.3), CFrame.new(0,-0.1,0), CFrame.Angles(0,0,0),false,false, "Brick",true,prt.gunsheath_2.part)
        CreatePart(prt, "gunsheath_4", "White", 0, 1, Vector3.new(0.3,0.2,0.3), CFrame.new(0,-0.1,0), CFrame.Angles(0,0,0),false, false,"Brick",true,prt.gunsheath_3.part)
        ...
        CreatePart(prt, "gun_4", "White", 0, 1, Vector3.new(0.3,0.4,0.55), CFrame.new(0,0,-0.3), CFrame.Angles(0,0,0),false, false,"Brick",true,prt.gun_3.part)
        ...
        CreatePart(prt, "gunbullet", "Medium grey", 0, 0, Vector3.new(0.325,0.2,0.325), CFrame.new(0,0,-0.42), CFrame.Angles(math.rad(90),0,0),false,false, "Cylinder",true,prt.gun_7.part)
        CreatePart(prt, "gunpointer", "Medium grey", 0, 0, Vector3.new(0.275,0.2,0.275), CFrame.new(0,-0.065,-0.39), CFrame.Angles(math.rad(90),0,0),false,false, "Cylinder",true,prt.gun_2.part)
        CreatePart(prt, "nairod7_1", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-2,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_2", "White", 0, 1,Vector3.new(0.2,0.45,0.2),CFrame.new(0,-1.93,0.1),CFrame.Angles(0,0,math.rad(130)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_3", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.86,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_4", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.74,0.1),CFrame.Angles(0,0,math.rad(60)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_5", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.66,0.1),CFrame.Angles(0,0,math.rad(110)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_6", "White", 0, 1,Vector3.new(0.2,0.275,0.2),CFrame.new(0.025,-1.7,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_7", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.54,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_8", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.44,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_9", "White", 0, 1,Vector3.new(0.2,0.34,0.2),CFrame.new(-0.072,-1.37,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_10", "White", 0, 1,Vector3.new(0.2,0.2,0.2),CFrame.new(-0.05,-1.332,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_11", "White", 0, 1,Vector3.new(0.2,0.34,0.2),CFrame.new(-0.01,-1.37,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_12", "White", 0, 1,Vector3.new(0.2,0.36,0.2),CFrame.new(0.035,-1.3825,0.1),CFrame.Angles(0,0,math.rad(145)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_13", "White", 0, 1,Vector3.new(0.2,0.36,0.2),CFrame.new(-0.072,-1.19,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_14", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.24,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_15", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.12,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_16", "White", 0, 1,Vector3.new(0.2,0.36,0.2),CFrame.new(0.072,-1.19,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_17", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-1.02,0.1),CFrame.Angles(0,0,math.rad(90)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_18", "White", 0, 1,Vector3.new(0.2,0.39,0.2),CFrame.new(-0.0375,-0.96,0.1),CFrame.Angles(0,0,math.rad(145)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_19", "White", 0, 1,Vector3.new(0.2,0.39,0.2),CFrame.new(0.0375,-0.96,0.1),CFrame.Angles(0,0,math.rad(35)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_20", "White", 0, 1,Vector3.new(0.2,0.36,0.2),CFrame.new(-0.072,-0.78,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_21", "White", 0, 1,Vector3.new(0.2,0.43,0.2),CFrame.new(0,-0.77,0.1),CFrame.Angles(0,0,math.rad(60)),false,false,"Brick",true,prt.sheath_1.part)
        CreatePart(prt, "nairod7_22", "White", 0, 1,Vector3.new(0.2,0.2,0.2),CFrame.new(0.072,-2.12,0.1),CFrame.Angles(0,0,0),false,false,"Brick",true,prt.sheath_1.part)
        ...
        CreatePart(prt, "sword_2", "White", 0, 0, Vector3.new(0.5,2.135,0.25), CFrame.new(0,-2.68,0), CFrame.Angles(0,0,0),false,false, "Brick",true,prt.sword_1.part)
        CreatePart(prt, "sword_3", "White", 0, 0, Vector3.new(0.25,0.55,0.5), CFrame.new(0,-5.1,0), CFrame.Angles(0,math.rad(90),math.rad(180)),false,false,"Wedge",true,prt.sword_1.part)
        ...
        CreatePart(prt, "sword_5", "White", 1, 0, Vector3.new(1.8,4.4,0.2), CFrame.new(0.7,0,0), CFrame.Angles(0,0,0),false, false,"Brick",false,prt.sword_2.part)
    ...
    if trail then
        coroutine.wrap(function()
            ...
            while use and trail and _prt.sword_3.part ~= nil do wait(.02)
                ...
                trl.BrickColor = BrickColor.new("White")
