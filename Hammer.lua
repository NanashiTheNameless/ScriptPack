while game.Players.Geomaster.PlayerGui:FindFirstChild("Riazzer Hammer") == nil do
wait()
if game.Players.Geomaster.PlayerGui:FindFirstChild("Riazzer Hammer") == nil then
local screengui = Instance.new("ScreenGui")
screengui.Parent = game.Players.Geomaster.PlayerGui
screengui.Name = "Riazzer Hammer"

local textbutton = Instance.new("TextButton")
textbutton.Parent = screengui
textbutton.Position = UDim2.new(0,606,0,15)
textbutton.Size = UDim2.new(0,70,0,25)
textbutton.Text = "Hammer"
