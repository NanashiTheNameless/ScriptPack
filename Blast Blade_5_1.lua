...
local prt3=part(3,modelzorz,0,0,BrickColor.new("Really black"),"Part3",vt(0.8,0.5,0.8))
...
local prt7=part(3,modelzorz,0,0,BrickColor.new("Navy blue"),"Part7",vt(1,1,1))
local prt8=part(3,modelzorz,0,0,BrickColor.new("Navy blue"),"Part8",vt(1,1,1))
local hitbox=part(3,modelzorz,0,1,BrickColor.new("Navy blue"),"Hitbox",vt(1,5,3))
...
numb=0
for i=1,8 do
local prt4=part(3,modelzorz,0.2,0,BrickColor.new("Really black"),"Part4",vt(1,1,1))
...
numb=0
for i=1,4 do
local prt9=part(3,modelzorz,0,0,BrickColor.new("Navy blue"),"Part9",vt(1,1,1))
...
Lightning(LP,point1,5,1,"Navy blue",0.3,0.1)
end
...
MagicCircle(BrickColor.new("Navy blue"),CFrame.new(newpos),2,2,2,3,3,3)
MagicBlock(BrickColor.new("Navy blue"),CFrame.new(newpos),2,2,2,2,2,2)
end
until rangepos <= 0
end))
end
...
--ADmg(hum,hit)
        ...
        BreakEffect(BrickColor.new("Navy blue"),CFrame.new(newpos),0.5,math.random(5,20),0.5)
        end
...
Damagefuncbr=function(hit,Damage,Knockback)
        ...
        Damage=Damage
        for i=1,math.random(3,6) do
        BreakEffect(BrickColor.new("Navy blue"),hit.Parent.Torso.CFrame,0.5,math.random(5,20),0.5)
        end
        coroutine.resume(coroutine.create(function(Part) 
        for i=1,5 do
        wait()
        Part.CFrame=Head.CFrame*cf(0,0,-3)
        MagicBlock(BrickColor.new("Navy blue"),Part.CFrame*cf(0,0,0),1,1,1,1,1,1)
        end
...
for i=1,25 do
wait()
MagicCircle(BrickColor.new("Navy blue"),prt7.CFrame*euler(math.random(-50,50),math.random(-50,50),math.random(-50,50)),0.1,2,0.1,0.5,5,0.5)
end
for i=0,1,0.2 do
wait()
...
MagicCircle(BrickColor.new("Navy blue"),prt7.CFrame*cf(0,1,0),1,1,1,10,10,10)
MagicBlock(BrickColor.new("Really black"),prt7.CFrame*cf(0,1,0),1,1,1,5,5,5)
MagicBlock(BrickColor.new("Navy blue"),prt7.CFrame*cf(0,1,0),1,1,1,7,7,7)
...
for i=0,1,0.1 do
wait()
MagicBlock(BrickColor.new("Really black"),hitbox.CFrame*cf(math.random()+math.random(-1,0),math.random()+math.random(-2,1),math.random()+math.random(-1,0)),1,1,1,0.5,0.5,0.5)
...
for i=0,10 do
wait()
MagicBlock(BrickColor.new("Really black"),hitbox.CFrame,1,1,1,2,2,2)
end
...
local baseprt=part(3,workspace,0,1,BrickColor.new("Navy blue"),"Part1",vt(1,1,1))
...
MagicBlock(BrickColor.new("Navy blue"),BaseCF,0.5,0.5,0.5,2,2,2)
BlastEffect(BrickColor.new("Navy blue"),BaseCF,0.5,0.5,0.5,0.5,0.5,0.5)
numb=numb-3
wait(0.2)
end
end))
...
MagicCircle(BrickColor.new("Navy blue"),prt7.CFrame,1,1,1,2,2,2)
for i=1,10 do
wait(0.1)
MagicBlock(BrickColor.new("Navy blue"),prt7.CFrame*cf(math.random(-1,1),math.random(-1,1),math.random(-1,1)),0,0,0,0.5,0.5,0.5)
end
wait(0.5)
so("http://www.roblox.com/asset/?id=2974249",prt7,1,0.6) 
so("http://www.roblox.com/asset?id=1369158",prt7,1,2) 
shoottrail2(mouse,prt7)
MagicCircle(BrickColor.new("Navy blue"),prt7.CFrame,1,1,1,3,3,3)
attack=false
end
...
so("http://www.roblox.com/asset/?id=2101137",prt7,1,0.75) 
MagicCircle(BrickColor.new("Navy blue"),prt7.CFrame,1,1,1,2,2,2)
local ring=part(3,modelzorz,0,1,BrickColor.new("Navy blue"),"Ring",vt(1,1,1))
...
MagicBlock(BrickColor.new("Navy blue"),Part.CFrame*cf(0,1,0),0,0,0,0.5,0.5,0.5)
end
...
if attack == true then return end 
if key=="f" then
BreakEffect(BrickColor.new("Navy blue"),Torso.CFrame,0.5,math.random(5,20),0.5)
end
if Mode=="Sword" then
if key=="z" then
GroundBlast()
...
so("http://www.roblox.com/asset?id=91154405",prt7,1,0.5) 
for i=0,1,0.2 do
wait()
BladeNumb=0.8+0.7*i
...
cannonmode=false
so("http://www.roblox.com/asset?id=91154405",prt7,1,0.7) 
for i=0,1,0.1 do
wait()
BladeNumb=1.5-0.7*i
