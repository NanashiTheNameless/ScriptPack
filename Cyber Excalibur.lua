...
partg = function(formfactor, parent, reflectance, transparency, brickcolor, name, size)
  local fp = it("Part")
  fp.formFactor = formfactor
  fp.Parent = parent
  fp.Reflectance = reflectance
...
local prt1 = part(3, modelzorz, 0, 1, BrickColor.new("Dark stone grey"), "Part01", vt())
local prt1han = part(3, modelzorz, 0, 0, BrickColor.new("Dark stone grey"), "Part01", vt())
local prt1end = part(3, modelzorz, 0, 0, BrickColor.new("Really black"), "Part01", vt())
local prt1endg = partg(3, modelzorz, 0, 0, BrickColor.new(NewCol), "Part01", vt())
local prt1tor = part(3, modelzorz, 0, 0, BrickColor.new(NewCol2), "Part01", vt())
local prt1mid = part(3, modelzorz, 0, 0, BrickColor.new(NewCol2), "Part01", vt())
local prt1midaa = part(3, modelzorz, 0, 0, BrickColor.new(NewCol2), "Part01", vt())
local prt1midy = part(3, modelzorz, 0.5, 0, BrickColor.new("Dark stone grey"), "Part01", vt())
local prt1midya = part(3, modelzorz, 0.5, 0, BrickColor.new(NewCol), "Part01", vt())
local prt1midyan = part(3, modelzorz, 0.5, 0, BrickColor.new("Medium stone grey"), "Part01", vt())
local prt1midn = part(3, modelzorz, 0, 0, BrickColor.new("Dark stone grey"), "Part01", vt())
local prt1midne = part(3, modelzorz, 0.25, 0, BrickColor.new("Dark stone grey"), "Part01", vt())
local prt1midney = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part01", vt())
local prt1midgr = part(3, modelzorz, 0.5, 0, BrickColor.new("Really black"), "Part01", vt())
local blade = part(3, modelzorz, 0.5, 0, BrickColor.new("Medium stone grey"), "Blade", vt())
local bladen = part(3, modelzorz, 0.5, 0, BrickColor.new("Dark stone grey"), "Blade", vt())
local bladeg = partg(3, modelzorz, 0.5, 0, BrickColor.new(NewCol), "Blade", vt())
local prt2 = part(3, modelzorz, 0, 1, BrickColor.new("Really black"), "Part02", vt())
local prt3 = part(3, modelzorz, 0, 1, BrickColor.new("Dark stone grey"), "Part03", vt())
local prt4 = part(3, modelzorz, 0, 1, BrickColor.new("Really black"), "Part04", vt())
local prt5 = part(3, modelzorz, 0, 1, BrickColor.new("Really black"), "Part05", vt())
...
local prt11 = part(3, modelzorz, 0.5, 1, BrickColor.new("Medium blue"), "Part11", vt())
local prt12 = part(3, modelzorz, 0.5, 1, BrickColor.new("Medium blue"), "Part12", vt())
msh1 = mesh("CylinderMesh", prt1, "", "", vt(0, 0, 0), vt(1.5, 7.5, 1.5))
msh1han = mesh("CylinderMesh", prt1han, "", "", vt(0, 0, 0), vt(1.5, 10, 1.5))
msh1end = mesh("CylinderMesh", prt1end, "", "", vt(0, 0, 0), vt(2.125, 2.25, 2.125))
msh1endg = mesh("CylinderMesh", prt1endg, "", "", vt(0, 0, 0), vt(2, 2, 2))
msh1tor = mesh("CylinderMesh", prt1tor, "", "", vt(0, 0, 0), vt(1.65, 6.75, 1.65))
msh1mid = mesh("SpecialMesh", prt1mid, "FileMesh", "9756362", vt(0, 0, 0), vt(0.35, 0.35, 0.35))
msh1midaa = mesh("BlockMesh", prt1midaa, "", "", vt(0, 0, 0), vt(0.8, 15, 1))
msh1midya = mesh("SpecialMesh", prt1midya, "Torso", "nil", vt(0, 0, 0), vt(4.5, 2.25, 6))
msh1midyan = mesh("SpecialMesh", prt1midyan, "Torso", "nil", vt(0, 0, 0), vt(4.75, 2.65, 5))
msh1midn = mesh("SpecialMesh", prt1midn, "FileMesh", "9756362", vt(0, 0, 0), vt(0.45, 0.45, 0.75))
msh1midne = mesh("SpecialMesh", prt1midne, "FileMesh", "156292343", vt(0, 0, 0), vt(1, 1, 3.1))
msh1midney = mesh("SpecialMesh", prt1midney, "FileMesh", "156292343", vt(0, 0, 0), vt(1.05, 1.05, 2.75))
msh1midgr = mesh("SpecialMesh", prt1midgr, "FileMesh", "156292343", vt(0, 0, 0), vt(1.25, 1.25, 3.1))
msh1midy = mesh("SpecialMesh", prt1midy, "Torso", "nil", vt(0, 0, 0), vt(5, 2.5, 5.75))
mshblade = mesh("BlockMesh", blade, "", "", vt(0, 0, 0), vt(0.75, 27.75, 2.5))
mshbladen = mesh("BlockMesh", bladen, "", "", vt(0, 0, 0), vt(0.675, 28.5, 3.25))
mshbladeg = mesh("BlockMesh", bladeg, "", "", vt(0, 0, 0), vt(0.65, 28.65, 3.35))
msh2 = mesh("SpecialMesh", prt2, "FileMesh", "9756362", vt(0, 0, 0), vt(0.5, 1, 0.5))
msh3 = mesh("CylinderMesh", prt3, "", "", vt(0, 0, 0), vt(2.5, 3.5, 2.5))
msh4 = mesh("SpecialMesh", prt4, "FileMesh", "3270017", vt(0, 0, 0), vt(1.5, 1.5, 2.5))
msh5 = mesh("SpecialMesh", prt5, "FileMesh", "3270017", vt(0, 0, 0), vt(1.5, 1.5, 2.5))
...
local handleorbwld = weld(handleorb, handleorb, LeftArm, euler(0, 0, 0) * cf(0, 1.035, 0))
local wld1 = weld(prt1, prt1, handle, euler(0, 0, 0) * cf(0, 0, 0))
local wld1han = weld(prt1, prt1han, handle, euler(0, 0, 0) * cf(0, 0.05, 0))
local wld1end = weld(prt1, prt1end, handle, euler(0, 0, 0) * cf(0, 1.25, 0))
local wld1endg = weld(prt1, prt1endg, handle, euler(0, 0, 0) * cf(0, 1.35, 0))
local wld1tor = weld(prt1, prt1tor, handle, euler(0, 0, 0) * cf(0, 0.05, 0))
local wld1mid = weld(prt1, prt1mid, handle, euler(0, 0, 0) * cf(0, -1.25, 0))
local wld1midaa = weld(prt1, prt1midaa, handle, euler(0, 0, 0) * cf(0, -2.5, 0))
local wld1midy = weld(prt1, prt1midy, handle, euler(0, 0, 0) * cf(0, -1, 0))
local wld1midya = weld(prt1, prt1midya, handle, euler(0, 0, 0) * cf(0, -1, 0))
local wld1midyan = weld(prt1, prt1midyan, handle, euler(0, 0, 0) * cf(0, -1, 0))
local wld1midn = weld(prt1, prt1midn, handle, euler(0, 0, 0) * cf(0, -0.9, 0))
local wld1midne = weld(prt1, prt1midne, handle, euler(4.74, 0, 0) * cf(0, -0.75, 0))
local wld1midney = weld(prt1, prt1midney, handle, euler(4.74, 0, 0) * cf(0, -0.75, 0))
local wld1midgr = weld(prt1, prt1midgr, handle, euler(0, 0, 0) * cf(0, -0.65, 0))
local wld1blade = weld(prt1, blade, handle, euler(0, 0, 0) * cf(0, -3.75, 0))
local wld1bladen = weld(prt1, bladen, handle, euler(0, 0, 0) * cf(0, -3.75, 0))
local wld1bladeg = weld(prt1, bladeg, handle, euler(0, 0, 0) * cf(0, -3.75, 0))
local wld2 = weld(prt1, prt2, prt1, euler(3.14, 0, 0) * cf(0, 3, 0))
local wld3 = weld(prt1, prt3, prt1, euler(0, 0, 0) * cf(0, -2.75, 0))
local wld4 = weld(prt1, prt4, prt3, euler(-1.57, 0, 1.57) * euler(0, -0.7, 0) * cf(0, -1.25, 0))
local wld5 = weld(prt1, prt5, prt3, euler(-1.57, 0, -1.57) * euler(0, 0.7, 0) * cf(0, -1.25, 0))
local wld12 = weld(prt1, prt12, prt1, euler(0, 0, 0) * cf(0, -2.6, 0))
local wld11 = weld(prt1, prt11, prt1, euler(0, 0, 0) * cf(0, -2.6, 0))
...
if script.Parent.className ~= "HopperBin" then
  ...
  Tool.Name = "Energy Blade"
  script.Parent = Tool
end
Bin = script.Parent
if Bin.Name == "Energy Blade" then
  Bin.Name = "Energy Blade"
end
...
attackone = function()
  ...
  for i = 0, 1, 0.1 do
    swait()
    MagicBlockTrail(BrickColor.new(NewCol), cf(bladeg.Position), 0.65, 28.65, 3.35, 0, 0, 0, 0.05, 3)
    hitboxCF = prt12.CFrame
    hitbox.CFrame = hitboxCF
    MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 5, 5, 5, 0.1, 0.1, 0.1, 0.1, 1)
...
attackthree = function()
  ...
  for i = 0, 1, 0.15 do
    swait()
    MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 0, 0, 0, 1, 1, 1, 0.1, 1)
    handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 0.6, -0.3), 0.4)
    wld1.C0 = clerp(wld1.C0, euler(1, 0, 0) * cf(0, 0, 0), 0.4)
    Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, -1.4) * euler(0, 0, 0), 0.3)
    RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 1.4), 0.3)
  ...
  MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 0, 0, 0, 5, 5, 5, 0.075, 1)
  MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 0, 0, 0, 5, 5, 5, 0.075, 1)
  MagniDamage(handleorb, 10, 3, 4, math.random(5, 10), "Normal", RootPart, 0.5, 1, (math.random(3, 6)), nil, true)
  hitbox.Parent = modelzorz
  hitbox.Size = vt()
  hitboxweld()
  hboxpos.Parent = nil
...
do1 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 15 then
    ...
    attack = false
      CF = RootPart.CFrame * cf(0, 0.25, -7.5)
      ...
      if hitfloor2 ~= nil then
        ...
        so("157878578", ref2, 0.3, 1.25)
        so("142070127", ref2, 1, 0.75)
        MagniDamage(ref2, 10, 10, 12, math.random(-50, -30), "Knockdown2", RootPart, 0, 1, (math.random(5, 10)), nil, nil, true)
        MagicCircle(BrickColor.new(NewCol), cf(posfloor2), 0, 0, 0, 5, 5, 5, 0.05)
        MagicWave(BrickColor.new(NewCol), cf(posfloor2) * euler(0, math.random(-50, 50), 0), 1, 1, 1, 0.5, 0, 0.5, 0.025)
        MagicWave(BrickColor.new(NewCol), cf(posfloor2) * euler(0, math.random(-50, 50), 0), 1, 1, 1, 0.5, 0, 0.5, 0.025)
        MagicWave(BrickColor.new(NewCol), cf(posfloor2) * euler(0, math.random(-50, 50), 0), 1, 1, 1, 0.5, 0, 0.5, 0.025)
        MagicCircle(BrickColor.new(NewCol), cf(posfloor2), 5, 0, 5, 1, 50, 1, 0.05)
      end
    end
end
do2 = function()
  ...
  if cooldownmax <= cooldowns[2] and mana.Value >= 30 then
    ...
    mana.Value = mana.Value - 30
      MagicCircle(BrickColor.new(NewCol), cf(handleorb.Position), 0, 0, 0, 5, 5, 5, 0.05)
      MagicCircle(BrickColor.new(NewCol), cf(handleorb.Position), 0, 0, 0, 4.5, 4.5, 4.5, 0.05)
      so("183763487", handleorb, 1.5, 0.85)
      MagniDamage(handleorb, 12.5, 5, 9, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
      wait(0.1)
      CF = RootPart.CFrame * cf(0, 0, -5)
      ref2 = part(3, workspace, 0, 1, BrickColor.new("Black"), "Reference", vt())
      ref2.Anchored = true
      ref2.CFrame = CF
      game:GetService("Debris"):AddItem(ref2, 5)
      ...
      if hitfloor2 ~= nil then
        ref2.CFrame = cf(posfloor2)
        MagicCircle(BrickColor.new("Bright blue"), cf(posfloor2), 0, 0, 0, 0, 0, 0, 1)     
        so("183763487", ref2, 1, 1.15)
        MagicCircle(BrickColor.new(NewCol), cf(posfloor2), 5, 0, 5, 1, 10, 1, 0.05)
        MagicCircle(BrickColor.new(NewCol), cf(posfloor2), 0, 0, 0, 5, 5, 5, 0.075)
        MagniDamage(ref2, 10, 3, 8, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
        wait(0.1)
        end
...
do3 = function()
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 35 then
    ...
    for i = 0, 1, 0.1 do
      swait()
      MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 7.5, 7.5, 7.5, 0.1, 0.1, 0.1, 0.1, 1)
      handlewld.C0 = clerp(handlewld.C0, euler(1.57, 0, 0) * cf(0, 0.6, -0.3), 0.4)
      wld1.C0 = clerp(wld1.C0, euler(1, 0, 0) * cf(0, 0, 0), 0.4)
      Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0.4) * euler(0.4, 0, 0), 0.5)
      RootJoint.C0 = clerp(RootJoint.C0, RootCF * cf(0, 0, -0.5) * euler(0, 0, 0.6), 0.5)
      ...
      MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 2, 2, 2, 10, 10, 10, 0.1, 1)
      wait(0.5)
    so("92597369", prt6, 0, 0)
    blcf = nil
    scfr = nil
    ...
    mana.Value = mana.Value - 35
      MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 10, 10, 10, 5, 5, 5, 0.035, 1)
      MagicBlock(BrickColor.new(NewCol), cf(handleorb.Position), 10, 10, 10, 5.5, 5.5, 5.5, 0.035, 1)
      MagicCircle(BrickColor.new(NewCol), cf(handleorb.Position), 7.5, 7.5, 7.5, 5, 5, 5, 0.035)
      so("87767777", handleorb, 0.5, 1)
      so("183763506", handleorb, 1.25, 1)
      so("183763487", handleorb, 1.5, 1)
      MagniDamage(handleorb, 13.75, 8, 11, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
      wait(0.1)
    end
end
do4 = function()
...
MagicBlockTrail = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay)
...
GMagicCircle = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay)
  local prt = partg(3, workspace, 0, 0, brickcolor, "Effect", vt())
  prt.Anchored = true
  prt.CFrame = cframe
  local msh = mesh("SpecialMesh", prt, "Sphere", "nil", vt(0, 0, 0), vt(x1, y1, z1))
