...
p=pa(Weapon,"","Block",1,1,1,false,false,0,0,"White") pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,Scale=v3(0.6,0.6,2),MeshId=ids.Chakram}


chak=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Toothpaste") chakw=weld(chak,ha,chak,0,0,0,0,0,0) qi{"SpecialMesh",chak,Scale=v3(1,1,2),MeshId=ids.chakram}


for i=0,360,360/3 do


p=pa(Weapon,"","Block",0.4,0.6,0.2,false,false,0,0,"White") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"BlockMesh",p} 
...
p=pa(Weapon,"","Block",0.2,0.3,0.3,false,false,0,0,"White") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,MeshType="Wedge",Scale=v3(1,1,1)} 
...
p=pa(Weapon,"","Block",0.4,1,0.2,false,false,0,0,"White") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"BlockMesh",p}
...
p=pa(Weapon,"","Block",0.2,0.4,0.4,false,false,0,0,"White") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,MeshType="Wedge",Scale=v3(1,1,1)} 
...
p=pa(Weapon,"Blade"..tostring(i),"Block",0.2,0.4,1.5,false,false,0,0,"White") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,MeshType="Wedge",Scale=v3(1,1,1)} 
...
p=pa(Weapon,"","Block",1,1,1,false,false,0,0,"Toothpaste") local pw=weld(p,ha,p,0,0,0,0,0,0) qi{"SpecialMesh",p,MeshId=ids.Diamond,Scale=v3(0.1,0.3,0.3)} 
