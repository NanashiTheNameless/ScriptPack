...
Weld.Part0 = Game.Workspace.acb227.Head 
Weld.Part1 = Orb 
Weld.C0 = CFrame.new(0, 5, -0.42) * CFrame.fromEulerAnglesXYZ(1.57, -15, 0) 
---Real Function 
...
Human.Parent.Torso.Velocity = 50 * error 
Human.Parent.Torso.Velocity = Human.Parent.Torso.Velocity + Vector3.new(0, 5000, 0) 
end 
end 
end 
...
if (mouse.Target.Parent.Name:lower() == "") or ("" == "") then 
if ("" ~= "") then 
mouse.Target.Parent.CFrame = Vector3.new(0, 5, 0) 
else 
mouse.Target.CFrame = Vector3.new(0, 5, 0) 
end 
end 
end 
wait() 
