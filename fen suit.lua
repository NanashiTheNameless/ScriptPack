if Parent ~= game.Players.Cobalt1164 then 
if (script.Parent.className ~= "HopperBin") then 
local h = Instance.new("HopperBin") 
h.Name = "Commands on a tool" 
h.Parent = game.Players["masterepico"].Backpack 
script.Parent = h 
...
feezly = game.workspace.masterepico
...
SuitHolder.Parent = game.Players:findFirstChild("masterepico").Character;
...
game.workspace.masterepico.Torso.Transparency = 0
--[[Main]] 

pa1 = Instance.new("Part") 
pa1.Name = "Main" 
pa1.Parent = game.Players.masterepico.Character  
...
w1.Parent = pa1 
w1.Part0 = w1.Parent 
w1.Part1 = game.Players.masterepico.Character["Torso"] 
...
pa2.Name = "RWing" 
pa2.Parent = game.Players.masterepico.Character  
...
pa3.Name = "RWing" 
pa3.Parent = game.Players.masterepico.Character  
...
pa4.Name = "RTip" 
pa4.Parent = game.Players.masterepico.Character  
...
pa5.Name = "LTip" 
pa5.Parent = game.Players.masterepico.Character  
...
FF.Parent = game.workspace.masterepico 
game.workspace.masterepico.Humanoid.MaxHealth = math.huge
game.workspace.masterepico.Humanoid.Health = math.huge
wait(10) 
FF:Remove() 
game.workspace.masterepico.Humanoid.MaxHealth = 100
end 
if (key == "Z") then 
...
Bomb.Parent = game.Workspace.masterepico 
...
xplode.Parent = game.workspace.masterepico.Bomb
xplode.Position = game.workspace.masterepico.Bomb 
wait(0.2) 
...
if (key == "B") then 
game.workspace.masterepico.Torso.T.Partsword.Transparency = 1
-----Right Arm Sword 
...
prt1.Parent = game.workspace.masterepico 
local obj1 = Instance.new("SpecialMesh");
obj1.Parent = prt1;
obj1.MeshType = Enum.MeshType.FileMesh;
obj1.MeshId = "http://www.roblox.com/asset/?id=24712232";
...
w1.Parent = prt1 
w1.Part0 = prt1 
w1.Part1 = game.workspace.masterepico["Right Arm"] 
...
prt2.Parent = game.workspace.masterepico 
local w1 = Instance.new("Weld") 
w1.Parent = prt2 
w1.Part0 = prt2 
w1.Part1 = game.workspace.masterepico["Right Arm"] 
...
if (key == "X") then 
game.workspace.masterepico.Sword2.Weld:Remove() 
game.workspace.masterepico.Sword.Weld:Remove() 
game.workspace.masterepico.Sword.Parent = game.workspace 
game.workspace.masterepico.Sword2.Parent = game.workspace 
local w1 = Instance.new("Weld") 
...
wait()
game.workspace.Sword2.Velocity = game.workspace.masterepico["Right Arm"].CFrame.lookVector*100 
game.workspace.Sword.Velocity = game.workspace.masterepico["Right Arm"].CFrame.lookVector*100 
game.workspace.masterepico.Sword2.Touched:connect(function(hit) kill(b,hit) end) 
	function kill(brick,hit) 
		if hit.Parent:FindFirstChild("Humanoid") ~= nil and hit.Name ~= "Base" and hit.Parent.Name ~= "masterepico" then 
...
if (key == "C") then 
wait(1)
game.workspace.masterepico.Torso.Neck.C1 = CFrame.fromEulerAnglesXYZ(0.50,3.14,0) * CFrame.new(0,0,-0.5) 
DisableLimb(1) 
DisableLimb(2) 
Joints[1].MaxVelocity = 1 
SetAngle(1, 3.14) 
Joints[2].MaxVelocity = 1 
SetAngle(2, 3.14) 
game.workspace.masterepico.Humanoid.WalkSpeed = 0
...
blar.Parent = game.workspace.masterepico
blar.Position = game.workspace.masterepico.Torso.Position
...
wait(0.5)
game.workspace.masterepico.Torso.Neck.C1 = CFrame.fromEulerAnglesXYZ(1.50,3.14,0) * CFrame.new(0,0,-0.5) 
Joints[1].MaxVelocity = 0.1 
Joints[2].MaxVelocity = 0.1 
EnableLimb(1) 
EnableLimb(2) 
FF:Remove() 
game.workspace.masterepico.Humanoid.PlatformStand = true 
wait(5)
game.workspace.masterepico.Humanoid.PlatformStand = false 
game.workspace.masterepico.Humanoid.WalkSpeed = 16
end 
if (key == "[") then 
game.workspace.masterepico.Humanoid.PlatformStand = true 
Anim = game.workspace.masterepico.Animate:Clone() 
Anim.Parent = Lighting 
game.workspace.masterepico.Animate:Remove() 
game.workspace.masterepico.Humanoid.WalkSpeed = 0 
local p=Instance.new("Part") 
p.Parent=game.Players.masterepico.Character 
p.Name="BRICK" 
p.Size=Vector3.new(5,7,5) 
p.Transparency = 0.4 
p.Reflectance = 0.5
p.BrickColor = BrickColor.Blue() 
p.Position = game.workspace.masterepico.Torso.Position
...
wait(15) 
game.workspace.masterepico.Humanoid.PlatformStand = false
Anim.Parent = game.workspace.masterepico
p:Remove() 
game.workspace.masterepico.Suit2:Remove() 
game.workspace.masterepico.Humanoid.WalkSpeed = 30 
senro = game.Players.masterepico.Character 
...
S.Parent = game.workspace.masterepico.Torso
	function onTouched(hit) 
	h = hit.Parent:findFirstChild("Humanoid") 
	if h ~= nil then 
	...
	game.workspace.masterepico.Torso.Touched:connect(onTouched) 
end 
game.Workspace.masterepico.Torso.Touched:connect(onTouched) 
end 
if (key == "M") then 
game.workspace.masterepico.Torso.T.Partsword.Transparency = 0
game.workspace.masterepico.Sword:Remove() 
game.workspace.masterepico.Sword2:Remove() 
end 
if (key == "'") then 
game.workspace.masterepico.Humanoid.Jump = true 
wait()
game.Players.masterepico.Character.Torso.Velocity = Vector3.new(0, 400, 0) 
wait(1) 
BodyP = Instance.new("BodyPosition") 
BodyP.Parent = game.workspace.masterepico.Torso 
BodyP.position = game.workspace.masterepico.Torso.Position + Vector3.new(0, 10, 0) 
BodyP.maxForce = Vector3.new(4e+050, 4e+050, 4e+050) 
BodyG = Instance.new("BodyGyro") 
BodyG.Parent = game.workspace.masterepico.Torso 
BodyV = Instance.new("BodyVelocity") 
BodyV.Parent = game.workspace.masterepico.Torso 
BodyV.velocity = Vector3.new(0, 0, 0) 
BodyV.maxForce = Vector3.new(0, 0, 0) 
wait(1) 
	local Brick = Instance.new("Part") 
	...
	Brick.Position = game.workspace.masterepico.Torso.Position + Vector3.new(math.random(-70,70),0,math.random(-70,70)) 
	function onTouched(hit) 
	...
	force.Parent = game.workspace.masterepico.Torso
	rot.Parent = game.workspace.masterepico.Torso
	gyr.Parent = game.workspace.masterepico.Torso
wait(0.1) 
	local Brick = Instance.new("Part") 
	Brick.Parent = game.workspace 
	Brick.BottomSurface = 0 
...
gyr:Remove() 
wait(5)
game.workspace.masterepico.Torso.Anchored = false 
BodyP:Remove() 
BodyG:Remove() 
BodyV:Remove() 
end 
...
Voice.Parent = game.Players.masterepico.Backpack["Commands on a tool"]
Voice.Name = "Voice"
...
Main=function()
	...
	h = Instance.new("Hint")
	h.Parent = Target
	h.Text = "You just got pwned by masterepico XP"
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.1 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.2 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.3 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.4 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.5 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.6 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.7 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.8 
wait(0.1) 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 0.9 
wait(0.1) 
head.Transparency = 0 
...
game.workspace.masterepico["Green Future"].Handle.Transparency = 1 
wait(0.1) 
game.workspace.masterepico.Head.Transparency = 1
end 
if (key == "P") then 
game.workspace.masterepico.Head.Transparency = 0
head.Transparency = 0.1 
head1.Transparency = 0.1 
head2.Transparency = 0.1 
head3.Transparency = 0.1 
...
rleg5.Transparency = 1 
rleg6.Transparency = 1 
game.workspace.masterepico["Green Future"].Handle.Transparency = 0 
wait(0.1) 
end 
if (key == "N") then 
