--[[
Franchi Sporting Purpose Automatic Shotgun (SPAS-12). 
Commonly used by North-American Police forces.
Fires 12 Gauge 2' Ammunition.
--]]
...
function makeParts(format)
	...
	if format ~= nil then
		...
		elseif format == "LeftHolster" then
			w.Part1 = Player.Character:FindFirstChild("Torso")
			w.C0 = CFrame.new(-0.95, -0.6, 0.5) * CFrame.fromEulerAnglesXYZ(math.rad(-40), math.rad(90), 0)
			w.C1 = CFrame.new()
	...
	m.Scale = Vector3.new(0.26, 0.37, 0.68)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.04, -0.4) * CFrame.fromEulerAnglesXYZ(math.rad(15), 0, 0)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Grip"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.26, 0.4, 0.3)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, -0.05, -0.05)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "TriggerGuard"
	...
	p.Parent = model
	local m = Instance.new("BlockMesh")
	m.Scale = Vector3.new(0.27, 1.2, 0.32)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.3, -0.05)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Front Sight"
	...
	local m = Instance.new("BlockMesh")
	m.Name = "Mesh"
	m.Scale = Vector3.new(0.26, 0.25, 0.1)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(-0.01, 0.5, 0.02)
	w.C1 = CFrame.new()
	w.Parent = p		
	local p = Instance.new("Part")
	p.Name = "Insert" --------------
	...
	local m = Instance.new("BlockMesh")
	m.Name = "Mesh"
	m.Scale = Vector3.new(0.12, 0.25, 0.1)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 0.5, -0.16)
	w.C1 = CFrame.new()
	w.Parent = p		
	local p = Instance.new("Part")
	p.Name = "Pump"
	...
	local m = Instance.new("BlockMesh")
	m.Name = "Mesh"
	m.Scale = Vector3.new(0.3, 0.8, 0.25)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.48, -0.1)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Tube"
	...
	m.Scale = Vector3.new(0.14, 0.9, 0.14)
	m.Offset = Vector3.new(0, 0.34, 0)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 1.98, -0.13)
	w.C1 = CFrame.new()
	w.Parent = p
	local p = Instance.new("Part")
	p.Name = "Muzzle"--                actually barrel
	p.formFactor = "Symmetric"
	p.Size = Vector3.new(1, 1, 1)
	p.BrickColor = MC
	p.Reflectance = MR
	...
	p.Parent = model
	local m = Instance.new("CylinderMesh")
	m.Scale = Vector3.new(0.16, 0.9, 0.16)
	m.Offset = Vector3.new(0, 0.34, 0)
	m.Parent = p
	local w = Instance.new("Weld")
	w.Part0 = p
	w.Part1 = pm
	w.C0 = CFrame.new(0, 2, 0.02)
	w.C1 = CFrame.new()
	w.Parent = p
	...
	if Stock == true then
		...
		w.Part0 = g
		w.Part1 = pm
		w.C0 = CFrame.new(0, -0.56, -0.08) * CFrame.fromEulerAnglesXYZ(math.rad(-8), 0, 0)
		w.C1 = CFrame.new()
		w.Parent = g	
		local p = Instance.new("Part")
		p.Name = "Stock1"
		...
		w.Part1 = g
		if Holstered == false then
			w.C0 = CFrame.new(0, -0.75, -0.1) --* CFrame.fromEulerAnglesXYZ(math.rad(5), 0, 0)
		else
...
function playAnimation(format, mouse)
	...
	if format == "reload" then
		...
		if magazine.Value == 0 then
			...
			wait(0.1)
			Player.Character[Name].Pump.Mesh.Offset = Vector3.new(0, 0.2, 0)
			Player.Character[Name].Bolt.Mesh.Offset = Vector3.new(0, 0.2, 0)						
			for i = 0, 10, 1.5 do
				if Player.Character:FindFirstChild("Torso") ~= nil then
					if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil then
						Player.Character.Torso["Left Shoulder 2"].C0 = CFrame.new()
		...
		Player.Character[Name].Handle.Reload.Pitch = 1.2				
		...
		if magazine.Value == 0 then
			...
			Player.Character[Name].Pump.Mesh.Offset = Vector3.new(0, 0, 0)			
			for i = 10, 0, -5 do
				if Player.Character:FindFirstChild("Torso") ~= nil then
					if Player.Character.Torso:FindFirstChild("Left Shoulder 2") ~= nil then
						Player.Character.Torso["Left Shoulder 2"].C0 = CFrame.new()
	...
	if format == "fire" then
		...
		if burst == false then
			...
			wait(0.1)
			Player.Character[Name].Handle.Reload.Pitch = 0.8				
			Player.Character[Name].Handle.Reload:Play()		
			Player.Character[Name].Pump.Mesh.Offset = Vector3.new(0, 0.2, 0)
			Player.Character[Name].Bolt.Mesh.Offset = Vector3.new(0, 0.2, 0)			
			for i = 0, 10, 1.5 do
...
function fire(startPoint, endPoint, hit)
	...
	if hit ~= nil then
		...
		if hit.Anchored == false then
			hit.Velocity = hit.Velocity + ((endPoint - startPoint).unit * (damage * 3))
		end
	end
end
