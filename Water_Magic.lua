...
NewCol2 = BrickColor.new("Electric blue").Color
...
fenframe5.ZIndex = 2
local tellbar = gui("TextLabel", fenframe5, "Enable: Q", 1, Color3.new(0, 0, 0), UDim2.new(0.25, 0, 0.25, 0), UDim2.new(0.5, 0, 0.5, 0))
...
if script.Parent.className ~= "HopperBin" then
  ...
  Tool.Name = "I N3eD t-0 BECOME WH0E0LE AGAIN"
  script.Parent = Tool
end
Bin = script.Parent
if Bin.Name == "I N3eD t-0 BECOME WH0E0LE AGAIN" then
  Bin.Name = "I N3eD t-0 BECOME WH0E0LE AGAIN"
end
...
attackone = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 0 then
    ...
    do
      ...
      for i = 0, 1, 0.2 do
        swait()
        RW.C0 = clerp(RW.C0, cf(1.2, 0.3, -0.5) * euler(1.6, 0, 0) * euler(0, 2, 0), 0.15)
        RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
        LW.C0 = clerp(LW.C0, cf(-1.2, 0.3, -0.5) * euler(1.6, 0, 0) * euler(0, 2, 0), 0.15)
      ...
      if Stagger.Value ~= true then --and StunT.Value > Stun.Value then
        if StaggerHit.Value ~= true then
          ...
          arcorb = true
          orb.Anchored = true
          orb.CFrame = RootPart.CFrame * cf(0, 0, -7.5)
          do
    ...
    so("359233107", ref, 5, 0.75)
    so("359233107", ref, 5, 1)
    game:GetService("Debris"):AddItem(ref, 5)
    MagicCircle(BrickColor.new(NewCol), cf(orb.Position), 10, 5, 10, 0.5, 0, 0.5, 0)
    MagicWave(BrickColor.new(NewCol), cf(orb.Position) * euler(0, math.random(-50, 50), 0), 1, 5, 1, 0.5, -0.25, 0.5, 0.05)
    MagniDamage(ref, 8.75, 7, 10, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
...
do2 = function()
  ...
  if cooldownmax <= cooldowns[1] and mana.Value >= 0 then
    ...
    do
      ...
      if Stagger.Value ~= true then --and StunT.Value > Stun.Value then
        if StaggerHit.Value ~= true then
          ...
          orb.CFrame = RootPart.CFrame * cf(0, 0, -7.5)
          do
            local msh = mesh("SpecialMesh", orb, "Sphere", "nil", vt(0, 0, 0), vt(30, 30, 30))
            ogui = Instance.new("BillboardGui")
            ogui.Parent = orb
            ogui.Size = UDim2.new(5, 0, 5, 0)
            oimg = Instance.new("ImageLabel")
    ...
    ref.Anchored = true
    ref.CFrame = cf(orb.Position)
    so("359233107", ref, 5, 0.5)
    so("359233107", ref, 5, 0.35)
    game:GetService("Debris"):AddItem(ref, 5)
    MagicCircle(BrickColor.new(NewCol), cf(orb.Position), 0, 5, 0, 25, 0.125, 25, 0)
    MagicWave(BrickColor.new(NewCol), cf(orb.Position) * euler(0, math.random(-50, 50), 0), 7.5, 5, 7.5, 1.5, -0.25, 1.5, 0.05)
    MagicWave(BrickColor.new(NewCol), cf(orb.Position) * euler(0, math.random(-50, 50), 0), 7.5, 5, 7.5, 0.75, 0.05, 0.75, 0.05)
    MagniDamage(ref, 17.5, 10, 13, math.random(5, 10), "Normal", RootPart, 0.5, 2, (math.random(5, 7)), nil, true)
    if isjugg == false then
    end
    orb.Parent = nil
  end
...
if attack == true then
  ...
  if cooldownmax <= cooldowns[3] and mana.Value >= 30 then
    ...
    do
          ...
          dec2.Parent = nil
          passive.Value = -1
          so("359233107", RootPart, 5, 0.5)
          so("359233107", RootPart, 5, 0.35)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position) * cf(0, -2.5, 0), 50, 25, 50, 1.5, 0, 1.5, 0.005)
          MagicCircle(BrickColor.new(NewCol), cf(Torso.Position) * cf(0, -2.5, 0), 50, 5, 50, 1, 100, 1, 0.075)
          MagicWave(BrickColor.new(NewCol), cf(Torso.Position) * euler(0, math.random(-50, 50), 0) * cf(0, -2.5, 0), 12.5, 5, 12.5, 1.25, 0.05, 1.25, 0.05)
          MagniDamage(RootPart, 25, 23, 25, math.random(30, 50), "Knockdown2", RootPart, 0, 1, (math.random(4, 8)), nil, nil, false)
          wait(0.25)
          for i = 0, 1, 0.1 do
            swait()
            if Stagger.Value ~= true and StunT.Value > Stun.Value then
...
MagicSkull = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay, goe)
  ...
  prt.Anchored = true
  prt.CFrame = cframe
  msh = mesh("SpecialMesh", prt, "FileMesh", "102638417", vt(0, 0, 0), vt(x1, y1, z1))
  game:GetService("Debris"):AddItem(prt, 10)
...
MagicRing2 = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay)
  local prt = part(3, workspace, 0, 0, brickcolor, "Effect", vt(0.5, 0.5, 0.5))
  prt.Anchored = true
  prt.CFrame = cframe * cf(x2, y2, z2)
  local msh = mesh("SpecialMesh", prt, "FileMesh", "102638417", vt(0, 0, 0), vt(x1, y1, z1))
  game:GetService("Debris"):AddItem(prt, 10)
  table.insert(Effects, {prt, "Cylinder", delay, x3, y3, z3, msh})
end
        ...
        if 1 < RootPart.Velocity.y and hitfloor == nil then
          ...
          if RootPart.Velocity.y < -1 and hitfloor == nil then
            ...
            if torvel < 1 and hitfloor ~= nil then
              Anim = "Idle"
              if attack == false then
                Neck.C0 = clerp(Neck.C0, necko * euler(0, 0, 0) * euler(0, 0, 0), 0.15)
                RootJoint.C0 = clerp(RootJoint.C0, RootCF * euler(0, 0, 0), 0.15)
                RW.C0 = clerp(RW.C0, cf(1.2, 0.3, -0.5) * euler(1.6, 0, -1.4) * euler(0, 1.57, 0), 0.15)
                RW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
                LW.C0 = clerp(LW.C0, cf(-1.2, 0.3, -0.5) * euler(1.6, 0, 1.4) * euler(0, -1.57, 0), 0.15)
                LW.C1 = clerp(LW.C1, cf(0, 0.5, 0) * euler(0, 0, 0), 0.15)
