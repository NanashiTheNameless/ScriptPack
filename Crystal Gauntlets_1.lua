...
local CrystalNumb=0
local Crystals={}
CrystalColor=BrickColor.new("Navy blue")
crystal = BrickColor.new("Navy blue")
--player
player = nil
--save shoulders
RSH, LSH = nil, nil
...
local prt7=part(3,modelzorz,0,0,BrickColor.new("Institutional white"),"Part7",vt(1,1,1))
...
if CrystalNumb<25 then
so("http://www.roblox.com/asset/?id=106626284",Torso,1,2)
CrystalEffect(prt7)
CrystalNumb=CrystalNumb+1
print(CrystalNumb)
local base=part(3,modelzorz,0,1,BrickColor.new("Really black"),"Part1",vt(1,1,1))
base.Anchored=true
