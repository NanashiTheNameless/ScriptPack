--Player Settings
local modelName="Void Staff" --Name here
...
function dmgHit(prt)
        prt.Touched:connect(function(h)
                if onKey==true and h.Parent:findFirstChild("Humanoid") and onHit==false and h.Parent~=char then
                        ...
                        local label=add.Part(fakeM, true, false, "Teal", 0, Vector3.new(.5, .5, .5), h.CFrame*CFrame.new(math.random(-4, 4), 4, math.random(-4, 4))) label.Name="Head"
                        --Freeze
                        play(Sounds.Abscond, 1, 1)
                        local f=add.Part(workspace, true, false, "Teal", .5, Vector3.new(6, 6, 6), hTorso.CFrame) hTorso.Anchored=true
...
function Smash()
        ...
        local b=add.Part(workspace, true, false, "Teal", .5, Vector3.new(80, 80, 80), torso.CFrame*CFrame.new(0, -3, 0)*CFrame.Angles(-math.rad(90), 0, 0)+torso.CFrame.lookVector*1.5)
        local bM=add.Mesh("SpecialMesh", b, Vector3.new(1, 1, 1), nil, nil, Meshes.Ring)
        local b2=add.Part(workspace, true, false, "Teal", .5, Vector3.new(80, 80, 80), torso.CFrame*CFrame.new(0, -3, 0)+torso.CFrame.lookVector*1.5)
        local b2M=add.Mesh("SpecialMesh", b2, Vector3.new(1, 4, 1), nil, nil, Meshes.Crown)
        dmgHit(b) dmgHit(b2)
        s(function()
...
function WinterSpike()
        ...
        for i=0, 1, .05 do wait()
                ...
                local b=add.Part(workspace, true, false, "Teal", .5, Vector3.new(10, 10, 10), torso.CFrame*CFrame.new(0, -3, 0)*CFrame.Angles(-math.rad(90), 0, 0)+torso.CFrame.lookVector*(120*i))
                local bM=add.Mesh("SpecialMesh", b, Vector3.new(10, 10, 10), nil, nil, Meshes.Ring)
                local b2=add.Part(workspace, true, false, "Teal", .5, Vector3.new(10, 10, 10), torso.CFrame*CFrame.new(0, -3, 0)+torso.CFrame.lookVector*(120*i))
                local b2M=add.Mesh("SpecialMesh", b2, Vector3.new(1, 2, 1), nil, nil, Meshes.Crown)
                local b3=add.Part(workspace, true, false, "Teal", .5, Vector3.new(1, .8, 4), torso.CFrame*CFrame.new(0, -3, 0)*CFrame.Angles(-math.rad(90), 0, 0)+torso.CFrame.lookVector*(120*i))
...
function Blast()
        ...
        if pressure>500 then onHold=false end
        while onHold do wait(.1)
                pressure=pressure+.1
                dmg=dmg+.5
                local ss=add.Part(workspace, true, false, "Teal", 0, Vector3.new(pressure, pressure, pressure), torso.CFrame+torso.CFrame.lookVector*10)
                local ssM=add.Mesh("SpecialMesh", ss, nil, nil, "Sphere")
                local e=add.Part(workspace, false, false, "Teal", 0, Vector3.new(2, 2, 2), ss.CFrame*CFrame.new(math.random(-pressure-10, pressure+10), math.random(-pressure-10, pressure+10), math.random(-pressure-10, pressure+10))*CFrame.Angles(math.rad(math.random(-45, 45)), math.rad(math.random(-45, 45)), math.rad(math.random(-45, 45))))
        ...
        local ss=add.Part(workspace, false, false, "Teal", .5, Vector3.new(pressure, pressure, pressure), torso.CFrame+torso.CFrame.lookVector*10)
        local ssM=add.Mesh("SpecialMesh", ss, nil, nil, "Sphere")
        trail(ss, nil, "Teal", pressure)
...
function Block()
        ...
        local shield=add.Part(workspace, false, true, "Teal", .2, Vector3.new(4, 4, 4.5), cf)
...
function WinterBoard()
        ...
        trail(obj.S, nil, "Teal", .5)
        trail(obj.S2, nil, "Teal", .5)
