--MADE BY OneLegend (NOT THE SCRIPT) Thanks to CyberFromLU for lettin mediafire g me Publish! REGULAR SCRIPT: Go to line 20 and 2524 and put your name where it says "YOUR NAME HERE"
-------------------------------------------------------------------
Player = game:GetService("Players"):FindFirstChild("DeadlyShroom")
Name = "SCAR-H"
selected = false
canDual = false
dual = false
