--[[
H&K M416 Carbine; developed as a solution to the aging M4/M16 platforms.
5.56x45mm NATO, 100 Round Beta-C Dual Drum Magazine OR Standard STANAG 30 Round Magazines.
...
animate:Destroy()
Name = "HK416"
MC = BrickColor.new("Lime gren")
DC = BrickColor.new("Black")
GC = BrickColor.new("Lime gren")
Magazine = "STANAG"
WSPenalty = 15
MR = 0
GR = 0
...
function makeParts(format)
	...
	p.formFactor = "Symmetric"
	p.Size = Vector3.new(1, 1, 1)
	p.BrickColor = BrickColor.new("Lime gren")
	p.CanCollide = false
	p.Locked = true
	p.TopSurface = 0
	p.BottomSurface = 0
...
function fire(startPoint, endPoint, hit)
	...
	trail.BrickColor = BrickColor.new("Black")
	trail.TopSurface = 0
...
if script.Parent.ClassName ~= "HopperBin" then
	...
	if script.Parent:FindFirstChild("AmmoMax") == nil then
		...
		ammoMax.Value = 3456754e34565433456543554
