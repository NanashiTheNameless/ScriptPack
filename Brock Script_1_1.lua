-- Brock Script --
-- Its a huge rock golem, lol its cool --
...
MeshEffect(35,Torso.CFrame*cn(0,-3.5*Scale,-6*Scale)*ca(90,0,0),nil,v3(2,2,1)*Scale,v3(12,12,5)*Scale,0.2,1,'Really black',as.ring)
wait(0.5)
for x=1,ASpeed do 
...
MeshEffect(24,cf,cf*cn(0,4*Scale,0),v3(0.5,0.5,0.5)*Scale,v3(mran2(1,4),mran2(3,5),mran2(1,3))*Scale,0.1,1,'Really black','Brick') 
...
MeshEffect(35,Grabbing.Part1.CFrame,nil,v3(2,2,1)*Scale,v3(7,7,3)*Scale,0.3,1,'Really black',as.ring)
local crushjo=60
...
MeshEffect(35,pt*cn(0,5,0)*ca(90,0,0),nil,v3(2,2,1)*Scale,v3(7,7,3)*Scale,0.2,1,'Really black',as.ring)
else
...
Hum.WalkSpeed=ws
if Hum.MaxHealth~=800 then Hum.MaxHealth=800 Hum.Health=800 end 
