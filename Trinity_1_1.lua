...
if hit ~= nil then
		if hit.Parent:FindFirstChild("Torso") ~= nil then
          Damagefunc(hit.Parent:FindFirstChild("Humanoid"), 9, 12, 0, "Target", RootPart, 0)
		end
		if hit.Parent.Parent:FindFirstChild("Torso") ~= nil then
          Damagefunc(hit.Parent.Parent:FindFirstChild("Humanoid"), 9, 12, 0, "Target", RootPart, 0)
		end
end
      end
    end
  ...
  if equipped == true or equipped == false then
    ...
    elseif RootPart.Velocity.y < -1 and hitfloor == nil then
      ...
      elseif torvel<1 and hitfloor ~= nil then
        ...
        elseif torvel>2 or torvel>22 and hitfloor ~= nil then
            Anim = "Walk"
            if attack == false then
              fat.Event:wait()
              Humanoid.WalkSpeed = 16 * speed.Value
          ...
          elseif torvel>22 or torvel<22 and hitfloor ~= nil then
              Anim = "Run"
              if attack == false then
                fat.Event:wait()
                change = 2
