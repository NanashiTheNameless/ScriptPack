--[[Add local/ at the beginning if you're using it at a script builder__Created by lordsheen]]
...
ee.C0=CFrame.new(0,7,0,-1,-0,-0,0,0,1,0,1,0)
ee.Parent=game.Players.LocalPlayer.Character.Torso

script.Parent=game.Players.LocalPlayer.StarterGear --Change Backpack to StarterGear for it to work throughout the rest of the server
