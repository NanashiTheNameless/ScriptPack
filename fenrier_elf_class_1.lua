...
game:GetService("Debris"):AddItem(giftprt,10)
Boom(giftprt,math.random(200,600),num,10,20,false)
end
--[[for i=1,100 do
num=math.random(100,400)/100
local giftprt=part(3,workspace,0,0,BrickColor.new("Black"),"Gift",vt(num,num,num))
...
giftprt.CanCollide=true
giftprt.Velocity=(RootPart.CFrame.lookVector*math.random(20,40))+(vt(math.random(-1,1),-1,math.random(-1,1))*math.random(80,100))
game:GetService("Debris"):AddItem(giftprt,10)
