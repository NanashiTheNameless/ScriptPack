...
row = row +1 
local pcont = Instance.new("TextButton") 
pcont.Text = a.Name 
...
pcont.MouseButton1Down:connect(function()
...
Frame3.Position = UDim2.new(0,150,0,325) 
...
function click() 
search:findFirstChild(a.Name):Remove() 
starter:remove() 
wait() 
load() 
end 
...
fnum.Parent = starter 
fnum.Position = UDim2.new(0,170,0,325) 
...
num.TextColor = BrickColor.new("Really black") 
num.BackgroundColor = BrickColor.new("Bright yellow") 
