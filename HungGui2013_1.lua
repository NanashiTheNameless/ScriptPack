...
PluginGui.Position = UDim2.new(0,30,0,380)
PluginGui.Text="Hung999" 
...
textlabel.Text = "E3X9O1T || By LocalPlayer || Drag This Bar"
...
IL.Text="128x128 !S UnBaNnEd"
IL.TextColor3 = Color3.new(0,0,0)
IL.FontSize="Size48"
...
exx.BlastPressure = 100000000000000000000000000000000000
exx.BlastRadius = 10000000000000000000000000000000
end)
...
b[i].HeadColor = BrickColor.Blue()
b[i].LeftArmColor = BrickColor.Blue()
b[i].LeftLegColor = BrickColor.Blue()
b[i].RightArmColor = BrickColor.Blue()
b[i].RightLegColor = BrickColor.Blue()
b[i].TorsoColor = BrickColor.Blue()
...
b[i].BrickColor = BrickColor.Blue()
...
c[i].BrickColor = BrickColor.Blue()
...
a[i].BrickColor = BrickColor.Blue()
...
game.Players.LocalPlayer.CharacterAppearance = ("http://www.roblox.com/Asset/CharacterFetch.ashx?userId=5355061&placeId=0")
end)
