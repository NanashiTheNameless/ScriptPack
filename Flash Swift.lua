...
Hitbox=part(Enum.FormFactor.Custom,m,Enum.Material.SmoothPlastic,0,1,"Lime green","Hitbox",Vector3.new(2.19002581, 6.55274916, 0.590025842))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 0.295012861, 0.442519456))
...
mesh("BlockMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(1, 0.7375319, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 0.200000003, 0.295012921))
...
mesh("CylinderMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(1, 0.774408579, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 0.295012772, 0.200000003))
...
mesh("CylinderMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(0.5, 0.7375319, 0.5))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 3.09763432, 0.200000003))
...
mesh("BlockMesh",Part,"","",Vector3.new(0, 0, 0),Vector3.new(0.737532437, 1, 0.737532377))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 3.09763432, 0.295012951))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 2.50760865, 0.200000003))
...
mesh("SpecialMesh",Part,Enum.MeshType.Wedge,"",Vector3.new(0, 0, 0),Vector3.new(1, 1, 1))
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 0.295012861, 0.295012951))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Neon,0,0.5,"Lime green","Part",Vector3.new(0.200000003, 2.50760865, 0.295012951))
	...
	if equipped == true or equipped == false then
		...
		elseif torvel < 1 and hitfloor ~= nil then
			...
			if attack == false then
				...
				Torso.Neck.C0 = clerp(Torso.Neck.C0, necko * angles(math.rad(-10), math.rad(0), math.rad(0)), .2)
				RW.C0 = clerp(RW.C0, CFrame.new(1.1, 0.3, -.5) * angles(math.rad(70), math.rad(0), math.rad(-50)), 0.2)
				LW.C0 = clerp(LW.C0, CFrame.new(-1.1, 0.3, -.5) * angles(math.rad(75), math.rad(0), math.rad(50)), 0.2)
				RH.C0 = clerp(RH.C0, cf(1, -1, 0) * angles(math.rad(0), math.rad(90), math.rad(20)) * angles(math.rad(-5), math.rad(0), math.rad(0)), .2)
				LH.C0 = clerp(LH.C0, cf(-1, -1, 0) * angles(math.rad(0), math.rad(-90), math.rad(-20)) * angles(math.rad(-5), math.rad(0), math.rad(0)), .2)
				FakeHandleweld.C0 = clerp(FakeHandleweld.C0, CFrame.new(0, -.5, 0) * angles(math.rad(0), math.rad(-50), math.rad(-10)), 0.25)
			end
