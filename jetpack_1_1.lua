...
ec = {"Lime green", "Bright green", "Dark green", "Camo"}
...
prop(main,jet,false,0,0.1,2.3,1.4,0.4,"Really black",false,"Custom")
...
for i=0.7,1.9,0.4 do
	...
	prop(glow,jet,false,0,0,1+(i/2),0.1,0.1,"Lime green",false,"Custom")
...
prop(lols1,jet,false,0,0.1,0.6,2.6,0.6,"Really black",false,"Custom")
...
prop(lolss1,jet,false,0,0.1,0.5,2,0.5,"Really black",false,"Custom")
...
prop(heh,jet,false,0,0,0.5,0.1,0.5,"Lime green",false,"Custom")
...
prop(lols2,jet,false,0,0.1,0.6,2.6,0.6,"Really black",false,"Custom")
...
prop(lolss2,jet,false,0,0.1,0.5,2,0.5,"Really black",false,"Custom")
