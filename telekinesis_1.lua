...
if Player.Backpack:FindFirstChild("Telekinesis") ~= nil then
	Player.Backpack.Telekinesis:Destroy()
end
...
if game.Lighting:FindFirstChild("TelekinesisGrab") ~= nil then
	game.Lighting.TelekinesisGrab:Destroy()
end
