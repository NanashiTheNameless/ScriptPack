...
o RAYCASTING. The script now runs off an actualt raycasting function I made, instead of being rather hacky and fake. 
o 1.3 
...
Player = game.Players:FindFirstChild("acb227") 
Name = "Pistol" 
selected = false 
dropped = false 
Button1Down = false 
...
if children.Parent ~= Player.Character:FindFirstChild(Name) and children.Name ~= "Bullet Trail" then 
...
p.Parent = model 
local m = Instance.new("CylinderMesh") 
m.Scale = Vector3.new(0.4, 1.3, 0.4) 
m.Parent = p 
local w = Instance.new("Weld") 
w.Part0 = p 
w.Part1 = pm 
w.C0 = CFrame.new(0, 2.575, 0.025) 
w.C1 = CFrame.new() 
w.Parent = p 
end 
...
local time = 7 
local seed = Vector3.new(math.random(100, 200) / 10000, math.random(100, 200) / 10000, 0) 
