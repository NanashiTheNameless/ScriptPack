...
for i=1,14 do
        local gr = clone(part)
        gr.BrickColor = BrickColor.new("Toothpaste")
...
local bt = clone(part)
bt.BrickColor = BrickColor.new("Toothpaste")
...
local tt = clone(part)
tt.BrickColor = BrickColor.new("White")
...
local l1 = clone(part)
l1.BrickColor = BrickColor.new("Toothpaste")
...
arrow.Parent = amodel
arrow.BrickColor = BrickColor.new("Toothpaste")
...
tip.Parent = amodel
tip.BrickColor = BrickColor.new("Toothpaste")
