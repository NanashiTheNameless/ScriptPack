...
mouse.Button1Down:connect(function()
	...
	shooting = true
                while shooting do
		wait(0.2)
	   if ammo == 25 or ammo == 24 or ammo == 23 or ammo == 22 or ammo == 21 or ammo == 20 or ammo == 19 or ammo == 18 or ammo == 17 or ammo == 16 or ammo == 15 or ammo == 16 or ammo == 15 or ammo == 14 or ammo == 13 or ammo == 12 or ammo == 11 or ammo == 10 or ammo == 9 or ammo == 8 or ammo == 7 or ammo == 6 or ammo == 5 or ammo == 4 or ammo == 3 or ammo == 2 or ammo == 1 then
	ammo = ammo - 1
		                     txt.Text = "Ammo "..ammo
