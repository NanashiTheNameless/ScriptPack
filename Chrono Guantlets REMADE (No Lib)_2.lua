...
local v = ins(tab[1])
--
if v:IsA("Part") or v:IsA("WedgePart") then v.formFactor="Custom" v.Material = "SmoothPlastic" v.TopSurface = "SmoothNoOutlines" v.BottomSurface = "SmoothNoOutlines" v.RightSurface = "SmoothNoOutlines" v.LeftSurface = "SmoothNoOutlines" end
...
pTorso=Char.HumanoidRootPart --lul no rootjoint included C:
tw=qi{'Weld',Torso,P0=pTorso,P1=Torso}
_G.ttw=tw

Head.CanCollide=false --[[Head.Parent=m Head.Transparency=0 ]]--
hw=qi{'Weld',Torso,P0=Torso,P1=Head,C0=cn(0,1.5,0)}
...
wait() 
la.Parent = Torso ra.Parent = Torso 
...
wait() 
ll.Parent = Torso rl.Parent = Torso 
...
q(function() wait(0.1) Legs() Arms() end) -- Legs() end)
...
BP=qi{'BodyPosition',pTorso,n=ModelName..'BP',maxForce=v3(0,0,0)}
BG=qi{'BodyGyro',pTorso,n=ModelName..'BG',maxTorque=v3(0,0,0),D=150}
...
hanw=qi{'Weld',han,P0=Torso,P1=han,C0=cn(1,1.5,0.75)*ca(0,0,125)*ca(0,90,0)}
...
vv:Remove()
Ani(ra, 1.5,0.5,0,-210,0,0,2,ns,1)
local hanc=Torso.CFrame:toObjectSpace(han.CFrame)
hanw.Part0=Torso hanw.C0=hanc rAni(hanw)
...
AddBV(-18,pTorso.CFrame,pTorso,0.25,true)
...
AddBV(1,pTorso.CFrame,pTorso,0.7,true)
Sound(as.abscond,Torso,1,1.5)
qAni(ra, 1.5,0.5,0,0,0,-90,2,ns,1)
...
Speed[1]=2
local bv=AddBV(15,pTorso.CFrame,pTorso,4,true)
...
BGFace=true
AddBV(-12,pTorso.CFrame,pTorso,0.7,true)
qAni(la,-1.5,0.5,0,-90, 10,0,2,ns,1)
qAni(ra, 1.5,0.5,0,-90,-10,0,2,ns,1)
local b1=qi{'Part',m2,sc=v3(0,0,0),bn='Really black',ref=0.4} local b1m=qi{'SpecialMesh',b1,mtyp='Sphere',sca=v3(2,2,2)*5} local b1w=qi{'Weld',b1,P0=Torso,P1=b1,C0=cn(0,0.5,-3)}
...
Anim='GE' OH:Heat(OH.Cost[Anim],true) 
Legs''
Sound(as.slash,Torso,1,1.5) AddBV(1,pTorso.CFrame,pTorso,0.4,true)
...
q(function()
local tcf=qi{'Part',m,tra=1,an=true,sc=v3(0,0,0),cf=pTorso.CFrame}
...
G={
function()
AddBV(10,pTorso.CFrame,pTorso,0.2,true)
...
AddBV(-22,pTorso.CFrame,pTorso,0.4,true)
wait(0.5)
AddBV(16,pTorso.CFrame,pTorso,0.4,true)
...
AddBV(10,pTorso.CFrame,pTorso,0.4,true)
qAni(hw,0,1.5,0,0,90,0,0,ns,1)
qAni(la,-0.5,0.5,-1,-90,90,0,2,ns,1)
qAni(ra, 1.5,0.5,0,0,0,-25,2,ns,1)
Legs''
