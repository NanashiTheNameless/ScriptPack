...
function RandomExplosionColor() colz={"New Yeller","Bright yellow","Neon orange","Deep orange","Black","Black"} return colz[rn(1,#colz)] end 
...
hd2.Mesh.TextureId="http://www.roblox.com/asset/?id=40467230 " 
...
local dbr=it("Model",workspace) local colz2="Black" if ts(dmge)=="Block!" then colz2="Bright blue" end 
...
wait() end 
if glo then GlowMesh(false,"Sphere",t,v3(glo,glo,glo),'Black',cn(bpos),0.1,1,0.08) end 
...
local bal = pa(c,"","Ball",4*sc,4*sc,4*sc,false,true,0.16,0,"Black") bal.CFrame = pos 
local spi = pa(c,"","Ball",0,0,0,false,true,0.16,0,"Black") spi.CFrame = bal.CFrame local spm = qi({"SpecialMesh",spi,MeshType="FileMesh",MeshId=Decs.SpikeBall}) 
...
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(25,0,0).p,4,2.5,"Black",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(-25,0,0).p,4,2.5,"Black",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,25,0).p,4,2.5,"Black",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,-25,0).p,4,2.5,"Black",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,0,25).p,4,2.5,"Black",0.3,0) 
Lightning(pos.p,pos*ca(rd(i*o),rd(i*o),rd(i*o))*cn(0,0,-25).p,4,2.5,"Black",0.3,0) 
...
local cor = db1:Clone() cor.Mesh.Scale=v3(sc,sc,sc)*5 local cor2 = db2:Clone() cor2.Mesh.Scale = cor.Mesh.Scale*1.55 qi({"Fire",cor,Color=bc('Black').Color,SecondaryColor=bc('Black').Color,Size=sc*3.5,Heat=0}) 
...
local lolpos = FindGround(cor.CFrame) if lolpos and i%rn(2,3)==0 then GlowMesh(false,Decs.Crown,t,v3(2.6*sc,0.8*sc,2.6*sc),'Black',cn(lolpos.p+v3(0,0.15*sc,0)),0.1,1,0.05) end 
wait() end cor.Fire:Remove() 
q(function() 
local n1 = pa(su,"","Block",0,0,0,true,true,0.3,0,"Black") qi({"SpecialMesh",n1,Scale=v3(3.5,3.5,8),MeshType="FileMesh",MeshId=Decs.Chakram}) 
...
local rip = pa(su,"","Block",1,1,1,false,true,0.2,0,"Black") local ripm = qi({"SpecialMesh",rip,MeshType="Sphere"}) 
...
local fis = pa(su,"","Block",0,0,0,false,true,0.2,0,"Black") local fism = qi({"SpecialMesh",fis,Scale=v3(8*sc,8*sc,8*sc),MeshType="FileMesh",MeshId=Decs.Fist}) 
for i=0.5,5.5,1 do fism.Scale = v3(8*sc,((8*sc)/5.5)*i,8*sc) fis.CFrame = pos*cn(0,0,-i*sc)*ca(rd(-90),rd(-90),0) wait() end 
fism.Scale = fism.Scale+v3(1*sc,1*sc,1*sc) fis.CFrame = pos*cn(0,5*sc,-5*sc)*ca(rd(45),0,0)*ca(rd(-90),rd(-90),0) rip.CFrame=pos*ca(rd(45),0,0) qi({"Fire",fis,Heat=-25,Size=15,Color=bc('Black').Color,SecondaryColor=bc('Black').Color}) 
...
local worm0 = pa(mm,"","Block",0,60,0,true,true,tr,0,"Black") qi({"SpecialMesh",worm0,Scale=v3(9*sca,12*sca,9*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=12137531"}) 
local worm1 = pa(mm,"","Block",10*sca,6*sca,10*sca,true,true,tr,0,"Black") it('CylinderMesh',worm1) 
local worm2 = pa(mm,"","Block",9.5*sca,6*sca,9.5*sca,true,true,tr,0,"Black") it('CylinderMesh',worm2) 
local worm3 = pa(mm,"","Block",9*sca,6*sca,9*sca,true,true,tr,0,"Black") it('CylinderMesh',worm3) 
local worm4 = pa(mm,"","Block",8.5*sca,6*sca,8.5*sca,true,true,tr,0,"Black") it('CylinderMesh',worm4) 
local worm5 = pa(mm,"","Block",8*sca,6*sca,8*sca,true,true,tr,0,"Black") it('CylinderMesh',worm5) 
local worm6 = pa(mm,"","Block",7.2*sca,6*sca,7.2*sca,true,true,tr,0,"Black") qi({"SpecialMesh",worm6,Scale=v3(4*sca,18.5*sca,4*sca),MeshType="FileMesh",MeshId="http://www.roblox.com/asset/?id=1033714"}) 
...
local tor = pa(su,"","Block",0,0,0,true,true,1,0,"Black") qi({"SpecialMesh",tor,Scale=v3(6.4*sc,8*sc,6.5*sc),MeshType="FileMesh",MeshId=Decs.Tornado}) 
...
wait(tyms) tpos = tor.Position local torm = tor.Mesh.Scale tor:Remove() GlowMesh(false,Decs.Tornado,t,torm*3,'Black',cn(tpos),0.2,1,0.05) 
end) end 
function CrownSwords(pos) q(function() 
local hol = pa(su,"","Block",1,1,1,false,true,0.1,0,"Black") qi({"SpecialMesh",hol,MeshType="Sphere"}) 
...
local swr = {} for i=1,14 do local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Black") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(4,4,4),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) ti(swr,swor) end 
local swr2 ={} for i=1,8 do local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Black") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(4,4,4),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) ti(swr2,swor) end 
local swor = pa(su,"","Block",0,0,0,false,true,0.2,0,"Black") qi({"SpecialMesh",swor,MeshType="FileMesh",Scale=v3(10,14,7.5),MeshId=Decs.SplinteredSky,TextureId=Decs.SplinteredSkyT,VertexColor=v3(0,0,0.8)}) 
...
swor.CFrame = hol.CFrame*cn(0,i-1,0)*ca(rd(90),0,0) GlowMesh(false,Decs.Crown,t,v3(5,10,5),'Black',swor.CFrame*ca(rd(-90),0,0),0.1,1,0.1) 
...
for i=0,7.5,2.5 do GlowMesh(false,Decs.Ring,t,v3(85-i,85-i,60-i),'Black',hol.CFrame*cn(0,3,0)*ca(rd(-90),0,0),0.1,1,0.05) wait(0.1) end 
...
GlowMesh(false,"Sphere",t,v3(12,12,12),'Black',v.CFrame,0.1,1,0.1) 
...
wait(rn(23,30)) 
for i,v in pairs({{"Black",v3(30,30,30)},{"Really black",v3(20,20,20)}}) do GlowMesh(false,"Sphere",t,v[2],v[1],bl.CFrame,0.1,1,0.1) end 
...
---- TUT01LOL 
han = pa(su,"","Block",0.4,0.4,0.4,false,false,0,0,"Black") it('CylinderMesh',han) 
...
han3 = pa(su,"","Block",0,0,0,false,false,0,1,"Black") qi({"SpecialMesh",han3,MeshType="Sphere",Scale=v3(0.4,0.4,0.4)*5}) 
...
for i=1,7 do 
des = pa(su,"","Block",0.4,0.2,0.4,false,false,0,0,"Black") it('CylinderMesh',des).Scale = v3(1,0.4,1) 
...
han8 = pa(su,"","Block",0,0,0,false,false,0.3,0.1,"Black") qi({"SpecialMesh",han8,MeshType="Sphere",Scale=v3(0.7,0.7,0.7)*5}) 
han8w = qi({"Weld",han2,Part0=han2,Part1=han8,C0=cn(0,2.9,0)*ca(0,0,0)}) 
han9 = pa(su,"","Block",0,0,0,false,false,0,0,"Black") qi({"SpecialMesh",han9,Scale=v3(0.25,1,0.25),MeshType="FileMesh",MeshId = Decs.Chakram3}) 
...
clawb1 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Black") qi({"SpecialMesh",clawb1,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike}) 
clawb1w = qi({"Weld",han2,Part0=clawa1,Part1=clawb1,C0=cn(0,0.15,0)}) 
clawb2 = pa(su,"","Block",0,0,0,false,false,0,0.4,"Black") qi({"SpecialMesh",clawb2,MeshType="FileMesh",Scale=v3(0.12,0.8,0.12),MeshId=Decs.Spike}) 
...
db1 = pa(su,"","Block",0,0,0,false,false,1,0,"Black") qi({"SpecialMesh",db1,MeshType="Sphere",Scale=v3(1,1,1)*5}) 
db1w = qi({"Weld",han2,Part0=laa,Part1=db1,C0=cn(0,-2,0)}) 
db2 = pa(su,"","Block",0,0,0,false,false,1,0.1,"Black") qi({"SpecialMesh",db2,MeshType="Sphere",Scale=v3(1.2,1.2,1.2)*5}) 
...
chak2 = pa(su,"","Block",0,0,0,false,false,0.1,0.1,"Black") qi({"SpecialMesh",chak2,Scale=v3(0.15,0.15,0.05)*5,MeshType="FileMesh",MeshId=Decs.Chakram2}) 
...
c1(raw,spd,3,1,0.5,0,0,0,-80) c2(raw,spd,3,1,0.4,0,0,0,-140) for i=1,5 do SpawnSword(FindGround(to.CFrame*cn(0,-2.75,-0.5+(-i*8)-i)),1+(i/10),15,"Black") wait(0.06) end 
...
Trail(bla3,15,0,"Black",0.65,cn(0,-0.2,-1)) rayHit(0.6,1,ra,ca(rd(-90),0,0),8,1.3) 
...
block.Value = true repeat wait(0.4) GlowMesh(true,chak2.Mesh.MeshId,chak2,chak2.Mesh.Scale*1.5,'Black',cn(0,0,0),chak2.Transparency,1,0.025) until not ky[k] for i=11,1,-1 do chak2.Reflectance = i/40 chak2.Mesh.Scale = spm*i wait() end chak2.Reflectance = 0 
...
local tpos = mouse.hit.p if (tpos - bla2.Position).magnitude < 350 then q(function() local to = pa(su,"","Block",2,1,2,false,true,0.1,0,"Black") it('CylinderMesh',to) local to2 = pa(su,"","Block",0,0,0,false,true,0.1,0,"Black") qi({"SpecialMesh",to2,Scale=v3(2,2,2),MeshType="FileMesh",MeshId=Decs.Totem}) 
...
for i=1,8 do Lightning(bla2.Position,tpos,math.floor((bla2.Position-tpos).magnitude/18)+1,1.5,"Black",0.3,0) wait(0.04) end fac = false 
caw = true q(function() wait(1) WormDrill(cn(tpos),rn(25,30)/10) end) c1(law,spd,3,-1.5,0.25,0,0,0,180) q(function() local to = pa(su,"","Block",1.5,1.5,1.5,false,true,0.1,0,"Black") qi({"SpecialMesh",to,MeshType="Sphere"}) for i=1,15,1 do to.Size=v3(1.5,i*2,1.5) to.CFrame=la.CFrame*cn(0,-2+(-i),0) wait() end GlowMesh(false,"Sphere",t,v3(35,35,35),'Black',la.CFrame*cn(0,-32,0),0.1,1,0.1) fade(to,0.1) end) 
...
local to = pa(su,"","Block",0,0,0,false,false,0.2,0,"Black") it('CylinderMesh',to).Scale=v3(9,0.2,9)*5 local tom = qi({"Weld",to,Part0=ra,Part1=to}) 
...
c2(raw,spd,3,1,0.5,-0.5,-70,-25,0) c2(law,spd,3,-1,0.5,-0.5,-70,25,0) c1(tw,spd,3,0,0,0,30,0,0) wait(0.2) GlowMesh(false,"Sphere",t,v3(9,15,12),'Black',to.CFrame,0.1,1,0.05) CrownSwords(to.CFrame*cn(0,-2.5,-3)) to.CFrame = to.CFrame*cn(0,0,30) GlowMesh(false,"Sphere",t,v3(9,15,12),'Black',to.CFrame,0.1,1,0.05) 
...
c2(raw,spd*1.4,3,1,0.5,-0.5,-45,-25,0) c1(law,spd*1.4,3,-1,0.5,-0.5,-45,25,0) GlowMesh(false,"Sphere",t,v3(15,1,15),'Black',to.CFrame*cn(0,-2.8,-5.5),0.1,1,0.03) 
...
local das = pa(su,"","Block",1.5,2.5,1.5,false,true,0.1,0,"Black") qi({"SpecialMesh",das,MeshType="Sphere"}) 
...
if ty%6==0 then GlowMesh(false,Decs.Crown,t,v3(3,6,3),'Black',to.CFrame*cn(0,0,3)*ca(rd(90),0,0),0.1,1,0.05) end 
end) ws(16) 
...
local pla = pa(su,"","Block",7,1,7,true,true,1,0,"Red") 
function ButtonDown() if Anim~="None" then return end 
to.Velocity=v3(0,0,0) if hu.Jump then GlowMesh(false,"Sphere",t,v3(8,2,8),'Black',to.CFrame*cn(0,-2,0),0.1,1,0.05) GlowMesh(false,Decs.Crown,t,v3(5,3,5),'Black',to.CFrame*cn(0,-1.5,0)*ca(rd(180),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,20,0) 
hu.Jump=false GlowMesh(false,"Sphere",t,v3(8,2,8),'Black',to.CFrame*cn(0,-4,0),0.1,1,0.05) 
else GlowMesh(false,"Sphere",t,v3(8,10,2),'Black',to.CFrame,0.1,1,0.05) 
GlowMesh(false,Decs.Crown,t,v3(5,3,5),'Black',to.CFrame*cn(0,0,1)*ca(rd(90),0,0),0.1,1,0.05) to.CFrame=to.CFrame*cn(0,0,-12) GlowMesh(false,"Sphere",t,v3(8,10,2),'Black',to.CFrame*cn(0,0,1),0.1,1,0.05) end 
pla.CFrame= to.CFrame*cn(0,-3.4,0) local orpos = pla.Position repeat wait(0.5) GlowMesh(false,"Sphere",t,v3(14,1,14),'Black',cn(orpos)*cn(0,0.5,0),0.1,1,0.02) until pla.Position~=orpos or (pla.Position-to.Position).magnitude>10 
...
bin.TextureId="http://www.roblox.com/asset/?id=78680783" 
bin.Parent=bp 
bin.Name = sn 
---- TUT03LOL 
...
--SCRIPTIS' CODE 
--Dominus Empryeus 
--Mesh: http://www.roblox.com/asset/?id=21057410 
--Texture: http://www.roblox.com/asset/?id=21057378 
