-- (NOT THE SCRIPT) Thanks to CyberFromLU for letting me Publish! REGULAR SCRIPT: Go to line 20 and 2524 and put your name where it says 
-------------------------------------------------------------------
Player = game:GetService("Players"):FindFirstChild("peyquinn")
Name = "SCAR-H"
selected = false
canDual = false
dual = false
