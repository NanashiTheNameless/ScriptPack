...
function fun(n1, n2)
	...
	local c2 = d:Clone()
	c2.BrickColor = BrickColor.new("Hot pink")
	...
	bln.BrickColor=BrickColor.new"Hot pink"
	bln.TopSurface = 0
	bln.BottomSurface = 0
	...
	brn.BrickColor=BrickColor.new"Hot pink"
	brn.TopSurface = 0
	brn.BottomSurface = 0
	...
	local we = fWeld("weldx", t1, t1, t2, true, 0, -0.9, -1.3, math.rad(-90), 0, 0)
	local n = t2.Neck
...
for _, p in pairs(game.Players:GetPlayers()) do
	...
	if #grr==2 then
		...
		wait()
		fun(grr[1].Character, grr[2].Character)
		grr={}
	end
end
