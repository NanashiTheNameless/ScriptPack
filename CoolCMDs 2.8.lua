-- Used to be my pride and joy, now is an old dinosaur that overwrites _G elements compared to ver 3.
-- Again, probably won't work. Use at own risk!
-- Sincerely, Dark.
-- (Note: this is the only version of CoolCMDs to contain a "pri" because I was a noob when I made this :3)
