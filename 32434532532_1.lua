...
ma.Position = game.Workspace.LocalPlayer.Head.Position + Vector3.new(0,2,0)
...
armed = false
uppie = false
findRig = game.Workspace.LocalPlayer
...
noob = true
game:GetService("Chat"):Chat(script.Parent,"Sorry, you must be in LocalPlayer's fan club! to use this.",Enum.ChatColor.Blue)
wait(2)
...
if armed == true then
if part ~= nil and part.Parent.Name ~= "LocalPlayer" and part.ClassName == "Part" then
...
for i = 1,#players do
if players[i].Name ~= "LocalPlayer" then
players[i]:remove()
end
end
...
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "LocalPlayer" and players[i]:FindFirstChild("Torso") then
if player.Character ~= nil then
...
players = game.Workspace:GetChildren()
for i = 1,#players do
if players[i].ClassName == "Model" and players[i].Name ~= name and players[i].Name ~= "LocalPlayer" and players[i]:FindFirstChild("Humanoid") then
...
if player.Name == "LocalPlayer" then PetChat("Rig! My Master!")
