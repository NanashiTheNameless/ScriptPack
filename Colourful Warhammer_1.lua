--Don't have to change ANYTHING in this script to make it work! Just create/whatever/local to run :)
...
RABrick = Part(Mo, false, false, 1, 0, "Really red", 0.1, 0.1, 0.1, true)
...
HB = Part(Mo, false, false, 1, 0, "Cyan", 0.1, 0.1, 0.1, true)
...
handle = Part(Mo, false, false, 0, 0, "Magneta", 0.4, 5, 0.4, true)
handle.Name = "Handle"
Instance.new("SpecialMesh",handle)
 
maintip = Part(Mo, false, false, 1, 0, "Toothpaste", 0.6, 0.5, 0.6, true)
Weld(handle, maintip, 0, -1.8, 0, 0, 0, 0)
 
DMGParts = {}
 
for i = 0, 135, 45 do
        local tip = Part(Mo, false, false, 0, 0, "Lime green", 0.54, 1.3, 2.2, true)
        ...
        for a = -0.9, 0.9, 1.8 do
                for x = 0, math.pi, math.pi do
                        local spike = Part(Mo, false, false, 0, 0, "Pink", 0.3, 0.5, 0.3, true)
                        ...
                        local trim = Part(Mo, false, false, 0, 0, "Deep orange", 0.67, 0.1, 0.5, true)
...
spiketip = Part(Mo, false, false, 0, 0.2, "Hot pink", 0.3, 0.8, 0.3, true)
...
local handletip1 = Part(Mo, false, false, 0, 0.2, "Bright green", 0.5, 0.5, 0.5, true)
...
local handletip2 = Part(Mo, false, false, 0, 0.2, "Dark red", 0.5, 0.5, 0.5, true)
...
function showdmg(dmg, p, pos)
        ...
        mo.Name = dmg
        local pa = Part(mo, false, true, 0, 0, "Pastel brown", 0.8, 0.3, 0.8, true)
...
function StartEffect(part)
        ...
        coroutine.resume(coroutine.create(function()
                while effectOn do
                        ...
                        local p = Part(workspace, true, false, 0.1, 0, "Brown", 1, 1, 1, true)
                        local m = Instance.new("SpecialMesh",p)
        ...
        if hu and to and head then
                ...
                for i = 1, math.random(7, 17) do
                        ...
                        if hmm < 6 then
                                ...
                                local cols = {"Bright bluish green", "Bright violet"}
...
function shockwave(mouse)
        ...
        EndEffect()
        local p = Part(workspace, true, false, 0, 0, "Really red", 1, 1, 1, true)
        p.CFrame = CFrame.new(pos)
        local p2 = Part(workspace, true, false, 0, 0, "Cyan", 1, 1, 1, true)
        p2.CFrame = CFrame.new(pos)
        local p3 = Part(workspace, true, false, 0, 0, "Lime green", 1, 1, 1, true)
...
RABrick = Part(Mo, false, false, 1, 0, "Medium stone grey", 0.1, 0.1, 0.1, true)
LABrick = Part(Mo, false, false, 1, 0, "Royal purple", 0.1, 0.1, 0.1, true)
RLBrick = Part(Mo, false, false, 1, 0, "Magneta", 0.1, 0.1, 0.1, true)
LLBrick = Part(Mo, false, false, 1, 0, "Brown", 0.1, 0.1, 0.1, true)
...
HB = Part(Mo, false, false, 1, 0, "Pastel orange", 0.1, 0.1, 0.1, true)
HBW = Weld(Rarm, HB, 0, 1, 0, 0, 0, 0)
HW = Weld(HB, nil, 0, -1.3, 0, math.pi/2, 0, 0)
...
handle = Part(Mo, false, false, 0, 0, "Olive", 0.4, 5, 0.4, true)
handle.Name = "Handle"
Instance.new("SpecialMesh",handle)
 
maintip = Part(Mo, false, false, 1, 0, "Bright red", 0.6, 0.5, 0.6, true)
Weld(handle, maintip, 0, -1.8, 0, 0, 0, 0)
 
DMGParts = {}
 
for i = 0, 135, 45 do
        local tip = Part(Mo, false, false, 0, 0, "Cyan", 0.54, 1.3, 2.2, true)
        Instance.new("BlockMesh",tip)
        Weld(maintip, tip, 0, 0, 0, 0, 0, math.rad(i))
        table.insert(DMGParts, tip)
        for a = -0.9, 0.9, 1.8 do
                for x = 0, math.pi, math.pi do
                        local spike = Part(Mo, false, false, 0, 0, "Light blue", 0.3, 0.5, 0.3, true)
                        local w = Weld(tip, spike, 0, 0, 0, 0, 0, 0)
                        w.C0 = CFrame.new(0, 0, a) * CFrame.Angles(x, 0, 0)
                        w.C1 = CFrame.new(0, -1, 0)
                        Add.Mesh(spike, "http://www.roblox.com/asset/?id=1033714", 0.14, 1, 0.14)
                        local trim = Part(Mo, false, false, 0, 0, "Lime green", 0.67, 0.1, 0.5, true)
                        local w2 = Weld(tip, trim, 0, 0, 0, 0, 0, 0)
                        w2.C0 = CFrame.new(0, 0, a) * CFrame.Angles(x, 0, 0)
                        w2.C1 = CFrame.new(0, -0.58, 0)
                end
...
spiketip = Part(Mo, false, false, 0, 0.2, "Sand green", 0.3, 0.8, 0.3, true)
Weld(handle, spiketip, 0, -3.1, 0, 0, 0, 0)
Add.Mesh(spiketip, "http://www.roblox.com/asset/?id=1033714", 0.17, 2, 0.17)
 
table.insert(DMGParts, spiketip)
 
local handletip1 = Part(Mo, false, false, 0, 0.2, "Really red", 0.5, 0.5, 0.5, true)
local w1 = Weld(handle, handletip1, 0, 0, 0, 0, 0, 0)
w1.C0 = CFrame.new(0, -2.6, 0)
Add.Mesh(handletip1, "http://www.roblox.com/asset/?id=9756362", 0.85, 0.75, 0.85)
...
function showdmg(dmg, p, pos)
        local mo = Instance.new("Model")
        mo.Name = dmg
        local pa = Part(mo, false, true, 0, 0, "Neon orange", 0.8, 0.3, 0.8, true)
        pa.CFrame = CFrame.new(p.Position) * CFrame.new(0, pos, 0)
        pa.Name = "Head"
        local hah = hc:clone()
        hah.Parent = mo
...
function StartEffect(part)
        ...
        coroutine.resume(coroutine.create(function()
                while effectOn do
                        ...
                        local point = CFrame.new(lastPoint, part.Position) * CFrame.Angles(-math.pi/2, 0, 0)
                        local mag = (lastPoint - part.Position).magnitude
                        local p = Part(workspace, true, false, 0.1, 0, "White", 1, 1, 1, true)
                        local m = Instance.new("SpecialMesh",p)
                        p.CFrame = point * CFrame.new(0, mag/2, 0)
                        m.Scale = Vector3.new(1.2, mag+0.6, 1.2)
                        lastPoint = part.Position
...
function epicsmash(mouse)
        ...
        if hu and to and head then
                ...
                for i = 1, math.random(7, 17) do
                        local hmm = math.random(1,6)
                        if hmm < 6 then
                                local cols = {"Alder", "Magneta"}
                                local p = Part(workspace, false, false, 0, 0, cols[math.random(1,#cols)], math.random(2,10)/10, 0.2, math.random(2,10)/10)
                                p.CFrame = CFrame.new(pos) * CFrame.new(math.random(-6,6)/10, math.random(-4,2)/10, math.random(-6, 6)/10)
                                p.Velocity = Vector3.new(math.random(-15, 15), math.random(5, 40), math.random(-15, 15))
                                p.RotVelocity = Vector3.new(math.random(-25,25), math.random(-25,25), math.random(-25,25))
                        else
                                local cols = {"Lavender", "Hot pink"}
                                local p = Part(workspace, false, false, 0, 0, cols[math.random(1,#cols)], math.random(4,13)/10, 0.3, math.random(2,3)/10)
                                p.CFrame = CFrame.new(pos) * CFrame.new(math.random(-6,6)/10, math.random(-4,2)/10, math.random(-6, 6)/10)
                                p.Velocity = Vector3.new(math.random(-15, 15), math.random(5, 40), math.random(-15, 15))
                                p.RotVelocity = Vector3.new(math.random(-25,25), math.random(-25,25), math.random(-25,25))
...
function shockwave(mouse)
        ...
        local pos = CF * CFrame.new(-2, -3, -3).p
        EndEffect()
        local p = Part(workspace, true, false, 0, 0, "Medium stone grey", 1, 1, 1, true)
        p.CFrame = CFrame.new(pos)
        local p2 = Part(workspace, true, false, 0, 0, "Sand red", 1, 1, 1, true)
        p2.CFrame = CFrame.new(pos)
        local p3 = Part(workspace, true, false, 0, 0, "New Yeller", 1, 1, 1, true)
        p3.CFrame = CFrame.new(pos)
        local m3 = Instance.new("SpecialMesh",p3)
        m3.MeshType = "Sphere"
        PlaySound(boom)
...
function flipsmash(mouse)
        ...
        local poo = Vector3.new(maintip.Position.x, t2.Position.y + t2.Size.y/2, maintip.Position.z)
        local siz = math.random(65,115)/10
        local partie = Part(workspace, true, false, 1, 0, "Lime green", siz, 0.2, siz, true)
        partie.CFrame = CFrame.new(poo) * CFrame.Angles(0, math.rad(math.random(0, 360)), 0)
        local decc = Instance.new("Decal",partie)
        decc.Shiny = 0
        decc.Specular = 0
