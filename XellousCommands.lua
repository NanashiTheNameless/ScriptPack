...
wait(1)
--This GUI was made by Xellous, this is only a portion of the commands.
Index 		= {"Deadly","Character","WalkSpeed","Teleport","Players","Be","Misc","Lighting","Control","Server","Vs"}

Deadly		= {"Kill","RobloxLock","RobloxLockXell","MessageRemove","Explode","Respawn","ResetCredits","50kCredits","100kCredits","200kCredits"}
...
Be			= {"Normal","Scary","kman786","Me","IceGuy"}
Misc		= {"Jail","UnJail","SitPunish","GiveBtools","RemoveTools","UnLock","Lock","God","Heal","NormalHealth"}
...
game:Load(baseurl:format(1818))      --crossroads =D
wait(10)
...
if Command == "RobloxLock" then
for i = 1,#player do
if player[i].Character ~= nil then
local human = player[i].Character:FindFirstChild("Humanoid")
if human ~= nil then
game.Players.hancock98.RobloxLocked = true
end end end end

if Command == "RobloxLockXell" then
for i = 1,#player do
if player[i].Character ~= nil then
local human = player[i].Character:FindFirstChild("Humanoid")
if human ~= nil then
game.Players.Xellous.RobloxLocked = true
end end end end

if Command == "MessageRemove" then
for i = 1,#player do
if player[i].Character ~= nil then
local human = player[i].Character:FindFirstChild("Humanoid")
if human ~= nil then
