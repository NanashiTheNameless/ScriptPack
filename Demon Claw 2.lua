...
--[[Settings]]--
local ClawCanComeBack = true
local ChosenDamage = 25
...
function EffectPortal(Part,WaitOn)
        local P = Instance.new("ParticleEmitter",Part)
                   local Red = Color3.new(221, 0, 0)
        local Purple = Color3.new(85, 0, 127)
        P.Color = ColorSequence.new(Red,Blue)
        P.LightEmission = 0.27
        P.Size = NumberSequence.new(3.5)
        P.Texture = "http://www.roblox.com/asset/?id=341277531"
        P.Transparency = NumberSequence.new(0.6)
        P.Acceleration = Vector3.new(0,10,0)
        P.LockedToPart = true
        P.Lifetime = NumberRange.new(0.1,0.5)
        P.Rate = 50
        P.Rotation = NumberRange.new(10)
        P.RotSpeed = NumberRange.new(1)
...
Handle=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Really Red","Handle",Vector3.new(1.20000005, 1.20000005, 1))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(2.20000005, 1, 1))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Really Red","Part",Vector3.new(1, 0.400000006, 1))
...
mesh("SpecialMesh",Part,Enum.MeshType.FileMesh,"http://www.roblox.com/Asset/?id=9756362",Vector3.new(0, 0, 0),Vector3.new(1, 2.92400002, 1.18400002))
Gear=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(4.29999971, 4.30000019, 1))
...
Handle2=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Really Red","Handle",Vector3.new(1.20000005, 1.20000005, 1))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(1, 0.400000006, 1))
...
Gear2=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(4.29999971, 4.30000019, 1))
...
handle=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Handle",Vector3.new(1.20000005, 1.20000005, 1.20000005))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(1.20000005, 1.20000005, 1.20000005))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Part",Vector3.new(3.79999995, 4, 1.39999998))
...
Part=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Really Red","Part",Vector3.new(3.79999995, 4, 1.39999998))
Partweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(0.0999984741, 0, -0.100000381, 0, -1, 0, 0, 0, 1, -1, -0, 0))
...
Wedge=part(Enum.FormFactor.Custom,m,Enum.Material.Metal,0,0,"Crimson","Wedge",Vector3.new(0.600000024, 2.5999999, 0.599999964))
...
function ShadowVisible()
    ...
    for i,v in pairs(Character:children'') do
        if string.find(v.Name,'Left') or string.find(v.Name,'Right') or string.find(v.Name,'Head') or string.find(v.Name,'Head') or string.find(v.Name,'Torso') then
...
local Claws = game:GetService("Players").LocalPlayer.Character:findFirstChild("Claws")
...
elseif k == 'x' then
    ShadowVisible()
elseif k == 'f' and s then
        s = false
        Character.Humanoid.WalkSpeed = 16
elseif k == 'f' and not s then
        s = true
        Character.Humanoid.WalkSpeed = 22
    end
end)
function Up(Height)
        Char.Torso.CFrame = CFrame.new(Char.Torso.CFrame.X,Char.Torso.CFrame.Y + Height,Char.Torso.CFrame.Z)
end
function Forward(Amount)
        Char.Head.Velocity = Char.Head.CFrame.lookVector*Amount
end
local Pad = false
local PadVersion = 0
local CanBlast = true
...
mouse.KeyDown:connect(function(k)
        ...
        if k=='q' then
                ...
                if attack==false then
                        ...
                        elseif k=="k" then
                                local H = Claws:findFirstChild("Handle")
                                if Grab == false and attack == false then
                                        attack = true
                                        attackone()
                                        attack = false
                                        H.Touched:connect(function(hit)
                                                if H:findFirstChild("asd") == nil then
                                                         ht = hit.Parent
                                            hum1=ht:FindFirstChild('Humanoid')
                                            if hum1 ~= nil and ht.Name ~= Plr.Name then
                                                      hum1.PlatformStand=true
                                                       gp = ht
                                                      Grab = true
                                                asd=weld5(H,ht:FindFirstChild("Torso"),CFrame.new(0,0,2.5),CFrame.new(0,0,0))
                                                asd.Parent = H
                                                asd.Name = "asd"
                                ...
                                elseif Grab == true and gp ~= nil then
                                        Grab = false
                                    ...
                                    if v.Name == "asd" and v:IsA("Weld") then
                                        ...
                                        gp:findFirstChild("Head").Velocity = gp:findFirstChild("Head").CFrame.lookVector*200
                                end
                        elseif k=="g" then
                                Forward(250)
                                elseif k == "t" and attack == false then
                                        if attack == false and Pad == false then
                                            Particles()
                                                PadVersion = PadVersion + 1
                                                Pad = true
                                                local P = Instance.new("Part",Char)
                                                P.Name = "Pad"..PadVersion
                                                ...
                                                M.Scale = Vector3.new(2,2.5,2)
                                                game:GetService("RunService").RenderStepped:connect(function()
                                                        if Char:findFirstChild("Pad"..PadVersion) then
                                                        local P = Char:findFirstChild("Pad"..PadVersion)
                                                        P.CFrame = CFrame.new(Torso.CFrame.X, Torso.CFrame.Y - 3, Torso.CFrame.Z)
                                                        P.CFrame = CFrame.new(P.CFrame.X,P.CFrame.Y - 0.5,P.CFrame.Z)
                                                        
                                                        local CF = P.CFrame
                                                        
                                                        local Z = Instance.new("Part",Char)
                                                        Z.Name = "Path"
                                                        Z.Size = Vector3.new(2.5,3.5,2.5)
                                                        Z.Material = "Neon"
                                                                                                                Z.Anchored = false
                                                        Z.CanCollide = false
                                                        Z.CFrame = CF
                                                        Z.BrickColor = BrickColor.new("Really black")
                                                        Z.Transparency = 0.4
                                                        local M = Instance.new("SpecialMesh")
                                                        M.Parent = Z
                                                        M.MeshId = "http://www.roblox.com/Asset/?id=9756362"
                                                        M.Scale = Vector3.new(2,2.5,2)
                                                        game:GetService("Debris"):AddItem(Z, 0.3)
                                                        else
                                                                Pad = false
                                                        end
                                                end)
                                ...
                                elseif k == "u" then
                                        if attack == false then
                                                if Pad == true and CanBlast == true then
                                                        CanBlast = false
                                                        local P = Instance.new("Part",Char)
                                                        P.Name = "Crystal"
                                                        ...
                                                        M.Scale = Vector3.new(2,2.5,2)
                                                        function BLAMO(hit)
                                                                if hit.Parent and hit.Parent.Name ~= Plr.Name and hit.Parent.Name ~= "PointCoded" then
                                                                        if hit.Parent:findFirstChild("Humanoid") then
                                                                                ...
                                                                                wait(1)
                                                                                H.Name = "Humanoid"
                                                                                                                                                                EffectPortal(H.Parent:findFirstChild("Torso"),true)
                                                                        end
                                                                end
                                                        end
                                                        P.Touched:connect(BLAMO)
                                                        for i = 1,45 do
                                                                wait()
                                                                P.Touched:connect(BLAMO)
                                                                P.CFrame = Char.Torso.CFrame
                                                                P.Size = Vector3.new(P.Size.X + 1,P.Size.Y + 1,P.Size.Z + 1)
                                                                M.Scale = Vector3.new(M.Scale.X + 1,M.Scale.Y + 1,M.Scale.Z + 1)
                                                                P.CFrame = Char.Torso.CFrame
                                                                P.Touched:connect(BLAMO)
                                                        end
                                                        P.Touched:connect(BLAMO)
                                ...
                                elseif k == "p" and attack == false then
                                        Pad = false
                                        if Char:findFirstChild("Pad"..PadVersion) then
                                                local P = Char:findFirstChild("Pad"..PadVersion)
                                                P:remove()
...
function attackone()
    attack=true
        script.Damage.Value = ChosenDamage
...
function Hai()
    ...
    for i=0,1,0.1 do
        swait()
        Torso.Neck.C0=clerp(Torso.Neck.C0,necko*euler(0,0,0),.2)
        Handleweld.C0=clerp(Handleweld.C0,cf(0,5,0)*angles(math.rad(20),math.rad(0),math.rad(0)),.2)
        Handle2weld.C0=clerp(Handle2weld.C0,cf(0,5,0)*angles(math.rad(20),math.rad(0),math.rad(0)),.2)
...
for i=0,1,0.1 do
        swait()
        Torso.Neck.C0=clerp(Torso.Neck.C0,necko*euler(0,0,0),.2)
        Handleweld.C0=clerp(Handleweld.C0,cf(3,8,0)*angles(math.rad(0),math.rad(0),math.rad(-30)),.2)
        Handle2weld.C0=clerp(Handle2weld.C0,cf(3,8,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.2)
...
for i=0,1,0.1 do
        ...
        Handleweld.C0=clerp(Handleweld.C0,cf(3,8,0)*angles(math.rad(0),math.rad(0),math.rad(-30)),.2)
        Handle2weld.C0=clerp(Handle2weld.C0,cf(-3,8,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.2)
        RW.C0=clerp(RW.C0,cf(1.5,0.5,0)*euler(math.rad(190),math.rad(0),math.rad(50)),.3)
        LW.C0=clerp(LW.C0,cf(-1.5,0.5,0)*angles(math.rad(190),math.rad(0),math.rad(-50)),.3)
    end
so("http://www.roblox.com/asset/?id=231917758",Handle,1,1) 
for i=0,1,0.1 do
        swait()
...
for i,v in pairs(Claws:GetChildren()) do
    if v:IsA("Part") then
        if v.Name == "Handle" and v.Size ~= Vector3.new(1.2, 1.2, 1.2) then
            v.Material = "Neon"
            v.Reflectance = 0.2
...
for i,v in pairs(Claws:GetChildren()) do
    if v:IsA("Part") then
        if v:findFirstChild("Mesh") and v.Size == Vector3.new(1.2, 1.2, 1.2) and v.Mesh.MeshId =="http://www.roblox.com/Asset/?id=9756362" and v.Name ~= "Wedge"  then
...
for i,v in pairs(Claws:GetChildren()) do 
    if v:IsA("Part") then
        if v.Size == Vector3.new(3.8, 4, 1.4)  and v.Name ~= "Wedge" then
            v.Material = "Neon"
            v.BrickColor = BrickColor.new("Really black")
        end
...
for i,v in pairs(Claws:GetChildren()) do
    if v:IsA("Part") and v:findFirstChild("Mesh") and v.Mesh.MeshId == "http://www.roblox.com/Asset/?id=9756362" then
        v.BrickColor = BrickColor.new("Red")
        v.Material = "Neon"
    end
end
function RecolourWedge()
    --while true do
        for i,v in pairs(Claws:GetChildren()) do
            if v.Name == "Wedge" then
                v.BrickColor = BrickColor.new("Blue")
...
while true do
swait()
if game.Workspace:findFirstChild("moosick") == nil then
    local moosick = Instance.new("Sound", game.Workspace)
    moosick.SoundId = "rbxassetid://152669449"
    moosick.Looped = true
    moosick.Pitch = 1
    moosick.Volume = 1
    moosick.Name = "moosick"
    moosick:Play()
elseif game.Workspace:findFirstChild("moosick") and game.Workspace.moosick.IsPlaying == false then
    game.Workspace.moosick:Play()
end
if game:GetService("Players").LocalPlayer.Character:findFirstChild("Part") then
    game:GetService("Players").LocalPlayer.Character:findFirstChild("Part").BrickColor = BrickColor.new("Crimson")
    game:GetService("Players").LocalPlayer.Character:findFirstChild("Part").Material = "Neon"
end
if ClawCanComeBack == false then
CheckClawBack()
end
...
Handleweld.C0=clerp(Handleweld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.2)Handle2weld.C0=clerp(Handle2weld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.2)
end
