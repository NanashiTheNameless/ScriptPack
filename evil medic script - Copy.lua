...
game.workspace.luxulux.hit.Touched:connect(KillPlayer)
function knifes()
healing = true
knife = true
me = game.workspace.luxulux
...
wait(0.01)
wait(1)
game.workspace.luxulux.bl:remove()
game.workspace.luxulux.bsz:remove()
knife = false
healing = false
game.workspace.luxulux.left:remove()
end
function healn()
la = game.workspace.luxulux.Torso["Left Shoulder"]
ra = game.workspace.luxulux.Torso["Right Shoulder"]
...
if life ~= nil then
dis = (game.workspace.luxulux.Torso.Position - mouse.Hit.p).magnitude
if dis<7 then
...
local colors = {"Green","Green","Green"} -- The only 3 colors, adding more will error.
                        local chat = game:GetService("Chat")
                        chat:Chat( game.workspace.luxulux.Head,speak[math.random(1,#speak)], colors[math.random(1,3)] )
man.Humanoid.WalkSpeed = 0
man.Torso.CFrame = game.workspace.luxulux.d.CFrame + Vector3.new(0,0,0)
...
sg.maxForce = Vector3.new(104000,2004000, 1044000) 
                        sg.Name = "crouch"
                        sg.position = game.workspace.luxulux.Torso.Position + Vector3.new(0,-1.3,0)
                        sg.Parent = game.workspace.luxulux.Torso
game.workspace.luxulux.Torso["Left Hip"].C0 = CFrame.new(-1,-1,-1)*CFrame.fromEulerAnglesXYZ(-1.3,-1.6,0)
game.workspace.luxulux.Torso["Right Hip"].C0 = CFrame.new(1,0,-0.8)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
me = game.workspace.luxulux
...
game.workspace.luxulux.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.luxulux.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.luxulux.Torso["Right Shoulder"].C0 = CFrame.new(1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.luxulux.Torso["Left Shoulder"].C0 = CFrame.new(-1,0.5,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.luxulux.bottem:remove()
game.workspace.luxulux.botle:remove()
game.workspace.luxulux.botle:remove()
game.workspace.luxulux.botle:remove()
lg:remove()
sg:remove()
wait(0)
game.workspace.luxulux.d:remove()
...
game.workspace.luxulux.Humanoid.WalkSpeed = 16
game.workspace.luxulux.fib:remove()
game.workspace.luxulux.fib:remove()
game.workspace.luxulux.fib:remove()
game.workspace.luxulux.fib:remove()
game.workspace.luxulux.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
...
sg.maxForce = Vector3.new(104000,2004000, 1044000) 
                        sg.Name = "crouch"
                        sg.position = game.workspace.luxulux.Torso.Position + Vector3.new(0,-1.3,0)
                        sg.Parent = game.workspace.GRENADESPARTAN3.Torso
game.workspace.luxulux.Torso["Left Hip"].C0 = CFrame.new(-1,-1,-1)*CFrame.fromEulerAnglesXYZ(-1.3,-1.6,0)
game.workspace.luxulux.Torso["Right Hip"].C0 = CFrame.new(1,0,-0.8)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
me = game.workspace.luxulux
me.Humanoid.WalkSpeed = 0
...
sg:remove()
man.Humanoid.WalkSpeed = 16
game.workspace.luxulux.Humanoid.WalkSpeed = 25
man.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
man.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
game.workspace.luxulux.Torso["Left Hip"].C0 = CFrame.new(-1,-1,0)*CFrame.fromEulerAnglesXYZ(0,-1.6,0)
game.workspace.luxulux.Torso["Right Hip"].C0 = CFrame.new(1,-1,0)*CFrame.fromEulerAnglesXYZ(0,1.6,0)
...
wait(0.1)
game.workspace.GRENADESPARTAN3.Torso.Velocity = Vector3.new(math.random(-40,40),math.random(40,60),math.random(-40,40))
