...
RABrick = Part(Mo, false, false, 1, 0, "New Yeller", 0.1, 0.1, 0.1, true)
LABrick = Part(Mo, false, false, 1, 0, "New Yeller", 0.1, 0.1, 0.1, true)
RLBrick = Part(Mo, false, false, 1, 0, "New Yeller", 0.1, 0.1, 0.1, true)
LLBrick = Part(Mo, false, false, 1, 0, "New Yeller", 0.1, 0.1, 0.1, true)
gripBrick = Part(Mo, false, false, 1, 0, "New Yeller", 0.1, 0.1, 0.1, true)
...
handle = Part(Mo, false, false, 0, 0, "Really black", 0.2, 0.8, 0.3, true)
handle.Name = "Handle"
...
blade = Part(Mo, false, false, 0, 0.1, "New Yeller", 0.2, 1.15, 0.3, true)
blade.Name = "Blade"
Instance.new("BlockMesh", blade).Scale = Vector3.new(0.1, 1, 0.8)
 
bladetip = Part(Mo, false, false, 0, 0.1, "New Yeller", 0.2, 0.3, 0.3, true)
bladetip.Name = "Tip"
bladetipmesh = Instance.new("SpecialMesh", bladetip)
bladetipmesh.MeshType = "Wedge"
bladetipmesh.Scale = Vector3.new(0.1, 1, 0.8)
 
sheath = Part(Mo, false, false, 0, 0, "Really black", 0.3, 1.5, 0.4, true)
sheath.Name = "Sheath"
...
Weld(guard, blade, 0, -0.575, 0, 0, 0, 0)
Weld(blade, bladetip, 0, -0.725, 0, 0, 0, 0)
