...
--_G.Damage(tTorso,game.Players.rigletto,math.huge,"Bow")
elseif hit.Parent.Parent ~= nil and hit.Parent.Parent:FindFirstChild("Humanoid") ~= nil then
--hum = hit.Parent.Parent.Humanoid
...
--[[	if attackdebounce == false then 
	...
	if h~=nil and hit.Parent.Name~=game.workspace.CurrentCamera and hit.Parent:FindFirstChild("Torso")~=nil then
		Damage=Damage
