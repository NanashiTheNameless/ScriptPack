...
game:GetService("Chat"):Chat(Workspace.ralf2234.Head,"I have one last Trump Card on my sleeve Mangekyo Sharingan!...")
wait()
game:GetService("Chat"):Chat(Workspace.ralf2234.Head,"SUSANOO!")
wait(1)
 
Workspace.ralf2234.Humanoid.MaxHealth = math.huge
Workspace.ralf2234.Humanoid.WalkSpeed = 30
Workspace.ralf2234["Left Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ralf2234.Torso.BrickColor = BrickColor.new("Cool yellow")
Workspace.ralf2234.Head.BrickColor = BrickColor.new("Cool yellow")
Workspace.ralf2234["Right Arm"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ralf2234["Left Leg"].BrickColor = BrickColor.new("Cool yellow")
Workspace.ralf2234["Right Leg"].BrickColor = BrickColor.new("Cool yellow")
...
Katana = Instance.new("Part",Workspace.ralf2234)
