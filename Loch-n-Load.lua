...
local prt1=part(3,modelzorz,0,1,BrickColor.new("Really black"),"Part1",vt(1,1,1))
...
local prt17=part(3,modelzorz,0,0,BrickColor.new("Really black"),"Part17",vt(1,1,1))
...
local prt20=part(3,modelzorz,0,0,BrickColor.new("Really black"),"Part20",vt(1,1,1))
local prt21=part(3,modelzorz,0,0,BrickColor.new("Really black"),"Part21",vt(1,1,1))
local prt22=part(3,modelzorz,0,0,BrickColor.new("Really black"),"Part22",vt(1,1,1))
...
dmode.Name="Bomb"
local bprt1=part(3,dmode,0,0,BrickColor.new("Really black"),"Bomb Part1",vt(1,1,1))
...
wait(5)
so("http://www.roblox.com/asset?id=133680244",Bomb,3,1) 
Bomb.Transparency=1
b=it("Explosion")
b.Parent=workspace
...
wait(4+math.random())
so("http://www.roblox.com/asset?id=133680244",Bombeh,3,1) 
b=it("Explosion")
b.Parent=workspace
...
if count~=2 then
coroutine.resume(coroutine.create(function()
so("http://www.roblox.com/asset?id=131632972",prt26,1,1)
shoottrail(mouse)
end))
dynamiteammo=false
for i=0,1,0.5 do
...
reloading=true
attack=true
so("http://roblox.com/asset/?id=131072992",prt1,1,0.7)
for i=0,1,0.2 do
wait()
...
so("http://roblox.com/asset/?id=131072992",dynamite,1,1)
for i=0,1,0.2 do
wait()
...
reloading=true
attack=true
so("http://roblox.com/asset/?id=10209869",prt1,1,0.8)
for i=0,1,0.2 do
wait()
wld10.C0=euler(0,0.785*i,0)*cf(0,0,0)
Neck.C1=necko2*euler(-offset+0.3*i,0,0)
...
bwld4.Part1=prt13
bwld4.C0=cf(0,2,0)
so("http://roblox.com/asset/?id=10209845",bprt1,1,1)
for i=0,1,0.2 do
wait()
LW.C0=cf(-1.5+0.5, 0.5, -0.7) * euler(1.2-0.5*i,0,-0.1)
LW.C1=cf(0, 0.5, 0) * euler(0.2,0,0)
