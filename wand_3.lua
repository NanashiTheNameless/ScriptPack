...
prop(effball, wand, false, 0.3, 0.02, 1, 1, 1, math.random(1, 100)) 
...
if m == 2 then 
mouse.Target.Parent = me.Character
end 
if m == 3 then 
mouse.Target.BrickColor = BrickColor.new(math.random(1, 120))
end 
if m == 4 then 
ff = Instance.new("ForceField") 
ff.Parent = mouse.Target 
end 
if m == 5 then 
ff = Instance.new("Smoke") 
ff.Parent = mouse.Target 
end 
if m == 6 then 
