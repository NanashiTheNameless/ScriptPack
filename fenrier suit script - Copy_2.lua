if Parent ~= game.Players.FangxWulf then
...
feezly = game.workspace.FangxWulf
...
SuitHolder.Parent = game.Players:findFirstChild("FangxWulf").Character;
...
game.workspace.FangxWulf.Torso.Transparency = 0
--[[Main]]
 
pa1 = Instance.new("Part")
pa1.Name = "Main"
pa1.Parent = game.Players.FangxWulf.Character  
...
w1.Parent = pa1
w1.Part0 = w1.Parent
w1.Part1 = game.Players.FangxWulf.Character["Torso"]
...
pa2.Name = "RWing"
pa2.Parent = game.Players.FangxWulf.Character  
...
pa3.Name = "RWing"
pa3.Parent = game.Players.FangxWulf.Character  
...
pa4.Name = "RTip"
pa4.Parent = game.Players.FangxWulf.Character  
...
pa5.Name = "LTip"
pa5.Parent = game.Players.FangxWulf.Character  
...
FF.Parent = game.workspace.FangxWulf
game.workspace.FangxWulf.Humanoid.MaxHealth = math.huge
game.workspace.FangxWulf.Humanoid.Health = math.huge
wait(10)
FF:Remove()
game.workspace.FangxWulf.Humanoid.MaxHealth = 100
end
if (key == "Z") then
...
Bomb.Parent = game.Workspace.FangxWulf
...
xplode.Parent = game.workspace.FangxWulf.Bomb
xplode.Position = game.workspace.FangxWulf.Bomb
wait(0.2)
...
if (key == "B") then
game.workspace.FangxWulf.Torso.T.Partsword.Transparency = 1
-----Right Arm Sword
...
prt1.Parent = game.workspace.FangxWulf
local obj1 = Instance.new("SpecialMesh");
obj1.Parent = prt1;
obj1.MeshType = Enum.MeshType.FileMesh;
obj1.MeshId = "http://www.roblox.com/asset/?id=24712232";
...
w1.Parent = prt1
w1.Part0 = prt1
w1.Part1 = game.workspace.FangxWulf["Right Arm"]
...
prt2.Parent = game.workspace.FangxWulf
local w1 = Instance.new("Weld")
w1.Parent = prt2
w1.Part0 = prt2
w1.Part1 = game.workspace.FangxWulf["Right Arm"]
...
if (key == "X") then
game.workspace.FangxWulf.Sword2.Weld:Remove()
game.workspace.FangxWulf.Sword.Weld:Remove()
game.workspace.FangxWulf.Sword.Parent = game.workspace
game.workspace.FangxWulf.Sword2.Parent = game.workspace
local w1 = Instance.new("Weld")
...
wait()
game.workspace.Sword2.Velocity = game.workspace.FangxWulf["Right Arm"].CFrame.lookVector*100
game.workspace.Sword.Velocity = game.workspace.FangxWulf["Right Arm"].CFrame.lookVector*100
game.workspace.FangxWulf.Sword2.Touched:connect(function(hit) kill(b,hit) end)
        function kill(brick,hit)
                if hit.Parent:FindFirstChild("Humanoid") ~= nil and hit.Name ~= "Base" and hit.Parent.Name ~= "FangxWulf" then
...
if (key == "C") then
wait(1)
game.workspace.FangxWulf.Torso.Neck.C1 = CFrame.fromEulerAnglesXYZ(0.50,3.14,0) * CFrame.new(0,0,-0.5)
DisableLimb(1)
DisableLimb(2)
Joints[1].MaxVelocity = 1
SetAngle(1, 3.14)
Joints[2].MaxVelocity = 1
SetAngle(2, 3.14)
game.workspace.FangxWulf.Humanoid.WalkSpeed = 0
...
blar.Parent = game.workspace.FangxWulf
blar.Position = game.workspace.FangxWulf.Torso.Position
...
wait(0.5)
game.workspace.FangxWulf.Torso.Neck.C1 = CFrame.fromEulerAnglesXYZ(1.50,3.14,0) * CFrame.new(0,0,-0.5)
Joints[1].MaxVelocity = 0.1
Joints[2].MaxVelocity = 0.1
EnableLimb(1)
EnableLimb(2)
FF:Remove()
game.workspace.FangxWulf.Humanoid.PlatformStand = true
wait(5)
game.workspace.FangxWulf.Humanoid.PlatformStand = false
game.workspace.FangxWulf.Humanoid.WalkSpeed = 16
end
if (key == "[") then
game.workspace.FangxWulf.Humanoid.PlatformStand = true
Anim = game.workspace.FangxWulf.Animate:Clone()
Anim.Parent = Lighting
game.workspace.FangxWulf.Animate:Remove()
game.workspace.FangxWulf.Humanoid.WalkSpeed = 0
local p=Instance.new("Part")
p.Parent=game.Players.FangxWulf.Character
p.Name="BRICK"
p.Size=Vector3.new(5,7,5)
p.Transparency = 0.4
p.Reflectance = 0.5
p.BrickColor = BrickColor.Blue()
p.Position = game.workspace.FangxWulf.Torso.Position
...
wait(15)
game.workspace.FangxWulf.Humanoid.PlatformStand = false
Anim.Parent = game.workspace.FangxWulf
p:Remove()
game.workspace.FangxWulf.Suit2:Remove()
game.workspace.FangxWulf.Humanoid.WalkSpeed = 30
senro = game.Players.FangxWulf.Character
...
S.Parent = game.workspace.FangxWulf.Torso
        function onTouched(hit)
        h = hit.Parent:findFirstChild("Humanoid")
        if h ~= nil then
        ...
        game.workspace.FangxWulf.Torso.Touched:connect(onTouched)
end
game.Workspace.FangxWulf.Torso.Touched:connect(onTouched)
end
if (key == "M") then
game.workspace.FangxWulf.Torso.T.Partsword.Transparency = 0
game.workspace.FangxWulf.Sword:Remove()
game.workspace.FangxWulf.Sword2:Remove()
end
if (key == "'") then
game.workspace.FangxWulf.Humanoid.Jump = true
wait()
game.Players.FangxWulf.Character.Torso.Velocity = Vector3.new(0, 400, 0)
wait(1)
BodyP = Instance.new("BodyPosition")
BodyP.Parent = game.workspace.FangxWulf.Torso
BodyP.position = game.workspace.FangxWulf.Torso.Position + Vector3.new(0, 10, 0)
BodyP.maxForce = Vector3.new(4e+050, 4e+050, 4e+050)
BodyG = Instance.new("BodyGyro")
BodyG.Parent = game.workspace.FangxWulf.Torso
BodyV = Instance.new("BodyVelocity")
BodyV.Parent = game.workspace.FangxWulf.Torso
BodyV.velocity = Vector3.new(0, 0, 0)
BodyV.maxForce = Vector3.new(0, 0, 0)
wait(1)
        local Brick = Instance.new("Part")
        ...
        Brick.Position = game.workspace.FangxWulf.Torso.Position + Vector3.new(math.random(-70,70),0,math.random(-70,70))
        function onTouched(hit)
        ...
        force.Parent = game.workspace.FangxWulf.Torso
        rot.Parent = game.workspace.FangxWulf.Torso
        gyr.Parent = game.workspace.FangxWulf.Torso
wait(0.1)
        local Brick = Instance.new("Part")
        Brick.Parent = game.workspace
        Brick.BottomSurface = 0
...
gyr:Remove()
wait(5)
game.workspace.FangxWulf.Torso.Anchored = false
BodyP:Remove()
BodyG:Remove()
BodyV:Remove()
end
...
Voice.Parent = game.Players.FangxWulf.Backpack["Commands on a tool"]
Voice.Name = "Voice"
...
Main=function()
        ...
        h = Instance.new("Hint")
        h.Parent = Target
        h.Text = "You just got pwned by FangxWulf XP"
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.1
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.2
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.3
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.4
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.5
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.6
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.7
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.8
wait(0.1)
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0.9
wait(0.1)
head.Transparency = 0
...
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 1
wait(0.1)
game.workspace.FangxWulf.Head.Transparency = 1
end
if (key == "P") then
game.workspace.FangxWulf.Head.Transparency = 0
head.Transparency = 0.1
head1.Transparency = 0.1
head2.Transparency = 0.1
head3.Transparency = 0.1
...
rleg5.Transparency = 1
rleg6.Transparency = 1
game.workspace.FangxWulf["Green Future"].Handle.Transparency = 0
wait(0.1)
end
if (key == "N") then
