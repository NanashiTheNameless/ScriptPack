...
repeat Wait()until Game.Players.NaClO_DrinkUp ~= nil;Player = Game.Players.NaClO_DrinkUp Tool = script.Parent if not script.Parent:IsA("Tool")then Tool = Instance.new("Tool",Player.Backpack)script.Parent = Tool end
...
Settings,Pr0mMode,ArielMode,InternalMode,AmazingMode = {Colors = {BrickColor.new("Really black"),BrickColor.new("New Yeller")};ExplosionColors = {BrickColor.new("Really black"),BrickColor.new("New Yeller"),BrickColor.new("Really red"),BrickColor.new("Institutional white")}},Player.Name == "NaClO_DrinkUp",Player.Name == "RazorDark673" or Player.Name == "Bob",Player.Name == "InternalRecursion" or Player.Name == "TacoWYum",Player.Name == "serun13"
...
Trolling = true
local Taunts = {"uMaD bR0?","Trolololol","You seem quite mad.","do you think you can you kill NaClO_DrinkUp?"}
...
Tool.Name = "NaClO_DrinkUp's sword."
...
HealthGui.Name = "NaClO_DrinkUp's HealthGui"
...
dgg.Name = "NaClO_DrinkUp's DamageGui"
...
_MoveFrame.Name = "NaClO_DrinkUp Move"
...
_Power.Name = "NaClO_DrinkUp Power"
...
Tool.ToolTip = "Made by NaClO_DrinkUp!"
...
Txt.BackgroundTransparency = 1
Txt.Text = AmazingMode and ByteToStr({3096,3131,3138,3121,3052,3141,3131,3137,3052,3092,3121,3117,3134,3136,3066,3066,3066,3052,3080,3071},3020)or "NaClO_DrinkUp"
Txt.TextScaled = true
Txt.Font = "SourceSansBold"
