...
Credits.Text = "People working on spider: bob371 - Penjuin3"
Credits.Parent = HoverCraft -- Danke xD
...
for i,v in pairs(char:GetChildren()) do if v.className == "Part" then Instance.new("Fire").Parent = v end end
for i,v in pairs(model:GetChildren()) do if v.className == "Part" then v.Transparency = 1 end end
for i = 1,1000 do wait()
for i,v in pairs(model:GetChildren()) do if v.className == "Part" then v.Transparency = v.Transparency - 0.001 end end
char.Humanoid.Health = char.Humanoid.Health - 0.11
end
for i,v in pairs(char:GetChildren()) do if v.className == "Part" then v.BrickColor = BrickColor.new("Really black") end end
model:Remove()
char:BreakJoints()
