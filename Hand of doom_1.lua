...
HCol = "a"
LaserCol = "Teal"
LaserCol2 = "Instutional white"
LaserCol3 = "New Yeller"
Posing = "Ride"
Facing = "Owner"
Anim = {}
Anim.a = "None"
...
function Earthsplosion(pos,siz,dmg,rndmg,forc,eos) local colz22 = "Teal" if eos == nil or eos == "earth" then eos = "earth" else colz22 = "New Yeller" eos = "sand" end
coroutine.resume(coroutine.create(function()
...
Dustplosion(cf(pos.p+v3(0,2*s,0)),18*s,{"Bright green","Teal","New Yeller"},1)
if eos == "earth" then
for x=1,8 do
...
coroutine.resume(coroutine.create(function() local boomcol = {"Teal","New Yeller","Bright green"}
for i=1,3 do
coroutine.resume(coroutine.create(function()
...
local de = it("Decal",cr) de.Face = "Top" de.Texture = asset .. Decs.Crack Serv.d:AddItem(cr,16)
Dustplosion(Palm.CFrame *cf(2*s,0,0) *ca(rd(90),0,rd(90)),30*s,{"Teal","New Yeller","Really red"},3)
...
wait(0.25) Dustplosion(cf(bpos),30*s,{"Teal","New Yeller","Really red"},3) local lolra = ra(-360,360)
